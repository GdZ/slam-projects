...
public class ParkingFacilityAttributeSetList implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    ...
    public ParkingFacilityAttributeSetList(
            byte coordShift_)
    {
        this.coordShift_ = coordShift_;
    }

    public ParkingFacilityAttributeSetList(zserio.runtime.io.BitStreamReader in,
            byte coordShift_)
    ...
    public ParkingFacilityAttributeSetList(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in,
            byte coordShift_)
            throws java.io.IOException
    {
        this.coordShift_ = coordShift_;
    ...
    public ParkingFacilityAttributeSetList(
            ...
            nds.venue.details.instantiations.ParkingFacilityAttributeSetMap[] sets_)
    {
        this(coordShift_);
    ...
    public nds.venue.details.instantiations.ParkingFacilityAttributeSetMap[] getSets()
    {
        return (sets_ == null) ? null : sets_.getRawArray();
    }

    public void setSets(nds.venue.details.instantiations.ParkingFacilityAttributeSetMap[] sets_)
    {
        this.sets_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.ObjectRawArray<>(nds.venue.details.instantiations.ParkingFacilityAttributeSetMap.class, sets_),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.venue.details.instantiations.ParkingFacilityAttributeSetMap>(new ZserioElementFactory_sets()),
    ...
    {
        if (obj instanceof ParkingFacilityAttributeSetList)
        {
            final ParkingFacilityAttributeSetList that = (ParkingFacilityAttributeSetList)obj;
            ...
            throws java.io.IOException
    {
        ...
        sets_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.ObjectRawArray<>(nds.venue.details.instantiations.ParkingFacilityAttributeSetMap.class),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.venue.details.instantiations.ParkingFacilityAttributeSetMap>(new ZserioElementFactory_sets()),
                zserio.runtime.array.ArrayType.NORMAL);
    ...
    public void write(zserio.runtime.io.BitStreamWriter out) throws java.io.IOException
    {
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field ParkingFacilityAttributeSetList.sets: " +
    ...
    private final class ZserioElementFactory_sets implements zserio.runtime.array.PackableElementFactory<nds.venue.details.instantiations.ParkingFacilityAttributeSetMap>
    {
        @Override
        public nds.venue.details.instantiations.ParkingFacilityAttributeSetMap create(zserio.runtime.io.BitStreamReader in, int index)
                throws java.io.IOException
        {
            return new nds.venue.details.instantiations.ParkingFacilityAttributeSetMap(in, (byte)(getCoordShift()));
        }

        @Override
        public zserio.runtime.array.PackingContext createPackingContext()
        {
            return new nds.venue.details.instantiations.ParkingFacilityAttributeSetMap.ZserioPackingContext();
        }

        @Override
        public nds.venue.details.instantiations.ParkingFacilityAttributeSetMap create(zserio.runtime.array.PackingContext context,
                zserio.runtime.io.BitStreamReader in, int index) throws java.io.IOException
        {
            return new nds.venue.details.instantiations.ParkingFacilityAttributeSetMap(context, in, (byte)(getCoordShift()));
        }
    }
