...
public class ParkingFacilityAttributeMap implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    ...
    public ParkingFacilityAttributeMap(
            byte coordShift_)
    {
        this.coordShift_ = coordShift_;
    }

    public ParkingFacilityAttributeMap(zserio.runtime.io.BitStreamReader in,
            byte coordShift_)
    ...
    public ParkingFacilityAttributeMap(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in,
            byte coordShift_)
            throws java.io.IOException
    {
        this.coordShift_ = coordShift_;
    ...
    public ParkingFacilityAttributeMap(
            ...
            int attribute_,
            nds.venue.details.instantiations.ParkingFacilityAttribute[] attributeValues_,
    ...
    public nds.venue.details.attributes.ParkingFacilityAttributeType getAttributeTypeCode()
    {
        return attributeTypeCode_;
    }

    public void setAttributeTypeCode(nds.venue.details.attributes.ParkingFacilityAttributeType attributeTypeCode_)
    {
    ...
    public nds.venue.details.instantiations.ParkingFacilityAttribute[] getAttributeValues()
    {
        return (attributeValues_ == null) ? null : attributeValues_.getRawArray();
    }

    public void setAttributeValues(nds.venue.details.instantiations.ParkingFacilityAttribute[] attributeValues_)
    {
        this.attributeValues_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.ObjectRawArray<>(nds.venue.details.instantiations.ParkingFacilityAttribute.class, attributeValues_),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.venue.details.instantiations.ParkingFacilityAttribute>(new ZserioElementFactory_attributeValues()),
                zserio.runtime.array.ArrayType.NORMAL);
    }
    ...
    {
        if (obj instanceof ParkingFacilityAttributeMap)
        {
            final ParkingFacilityAttributeMap that = (ParkingFacilityAttributeMap)obj;
    ...
    public void read(zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        attributeTypeCode_ = nds.venue.details.attributes.ParkingFacilityAttributeType.readEnum(in);
        ...
        attributeValues_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.ObjectRawArray<>(nds.venue.details.instantiations.ParkingFacilityAttribute.class),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.venue.details.instantiations.ParkingFacilityAttribute>(new ZserioElementFactory_attributeValues()),
                zserio.runtime.array.ArrayType.NORMAL);
    ...
    {
        final ZserioPackingContext zserioContext = context.cast();
        attributeTypeCode_ = nds.venue.details.attributes.ParkingFacilityAttributeType.readEnum(zserioContext.getAttributeTypeCode(), in);
    ...
    public void write(zserio.runtime.io.BitStreamWriter out) throws java.io.IOException
    {
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field ParkingFacilityAttributeMap.featureReferences: " +
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field ParkingFacilityAttributeMap.featureValidities: " +
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field ParkingFacilityAttributeMap.featureValuePtr: " +
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field ParkingFacilityAttributeMap.attributeValues: " +
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field ParkingFacilityAttributeMap.attributeProperties: " +
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field ParkingFacilityAttributeMap.attributeConditions: " +
    ...
    private final class ZserioElementFactory_attributeValues implements zserio.runtime.array.PackableElementFactory<nds.venue.details.instantiations.ParkingFacilityAttribute>
    {
        @Override
        public nds.venue.details.instantiations.ParkingFacilityAttribute create(zserio.runtime.io.BitStreamReader in, int index)
                throws java.io.IOException
        {
            return new nds.venue.details.instantiations.ParkingFacilityAttribute(in, getAttributeTypeCode());
        }

        @Override
        public zserio.runtime.array.PackingContext createPackingContext()
        {
            return new nds.venue.details.instantiations.ParkingFacilityAttribute.ZserioPackingContext();
        }

        @Override
        public nds.venue.details.instantiations.ParkingFacilityAttribute create(zserio.runtime.array.PackingContext context,
                zserio.runtime.io.BitStreamReader in, int index) throws java.io.IOException
        {
            return new nds.venue.details.instantiations.ParkingFacilityAttribute(context, in, getAttributeTypeCode());
        }
    }
    ...
    private nds.venue.details.attributes.ParkingFacilityAttributeType attributeTypeCode_;
