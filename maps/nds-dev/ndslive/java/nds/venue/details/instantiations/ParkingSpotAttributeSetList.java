...
public class ParkingSpotAttributeSetList implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    ...
    public ParkingSpotAttributeSetList(
            byte coordShift_)
    {
        this.coordShift_ = coordShift_;
    }

    public ParkingSpotAttributeSetList(zserio.runtime.io.BitStreamReader in,
            byte coordShift_)
    ...
    public ParkingSpotAttributeSetList(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in,
            byte coordShift_)
            throws java.io.IOException
    {
        this.coordShift_ = coordShift_;
    ...
    public ParkingSpotAttributeSetList(
            ...
            nds.venue.details.instantiations.ParkingSpotAttributeSetMap[] sets_)
    {
        this(coordShift_);
    ...
    public nds.venue.details.instantiations.ParkingSpotAttributeSetMap[] getSets()
    {
        return (sets_ == null) ? null : sets_.getRawArray();
    }

    public void setSets(nds.venue.details.instantiations.ParkingSpotAttributeSetMap[] sets_)
    {
        this.sets_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.ObjectRawArray<>(nds.venue.details.instantiations.ParkingSpotAttributeSetMap.class, sets_),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.venue.details.instantiations.ParkingSpotAttributeSetMap>(new ZserioElementFactory_sets()),
    ...
    {
        if (obj instanceof ParkingSpotAttributeSetList)
        {
            final ParkingSpotAttributeSetList that = (ParkingSpotAttributeSetList)obj;
            ...
            throws java.io.IOException
    {
        ...
        sets_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.ObjectRawArray<>(nds.venue.details.instantiations.ParkingSpotAttributeSetMap.class),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.venue.details.instantiations.ParkingSpotAttributeSetMap>(new ZserioElementFactory_sets()),
                zserio.runtime.array.ArrayType.NORMAL);
    ...
    public void write(zserio.runtime.io.BitStreamWriter out) throws java.io.IOException
    {
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field ParkingSpotAttributeSetList.sets: " +
    ...
    private final class ZserioElementFactory_sets implements zserio.runtime.array.PackableElementFactory<nds.venue.details.instantiations.ParkingSpotAttributeSetMap>
    {
        @Override
        public nds.venue.details.instantiations.ParkingSpotAttributeSetMap create(zserio.runtime.io.BitStreamReader in, int index)
                throws java.io.IOException
        {
            return new nds.venue.details.instantiations.ParkingSpotAttributeSetMap(in, (byte)(getCoordShift()));
        }

        @Override
        public zserio.runtime.array.PackingContext createPackingContext()
        {
            return new nds.venue.details.instantiations.ParkingSpotAttributeSetMap.ZserioPackingContext();
        }

        @Override
        public nds.venue.details.instantiations.ParkingSpotAttributeSetMap create(zserio.runtime.array.PackingContext context,
                zserio.runtime.io.BitStreamReader in, int index) throws java.io.IOException
        {
            return new nds.venue.details.instantiations.ParkingSpotAttributeSetMap(context, in, (byte)(getCoordShift()));
        }
    }
