...
public class ParkingRowAttributeSetList implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    ...
    public ParkingRowAttributeSetList(
            byte coordShift_)
    {
        this.coordShift_ = coordShift_;
    }

    public ParkingRowAttributeSetList(zserio.runtime.io.BitStreamReader in,
            byte coordShift_)
    ...
    public ParkingRowAttributeSetList(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in,
            byte coordShift_)
            throws java.io.IOException
    {
        this.coordShift_ = coordShift_;
    ...
    public ParkingRowAttributeSetList(
            ...
            nds.venue.details.instantiations.ParkingRowAttributeSetMap[] sets_)
    {
        this(coordShift_);
    ...
    public nds.venue.details.instantiations.ParkingRowAttributeSetMap[] getSets()
    {
        return (sets_ == null) ? null : sets_.getRawArray();
    }

    public void setSets(nds.venue.details.instantiations.ParkingRowAttributeSetMap[] sets_)
    {
        this.sets_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.ObjectRawArray<>(nds.venue.details.instantiations.ParkingRowAttributeSetMap.class, sets_),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.venue.details.instantiations.ParkingRowAttributeSetMap>(new ZserioElementFactory_sets()),
    ...
    {
        if (obj instanceof ParkingRowAttributeSetList)
        {
            final ParkingRowAttributeSetList that = (ParkingRowAttributeSetList)obj;
            ...
            throws java.io.IOException
    {
        ...
        sets_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.ObjectRawArray<>(nds.venue.details.instantiations.ParkingRowAttributeSetMap.class),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.venue.details.instantiations.ParkingRowAttributeSetMap>(new ZserioElementFactory_sets()),
                zserio.runtime.array.ArrayType.NORMAL);
    ...
    public void write(zserio.runtime.io.BitStreamWriter out) throws java.io.IOException
    {
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field ParkingRowAttributeSetList.sets: " +
    ...
    private final class ZserioElementFactory_sets implements zserio.runtime.array.PackableElementFactory<nds.venue.details.instantiations.ParkingRowAttributeSetMap>
    {
        @Override
        public nds.venue.details.instantiations.ParkingRowAttributeSetMap create(zserio.runtime.io.BitStreamReader in, int index)
                throws java.io.IOException
        {
            return new nds.venue.details.instantiations.ParkingRowAttributeSetMap(in, (byte)(getCoordShift()));
        }

        @Override
        public zserio.runtime.array.PackingContext createPackingContext()
        {
            return new nds.venue.details.instantiations.ParkingRowAttributeSetMap.ZserioPackingContext();
        }

        @Override
        public nds.venue.details.instantiations.ParkingRowAttributeSetMap create(zserio.runtime.array.PackingContext context,
                zserio.runtime.io.BitStreamReader in, int index) throws java.io.IOException
        {
            return new nds.venue.details.instantiations.ParkingRowAttributeSetMap(context, in, (byte)(getCoordShift()));
        }
    }
