...
public class ParkingFacilityAttributeSetMap implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    public static final class ZserioPackingContext extends zserio.runtime.array.PackingContext
    {
        public ZserioPackingContext()
        {
            attributeSet_ = new nds.venue.details.instantiations.ParkingFacilityAttributeSet.ZserioPackingContext();
            feature_ = new zserio.runtime.array.DeltaContext();
        }

        public nds.venue.details.instantiations.ParkingFacilityAttributeSet.ZserioPackingContext getAttributeSet()
        {
        ...
        private nds.venue.details.instantiations.ParkingFacilityAttributeSet.ZserioPackingContext attributeSet_;
        private zserio.runtime.array.DeltaContext feature_;
    };

    public ParkingFacilityAttributeSetMap(
            byte coordShift_)
    {
        this.coordShift_ = coordShift_;
    }

    public ParkingFacilityAttributeSetMap(zserio.runtime.io.BitStreamReader in,
            byte coordShift_)
    ...
    public ParkingFacilityAttributeSetMap(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in,
            byte coordShift_)
            throws java.io.IOException
    {
        this.coordShift_ = coordShift_;
    ...
    public ParkingFacilityAttributeSetMap(
            byte coordShift_,
            nds.venue.details.instantiations.ParkingFacilityAttributeSet attributeSet_,
            int feature_,
    ...
    public nds.venue.details.instantiations.ParkingFacilityAttributeSet getAttributeSet()
    {
        return attributeSet_;
    }

    public void setAttributeSet(nds.venue.details.instantiations.ParkingFacilityAttributeSet attributeSet_)
    {
    ...
    {
        if (obj instanceof ParkingFacilityAttributeSetMap)
        {
            final ParkingFacilityAttributeSetMap that = (ParkingFacilityAttributeSetMap)obj;
    ...
    public void read(zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        attributeSet_ = new nds.venue.details.instantiations.ParkingFacilityAttributeSet(in);
    ...
    {
        final ZserioPackingContext zserioContext = context.cast();
        attributeSet_ = new nds.venue.details.instantiations.ParkingFacilityAttributeSet(zserioContext.getAttributeSet(), in);
    ...
    public void write(zserio.runtime.io.BitStreamWriter out) throws java.io.IOException
    {
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field ParkingFacilityAttributeSetMap.references: " +
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field ParkingFacilityAttributeSetMap.validities: " +
    ...
    private nds.venue.details.instantiations.ParkingFacilityAttributeSet attributeSet_;
