...
public class ParkingSpotFullAttribute implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    public static final class ZserioPackingContext extends zserio.runtime.array.PackingContext
    {
        public ZserioPackingContext()
        {
            ...
            attributeValue_ = new nds.venue.details.attributes.ParkingSpotAttributeValue.ZserioPackingContext();
        ...
        public nds.venue.details.attributes.ParkingSpotAttributeValue.ZserioPackingContext getAttributeValue()
        {
        ...
        private nds.venue.details.attributes.ParkingSpotAttributeValue.ZserioPackingContext attributeValue_;
    ...
    public ParkingSpotFullAttribute()
    {
    }

    public ParkingSpotFullAttribute(zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        read(in);
    }

    public ParkingSpotFullAttribute(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        read(context, in);
    }
    ...
    public ParkingSpotFullAttribute(
            ...
            nds.venue.details.attributes.ParkingSpotAttributeValue attributeValue_,
    ...
    public nds.venue.details.attributes.ParkingSpotAttributeValue getAttributeValue()
    {
        return attributeValue_;
    }

    public void setAttributeValue(nds.venue.details.attributes.ParkingSpotAttributeValue attributeValue_)
    {
    ...
    {
        if (obj instanceof ParkingSpotFullAttribute)
        {
            final ParkingSpotFullAttribute that = (ParkingSpotFullAttribute)obj;
            ...
            throws java.io.IOException
    {
        ...
        attributeValue_ = new nds.venue.details.attributes.ParkingSpotAttributeValue(in, getAttributeTypeCode());
            ...
            throws java.io.IOException
    {
        ...
        attributeValue_ = new nds.venue.details.attributes.ParkingSpotAttributeValue(zserioContext.getAttributeValue(), in, getAttributeTypeCode());
    ...
    public void write(zserio.runtime.io.BitStreamWriter out) throws java.io.IOException
    {
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Inconsistent parameter type for field ParkingSpotFullAttribute.attributeValue!");
        }
    ...
    private nds.venue.details.attributes.ParkingSpotAttributeValue attributeValue_;
