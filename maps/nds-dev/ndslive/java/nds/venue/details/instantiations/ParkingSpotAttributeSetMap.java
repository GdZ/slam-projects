...
public class ParkingSpotAttributeSetMap implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    public static final class ZserioPackingContext extends zserio.runtime.array.PackingContext
    {
        public ZserioPackingContext()
        {
            attributeSet_ = new nds.venue.details.instantiations.ParkingSpotAttributeSet.ZserioPackingContext();
            feature_ = new zserio.runtime.array.DeltaContext();
        }

        public nds.venue.details.instantiations.ParkingSpotAttributeSet.ZserioPackingContext getAttributeSet()
        {
        ...
        private nds.venue.details.instantiations.ParkingSpotAttributeSet.ZserioPackingContext attributeSet_;
        private zserio.runtime.array.DeltaContext feature_;
    };

    public ParkingSpotAttributeSetMap(
            byte coordShift_)
    {
        this.coordShift_ = coordShift_;
    }

    public ParkingSpotAttributeSetMap(zserio.runtime.io.BitStreamReader in,
            byte coordShift_)
    ...
    public ParkingSpotAttributeSetMap(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in,
            byte coordShift_)
            throws java.io.IOException
    {
        this.coordShift_ = coordShift_;
    ...
    public ParkingSpotAttributeSetMap(
            byte coordShift_,
            nds.venue.details.instantiations.ParkingSpotAttributeSet attributeSet_,
            int feature_,
    ...
    public nds.venue.details.instantiations.ParkingSpotAttributeSet getAttributeSet()
    {
        return attributeSet_;
    }

    public void setAttributeSet(nds.venue.details.instantiations.ParkingSpotAttributeSet attributeSet_)
    {
    ...
    {
        if (obj instanceof ParkingSpotAttributeSetMap)
        {
            final ParkingSpotAttributeSetMap that = (ParkingSpotAttributeSetMap)obj;
    ...
    public void read(zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        attributeSet_ = new nds.venue.details.instantiations.ParkingSpotAttributeSet(in);
    ...
    {
        final ZserioPackingContext zserioContext = context.cast();
        attributeSet_ = new nds.venue.details.instantiations.ParkingSpotAttributeSet(zserioContext.getAttributeSet(), in);
    ...
    public void write(zserio.runtime.io.BitStreamWriter out) throws java.io.IOException
    {
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field ParkingSpotAttributeSetMap.references: " +
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field ParkingSpotAttributeSetMap.validities: " +
    ...
    private nds.venue.details.instantiations.ParkingSpotAttributeSet attributeSet_;
