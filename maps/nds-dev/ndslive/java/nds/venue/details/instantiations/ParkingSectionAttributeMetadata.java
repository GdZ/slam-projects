...
public class ParkingSectionAttributeMetadata implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    ...
    public ParkingSectionAttributeMetadata()
    {
    }

    public ParkingSectionAttributeMetadata(zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        read(in);
    }

    public ParkingSectionAttributeMetadata(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        read(context, in);
    }
    ...
    public ParkingSectionAttributeMetadata(
            nds.venue.details.attributes.ParkingSectionAttributeType[] availableAttributes_,
    ...
    public nds.venue.details.attributes.ParkingSectionAttributeType[] getAvailableAttributes()
    {
        return (availableAttributes_ == null) ? null : availableAttributes_.getRawArray();
    }

    public void setAvailableAttributes(nds.venue.details.attributes.ParkingSectionAttributeType[] availableAttributes_)
    {
        this.availableAttributes_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.EnumRawArray<>(nds.venue.details.attributes.ParkingSectionAttributeType.class, availableAttributes_),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.venue.details.attributes.ParkingSectionAttributeType>(new ZserioElementFactory_availableAttributes()),
    ...
    {
        if (obj instanceof ParkingSectionAttributeMetadata)
        {
            final ParkingSectionAttributeMetadata that = (ParkingSectionAttributeMetadata)obj;
    ...
    private static final class ZserioElementFactory_availableAttributes implements zserio.runtime.array.PackableElementFactory<nds.venue.details.attributes.ParkingSectionAttributeType>
    {
        @Override
