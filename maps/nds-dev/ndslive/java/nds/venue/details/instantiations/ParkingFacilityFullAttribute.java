...
public class ParkingFacilityFullAttribute implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    public static final class ZserioPackingContext extends zserio.runtime.array.PackingContext
    {
        public ZserioPackingContext()
        {
            ...
            attributeValue_ = new nds.venue.details.attributes.ParkingFacilityAttributeValue.ZserioPackingContext();
        ...
        public nds.venue.details.attributes.ParkingFacilityAttributeValue.ZserioPackingContext getAttributeValue()
        {
        ...
        private nds.venue.details.attributes.ParkingFacilityAttributeValue.ZserioPackingContext attributeValue_;
    ...
    public ParkingFacilityFullAttribute()
    {
    }

    public ParkingFacilityFullAttribute(zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        read(in);
    }

    public ParkingFacilityFullAttribute(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        read(context, in);
    }
    ...
    public ParkingFacilityFullAttribute(
            ...
            nds.venue.details.attributes.ParkingFacilityAttributeValue attributeValue_,
    ...
    public nds.venue.details.attributes.ParkingFacilityAttributeValue getAttributeValue()
    {
        return attributeValue_;
    }

    public void setAttributeValue(nds.venue.details.attributes.ParkingFacilityAttributeValue attributeValue_)
    {
    ...
    {
        if (obj instanceof ParkingFacilityFullAttribute)
        {
            final ParkingFacilityFullAttribute that = (ParkingFacilityFullAttribute)obj;
            ...
            throws java.io.IOException
    {
        ...
        attributeValue_ = new nds.venue.details.attributes.ParkingFacilityAttributeValue(in, getAttributeTypeCode());
            ...
            throws java.io.IOException
    {
        ...
        attributeValue_ = new nds.venue.details.attributes.ParkingFacilityAttributeValue(zserioContext.getAttributeValue(), in, getAttributeTypeCode());
    ...
    public void write(zserio.runtime.io.BitStreamWriter out) throws java.io.IOException
    {
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Inconsistent parameter type for field ParkingFacilityFullAttribute.attributeValue!");
        }
    ...
    private nds.venue.details.attributes.ParkingFacilityAttributeValue attributeValue_;
