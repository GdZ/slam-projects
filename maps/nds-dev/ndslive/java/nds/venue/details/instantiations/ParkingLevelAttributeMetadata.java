...
public class ParkingLevelAttributeMetadata implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    ...
    public ParkingLevelAttributeMetadata()
    {
    }

    public ParkingLevelAttributeMetadata(zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        read(in);
    }

    public ParkingLevelAttributeMetadata(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        read(context, in);
    }
    ...
    public ParkingLevelAttributeMetadata(
            nds.venue.details.attributes.ParkingLevelAttributeType[] availableAttributes_,
    ...
    public nds.venue.details.attributes.ParkingLevelAttributeType[] getAvailableAttributes()
    {
        return (availableAttributes_ == null) ? null : availableAttributes_.getRawArray();
    }

    public void setAvailableAttributes(nds.venue.details.attributes.ParkingLevelAttributeType[] availableAttributes_)
    {
        this.availableAttributes_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.EnumRawArray<>(nds.venue.details.attributes.ParkingLevelAttributeType.class, availableAttributes_),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.venue.details.attributes.ParkingLevelAttributeType>(new ZserioElementFactory_availableAttributes()),
    ...
    {
        if (obj instanceof ParkingLevelAttributeMetadata)
        {
            final ParkingLevelAttributeMetadata that = (ParkingLevelAttributeMetadata)obj;
            ...
            throws java.io.IOException
    {
        availableAttributes_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.EnumRawArray<>(nds.venue.details.attributes.ParkingLevelAttributeType.class),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.venue.details.attributes.ParkingLevelAttributeType>(new ZserioElementFactory_availableAttributes()),
                zserio.runtime.array.ArrayType.AUTO);
    ...
    private static final class ZserioElementFactory_availableAttributes implements zserio.runtime.array.PackableElementFactory<nds.venue.details.attributes.ParkingLevelAttributeType>
    {
        @Override
        public nds.venue.details.attributes.ParkingLevelAttributeType create(zserio.runtime.io.BitStreamReader in, int index)
                throws java.io.IOException
        {
            return nds.venue.details.attributes.ParkingLevelAttributeType.readEnum(in);
        }
        ...
        @Override
        public nds.venue.details.attributes.ParkingLevelAttributeType create(zserio.runtime.array.PackingContext context,
                zserio.runtime.io.BitStreamReader in, int index) throws java.io.IOException
        {
            return nds.venue.details.attributes.ParkingLevelAttributeType.readEnum(context, in);
        }
    }
