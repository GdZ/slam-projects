...
public class VenuePropertyList implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    ...
    public VenuePropertyList()
    {
    }

    public VenuePropertyList(zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        read(in);
    }

    public VenuePropertyList(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        read(context, in);
    }
    ...
    public VenuePropertyList(
            ...
            nds.venue.details.instantiations.VenueProperty[] property_)
    {
    ...
    public nds.venue.details.instantiations.VenueProperty[] getProperty()
    {
        return (property_ == null) ? null : property_.getRawArray();
    }

    public void setProperty(nds.venue.details.instantiations.VenueProperty[] property_)
    {
        if (property_ == null)
        {
            this.property_ = null;
        ...
        else
        {
            this.property_ = new zserio.runtime.array.Array(
                    new zserio.runtime.array.RawArray.ObjectRawArray<>(nds.venue.details.instantiations.VenueProperty.class, property_),
                    new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.venue.details.instantiations.VenueProperty>(new ZserioElementFactory_property()),
    ...
    {
        if (obj instanceof VenuePropertyList)
        {
            final VenuePropertyList that = (VenuePropertyList)obj;
            ...
            throws java.io.IOException
    {
        ...
        if (getNumProperties() > 0)
        {
            property_ = new zserio.runtime.array.Array(
                    new zserio.runtime.array.RawArray.ObjectRawArray<>(nds.venue.details.instantiations.VenueProperty.class),
                    new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.venue.details.instantiations.VenueProperty>(new ZserioElementFactory_property()),
                    zserio.runtime.array.ArrayType.NORMAL);
    ...
    public void write(zserio.runtime.io.BitStreamWriter out) throws java.io.IOException
    {
        ...
        if (isPropertyUsed())
        {
            ...
            {
                throw new zserio.runtime.ZserioError("Write: Wrong array length for field VenuePropertyList.property: " +
    ...
    private static final class ZserioElementFactory_property implements zserio.runtime.array.PackableElementFactory<nds.venue.details.instantiations.VenueProperty>
    {
        @Override
        public nds.venue.details.instantiations.VenueProperty create(zserio.runtime.io.BitStreamReader in, int index)
                throws java.io.IOException
        {
            return new nds.venue.details.instantiations.VenueProperty(in);
        }

        @Override
        public zserio.runtime.array.PackingContext createPackingContext()
        {
            return new nds.venue.details.instantiations.VenueProperty.ZserioPackingContext();
        }

        @Override
        public nds.venue.details.instantiations.VenueProperty create(zserio.runtime.array.PackingContext context,
                zserio.runtime.io.BitStreamReader in, int index) throws java.io.IOException
        {
            return new nds.venue.details.instantiations.VenueProperty(context, in);
        }
    }
