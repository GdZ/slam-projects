...
public class ParkingRowAttributeMetadata implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    ...
    public ParkingRowAttributeMetadata()
    {
    }

    public ParkingRowAttributeMetadata(zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        read(in);
    }

    public ParkingRowAttributeMetadata(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        read(context, in);
    }
    ...
    public ParkingRowAttributeMetadata(
            nds.venue.details.attributes.ParkingRowAttributeType[] availableAttributes_,
    ...
    public nds.venue.details.attributes.ParkingRowAttributeType[] getAvailableAttributes()
    {
        return (availableAttributes_ == null) ? null : availableAttributes_.getRawArray();
    }

    public void setAvailableAttributes(nds.venue.details.attributes.ParkingRowAttributeType[] availableAttributes_)
    {
        this.availableAttributes_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.EnumRawArray<>(nds.venue.details.attributes.ParkingRowAttributeType.class, availableAttributes_),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.venue.details.attributes.ParkingRowAttributeType>(new ZserioElementFactory_availableAttributes()),
    ...
    {
        if (obj instanceof ParkingRowAttributeMetadata)
        {
            final ParkingRowAttributeMetadata that = (ParkingRowAttributeMetadata)obj;
            ...
            throws java.io.IOException
    {
        availableAttributes_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.EnumRawArray<>(nds.venue.details.attributes.ParkingRowAttributeType.class),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.venue.details.attributes.ParkingRowAttributeType>(new ZserioElementFactory_availableAttributes()),
                zserio.runtime.array.ArrayType.AUTO);
    ...
    private static final class ZserioElementFactory_availableAttributes implements zserio.runtime.array.PackableElementFactory<nds.venue.details.attributes.ParkingRowAttributeType>
    {
        @Override
        public nds.venue.details.attributes.ParkingRowAttributeType create(zserio.runtime.io.BitStreamReader in, int index)
                throws java.io.IOException
        {
            return nds.venue.details.attributes.ParkingRowAttributeType.readEnum(in);
        }
        ...
        @Override
        public nds.venue.details.attributes.ParkingRowAttributeType create(zserio.runtime.array.PackingContext context,
                zserio.runtime.io.BitStreamReader in, int index) throws java.io.IOException
        {
            return nds.venue.details.attributes.ParkingRowAttributeType.readEnum(context, in);
        }
    }
