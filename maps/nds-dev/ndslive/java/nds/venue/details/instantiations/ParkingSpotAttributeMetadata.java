...
public class ParkingSpotAttributeMetadata implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    ...
    public ParkingSpotAttributeMetadata()
    {
    }

    public ParkingSpotAttributeMetadata(zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        read(in);
    }

    public ParkingSpotAttributeMetadata(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        read(context, in);
    }
    ...
    public ParkingSpotAttributeMetadata(
            nds.venue.details.attributes.ParkingSpotAttributeType[] availableAttributes_,
    ...
    public nds.venue.details.attributes.ParkingSpotAttributeType[] getAvailableAttributes()
    {
        return (availableAttributes_ == null) ? null : availableAttributes_.getRawArray();
    }

    public void setAvailableAttributes(nds.venue.details.attributes.ParkingSpotAttributeType[] availableAttributes_)
    {
        this.availableAttributes_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.EnumRawArray<>(nds.venue.details.attributes.ParkingSpotAttributeType.class, availableAttributes_),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.venue.details.attributes.ParkingSpotAttributeType>(new ZserioElementFactory_availableAttributes()),
    ...
    {
        if (obj instanceof ParkingSpotAttributeMetadata)
        {
            final ParkingSpotAttributeMetadata that = (ParkingSpotAttributeMetadata)obj;
            ...
            throws java.io.IOException
    {
        availableAttributes_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.EnumRawArray<>(nds.venue.details.attributes.ParkingSpotAttributeType.class),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.venue.details.attributes.ParkingSpotAttributeType>(new ZserioElementFactory_availableAttributes()),
                zserio.runtime.array.ArrayType.AUTO);
    ...
    private static final class ZserioElementFactory_availableAttributes implements zserio.runtime.array.PackableElementFactory<nds.venue.details.attributes.ParkingSpotAttributeType>
    {
        @Override
        public nds.venue.details.attributes.ParkingSpotAttributeType create(zserio.runtime.io.BitStreamReader in, int index)
                throws java.io.IOException
        {
            return nds.venue.details.attributes.ParkingSpotAttributeType.readEnum(in);
        }
        ...
        @Override
        public nds.venue.details.attributes.ParkingSpotAttributeType create(zserio.runtime.array.PackingContext context,
                zserio.runtime.io.BitStreamReader in, int index) throws java.io.IOException
        {
            return nds.venue.details.attributes.ParkingSpotAttributeType.readEnum(context, in);
        }
    }
