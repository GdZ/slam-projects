...
public class ParkingRowAttributeSetMap implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    public static final class ZserioPackingContext extends zserio.runtime.array.PackingContext
    {
        public ZserioPackingContext()
        {
            attributeSet_ = new nds.venue.details.instantiations.ParkingRowAttributeSet.ZserioPackingContext();
            feature_ = new zserio.runtime.array.DeltaContext();
        }

        public nds.venue.details.instantiations.ParkingRowAttributeSet.ZserioPackingContext getAttributeSet()
        {
        ...
        private nds.venue.details.instantiations.ParkingRowAttributeSet.ZserioPackingContext attributeSet_;
        private zserio.runtime.array.DeltaContext feature_;
    };

    public ParkingRowAttributeSetMap(
            byte coordShift_)
    {
        this.coordShift_ = coordShift_;
    }

    public ParkingRowAttributeSetMap(zserio.runtime.io.BitStreamReader in,
            byte coordShift_)
    ...
    public ParkingRowAttributeSetMap(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in,
            byte coordShift_)
            throws java.io.IOException
    {
        this.coordShift_ = coordShift_;
    ...
    public ParkingRowAttributeSetMap(
            byte coordShift_,
            nds.venue.details.instantiations.ParkingRowAttributeSet attributeSet_,
            int feature_,
    ...
    public nds.venue.details.instantiations.ParkingRowAttributeSet getAttributeSet()
    {
        return attributeSet_;
    }

    public void setAttributeSet(nds.venue.details.instantiations.ParkingRowAttributeSet attributeSet_)
    {
    ...
    {
        if (obj instanceof ParkingRowAttributeSetMap)
        {
            final ParkingRowAttributeSetMap that = (ParkingRowAttributeSetMap)obj;
    ...
    public void read(zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        attributeSet_ = new nds.venue.details.instantiations.ParkingRowAttributeSet(in);
    ...
    {
        final ZserioPackingContext zserioContext = context.cast();
        attributeSet_ = new nds.venue.details.instantiations.ParkingRowAttributeSet(zserioContext.getAttributeSet(), in);
    ...
    public void write(zserio.runtime.io.BitStreamWriter out) throws java.io.IOException
    {
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field ParkingRowAttributeSetMap.references: " +
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field ParkingRowAttributeSetMap.validities: " +
    ...
    private nds.venue.details.instantiations.ParkingRowAttributeSet attributeSet_;
