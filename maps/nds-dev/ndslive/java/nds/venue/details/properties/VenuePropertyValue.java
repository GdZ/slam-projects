...
public class VenuePropertyValue implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    ...
    public VenuePropertyValue(
            nds.venue.details.properties.VenuePropertyType type_)
    {
        this.type_ = type_;
    }

    public VenuePropertyValue(zserio.runtime.io.BitStreamReader in,
            nds.venue.details.properties.VenuePropertyType type_)
    ...
    public VenuePropertyValue(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in,
            nds.venue.details.properties.VenuePropertyType type_)
            throws java.io.IOException
    {
        this.type_ = type_;
    ...
    public VenuePropertyValue(
            nds.venue.details.properties.VenuePropertyType type_,
            nds.venue.details.properties.PropertyValue value_,
    ...
    public nds.venue.details.properties.VenuePropertyType getType()
    {
        return this.type_;
    }

    public nds.venue.details.properties.PropertyValue getValue()
    {
        return value_;
    }

    public void setValue(nds.venue.details.properties.PropertyValue value_)
    {
        this.value_ = value_;
    }
    ...
    {
        if (obj instanceof VenuePropertyValue)
        {
            final VenuePropertyValue that = (VenuePropertyValue)obj;
            ...
            throws java.io.IOException
    {
        ...
        {
            value_ = new nds.venue.details.properties.PropertyValue(in, getType().getType());
        }
    ...
    public void write(zserio.runtime.io.BitStreamWriter out) throws java.io.IOException
    {
        if (isValueUsed())
        {
            ...
            {
                throw new zserio.runtime.ZserioError("Write: Inconsistent parameter type for field VenuePropertyValue.value!");
            }
            value_.write(out);
        }
        ...
        if (isCoreValueUsed())
        {
            ...
            {
                throw new zserio.runtime.ZserioError("Write: Inconsistent parameter type for field VenuePropertyValue.coreValue!");
            }
    ...
    private final nds.venue.details.properties.VenuePropertyType type_;
    private nds.venue.details.properties.PropertyValue value_;
