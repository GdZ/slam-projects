...
public class VenuePropertyType implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    ...
    public VenuePropertyType()
    {
    }

    public VenuePropertyType(zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        read(in);
    }

    public VenuePropertyType(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        read(context, in);
    }
    ...
    public void setType(nds.venue.details.properties.PropertyType type_)
    {
        this.type_ = type_;
    }
    ...
    {
        if (obj instanceof VenuePropertyType)
        {
            final VenuePropertyType that = (VenuePropertyType)obj;
    ...
    public void read(zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        type_ = nds.venue.details.properties.PropertyType.readEnum(in);
    ...
    {
        final ZserioPackingContext zserioContext = context.cast();
        type_ = nds.venue.details.properties.PropertyType.readEnum(zserioContext.getType(), in);
    ...
    private nds.venue.details.properties.PropertyType type_;
