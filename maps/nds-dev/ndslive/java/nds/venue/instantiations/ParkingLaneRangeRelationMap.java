...
public class ParkingLaneRangeRelationMap implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    ...
    public ParkingLaneRangeRelationMap(
            byte coordShift_)
    {
        this.coordShift_ = coordShift_;
    }

    public ParkingLaneRangeRelationMap(zserio.runtime.io.BitStreamReader in,
            byte coordShift_)
    ...
    public ParkingLaneRangeRelationMap(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in,
            byte coordShift_)
            throws java.io.IOException
    {
        this.coordShift_ = coordShift_;
    ...
    public ParkingLaneRangeRelationMap(
            ...
            int attribute_,
            nds.venue.instantiations.ParkingRangeRelation[] attributeValues_,
    ...
    public void setAttributeTypeCode(nds.venue.parking.ParkingRangeRelationType attributeTypeCode_)
    {
    ...
    public nds.venue.instantiations.ParkingRangeRelation[] getAttributeValues()
    {
        return (attributeValues_ == null) ? null : attributeValues_.getRawArray();
    }

    public void setAttributeValues(nds.venue.instantiations.ParkingRangeRelation[] attributeValues_)
    {
        this.attributeValues_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.ObjectRawArray<>(nds.venue.instantiations.ParkingRangeRelation.class, attributeValues_),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.venue.instantiations.ParkingRangeRelation>(new ZserioElementFactory_attributeValues()),
                zserio.runtime.array.ArrayType.NORMAL);
    }
    ...
    {
        if (obj instanceof ParkingLaneRangeRelationMap)
        {
            final ParkingLaneRangeRelationMap that = (ParkingLaneRangeRelationMap)obj;
    ...
    public void read(zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        attributeTypeCode_ = nds.venue.parking.ParkingRangeRelationType.readEnum(in);
        ...
        attributeValues_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.ObjectRawArray<>(nds.venue.instantiations.ParkingRangeRelation.class),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.venue.instantiations.ParkingRangeRelation>(new ZserioElementFactory_attributeValues()),
                zserio.runtime.array.ArrayType.NORMAL);
    ...
    {
        final ZserioPackingContext zserioContext = context.cast();
        attributeTypeCode_ = nds.venue.parking.ParkingRangeRelationType.readEnum(zserioContext.getAttributeTypeCode(), in);
    ...
    public void write(zserio.runtime.io.BitStreamWriter out) throws java.io.IOException
    {
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field ParkingLaneRangeRelationMap.featureReferences: " +
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field ParkingLaneRangeRelationMap.featureValidities: " +
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field ParkingLaneRangeRelationMap.featureValuePtr: " +
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field ParkingLaneRangeRelationMap.attributeValues: " +
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field ParkingLaneRangeRelationMap.attributeProperties: " +
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field ParkingLaneRangeRelationMap.attributeConditions: " +
    ...
    private final class ZserioElementFactory_attributeValues implements zserio.runtime.array.PackableElementFactory<nds.venue.instantiations.ParkingRangeRelation>
    {
        @Override
        public nds.venue.instantiations.ParkingRangeRelation create(zserio.runtime.io.BitStreamReader in, int index)
                throws java.io.IOException
        {
            return new nds.venue.instantiations.ParkingRangeRelation(in, getAttributeTypeCode());
        }

        @Override
        public zserio.runtime.array.PackingContext createPackingContext()
        {
            return new nds.venue.instantiations.ParkingRangeRelation.ZserioPackingContext();
        }

        @Override
        public nds.venue.instantiations.ParkingRangeRelation create(zserio.runtime.array.PackingContext context,
                zserio.runtime.io.BitStreamReader in, int index) throws java.io.IOException
        {
            return new nds.venue.instantiations.ParkingRangeRelation(context, in, getAttributeTypeCode());
        }
    }
    ...
    private nds.venue.parking.ParkingRangeRelationType attributeTypeCode_;
