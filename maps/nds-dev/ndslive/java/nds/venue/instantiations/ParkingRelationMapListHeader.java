...
public class ParkingRelationMapListHeader implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    public static final class ZserioPackingContext extends zserio.runtime.array.PackingContext
    {
    };

    public ParkingRelationMapListHeader(
            short numMaps_)
    {
        this.numMaps_ = numMaps_;
    }

    public ParkingRelationMapListHeader(zserio.runtime.io.BitStreamReader in,
            short numMaps_)
    ...
    public ParkingRelationMapListHeader(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in,
            short numMaps_)
            throws java.io.IOException
    {
        this.numMaps_ = numMaps_;
    ...
    public void setAttributeTypeCode(nds.venue.parking.ParkingRelationType[] attributeTypeCode_)
    {
        this.attributeTypeCode_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.EnumRawArray<>(nds.venue.parking.ParkingRelationType.class, attributeTypeCode_),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.venue.parking.ParkingRelationType>(new ZserioElementFactory_attributeTypeCode()),
    ...
    {
        if (obj instanceof ParkingRelationMapListHeader)
        {
            final ParkingRelationMapListHeader that = (ParkingRelationMapListHeader)obj;
    ...
    public void write(zserio.runtime.io.BitStreamWriter out) throws java.io.IOException
    {
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field ParkingRelationMapListHeader.attributeTypeCode: " +
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field ParkingRelationMapListHeader.conditionType: " +
    ...
    private static final class ZserioElementFactory_attributeTypeCode implements zserio.runtime.array.PackableElementFactory<nds.venue.parking.ParkingRelationType>
    {
        @Override
