...
public class ParkingPositionRelationMapListHeader implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    public static final class ZserioPackingContext extends zserio.runtime.array.PackingContext
    {
    };

    public ParkingPositionRelationMapListHeader(
            short numMaps_)
    {
        this.numMaps_ = numMaps_;
    }

    public ParkingPositionRelationMapListHeader(zserio.runtime.io.BitStreamReader in,
            short numMaps_)
    ...
    public ParkingPositionRelationMapListHeader(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in,
            short numMaps_)
            throws java.io.IOException
    {
        this.numMaps_ = numMaps_;
    ...
    public void setAttributeTypeCode(nds.venue.parking.ParkingPositionRelationType[] attributeTypeCode_)
    {
        this.attributeTypeCode_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.EnumRawArray<>(nds.venue.parking.ParkingPositionRelationType.class, attributeTypeCode_),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.venue.parking.ParkingPositionRelationType>(new ZserioElementFactory_attributeTypeCode()),
    ...
    {
        if (obj instanceof ParkingPositionRelationMapListHeader)
        {
            final ParkingPositionRelationMapListHeader that = (ParkingPositionRelationMapListHeader)obj;
    ...
    public void write(zserio.runtime.io.BitStreamWriter out) throws java.io.IOException
    {
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field ParkingPositionRelationMapListHeader.attributeTypeCode: " +
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field ParkingPositionRelationMapListHeader.conditionType: " +
    ...
    private static final class ZserioElementFactory_attributeTypeCode implements zserio.runtime.array.PackableElementFactory<nds.venue.parking.ParkingPositionRelationType>
    {
        @Override
