...
public class ParkingRelationMetadata implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    ...
    public ParkingRelationMetadata()
    {
    }

    public ParkingRelationMetadata(zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        read(in);
    }

    public ParkingRelationMetadata(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        read(context, in);
    }
    ...
    public ParkingRelationMetadata(
            nds.venue.parking.ParkingRelationType[] availableAttributes_,
    ...
    public nds.venue.parking.ParkingRelationType[] getAvailableAttributes()
    {
        return (availableAttributes_ == null) ? null : availableAttributes_.getRawArray();
    }

    public void setAvailableAttributes(nds.venue.parking.ParkingRelationType[] availableAttributes_)
    {
        this.availableAttributes_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.EnumRawArray<>(nds.venue.parking.ParkingRelationType.class, availableAttributes_),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.venue.parking.ParkingRelationType>(new ZserioElementFactory_availableAttributes()),
    ...
    {
        if (obj instanceof ParkingRelationMetadata)
        {
            final ParkingRelationMetadata that = (ParkingRelationMetadata)obj;
            ...
            throws java.io.IOException
    {
        availableAttributes_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.EnumRawArray<>(nds.venue.parking.ParkingRelationType.class),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.venue.parking.ParkingRelationType>(new ZserioElementFactory_availableAttributes()),
                zserio.runtime.array.ArrayType.AUTO);
    ...
    private static final class ZserioElementFactory_availableAttributes implements zserio.runtime.array.PackableElementFactory<nds.venue.parking.ParkingRelationType>
    {
        @Override
        public nds.venue.parking.ParkingRelationType create(zserio.runtime.io.BitStreamReader in, int index)
                throws java.io.IOException
        {
            return nds.venue.parking.ParkingRelationType.readEnum(in);
        }
        ...
        @Override
        public nds.venue.parking.ParkingRelationType create(zserio.runtime.array.PackingContext context,
                zserio.runtime.io.BitStreamReader in, int index) throws java.io.IOException
        {
            return nds.venue.parking.ParkingRelationType.readEnum(context, in);
        }
    }
