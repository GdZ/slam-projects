...
public class ParkingPoiRelationMap implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    ...
    public ParkingPoiRelationMap(
            byte coordShift_)
    {
        this.coordShift_ = coordShift_;
    }

    public ParkingPoiRelationMap(zserio.runtime.io.BitStreamReader in,
            byte coordShift_)
    ...
    public ParkingPoiRelationMap(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in,
            byte coordShift_)
            throws java.io.IOException
    {
        this.coordShift_ = coordShift_;
    ...
    public ParkingPoiRelationMap(
            ...
            int attribute_,
            nds.venue.instantiations.ParkingRelation[] attributeValues_,
    ...
    public void setAttributeTypeCode(nds.venue.parking.ParkingRelationType attributeTypeCode_)
    {
    ...
    public nds.venue.instantiations.ParkingRelation[] getAttributeValues()
    {
        return (attributeValues_ == null) ? null : attributeValues_.getRawArray();
    }

    public void setAttributeValues(nds.venue.instantiations.ParkingRelation[] attributeValues_)
    {
        this.attributeValues_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.ObjectRawArray<>(nds.venue.instantiations.ParkingRelation.class, attributeValues_),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.venue.instantiations.ParkingRelation>(new ZserioElementFactory_attributeValues()),
                zserio.runtime.array.ArrayType.NORMAL);
    }
    ...
    {
        if (obj instanceof ParkingPoiRelationMap)
        {
            final ParkingPoiRelationMap that = (ParkingPoiRelationMap)obj;
    ...
    public void read(zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        attributeTypeCode_ = nds.venue.parking.ParkingRelationType.readEnum(in);
        ...
        attributeValues_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.ObjectRawArray<>(nds.venue.instantiations.ParkingRelation.class),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.venue.instantiations.ParkingRelation>(new ZserioElementFactory_attributeValues()),
                zserio.runtime.array.ArrayType.NORMAL);
    ...
    {
        final ZserioPackingContext zserioContext = context.cast();
        attributeTypeCode_ = nds.venue.parking.ParkingRelationType.readEnum(zserioContext.getAttributeTypeCode(), in);
    ...
    public void write(zserio.runtime.io.BitStreamWriter out) throws java.io.IOException
    {
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field ParkingPoiRelationMap.featureReferences: " +
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field ParkingPoiRelationMap.featureValidities: " +
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field ParkingPoiRelationMap.featureValuePtr: " +
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field ParkingPoiRelationMap.attributeValues: " +
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field ParkingPoiRelationMap.attributeProperties: " +
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field ParkingPoiRelationMap.attributeConditions: " +
    ...
    private final class ZserioElementFactory_attributeValues implements zserio.runtime.array.PackableElementFactory<nds.venue.instantiations.ParkingRelation>
    {
        @Override
        public nds.venue.instantiations.ParkingRelation create(zserio.runtime.io.BitStreamReader in, int index)
                throws java.io.IOException
        {
            return new nds.venue.instantiations.ParkingRelation(in, getAttributeTypeCode());
        }

        @Override
        public zserio.runtime.array.PackingContext createPackingContext()
        {
            return new nds.venue.instantiations.ParkingRelation.ZserioPackingContext();
        }

        @Override
        public nds.venue.instantiations.ParkingRelation create(zserio.runtime.array.PackingContext context,
                zserio.runtime.io.BitStreamReader in, int index) throws java.io.IOException
        {
            return new nds.venue.instantiations.ParkingRelation(context, in, getAttributeTypeCode());
        }
    }
    ...
    private nds.venue.parking.ParkingRelationType attributeTypeCode_;
