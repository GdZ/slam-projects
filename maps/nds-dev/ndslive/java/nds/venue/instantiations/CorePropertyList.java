...
public class CorePropertyList implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    ...
    public CorePropertyList()
    {
    }

    public CorePropertyList(zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        read(in);
    }

    public CorePropertyList(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        read(context, in);
    }
    ...
    public CorePropertyList(
            ...
            nds.venue.instantiations.CoreProperty[] property_)
    {
    ...
    public nds.venue.instantiations.CoreProperty[] getProperty()
    {
        return (property_ == null) ? null : property_.getRawArray();
    }

    public void setProperty(nds.venue.instantiations.CoreProperty[] property_)
    {
        if (property_ == null)
        {
            this.property_ = null;
        ...
        else
        {
            this.property_ = new zserio.runtime.array.Array(
                    new zserio.runtime.array.RawArray.ObjectRawArray<>(nds.venue.instantiations.CoreProperty.class, property_),
                    new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.venue.instantiations.CoreProperty>(new ZserioElementFactory_property()),
    ...
    {
        if (obj instanceof CorePropertyList)
        {
            final CorePropertyList that = (CorePropertyList)obj;
            ...
            throws java.io.IOException
    {
        ...
        if (getNumProperties() > 0)
        {
            property_ = new zserio.runtime.array.Array(
                    new zserio.runtime.array.RawArray.ObjectRawArray<>(nds.venue.instantiations.CoreProperty.class),
                    new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.venue.instantiations.CoreProperty>(new ZserioElementFactory_property()),
                    zserio.runtime.array.ArrayType.NORMAL);
    ...
    public void write(zserio.runtime.io.BitStreamWriter out) throws java.io.IOException
    {
        ...
        if (isPropertyUsed())
        {
            ...
            {
                throw new zserio.runtime.ZserioError("Write: Wrong array length for field CorePropertyList.property: " +
    ...
    private static final class ZserioElementFactory_property implements zserio.runtime.array.PackableElementFactory<nds.venue.instantiations.CoreProperty>
    {
        @Override
        public nds.venue.instantiations.CoreProperty create(zserio.runtime.io.BitStreamReader in, int index)
                throws java.io.IOException
        {
            return new nds.venue.instantiations.CoreProperty(in);
        }

        @Override
        public zserio.runtime.array.PackingContext createPackingContext()
        {
            return new nds.venue.instantiations.CoreProperty.ZserioPackingContext();
        }

        @Override
        public nds.venue.instantiations.CoreProperty create(zserio.runtime.array.PackingContext context,
                zserio.runtime.io.BitStreamReader in, int index) throws java.io.IOException
        {
            return new nds.venue.instantiations.CoreProperty(context, in);
        }
    }
