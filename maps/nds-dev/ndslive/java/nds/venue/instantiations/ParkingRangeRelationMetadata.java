...
public class ParkingRangeRelationMetadata implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    ...
    public ParkingRangeRelationMetadata()
    {
    }

    public ParkingRangeRelationMetadata(zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        read(in);
    }

    public ParkingRangeRelationMetadata(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        read(context, in);
    }
    ...
    public ParkingRangeRelationMetadata(
            nds.venue.parking.ParkingRangeRelationType[] availableAttributes_,
    ...
    public nds.venue.parking.ParkingRangeRelationType[] getAvailableAttributes()
    {
        return (availableAttributes_ == null) ? null : availableAttributes_.getRawArray();
    }

    public void setAvailableAttributes(nds.venue.parking.ParkingRangeRelationType[] availableAttributes_)
    {
        this.availableAttributes_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.EnumRawArray<>(nds.venue.parking.ParkingRangeRelationType.class, availableAttributes_),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.venue.parking.ParkingRangeRelationType>(new ZserioElementFactory_availableAttributes()),
    ...
    {
        if (obj instanceof ParkingRangeRelationMetadata)
        {
            final ParkingRangeRelationMetadata that = (ParkingRangeRelationMetadata)obj;
            ...
            throws java.io.IOException
    {
        availableAttributes_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.EnumRawArray<>(nds.venue.parking.ParkingRangeRelationType.class),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.venue.parking.ParkingRangeRelationType>(new ZserioElementFactory_availableAttributes()),
                zserio.runtime.array.ArrayType.AUTO);
    ...
    private static final class ZserioElementFactory_availableAttributes implements zserio.runtime.array.PackableElementFactory<nds.venue.parking.ParkingRangeRelationType>
    {
        @Override
        public nds.venue.parking.ParkingRangeRelationType create(zserio.runtime.io.BitStreamReader in, int index)
                throws java.io.IOException
        {
            return nds.venue.parking.ParkingRangeRelationType.readEnum(in);
        }
        ...
        @Override
        public nds.venue.parking.ParkingRangeRelationType create(zserio.runtime.array.PackingContext context,
                zserio.runtime.io.BitStreamReader in, int index) throws java.io.IOException
        {
            return nds.venue.parking.ParkingRangeRelationType.readEnum(context, in);
        }
    }
