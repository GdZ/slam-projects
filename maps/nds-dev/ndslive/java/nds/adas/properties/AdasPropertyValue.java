...
public class AdasPropertyValue implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    public static final class ZserioPackingContext extends zserio.runtime.array.PackingContext
    {
        public ZserioPackingContext()
        {
            value_ = new nds.adas.properties.PropertyValue.ZserioPackingContext();
            coreValue_ = new nds.core.properties.CorePropertyValue.ZserioPackingContext();
        }

        public nds.adas.properties.PropertyValue.ZserioPackingContext getValue()
        {
            return value_;
        }
        ...
        private nds.adas.properties.PropertyValue.ZserioPackingContext value_;
        private nds.core.properties.CorePropertyValue.ZserioPackingContext coreValue_;
    };

    public AdasPropertyValue(
            nds.adas.properties.AdasPropertyType type_)
    {
        this.type_ = type_;
    }

    public AdasPropertyValue(zserio.runtime.io.BitStreamReader in,
            nds.adas.properties.AdasPropertyType type_)
    ...
    public AdasPropertyValue(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in,
            nds.adas.properties.AdasPropertyType type_)
            throws java.io.IOException
    {
        this.type_ = type_;
    ...
    public AdasPropertyValue(
            nds.adas.properties.AdasPropertyType type_,
            nds.adas.properties.PropertyValue value_,
    ...
    public nds.adas.properties.AdasPropertyType getType()
    {
        return this.type_;
    }

    public nds.adas.properties.PropertyValue getValue()
    {
        return value_;
    }

    public void setValue(nds.adas.properties.PropertyValue value_)
    {
        this.value_ = value_;
    }
    ...
    {
        if (obj instanceof AdasPropertyValue)
        {
            final AdasPropertyValue that = (AdasPropertyValue)obj;
            ...
            throws java.io.IOException
    {
        ...
        {
            value_ = new nds.adas.properties.PropertyValue(in, getType().getType());
        }
            ...
            throws java.io.IOException
    {
        ...
        if (getType().getType() != nds.adas.properties.PropertyType.CORE)
        {
            value_ = new nds.adas.properties.PropertyValue(zserioContext.getValue(), in, getType().getType());
        }
    ...
    public void write(zserio.runtime.io.BitStreamWriter out) throws java.io.IOException
    {
        if (isValueUsed())
        {
            ...
            {
                throw new zserio.runtime.ZserioError("Write: Inconsistent parameter type for field AdasPropertyValue.value!");
            }
            value_.write(out);
        }
        ...
        if (isCoreValueUsed())
        {
            ...
            {
                throw new zserio.runtime.ZserioError("Write: Inconsistent parameter type for field AdasPropertyValue.coreValue!");
            }
    ...
    private final nds.adas.properties.AdasPropertyType type_;
    private nds.adas.properties.PropertyValue value_;
