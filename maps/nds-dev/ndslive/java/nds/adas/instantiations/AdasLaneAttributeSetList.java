...
public class AdasLaneAttributeSetList implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    ...
    public AdasLaneAttributeSetList(
            byte coordShift_)
    {
        this.coordShift_ = coordShift_;
    }

    public AdasLaneAttributeSetList(zserio.runtime.io.BitStreamReader in,
            byte coordShift_)
    ...
    public AdasLaneAttributeSetList(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in,
            byte coordShift_)
            throws java.io.IOException
    {
        this.coordShift_ = coordShift_;
    ...
    public AdasLaneAttributeSetList(
            ...
            nds.adas.instantiations.AdasLaneAttributeSetMap[] sets_)
    {
        this(coordShift_);
    ...
    public nds.adas.instantiations.AdasLaneAttributeSetMap[] getSets()
    {
        return (sets_ == null) ? null : sets_.getRawArray();
    }

    public void setSets(nds.adas.instantiations.AdasLaneAttributeSetMap[] sets_)
    {
        this.sets_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.ObjectRawArray<>(nds.adas.instantiations.AdasLaneAttributeSetMap.class, sets_),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.adas.instantiations.AdasLaneAttributeSetMap>(new ZserioElementFactory_sets()),
    ...
    {
        if (obj instanceof AdasLaneAttributeSetList)
        {
            final AdasLaneAttributeSetList that = (AdasLaneAttributeSetList)obj;
            ...
            throws java.io.IOException
    {
        ...
        sets_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.ObjectRawArray<>(nds.adas.instantiations.AdasLaneAttributeSetMap.class),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.adas.instantiations.AdasLaneAttributeSetMap>(new ZserioElementFactory_sets()),
                zserio.runtime.array.ArrayType.NORMAL);
    ...
    public void write(zserio.runtime.io.BitStreamWriter out) throws java.io.IOException
    {
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field AdasLaneAttributeSetList.sets: " +
    ...
    private final class ZserioElementFactory_sets implements zserio.runtime.array.PackableElementFactory<nds.adas.instantiations.AdasLaneAttributeSetMap>
    {
        @Override
        public nds.adas.instantiations.AdasLaneAttributeSetMap create(zserio.runtime.io.BitStreamReader in, int index)
                throws java.io.IOException
        {
            return new nds.adas.instantiations.AdasLaneAttributeSetMap(in, (byte)(getCoordShift()));
        }

        @Override
        public zserio.runtime.array.PackingContext createPackingContext()
        {
            return new nds.adas.instantiations.AdasLaneAttributeSetMap.ZserioPackingContext();
        }

        @Override
        public nds.adas.instantiations.AdasLaneAttributeSetMap create(zserio.runtime.array.PackingContext context,
                zserio.runtime.io.BitStreamReader in, int index) throws java.io.IOException
        {
            return new nds.adas.instantiations.AdasLaneAttributeSetMap(context, in, (byte)(getCoordShift()));
        }
    }
