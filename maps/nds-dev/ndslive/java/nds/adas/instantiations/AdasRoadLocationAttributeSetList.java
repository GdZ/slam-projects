...
public class AdasRoadLocationAttributeSetList implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    ...
    public AdasRoadLocationAttributeSetList(
            byte coordShift_)
    {
        this.coordShift_ = coordShift_;
    }

    public AdasRoadLocationAttributeSetList(zserio.runtime.io.BitStreamReader in,
            byte coordShift_)
    ...
    public AdasRoadLocationAttributeSetList(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in,
            byte coordShift_)
            throws java.io.IOException
    {
        this.coordShift_ = coordShift_;
    ...
    public AdasRoadLocationAttributeSetList(
            ...
            nds.adas.instantiations.AdasRoadLocationAttributeSetMap[] sets_)
    {
        this(coordShift_);
    ...
    public nds.adas.instantiations.AdasRoadLocationAttributeSetMap[] getSets()
    {
        return (sets_ == null) ? null : sets_.getRawArray();
    }

    public void setSets(nds.adas.instantiations.AdasRoadLocationAttributeSetMap[] sets_)
    {
        this.sets_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.ObjectRawArray<>(nds.adas.instantiations.AdasRoadLocationAttributeSetMap.class, sets_),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.adas.instantiations.AdasRoadLocationAttributeSetMap>(new ZserioElementFactory_sets()),
    ...
    {
        if (obj instanceof AdasRoadLocationAttributeSetList)
        {
            final AdasRoadLocationAttributeSetList that = (AdasRoadLocationAttributeSetList)obj;
            ...
            throws java.io.IOException
    {
        ...
        sets_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.ObjectRawArray<>(nds.adas.instantiations.AdasRoadLocationAttributeSetMap.class),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.adas.instantiations.AdasRoadLocationAttributeSetMap>(new ZserioElementFactory_sets()),
                zserio.runtime.array.ArrayType.NORMAL);
    ...
    public void write(zserio.runtime.io.BitStreamWriter out) throws java.io.IOException
    {
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field AdasRoadLocationAttributeSetList.sets: " +
    ...
    private final class ZserioElementFactory_sets implements zserio.runtime.array.PackableElementFactory<nds.adas.instantiations.AdasRoadLocationAttributeSetMap>
    {
        @Override
        public nds.adas.instantiations.AdasRoadLocationAttributeSetMap create(zserio.runtime.io.BitStreamReader in, int index)
                throws java.io.IOException
        {
            return new nds.adas.instantiations.AdasRoadLocationAttributeSetMap(in, (byte)(getCoordShift()));
        }

        @Override
        public zserio.runtime.array.PackingContext createPackingContext()
        {
            return new nds.adas.instantiations.AdasRoadLocationAttributeSetMap.ZserioPackingContext();
        }

        @Override
        public nds.adas.instantiations.AdasRoadLocationAttributeSetMap create(zserio.runtime.array.PackingContext context,
                zserio.runtime.io.BitStreamReader in, int index) throws java.io.IOException
        {
            return new nds.adas.instantiations.AdasRoadLocationAttributeSetMap(context, in, (byte)(getCoordShift()));
        }
    }
