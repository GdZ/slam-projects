...
public class AdasRoadFullAttribute implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    public static final class ZserioPackingContext extends zserio.runtime.array.PackingContext
    {
        public ZserioPackingContext()
        {
            ...
            attributeValue_ = new nds.adas.attributes.AdasRoadAttributeValue.ZserioPackingContext();
        ...
        public nds.adas.attributes.AdasRoadAttributeValue.ZserioPackingContext getAttributeValue()
        {
        ...
        private nds.adas.attributes.AdasRoadAttributeValue.ZserioPackingContext attributeValue_;
    ...
    public AdasRoadFullAttribute()
    {
    }

    public AdasRoadFullAttribute(zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        read(in);
    }

    public AdasRoadFullAttribute(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        read(context, in);
    }
    ...
    public AdasRoadFullAttribute(
            ...
            nds.adas.attributes.AdasRoadAttributeValue attributeValue_,
    ...
    public nds.adas.attributes.AdasRoadAttributeValue getAttributeValue()
    {
        return attributeValue_;
    }

    public void setAttributeValue(nds.adas.attributes.AdasRoadAttributeValue attributeValue_)
    {
    ...
    {
        if (obj instanceof AdasRoadFullAttribute)
        {
            final AdasRoadFullAttribute that = (AdasRoadFullAttribute)obj;
            ...
            throws java.io.IOException
    {
        ...
        attributeValue_ = new nds.adas.attributes.AdasRoadAttributeValue(in, getAttributeTypeCode());
            ...
            throws java.io.IOException
    {
        ...
        attributeValue_ = new nds.adas.attributes.AdasRoadAttributeValue(zserioContext.getAttributeValue(), in, getAttributeTypeCode());
    ...
    public void write(zserio.runtime.io.BitStreamWriter out) throws java.io.IOException
    {
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Inconsistent parameter type for field AdasRoadFullAttribute.attributeValue!");
        }
    ...
    private nds.adas.attributes.AdasRoadAttributeValue attributeValue_;
