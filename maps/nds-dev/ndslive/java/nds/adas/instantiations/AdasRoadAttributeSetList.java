...
public class AdasRoadAttributeSetList implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    ...
    public AdasRoadAttributeSetList(
            byte coordShift_)
    {
        this.coordShift_ = coordShift_;
    }

    public AdasRoadAttributeSetList(zserio.runtime.io.BitStreamReader in,
            byte coordShift_)
    ...
    public AdasRoadAttributeSetList(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in,
            byte coordShift_)
            throws java.io.IOException
    {
        this.coordShift_ = coordShift_;
    ...
    public AdasRoadAttributeSetList(
            ...
            nds.adas.instantiations.AdasRoadAttributeSetMap[] sets_)
    {
        this(coordShift_);
    ...
    public nds.adas.instantiations.AdasRoadAttributeSetMap[] getSets()
    {
        return (sets_ == null) ? null : sets_.getRawArray();
    }

    public void setSets(nds.adas.instantiations.AdasRoadAttributeSetMap[] sets_)
    {
        this.sets_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.ObjectRawArray<>(nds.adas.instantiations.AdasRoadAttributeSetMap.class, sets_),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.adas.instantiations.AdasRoadAttributeSetMap>(new ZserioElementFactory_sets()),
    ...
    {
        if (obj instanceof AdasRoadAttributeSetList)
        {
            final AdasRoadAttributeSetList that = (AdasRoadAttributeSetList)obj;
            ...
            throws java.io.IOException
    {
        ...
        sets_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.ObjectRawArray<>(nds.adas.instantiations.AdasRoadAttributeSetMap.class),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.adas.instantiations.AdasRoadAttributeSetMap>(new ZserioElementFactory_sets()),
                zserio.runtime.array.ArrayType.NORMAL);
    ...
    public void write(zserio.runtime.io.BitStreamWriter out) throws java.io.IOException
    {
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field AdasRoadAttributeSetList.sets: " +
    ...
    private final class ZserioElementFactory_sets implements zserio.runtime.array.PackableElementFactory<nds.adas.instantiations.AdasRoadAttributeSetMap>
    {
        @Override
        public nds.adas.instantiations.AdasRoadAttributeSetMap create(zserio.runtime.io.BitStreamReader in, int index)
                throws java.io.IOException
        {
            return new nds.adas.instantiations.AdasRoadAttributeSetMap(in, (byte)(getCoordShift()));
        }

        @Override
        public zserio.runtime.array.PackingContext createPackingContext()
        {
            return new nds.adas.instantiations.AdasRoadAttributeSetMap.ZserioPackingContext();
        }

        @Override
        public nds.adas.instantiations.AdasRoadAttributeSetMap create(zserio.runtime.array.PackingContext context,
                zserio.runtime.io.BitStreamReader in, int index) throws java.io.IOException
        {
            return new nds.adas.instantiations.AdasRoadAttributeSetMap(context, in, (byte)(getCoordShift()));
        }
    }
