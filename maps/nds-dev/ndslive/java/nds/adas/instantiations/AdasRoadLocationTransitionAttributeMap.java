...
public class AdasRoadLocationTransitionAttributeMap implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    ...
    public AdasRoadLocationTransitionAttributeMap(
            byte coordShift_)
    {
        this.coordShift_ = coordShift_;
    }

    public AdasRoadLocationTransitionAttributeMap(zserio.runtime.io.BitStreamReader in,
            byte coordShift_)
    ...
    public AdasRoadLocationTransitionAttributeMap(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in,
            byte coordShift_)
            throws java.io.IOException
    {
        this.coordShift_ = coordShift_;
    ...
    public AdasRoadLocationTransitionAttributeMap(
            ...
            int feature_,
            nds.road.reference.location.RoadLocationTransitionReference[] featureReferences_,
            nds.core.attributemap.Validity[] featureValidities_,
            int[] featureValuePtr_,
            int attribute_,
            nds.adas.instantiations.AdasTransitionAttribute[] attributeValues_,
    ...
    public void setAttributeTypeCode(nds.adas.attributes.AdasTransitionAttributeType attributeTypeCode_)
    {
    ...
    public nds.road.reference.location.RoadLocationTransitionReference[] getFeatureReferences()
    {
        return (featureReferences_ == null) ? null : featureReferences_.getRawArray();
    }

    public void setFeatureReferences(nds.road.reference.location.RoadLocationTransitionReference[] featureReferences_)
    {
        this.featureReferences_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.ObjectRawArray<>(nds.road.reference.location.RoadLocationTransitionReference.class, featureReferences_),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.road.reference.location.RoadLocationTransitionReference>(new ZserioElementFactory_featureReferences()),
    ...
    public nds.adas.instantiations.AdasTransitionAttribute[] getAttributeValues()
    {
        return (attributeValues_ == null) ? null : attributeValues_.getRawArray();
    }

    public void setAttributeValues(nds.adas.instantiations.AdasTransitionAttribute[] attributeValues_)
    {
        this.attributeValues_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.ObjectRawArray<>(nds.adas.instantiations.AdasTransitionAttribute.class, attributeValues_),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.adas.instantiations.AdasTransitionAttribute>(new ZserioElementFactory_attributeValues()),
                zserio.runtime.array.ArrayType.NORMAL);
    }
    ...
    {
        if (obj instanceof AdasRoadLocationTransitionAttributeMap)
        {
            final AdasRoadLocationTransitionAttributeMap that = (AdasRoadLocationTransitionAttributeMap)obj;
    ...
    public void read(zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        attributeTypeCode_ = nds.adas.attributes.AdasTransitionAttributeType.readEnum(in);

        in.alignTo(8);
        feature_ = in.readVarSize();

        featureReferences_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.ObjectRawArray<>(nds.road.reference.location.RoadLocationTransitionReference.class),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.road.reference.location.RoadLocationTransitionReference>(new ZserioElementFactory_featureReferences()),
                zserio.runtime.array.ArrayType.NORMAL);
        ...
        attributeValues_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.ObjectRawArray<>(nds.adas.instantiations.AdasTransitionAttribute.class),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.adas.instantiations.AdasTransitionAttribute>(new ZserioElementFactory_attributeValues()),
                zserio.runtime.array.ArrayType.NORMAL);
    ...
    {
        final ZserioPackingContext zserioContext = context.cast();
        attributeTypeCode_ = nds.adas.attributes.AdasTransitionAttributeType.readEnum(zserioContext.getAttributeTypeCode(), in);
    ...
    public void write(zserio.runtime.io.BitStreamWriter out) throws java.io.IOException
    {
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field AdasRoadLocationTransitionAttributeMap.featureReferences: " +
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field AdasRoadLocationTransitionAttributeMap.featureValidities: " +
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field AdasRoadLocationTransitionAttributeMap.featureValuePtr: " +
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field AdasRoadLocationTransitionAttributeMap.attributeValues: " +
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field AdasRoadLocationTransitionAttributeMap.attributeProperties: " +
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field AdasRoadLocationTransitionAttributeMap.attributeConditions: " +
    ...
    private static final class ZserioElementFactory_featureReferences implements zserio.runtime.array.PackableElementFactory<nds.road.reference.location.RoadLocationTransitionReference>
    {
        @Override
        public nds.road.reference.location.RoadLocationTransitionReference create(zserio.runtime.io.BitStreamReader in, int index)
                throws java.io.IOException
        {
            return new nds.road.reference.location.RoadLocationTransitionReference(in);
        }

        @Override
        public zserio.runtime.array.PackingContext createPackingContext()
        {
            return new nds.road.reference.location.RoadLocationTransitionReference.ZserioPackingContext();
        }

        @Override
        public nds.road.reference.location.RoadLocationTransitionReference create(zserio.runtime.array.PackingContext context,
                zserio.runtime.io.BitStreamReader in, int index) throws java.io.IOException
        {
            return new nds.road.reference.location.RoadLocationTransitionReference(context, in);
        }
    }
    ...
    private final class ZserioElementFactory_attributeValues implements zserio.runtime.array.PackableElementFactory<nds.adas.instantiations.AdasTransitionAttribute>
    {
        @Override
        public nds.adas.instantiations.AdasTransitionAttribute create(zserio.runtime.io.BitStreamReader in, int index)
                throws java.io.IOException
        {
            return new nds.adas.instantiations.AdasTransitionAttribute(in, getAttributeTypeCode());
        }

        @Override
        public zserio.runtime.array.PackingContext createPackingContext()
        {
            return new nds.adas.instantiations.AdasTransitionAttribute.ZserioPackingContext();
        }

        @Override
        public nds.adas.instantiations.AdasTransitionAttribute create(zserio.runtime.array.PackingContext context,
                zserio.runtime.io.BitStreamReader in, int index) throws java.io.IOException
        {
            return new nds.adas.instantiations.AdasTransitionAttribute(context, in, getAttributeTypeCode());
        }
    }
    ...
    private nds.adas.attributes.AdasTransitionAttributeType attributeTypeCode_;
