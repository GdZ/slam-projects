...
public class AdasTransitionAttributeMetadata implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    ...
    public AdasTransitionAttributeMetadata()
    {
    }

    public AdasTransitionAttributeMetadata(zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        read(in);
    }

    public AdasTransitionAttributeMetadata(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        read(context, in);
    }
    ...
    public AdasTransitionAttributeMetadata(
            nds.adas.attributes.AdasTransitionAttributeType[] availableAttributes_,
    ...
    public nds.adas.attributes.AdasTransitionAttributeType[] getAvailableAttributes()
    {
        return (availableAttributes_ == null) ? null : availableAttributes_.getRawArray();
    }

    public void setAvailableAttributes(nds.adas.attributes.AdasTransitionAttributeType[] availableAttributes_)
    {
        this.availableAttributes_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.EnumRawArray<>(nds.adas.attributes.AdasTransitionAttributeType.class, availableAttributes_),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.adas.attributes.AdasTransitionAttributeType>(new ZserioElementFactory_availableAttributes()),
    ...
    {
        if (obj instanceof AdasTransitionAttributeMetadata)
        {
            final AdasTransitionAttributeMetadata that = (AdasTransitionAttributeMetadata)obj;
    ...
    private static final class ZserioElementFactory_availableAttributes implements zserio.runtime.array.PackableElementFactory<nds.adas.attributes.AdasTransitionAttributeType>
    {
        @Override
