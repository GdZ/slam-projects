...
public class AdasPropertyList implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    ...
    public AdasPropertyList()
    {
    }

    public AdasPropertyList(zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        read(in);
    }

    public AdasPropertyList(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        read(context, in);
    }
    ...
    public AdasPropertyList(
            ...
            nds.adas.instantiations.AdasProperty[] property_)
    {
    ...
    public nds.adas.instantiations.AdasProperty[] getProperty()
    {
        return (property_ == null) ? null : property_.getRawArray();
    }

    public void setProperty(nds.adas.instantiations.AdasProperty[] property_)
    {
        if (property_ == null)
        {
            this.property_ = null;
        ...
        else
        {
            this.property_ = new zserio.runtime.array.Array(
                    new zserio.runtime.array.RawArray.ObjectRawArray<>(nds.adas.instantiations.AdasProperty.class, property_),
                    new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.adas.instantiations.AdasProperty>(new ZserioElementFactory_property()),
    ...
    {
        if (obj instanceof AdasPropertyList)
        {
            final AdasPropertyList that = (AdasPropertyList)obj;
            ...
            throws java.io.IOException
    {
        ...
        if (getNumProperties() > 0)
        {
            property_ = new zserio.runtime.array.Array(
                    new zserio.runtime.array.RawArray.ObjectRawArray<>(nds.adas.instantiations.AdasProperty.class),
                    new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.adas.instantiations.AdasProperty>(new ZserioElementFactory_property()),
                    zserio.runtime.array.ArrayType.NORMAL);
    ...
    public void write(zserio.runtime.io.BitStreamWriter out) throws java.io.IOException
    {
        ...
        if (isPropertyUsed())
        {
            ...
            {
                throw new zserio.runtime.ZserioError("Write: Wrong array length for field AdasPropertyList.property: " +
    ...
    private static final class ZserioElementFactory_property implements zserio.runtime.array.PackableElementFactory<nds.adas.instantiations.AdasProperty>
    {
        @Override
        public nds.adas.instantiations.AdasProperty create(zserio.runtime.io.BitStreamReader in, int index)
                throws java.io.IOException
        {
            return new nds.adas.instantiations.AdasProperty(in);
        }

        @Override
        public zserio.runtime.array.PackingContext createPackingContext()
        {
            return new nds.adas.instantiations.AdasProperty.ZserioPackingContext();
        }

        @Override
        public nds.adas.instantiations.AdasProperty create(zserio.runtime.array.PackingContext context,
                zserio.runtime.io.BitStreamReader in, int index) throws java.io.IOException
        {
            return new nds.adas.instantiations.AdasProperty(context, in);
        }
    }
