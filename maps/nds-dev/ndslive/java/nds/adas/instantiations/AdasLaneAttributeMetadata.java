...
public class AdasLaneAttributeMetadata implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    ...
    public AdasLaneAttributeMetadata()
    {
    }

    public AdasLaneAttributeMetadata(zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        read(in);
    }

    public AdasLaneAttributeMetadata(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        read(context, in);
    }
    ...
    public AdasLaneAttributeMetadata(
            nds.adas.attributes.AdasLaneAttributeType[] availableAttributes_,
    ...
    public nds.adas.attributes.AdasLaneAttributeType[] getAvailableAttributes()
    {
        return (availableAttributes_ == null) ? null : availableAttributes_.getRawArray();
    }

    public void setAvailableAttributes(nds.adas.attributes.AdasLaneAttributeType[] availableAttributes_)
    {
        this.availableAttributes_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.EnumRawArray<>(nds.adas.attributes.AdasLaneAttributeType.class, availableAttributes_),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.adas.attributes.AdasLaneAttributeType>(new ZserioElementFactory_availableAttributes()),
    ...
    {
        if (obj instanceof AdasLaneAttributeMetadata)
        {
            final AdasLaneAttributeMetadata that = (AdasLaneAttributeMetadata)obj;
    ...
    private static final class ZserioElementFactory_availableAttributes implements zserio.runtime.array.PackableElementFactory<nds.adas.attributes.AdasLaneAttributeType>
    {
        @Override
