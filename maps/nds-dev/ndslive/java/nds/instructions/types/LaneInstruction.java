...
public class LaneInstruction implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    ...
    public LaneInstruction()
    {
    }

    public LaneInstruction(zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        read(in);
    }

    public LaneInstruction(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        read(context, in);
    }
    ...
    public LaneInstruction(
            int numScenes_,
            nds.instructions.types.LaneInstructionScene[] scenes_,
    ...
    public nds.instructions.types.LaneInstructionScene[] getScenes()
    {
        return (scenes_ == null) ? null : scenes_.getRawArray();
    }

    public void setScenes(nds.instructions.types.LaneInstructionScene[] scenes_)
    {
        this.scenes_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.ObjectRawArray<>(nds.instructions.types.LaneInstructionScene.class, scenes_),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.instructions.types.LaneInstructionScene>(new ZserioElementFactory_scenes()),
    ...
    public boolean equals(java.lang.Object obj)
    {
        ...
        {
            final LaneInstruction that = (LaneInstruction)obj;
            ...
            throws java.io.IOException
    {
        ...
        scenes_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.ObjectRawArray<>(nds.instructions.types.LaneInstructionScene.class),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.instructions.types.LaneInstructionScene>(new ZserioElementFactory_scenes()),
                zserio.runtime.array.ArrayType.NORMAL);
        ...
        positions_ = new zserio.runtime.array.Array(
                ...
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.core.types.PercentagePosition>(new ZserioElementFactory_positions()),
                zserio.runtime.array.ArrayType.NORMAL);
        positions_.read(in, (int)(getNumScenes()));
    }
    ...
    public void write(zserio.runtime.io.BitStreamWriter out) throws java.io.IOException
    {
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field LaneInstruction.scenes: " +
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field LaneInstruction.positions: " +
    ...
    private static final class ZserioElementFactory_scenes implements zserio.runtime.array.PackableElementFactory<nds.instructions.types.LaneInstructionScene>
    {
        @Override
        public nds.instructions.types.LaneInstructionScene create(zserio.runtime.io.BitStreamReader in, int index)
                throws java.io.IOException
        {
            return new nds.instructions.types.LaneInstructionScene(in);
        }

        @Override
        public zserio.runtime.array.PackingContext createPackingContext()
        {
            return new nds.instructions.types.LaneInstructionScene.ZserioPackingContext();
        }

        @Override
        public nds.instructions.types.LaneInstructionScene create(zserio.runtime.array.PackingContext context,
                zserio.runtime.io.BitStreamReader in, int index) throws java.io.IOException
        {
            return new nds.instructions.types.LaneInstructionScene(context, in);
        }
    }
