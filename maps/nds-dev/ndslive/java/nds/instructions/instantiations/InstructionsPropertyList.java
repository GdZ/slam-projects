...
public class InstructionsPropertyList implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    ...
    public InstructionsPropertyList()
    {
    }

    public InstructionsPropertyList(zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        read(in);
    }

    public InstructionsPropertyList(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        read(context, in);
    }
    ...
    public InstructionsPropertyList(
            ...
            nds.instructions.instantiations.InstructionsProperty[] property_)
    {
    ...
    public nds.instructions.instantiations.InstructionsProperty[] getProperty()
    {
        return (property_ == null) ? null : property_.getRawArray();
    }

    public void setProperty(nds.instructions.instantiations.InstructionsProperty[] property_)
    {
        if (property_ == null)
        {
            this.property_ = null;
        ...
        else
        {
            this.property_ = new zserio.runtime.array.Array(
                    new zserio.runtime.array.RawArray.ObjectRawArray<>(nds.instructions.instantiations.InstructionsProperty.class, property_),
                    new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.instructions.instantiations.InstructionsProperty>(new ZserioElementFactory_property()),
    ...
    {
        if (obj instanceof InstructionsPropertyList)
        {
            final InstructionsPropertyList that = (InstructionsPropertyList)obj;
            ...
            throws java.io.IOException
    {
        ...
        if (getNumProperties() > 0)
        {
            property_ = new zserio.runtime.array.Array(
                    new zserio.runtime.array.RawArray.ObjectRawArray<>(nds.instructions.instantiations.InstructionsProperty.class),
                    new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.instructions.instantiations.InstructionsProperty>(new ZserioElementFactory_property()),
                    zserio.runtime.array.ArrayType.NORMAL);
    ...
    public void write(zserio.runtime.io.BitStreamWriter out) throws java.io.IOException
    {
        ...
        if (isPropertyUsed())
        {
            ...
            {
                throw new zserio.runtime.ZserioError("Write: Wrong array length for field InstructionsPropertyList.property: " +
    ...
    private static final class ZserioElementFactory_property implements zserio.runtime.array.PackableElementFactory<nds.instructions.instantiations.InstructionsProperty>
    {
        @Override
        public nds.instructions.instantiations.InstructionsProperty create(zserio.runtime.io.BitStreamReader in, int index)
                throws java.io.IOException
        {
            return new nds.instructions.instantiations.InstructionsProperty(in);
        }

        @Override
        public zserio.runtime.array.PackingContext createPackingContext()
        {
            return new nds.instructions.instantiations.InstructionsProperty.ZserioPackingContext();
        }

        @Override
        public nds.instructions.instantiations.InstructionsProperty create(zserio.runtime.array.PackingContext context,
                zserio.runtime.io.BitStreamReader in, int index) throws java.io.IOException
        {
            return new nds.instructions.instantiations.InstructionsProperty(context, in);
        }
    }
