...
public class InstructionsLaneTransitionFullAttribute implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    public static final class ZserioPackingContext extends zserio.runtime.array.PackingContext
    {
        public ZserioPackingContext()
        {
            ...
            attributeValue_ = new nds.instructions.attributes.InstructionsLaneTransitionAttributeValue.ZserioPackingContext();
        ...
        public nds.instructions.attributes.InstructionsLaneTransitionAttributeValue.ZserioPackingContext getAttributeValue()
        {
        ...
        private nds.instructions.attributes.InstructionsLaneTransitionAttributeValue.ZserioPackingContext attributeValue_;
    ...
    public InstructionsLaneTransitionFullAttribute()
    {
    }

    public InstructionsLaneTransitionFullAttribute(zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        read(in);
    }

    public InstructionsLaneTransitionFullAttribute(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        read(context, in);
    }
    ...
    public InstructionsLaneTransitionFullAttribute(
            ...
            nds.instructions.attributes.InstructionsLaneTransitionAttributeValue attributeValue_,
    ...
    public nds.instructions.attributes.InstructionsLaneTransitionAttributeValue getAttributeValue()
    {
        return attributeValue_;
    }

    public void setAttributeValue(nds.instructions.attributes.InstructionsLaneTransitionAttributeValue attributeValue_)
    {
    ...
    {
        if (obj instanceof InstructionsLaneTransitionFullAttribute)
        {
            final InstructionsLaneTransitionFullAttribute that = (InstructionsLaneTransitionFullAttribute)obj;
            ...
            throws java.io.IOException
    {
        ...
        attributeValue_ = new nds.instructions.attributes.InstructionsLaneTransitionAttributeValue(in, getAttributeTypeCode());
            ...
            throws java.io.IOException
    {
        ...
        attributeValue_ = new nds.instructions.attributes.InstructionsLaneTransitionAttributeValue(zserioContext.getAttributeValue(), in, getAttributeTypeCode());
    ...
    public void write(zserio.runtime.io.BitStreamWriter out) throws java.io.IOException
    {
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Inconsistent parameter type for field InstructionsLaneTransitionFullAttribute.attributeValue!");
        }
    ...
    private nds.instructions.attributes.InstructionsLaneTransitionAttributeValue attributeValue_;
