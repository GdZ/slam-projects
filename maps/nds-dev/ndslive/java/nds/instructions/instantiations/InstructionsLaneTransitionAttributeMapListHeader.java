...
public class InstructionsLaneTransitionAttributeMapListHeader implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    public static final class ZserioPackingContext extends zserio.runtime.array.PackingContext
    {
    };

    public InstructionsLaneTransitionAttributeMapListHeader(
            short numMaps_)
    {
        this.numMaps_ = numMaps_;
    }

    public InstructionsLaneTransitionAttributeMapListHeader(zserio.runtime.io.BitStreamReader in,
            short numMaps_)
    ...
    public InstructionsLaneTransitionAttributeMapListHeader(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in,
            short numMaps_)
            throws java.io.IOException
    {
        this.numMaps_ = numMaps_;
    ...
    public void setAttributeTypeCode(nds.instructions.attributes.InstructionsLaneTransitionAttributeType[] attributeTypeCode_)
    {
        this.attributeTypeCode_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.EnumRawArray<>(nds.instructions.attributes.InstructionsLaneTransitionAttributeType.class, attributeTypeCode_),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.instructions.attributes.InstructionsLaneTransitionAttributeType>(new ZserioElementFactory_attributeTypeCode()),
    ...
    {
        if (obj instanceof InstructionsLaneTransitionAttributeMapListHeader)
        {
            final InstructionsLaneTransitionAttributeMapListHeader that = (InstructionsLaneTransitionAttributeMapListHeader)obj;
    ...
    public void write(zserio.runtime.io.BitStreamWriter out) throws java.io.IOException
    {
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field InstructionsLaneTransitionAttributeMapListHeader.attributeTypeCode: " +
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field InstructionsLaneTransitionAttributeMapListHeader.conditionType: " +
    ...
    private static final class ZserioElementFactory_attributeTypeCode implements zserio.runtime.array.PackableElementFactory<nds.instructions.attributes.InstructionsLaneTransitionAttributeType>
    {
        @Override
