...
public class InstructionsLaneTransitionAttributeMap implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    ...
    public InstructionsLaneTransitionAttributeMap(
            byte coordShift_)
    {
        this.coordShift_ = coordShift_;
    }

    public InstructionsLaneTransitionAttributeMap(zserio.runtime.io.BitStreamReader in,
            byte coordShift_)
    ...
    public InstructionsLaneTransitionAttributeMap(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in,
            byte coordShift_)
            throws java.io.IOException
    {
        this.coordShift_ = coordShift_;
    ...
    public InstructionsLaneTransitionAttributeMap(
            ...
            int feature_,
            nds.lane.reference.types.LaneGroupTransitionReference[] featureReferences_,
            nds.core.attributemap.Validity[] featureValidities_,
            int[] featureValuePtr_,
            int attribute_,
            nds.instructions.instantiations.InstructionsLaneTransitionAttribute[] attributeValues_,
            nds.instructions.instantiations.InstructionsPropertyList[] attributeProperties_,
    ...
    public nds.instructions.attributes.InstructionsLaneTransitionAttributeType getAttributeTypeCode()
    {
        return attributeTypeCode_;
    }

    public void setAttributeTypeCode(nds.instructions.attributes.InstructionsLaneTransitionAttributeType attributeTypeCode_)
    {
    ...
    public nds.lane.reference.types.LaneGroupTransitionReference[] getFeatureReferences()
    {
        return (featureReferences_ == null) ? null : featureReferences_.getRawArray();
    }

    public void setFeatureReferences(nds.lane.reference.types.LaneGroupTransitionReference[] featureReferences_)
    {
        this.featureReferences_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.ObjectRawArray<>(nds.lane.reference.types.LaneGroupTransitionReference.class, featureReferences_),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.lane.reference.types.LaneGroupTransitionReference>(new ZserioElementFactory_featureReferences()),
    ...
    public nds.instructions.instantiations.InstructionsLaneTransitionAttribute[] getAttributeValues()
    {
        return (attributeValues_ == null) ? null : attributeValues_.getRawArray();
    }

    public void setAttributeValues(nds.instructions.instantiations.InstructionsLaneTransitionAttribute[] attributeValues_)
    {
        this.attributeValues_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.ObjectRawArray<>(nds.instructions.instantiations.InstructionsLaneTransitionAttribute.class, attributeValues_),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.instructions.instantiations.InstructionsLaneTransitionAttribute>(new ZserioElementFactory_attributeValues()),
                zserio.runtime.array.ArrayType.NORMAL);
    }

    public nds.instructions.instantiations.InstructionsPropertyList[] getAttributeProperties()
    {
        return (attributeProperties_ == null) ? null : attributeProperties_.getRawArray();
    }

    public void setAttributeProperties(nds.instructions.instantiations.InstructionsPropertyList[] attributeProperties_)
    {
        this.attributeProperties_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.ObjectRawArray<>(nds.instructions.instantiations.InstructionsPropertyList.class, attributeProperties_),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.instructions.instantiations.InstructionsPropertyList>(new ZserioElementFactory_attributeProperties()),
                zserio.runtime.array.ArrayType.NORMAL);
    }
    ...
    {
        if (obj instanceof InstructionsLaneTransitionAttributeMap)
        {
            final InstructionsLaneTransitionAttributeMap that = (InstructionsLaneTransitionAttributeMap)obj;
    ...
    public void read(zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        attributeTypeCode_ = nds.instructions.attributes.InstructionsLaneTransitionAttributeType.readEnum(in);
        ...
        attributeValues_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.ObjectRawArray<>(nds.instructions.instantiations.InstructionsLaneTransitionAttribute.class),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.instructions.instantiations.InstructionsLaneTransitionAttribute>(new ZserioElementFactory_attributeValues()),
                zserio.runtime.array.ArrayType.NORMAL);
        ...
        attributeProperties_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.ObjectRawArray<>(nds.instructions.instantiations.InstructionsPropertyList.class),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.instructions.instantiations.InstructionsPropertyList>(new ZserioElementFactory_attributeProperties()),
                zserio.runtime.array.ArrayType.NORMAL);
    ...
    {
        final ZserioPackingContext zserioContext = context.cast();
        attributeTypeCode_ = nds.instructions.attributes.InstructionsLaneTransitionAttributeType.readEnum(zserioContext.getAttributeTypeCode(), in);
    ...
    public void write(zserio.runtime.io.BitStreamWriter out) throws java.io.IOException
    {
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field InstructionsLaneTransitionAttributeMap.featureReferences: " +
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field InstructionsLaneTransitionAttributeMap.featureValidities: " +
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field InstructionsLaneTransitionAttributeMap.featureValuePtr: " +
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field InstructionsLaneTransitionAttributeMap.attributeValues: " +
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field InstructionsLaneTransitionAttributeMap.attributeProperties: " +
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field InstructionsLaneTransitionAttributeMap.attributeConditions: " +
    ...
    private static final class ZserioElementFactory_featureReferences implements zserio.runtime.array.PackableElementFactory<nds.lane.reference.types.LaneGroupTransitionReference>
    {
        @Override
    ...
    private final class ZserioElementFactory_attributeValues implements zserio.runtime.array.PackableElementFactory<nds.instructions.instantiations.InstructionsLaneTransitionAttribute>
    {
        @Override
        public nds.instructions.instantiations.InstructionsLaneTransitionAttribute create(zserio.runtime.io.BitStreamReader in, int index)
                throws java.io.IOException
        {
            return new nds.instructions.instantiations.InstructionsLaneTransitionAttribute(in, getAttributeTypeCode());
        }

        @Override
        public zserio.runtime.array.PackingContext createPackingContext()
        {
            return new nds.instructions.instantiations.InstructionsLaneTransitionAttribute.ZserioPackingContext();
        }

        @Override
        public nds.instructions.instantiations.InstructionsLaneTransitionAttribute create(zserio.runtime.array.PackingContext context,
                zserio.runtime.io.BitStreamReader in, int index) throws java.io.IOException
        {
            return new nds.instructions.instantiations.InstructionsLaneTransitionAttribute(context, in, getAttributeTypeCode());
        }
    }

    private static final class ZserioElementFactory_attributeProperties implements zserio.runtime.array.PackableElementFactory<nds.instructions.instantiations.InstructionsPropertyList>
    {
        @Override
        public nds.instructions.instantiations.InstructionsPropertyList create(zserio.runtime.io.BitStreamReader in, int index)
                throws java.io.IOException
        {
            return new nds.instructions.instantiations.InstructionsPropertyList(in);
        }

        @Override
        public zserio.runtime.array.PackingContext createPackingContext()
        {
            return new nds.instructions.instantiations.InstructionsPropertyList.ZserioPackingContext();
        }

        @Override
        public nds.instructions.instantiations.InstructionsPropertyList create(zserio.runtime.array.PackingContext context,
                zserio.runtime.io.BitStreamReader in, int index) throws java.io.IOException
        {
            return new nds.instructions.instantiations.InstructionsPropertyList(context, in);
        }
    }
    ...
    private nds.instructions.attributes.InstructionsLaneTransitionAttributeType attributeTypeCode_;
