...
public class InstructionsTransitionAttributeSetMap implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    public static final class ZserioPackingContext extends zserio.runtime.array.PackingContext
    {
        public ZserioPackingContext()
        {
            attributeSet_ = new nds.instructions.instantiations.InstructionsTransitionAttributeSet.ZserioPackingContext();
            feature_ = new zserio.runtime.array.DeltaContext();
        }

        public nds.instructions.instantiations.InstructionsTransitionAttributeSet.ZserioPackingContext getAttributeSet()
        {
        ...
        private nds.instructions.instantiations.InstructionsTransitionAttributeSet.ZserioPackingContext attributeSet_;
        private zserio.runtime.array.DeltaContext feature_;
    };

    public InstructionsTransitionAttributeSetMap(
            byte coordShift_)
    {
        this.coordShift_ = coordShift_;
    }

    public InstructionsTransitionAttributeSetMap(zserio.runtime.io.BitStreamReader in,
            byte coordShift_)
    ...
    public InstructionsTransitionAttributeSetMap(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in,
            byte coordShift_)
            throws java.io.IOException
    {
        this.coordShift_ = coordShift_;
    ...
    public InstructionsTransitionAttributeSetMap(
            byte coordShift_,
            nds.instructions.instantiations.InstructionsTransitionAttributeSet attributeSet_,
            int feature_,
            nds.road.reference.types.TransitionReference[] references_,
    ...
    public nds.instructions.instantiations.InstructionsTransitionAttributeSet getAttributeSet()
    {
        return attributeSet_;
    }

    public void setAttributeSet(nds.instructions.instantiations.InstructionsTransitionAttributeSet attributeSet_)
    {
    ...
    public nds.road.reference.types.TransitionReference[] getReferences()
    {
        return (references_ == null) ? null : references_.getRawArray();
    }

    public void setReferences(nds.road.reference.types.TransitionReference[] references_)
    {
        this.references_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.ObjectRawArray<>(nds.road.reference.types.TransitionReference.class, references_),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.road.reference.types.TransitionReference>(new ZserioElementFactory_references()),
    ...
    {
        if (obj instanceof InstructionsTransitionAttributeSetMap)
        {
            final InstructionsTransitionAttributeSetMap that = (InstructionsTransitionAttributeSetMap)obj;
    ...
    public void read(zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        attributeSet_ = new nds.instructions.instantiations.InstructionsTransitionAttributeSet(in);
    ...
    {
        final ZserioPackingContext zserioContext = context.cast();
        attributeSet_ = new nds.instructions.instantiations.InstructionsTransitionAttributeSet(zserioContext.getAttributeSet(), in);
    ...
    public void write(zserio.runtime.io.BitStreamWriter out) throws java.io.IOException
    {
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field InstructionsTransitionAttributeSetMap.references: " +
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field InstructionsTransitionAttributeSetMap.validities: " +
    ...
    private static final class ZserioElementFactory_references implements zserio.runtime.array.PackableElementFactory<nds.road.reference.types.TransitionReference>
    {
        @Override
    ...
    private nds.instructions.instantiations.InstructionsTransitionAttributeSet attributeSet_;
