...
public class InstructionsPropertyValue implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    public static final class ZserioPackingContext extends zserio.runtime.array.PackingContext
    {
        public ZserioPackingContext()
        {
            value_ = new nds.instructions.properties.PropertyValue.ZserioPackingContext();
            coreValue_ = new nds.core.properties.CorePropertyValue.ZserioPackingContext();
        }

        public nds.instructions.properties.PropertyValue.ZserioPackingContext getValue()
        {
            return value_;
        }
        ...
        private nds.instructions.properties.PropertyValue.ZserioPackingContext value_;
        private nds.core.properties.CorePropertyValue.ZserioPackingContext coreValue_;
    };

    public InstructionsPropertyValue(
            nds.instructions.properties.InstructionsPropertyType type_)
    {
        this.type_ = type_;
    }

    public InstructionsPropertyValue(zserio.runtime.io.BitStreamReader in,
            nds.instructions.properties.InstructionsPropertyType type_)
    ...
    public InstructionsPropertyValue(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in,
            nds.instructions.properties.InstructionsPropertyType type_)
            throws java.io.IOException
    {
        this.type_ = type_;
    ...
    public InstructionsPropertyValue(
            nds.instructions.properties.InstructionsPropertyType type_,
            nds.instructions.properties.PropertyValue value_,
    ...
    public nds.instructions.properties.InstructionsPropertyType getType()
    {
        return this.type_;
    }

    public nds.instructions.properties.PropertyValue getValue()
    {
        return value_;
    }

    public void setValue(nds.instructions.properties.PropertyValue value_)
    {
        this.value_ = value_;
    }
    ...
    {
        if (obj instanceof InstructionsPropertyValue)
        {
            final InstructionsPropertyValue that = (InstructionsPropertyValue)obj;
            ...
            throws java.io.IOException
    {
        ...
        {
            value_ = new nds.instructions.properties.PropertyValue(in, getType().getType());
        }
            ...
            throws java.io.IOException
    {
        ...
        if (getType().getType() != nds.instructions.properties.PropertyType.CORE)
        {
            value_ = new nds.instructions.properties.PropertyValue(zserioContext.getValue(), in, getType().getType());
        }
    ...
    public void write(zserio.runtime.io.BitStreamWriter out) throws java.io.IOException
    {
        if (isValueUsed())
        {
            ...
            {
                throw new zserio.runtime.ZserioError("Write: Inconsistent parameter type for field InstructionsPropertyValue.value!");
            }
            value_.write(out);
        }
        ...
        if (isCoreValueUsed())
        {
            ...
            {
                throw new zserio.runtime.ZserioError("Write: Inconsistent parameter type for field InstructionsPropertyValue.coreValue!");
            }
    ...
    private final nds.instructions.properties.InstructionsPropertyType type_;
    private nds.instructions.properties.PropertyValue value_;
