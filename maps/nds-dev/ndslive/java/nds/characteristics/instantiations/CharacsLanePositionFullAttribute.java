...
public class CharacsLanePositionFullAttribute implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    public static final class ZserioPackingContext extends zserio.runtime.array.PackingContext
    {
        public ZserioPackingContext()
        {
            ...
            attributeValue_ = new nds.characteristics.attributes.CharacsLanePositionAttributeValue.ZserioPackingContext();
        ...
        public nds.characteristics.attributes.CharacsLanePositionAttributeValue.ZserioPackingContext getAttributeValue()
        {
        ...
        private nds.characteristics.attributes.CharacsLanePositionAttributeValue.ZserioPackingContext attributeValue_;
    ...
    public CharacsLanePositionFullAttribute()
    {
    }

    public CharacsLanePositionFullAttribute(zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        read(in);
    }

    public CharacsLanePositionFullAttribute(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        read(context, in);
    }
    ...
    public CharacsLanePositionFullAttribute(
            ...
            nds.characteristics.attributes.CharacsLanePositionAttributeValue attributeValue_,
    ...
    public nds.characteristics.attributes.CharacsLanePositionAttributeValue getAttributeValue()
    {
        return attributeValue_;
    }

    public void setAttributeValue(nds.characteristics.attributes.CharacsLanePositionAttributeValue attributeValue_)
    {
    ...
    {
        if (obj instanceof CharacsLanePositionFullAttribute)
        {
            final CharacsLanePositionFullAttribute that = (CharacsLanePositionFullAttribute)obj;
            ...
            throws java.io.IOException
    {
        ...
        attributeValue_ = new nds.characteristics.attributes.CharacsLanePositionAttributeValue(in, getAttributeTypeCode());
            ...
            throws java.io.IOException
    {
        ...
        attributeValue_ = new nds.characteristics.attributes.CharacsLanePositionAttributeValue(zserioContext.getAttributeValue(), in, getAttributeTypeCode());
    ...
    public void write(zserio.runtime.io.BitStreamWriter out) throws java.io.IOException
    {
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Inconsistent parameter type for field CharacsLanePositionFullAttribute.attributeValue!");
        }
    ...
    private nds.characteristics.attributes.CharacsLanePositionAttributeValue attributeValue_;
