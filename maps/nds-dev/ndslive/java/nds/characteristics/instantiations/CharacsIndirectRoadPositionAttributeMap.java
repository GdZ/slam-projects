...
public class CharacsIndirectRoadPositionAttributeMap implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    ...
    public CharacsIndirectRoadPositionAttributeMap(
            byte coordShift_)
    {
        this.coordShift_ = coordShift_;
    }

    public CharacsIndirectRoadPositionAttributeMap(zserio.runtime.io.BitStreamReader in,
            byte coordShift_)
    ...
    public CharacsIndirectRoadPositionAttributeMap(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in,
            byte coordShift_)
            throws java.io.IOException
    {
        this.coordShift_ = coordShift_;
    ...
    public CharacsIndirectRoadPositionAttributeMap(
            ...
            int attribute_,
            nds.characteristics.instantiations.CharacsRoadPositionAttribute[] attributeValues_,
    ...
    public void setAttributeTypeCode(nds.characteristics.attributes.CharacsRoadPositionAttributeType attributeTypeCode_)
    {
    ...
    public nds.characteristics.instantiations.CharacsRoadPositionAttribute[] getAttributeValues()
    {
        return (attributeValues_ == null) ? null : attributeValues_.getRawArray();
    }

    public void setAttributeValues(nds.characteristics.instantiations.CharacsRoadPositionAttribute[] attributeValues_)
    {
        this.attributeValues_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.ObjectRawArray<>(nds.characteristics.instantiations.CharacsRoadPositionAttribute.class, attributeValues_),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.characteristics.instantiations.CharacsRoadPositionAttribute>(new ZserioElementFactory_attributeValues()),
                zserio.runtime.array.ArrayType.NORMAL);
    }
    ...
    {
        if (obj instanceof CharacsIndirectRoadPositionAttributeMap)
        {
            final CharacsIndirectRoadPositionAttributeMap that = (CharacsIndirectRoadPositionAttributeMap)obj;
    ...
    public void read(zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        attributeTypeCode_ = nds.characteristics.attributes.CharacsRoadPositionAttributeType.readEnum(in);
        ...
        attributeValues_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.ObjectRawArray<>(nds.characteristics.instantiations.CharacsRoadPositionAttribute.class),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.characteristics.instantiations.CharacsRoadPositionAttribute>(new ZserioElementFactory_attributeValues()),
                zserio.runtime.array.ArrayType.NORMAL);
    ...
    {
        final ZserioPackingContext zserioContext = context.cast();
        attributeTypeCode_ = nds.characteristics.attributes.CharacsRoadPositionAttributeType.readEnum(zserioContext.getAttributeTypeCode(), in);
    ...
    public void write(zserio.runtime.io.BitStreamWriter out) throws java.io.IOException
    {
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field CharacsIndirectRoadPositionAttributeMap.featureReferences: " +
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field CharacsIndirectRoadPositionAttributeMap.featureValidities: " +
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field CharacsIndirectRoadPositionAttributeMap.featureValuePtr: " +
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field CharacsIndirectRoadPositionAttributeMap.attributeValues: " +
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field CharacsIndirectRoadPositionAttributeMap.attributeProperties: " +
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field CharacsIndirectRoadPositionAttributeMap.attributeConditions: " +
    ...
    private final class ZserioElementFactory_attributeValues implements zserio.runtime.array.PackableElementFactory<nds.characteristics.instantiations.CharacsRoadPositionAttribute>
    {
        @Override
        public nds.characteristics.instantiations.CharacsRoadPositionAttribute create(zserio.runtime.io.BitStreamReader in, int index)
                throws java.io.IOException
        {
            return new nds.characteristics.instantiations.CharacsRoadPositionAttribute(in, getAttributeTypeCode());
        }

        @Override
        public zserio.runtime.array.PackingContext createPackingContext()
        {
            return new nds.characteristics.instantiations.CharacsRoadPositionAttribute.ZserioPackingContext();
        }

        @Override
        public nds.characteristics.instantiations.CharacsRoadPositionAttribute create(zserio.runtime.array.PackingContext context,
                zserio.runtime.io.BitStreamReader in, int index) throws java.io.IOException
        {
            return new nds.characteristics.instantiations.CharacsRoadPositionAttribute(context, in, getAttributeTypeCode());
        }
    }
    ...
    private nds.characteristics.attributes.CharacsRoadPositionAttributeType attributeTypeCode_;
