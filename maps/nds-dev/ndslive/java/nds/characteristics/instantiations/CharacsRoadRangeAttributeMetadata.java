...
public class CharacsRoadRangeAttributeMetadata implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    ...
    public CharacsRoadRangeAttributeMetadata()
    {
    }

    public CharacsRoadRangeAttributeMetadata(zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        read(in);
    }

    public CharacsRoadRangeAttributeMetadata(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        read(context, in);
    }
    ...
    public CharacsRoadRangeAttributeMetadata(
            nds.characteristics.attributes.CharacsRoadRangeAttributeType[] availableAttributes_,
    ...
    public nds.characteristics.attributes.CharacsRoadRangeAttributeType[] getAvailableAttributes()
    {
        return (availableAttributes_ == null) ? null : availableAttributes_.getRawArray();
    }

    public void setAvailableAttributes(nds.characteristics.attributes.CharacsRoadRangeAttributeType[] availableAttributes_)
    {
        this.availableAttributes_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.EnumRawArray<>(nds.characteristics.attributes.CharacsRoadRangeAttributeType.class, availableAttributes_),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.characteristics.attributes.CharacsRoadRangeAttributeType>(new ZserioElementFactory_availableAttributes()),
    ...
    {
        if (obj instanceof CharacsRoadRangeAttributeMetadata)
        {
            final CharacsRoadRangeAttributeMetadata that = (CharacsRoadRangeAttributeMetadata)obj;
            ...
            throws java.io.IOException
    {
        availableAttributes_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.EnumRawArray<>(nds.characteristics.attributes.CharacsRoadRangeAttributeType.class),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.characteristics.attributes.CharacsRoadRangeAttributeType>(new ZserioElementFactory_availableAttributes()),
                zserio.runtime.array.ArrayType.AUTO);
    ...
    private static final class ZserioElementFactory_availableAttributes implements zserio.runtime.array.PackableElementFactory<nds.characteristics.attributes.CharacsRoadRangeAttributeType>
    {
        @Override
        public nds.characteristics.attributes.CharacsRoadRangeAttributeType create(zserio.runtime.io.BitStreamReader in, int index)
                throws java.io.IOException
        {
            return nds.characteristics.attributes.CharacsRoadRangeAttributeType.readEnum(in);
        }
        ...
        @Override
        public nds.characteristics.attributes.CharacsRoadRangeAttributeType create(zserio.runtime.array.PackingContext context,
                zserio.runtime.io.BitStreamReader in, int index) throws java.io.IOException
        {
            return nds.characteristics.attributes.CharacsRoadRangeAttributeType.readEnum(context, in);
        }
    }
