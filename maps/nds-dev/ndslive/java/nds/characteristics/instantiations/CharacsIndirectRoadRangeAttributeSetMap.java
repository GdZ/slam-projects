...
public class CharacsIndirectRoadRangeAttributeSetMap implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    ...
    public CharacsIndirectRoadRangeAttributeSetMap(
            byte coordShift_)
    {
        this.coordShift_ = coordShift_;
    }

    public CharacsIndirectRoadRangeAttributeSetMap(zserio.runtime.io.BitStreamReader in,
            byte coordShift_)
    ...
    public CharacsIndirectRoadRangeAttributeSetMap(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in,
            byte coordShift_)
            throws java.io.IOException
    {
        this.coordShift_ = coordShift_;
    ...
    public CharacsIndirectRoadRangeAttributeSetMap(
            ...
            int feature_,
            nds.road.reference.types.RoadReferenceIndirect[] references_,
    ...
    public nds.road.reference.types.RoadReferenceIndirect[] getReferences()
    {
        return (references_ == null) ? null : references_.getRawArray();
    }

    public void setReferences(nds.road.reference.types.RoadReferenceIndirect[] references_)
    {
        this.references_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.ObjectRawArray<>(nds.road.reference.types.RoadReferenceIndirect.class, references_),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.road.reference.types.RoadReferenceIndirect>(new ZserioElementFactory_references()),
    ...
    {
        if (obj instanceof CharacsIndirectRoadRangeAttributeSetMap)
        {
            final CharacsIndirectRoadRangeAttributeSetMap that = (CharacsIndirectRoadRangeAttributeSetMap)obj;
    ...
    public void write(zserio.runtime.io.BitStreamWriter out) throws java.io.IOException
    {
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field CharacsIndirectRoadRangeAttributeSetMap.references: " +
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field CharacsIndirectRoadRangeAttributeSetMap.validities: " +
    ...
    private static final class ZserioElementFactory_references implements zserio.runtime.array.PackableElementFactory<nds.road.reference.types.RoadReferenceIndirect>
    {
        @Override
