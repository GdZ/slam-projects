...
public class CharacsTransitionAttributeSetMap implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    public static final class ZserioPackingContext extends zserio.runtime.array.PackingContext
    {
        public ZserioPackingContext()
        {
            attributeSet_ = new nds.characteristics.instantiations.CharacsTransitionAttributeSet.ZserioPackingContext();
            feature_ = new zserio.runtime.array.DeltaContext();
        }

        public nds.characteristics.instantiations.CharacsTransitionAttributeSet.ZserioPackingContext getAttributeSet()
        {
        ...
        private nds.characteristics.instantiations.CharacsTransitionAttributeSet.ZserioPackingContext attributeSet_;
        private zserio.runtime.array.DeltaContext feature_;
    };

    public CharacsTransitionAttributeSetMap(
            byte coordShift_)
    {
        this.coordShift_ = coordShift_;
    }

    public CharacsTransitionAttributeSetMap(zserio.runtime.io.BitStreamReader in,
            byte coordShift_)
    ...
    public CharacsTransitionAttributeSetMap(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in,
            byte coordShift_)
            throws java.io.IOException
    {
        this.coordShift_ = coordShift_;
    ...
    public CharacsTransitionAttributeSetMap(
            byte coordShift_,
            nds.characteristics.instantiations.CharacsTransitionAttributeSet attributeSet_,
            int feature_,
    ...
    public nds.characteristics.instantiations.CharacsTransitionAttributeSet getAttributeSet()
    {
        return attributeSet_;
    }

    public void setAttributeSet(nds.characteristics.instantiations.CharacsTransitionAttributeSet attributeSet_)
    {
    ...
    {
        if (obj instanceof CharacsTransitionAttributeSetMap)
        {
            final CharacsTransitionAttributeSetMap that = (CharacsTransitionAttributeSetMap)obj;
    ...
    public void read(zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        attributeSet_ = new nds.characteristics.instantiations.CharacsTransitionAttributeSet(in);
    ...
    {
        final ZserioPackingContext zserioContext = context.cast();
        attributeSet_ = new nds.characteristics.instantiations.CharacsTransitionAttributeSet(zserioContext.getAttributeSet(), in);
    ...
    public void write(zserio.runtime.io.BitStreamWriter out) throws java.io.IOException
    {
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field CharacsTransitionAttributeSetMap.references: " +
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field CharacsTransitionAttributeSetMap.validities: " +
    ...
    private nds.characteristics.instantiations.CharacsTransitionAttributeSet attributeSet_;
