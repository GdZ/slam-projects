...
public class CharacsTransitionFullAttribute implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    public static final class ZserioPackingContext extends zserio.runtime.array.PackingContext
    {
        public ZserioPackingContext()
        {
            ...
            attributeValue_ = new nds.characteristics.attributes.CharacsTransitionAttributeValue.ZserioPackingContext();
        ...
        public nds.characteristics.attributes.CharacsTransitionAttributeValue.ZserioPackingContext getAttributeValue()
        {
        ...
        private nds.characteristics.attributes.CharacsTransitionAttributeValue.ZserioPackingContext attributeValue_;
    ...
    public CharacsTransitionFullAttribute()
    {
    }

    public CharacsTransitionFullAttribute(zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        read(in);
    }

    public CharacsTransitionFullAttribute(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        read(context, in);
    }
    ...
    public CharacsTransitionFullAttribute(
            ...
            nds.characteristics.attributes.CharacsTransitionAttributeValue attributeValue_,
    ...
    public nds.characteristics.attributes.CharacsTransitionAttributeValue getAttributeValue()
    {
        return attributeValue_;
    }

    public void setAttributeValue(nds.characteristics.attributes.CharacsTransitionAttributeValue attributeValue_)
    {
    ...
    {
        if (obj instanceof CharacsTransitionFullAttribute)
        {
            final CharacsTransitionFullAttribute that = (CharacsTransitionFullAttribute)obj;
            ...
            throws java.io.IOException
    {
        ...
        attributeValue_ = new nds.characteristics.attributes.CharacsTransitionAttributeValue(in, getAttributeTypeCode());
            ...
            throws java.io.IOException
    {
        ...
        attributeValue_ = new nds.characteristics.attributes.CharacsTransitionAttributeValue(zserioContext.getAttributeValue(), in, getAttributeTypeCode());
    ...
    public void write(zserio.runtime.io.BitStreamWriter out) throws java.io.IOException
    {
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Inconsistent parameter type for field CharacsTransitionFullAttribute.attributeValue!");
        }
    ...
    private nds.characteristics.attributes.CharacsTransitionAttributeValue attributeValue_;
