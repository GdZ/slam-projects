...
public class CharacsRoadRangeFullAttribute implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    public static final class ZserioPackingContext extends zserio.runtime.array.PackingContext
    {
        public ZserioPackingContext()
        {
            ...
            attributeValue_ = new nds.characteristics.attributes.CharacsRoadRangeAttributeValue.ZserioPackingContext();
        ...
        public nds.characteristics.attributes.CharacsRoadRangeAttributeValue.ZserioPackingContext getAttributeValue()
        {
        ...
        private nds.characteristics.attributes.CharacsRoadRangeAttributeValue.ZserioPackingContext attributeValue_;
    ...
    public CharacsRoadRangeFullAttribute()
    {
    }

    public CharacsRoadRangeFullAttribute(zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        read(in);
    }

    public CharacsRoadRangeFullAttribute(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        read(context, in);
    }
    ...
    public CharacsRoadRangeFullAttribute(
            ...
            nds.characteristics.attributes.CharacsRoadRangeAttributeValue attributeValue_,
    ...
    public nds.characteristics.attributes.CharacsRoadRangeAttributeValue getAttributeValue()
    {
        return attributeValue_;
    }

    public void setAttributeValue(nds.characteristics.attributes.CharacsRoadRangeAttributeValue attributeValue_)
    {
    ...
    {
        if (obj instanceof CharacsRoadRangeFullAttribute)
        {
            final CharacsRoadRangeFullAttribute that = (CharacsRoadRangeFullAttribute)obj;
            ...
            throws java.io.IOException
    {
        ...
        attributeValue_ = new nds.characteristics.attributes.CharacsRoadRangeAttributeValue(in, getAttributeTypeCode());
            ...
            throws java.io.IOException
    {
        ...
        attributeValue_ = new nds.characteristics.attributes.CharacsRoadRangeAttributeValue(zserioContext.getAttributeValue(), in, getAttributeTypeCode());
    ...
    public void write(zserio.runtime.io.BitStreamWriter out) throws java.io.IOException
    {
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Inconsistent parameter type for field CharacsRoadRangeFullAttribute.attributeValue!");
        }
    ...
    private nds.characteristics.attributes.CharacsRoadRangeAttributeValue attributeValue_;
