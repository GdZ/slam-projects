...
public class CharacsDisplayLineRangeAttributeSetMap implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    public static final class ZserioPackingContext extends zserio.runtime.array.PackingContext
    {
        public ZserioPackingContext()
        {
            attributeSet_ = new nds.characteristics.instantiations.CharacsDisplayLineRangeAttributeSet.ZserioPackingContext();
            feature_ = new zserio.runtime.array.DeltaContext();
        }

        public nds.characteristics.instantiations.CharacsDisplayLineRangeAttributeSet.ZserioPackingContext getAttributeSet()
        {
        ...
        private nds.characteristics.instantiations.CharacsDisplayLineRangeAttributeSet.ZserioPackingContext attributeSet_;
        private zserio.runtime.array.DeltaContext feature_;
    };

    public CharacsDisplayLineRangeAttributeSetMap(
            byte coordShift_)
    {
        this.coordShift_ = coordShift_;
    }

    public CharacsDisplayLineRangeAttributeSetMap(zserio.runtime.io.BitStreamReader in,
            byte coordShift_)
    ...
    public CharacsDisplayLineRangeAttributeSetMap(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in,
            byte coordShift_)
            throws java.io.IOException
    {
        this.coordShift_ = coordShift_;
    ...
    public CharacsDisplayLineRangeAttributeSetMap(
            byte coordShift_,
            nds.characteristics.instantiations.CharacsDisplayLineRangeAttributeSet attributeSet_,
            int feature_,
            nds.display.reference.types.DisplayLineReference[] references_,
            nds.display.reference.types.DisplayLineRangeValidity[] validities_)
    {
        this(coordShift_);
    ...
    public nds.characteristics.instantiations.CharacsDisplayLineRangeAttributeSet getAttributeSet()
    {
        return attributeSet_;
    }

    public void setAttributeSet(nds.characteristics.instantiations.CharacsDisplayLineRangeAttributeSet attributeSet_)
    {
    ...
    public nds.display.reference.types.DisplayLineReference[] getReferences()
    {
        return (references_ == null) ? null : references_.getRawArray();
    }

    public void setReferences(nds.display.reference.types.DisplayLineReference[] references_)
    {
        this.references_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.ObjectRawArray<>(nds.display.reference.types.DisplayLineReference.class, references_),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.display.reference.types.DisplayLineReference>(new ZserioElementFactory_references()),
                zserio.runtime.array.ArrayType.NORMAL);
    }

    public nds.display.reference.types.DisplayLineRangeValidity[] getValidities()
    {
        return (validities_ == null) ? null : validities_.getRawArray();
    }

    public void setValidities(nds.display.reference.types.DisplayLineRangeValidity[] validities_)
    {
        this.validities_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.ObjectRawArray<>(nds.display.reference.types.DisplayLineRangeValidity.class, validities_),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.display.reference.types.DisplayLineRangeValidity>(new ZserioElementFactory_validities()),
                zserio.runtime.array.ArrayType.NORMAL);
    }
    ...
    {
        if (obj instanceof CharacsDisplayLineRangeAttributeSetMap)
        {
            final CharacsDisplayLineRangeAttributeSetMap that = (CharacsDisplayLineRangeAttributeSetMap)obj;
    ...
    public void read(zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        attributeSet_ = new nds.characteristics.instantiations.CharacsDisplayLineRangeAttributeSet(in);
    ...
    {
        final ZserioPackingContext zserioContext = context.cast();
        attributeSet_ = new nds.characteristics.instantiations.CharacsDisplayLineRangeAttributeSet(zserioContext.getAttributeSet(), in);
    ...
    public void write(zserio.runtime.io.BitStreamWriter out) throws java.io.IOException
    {
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field CharacsDisplayLineRangeAttributeSetMap.references: " +
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field CharacsDisplayLineRangeAttributeSetMap.validities: " +
    ...
    private static final class ZserioElementFactory_references implements zserio.runtime.array.PackableElementFactory<nds.display.reference.types.DisplayLineReference>
    {
        @Override
    ...
    private final class ZserioElementFactory_validities implements zserio.runtime.array.PackableElementFactory<nds.display.reference.types.DisplayLineRangeValidity>
    {
        @Override
    ...
    private nds.characteristics.instantiations.CharacsDisplayLineRangeAttributeSet attributeSet_;
