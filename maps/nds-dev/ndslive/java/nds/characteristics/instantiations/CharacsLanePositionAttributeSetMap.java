...
public class CharacsLanePositionAttributeSetMap implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    public static final class ZserioPackingContext extends zserio.runtime.array.PackingContext
    {
        public ZserioPackingContext()
        {
            attributeSet_ = new nds.characteristics.instantiations.CharacsLanePositionAttributeSet.ZserioPackingContext();
            feature_ = new zserio.runtime.array.DeltaContext();
        }

        public nds.characteristics.instantiations.CharacsLanePositionAttributeSet.ZserioPackingContext getAttributeSet()
        {
        ...
        private nds.characteristics.instantiations.CharacsLanePositionAttributeSet.ZserioPackingContext attributeSet_;
        private zserio.runtime.array.DeltaContext feature_;
    };

    public CharacsLanePositionAttributeSetMap(
            byte coordShift_)
    {
        this.coordShift_ = coordShift_;
    }

    public CharacsLanePositionAttributeSetMap(zserio.runtime.io.BitStreamReader in,
            byte coordShift_)
    ...
    public CharacsLanePositionAttributeSetMap(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in,
            byte coordShift_)
            throws java.io.IOException
    {
        this.coordShift_ = coordShift_;
    ...
    public CharacsLanePositionAttributeSetMap(
            byte coordShift_,
            nds.characteristics.instantiations.CharacsLanePositionAttributeSet attributeSet_,
            int feature_,
            nds.core.types.Var4ByteId[] references_,
            nds.lane.reference.types.LaneGroupPositionValidity[] validities_)
    {
        this(coordShift_);
    ...
    public nds.characteristics.instantiations.CharacsLanePositionAttributeSet getAttributeSet()
    {
        return attributeSet_;
    }

    public void setAttributeSet(nds.characteristics.instantiations.CharacsLanePositionAttributeSet attributeSet_)
    {
    ...
    public nds.lane.reference.types.LaneGroupPositionValidity[] getValidities()
    {
        return (validities_ == null) ? null : validities_.getRawArray();
    }

    public void setValidities(nds.lane.reference.types.LaneGroupPositionValidity[] validities_)
    {
        this.validities_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.ObjectRawArray<>(nds.lane.reference.types.LaneGroupPositionValidity.class, validities_),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.lane.reference.types.LaneGroupPositionValidity>(new ZserioElementFactory_validities()),
                zserio.runtime.array.ArrayType.NORMAL);
    }
    ...
    {
        if (obj instanceof CharacsLanePositionAttributeSetMap)
        {
            final CharacsLanePositionAttributeSetMap that = (CharacsLanePositionAttributeSetMap)obj;
    ...
    public void read(zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        attributeSet_ = new nds.characteristics.instantiations.CharacsLanePositionAttributeSet(in);
    ...
    {
        final ZserioPackingContext zserioContext = context.cast();
        attributeSet_ = new nds.characteristics.instantiations.CharacsLanePositionAttributeSet(zserioContext.getAttributeSet(), in);
    ...
    public void write(zserio.runtime.io.BitStreamWriter out) throws java.io.IOException
    {
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field CharacsLanePositionAttributeSetMap.references: " +
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field CharacsLanePositionAttributeSetMap.validities: " +
    ...
    private final class ZserioElementFactory_validities implements zserio.runtime.array.PackableElementFactory<nds.lane.reference.types.LaneGroupPositionValidity>
    {
        @Override
    ...
    private nds.characteristics.instantiations.CharacsLanePositionAttributeSet attributeSet_;
