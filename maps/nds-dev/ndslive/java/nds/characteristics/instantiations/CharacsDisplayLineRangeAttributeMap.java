...
public class CharacsDisplayLineRangeAttributeMap implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    ...
    public CharacsDisplayLineRangeAttributeMap(
            byte coordShift_)
    {
        this.coordShift_ = coordShift_;
    }

    public CharacsDisplayLineRangeAttributeMap(zserio.runtime.io.BitStreamReader in,
            byte coordShift_)
    ...
    public CharacsDisplayLineRangeAttributeMap(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in,
            byte coordShift_)
            throws java.io.IOException
    {
        this.coordShift_ = coordShift_;
    ...
    public CharacsDisplayLineRangeAttributeMap(
            ...
            int attribute_,
            nds.characteristics.instantiations.CharacsDisplayLineRangeAttribute[] attributeValues_,
    ...
    public nds.characteristics.instantiations.CharacsDisplayLineRangeAttribute[] getAttributeValues()
    {
        return (attributeValues_ == null) ? null : attributeValues_.getRawArray();
    }

    public void setAttributeValues(nds.characteristics.instantiations.CharacsDisplayLineRangeAttribute[] attributeValues_)
    {
        this.attributeValues_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.ObjectRawArray<>(nds.characteristics.instantiations.CharacsDisplayLineRangeAttribute.class, attributeValues_),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.characteristics.instantiations.CharacsDisplayLineRangeAttribute>(new ZserioElementFactory_attributeValues()),
                zserio.runtime.array.ArrayType.NORMAL);
    }
    ...
    {
        if (obj instanceof CharacsDisplayLineRangeAttributeMap)
        {
            final CharacsDisplayLineRangeAttributeMap that = (CharacsDisplayLineRangeAttributeMap)obj;
    ...
    public void read(zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        attributeTypeCode_ = nds.characteristics.attributes.CharacsDisplayLineRangeAttributeType.readEnum(in);
        ...
        attributeValues_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.ObjectRawArray<>(nds.characteristics.instantiations.CharacsDisplayLineRangeAttribute.class),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.characteristics.instantiations.CharacsDisplayLineRangeAttribute>(new ZserioElementFactory_attributeValues()),
                zserio.runtime.array.ArrayType.NORMAL);
    ...
    {
        final ZserioPackingContext zserioContext = context.cast();
        attributeTypeCode_ = nds.characteristics.attributes.CharacsDisplayLineRangeAttributeType.readEnum(zserioContext.getAttributeTypeCode(), in);
    ...
    public void write(zserio.runtime.io.BitStreamWriter out) throws java.io.IOException
    {
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field CharacsDisplayLineRangeAttributeMap.featureReferences: " +
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field CharacsDisplayLineRangeAttributeMap.featureValidities: " +
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field CharacsDisplayLineRangeAttributeMap.featureValuePtr: " +
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field CharacsDisplayLineRangeAttributeMap.attributeValues: " +
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field CharacsDisplayLineRangeAttributeMap.attributeProperties: " +
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field CharacsDisplayLineRangeAttributeMap.attributeConditions: " +
    ...
    private final class ZserioElementFactory_attributeValues implements zserio.runtime.array.PackableElementFactory<nds.characteristics.instantiations.CharacsDisplayLineRangeAttribute>
    {
        @Override
        public nds.characteristics.instantiations.CharacsDisplayLineRangeAttribute create(zserio.runtime.io.BitStreamReader in, int index)
                throws java.io.IOException
        {
            return new nds.characteristics.instantiations.CharacsDisplayLineRangeAttribute(in, getAttributeTypeCode());
        }

        @Override
        public zserio.runtime.array.PackingContext createPackingContext()
        {
            return new nds.characteristics.instantiations.CharacsDisplayLineRangeAttribute.ZserioPackingContext();
        }

        @Override
        public nds.characteristics.instantiations.CharacsDisplayLineRangeAttribute create(zserio.runtime.array.PackingContext context,
                zserio.runtime.io.BitStreamReader in, int index) throws java.io.IOException
        {
            return new nds.characteristics.instantiations.CharacsDisplayLineRangeAttribute(context, in, getAttributeTypeCode());
        }
    }
    ...
    private nds.characteristics.attributes.CharacsDisplayLineRangeAttributeType attributeTypeCode_;
