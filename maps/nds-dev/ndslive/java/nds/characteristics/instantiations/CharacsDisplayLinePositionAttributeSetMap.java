...
public class CharacsDisplayLinePositionAttributeSetMap implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    public static final class ZserioPackingContext extends zserio.runtime.array.PackingContext
    {
        public ZserioPackingContext()
        {
            attributeSet_ = new nds.characteristics.instantiations.CharacsDisplayLinePositionAttributeSet.ZserioPackingContext();
            feature_ = new zserio.runtime.array.DeltaContext();
        }

        public nds.characteristics.instantiations.CharacsDisplayLinePositionAttributeSet.ZserioPackingContext getAttributeSet()
        {
        ...
        private nds.characteristics.instantiations.CharacsDisplayLinePositionAttributeSet.ZserioPackingContext attributeSet_;
        private zserio.runtime.array.DeltaContext feature_;
    };

    public CharacsDisplayLinePositionAttributeSetMap(
            byte coordShift_)
    {
        this.coordShift_ = coordShift_;
    }

    public CharacsDisplayLinePositionAttributeSetMap(zserio.runtime.io.BitStreamReader in,
            byte coordShift_)
    ...
    public CharacsDisplayLinePositionAttributeSetMap(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in,
            byte coordShift_)
            throws java.io.IOException
    {
        this.coordShift_ = coordShift_;
    ...
    public CharacsDisplayLinePositionAttributeSetMap(
            byte coordShift_,
            nds.characteristics.instantiations.CharacsDisplayLinePositionAttributeSet attributeSet_,
            int feature_,
            nds.display.reference.types.DisplayLineReference[] references_,
            nds.display.reference.types.DisplayLinePositionValidity[] validities_)
    {
        this(coordShift_);
    ...
    public nds.characteristics.instantiations.CharacsDisplayLinePositionAttributeSet getAttributeSet()
    {
        return attributeSet_;
    }

    public void setAttributeSet(nds.characteristics.instantiations.CharacsDisplayLinePositionAttributeSet attributeSet_)
    {
    ...
    public nds.display.reference.types.DisplayLinePositionValidity[] getValidities()
    {
        return (validities_ == null) ? null : validities_.getRawArray();
    }

    public void setValidities(nds.display.reference.types.DisplayLinePositionValidity[] validities_)
    {
        this.validities_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.ObjectRawArray<>(nds.display.reference.types.DisplayLinePositionValidity.class, validities_),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.display.reference.types.DisplayLinePositionValidity>(new ZserioElementFactory_validities()),
                zserio.runtime.array.ArrayType.NORMAL);
    }
    ...
    {
        if (obj instanceof CharacsDisplayLinePositionAttributeSetMap)
        {
            final CharacsDisplayLinePositionAttributeSetMap that = (CharacsDisplayLinePositionAttributeSetMap)obj;
    ...
    public void read(zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        attributeSet_ = new nds.characteristics.instantiations.CharacsDisplayLinePositionAttributeSet(in);
    ...
    {
        final ZserioPackingContext zserioContext = context.cast();
        attributeSet_ = new nds.characteristics.instantiations.CharacsDisplayLinePositionAttributeSet(zserioContext.getAttributeSet(), in);
    ...
    public void write(zserio.runtime.io.BitStreamWriter out) throws java.io.IOException
    {
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field CharacsDisplayLinePositionAttributeSetMap.references: " +
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field CharacsDisplayLinePositionAttributeSetMap.validities: " +
    ...
    private final class ZserioElementFactory_validities implements zserio.runtime.array.PackableElementFactory<nds.display.reference.types.DisplayLinePositionValidity>
    {
        @Override
    ...
    private nds.characteristics.instantiations.CharacsDisplayLinePositionAttributeSet attributeSet_;
