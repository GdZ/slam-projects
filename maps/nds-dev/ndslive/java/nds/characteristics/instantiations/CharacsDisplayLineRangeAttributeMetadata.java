...
public class CharacsDisplayLineRangeAttributeMetadata implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    ...
    public CharacsDisplayLineRangeAttributeMetadata()
    {
    }

    public CharacsDisplayLineRangeAttributeMetadata(zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        read(in);
    }

    public CharacsDisplayLineRangeAttributeMetadata(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        read(context, in);
    }
    ...
    public CharacsDisplayLineRangeAttributeMetadata(
            nds.characteristics.attributes.CharacsDisplayLineRangeAttributeType[] availableAttributes_,
    ...
    public nds.characteristics.attributes.CharacsDisplayLineRangeAttributeType[] getAvailableAttributes()
    {
        return (availableAttributes_ == null) ? null : availableAttributes_.getRawArray();
    }

    public void setAvailableAttributes(nds.characteristics.attributes.CharacsDisplayLineRangeAttributeType[] availableAttributes_)
    {
        this.availableAttributes_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.EnumRawArray<>(nds.characteristics.attributes.CharacsDisplayLineRangeAttributeType.class, availableAttributes_),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.characteristics.attributes.CharacsDisplayLineRangeAttributeType>(new ZserioElementFactory_availableAttributes()),
    ...
    {
        if (obj instanceof CharacsDisplayLineRangeAttributeMetadata)
        {
            final CharacsDisplayLineRangeAttributeMetadata that = (CharacsDisplayLineRangeAttributeMetadata)obj;
    ...
    private static final class ZserioElementFactory_availableAttributes implements zserio.runtime.array.PackableElementFactory<nds.characteristics.attributes.CharacsDisplayLineRangeAttributeType>
    {
        @Override
