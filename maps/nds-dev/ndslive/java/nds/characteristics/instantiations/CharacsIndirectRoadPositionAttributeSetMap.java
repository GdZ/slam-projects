...
public class CharacsIndirectRoadPositionAttributeSetMap implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    public static final class ZserioPackingContext extends zserio.runtime.array.PackingContext
    {
        public ZserioPackingContext()
        {
            attributeSet_ = new nds.characteristics.instantiations.CharacsRoadPositionAttributeSet.ZserioPackingContext();
            feature_ = new zserio.runtime.array.DeltaContext();
        }

        public nds.characteristics.instantiations.CharacsRoadPositionAttributeSet.ZserioPackingContext getAttributeSet()
        {
        ...
        private nds.characteristics.instantiations.CharacsRoadPositionAttributeSet.ZserioPackingContext attributeSet_;
        private zserio.runtime.array.DeltaContext feature_;
    };

    public CharacsIndirectRoadPositionAttributeSetMap(
            byte coordShift_)
    {
        this.coordShift_ = coordShift_;
    }

    public CharacsIndirectRoadPositionAttributeSetMap(zserio.runtime.io.BitStreamReader in,
            byte coordShift_)
    ...
    public CharacsIndirectRoadPositionAttributeSetMap(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in,
            byte coordShift_)
            throws java.io.IOException
    {
        this.coordShift_ = coordShift_;
    ...
    public CharacsIndirectRoadPositionAttributeSetMap(
            byte coordShift_,
            nds.characteristics.instantiations.CharacsRoadPositionAttributeSet attributeSet_,
            int feature_,
    ...
    public nds.characteristics.instantiations.CharacsRoadPositionAttributeSet getAttributeSet()
    {
        return attributeSet_;
    }

    public void setAttributeSet(nds.characteristics.instantiations.CharacsRoadPositionAttributeSet attributeSet_)
    {
    ...
    {
        if (obj instanceof CharacsIndirectRoadPositionAttributeSetMap)
        {
            final CharacsIndirectRoadPositionAttributeSetMap that = (CharacsIndirectRoadPositionAttributeSetMap)obj;
    ...
    public void read(zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        attributeSet_ = new nds.characteristics.instantiations.CharacsRoadPositionAttributeSet(in);
    ...
    {
        final ZserioPackingContext zserioContext = context.cast();
        attributeSet_ = new nds.characteristics.instantiations.CharacsRoadPositionAttributeSet(zserioContext.getAttributeSet(), in);
    ...
    public void write(zserio.runtime.io.BitStreamWriter out) throws java.io.IOException
    {
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field CharacsIndirectRoadPositionAttributeSetMap.references: " +
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field CharacsIndirectRoadPositionAttributeSetMap.validities: " +
    ...
    private nds.characteristics.instantiations.CharacsRoadPositionAttributeSet attributeSet_;
