...
public class CharacsPropertyType implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    ...
    public CharacsPropertyType()
    {
    }

    public CharacsPropertyType(zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        read(in);
    }

    public CharacsPropertyType(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        read(context, in);
    }
    ...
    public void setType(nds.characteristics.properties.PropertyType type_)
    {
        this.type_ = type_;
    }
    ...
    {
        if (obj instanceof CharacsPropertyType)
        {
            final CharacsPropertyType that = (CharacsPropertyType)obj;
    ...
    public void read(zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        type_ = nds.characteristics.properties.PropertyType.readEnum(in);
    ...
    {
        final ZserioPackingContext zserioContext = context.cast();
        type_ = nds.characteristics.properties.PropertyType.readEnum(zserioContext.getType(), in);
    ...
    private nds.characteristics.properties.PropertyType type_;
