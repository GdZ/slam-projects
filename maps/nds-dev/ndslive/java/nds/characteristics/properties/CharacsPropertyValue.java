...
public class CharacsPropertyValue implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    public static final class ZserioPackingContext extends zserio.runtime.array.PackingContext
    {
        public ZserioPackingContext()
        {
            value_ = new nds.characteristics.properties.PropertyValue.ZserioPackingContext();
            coreValue_ = new nds.core.properties.CorePropertyValue.ZserioPackingContext();
        }

        public nds.characteristics.properties.PropertyValue.ZserioPackingContext getValue()
        {
            return value_;
        }
        ...
        private nds.characteristics.properties.PropertyValue.ZserioPackingContext value_;
        private nds.core.properties.CorePropertyValue.ZserioPackingContext coreValue_;
    };

    public CharacsPropertyValue(
            nds.characteristics.properties.CharacsPropertyType type_)
    {
        this.type_ = type_;
    }

    public CharacsPropertyValue(zserio.runtime.io.BitStreamReader in,
            nds.characteristics.properties.CharacsPropertyType type_)
    ...
    public CharacsPropertyValue(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in,
            nds.characteristics.properties.CharacsPropertyType type_)
            throws java.io.IOException
    {
        this.type_ = type_;
    ...
    public CharacsPropertyValue(
            nds.characteristics.properties.CharacsPropertyType type_,
            nds.characteristics.properties.PropertyValue value_,
    ...
    public nds.characteristics.properties.CharacsPropertyType getType()
    {
        return this.type_;
    }

    public nds.characteristics.properties.PropertyValue getValue()
    {
        return value_;
    }

    public void setValue(nds.characteristics.properties.PropertyValue value_)
    {
        this.value_ = value_;
    }
    ...
    {
        if (obj instanceof CharacsPropertyValue)
        {
            final CharacsPropertyValue that = (CharacsPropertyValue)obj;
            ...
            throws java.io.IOException
    {
        ...
        {
            value_ = new nds.characteristics.properties.PropertyValue(in, getType().getType());
        }
            ...
            throws java.io.IOException
    {
        ...
        if (getType().getType() != nds.characteristics.properties.PropertyType.CORE)
        {
            value_ = new nds.characteristics.properties.PropertyValue(zserioContext.getValue(), in, getType().getType());
        }
    ...
    public void write(zserio.runtime.io.BitStreamWriter out) throws java.io.IOException
    {
        if (isValueUsed())
        {
            ...
            {
                throw new zserio.runtime.ZserioError("Write: Inconsistent parameter type for field CharacsPropertyValue.value!");
            }
            value_.write(out);
        }
        ...
        if (isCoreValueUsed())
        {
            ...
            {
                throw new zserio.runtime.ZserioError("Write: Inconsistent parameter type for field CharacsPropertyValue.coreValue!");
            }
    ...
    private final nds.characteristics.properties.CharacsPropertyType type_;
    private nds.characteristics.properties.PropertyValue value_;
