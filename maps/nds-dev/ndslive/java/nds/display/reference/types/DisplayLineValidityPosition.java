...
public class DisplayLineValidityPosition implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    ...
    public DisplayLineValidityPosition(
            byte shift_)
    {
        this.shift_ = shift_;
    }

    public DisplayLineValidityPosition(zserio.runtime.io.BitStreamReader in,
            byte shift_)
    ...
    public DisplayLineValidityPosition(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in,
            byte shift_)
            throws java.io.IOException
    {
        this.shift_ = shift_;
    ...
    {
        if (obj instanceof DisplayLineValidityPosition)
        {
            final DisplayLineValidityPosition that = (DisplayLineValidityPosition)obj;
    ...
    public void write(zserio.runtime.io.BitStreamWriter out) throws java.io.IOException
    {
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong parameter shift for field DisplayLineValidityPosition.position: " +
