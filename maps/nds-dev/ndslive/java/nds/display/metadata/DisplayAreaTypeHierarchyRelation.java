...
public class DisplayAreaTypeHierarchyRelation implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    ...
    public DisplayAreaTypeHierarchyRelation()
    {
    }

    public DisplayAreaTypeHierarchyRelation(zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        read(in);
    }

    public DisplayAreaTypeHierarchyRelation(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        read(context, in);
    }
    ...
    public DisplayAreaTypeHierarchyRelation(
            ...
            nds.display.types.DisplayAreaType[] children_)
    {
        setParent(parent_);
    ...
    public nds.display.types.DisplayAreaType getParent()
    {
        return parent_;
    }

    public void setParent(nds.display.types.DisplayAreaType parent_)
    {
        this.parent_ = parent_;
    }

    public nds.display.types.DisplayAreaType[] getChildren()
    {
        return (children_ == null) ? null : children_.getRawArray();
    }

    public void setChildren(nds.display.types.DisplayAreaType[] children_)
    {
        this.children_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.EnumRawArray<>(nds.display.types.DisplayAreaType.class, children_),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.display.types.DisplayAreaType>(new ZserioElementFactory_children()),
    ...
    {
        if (obj instanceof DisplayAreaTypeHierarchyRelation)
        {
            final DisplayAreaTypeHierarchyRelation that = (DisplayAreaTypeHierarchyRelation)obj;
    ...
    public void read(zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        parent_ = nds.display.types.DisplayAreaType.readEnum(in);
    ...
    {
        final ZserioPackingContext zserioContext = context.cast();
        parent_ = nds.display.types.DisplayAreaType.readEnum(zserioContext.getParent(), in);
    ...
    private static final class ZserioElementFactory_children implements zserio.runtime.array.PackableElementFactory<nds.display.types.DisplayAreaType>
    {
        @Override
    ...
    private nds.display.types.DisplayAreaType parent_;
