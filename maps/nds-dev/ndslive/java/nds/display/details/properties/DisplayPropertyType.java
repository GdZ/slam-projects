...
public class DisplayPropertyType implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    ...
    public DisplayPropertyType()
    {
    }

    public DisplayPropertyType(zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        read(in);
    }

    public DisplayPropertyType(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        read(context, in);
    }
    ...
    public nds.display.details.properties.PropertyType getType()
    {
        return type_;
    }

    public void setType(nds.display.details.properties.PropertyType type_)
    {
        this.type_ = type_;
    }
    ...
    {
        if (obj instanceof DisplayPropertyType)
        {
            final DisplayPropertyType that = (DisplayPropertyType)obj;
    ...
    public void read(zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        type_ = nds.display.details.properties.PropertyType.readEnum(in);
    ...
    {
        final ZserioPackingContext zserioContext = context.cast();
        type_ = nds.display.details.properties.PropertyType.readEnum(zserioContext.getType(), in);
    ...
    private nds.display.details.properties.PropertyType type_;
