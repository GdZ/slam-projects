...
public class DisplayPointAttributeSetList implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    ...
    public DisplayPointAttributeSetList(
            byte coordShift_)
    {
        this.coordShift_ = coordShift_;
    }

    public DisplayPointAttributeSetList(zserio.runtime.io.BitStreamReader in,
            byte coordShift_)
    ...
    public DisplayPointAttributeSetList(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in,
            byte coordShift_)
            throws java.io.IOException
    {
        this.coordShift_ = coordShift_;
    ...
    public DisplayPointAttributeSetList(
            ...
            nds.display.details.instantiations.DisplayPointAttributeSetMap[] sets_)
    {
        this(coordShift_);
    ...
    public nds.display.details.instantiations.DisplayPointAttributeSetMap[] getSets()
    {
        return (sets_ == null) ? null : sets_.getRawArray();
    }

    public void setSets(nds.display.details.instantiations.DisplayPointAttributeSetMap[] sets_)
    {
        this.sets_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.ObjectRawArray<>(nds.display.details.instantiations.DisplayPointAttributeSetMap.class, sets_),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.display.details.instantiations.DisplayPointAttributeSetMap>(new ZserioElementFactory_sets()),
    ...
    {
        if (obj instanceof DisplayPointAttributeSetList)
        {
            final DisplayPointAttributeSetList that = (DisplayPointAttributeSetList)obj;
            ...
            throws java.io.IOException
    {
        ...
        sets_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.ObjectRawArray<>(nds.display.details.instantiations.DisplayPointAttributeSetMap.class),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.display.details.instantiations.DisplayPointAttributeSetMap>(new ZserioElementFactory_sets()),
                zserio.runtime.array.ArrayType.NORMAL);
    ...
    public void write(zserio.runtime.io.BitStreamWriter out) throws java.io.IOException
    {
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field DisplayPointAttributeSetList.sets: " +
    ...
    private final class ZserioElementFactory_sets implements zserio.runtime.array.PackableElementFactory<nds.display.details.instantiations.DisplayPointAttributeSetMap>
    {
        @Override
        public nds.display.details.instantiations.DisplayPointAttributeSetMap create(zserio.runtime.io.BitStreamReader in, int index)
                throws java.io.IOException
        {
            return new nds.display.details.instantiations.DisplayPointAttributeSetMap(in, (byte)(getCoordShift()));
        }

        @Override
        public zserio.runtime.array.PackingContext createPackingContext()
        {
            return new nds.display.details.instantiations.DisplayPointAttributeSetMap.ZserioPackingContext();
        }

        @Override
        public nds.display.details.instantiations.DisplayPointAttributeSetMap create(zserio.runtime.array.PackingContext context,
                zserio.runtime.io.BitStreamReader in, int index) throws java.io.IOException
        {
            return new nds.display.details.instantiations.DisplayPointAttributeSetMap(context, in, (byte)(getCoordShift()));
        }
    }
