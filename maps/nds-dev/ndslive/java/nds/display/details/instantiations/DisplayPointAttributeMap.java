...
public class DisplayPointAttributeMap implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    ...
    public DisplayPointAttributeMap(
            byte coordShift_)
    {
        this.coordShift_ = coordShift_;
    }

    public DisplayPointAttributeMap(zserio.runtime.io.BitStreamReader in,
            byte coordShift_)
    ...
    public DisplayPointAttributeMap(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in,
            byte coordShift_)
            throws java.io.IOException
    {
        this.coordShift_ = coordShift_;
    ...
    public DisplayPointAttributeMap(
            ...
            int attribute_,
            nds.display.details.instantiations.DisplayPointAttribute[] attributeValues_,
    ...
    public nds.display.details.attributes.DisplayPointAttributeType getAttributeTypeCode()
    {
        return attributeTypeCode_;
    }

    public void setAttributeTypeCode(nds.display.details.attributes.DisplayPointAttributeType attributeTypeCode_)
    {
    ...
    public nds.display.details.instantiations.DisplayPointAttribute[] getAttributeValues()
    {
        return (attributeValues_ == null) ? null : attributeValues_.getRawArray();
    }

    public void setAttributeValues(nds.display.details.instantiations.DisplayPointAttribute[] attributeValues_)
    {
        this.attributeValues_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.ObjectRawArray<>(nds.display.details.instantiations.DisplayPointAttribute.class, attributeValues_),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.display.details.instantiations.DisplayPointAttribute>(new ZserioElementFactory_attributeValues()),
                zserio.runtime.array.ArrayType.NORMAL);
    }
    ...
    {
        if (obj instanceof DisplayPointAttributeMap)
        {
            final DisplayPointAttributeMap that = (DisplayPointAttributeMap)obj;
    ...
    public void read(zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        attributeTypeCode_ = nds.display.details.attributes.DisplayPointAttributeType.readEnum(in);
        ...
        attributeValues_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.ObjectRawArray<>(nds.display.details.instantiations.DisplayPointAttribute.class),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.display.details.instantiations.DisplayPointAttribute>(new ZserioElementFactory_attributeValues()),
                zserio.runtime.array.ArrayType.NORMAL);
    ...
    {
        final ZserioPackingContext zserioContext = context.cast();
        attributeTypeCode_ = nds.display.details.attributes.DisplayPointAttributeType.readEnum(zserioContext.getAttributeTypeCode(), in);
    ...
    public void write(zserio.runtime.io.BitStreamWriter out) throws java.io.IOException
    {
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field DisplayPointAttributeMap.featureReferences: " +
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field DisplayPointAttributeMap.featureValidities: " +
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field DisplayPointAttributeMap.featureValuePtr: " +
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field DisplayPointAttributeMap.attributeValues: " +
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field DisplayPointAttributeMap.attributeProperties: " +
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field DisplayPointAttributeMap.attributeConditions: " +
    ...
    private final class ZserioElementFactory_attributeValues implements zserio.runtime.array.PackableElementFactory<nds.display.details.instantiations.DisplayPointAttribute>
    {
        @Override
        public nds.display.details.instantiations.DisplayPointAttribute create(zserio.runtime.io.BitStreamReader in, int index)
                throws java.io.IOException
        {
            return new nds.display.details.instantiations.DisplayPointAttribute(in, getAttributeTypeCode());
        }

        @Override
        public zserio.runtime.array.PackingContext createPackingContext()
        {
            return new nds.display.details.instantiations.DisplayPointAttribute.ZserioPackingContext();
        }

        @Override
        public nds.display.details.instantiations.DisplayPointAttribute create(zserio.runtime.array.PackingContext context,
                zserio.runtime.io.BitStreamReader in, int index) throws java.io.IOException
        {
            return new nds.display.details.instantiations.DisplayPointAttribute(context, in, getAttributeTypeCode());
        }
    }
    ...
    private nds.display.details.attributes.DisplayPointAttributeType attributeTypeCode_;
