...
public class DisplayLineAttributeSetList implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    ...
    public DisplayLineAttributeSetList(
            byte coordShift_)
    {
        this.coordShift_ = coordShift_;
    }

    public DisplayLineAttributeSetList(zserio.runtime.io.BitStreamReader in,
            byte coordShift_)
    ...
    public DisplayLineAttributeSetList(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in,
            byte coordShift_)
            throws java.io.IOException
    {
        this.coordShift_ = coordShift_;
    ...
    public DisplayLineAttributeSetList(
            ...
            nds.display.details.instantiations.DisplayLineAttributeSetMap[] sets_)
    {
        this(coordShift_);
    ...
    public nds.display.details.instantiations.DisplayLineAttributeSetMap[] getSets()
    {
        return (sets_ == null) ? null : sets_.getRawArray();
    }

    public void setSets(nds.display.details.instantiations.DisplayLineAttributeSetMap[] sets_)
    {
        this.sets_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.ObjectRawArray<>(nds.display.details.instantiations.DisplayLineAttributeSetMap.class, sets_),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.display.details.instantiations.DisplayLineAttributeSetMap>(new ZserioElementFactory_sets()),
    ...
    {
        if (obj instanceof DisplayLineAttributeSetList)
        {
            final DisplayLineAttributeSetList that = (DisplayLineAttributeSetList)obj;
            ...
            throws java.io.IOException
    {
        ...
        sets_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.ObjectRawArray<>(nds.display.details.instantiations.DisplayLineAttributeSetMap.class),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.display.details.instantiations.DisplayLineAttributeSetMap>(new ZserioElementFactory_sets()),
                zserio.runtime.array.ArrayType.NORMAL);
    ...
    public void write(zserio.runtime.io.BitStreamWriter out) throws java.io.IOException
    {
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field DisplayLineAttributeSetList.sets: " +
    ...
    private final class ZserioElementFactory_sets implements zserio.runtime.array.PackableElementFactory<nds.display.details.instantiations.DisplayLineAttributeSetMap>
    {
        @Override
        public nds.display.details.instantiations.DisplayLineAttributeSetMap create(zserio.runtime.io.BitStreamReader in, int index)
                throws java.io.IOException
        {
            return new nds.display.details.instantiations.DisplayLineAttributeSetMap(in, (byte)(getCoordShift()));
        }

        @Override
        public zserio.runtime.array.PackingContext createPackingContext()
        {
            return new nds.display.details.instantiations.DisplayLineAttributeSetMap.ZserioPackingContext();
        }

        @Override
        public nds.display.details.instantiations.DisplayLineAttributeSetMap create(zserio.runtime.array.PackingContext context,
                zserio.runtime.io.BitStreamReader in, int index) throws java.io.IOException
        {
            return new nds.display.details.instantiations.DisplayLineAttributeSetMap(context, in, (byte)(getCoordShift()));
        }
    }
