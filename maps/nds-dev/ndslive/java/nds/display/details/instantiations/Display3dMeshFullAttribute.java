...
public class Display3dMeshFullAttribute implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    public static final class ZserioPackingContext extends zserio.runtime.array.PackingContext
    {
        public ZserioPackingContext()
        {
            ...
            properties_ = new nds.display.details.instantiations.DisplayPropertyList.ZserioPackingContext();
        ...
        public nds.display.details.instantiations.DisplayPropertyList.ZserioPackingContext getProperties()
        {
            return properties_;
        }
        ...
        private nds.display.details.instantiations.DisplayPropertyList.ZserioPackingContext properties_;
        private nds.core.attributemap.ConditionList.ZserioPackingContext conditions_;
    };

    public Display3dMeshFullAttribute()
    {
    }

    public Display3dMeshFullAttribute(zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        read(in);
    }

    public Display3dMeshFullAttribute(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        read(context, in);
    }
    ...
    public Display3dMeshFullAttribute(
            ...
            nds.display.details.instantiations.DisplayPropertyList properties_,
    ...
    public nds.display.details.instantiations.DisplayPropertyList getProperties()
    {
        return properties_;
    }

    public void setProperties(nds.display.details.instantiations.DisplayPropertyList properties_)
    {
    ...
    {
        if (obj instanceof Display3dMeshFullAttribute)
        {
            final Display3dMeshFullAttribute that = (Display3dMeshFullAttribute)obj;
            ...
            throws java.io.IOException
    {
        ...
        if (in.readBool())
        {
            properties_ = new nds.display.details.instantiations.DisplayPropertyList(in);
        }
            ...
            throws java.io.IOException
    {
        ...
        if (in.readBool())
        {
            properties_ = new nds.display.details.instantiations.DisplayPropertyList(zserioContext.getProperties(), in);
        }
    ...
    public void write(zserio.runtime.io.BitStreamWriter out) throws java.io.IOException
    {
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Inconsistent parameter type for field Display3dMeshFullAttribute.attributeValue!");
        }
    ...
    private nds.display.details.instantiations.DisplayPropertyList properties_;
