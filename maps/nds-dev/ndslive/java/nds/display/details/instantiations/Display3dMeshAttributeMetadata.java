...
public class Display3dMeshAttributeMetadata implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    ...
    public Display3dMeshAttributeMetadata()
    {
    }

    public Display3dMeshAttributeMetadata(zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        read(in);
    }

    public Display3dMeshAttributeMetadata(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        read(context, in);
    }
    ...
    public Display3dMeshAttributeMetadata(
            nds.display.details.attributes.Display3dMeshAttributeType[] availableAttributes_,
            nds.display.details.properties.DisplayPropertyType[] availableProperties_,
    ...
    public nds.display.details.attributes.Display3dMeshAttributeType[] getAvailableAttributes()
    {
        return (availableAttributes_ == null) ? null : availableAttributes_.getRawArray();
    }

    public void setAvailableAttributes(nds.display.details.attributes.Display3dMeshAttributeType[] availableAttributes_)
    {
        this.availableAttributes_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.EnumRawArray<>(nds.display.details.attributes.Display3dMeshAttributeType.class, availableAttributes_),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.display.details.attributes.Display3dMeshAttributeType>(new ZserioElementFactory_availableAttributes()),
                zserio.runtime.array.ArrayType.AUTO);
    }

    public nds.display.details.properties.DisplayPropertyType[] getAvailableProperties()
    {
        return (availableProperties_ == null) ? null : availableProperties_.getRawArray();
    }

    public void setAvailableProperties(nds.display.details.properties.DisplayPropertyType[] availableProperties_)
    {
        this.availableProperties_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.ObjectRawArray<>(nds.display.details.properties.DisplayPropertyType.class, availableProperties_),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.display.details.properties.DisplayPropertyType>(new ZserioElementFactory_availableProperties()),
                zserio.runtime.array.ArrayType.AUTO);
    }
    ...
    {
        if (obj instanceof Display3dMeshAttributeMetadata)
        {
            final Display3dMeshAttributeMetadata that = (Display3dMeshAttributeMetadata)obj;
            ...
            throws java.io.IOException
    {
        ...
        availableProperties_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.ObjectRawArray<>(nds.display.details.properties.DisplayPropertyType.class),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.display.details.properties.DisplayPropertyType>(new ZserioElementFactory_availableProperties()),
                zserio.runtime.array.ArrayType.AUTO);
    ...
    private static final class ZserioElementFactory_availableAttributes implements zserio.runtime.array.PackableElementFactory<nds.display.details.attributes.Display3dMeshAttributeType>
    {
        @Override
    ...
    private static final class ZserioElementFactory_availableProperties implements zserio.runtime.array.PackableElementFactory<nds.display.details.properties.DisplayPropertyType>
    {
        @Override
        public nds.display.details.properties.DisplayPropertyType create(zserio.runtime.io.BitStreamReader in, int index)
                throws java.io.IOException
        {
            return new nds.display.details.properties.DisplayPropertyType(in);
        }

        @Override
        public zserio.runtime.array.PackingContext createPackingContext()
        {
            return new nds.display.details.properties.DisplayPropertyType.ZserioPackingContext();
        }

        @Override
        public nds.display.details.properties.DisplayPropertyType create(zserio.runtime.array.PackingContext context,
                zserio.runtime.io.BitStreamReader in, int index) throws java.io.IOException
        {
            return new nds.display.details.properties.DisplayPropertyType(context, in);
        }
    }
