...
public class DisplayPointAttributeMetadata implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    ...
    public DisplayPointAttributeMetadata()
    {
    }

    public DisplayPointAttributeMetadata(zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        read(in);
    }

    public DisplayPointAttributeMetadata(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        read(context, in);
    }
    ...
    public DisplayPointAttributeMetadata(
            nds.display.details.attributes.DisplayPointAttributeType[] availableAttributes_,
    ...
    public nds.display.details.attributes.DisplayPointAttributeType[] getAvailableAttributes()
    {
        return (availableAttributes_ == null) ? null : availableAttributes_.getRawArray();
    }

    public void setAvailableAttributes(nds.display.details.attributes.DisplayPointAttributeType[] availableAttributes_)
    {
        this.availableAttributes_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.EnumRawArray<>(nds.display.details.attributes.DisplayPointAttributeType.class, availableAttributes_),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.display.details.attributes.DisplayPointAttributeType>(new ZserioElementFactory_availableAttributes()),
    ...
    {
        if (obj instanceof DisplayPointAttributeMetadata)
        {
            final DisplayPointAttributeMetadata that = (DisplayPointAttributeMetadata)obj;
            ...
            throws java.io.IOException
    {
        availableAttributes_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.EnumRawArray<>(nds.display.details.attributes.DisplayPointAttributeType.class),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.display.details.attributes.DisplayPointAttributeType>(new ZserioElementFactory_availableAttributes()),
                zserio.runtime.array.ArrayType.AUTO);
    ...
    private static final class ZserioElementFactory_availableAttributes implements zserio.runtime.array.PackableElementFactory<nds.display.details.attributes.DisplayPointAttributeType>
    {
        @Override
        public nds.display.details.attributes.DisplayPointAttributeType create(zserio.runtime.io.BitStreamReader in, int index)
                throws java.io.IOException
        {
            return nds.display.details.attributes.DisplayPointAttributeType.readEnum(in);
        }
        ...
        @Override
        public nds.display.details.attributes.DisplayPointAttributeType create(zserio.runtime.array.PackingContext context,
                zserio.runtime.io.BitStreamReader in, int index) throws java.io.IOException
        {
            return nds.display.details.attributes.DisplayPointAttributeType.readEnum(context, in);
        }
    }
