...
public class Display3dMeshAttributeSetList implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    ...
    public Display3dMeshAttributeSetList(
            byte coordShift_)
    {
        this.coordShift_ = coordShift_;
    }

    public Display3dMeshAttributeSetList(zserio.runtime.io.BitStreamReader in,
            byte coordShift_)
    ...
    public Display3dMeshAttributeSetList(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in,
            byte coordShift_)
            throws java.io.IOException
    {
        this.coordShift_ = coordShift_;
    ...
    public Display3dMeshAttributeSetList(
            ...
            nds.display.details.instantiations.Display3dMeshAttributeSetMap[] sets_)
    {
        this(coordShift_);
    ...
    public nds.display.details.instantiations.Display3dMeshAttributeSetMap[] getSets()
    {
        return (sets_ == null) ? null : sets_.getRawArray();
    }

    public void setSets(nds.display.details.instantiations.Display3dMeshAttributeSetMap[] sets_)
    {
        this.sets_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.ObjectRawArray<>(nds.display.details.instantiations.Display3dMeshAttributeSetMap.class, sets_),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.display.details.instantiations.Display3dMeshAttributeSetMap>(new ZserioElementFactory_sets()),
    ...
    {
        if (obj instanceof Display3dMeshAttributeSetList)
        {
            final Display3dMeshAttributeSetList that = (Display3dMeshAttributeSetList)obj;
            ...
            throws java.io.IOException
    {
        ...
        sets_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.ObjectRawArray<>(nds.display.details.instantiations.Display3dMeshAttributeSetMap.class),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.display.details.instantiations.Display3dMeshAttributeSetMap>(new ZserioElementFactory_sets()),
                zserio.runtime.array.ArrayType.NORMAL);
    ...
    public void write(zserio.runtime.io.BitStreamWriter out) throws java.io.IOException
    {
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field Display3dMeshAttributeSetList.sets: " +
    ...
    private final class ZserioElementFactory_sets implements zserio.runtime.array.PackableElementFactory<nds.display.details.instantiations.Display3dMeshAttributeSetMap>
    {
        @Override
        public nds.display.details.instantiations.Display3dMeshAttributeSetMap create(zserio.runtime.io.BitStreamReader in, int index)
                throws java.io.IOException
        {
            return new nds.display.details.instantiations.Display3dMeshAttributeSetMap(in, (byte)(getCoordShift()));
        }

        @Override
        public zserio.runtime.array.PackingContext createPackingContext()
        {
            return new nds.display.details.instantiations.Display3dMeshAttributeSetMap.ZserioPackingContext();
        }

        @Override
        public nds.display.details.instantiations.Display3dMeshAttributeSetMap create(zserio.runtime.array.PackingContext context,
                zserio.runtime.io.BitStreamReader in, int index) throws java.io.IOException
        {
            return new nds.display.details.instantiations.Display3dMeshAttributeSetMap(context, in, (byte)(getCoordShift()));
        }
    }
