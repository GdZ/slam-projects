...
public class DisplayAreaAttributeMetadata implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    ...
    public DisplayAreaAttributeMetadata()
    {
    }

    public DisplayAreaAttributeMetadata(zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        read(in);
    }

    public DisplayAreaAttributeMetadata(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        read(context, in);
    }
    ...
    public DisplayAreaAttributeMetadata(
            nds.display.details.attributes.DisplayAreaAttributeType[] availableAttributes_,
    ...
    public nds.display.details.attributes.DisplayAreaAttributeType[] getAvailableAttributes()
    {
        return (availableAttributes_ == null) ? null : availableAttributes_.getRawArray();
    }

    public void setAvailableAttributes(nds.display.details.attributes.DisplayAreaAttributeType[] availableAttributes_)
    {
        this.availableAttributes_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.EnumRawArray<>(nds.display.details.attributes.DisplayAreaAttributeType.class, availableAttributes_),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.display.details.attributes.DisplayAreaAttributeType>(new ZserioElementFactory_availableAttributes()),
    ...
    {
        if (obj instanceof DisplayAreaAttributeMetadata)
        {
            final DisplayAreaAttributeMetadata that = (DisplayAreaAttributeMetadata)obj;
    ...
    private static final class ZserioElementFactory_availableAttributes implements zserio.runtime.array.PackableElementFactory<nds.display.details.attributes.DisplayAreaAttributeType>
    {
        @Override
