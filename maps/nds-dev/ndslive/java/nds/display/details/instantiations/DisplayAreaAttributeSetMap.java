...
public class DisplayAreaAttributeSetMap implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    public static final class ZserioPackingContext extends zserio.runtime.array.PackingContext
    {
        public ZserioPackingContext()
        {
            attributeSet_ = new nds.display.details.instantiations.DisplayAreaAttributeSet.ZserioPackingContext();
            feature_ = new zserio.runtime.array.DeltaContext();
        }

        public nds.display.details.instantiations.DisplayAreaAttributeSet.ZserioPackingContext getAttributeSet()
        {
        ...
        private nds.display.details.instantiations.DisplayAreaAttributeSet.ZserioPackingContext attributeSet_;
        private zserio.runtime.array.DeltaContext feature_;
    };

    public DisplayAreaAttributeSetMap(
            byte coordShift_)
    {
        this.coordShift_ = coordShift_;
    }

    public DisplayAreaAttributeSetMap(zserio.runtime.io.BitStreamReader in,
            byte coordShift_)
    ...
    public DisplayAreaAttributeSetMap(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in,
            byte coordShift_)
            throws java.io.IOException
    {
        this.coordShift_ = coordShift_;
    ...
    public DisplayAreaAttributeSetMap(
            byte coordShift_,
            nds.display.details.instantiations.DisplayAreaAttributeSet attributeSet_,
            int feature_,
            nds.core.types.Var4ByteId[] references_,
            nds.display.reference.types.DisplayAreaValidity[] validities_)
    {
        this(coordShift_);
    ...
    public nds.display.details.instantiations.DisplayAreaAttributeSet getAttributeSet()
    {
        return attributeSet_;
    }

    public void setAttributeSet(nds.display.details.instantiations.DisplayAreaAttributeSet attributeSet_)
    {
    ...
    public nds.display.reference.types.DisplayAreaValidity[] getValidities()
    {
        return (validities_ == null) ? null : validities_.getRawArray();
    }

    public void setValidities(nds.display.reference.types.DisplayAreaValidity[] validities_)
    {
        this.validities_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.ObjectRawArray<>(nds.display.reference.types.DisplayAreaValidity.class, validities_),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.display.reference.types.DisplayAreaValidity>(new ZserioElementFactory_validities()),
                zserio.runtime.array.ArrayType.NORMAL);
    }
    ...
    {
        if (obj instanceof DisplayAreaAttributeSetMap)
        {
            final DisplayAreaAttributeSetMap that = (DisplayAreaAttributeSetMap)obj;
    ...
    public void read(zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        attributeSet_ = new nds.display.details.instantiations.DisplayAreaAttributeSet(in);
    ...
    {
        final ZserioPackingContext zserioContext = context.cast();
        attributeSet_ = new nds.display.details.instantiations.DisplayAreaAttributeSet(zserioContext.getAttributeSet(), in);
    ...
    public void write(zserio.runtime.io.BitStreamWriter out) throws java.io.IOException
    {
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field DisplayAreaAttributeSetMap.references: " +
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field DisplayAreaAttributeSetMap.validities: " +
    ...
    private final class ZserioElementFactory_validities implements zserio.runtime.array.PackableElementFactory<nds.display.reference.types.DisplayAreaValidity>
    {
        @Override
    ...
    private nds.display.details.instantiations.DisplayAreaAttributeSet attributeSet_;
