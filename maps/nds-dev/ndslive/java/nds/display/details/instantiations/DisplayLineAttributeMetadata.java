...
public class DisplayLineAttributeMetadata implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    ...
    public DisplayLineAttributeMetadata()
    {
    }

    public DisplayLineAttributeMetadata(zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        read(in);
    }

    public DisplayLineAttributeMetadata(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        read(context, in);
    }
    ...
    public DisplayLineAttributeMetadata(
            nds.display.details.attributes.DisplayLineAttributeType[] availableAttributes_,
    ...
    public nds.display.details.attributes.DisplayLineAttributeType[] getAvailableAttributes()
    {
        return (availableAttributes_ == null) ? null : availableAttributes_.getRawArray();
    }

    public void setAvailableAttributes(nds.display.details.attributes.DisplayLineAttributeType[] availableAttributes_)
    {
        this.availableAttributes_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.EnumRawArray<>(nds.display.details.attributes.DisplayLineAttributeType.class, availableAttributes_),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.display.details.attributes.DisplayLineAttributeType>(new ZserioElementFactory_availableAttributes()),
    ...
    {
        if (obj instanceof DisplayLineAttributeMetadata)
        {
            final DisplayLineAttributeMetadata that = (DisplayLineAttributeMetadata)obj;
            ...
            throws java.io.IOException
    {
        availableAttributes_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.EnumRawArray<>(nds.display.details.attributes.DisplayLineAttributeType.class),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.display.details.attributes.DisplayLineAttributeType>(new ZserioElementFactory_availableAttributes()),
                zserio.runtime.array.ArrayType.AUTO);
    ...
    private static final class ZserioElementFactory_availableAttributes implements zserio.runtime.array.PackableElementFactory<nds.display.details.attributes.DisplayLineAttributeType>
    {
        @Override
        public nds.display.details.attributes.DisplayLineAttributeType create(zserio.runtime.io.BitStreamReader in, int index)
                throws java.io.IOException
        {
            return nds.display.details.attributes.DisplayLineAttributeType.readEnum(in);
        }
        ...
        @Override
        public nds.display.details.attributes.DisplayLineAttributeType create(zserio.runtime.array.PackingContext context,
                zserio.runtime.io.BitStreamReader in, int index) throws java.io.IOException
        {
            return nds.display.details.attributes.DisplayLineAttributeType.readEnum(context, in);
        }
    }
