...
public class PointDisplayGeometryLayer implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    ...
    public PointDisplayGeometryLayer(
    ...
    public PointDisplayGeometryLayer(zserio.runtime.io.BitStreamReader in,
            nds.core.geometry.GeometryLayerType type_,
            boolean hasIds_,
            boolean hasTypes_)
    ...
    public PointDisplayGeometryLayer(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in,
            nds.core.geometry.GeometryLayerType type_,
            boolean hasIds_,
            boolean hasTypes_)
            throws java.io.IOException
    ...
    public PointDisplayGeometryLayer(
            ...
            nds.display.types.DisplayPointType[] types_,
    ...
    public nds.display.types.DisplayPointType[] getTypes()
    {
        return (types_ == null) ? null : types_.getRawArray();
    }

    public void setTypes(nds.display.types.DisplayPointType[] types_)
    {
        if (types_ == null)
        {
            this.types_ = null;
        ...
        else
        {
            this.types_ = new zserio.runtime.array.Array(
                    new zserio.runtime.array.RawArray.EnumRawArray<>(nds.display.types.DisplayPointType.class, types_),
                    new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.display.types.DisplayPointType>(new ZserioElementFactory_types()),
                    zserio.runtime.array.ArrayType.NORMAL);
        }
    }
    ...
    {
        if (obj instanceof PointDisplayGeometryLayer)
        {
            final PointDisplayGeometryLayer that = (PointDisplayGeometryLayer)obj;
    ...
    public void write(zserio.runtime.io.BitStreamWriter out) throws java.io.IOException
    {
        ...
        if (isIdentifierUsed())
        {
            ...
            {
                throw new zserio.runtime.ZserioError("Write: Wrong array length for field PointDisplayGeometryLayer.identifier: " +
        ...
        if (isTypesUsed())
        {
            ...
            {
                throw new zserio.runtime.ZserioError("Write: Wrong array length for field PointDisplayGeometryLayer.types: " +
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Inconsistent parameter type for field PointDisplayGeometryLayer.buffers!");
        }
        if (buffers_.getShiftXY() != (byte)(getCoordShiftXY()))
        {
            throw new zserio.runtime.ZserioError("Write: Wrong parameter shiftXY for field PointDisplayGeometryLayer.buffers: " +
                    buffers_.getShiftXY() + " != " + (byte)(getCoordShiftXY()) + "!");
        }
        if (buffers_.getShiftZ() != (byte)(getCoordShiftZ()))
        {
            throw new zserio.runtime.ZserioError("Write: Wrong parameter shiftZ for field PointDisplayGeometryLayer.buffers: " +
                    buffers_.getShiftZ() + " != " + (byte)(getCoordShiftZ()) + "!");
        }
        if (buffers_.getNumElements() != (int)(getNumElements()))
        {
            throw new zserio.runtime.ZserioError("Write: Wrong parameter numElements for field PointDisplayGeometryLayer.buffers: " +
    ...
    private static final class ZserioElementFactory_types implements zserio.runtime.array.PackableElementFactory<nds.display.types.DisplayPointType>
    {
        @Override
