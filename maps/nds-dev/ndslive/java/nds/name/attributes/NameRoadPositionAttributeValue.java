...
public class NameRoadPositionAttributeValue implements zserio.runtime.io.Writer, zserio.runtime.SizeOf
{
    public NameRoadPositionAttributeValue(
            nds.name.attributes.NameRoadPositionAttributeType type_)
    {
        this.type_ = type_;
    }

    public NameRoadPositionAttributeValue(zserio.runtime.io.BitStreamReader in,
            nds.name.attributes.NameRoadPositionAttributeType type_)
    ...
    public int bitSizeOf(long bitPosition)
    {
        ...
        case TOLL_STATION_NAME:
            ...
            break;
        default:
            throw new zserio.runtime.ZserioError("No match in choice NameRoadPositionAttributeValue: " + getType() + "!");
        }

        return (int)(endBitPosition - bitPosition);
    }

    public nds.name.attributes.NameRoadPositionAttributeType getType()
    {
        return this.type_;
    }
    ...
    {
        if (obj instanceof NameRoadPositionAttributeValue)
        {
            final NameRoadPositionAttributeValue that = (NameRoadPositionAttributeValue)obj;
    ...
    private final nds.name.attributes.NameRoadPositionAttributeType type_;
