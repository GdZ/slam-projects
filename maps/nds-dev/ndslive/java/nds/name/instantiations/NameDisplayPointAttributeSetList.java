...
public class NameDisplayPointAttributeSetList implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    ...
    public NameDisplayPointAttributeSetList(
            byte coordShift_)
    {
        this.coordShift_ = coordShift_;
    }

    public NameDisplayPointAttributeSetList(zserio.runtime.io.BitStreamReader in,
            byte coordShift_)
    ...
    public NameDisplayPointAttributeSetList(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in,
            byte coordShift_)
            throws java.io.IOException
    {
        this.coordShift_ = coordShift_;
    ...
    public NameDisplayPointAttributeSetList(
            ...
            nds.name.instantiations.NameDisplayPointAttributeSetMap[] sets_)
    {
        this(coordShift_);
    ...
    public nds.name.instantiations.NameDisplayPointAttributeSetMap[] getSets()
    {
        return (sets_ == null) ? null : sets_.getRawArray();
    }

    public void setSets(nds.name.instantiations.NameDisplayPointAttributeSetMap[] sets_)
    {
        this.sets_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.ObjectRawArray<>(nds.name.instantiations.NameDisplayPointAttributeSetMap.class, sets_),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.name.instantiations.NameDisplayPointAttributeSetMap>(new ZserioElementFactory_sets()),
    ...
    {
        if (obj instanceof NameDisplayPointAttributeSetList)
        {
            final NameDisplayPointAttributeSetList that = (NameDisplayPointAttributeSetList)obj;
            ...
            throws java.io.IOException
    {
        ...
        sets_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.ObjectRawArray<>(nds.name.instantiations.NameDisplayPointAttributeSetMap.class),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.name.instantiations.NameDisplayPointAttributeSetMap>(new ZserioElementFactory_sets()),
                zserio.runtime.array.ArrayType.NORMAL);
    ...
    public void write(zserio.runtime.io.BitStreamWriter out) throws java.io.IOException
    {
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field NameDisplayPointAttributeSetList.sets: " +
    ...
    private final class ZserioElementFactory_sets implements zserio.runtime.array.PackableElementFactory<nds.name.instantiations.NameDisplayPointAttributeSetMap>
    {
        @Override
        public nds.name.instantiations.NameDisplayPointAttributeSetMap create(zserio.runtime.io.BitStreamReader in, int index)
                throws java.io.IOException
        {
            return new nds.name.instantiations.NameDisplayPointAttributeSetMap(in, (byte)(getCoordShift()));
        }

        @Override
        public zserio.runtime.array.PackingContext createPackingContext()
        {
            return new nds.name.instantiations.NameDisplayPointAttributeSetMap.ZserioPackingContext();
        }

        @Override
        public nds.name.instantiations.NameDisplayPointAttributeSetMap create(zserio.runtime.array.PackingContext context,
                zserio.runtime.io.BitStreamReader in, int index) throws java.io.IOException
        {
            return new nds.name.instantiations.NameDisplayPointAttributeSetMap(context, in, (byte)(getCoordShift()));
        }
    }
