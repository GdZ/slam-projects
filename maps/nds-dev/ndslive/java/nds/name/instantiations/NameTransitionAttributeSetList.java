...
public class NameTransitionAttributeSetList implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    ...
    public NameTransitionAttributeSetList(
            byte coordShift_)
    {
        this.coordShift_ = coordShift_;
    }

    public NameTransitionAttributeSetList(zserio.runtime.io.BitStreamReader in,
            byte coordShift_)
    ...
    public NameTransitionAttributeSetList(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in,
            byte coordShift_)
            throws java.io.IOException
    {
        this.coordShift_ = coordShift_;
    ...
    public NameTransitionAttributeSetList(
            ...
            nds.name.instantiations.NameTransitionAttributeSetMap[] sets_)
    {
        this(coordShift_);
    ...
    public nds.name.instantiations.NameTransitionAttributeSetMap[] getSets()
    {
        return (sets_ == null) ? null : sets_.getRawArray();
    }

    public void setSets(nds.name.instantiations.NameTransitionAttributeSetMap[] sets_)
    {
        this.sets_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.ObjectRawArray<>(nds.name.instantiations.NameTransitionAttributeSetMap.class, sets_),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.name.instantiations.NameTransitionAttributeSetMap>(new ZserioElementFactory_sets()),
    ...
    {
        if (obj instanceof NameTransitionAttributeSetList)
        {
            final NameTransitionAttributeSetList that = (NameTransitionAttributeSetList)obj;
            ...
            throws java.io.IOException
    {
        ...
        sets_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.ObjectRawArray<>(nds.name.instantiations.NameTransitionAttributeSetMap.class),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.name.instantiations.NameTransitionAttributeSetMap>(new ZserioElementFactory_sets()),
                zserio.runtime.array.ArrayType.NORMAL);
    ...
    public void write(zserio.runtime.io.BitStreamWriter out) throws java.io.IOException
    {
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field NameTransitionAttributeSetList.sets: " +
    ...
    private final class ZserioElementFactory_sets implements zserio.runtime.array.PackableElementFactory<nds.name.instantiations.NameTransitionAttributeSetMap>
    {
        @Override
        public nds.name.instantiations.NameTransitionAttributeSetMap create(zserio.runtime.io.BitStreamReader in, int index)
                throws java.io.IOException
        {
            return new nds.name.instantiations.NameTransitionAttributeSetMap(in, (byte)(getCoordShift()));
        }

        @Override
        public zserio.runtime.array.PackingContext createPackingContext()
        {
            return new nds.name.instantiations.NameTransitionAttributeSetMap.ZserioPackingContext();
        }

        @Override
        public nds.name.instantiations.NameTransitionAttributeSetMap create(zserio.runtime.array.PackingContext context,
                zserio.runtime.io.BitStreamReader in, int index) throws java.io.IOException
        {
            return new nds.name.instantiations.NameTransitionAttributeSetMap(context, in, (byte)(getCoordShift()));
        }
    }
