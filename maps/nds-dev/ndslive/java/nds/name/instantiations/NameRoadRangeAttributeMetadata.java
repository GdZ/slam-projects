...
public class NameRoadRangeAttributeMetadata implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    ...
    public NameRoadRangeAttributeMetadata()
    {
    }

    public NameRoadRangeAttributeMetadata(zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        read(in);
    }

    public NameRoadRangeAttributeMetadata(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        read(context, in);
    }
    ...
    public NameRoadRangeAttributeMetadata(
            nds.name.attributes.NameRoadRangeAttributeType[] availableAttributes_,
    ...
    public nds.name.attributes.NameRoadRangeAttributeType[] getAvailableAttributes()
    {
        return (availableAttributes_ == null) ? null : availableAttributes_.getRawArray();
    }

    public void setAvailableAttributes(nds.name.attributes.NameRoadRangeAttributeType[] availableAttributes_)
    {
        this.availableAttributes_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.EnumRawArray<>(nds.name.attributes.NameRoadRangeAttributeType.class, availableAttributes_),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.name.attributes.NameRoadRangeAttributeType>(new ZserioElementFactory_availableAttributes()),
    ...
    {
        if (obj instanceof NameRoadRangeAttributeMetadata)
        {
            final NameRoadRangeAttributeMetadata that = (NameRoadRangeAttributeMetadata)obj;
    ...
    private static final class ZserioElementFactory_availableAttributes implements zserio.runtime.array.PackableElementFactory<nds.name.attributes.NameRoadRangeAttributeType>
    {
        @Override
