...
public class NameRoadPositionAttributeSetList implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    ...
    public NameRoadPositionAttributeSetList(
            byte coordShift_)
    {
        this.coordShift_ = coordShift_;
    }

    public NameRoadPositionAttributeSetList(zserio.runtime.io.BitStreamReader in,
            byte coordShift_)
    ...
    public NameRoadPositionAttributeSetList(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in,
            byte coordShift_)
            throws java.io.IOException
    {
        this.coordShift_ = coordShift_;
    ...
    public NameRoadPositionAttributeSetList(
            ...
            nds.name.instantiations.NameRoadPositionAttributeSetMap[] sets_)
    {
        this(coordShift_);
    ...
    public nds.name.instantiations.NameRoadPositionAttributeSetMap[] getSets()
    {
        return (sets_ == null) ? null : sets_.getRawArray();
    }

    public void setSets(nds.name.instantiations.NameRoadPositionAttributeSetMap[] sets_)
    {
        this.sets_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.ObjectRawArray<>(nds.name.instantiations.NameRoadPositionAttributeSetMap.class, sets_),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.name.instantiations.NameRoadPositionAttributeSetMap>(new ZserioElementFactory_sets()),
    ...
    {
        if (obj instanceof NameRoadPositionAttributeSetList)
        {
            final NameRoadPositionAttributeSetList that = (NameRoadPositionAttributeSetList)obj;
            ...
            throws java.io.IOException
    {
        ...
        sets_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.ObjectRawArray<>(nds.name.instantiations.NameRoadPositionAttributeSetMap.class),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.name.instantiations.NameRoadPositionAttributeSetMap>(new ZserioElementFactory_sets()),
                zserio.runtime.array.ArrayType.NORMAL);
    ...
    public void write(zserio.runtime.io.BitStreamWriter out) throws java.io.IOException
    {
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field NameRoadPositionAttributeSetList.sets: " +
    ...
    private final class ZserioElementFactory_sets implements zserio.runtime.array.PackableElementFactory<nds.name.instantiations.NameRoadPositionAttributeSetMap>
    {
        @Override
        public nds.name.instantiations.NameRoadPositionAttributeSetMap create(zserio.runtime.io.BitStreamReader in, int index)
                throws java.io.IOException
        {
            return new nds.name.instantiations.NameRoadPositionAttributeSetMap(in, (byte)(getCoordShift()));
        }

        @Override
        public zserio.runtime.array.PackingContext createPackingContext()
        {
            return new nds.name.instantiations.NameRoadPositionAttributeSetMap.ZserioPackingContext();
        }

        @Override
        public nds.name.instantiations.NameRoadPositionAttributeSetMap create(zserio.runtime.array.PackingContext context,
                zserio.runtime.io.BitStreamReader in, int index) throws java.io.IOException
        {
            return new nds.name.instantiations.NameRoadPositionAttributeSetMap(context, in, (byte)(getCoordShift()));
        }
    }
