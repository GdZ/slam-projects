...
public class NameLaneRangeAttributeSetList implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    ...
    public NameLaneRangeAttributeSetList(
            byte coordShift_)
    {
        this.coordShift_ = coordShift_;
    }

    public NameLaneRangeAttributeSetList(zserio.runtime.io.BitStreamReader in,
            byte coordShift_)
    ...
    public NameLaneRangeAttributeSetList(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in,
            byte coordShift_)
            throws java.io.IOException
    {
        this.coordShift_ = coordShift_;
    ...
    public NameLaneRangeAttributeSetList(
            ...
            nds.name.instantiations.NameLaneRangeAttributeSetMap[] sets_)
    {
        this(coordShift_);
    ...
    public nds.name.instantiations.NameLaneRangeAttributeSetMap[] getSets()
    {
        return (sets_ == null) ? null : sets_.getRawArray();
    }

    public void setSets(nds.name.instantiations.NameLaneRangeAttributeSetMap[] sets_)
    {
        this.sets_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.ObjectRawArray<>(nds.name.instantiations.NameLaneRangeAttributeSetMap.class, sets_),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.name.instantiations.NameLaneRangeAttributeSetMap>(new ZserioElementFactory_sets()),
    ...
    {
        if (obj instanceof NameLaneRangeAttributeSetList)
        {
            final NameLaneRangeAttributeSetList that = (NameLaneRangeAttributeSetList)obj;
            ...
            throws java.io.IOException
    {
        ...
        sets_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.ObjectRawArray<>(nds.name.instantiations.NameLaneRangeAttributeSetMap.class),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.name.instantiations.NameLaneRangeAttributeSetMap>(new ZserioElementFactory_sets()),
                zserio.runtime.array.ArrayType.NORMAL);
    ...
    public void write(zserio.runtime.io.BitStreamWriter out) throws java.io.IOException
    {
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field NameLaneRangeAttributeSetList.sets: " +
    ...
    private final class ZserioElementFactory_sets implements zserio.runtime.array.PackableElementFactory<nds.name.instantiations.NameLaneRangeAttributeSetMap>
    {
        @Override
        public nds.name.instantiations.NameLaneRangeAttributeSetMap create(zserio.runtime.io.BitStreamReader in, int index)
                throws java.io.IOException
        {
            return new nds.name.instantiations.NameLaneRangeAttributeSetMap(in, (byte)(getCoordShift()));
        }

        @Override
        public zserio.runtime.array.PackingContext createPackingContext()
        {
            return new nds.name.instantiations.NameLaneRangeAttributeSetMap.ZserioPackingContext();
        }

        @Override
        public nds.name.instantiations.NameLaneRangeAttributeSetMap create(zserio.runtime.array.PackingContext context,
                zserio.runtime.io.BitStreamReader in, int index) throws java.io.IOException
        {
            return new nds.name.instantiations.NameLaneRangeAttributeSetMap(context, in, (byte)(getCoordShift()));
        }
    }
