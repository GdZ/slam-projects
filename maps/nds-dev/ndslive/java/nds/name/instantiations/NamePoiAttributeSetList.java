...
public class NamePoiAttributeSetList implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    ...
    public NamePoiAttributeSetList(
            byte coordShift_)
    {
        this.coordShift_ = coordShift_;
    }

    public NamePoiAttributeSetList(zserio.runtime.io.BitStreamReader in,
            byte coordShift_)
    ...
    public NamePoiAttributeSetList(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in,
            byte coordShift_)
            throws java.io.IOException
    {
        this.coordShift_ = coordShift_;
    ...
    public NamePoiAttributeSetList(
            ...
            nds.name.instantiations.NamePoiAttributeSetMap[] sets_)
    {
        this(coordShift_);
    ...
    public nds.name.instantiations.NamePoiAttributeSetMap[] getSets()
    {
        return (sets_ == null) ? null : sets_.getRawArray();
    }

    public void setSets(nds.name.instantiations.NamePoiAttributeSetMap[] sets_)
    {
        this.sets_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.ObjectRawArray<>(nds.name.instantiations.NamePoiAttributeSetMap.class, sets_),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.name.instantiations.NamePoiAttributeSetMap>(new ZserioElementFactory_sets()),
    ...
    {
        if (obj instanceof NamePoiAttributeSetList)
        {
            final NamePoiAttributeSetList that = (NamePoiAttributeSetList)obj;
            ...
            throws java.io.IOException
    {
        ...
        sets_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.ObjectRawArray<>(nds.name.instantiations.NamePoiAttributeSetMap.class),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.name.instantiations.NamePoiAttributeSetMap>(new ZserioElementFactory_sets()),
                zserio.runtime.array.ArrayType.NORMAL);
    ...
    public void write(zserio.runtime.io.BitStreamWriter out) throws java.io.IOException
    {
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field NamePoiAttributeSetList.sets: " +
    ...
    private final class ZserioElementFactory_sets implements zserio.runtime.array.PackableElementFactory<nds.name.instantiations.NamePoiAttributeSetMap>
    {
        @Override
        public nds.name.instantiations.NamePoiAttributeSetMap create(zserio.runtime.io.BitStreamReader in, int index)
                throws java.io.IOException
        {
            return new nds.name.instantiations.NamePoiAttributeSetMap(in, (byte)(getCoordShift()));
        }

        @Override
        public zserio.runtime.array.PackingContext createPackingContext()
        {
            return new nds.name.instantiations.NamePoiAttributeSetMap.ZserioPackingContext();
        }

        @Override
        public nds.name.instantiations.NamePoiAttributeSetMap create(zserio.runtime.array.PackingContext context,
                zserio.runtime.io.BitStreamReader in, int index) throws java.io.IOException
        {
            return new nds.name.instantiations.NamePoiAttributeSetMap(context, in, (byte)(getCoordShift()));
        }
    }
