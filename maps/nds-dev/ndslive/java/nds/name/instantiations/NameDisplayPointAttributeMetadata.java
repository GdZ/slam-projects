...
public class NameDisplayPointAttributeMetadata implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    ...
    public NameDisplayPointAttributeMetadata()
    {
    }

    public NameDisplayPointAttributeMetadata(zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        read(in);
    }

    public NameDisplayPointAttributeMetadata(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        read(context, in);
    }
    ...
    public NameDisplayPointAttributeMetadata(
            nds.name.attributes.NameDisplayPointAttributeType[] availableAttributes_,
    ...
    public nds.name.attributes.NameDisplayPointAttributeType[] getAvailableAttributes()
    {
        return (availableAttributes_ == null) ? null : availableAttributes_.getRawArray();
    }

    public void setAvailableAttributes(nds.name.attributes.NameDisplayPointAttributeType[] availableAttributes_)
    {
        this.availableAttributes_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.EnumRawArray<>(nds.name.attributes.NameDisplayPointAttributeType.class, availableAttributes_),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.name.attributes.NameDisplayPointAttributeType>(new ZserioElementFactory_availableAttributes()),
    ...
    {
        if (obj instanceof NameDisplayPointAttributeMetadata)
        {
            final NameDisplayPointAttributeMetadata that = (NameDisplayPointAttributeMetadata)obj;
    ...
    private static final class ZserioElementFactory_availableAttributes implements zserio.runtime.array.PackableElementFactory<nds.name.attributes.NameDisplayPointAttributeType>
    {
        @Override
