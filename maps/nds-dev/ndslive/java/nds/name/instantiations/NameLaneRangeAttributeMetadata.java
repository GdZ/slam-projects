...
public class NameLaneRangeAttributeMetadata implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    ...
    public NameLaneRangeAttributeMetadata()
    {
    }

    public NameLaneRangeAttributeMetadata(zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        read(in);
    }

    public NameLaneRangeAttributeMetadata(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        read(context, in);
    }
    ...
    public NameLaneRangeAttributeMetadata(
            nds.name.attributes.NameLaneRangeAttributeType[] availableAttributes_,
    ...
    public nds.name.attributes.NameLaneRangeAttributeType[] getAvailableAttributes()
    {
        return (availableAttributes_ == null) ? null : availableAttributes_.getRawArray();
    }

    public void setAvailableAttributes(nds.name.attributes.NameLaneRangeAttributeType[] availableAttributes_)
    {
        this.availableAttributes_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.EnumRawArray<>(nds.name.attributes.NameLaneRangeAttributeType.class, availableAttributes_),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.name.attributes.NameLaneRangeAttributeType>(new ZserioElementFactory_availableAttributes()),
    ...
    {
        if (obj instanceof NameLaneRangeAttributeMetadata)
        {
            final NameLaneRangeAttributeMetadata that = (NameLaneRangeAttributeMetadata)obj;
    ...
    private static final class ZserioElementFactory_availableAttributes implements zserio.runtime.array.PackableElementFactory<nds.name.attributes.NameLaneRangeAttributeType>
    {
        @Override
