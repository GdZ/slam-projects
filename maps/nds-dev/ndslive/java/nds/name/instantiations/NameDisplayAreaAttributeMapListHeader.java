...
public class NameDisplayAreaAttributeMapListHeader implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    public static final class ZserioPackingContext extends zserio.runtime.array.PackingContext
    {
    };

    public NameDisplayAreaAttributeMapListHeader(
            short numMaps_)
    {
        this.numMaps_ = numMaps_;
    }

    public NameDisplayAreaAttributeMapListHeader(zserio.runtime.io.BitStreamReader in,
            short numMaps_)
    ...
    public NameDisplayAreaAttributeMapListHeader(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in,
            short numMaps_)
            throws java.io.IOException
    {
        this.numMaps_ = numMaps_;
    ...
    public void setAttributeTypeCode(nds.name.attributes.NameDisplayAreaAttributeType[] attributeTypeCode_)
    {
        this.attributeTypeCode_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.EnumRawArray<>(nds.name.attributes.NameDisplayAreaAttributeType.class, attributeTypeCode_),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.name.attributes.NameDisplayAreaAttributeType>(new ZserioElementFactory_attributeTypeCode()),
    ...
    {
        if (obj instanceof NameDisplayAreaAttributeMapListHeader)
        {
            final NameDisplayAreaAttributeMapListHeader that = (NameDisplayAreaAttributeMapListHeader)obj;
            ...
            throws java.io.IOException
    {
        attributeTypeCode_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.EnumRawArray<>(nds.name.attributes.NameDisplayAreaAttributeType.class),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.name.attributes.NameDisplayAreaAttributeType>(new ZserioElementFactory_attributeTypeCode()),
                zserio.runtime.array.ArrayType.NORMAL);
    ...
    public void write(zserio.runtime.io.BitStreamWriter out) throws java.io.IOException
    {
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field NameDisplayAreaAttributeMapListHeader.attributeTypeCode: " +
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field NameDisplayAreaAttributeMapListHeader.conditionType: " +
    ...
    private static final class ZserioElementFactory_attributeTypeCode implements zserio.runtime.array.PackableElementFactory<nds.name.attributes.NameDisplayAreaAttributeType>
    {
        @Override
        public nds.name.attributes.NameDisplayAreaAttributeType create(zserio.runtime.io.BitStreamReader in, int index)
                throws java.io.IOException
        {
            return nds.name.attributes.NameDisplayAreaAttributeType.readEnum(in);
        }
        ...
        @Override
        public nds.name.attributes.NameDisplayAreaAttributeType create(zserio.runtime.array.PackingContext context,
                zserio.runtime.io.BitStreamReader in, int index) throws java.io.IOException
        {
            return nds.name.attributes.NameDisplayAreaAttributeType.readEnum(context, in);
        }
    }
