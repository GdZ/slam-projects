...
public class NameDisplayLineRangeAttributeMetadata implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    ...
    public NameDisplayLineRangeAttributeMetadata()
    {
    }

    public NameDisplayLineRangeAttributeMetadata(zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        read(in);
    }

    public NameDisplayLineRangeAttributeMetadata(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        read(context, in);
    }
    ...
    public NameDisplayLineRangeAttributeMetadata(
            nds.name.attributes.NameDisplayLineRangeAttributeType[] availableAttributes_,
    ...
    public nds.name.attributes.NameDisplayLineRangeAttributeType[] getAvailableAttributes()
    {
        return (availableAttributes_ == null) ? null : availableAttributes_.getRawArray();
    }

    public void setAvailableAttributes(nds.name.attributes.NameDisplayLineRangeAttributeType[] availableAttributes_)
    {
        this.availableAttributes_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.EnumRawArray<>(nds.name.attributes.NameDisplayLineRangeAttributeType.class, availableAttributes_),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.name.attributes.NameDisplayLineRangeAttributeType>(new ZserioElementFactory_availableAttributes()),
    ...
    {
        if (obj instanceof NameDisplayLineRangeAttributeMetadata)
        {
            final NameDisplayLineRangeAttributeMetadata that = (NameDisplayLineRangeAttributeMetadata)obj;
    ...
    private static final class ZserioElementFactory_availableAttributes implements zserio.runtime.array.PackableElementFactory<nds.name.attributes.NameDisplayLineRangeAttributeType>
    {
        @Override
