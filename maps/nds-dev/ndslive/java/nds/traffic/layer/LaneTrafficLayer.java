...
public class LaneTrafficLayer implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    public static final class ZserioPackingContext extends zserio.runtime.array.PackingContext
    {
        public ZserioPackingContext()
        {
            ...
            laneRangeAttributeMaps_ = new nds.traffic.instantiations.TrafficLaneRangeAttributeMapList.ZserioPackingContext();
            laneRangeAttributeSets_ = new nds.traffic.instantiations.TrafficLaneRangeAttributeSetList.ZserioPackingContext();
        }
        ...
        public nds.traffic.instantiations.TrafficLaneRangeAttributeMapList.ZserioPackingContext getLaneRangeAttributeMaps()
        {
            return laneRangeAttributeMaps_;
        }

        public nds.traffic.instantiations.TrafficLaneRangeAttributeSetList.ZserioPackingContext getLaneRangeAttributeSets()
        {
            return laneRangeAttributeSets_;
        }

        private zserio.runtime.array.DeltaContext content_;
        private nds.traffic.instantiations.TrafficLaneRangeAttributeMapList.ZserioPackingContext laneRangeAttributeMaps_;
        private nds.traffic.instantiations.TrafficLaneRangeAttributeSetList.ZserioPackingContext laneRangeAttributeSets_;
    };

    public LaneTrafficLayer()
    {
    }

    public LaneTrafficLayer(zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        read(in);
    }

    public LaneTrafficLayer(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        read(context, in);
    }
    ...
    public LaneTrafficLayer(
            ...
            nds.traffic.instantiations.TrafficLaneRangeAttributeMapList laneRangeAttributeMaps_,
            nds.traffic.instantiations.TrafficLaneRangeAttributeSetList laneRangeAttributeSets_)
    {
        setContent(content_);
    ...
    public nds.traffic.instantiations.TrafficLaneRangeAttributeMapList getLaneRangeAttributeMaps()
    {
        return laneRangeAttributeMaps_;
    }

    public void setLaneRangeAttributeMaps(nds.traffic.instantiations.TrafficLaneRangeAttributeMapList laneRangeAttributeMaps_)
    {
    ...
    public nds.traffic.instantiations.TrafficLaneRangeAttributeSetList getLaneRangeAttributeSets()
    {
        return laneRangeAttributeSets_;
    }

    public void setLaneRangeAttributeSets(nds.traffic.instantiations.TrafficLaneRangeAttributeSetList laneRangeAttributeSets_)
    {
    ...
    {
        if (obj instanceof LaneTrafficLayer)
        {
            final LaneTrafficLayer that = (LaneTrafficLayer)obj;
            ...
            throws java.io.IOException
    {
        ...
        {
            laneRangeAttributeMaps_ = new nds.traffic.instantiations.TrafficLaneRangeAttributeMapList(in, (byte)(0));
        }
        ...
        {
            laneRangeAttributeSets_ = new nds.traffic.instantiations.TrafficLaneRangeAttributeSetList(in, (byte)(0));
        }
    }
            ...
            throws java.io.IOException
    {
        ...
        if ((getContent().and(nds.traffic.metadata.LaneTrafficLayerContent.Values.LANE_RANGE_MAPS)).equals(nds.traffic.metadata.LaneTrafficLayerContent.Values.LANE_RANGE_MAPS))
        {
            laneRangeAttributeMaps_ = new nds.traffic.instantiations.TrafficLaneRangeAttributeMapList(zserioContext.getLaneRangeAttributeMaps(), in, (byte)(0));
        }

        if ((getContent().and(nds.traffic.metadata.LaneTrafficLayerContent.Values.LANE_RANGE_SETS)).equals(nds.traffic.metadata.LaneTrafficLayerContent.Values.LANE_RANGE_SETS))
        {
            laneRangeAttributeSets_ = new nds.traffic.instantiations.TrafficLaneRangeAttributeSetList(zserioContext.getLaneRangeAttributeSets(), in, (byte)(0));
        }
    }
    ...
    public void write(zserio.runtime.io.BitStreamWriter out) throws java.io.IOException
    {
        ...
        if (isLaneRangeAttributeMapsUsed())
        {
            ...
            {
                throw new zserio.runtime.ZserioError("Write: Wrong parameter coordShift for field LaneTrafficLayer.laneRangeAttributeMaps: " +
        ...
        if (isLaneRangeAttributeSetsUsed())
        {
            ...
            {
                throw new zserio.runtime.ZserioError("Write: Wrong parameter coordShift for field LaneTrafficLayer.laneRangeAttributeSets: " +
    ...
    private nds.traffic.instantiations.TrafficLaneRangeAttributeMapList laneRangeAttributeMaps_;
    private nds.traffic.instantiations.TrafficLaneRangeAttributeSetList laneRangeAttributeSets_;
}
