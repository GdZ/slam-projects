...
public class TrafficRoadRangeAttributeSetList implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    ...
    public TrafficRoadRangeAttributeSetList(
            byte coordShift_)
    {
        this.coordShift_ = coordShift_;
    }

    public TrafficRoadRangeAttributeSetList(zserio.runtime.io.BitStreamReader in,
            byte coordShift_)
    ...
    public TrafficRoadRangeAttributeSetList(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in,
            byte coordShift_)
            throws java.io.IOException
    {
        this.coordShift_ = coordShift_;
    ...
    public TrafficRoadRangeAttributeSetList(
            ...
            nds.traffic.instantiations.TrafficRoadRangeAttributeSetMap[] sets_)
    {
        this(coordShift_);
    ...
    public nds.traffic.instantiations.TrafficRoadRangeAttributeSetMap[] getSets()
    {
        return (sets_ == null) ? null : sets_.getRawArray();
    }

    public void setSets(nds.traffic.instantiations.TrafficRoadRangeAttributeSetMap[] sets_)
    {
        this.sets_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.ObjectRawArray<>(nds.traffic.instantiations.TrafficRoadRangeAttributeSetMap.class, sets_),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.traffic.instantiations.TrafficRoadRangeAttributeSetMap>(new ZserioElementFactory_sets()),
    ...
    {
        if (obj instanceof TrafficRoadRangeAttributeSetList)
        {
            final TrafficRoadRangeAttributeSetList that = (TrafficRoadRangeAttributeSetList)obj;
            ...
            throws java.io.IOException
    {
        ...
        sets_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.ObjectRawArray<>(nds.traffic.instantiations.TrafficRoadRangeAttributeSetMap.class),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.traffic.instantiations.TrafficRoadRangeAttributeSetMap>(new ZserioElementFactory_sets()),
                zserio.runtime.array.ArrayType.NORMAL);
    ...
    public void write(zserio.runtime.io.BitStreamWriter out) throws java.io.IOException
    {
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field TrafficRoadRangeAttributeSetList.sets: " +
    ...
    private final class ZserioElementFactory_sets implements zserio.runtime.array.PackableElementFactory<nds.traffic.instantiations.TrafficRoadRangeAttributeSetMap>
    {
        @Override
        public nds.traffic.instantiations.TrafficRoadRangeAttributeSetMap create(zserio.runtime.io.BitStreamReader in, int index)
                throws java.io.IOException
        {
            return new nds.traffic.instantiations.TrafficRoadRangeAttributeSetMap(in, (byte)(getCoordShift()));
        }

        @Override
        public zserio.runtime.array.PackingContext createPackingContext()
        {
            return new nds.traffic.instantiations.TrafficRoadRangeAttributeSetMap.ZserioPackingContext();
        }

        @Override
        public nds.traffic.instantiations.TrafficRoadRangeAttributeSetMap create(zserio.runtime.array.PackingContext context,
                zserio.runtime.io.BitStreamReader in, int index) throws java.io.IOException
        {
            return new nds.traffic.instantiations.TrafficRoadRangeAttributeSetMap(context, in, (byte)(getCoordShift()));
        }
    }
