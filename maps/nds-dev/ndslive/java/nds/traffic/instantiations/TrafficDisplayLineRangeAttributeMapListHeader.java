...
public class TrafficDisplayLineRangeAttributeMapListHeader implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    public static final class ZserioPackingContext extends zserio.runtime.array.PackingContext
    {
    };

    public TrafficDisplayLineRangeAttributeMapListHeader(
            short numMaps_)
    {
        this.numMaps_ = numMaps_;
    }

    public TrafficDisplayLineRangeAttributeMapListHeader(zserio.runtime.io.BitStreamReader in,
            short numMaps_)
    ...
    public TrafficDisplayLineRangeAttributeMapListHeader(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in,
            short numMaps_)
            throws java.io.IOException
    {
        this.numMaps_ = numMaps_;
    ...
    public void setAttributeTypeCode(nds.traffic.attributes.TrafficDisplayLineRangeAttributeType[] attributeTypeCode_)
    {
        this.attributeTypeCode_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.EnumRawArray<>(nds.traffic.attributes.TrafficDisplayLineRangeAttributeType.class, attributeTypeCode_),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.traffic.attributes.TrafficDisplayLineRangeAttributeType>(new ZserioElementFactory_attributeTypeCode()),
    ...
    {
        if (obj instanceof TrafficDisplayLineRangeAttributeMapListHeader)
        {
            final TrafficDisplayLineRangeAttributeMapListHeader that = (TrafficDisplayLineRangeAttributeMapListHeader)obj;
    ...
    public void write(zserio.runtime.io.BitStreamWriter out) throws java.io.IOException
    {
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field TrafficDisplayLineRangeAttributeMapListHeader.attributeTypeCode: " +
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field TrafficDisplayLineRangeAttributeMapListHeader.conditionType: " +
    ...
    private static final class ZserioElementFactory_attributeTypeCode implements zserio.runtime.array.PackableElementFactory<nds.traffic.attributes.TrafficDisplayLineRangeAttributeType>
    {
        @Override
