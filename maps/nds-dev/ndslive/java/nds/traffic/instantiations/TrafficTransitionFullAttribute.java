...
public class TrafficTransitionFullAttribute implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    public static final class ZserioPackingContext extends zserio.runtime.array.PackingContext
    {
        public ZserioPackingContext()
        {
            ...
            attributeValue_ = new nds.traffic.attributes.TrafficTransitionAttributeValue.ZserioPackingContext();
        ...
        public nds.traffic.attributes.TrafficTransitionAttributeValue.ZserioPackingContext getAttributeValue()
        {
        ...
        private nds.traffic.attributes.TrafficTransitionAttributeValue.ZserioPackingContext attributeValue_;
    ...
    public TrafficTransitionFullAttribute()
    {
    }

    public TrafficTransitionFullAttribute(zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        read(in);
    }

    public TrafficTransitionFullAttribute(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        read(context, in);
    }
    ...
    public TrafficTransitionFullAttribute(
            ...
            nds.traffic.attributes.TrafficTransitionAttributeValue attributeValue_,
    ...
    public nds.traffic.attributes.TrafficTransitionAttributeValue getAttributeValue()
    {
        return attributeValue_;
    }

    public void setAttributeValue(nds.traffic.attributes.TrafficTransitionAttributeValue attributeValue_)
    {
    ...
    {
        if (obj instanceof TrafficTransitionFullAttribute)
        {
            final TrafficTransitionFullAttribute that = (TrafficTransitionFullAttribute)obj;
            ...
            throws java.io.IOException
    {
        ...
        attributeValue_ = new nds.traffic.attributes.TrafficTransitionAttributeValue(in, getAttributeTypeCode());
            ...
            throws java.io.IOException
    {
        ...
        attributeValue_ = new nds.traffic.attributes.TrafficTransitionAttributeValue(zserioContext.getAttributeValue(), in, getAttributeTypeCode());
    ...
    public void write(zserio.runtime.io.BitStreamWriter out) throws java.io.IOException
    {
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Inconsistent parameter type for field TrafficTransitionFullAttribute.attributeValue!");
        }
    ...
    private nds.traffic.attributes.TrafficTransitionAttributeValue attributeValue_;
