...
public class TrafficLaneRangeFullAttribute implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    public static final class ZserioPackingContext extends zserio.runtime.array.PackingContext
    {
        public ZserioPackingContext()
        {
            ...
            attributeValue_ = new nds.traffic.attributes.TrafficLaneRangeAttributeValue.ZserioPackingContext();
        ...
        public nds.traffic.attributes.TrafficLaneRangeAttributeValue.ZserioPackingContext getAttributeValue()
        {
        ...
        private nds.traffic.attributes.TrafficLaneRangeAttributeValue.ZserioPackingContext attributeValue_;
    ...
    public TrafficLaneRangeFullAttribute()
    {
    }

    public TrafficLaneRangeFullAttribute(zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        read(in);
    }

    public TrafficLaneRangeFullAttribute(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        read(context, in);
    }
    ...
    public TrafficLaneRangeFullAttribute(
            ...
            nds.traffic.attributes.TrafficLaneRangeAttributeValue attributeValue_,
    ...
    public nds.traffic.attributes.TrafficLaneRangeAttributeValue getAttributeValue()
    {
        return attributeValue_;
    }

    public void setAttributeValue(nds.traffic.attributes.TrafficLaneRangeAttributeValue attributeValue_)
    {
    ...
    {
        if (obj instanceof TrafficLaneRangeFullAttribute)
        {
            final TrafficLaneRangeFullAttribute that = (TrafficLaneRangeFullAttribute)obj;
            ...
            throws java.io.IOException
    {
        ...
        attributeValue_ = new nds.traffic.attributes.TrafficLaneRangeAttributeValue(in, getAttributeTypeCode());
            ...
            throws java.io.IOException
    {
        ...
        attributeValue_ = new nds.traffic.attributes.TrafficLaneRangeAttributeValue(zserioContext.getAttributeValue(), in, getAttributeTypeCode());
    ...
    public void write(zserio.runtime.io.BitStreamWriter out) throws java.io.IOException
    {
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Inconsistent parameter type for field TrafficLaneRangeFullAttribute.attributeValue!");
        }
    ...
    private nds.traffic.attributes.TrafficLaneRangeAttributeValue attributeValue_;
