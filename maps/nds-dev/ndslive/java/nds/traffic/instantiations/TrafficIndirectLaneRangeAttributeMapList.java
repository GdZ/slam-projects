...
public class TrafficIndirectLaneRangeAttributeMapList implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    ...
    public TrafficIndirectLaneRangeAttributeMapList(
            byte coordShift_)
    {
        this.coordShift_ = coordShift_;
    }

    public TrafficIndirectLaneRangeAttributeMapList(zserio.runtime.io.BitStreamReader in,
            byte coordShift_)
    ...
    public TrafficIndirectLaneRangeAttributeMapList(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in,
            byte coordShift_)
            throws java.io.IOException
    {
        this.coordShift_ = coordShift_;
    ...
    public TrafficIndirectLaneRangeAttributeMapList(
            ...
            nds.traffic.instantiations.TrafficIndirectLaneRangeAttributeMap[] maps_)
    {
        this(coordShift_);
    ...
    public nds.traffic.instantiations.TrafficIndirectLaneRangeAttributeMap[] getMaps()
    {
        return (maps_ == null) ? null : maps_.getRawArray();
    }

    public void setMaps(nds.traffic.instantiations.TrafficIndirectLaneRangeAttributeMap[] maps_)
    {
        this.maps_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.ObjectRawArray<>(nds.traffic.instantiations.TrafficIndirectLaneRangeAttributeMap.class, maps_),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.traffic.instantiations.TrafficIndirectLaneRangeAttributeMap>(new ZserioElementFactory_maps()),
    ...
    {
        if (obj instanceof TrafficIndirectLaneRangeAttributeMapList)
        {
            final TrafficIndirectLaneRangeAttributeMapList that = (TrafficIndirectLaneRangeAttributeMapList)obj;
            ...
            throws java.io.IOException
    {
        ...
        maps_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.ObjectRawArray<>(nds.traffic.instantiations.TrafficIndirectLaneRangeAttributeMap.class),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.traffic.instantiations.TrafficIndirectLaneRangeAttributeMap>(new ZserioElementFactory_maps()),
                zserio.runtime.array.ArrayType.NORMAL);
    ...
    public void write(zserio.runtime.io.BitStreamWriter out) throws java.io.IOException
    {
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong parameter numMaps for field TrafficIndirectLaneRangeAttributeMapList.header: " +
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field TrafficIndirectLaneRangeAttributeMapList.maps: " +
    ...
    private final class ZserioElementFactory_maps implements zserio.runtime.array.PackableElementFactory<nds.traffic.instantiations.TrafficIndirectLaneRangeAttributeMap>
    {
        @Override
        public nds.traffic.instantiations.TrafficIndirectLaneRangeAttributeMap create(zserio.runtime.io.BitStreamReader in, int index)
                throws java.io.IOException
        {
            return new nds.traffic.instantiations.TrafficIndirectLaneRangeAttributeMap(in, (byte)(getCoordShift()));
        }

        @Override
        public zserio.runtime.array.PackingContext createPackingContext()
        {
            return new nds.traffic.instantiations.TrafficIndirectLaneRangeAttributeMap.ZserioPackingContext();
        }

        @Override
        public nds.traffic.instantiations.TrafficIndirectLaneRangeAttributeMap create(zserio.runtime.array.PackingContext context,
                zserio.runtime.io.BitStreamReader in, int index) throws java.io.IOException
        {
            return new nds.traffic.instantiations.TrafficIndirectLaneRangeAttributeMap(context, in, (byte)(getCoordShift()));
        }
    }
