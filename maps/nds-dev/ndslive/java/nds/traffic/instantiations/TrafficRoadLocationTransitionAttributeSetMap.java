...
public class TrafficRoadLocationTransitionAttributeSetMap implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    public static final class ZserioPackingContext extends zserio.runtime.array.PackingContext
    {
        public ZserioPackingContext()
        {
            attributeSet_ = new nds.traffic.instantiations.TrafficTransitionAttributeSet.ZserioPackingContext();
            feature_ = new zserio.runtime.array.DeltaContext();
        }

        public nds.traffic.instantiations.TrafficTransitionAttributeSet.ZserioPackingContext getAttributeSet()
        {
        ...
        private nds.traffic.instantiations.TrafficTransitionAttributeSet.ZserioPackingContext attributeSet_;
        private zserio.runtime.array.DeltaContext feature_;
    };

    public TrafficRoadLocationTransitionAttributeSetMap(
            byte coordShift_)
    {
        this.coordShift_ = coordShift_;
    }

    public TrafficRoadLocationTransitionAttributeSetMap(zserio.runtime.io.BitStreamReader in,
            byte coordShift_)
    ...
    public TrafficRoadLocationTransitionAttributeSetMap(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in,
            byte coordShift_)
            throws java.io.IOException
    {
        this.coordShift_ = coordShift_;
    ...
    public TrafficRoadLocationTransitionAttributeSetMap(
            byte coordShift_,
            nds.traffic.instantiations.TrafficTransitionAttributeSet attributeSet_,
            int feature_,
            nds.road.reference.location.RoadLocationTransitionReference[] references_,
    ...
    public nds.traffic.instantiations.TrafficTransitionAttributeSet getAttributeSet()
    {
        return attributeSet_;
    }

    public void setAttributeSet(nds.traffic.instantiations.TrafficTransitionAttributeSet attributeSet_)
    {
    ...
    public nds.road.reference.location.RoadLocationTransitionReference[] getReferences()
    {
        return (references_ == null) ? null : references_.getRawArray();
    }

    public void setReferences(nds.road.reference.location.RoadLocationTransitionReference[] references_)
    {
        this.references_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.ObjectRawArray<>(nds.road.reference.location.RoadLocationTransitionReference.class, references_),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.road.reference.location.RoadLocationTransitionReference>(new ZserioElementFactory_references()),
    ...
    {
        if (obj instanceof TrafficRoadLocationTransitionAttributeSetMap)
        {
            final TrafficRoadLocationTransitionAttributeSetMap that = (TrafficRoadLocationTransitionAttributeSetMap)obj;
    ...
    public void read(zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        attributeSet_ = new nds.traffic.instantiations.TrafficTransitionAttributeSet(in);
    ...
    {
        final ZserioPackingContext zserioContext = context.cast();
        attributeSet_ = new nds.traffic.instantiations.TrafficTransitionAttributeSet(zserioContext.getAttributeSet(), in);
    ...
    public void write(zserio.runtime.io.BitStreamWriter out) throws java.io.IOException
    {
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field TrafficRoadLocationTransitionAttributeSetMap.references: " +
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field TrafficRoadLocationTransitionAttributeSetMap.validities: " +
    ...
    private static final class ZserioElementFactory_references implements zserio.runtime.array.PackableElementFactory<nds.road.reference.location.RoadLocationTransitionReference>
    {
        @Override
    ...
    private nds.traffic.instantiations.TrafficTransitionAttributeSet attributeSet_;
