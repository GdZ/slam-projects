...
public class TrafficDisplayLineRangeFullAttribute implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    public static final class ZserioPackingContext extends zserio.runtime.array.PackingContext
    {
        public ZserioPackingContext()
        {
            ...
            attributeValue_ = new nds.traffic.attributes.TrafficDisplayLineRangeAttributeValue.ZserioPackingContext();
            properties_ = new nds.traffic.instantiations.TrafficPropertyList.ZserioPackingContext();
        ...
        public nds.traffic.attributes.TrafficDisplayLineRangeAttributeValue.ZserioPackingContext getAttributeValue()
        {
            return attributeValue_;
        }

        public nds.traffic.instantiations.TrafficPropertyList.ZserioPackingContext getProperties()
        {
            return properties_;
        }
        ...
        private nds.traffic.attributes.TrafficDisplayLineRangeAttributeValue.ZserioPackingContext attributeValue_;
        private nds.traffic.instantiations.TrafficPropertyList.ZserioPackingContext properties_;
        private nds.core.attributemap.ConditionList.ZserioPackingContext conditions_;
    };

    public TrafficDisplayLineRangeFullAttribute()
    {
    }

    public TrafficDisplayLineRangeFullAttribute(zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        read(in);
    }

    public TrafficDisplayLineRangeFullAttribute(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        read(context, in);
    }
    ...
    public TrafficDisplayLineRangeFullAttribute(
            ...
            nds.traffic.attributes.TrafficDisplayLineRangeAttributeValue attributeValue_,
            nds.traffic.instantiations.TrafficPropertyList properties_,
    ...
    public nds.traffic.attributes.TrafficDisplayLineRangeAttributeValue getAttributeValue()
    {
        return attributeValue_;
    }

    public void setAttributeValue(nds.traffic.attributes.TrafficDisplayLineRangeAttributeValue attributeValue_)
    {
        this.attributeValue_ = attributeValue_;
    }

    public nds.traffic.instantiations.TrafficPropertyList getProperties()
    {
        return properties_;
    }

    public void setProperties(nds.traffic.instantiations.TrafficPropertyList properties_)
    {
    ...
    {
        if (obj instanceof TrafficDisplayLineRangeFullAttribute)
        {
            final TrafficDisplayLineRangeFullAttribute that = (TrafficDisplayLineRangeFullAttribute)obj;
            ...
            throws java.io.IOException
    {
        ...
        attributeValue_ = new nds.traffic.attributes.TrafficDisplayLineRangeAttributeValue(in, getAttributeTypeCode());

        if (in.readBool())
        {
            properties_ = new nds.traffic.instantiations.TrafficPropertyList(in);
        }
            ...
            throws java.io.IOException
    {
        ...
        attributeValue_ = new nds.traffic.attributes.TrafficDisplayLineRangeAttributeValue(zserioContext.getAttributeValue(), in, getAttributeTypeCode());

        if (in.readBool())
        {
            properties_ = new nds.traffic.instantiations.TrafficPropertyList(zserioContext.getProperties(), in);
        }
    ...
    public void write(zserio.runtime.io.BitStreamWriter out) throws java.io.IOException
    {
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Inconsistent parameter type for field TrafficDisplayLineRangeFullAttribute.attributeValue!");
        }
    ...
    private nds.traffic.attributes.TrafficDisplayLineRangeAttributeValue attributeValue_;
    private nds.traffic.instantiations.TrafficPropertyList properties_;
