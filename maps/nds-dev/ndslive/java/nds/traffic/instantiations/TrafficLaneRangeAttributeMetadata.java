...
public class TrafficLaneRangeAttributeMetadata implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    ...
    public TrafficLaneRangeAttributeMetadata()
    {
    }

    public TrafficLaneRangeAttributeMetadata(zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        read(in);
    }

    public TrafficLaneRangeAttributeMetadata(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        read(context, in);
    }
    ...
    public TrafficLaneRangeAttributeMetadata(
            nds.traffic.attributes.TrafficLaneRangeAttributeType[] availableAttributes_,
    ...
    public nds.traffic.attributes.TrafficLaneRangeAttributeType[] getAvailableAttributes()
    {
        return (availableAttributes_ == null) ? null : availableAttributes_.getRawArray();
    }

    public void setAvailableAttributes(nds.traffic.attributes.TrafficLaneRangeAttributeType[] availableAttributes_)
    {
        this.availableAttributes_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.EnumRawArray<>(nds.traffic.attributes.TrafficLaneRangeAttributeType.class, availableAttributes_),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.traffic.attributes.TrafficLaneRangeAttributeType>(new ZserioElementFactory_availableAttributes()),
    ...
    {
        if (obj instanceof TrafficLaneRangeAttributeMetadata)
        {
            final TrafficLaneRangeAttributeMetadata that = (TrafficLaneRangeAttributeMetadata)obj;
    ...
    private static final class ZserioElementFactory_availableAttributes implements zserio.runtime.array.PackableElementFactory<nds.traffic.attributes.TrafficLaneRangeAttributeType>
    {
        @Override
