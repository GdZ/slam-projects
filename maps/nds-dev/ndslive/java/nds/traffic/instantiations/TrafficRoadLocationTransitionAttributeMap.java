...
public class TrafficRoadLocationTransitionAttributeMap implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    ...
    public TrafficRoadLocationTransitionAttributeMap(
            byte coordShift_)
    {
        this.coordShift_ = coordShift_;
    }

    public TrafficRoadLocationTransitionAttributeMap(zserio.runtime.io.BitStreamReader in,
            byte coordShift_)
    ...
    public TrafficRoadLocationTransitionAttributeMap(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in,
            byte coordShift_)
            throws java.io.IOException
    {
        this.coordShift_ = coordShift_;
    ...
    public TrafficRoadLocationTransitionAttributeMap(
            ...
            int attribute_,
            nds.traffic.instantiations.TrafficTransitionAttribute[] attributeValues_,
    ...
    public nds.traffic.attributes.TrafficTransitionAttributeType getAttributeTypeCode()
    {
        return attributeTypeCode_;
    }

    public void setAttributeTypeCode(nds.traffic.attributes.TrafficTransitionAttributeType attributeTypeCode_)
    {
    ...
    public nds.traffic.instantiations.TrafficTransitionAttribute[] getAttributeValues()
    {
        return (attributeValues_ == null) ? null : attributeValues_.getRawArray();
    }

    public void setAttributeValues(nds.traffic.instantiations.TrafficTransitionAttribute[] attributeValues_)
    {
        this.attributeValues_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.ObjectRawArray<>(nds.traffic.instantiations.TrafficTransitionAttribute.class, attributeValues_),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.traffic.instantiations.TrafficTransitionAttribute>(new ZserioElementFactory_attributeValues()),
                zserio.runtime.array.ArrayType.NORMAL);
    }
    ...
    {
        if (obj instanceof TrafficRoadLocationTransitionAttributeMap)
        {
            final TrafficRoadLocationTransitionAttributeMap that = (TrafficRoadLocationTransitionAttributeMap)obj;
    ...
    public void read(zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        attributeTypeCode_ = nds.traffic.attributes.TrafficTransitionAttributeType.readEnum(in);
        ...
        attributeValues_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.ObjectRawArray<>(nds.traffic.instantiations.TrafficTransitionAttribute.class),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.traffic.instantiations.TrafficTransitionAttribute>(new ZserioElementFactory_attributeValues()),
                zserio.runtime.array.ArrayType.NORMAL);
    ...
    {
        final ZserioPackingContext zserioContext = context.cast();
        attributeTypeCode_ = nds.traffic.attributes.TrafficTransitionAttributeType.readEnum(zserioContext.getAttributeTypeCode(), in);
    ...
    public void write(zserio.runtime.io.BitStreamWriter out) throws java.io.IOException
    {
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field TrafficRoadLocationTransitionAttributeMap.featureReferences: " +
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field TrafficRoadLocationTransitionAttributeMap.featureValidities: " +
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field TrafficRoadLocationTransitionAttributeMap.featureValuePtr: " +
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field TrafficRoadLocationTransitionAttributeMap.attributeValues: " +
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field TrafficRoadLocationTransitionAttributeMap.attributeProperties: " +
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field TrafficRoadLocationTransitionAttributeMap.attributeConditions: " +
    ...
    private final class ZserioElementFactory_attributeValues implements zserio.runtime.array.PackableElementFactory<nds.traffic.instantiations.TrafficTransitionAttribute>
    {
        @Override
        public nds.traffic.instantiations.TrafficTransitionAttribute create(zserio.runtime.io.BitStreamReader in, int index)
                throws java.io.IOException
        {
            return new nds.traffic.instantiations.TrafficTransitionAttribute(in, getAttributeTypeCode());
        }

        @Override
        public zserio.runtime.array.PackingContext createPackingContext()
        {
            return new nds.traffic.instantiations.TrafficTransitionAttribute.ZserioPackingContext();
        }

        @Override
        public nds.traffic.instantiations.TrafficTransitionAttribute create(zserio.runtime.array.PackingContext context,
                zserio.runtime.io.BitStreamReader in, int index) throws java.io.IOException
        {
            return new nds.traffic.instantiations.TrafficTransitionAttribute(context, in, getAttributeTypeCode());
        }
    }
    ...
    private nds.traffic.attributes.TrafficTransitionAttributeType attributeTypeCode_;
