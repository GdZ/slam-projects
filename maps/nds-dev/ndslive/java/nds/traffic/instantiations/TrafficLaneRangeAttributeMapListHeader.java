...
public class TrafficLaneRangeAttributeMapListHeader implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    public static final class ZserioPackingContext extends zserio.runtime.array.PackingContext
    {
    };

    public TrafficLaneRangeAttributeMapListHeader(
            short numMaps_)
    {
        this.numMaps_ = numMaps_;
    }

    public TrafficLaneRangeAttributeMapListHeader(zserio.runtime.io.BitStreamReader in,
            short numMaps_)
    ...
    public TrafficLaneRangeAttributeMapListHeader(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in,
            short numMaps_)
            throws java.io.IOException
    {
        this.numMaps_ = numMaps_;
    ...
    public void setAttributeTypeCode(nds.traffic.attributes.TrafficLaneRangeAttributeType[] attributeTypeCode_)
    {
        this.attributeTypeCode_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.EnumRawArray<>(nds.traffic.attributes.TrafficLaneRangeAttributeType.class, attributeTypeCode_),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.traffic.attributes.TrafficLaneRangeAttributeType>(new ZserioElementFactory_attributeTypeCode()),
    ...
    {
        if (obj instanceof TrafficLaneRangeAttributeMapListHeader)
        {
            final TrafficLaneRangeAttributeMapListHeader that = (TrafficLaneRangeAttributeMapListHeader)obj;
            ...
            throws java.io.IOException
    {
        attributeTypeCode_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.EnumRawArray<>(nds.traffic.attributes.TrafficLaneRangeAttributeType.class),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.traffic.attributes.TrafficLaneRangeAttributeType>(new ZserioElementFactory_attributeTypeCode()),
                zserio.runtime.array.ArrayType.NORMAL);
    ...
    public void write(zserio.runtime.io.BitStreamWriter out) throws java.io.IOException
    {
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field TrafficLaneRangeAttributeMapListHeader.attributeTypeCode: " +
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field TrafficLaneRangeAttributeMapListHeader.conditionType: " +
    ...
    private static final class ZserioElementFactory_attributeTypeCode implements zserio.runtime.array.PackableElementFactory<nds.traffic.attributes.TrafficLaneRangeAttributeType>
    {
        @Override
        public nds.traffic.attributes.TrafficLaneRangeAttributeType create(zserio.runtime.io.BitStreamReader in, int index)
                throws java.io.IOException
        {
            return nds.traffic.attributes.TrafficLaneRangeAttributeType.readEnum(in);
        }
        ...
        @Override
        public nds.traffic.attributes.TrafficLaneRangeAttributeType create(zserio.runtime.array.PackingContext context,
                zserio.runtime.io.BitStreamReader in, int index) throws java.io.IOException
        {
            return nds.traffic.attributes.TrafficLaneRangeAttributeType.readEnum(context, in);
        }
    }
