...
public class LaneTrafficLayerIndirectMetadata implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    ...
    public LaneTrafficLayerIndirectMetadata()
    {
    }

    public LaneTrafficLayerIndirectMetadata(zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        read(in);
    }

    public LaneTrafficLayerIndirectMetadata(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        read(context, in);
    }
    ...
    {
        if (obj instanceof LaneTrafficLayerIndirectMetadata)
        {
            final LaneTrafficLayerIndirectMetadata that = (LaneTrafficLayerIndirectMetadata)obj;
