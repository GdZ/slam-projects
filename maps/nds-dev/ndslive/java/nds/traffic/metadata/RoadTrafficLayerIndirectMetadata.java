...
public class RoadTrafficLayerIndirectMetadata implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    ...
    public RoadTrafficLayerIndirectMetadata()
    {
    }

    public RoadTrafficLayerIndirectMetadata(zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        read(in);
    }

    public RoadTrafficLayerIndirectMetadata(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        read(context, in);
    }
    ...
    {
        return ((getContent().and(nds.traffic.metadata.RoadTrafficLayerContent.Values.ROAD_RANGE_MAPS)).equals(nds.traffic.metadata.RoadTrafficLayerContent.Values.ROAD_RANGE_MAPS) || (getContent().and(nds.traffic.metadata.RoadTrafficLayerContent.Values.ROAD_RANGE_SETS)).equals(nds.traffic.metadata.RoadTrafficLayerContent.Values.ROAD_RANGE_SETS));
    }
    ...
    {
        return ((getContent().and(nds.traffic.metadata.RoadTrafficLayerContent.Values.TRANSITION_MAPS)).equals(nds.traffic.metadata.RoadTrafficLayerContent.Values.TRANSITION_MAPS) || (getContent().and(nds.traffic.metadata.RoadTrafficLayerContent.Values.TRANSITION_SETS)).equals(nds.traffic.metadata.RoadTrafficLayerContent.Values.TRANSITION_SETS));
    }
    ...
    {
        if (obj instanceof RoadTrafficLayerIndirectMetadata)
        {
            final RoadTrafficLayerIndirectMetadata that = (RoadTrafficLayerIndirectMetadata)obj;
            ...
            throws java.io.IOException
    {
        ...
        if ((getContent().and(nds.traffic.metadata.RoadTrafficLayerContent.Values.ROAD_RANGE_MAPS)).equals(nds.traffic.metadata.RoadTrafficLayerContent.Values.ROAD_RANGE_MAPS) || (getContent().and(nds.traffic.metadata.RoadTrafficLayerContent.Values.ROAD_RANGE_SETS)).equals(nds.traffic.metadata.RoadTrafficLayerContent.Values.ROAD_RANGE_SETS))
        {
