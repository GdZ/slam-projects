...
public class RoadTrafficLayerMetadata implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    ...
    public RoadTrafficLayerMetadata()
    {
    }

    public RoadTrafficLayerMetadata(zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        read(in);
    }

    public RoadTrafficLayerMetadata(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        read(context, in);
    }
    ...
    {
        if (obj instanceof RoadTrafficLayerMetadata)
        {
            final RoadTrafficLayerMetadata that = (RoadTrafficLayerMetadata)obj;
