...
public class TrafficPropertyType implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    ...
    public TrafficPropertyType()
    {
    }

    public TrafficPropertyType(zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        read(in);
    }

    public TrafficPropertyType(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        read(context, in);
    }
    ...
    public void setType(nds.traffic.properties.PropertyType type_)
    {
        this.type_ = type_;
    }
    ...
    {
        if (obj instanceof TrafficPropertyType)
        {
            final TrafficPropertyType that = (TrafficPropertyType)obj;
    ...
    public void read(zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        type_ = nds.traffic.properties.PropertyType.readEnum(in);
    ...
    {
        final ZserioPackingContext zserioContext = context.cast();
        type_ = nds.traffic.properties.PropertyType.readEnum(zserioContext.getType(), in);
    ...
    private nds.traffic.properties.PropertyType type_;
