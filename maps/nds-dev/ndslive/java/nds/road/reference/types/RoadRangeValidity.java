...
public class RoadRangeValidity implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    ...
    public RoadRangeValidity(
            byte shift_)
    {
        this.shift_ = shift_;
    }

    public RoadRangeValidity(zserio.runtime.io.BitStreamReader in,
            byte shift_)
    ...
    public RoadRangeValidity(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in,
            byte shift_)
            throws java.io.IOException
    {
        this.shift_ = shift_;
    ...
    public RoadRangeValidity(
            ...
            nds.road.reference.types.RoadRangeChoice[] ranges_)
    {
        this(shift_);
    ...
    public nds.road.reference.types.RoadRangeChoice[] getRanges()
    {
        return (ranges_ == null) ? null : ranges_.getRawArray();
    }

    public void setRanges(nds.road.reference.types.RoadRangeChoice[] ranges_)
    {
        if (ranges_ == null)
        {
            this.ranges_ = null;
        ...
        else
        {
            this.ranges_ = new zserio.runtime.array.Array(
                    new zserio.runtime.array.RawArray.ObjectRawArray<>(nds.road.reference.types.RoadRangeChoice.class, ranges_),
                    new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.road.reference.types.RoadRangeChoice>(new ZserioElementFactory_ranges()),
    ...
    {
        if (obj instanceof RoadRangeValidity)
        {
            final RoadRangeValidity that = (RoadRangeValidity)obj;
            ...
            throws java.io.IOException
    {
        ...
        if (getType() != nds.road.reference.types.RoadValidityType.COMPLETE)
        {
            ranges_ = new zserio.runtime.array.Array(
                    new zserio.runtime.array.RawArray.ObjectRawArray<>(nds.road.reference.types.RoadRangeChoice.class),
                    new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.road.reference.types.RoadRangeChoice>(new ZserioElementFactory_ranges()),
                    zserio.runtime.array.ArrayType.NORMAL);
    ...
    public void write(zserio.runtime.io.BitStreamWriter out) throws java.io.IOException
    {
        ...
        if (isRangesUsed())
        {
            ...
            {
                throw new zserio.runtime.ZserioError("Write: Wrong array length for field RoadRangeValidity.ranges: " +
    ...
    private void checkConstraints()
    {
        if (isNumRangesUsed() && !(getNumRanges() > 0))
            throw new zserio.runtime.ConstraintError("Constraint violated at RoadRangeValidity.numRanges!");
    }

    private final class ZserioElementFactory_ranges implements zserio.runtime.array.PackableElementFactory<nds.road.reference.types.RoadRangeChoice>
    {
        @Override
        public nds.road.reference.types.RoadRangeChoice create(zserio.runtime.io.BitStreamReader in, int index)
                throws java.io.IOException
        {
            return new nds.road.reference.types.RoadRangeChoice(in, getType(), (byte)(getShift()));
        }

        @Override
        public zserio.runtime.array.PackingContext createPackingContext()
        {
            return new nds.road.reference.types.RoadRangeChoice.ZserioPackingContext();
        }

        @Override
        public nds.road.reference.types.RoadRangeChoice create(zserio.runtime.array.PackingContext context,
                zserio.runtime.io.BitStreamReader in, int index) throws java.io.IOException
        {
            return new nds.road.reference.types.RoadRangeChoice(context, in, getType(), (byte)(getShift()));
        }
    }
