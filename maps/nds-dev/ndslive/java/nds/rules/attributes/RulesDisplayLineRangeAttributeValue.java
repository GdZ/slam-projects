...
public class RulesDisplayLineRangeAttributeValue implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    public static final class ZserioPackingContext extends zserio.runtime.array.PackingContext
    {
        public ZserioPackingContext()
        {
            ...
            adrTunnelCategory_ = new zserio.runtime.array.DeltaContext();
            licensePlateRestriction_ = new nds.rules.types.LicensePlateRestriction.ZserioPackingContext();
        ...
        public zserio.runtime.array.DeltaContext getAdrTunnelCategory()
        {
            return adrTunnelCategory_;
        }

        public nds.rules.types.LicensePlateRestriction.ZserioPackingContext getLicensePlateRestriction()
        {
            return licensePlateRestriction_;
        }
        ...
        private zserio.runtime.array.DeltaContext adrTunnelCategory_;
        private nds.rules.types.LicensePlateRestriction.ZserioPackingContext licensePlateRestriction_;
        private zserio.runtime.array.DeltaContext automatedDrivingClearance_;
    };

    public RulesDisplayLineRangeAttributeValue(
            nds.rules.attributes.RulesDisplayLineRangeAttributeType type_)
    {
        this.type_ = type_;
    }

    public RulesDisplayLineRangeAttributeValue(zserio.runtime.io.BitStreamReader in,
            nds.rules.attributes.RulesDisplayLineRangeAttributeType type_)
    ...
    public RulesDisplayLineRangeAttributeValue(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in,
            nds.rules.attributes.RulesDisplayLineRangeAttributeType type_)
            throws java.io.IOException
    {
        this.type_ = type_;
    ...
    public void initPackingContext(zserio.runtime.array.PackingContext context)
    {
        ...
        case TRAFFIC_ZONE:
            ...
            break;
        case ADR_TUNNEL_CATEGORY:
            getAdrTunnelCategory().initPackingContext(zserioContext.getAdrTunnelCategory());
            break;
        case LICENSE_PLATE_RESTRICTION:
            getLicensePlateRestriction().initPackingContext(zserioContext.getLicensePlateRestriction());
            break;
        case SEASONAL_CLOSED:
            break;
        case PROHIBITED_PARKING:
        ...
        case ROADWORKS:
            break;
        default:
            throw new zserio.runtime.ZserioError("No match in choice RulesDisplayLineRangeAttributeValue: " + getType() + "!");
        }
    }
    ...
    public int bitSizeOf(long bitPosition)
    {
        ...
        case TRAFFIC_ENFORCEMENT_ZONE:
            ...
            break;
        case NON_DEFAULT_DRIVING_SIDE:
            endBitPosition += getNonDefaultDrivingSide().bitSizeOf(endBitPosition);
            break;
        case TRAFFIC_ZONE:
            endBitPosition += getTrafficZone().bitSizeOf(endBitPosition);
            break;
        case ADR_TUNNEL_CATEGORY:
            endBitPosition += getAdrTunnelCategory().bitSizeOf(endBitPosition);
            break;
        case LICENSE_PLATE_RESTRICTION:
            endBitPosition += getLicensePlateRestriction().bitSizeOf(endBitPosition);
            break;
        case SEASONAL_CLOSED:
    ...
    public int bitSizeOf(zserio.runtime.array.PackingContext context, long bitPosition)
    {
        ...
        case TRAFFIC_ZONE:
            ...
            break;
        case ADR_TUNNEL_CATEGORY:
            endBitPosition += getAdrTunnelCategory().bitSizeOf(zserioContext.getAdrTunnelCategory(), endBitPosition);
            break;
        case LICENSE_PLATE_RESTRICTION:
            endBitPosition += getLicensePlateRestriction().bitSizeOf(zserioContext.getLicensePlateRestriction(), endBitPosition);
            break;
        case SEASONAL_CLOSED:
            endBitPosition += getSeasonalClosed().bitSizeOf(endBitPosition);
            break;
    ...
    public nds.rules.attributes.RulesDisplayLineRangeAttributeType getType()
    {
        return this.type_;
    }
    ...
    public nds.core.types.Flag getNonDefaultDrivingSide()
    {
        return (nds.core.types.Flag)objectChoice;
    }

    public void setNonDefaultDrivingSide(nds.core.types.Flag nonDefaultDrivingSide_)
    {
        objectChoice = nonDefaultDrivingSide_;
    }
    ...
    public nds.rules.types.AdrTunnelCategory getAdrTunnelCategory()
    {
        return (nds.rules.types.AdrTunnelCategory)objectChoice;
    }

    public void setAdrTunnelCategory(nds.rules.types.AdrTunnelCategory adrTunnelCategory_)
    {
        objectChoice = adrTunnelCategory_;
    }

    public nds.rules.types.LicensePlateRestriction getLicensePlateRestriction()
    {
        return (nds.rules.types.LicensePlateRestriction)objectChoice;
    }

    public void setLicensePlateRestriction(nds.rules.types.LicensePlateRestriction licensePlateRestriction_)
    {
        objectChoice = licensePlateRestriction_;
    }
    ...
    {
        if (obj instanceof RulesDisplayLineRangeAttributeValue)
        {
            final RulesDisplayLineRangeAttributeValue that = (RulesDisplayLineRangeAttributeValue)obj;
    ...
    public int hashCode()
    {
        ...
        if (objectChoice != null)
        {
            ...
            case TRAFFIC_ZONE:
                ...
                break;
            case ADR_TUNNEL_CATEGORY:
                result = zserio.runtime.HashCodeUtil.calcHashCode(result, (nds.rules.types.AdrTunnelCategory)objectChoice);
                break;
            case LICENSE_PLATE_RESTRICTION:
                result = zserio.runtime.HashCodeUtil.calcHashCode(result, (nds.rules.types.LicensePlateRestriction)objectChoice);
                break;
            case SEASONAL_CLOSED:
                result = zserio.runtime.HashCodeUtil.calcHashCode(result, (nds.core.types.Flag)objectChoice);
                break;
    ...
    public void read(zserio.runtime.io.BitStreamReader in) throws java.io.IOException
    {
        ...
        case TRAFFIC_ZONE:
            ...
            break;
        case ADR_TUNNEL_CATEGORY:
            objectChoice = nds.rules.types.AdrTunnelCategory.readEnum(in);
            break;
        case LICENSE_PLATE_RESTRICTION:
            objectChoice = new nds.rules.types.LicensePlateRestriction(in);
            break;
        case SEASONAL_CLOSED:
            objectChoice = new nds.core.types.Flag(in);
            break;
            ...
            throws java.io.IOException
    {
        ...
        case TRAFFIC_ZONE:
            ...
            break;
        case ADR_TUNNEL_CATEGORY:
            objectChoice = nds.rules.types.AdrTunnelCategory.readEnum(zserioContext.getAdrTunnelCategory(), in);
            break;
        case LICENSE_PLATE_RESTRICTION:
            objectChoice = new nds.rules.types.LicensePlateRestriction(zserioContext.getLicensePlateRestriction(), in);
            break;
        case SEASONAL_CLOSED:
            objectChoice = new nds.core.types.Flag(in);
            break;
    ...
    public long initializeOffsets(long bitPosition)
    {
        ...
        case NON_DEFAULT_DRIVING_SIDE:
            {
                endBitPosition = getNonDefaultDrivingSide().initializeOffsets(endBitPosition);
            }
            break;
        case TRAFFIC_ZONE:
            {
        ...
        case LICENSE_PLATE_RESTRICTION:
            {
                endBitPosition = getLicensePlateRestriction().initializeOffsets(endBitPosition);
            }
            break;
        case SEASONAL_CLOSED:
            {
    ...
    public long initializeOffsets(zserio.runtime.array.PackingContext context, long bitPosition)
    {
        ...
        case ADR_TUNNEL_CATEGORY:
            {
                endBitPosition = getAdrTunnelCategory().initializeOffsets(zserioContext.getAdrTunnelCategory(), endBitPosition);
            }
            break;
        case LICENSE_PLATE_RESTRICTION:
            {
                endBitPosition = getLicensePlateRestriction().initializeOffsets(zserioContext.getLicensePlateRestriction(), endBitPosition);
            }
            break;
        case SEASONAL_CLOSED:
            {
    ...
    public void write(zserio.runtime.io.BitStreamWriter out) throws java.io.IOException
    {
        ...
        case TRAFFIC_ENFORCEMENT_ZONE:
            ...
            break;
        case NON_DEFAULT_DRIVING_SIDE:
            getNonDefaultDrivingSide().write(out);
            break;
        case TRAFFIC_ZONE:
            getTrafficZone().write(out);
            break;
        case ADR_TUNNEL_CATEGORY:
            getAdrTunnelCategory().write(out);
            break;
        case LICENSE_PLATE_RESTRICTION:
            getLicensePlateRestriction().write(out);
            break;
        case SEASONAL_CLOSED:
            ...
            throws java.io.IOException
    {
        ...
        case TRAFFIC_ZONE:
            ...
            break;
        case ADR_TUNNEL_CATEGORY:
            getAdrTunnelCategory().write(zserioContext.getAdrTunnelCategory(), out);
            break;
        case LICENSE_PLATE_RESTRICTION:
            getLicensePlateRestriction().write(zserioContext.getLicensePlateRestriction(), out);
            break;
        case SEASONAL_CLOSED:
            getSeasonalClosed().write(out);
            break;
    ...
    public static final int CHOICE_nonDefaultDrivingSide = 9;
    public static final int CHOICE_trafficZone = 10;
    public static final int CHOICE_adrTunnelCategory = 11;
    public static final int CHOICE_licensePlateRestriction = 12;
    public static final int CHOICE_seasonalClosed = 13;
    public static final int CHOICE_prohibitedParking = 14;
    public static final int CHOICE_prohibitedStopping = 15;
    public static final int CHOICE_dontStopZone = 16;
    public static final int CHOICE_automatedDrivingClearance = 17;
    public static final int CHOICE_roadworks = 18;
    public static final int UNDEFINED_CHOICE = -1;

    private final nds.rules.attributes.RulesDisplayLineRangeAttributeType type_;
