...
public enum RulesRoadRangeAttributeType implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf,
        zserio.runtime.ZserioEnum
{
    ...
    private RulesRoadRangeAttributeType(short value)
    {
        this.value = value;
    }
    ...
    public static RulesRoadRangeAttributeType readEnum(zserio.runtime.io.BitStreamReader in) throws java.io.IOException
    {
        return toEnum(in.readVarUInt16());
    }

    public static RulesRoadRangeAttributeType readEnum(zserio.runtime.array.PackingContext context,
    ...
    public static RulesRoadRangeAttributeType toEnum(short value)
    {
        switch (value)
        {
            case (short)0:
            ...
            default:
                throw new java.lang.IllegalArgumentException(
                        "Unknown value for enumeration RulesRoadRangeAttributeType: " + value + "!");
        }
    }

    public static RulesRoadRangeAttributeType toEnum(java.lang.String itemName)
    {
        ...
        if (itemName.equals("ROADWORKS"))
            return ROADWORKS;
        throw new java.lang.IllegalArgumentException(
                "Enum item '" + itemName + "' doesn't exist in enumeration RulesRoadRangeAttributeType!");
    }
