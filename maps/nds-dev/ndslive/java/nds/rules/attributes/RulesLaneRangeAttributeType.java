...
public enum RulesLaneRangeAttributeType implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf,
        zserio.runtime.ZserioEnum
{
    ...
    TRAFFIC_ZONE((short)9),
    SEASONAL_CLOSED((short)10),
    DONT_STOP_ZONE((short)11),
    PROHIBITED_PARKING((short)12),
    PROHIBITED_STOPPING((short)13),
    AUTOMATED_DRIVING_CLEARANCE((short)14),
    ROADWORKS((short)15),
    LANE_RIGHT_OF_WAY_REGULATION((short)16),
    LANE_TRAFFIC_PRIORITY((short)17);

    private RulesLaneRangeAttributeType(short value)
    {
        this.value = value;
    }
    ...
    public static RulesLaneRangeAttributeType readEnum(zserio.runtime.io.BitStreamReader in) throws java.io.IOException
    {
        return toEnum(in.readVarUInt16());
    }

    public static RulesLaneRangeAttributeType readEnum(zserio.runtime.array.PackingContext context,
    ...
    public static RulesLaneRangeAttributeType toEnum(short value)
    {
        switch (value)
        {
            case (short)0:
            ...
            case (short)15:
                return ROADWORKS;
            case (short)16:
                return LANE_RIGHT_OF_WAY_REGULATION;
            case (short)17:
                return LANE_TRAFFIC_PRIORITY;
            default:
                throw new java.lang.IllegalArgumentException(
                        "Unknown value for enumeration RulesLaneRangeAttributeType: " + value + "!");
        }
    }

    public static RulesLaneRangeAttributeType toEnum(java.lang.String itemName)
    {
        ...
        if (itemName.equals("ROADWORKS"))
            return ROADWORKS;
        if (itemName.equals("LANE_RIGHT_OF_WAY_REGULATION"))
            return LANE_RIGHT_OF_WAY_REGULATION;
        if (itemName.equals("LANE_TRAFFIC_PRIORITY"))
            return LANE_TRAFFIC_PRIORITY;
        throw new java.lang.IllegalArgumentException(
                "Enum item '" + itemName + "' doesn't exist in enumeration RulesLaneRangeAttributeType!");
    }
