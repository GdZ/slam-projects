...
public class RoadRulesLayerIndirectMetadata implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    public static final class ZserioPackingContext extends zserio.runtime.array.PackingContext
    {
        public ZserioPackingContext()
        {
            ...
            roadPositionAttributeMetadata_ = new nds.rules.instantiations.RulesRoadPositionAttributeMetadata.ZserioPackingContext();
        ...
        public nds.rules.instantiations.RulesRoadPositionAttributeMetadata.ZserioPackingContext getRoadPositionAttributeMetadata()
        {
        ...
        private nds.rules.instantiations.RulesRoadPositionAttributeMetadata.ZserioPackingContext roadPositionAttributeMetadata_;
    ...
    public RoadRulesLayerIndirectMetadata()
    {
    }

    public RoadRulesLayerIndirectMetadata(zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        read(in);
    }

    public RoadRulesLayerIndirectMetadata(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        read(context, in);
    }
    ...
    public RoadRulesLayerIndirectMetadata(
            ...
            nds.rules.instantiations.RulesRoadPositionAttributeMetadata roadPositionAttributeMetadata_,
    ...
    {
        return ((getContent().and(nds.rules.metadata.RoadRulesLayerContent.Values.ROAD_RANGE_MAPS)).equals(nds.rules.metadata.RoadRulesLayerContent.Values.ROAD_RANGE_MAPS) || (getContent().and(nds.rules.metadata.RoadRulesLayerContent.Values.ROAD_RANGE_SETS)).equals(nds.rules.metadata.RoadRulesLayerContent.Values.ROAD_RANGE_SETS));
    }
    ...
    public nds.rules.instantiations.RulesRoadPositionAttributeMetadata getRoadPositionAttributeMetadata()
    {
        return roadPositionAttributeMetadata_;
    }

    public void setRoadPositionAttributeMetadata(nds.rules.instantiations.RulesRoadPositionAttributeMetadata roadPositionAttributeMetadata_)
    {
    ...
    {
        return ((getContent().and(nds.rules.metadata.RoadRulesLayerContent.Values.ROAD_POSITION_MAPS)).equals(nds.rules.metadata.RoadRulesLayerContent.Values.ROAD_POSITION_MAPS) || (getContent().and(nds.rules.metadata.RoadRulesLayerContent.Values.ROAD_POSITION_SETS)).equals(nds.rules.metadata.RoadRulesLayerContent.Values.ROAD_POSITION_SETS));
    }
    ...
    {
        return ((getContent().and(nds.rules.metadata.RoadRulesLayerContent.Values.TRANSITION_MAPS)).equals(nds.rules.metadata.RoadRulesLayerContent.Values.TRANSITION_MAPS) || (getContent().and(nds.rules.metadata.RoadRulesLayerContent.Values.TRANSITION_SETS)).equals(nds.rules.metadata.RoadRulesLayerContent.Values.TRANSITION_SETS));
    }
    ...
    {
        return ((getContent().and(nds.rules.metadata.RoadRulesLayerContent.Values.LANGUAGES)).equals(nds.rules.metadata.RoadRulesLayerContent.Values.LANGUAGES));
    }
    ...
    {
        if (obj instanceof RoadRulesLayerIndirectMetadata)
        {
            final RoadRulesLayerIndirectMetadata that = (RoadRulesLayerIndirectMetadata)obj;
            ...
            throws java.io.IOException
    {
        ...
        if ((getContent().and(nds.rules.metadata.RoadRulesLayerContent.Values.ROAD_RANGE_MAPS)).equals(nds.rules.metadata.RoadRulesLayerContent.Values.ROAD_RANGE_MAPS) || (getContent().and(nds.rules.metadata.RoadRulesLayerContent.Values.ROAD_RANGE_SETS)).equals(nds.rules.metadata.RoadRulesLayerContent.Values.ROAD_RANGE_SETS))
        {
            roadRangeAttributeMetadata_ = new nds.rules.instantiations.RulesRoadRangeAttributeMetadata(in);
        }

        if ((getContent().and(nds.rules.metadata.RoadRulesLayerContent.Values.ROAD_POSITION_MAPS)).equals(nds.rules.metadata.RoadRulesLayerContent.Values.ROAD_POSITION_MAPS) || (getContent().and(nds.rules.metadata.RoadRulesLayerContent.Values.ROAD_POSITION_SETS)).equals(nds.rules.metadata.RoadRulesLayerContent.Values.ROAD_POSITION_SETS))
        {
            roadPositionAttributeMetadata_ = new nds.rules.instantiations.RulesRoadPositionAttributeMetadata(in);
        }

        if ((getContent().and(nds.rules.metadata.RoadRulesLayerContent.Values.TRANSITION_MAPS)).equals(nds.rules.metadata.RoadRulesLayerContent.Values.TRANSITION_MAPS) || (getContent().and(nds.rules.metadata.RoadRulesLayerContent.Values.TRANSITION_SETS)).equals(nds.rules.metadata.RoadRulesLayerContent.Values.TRANSITION_SETS))
        {
        ...
        if ((getContent().and(nds.rules.metadata.RoadRulesLayerContent.Values.LANGUAGES)).equals(nds.rules.metadata.RoadRulesLayerContent.Values.LANGUAGES))
        {
            ...
            throws java.io.IOException
    {
        ...
        if ((getContent().and(nds.rules.metadata.RoadRulesLayerContent.Values.ROAD_POSITION_MAPS)).equals(nds.rules.metadata.RoadRulesLayerContent.Values.ROAD_POSITION_MAPS) || (getContent().and(nds.rules.metadata.RoadRulesLayerContent.Values.ROAD_POSITION_SETS)).equals(nds.rules.metadata.RoadRulesLayerContent.Values.ROAD_POSITION_SETS))
        {
            roadPositionAttributeMetadata_ = new nds.rules.instantiations.RulesRoadPositionAttributeMetadata(zserioContext.getRoadPositionAttributeMetadata(), in);
        }
    ...
    private nds.rules.instantiations.RulesRoadPositionAttributeMetadata roadPositionAttributeMetadata_;
