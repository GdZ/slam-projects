...
public class RulesPropertyValue implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    public static final class ZserioPackingContext extends zserio.runtime.array.PackingContext
    {
        public ZserioPackingContext()
        {
            value_ = new nds.rules.properties.PropertyValue.ZserioPackingContext();
            coreValue_ = new nds.core.properties.CorePropertyValue.ZserioPackingContext();
        }

        public nds.rules.properties.PropertyValue.ZserioPackingContext getValue()
        {
            return value_;
        }
        ...
        private nds.rules.properties.PropertyValue.ZserioPackingContext value_;
        private nds.core.properties.CorePropertyValue.ZserioPackingContext coreValue_;
    };

    public RulesPropertyValue(
            nds.rules.properties.RulesPropertyType type_)
    {
        this.type_ = type_;
    }

    public RulesPropertyValue(zserio.runtime.io.BitStreamReader in,
            nds.rules.properties.RulesPropertyType type_)
    ...
    public RulesPropertyValue(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in,
            nds.rules.properties.RulesPropertyType type_)
            throws java.io.IOException
    {
        this.type_ = type_;
    ...
    public RulesPropertyValue(
            nds.rules.properties.RulesPropertyType type_,
            nds.rules.properties.PropertyValue value_,
    ...
    public nds.rules.properties.RulesPropertyType getType()
    {
        return this.type_;
    }

    public nds.rules.properties.PropertyValue getValue()
    {
        return value_;
    }

    public void setValue(nds.rules.properties.PropertyValue value_)
    {
        this.value_ = value_;
    }
    ...
    {
        if (obj instanceof RulesPropertyValue)
        {
            final RulesPropertyValue that = (RulesPropertyValue)obj;
            ...
            throws java.io.IOException
    {
        ...
        {
            value_ = new nds.rules.properties.PropertyValue(in, getType().getType());
        }
            ...
            throws java.io.IOException
    {
        ...
        if (getType().getType() != nds.rules.properties.PropertyType.CORE)
        {
            value_ = new nds.rules.properties.PropertyValue(zserioContext.getValue(), in, getType().getType());
        }
    ...
    public void write(zserio.runtime.io.BitStreamWriter out) throws java.io.IOException
    {
        if (isValueUsed())
        {
            ...
            {
                throw new zserio.runtime.ZserioError("Write: Inconsistent parameter type for field RulesPropertyValue.value!");
            }
            value_.write(out);
        }
        ...
        if (isCoreValueUsed())
        {
            ...
            {
                throw new zserio.runtime.ZserioError("Write: Inconsistent parameter type for field RulesPropertyValue.coreValue!");
            }
    ...
    private final nds.rules.properties.RulesPropertyType type_;
    private nds.rules.properties.PropertyValue value_;
