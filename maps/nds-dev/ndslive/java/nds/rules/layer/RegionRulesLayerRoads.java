...
public class RegionRulesLayerRoads implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    ...
    public RegionRulesLayerRoads()
    {
    }

    public RegionRulesLayerRoads(zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        read(in);
    }

    public RegionRulesLayerRoads(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        read(context, in);
    }
    ...
    public RegionRulesLayerRoads(
            ...
            nds.rules.layer.RegionRoadRelationList[] featureRelations_)
    {
    ...
    public nds.rules.layer.RegionRoadRelationList[] getFeatureRelations()
    {
        return (featureRelations_ == null) ? null : featureRelations_.getRawArray();
    }

    public void setFeatureRelations(nds.rules.layer.RegionRoadRelationList[] featureRelations_)
    {
        ...
        else
        {
            this.featureRelations_ = new zserio.runtime.array.Array(
                    new zserio.runtime.array.RawArray.ObjectRawArray<>(nds.rules.layer.RegionRoadRelationList.class, featureRelations_),
                    new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.rules.layer.RegionRoadRelationList>(new ZserioElementFactory_featureRelations()),
                    zserio.runtime.array.ArrayType.NORMAL);
        }
    }
    ...
    {
        if (obj instanceof RegionRulesLayerRoads)
        {
            final RegionRulesLayerRoads that = (RegionRulesLayerRoads)obj;
            ...
            throws java.io.IOException
    {
        ...
        if (getNumRegions() > 1 && getHasFeatureRelations())
        {
            featureRelations_ = new zserio.runtime.array.Array(
                    new zserio.runtime.array.RawArray.ObjectRawArray<>(nds.rules.layer.RegionRoadRelationList.class),
                    new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.rules.layer.RegionRoadRelationList>(new ZserioElementFactory_featureRelations()),
                    zserio.runtime.array.ArrayType.NORMAL);
    ...
    public void write(zserio.runtime.io.BitStreamWriter out) throws java.io.IOException
    {
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field RegionRulesLayerRoads.regionId: " +
        ...
        if (isRegionRulesAttributeMapsUsed())
        {
            ...
            {
                throw new zserio.runtime.ZserioError("Write: Wrong parameter coordShift for field RegionRulesLayerRoads.regionRulesAttributeMaps: " +
        ...
        if (isRegionRulesAttributeSetsUsed())
        {
            ...
            {
                throw new zserio.runtime.ZserioError("Write: Wrong parameter coordShift for field RegionRulesLayerRoads.regionRulesAttributeSets: " +
        ...
        if (isFeatureRelationsUsed())
        {
            ...
            {
                throw new zserio.runtime.ZserioError("Write: Wrong array length for field RegionRulesLayerRoads.featureRelations: " +
    ...
    {
        if (!(getNumRegions() > 0))
            throw new zserio.runtime.ConstraintError("Constraint violated at RegionRulesLayerRoads.numRegions!");
    }

    private static final class ZserioElementFactory_featureRelations implements zserio.runtime.array.PackableElementFactory<nds.rules.layer.RegionRoadRelationList>
    {
        @Override
        public nds.rules.layer.RegionRoadRelationList create(zserio.runtime.io.BitStreamReader in, int index)
                throws java.io.IOException
        {
            return new nds.rules.layer.RegionRoadRelationList(in);
        }

        @Override
        public zserio.runtime.array.PackingContext createPackingContext()
        {
            return new nds.rules.layer.RegionRoadRelationList.ZserioPackingContext();
        }

        @Override
        public nds.rules.layer.RegionRoadRelationList create(zserio.runtime.array.PackingContext context,
                zserio.runtime.io.BitStreamReader in, int index) throws java.io.IOException
        {
            return new nds.rules.layer.RegionRoadRelationList(context, in);
        }
    }
