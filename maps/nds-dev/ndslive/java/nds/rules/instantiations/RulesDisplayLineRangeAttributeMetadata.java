...
public class RulesDisplayLineRangeAttributeMetadata implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    ...
    public RulesDisplayLineRangeAttributeMetadata()
    {
    }

    public RulesDisplayLineRangeAttributeMetadata(zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        read(in);
    }

    public RulesDisplayLineRangeAttributeMetadata(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        read(context, in);
    }
    ...
    public RulesDisplayLineRangeAttributeMetadata(
            nds.rules.attributes.RulesDisplayLineRangeAttributeType[] availableAttributes_,
    ...
    public nds.rules.attributes.RulesDisplayLineRangeAttributeType[] getAvailableAttributes()
    {
        return (availableAttributes_ == null) ? null : availableAttributes_.getRawArray();
    }

    public void setAvailableAttributes(nds.rules.attributes.RulesDisplayLineRangeAttributeType[] availableAttributes_)
    {
        this.availableAttributes_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.EnumRawArray<>(nds.rules.attributes.RulesDisplayLineRangeAttributeType.class, availableAttributes_),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.rules.attributes.RulesDisplayLineRangeAttributeType>(new ZserioElementFactory_availableAttributes()),
    ...
    {
        if (obj instanceof RulesDisplayLineRangeAttributeMetadata)
        {
            final RulesDisplayLineRangeAttributeMetadata that = (RulesDisplayLineRangeAttributeMetadata)obj;
            ...
            throws java.io.IOException
    {
        availableAttributes_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.EnumRawArray<>(nds.rules.attributes.RulesDisplayLineRangeAttributeType.class),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.rules.attributes.RulesDisplayLineRangeAttributeType>(new ZserioElementFactory_availableAttributes()),
                zserio.runtime.array.ArrayType.AUTO);
    ...
    private static final class ZserioElementFactory_availableAttributes implements zserio.runtime.array.PackableElementFactory<nds.rules.attributes.RulesDisplayLineRangeAttributeType>
    {
        @Override
        public nds.rules.attributes.RulesDisplayLineRangeAttributeType create(zserio.runtime.io.BitStreamReader in, int index)
                throws java.io.IOException
        {
            return nds.rules.attributes.RulesDisplayLineRangeAttributeType.readEnum(in);
        }
        ...
        @Override
        public nds.rules.attributes.RulesDisplayLineRangeAttributeType create(zserio.runtime.array.PackingContext context,
                zserio.runtime.io.BitStreamReader in, int index) throws java.io.IOException
        {
            return nds.rules.attributes.RulesDisplayLineRangeAttributeType.readEnum(context, in);
        }
    }
