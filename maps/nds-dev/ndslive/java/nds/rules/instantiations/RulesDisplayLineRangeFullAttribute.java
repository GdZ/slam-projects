...
public class RulesDisplayLineRangeFullAttribute implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    public static final class ZserioPackingContext extends zserio.runtime.array.PackingContext
    {
        public ZserioPackingContext()
        {
            ...
            attributeValue_ = new nds.rules.attributes.RulesDisplayLineRangeAttributeValue.ZserioPackingContext();
        ...
        public nds.rules.attributes.RulesDisplayLineRangeAttributeValue.ZserioPackingContext getAttributeValue()
        {
        ...
        private nds.rules.attributes.RulesDisplayLineRangeAttributeValue.ZserioPackingContext attributeValue_;
    ...
    public RulesDisplayLineRangeFullAttribute()
    {
    }

    public RulesDisplayLineRangeFullAttribute(zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        read(in);
    }

    public RulesDisplayLineRangeFullAttribute(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        read(context, in);
    }
    ...
    public RulesDisplayLineRangeFullAttribute(
            ...
            nds.rules.attributes.RulesDisplayLineRangeAttributeValue attributeValue_,
    ...
    public nds.rules.attributes.RulesDisplayLineRangeAttributeValue getAttributeValue()
    {
        return attributeValue_;
    }

    public void setAttributeValue(nds.rules.attributes.RulesDisplayLineRangeAttributeValue attributeValue_)
    {
    ...
    {
        if (obj instanceof RulesDisplayLineRangeFullAttribute)
        {
            final RulesDisplayLineRangeFullAttribute that = (RulesDisplayLineRangeFullAttribute)obj;
            ...
            throws java.io.IOException
    {
        ...
        attributeValue_ = new nds.rules.attributes.RulesDisplayLineRangeAttributeValue(in, getAttributeTypeCode());
            ...
            throws java.io.IOException
    {
        ...
        attributeValue_ = new nds.rules.attributes.RulesDisplayLineRangeAttributeValue(zserioContext.getAttributeValue(), in, getAttributeTypeCode());
    ...
    public void write(zserio.runtime.io.BitStreamWriter out) throws java.io.IOException
    {
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Inconsistent parameter type for field RulesDisplayLineRangeFullAttribute.attributeValue!");
        }
    ...
    private nds.rules.attributes.RulesDisplayLineRangeAttributeValue attributeValue_;
