...
public class RulesLaneTransitionAttributeSetList implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    ...
    public RulesLaneTransitionAttributeSetList(
            byte coordShift_)
    {
        this.coordShift_ = coordShift_;
    }

    public RulesLaneTransitionAttributeSetList(zserio.runtime.io.BitStreamReader in,
            byte coordShift_)
    ...
    public RulesLaneTransitionAttributeSetList(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in,
            byte coordShift_)
            throws java.io.IOException
    {
        this.coordShift_ = coordShift_;
    ...
    public RulesLaneTransitionAttributeSetList(
            ...
            nds.rules.instantiations.RulesLaneTransitionAttributeSetMap[] sets_)
    {
        this(coordShift_);
    ...
    public nds.rules.instantiations.RulesLaneTransitionAttributeSetMap[] getSets()
    {
        return (sets_ == null) ? null : sets_.getRawArray();
    }

    public void setSets(nds.rules.instantiations.RulesLaneTransitionAttributeSetMap[] sets_)
    {
        this.sets_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.ObjectRawArray<>(nds.rules.instantiations.RulesLaneTransitionAttributeSetMap.class, sets_),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.rules.instantiations.RulesLaneTransitionAttributeSetMap>(new ZserioElementFactory_sets()),
    ...
    {
        if (obj instanceof RulesLaneTransitionAttributeSetList)
        {
            final RulesLaneTransitionAttributeSetList that = (RulesLaneTransitionAttributeSetList)obj;
            ...
            throws java.io.IOException
    {
        ...
        sets_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.ObjectRawArray<>(nds.rules.instantiations.RulesLaneTransitionAttributeSetMap.class),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.rules.instantiations.RulesLaneTransitionAttributeSetMap>(new ZserioElementFactory_sets()),
                zserio.runtime.array.ArrayType.NORMAL);
    ...
    public void write(zserio.runtime.io.BitStreamWriter out) throws java.io.IOException
    {
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field RulesLaneTransitionAttributeSetList.sets: " +
    ...
    private final class ZserioElementFactory_sets implements zserio.runtime.array.PackableElementFactory<nds.rules.instantiations.RulesLaneTransitionAttributeSetMap>
    {
        @Override
        public nds.rules.instantiations.RulesLaneTransitionAttributeSetMap create(zserio.runtime.io.BitStreamReader in, int index)
                throws java.io.IOException
        {
            return new nds.rules.instantiations.RulesLaneTransitionAttributeSetMap(in, (byte)(getCoordShift()));
        }

        @Override
        public zserio.runtime.array.PackingContext createPackingContext()
        {
            return new nds.rules.instantiations.RulesLaneTransitionAttributeSetMap.ZserioPackingContext();
        }

        @Override
        public nds.rules.instantiations.RulesLaneTransitionAttributeSetMap create(zserio.runtime.array.PackingContext context,
                zserio.runtime.io.BitStreamReader in, int index) throws java.io.IOException
        {
            return new nds.rules.instantiations.RulesLaneTransitionAttributeSetMap(context, in, (byte)(getCoordShift()));
        }
    }
