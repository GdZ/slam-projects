...
public class RulesIndirectLanePositionAttributeMap implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    ...
    public RulesIndirectLanePositionAttributeMap(
            byte coordShift_)
    {
        this.coordShift_ = coordShift_;
    }

    public RulesIndirectLanePositionAttributeMap(zserio.runtime.io.BitStreamReader in,
            byte coordShift_)
    ...
    public RulesIndirectLanePositionAttributeMap(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in,
            byte coordShift_)
            throws java.io.IOException
    {
        this.coordShift_ = coordShift_;
    ...
    public RulesIndirectLanePositionAttributeMap(
            ...
            int attribute_,
            nds.rules.instantiations.RulesLanePositionAttribute[] attributeValues_,
    ...
    public nds.rules.attributes.RulesLanePositionAttributeType getAttributeTypeCode()
    {
        return attributeTypeCode_;
    }

    public void setAttributeTypeCode(nds.rules.attributes.RulesLanePositionAttributeType attributeTypeCode_)
    {
    ...
    public nds.rules.instantiations.RulesLanePositionAttribute[] getAttributeValues()
    {
        return (attributeValues_ == null) ? null : attributeValues_.getRawArray();
    }

    public void setAttributeValues(nds.rules.instantiations.RulesLanePositionAttribute[] attributeValues_)
    {
        this.attributeValues_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.ObjectRawArray<>(nds.rules.instantiations.RulesLanePositionAttribute.class, attributeValues_),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.rules.instantiations.RulesLanePositionAttribute>(new ZserioElementFactory_attributeValues()),
                zserio.runtime.array.ArrayType.NORMAL);
    }
    ...
    {
        if (obj instanceof RulesIndirectLanePositionAttributeMap)
        {
            final RulesIndirectLanePositionAttributeMap that = (RulesIndirectLanePositionAttributeMap)obj;
    ...
    public void read(zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        attributeTypeCode_ = nds.rules.attributes.RulesLanePositionAttributeType.readEnum(in);
        ...
        attributeValues_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.ObjectRawArray<>(nds.rules.instantiations.RulesLanePositionAttribute.class),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.rules.instantiations.RulesLanePositionAttribute>(new ZserioElementFactory_attributeValues()),
                zserio.runtime.array.ArrayType.NORMAL);
    ...
    {
        final ZserioPackingContext zserioContext = context.cast();
        attributeTypeCode_ = nds.rules.attributes.RulesLanePositionAttributeType.readEnum(zserioContext.getAttributeTypeCode(), in);
    ...
    public void write(zserio.runtime.io.BitStreamWriter out) throws java.io.IOException
    {
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field RulesIndirectLanePositionAttributeMap.featureReferences: " +
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field RulesIndirectLanePositionAttributeMap.featureValidities: " +
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field RulesIndirectLanePositionAttributeMap.featureValuePtr: " +
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field RulesIndirectLanePositionAttributeMap.attributeValues: " +
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field RulesIndirectLanePositionAttributeMap.attributeProperties: " +
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field RulesIndirectLanePositionAttributeMap.attributeConditions: " +
    ...
    private final class ZserioElementFactory_attributeValues implements zserio.runtime.array.PackableElementFactory<nds.rules.instantiations.RulesLanePositionAttribute>
    {
        @Override
        public nds.rules.instantiations.RulesLanePositionAttribute create(zserio.runtime.io.BitStreamReader in, int index)
                throws java.io.IOException
        {
            return new nds.rules.instantiations.RulesLanePositionAttribute(in, getAttributeTypeCode());
        }

        @Override
        public zserio.runtime.array.PackingContext createPackingContext()
        {
            return new nds.rules.instantiations.RulesLanePositionAttribute.ZserioPackingContext();
        }

        @Override
        public nds.rules.instantiations.RulesLanePositionAttribute create(zserio.runtime.array.PackingContext context,
                zserio.runtime.io.BitStreamReader in, int index) throws java.io.IOException
        {
            return new nds.rules.instantiations.RulesLanePositionAttribute(context, in, getAttributeTypeCode());
        }
    }
    ...
    private nds.rules.attributes.RulesLanePositionAttributeType attributeTypeCode_;
