...
public class RulesLanePositionAttributeSetList implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    ...
    public RulesLanePositionAttributeSetList(
            byte coordShift_)
    {
        this.coordShift_ = coordShift_;
    }

    public RulesLanePositionAttributeSetList(zserio.runtime.io.BitStreamReader in,
            byte coordShift_)
    ...
    public RulesLanePositionAttributeSetList(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in,
            byte coordShift_)
            throws java.io.IOException
    {
        this.coordShift_ = coordShift_;
    ...
    public RulesLanePositionAttributeSetList(
            ...
            nds.rules.instantiations.RulesLanePositionAttributeSetMap[] sets_)
    {
        this(coordShift_);
    ...
    public nds.rules.instantiations.RulesLanePositionAttributeSetMap[] getSets()
    {
        return (sets_ == null) ? null : sets_.getRawArray();
    }

    public void setSets(nds.rules.instantiations.RulesLanePositionAttributeSetMap[] sets_)
    {
        this.sets_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.ObjectRawArray<>(nds.rules.instantiations.RulesLanePositionAttributeSetMap.class, sets_),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.rules.instantiations.RulesLanePositionAttributeSetMap>(new ZserioElementFactory_sets()),
    ...
    {
        if (obj instanceof RulesLanePositionAttributeSetList)
        {
            final RulesLanePositionAttributeSetList that = (RulesLanePositionAttributeSetList)obj;
            ...
            throws java.io.IOException
    {
        ...
        sets_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.ObjectRawArray<>(nds.rules.instantiations.RulesLanePositionAttributeSetMap.class),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.rules.instantiations.RulesLanePositionAttributeSetMap>(new ZserioElementFactory_sets()),
                zserio.runtime.array.ArrayType.NORMAL);
    ...
    public void write(zserio.runtime.io.BitStreamWriter out) throws java.io.IOException
    {
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field RulesLanePositionAttributeSetList.sets: " +
    ...
    private final class ZserioElementFactory_sets implements zserio.runtime.array.PackableElementFactory<nds.rules.instantiations.RulesLanePositionAttributeSetMap>
    {
        @Override
        public nds.rules.instantiations.RulesLanePositionAttributeSetMap create(zserio.runtime.io.BitStreamReader in, int index)
                throws java.io.IOException
        {
            return new nds.rules.instantiations.RulesLanePositionAttributeSetMap(in, (byte)(getCoordShift()));
        }

        @Override
        public zserio.runtime.array.PackingContext createPackingContext()
        {
            return new nds.rules.instantiations.RulesLanePositionAttributeSetMap.ZserioPackingContext();
        }

        @Override
        public nds.rules.instantiations.RulesLanePositionAttributeSetMap create(zserio.runtime.array.PackingContext context,
                zserio.runtime.io.BitStreamReader in, int index) throws java.io.IOException
        {
            return new nds.rules.instantiations.RulesLanePositionAttributeSetMap(context, in, (byte)(getCoordShift()));
        }
    }
