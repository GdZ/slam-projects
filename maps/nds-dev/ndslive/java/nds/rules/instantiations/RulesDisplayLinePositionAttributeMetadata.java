...
public class RulesDisplayLinePositionAttributeMetadata implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    ...
    public RulesDisplayLinePositionAttributeMetadata()
    {
    }

    public RulesDisplayLinePositionAttributeMetadata(zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        read(in);
    }

    public RulesDisplayLinePositionAttributeMetadata(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        read(context, in);
    }
    ...
    public RulesDisplayLinePositionAttributeMetadata(
            nds.rules.attributes.RulesDisplayLinePositionAttributeType[] availableAttributes_,
    ...
    public nds.rules.attributes.RulesDisplayLinePositionAttributeType[] getAvailableAttributes()
    {
        return (availableAttributes_ == null) ? null : availableAttributes_.getRawArray();
    }

    public void setAvailableAttributes(nds.rules.attributes.RulesDisplayLinePositionAttributeType[] availableAttributes_)
    {
        this.availableAttributes_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.EnumRawArray<>(nds.rules.attributes.RulesDisplayLinePositionAttributeType.class, availableAttributes_),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.rules.attributes.RulesDisplayLinePositionAttributeType>(new ZserioElementFactory_availableAttributes()),
    ...
    {
        if (obj instanceof RulesDisplayLinePositionAttributeMetadata)
        {
            final RulesDisplayLinePositionAttributeMetadata that = (RulesDisplayLinePositionAttributeMetadata)obj;
            ...
            throws java.io.IOException
    {
        availableAttributes_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.EnumRawArray<>(nds.rules.attributes.RulesDisplayLinePositionAttributeType.class),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.rules.attributes.RulesDisplayLinePositionAttributeType>(new ZserioElementFactory_availableAttributes()),
                zserio.runtime.array.ArrayType.AUTO);
    ...
    private static final class ZserioElementFactory_availableAttributes implements zserio.runtime.array.PackableElementFactory<nds.rules.attributes.RulesDisplayLinePositionAttributeType>
    {
        @Override
        public nds.rules.attributes.RulesDisplayLinePositionAttributeType create(zserio.runtime.io.BitStreamReader in, int index)
                throws java.io.IOException
        {
            return nds.rules.attributes.RulesDisplayLinePositionAttributeType.readEnum(in);
        }
        ...
        @Override
        public nds.rules.attributes.RulesDisplayLinePositionAttributeType create(zserio.runtime.array.PackingContext context,
                zserio.runtime.io.BitStreamReader in, int index) throws java.io.IOException
        {
            return nds.rules.attributes.RulesDisplayLinePositionAttributeType.readEnum(context, in);
        }
    }
