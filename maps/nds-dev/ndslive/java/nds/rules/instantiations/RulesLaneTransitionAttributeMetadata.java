...
public class RulesLaneTransitionAttributeMetadata implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    ...
    public RulesLaneTransitionAttributeMetadata()
    {
    }

    public RulesLaneTransitionAttributeMetadata(zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        read(in);
    }

    public RulesLaneTransitionAttributeMetadata(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        read(context, in);
    }
    ...
    public RulesLaneTransitionAttributeMetadata(
            nds.rules.attributes.RulesLaneTransitionAttributeType[] availableAttributes_,
    ...
    public nds.rules.attributes.RulesLaneTransitionAttributeType[] getAvailableAttributes()
    {
        return (availableAttributes_ == null) ? null : availableAttributes_.getRawArray();
    }

    public void setAvailableAttributes(nds.rules.attributes.RulesLaneTransitionAttributeType[] availableAttributes_)
    {
        this.availableAttributes_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.EnumRawArray<>(nds.rules.attributes.RulesLaneTransitionAttributeType.class, availableAttributes_),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.rules.attributes.RulesLaneTransitionAttributeType>(new ZserioElementFactory_availableAttributes()),
    ...
    {
        if (obj instanceof RulesLaneTransitionAttributeMetadata)
        {
            final RulesLaneTransitionAttributeMetadata that = (RulesLaneTransitionAttributeMetadata)obj;
            ...
            throws java.io.IOException
    {
        availableAttributes_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.EnumRawArray<>(nds.rules.attributes.RulesLaneTransitionAttributeType.class),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.rules.attributes.RulesLaneTransitionAttributeType>(new ZserioElementFactory_availableAttributes()),
                zserio.runtime.array.ArrayType.AUTO);
    ...
    private static final class ZserioElementFactory_availableAttributes implements zserio.runtime.array.PackableElementFactory<nds.rules.attributes.RulesLaneTransitionAttributeType>
    {
        @Override
        public nds.rules.attributes.RulesLaneTransitionAttributeType create(zserio.runtime.io.BitStreamReader in, int index)
                throws java.io.IOException
        {
            return nds.rules.attributes.RulesLaneTransitionAttributeType.readEnum(in);
        }
        ...
        @Override
        public nds.rules.attributes.RulesLaneTransitionAttributeType create(zserio.runtime.array.PackingContext context,
                zserio.runtime.io.BitStreamReader in, int index) throws java.io.IOException
        {
            return nds.rules.attributes.RulesLaneTransitionAttributeType.readEnum(context, in);
        }
    }
