...
public class RulesRegionFullAttribute implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    public static final class ZserioPackingContext extends zserio.runtime.array.PackingContext
    {
        public ZserioPackingContext()
        {
            ...
            attributeValue_ = new nds.rules.attributes.RulesRegionAttributeValue.ZserioPackingContext();
        ...
        public nds.rules.attributes.RulesRegionAttributeValue.ZserioPackingContext getAttributeValue()
        {
        ...
        private nds.rules.attributes.RulesRegionAttributeValue.ZserioPackingContext attributeValue_;
    ...
    public RulesRegionFullAttribute()
    {
    }

    public RulesRegionFullAttribute(zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        read(in);
    }

    public RulesRegionFullAttribute(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        read(context, in);
    }
    ...
    public RulesRegionFullAttribute(
            ...
            nds.rules.attributes.RulesRegionAttributeValue attributeValue_,
    ...
    public nds.rules.attributes.RulesRegionAttributeValue getAttributeValue()
    {
        return attributeValue_;
    }

    public void setAttributeValue(nds.rules.attributes.RulesRegionAttributeValue attributeValue_)
    {
    ...
    {
        if (obj instanceof RulesRegionFullAttribute)
        {
            final RulesRegionFullAttribute that = (RulesRegionFullAttribute)obj;
            ...
            throws java.io.IOException
    {
        ...
        attributeValue_ = new nds.rules.attributes.RulesRegionAttributeValue(in, getAttributeTypeCode());
            ...
            throws java.io.IOException
    {
        ...
        attributeValue_ = new nds.rules.attributes.RulesRegionAttributeValue(zserioContext.getAttributeValue(), in, getAttributeTypeCode());
    ...
    public void write(zserio.runtime.io.BitStreamWriter out) throws java.io.IOException
    {
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Inconsistent parameter type for field RulesRegionFullAttribute.attributeValue!");
        }
    ...
    private nds.rules.attributes.RulesRegionAttributeValue attributeValue_;
