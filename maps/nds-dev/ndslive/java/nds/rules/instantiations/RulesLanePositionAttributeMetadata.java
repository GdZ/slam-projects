...
public class RulesLanePositionAttributeMetadata implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    ...
    public RulesLanePositionAttributeMetadata()
    {
    }

    public RulesLanePositionAttributeMetadata(zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        read(in);
    }

    public RulesLanePositionAttributeMetadata(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        read(context, in);
    }
    ...
    public RulesLanePositionAttributeMetadata(
            nds.rules.attributes.RulesLanePositionAttributeType[] availableAttributes_,
    ...
    public nds.rules.attributes.RulesLanePositionAttributeType[] getAvailableAttributes()
    {
        return (availableAttributes_ == null) ? null : availableAttributes_.getRawArray();
    }

    public void setAvailableAttributes(nds.rules.attributes.RulesLanePositionAttributeType[] availableAttributes_)
    {
        this.availableAttributes_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.EnumRawArray<>(nds.rules.attributes.RulesLanePositionAttributeType.class, availableAttributes_),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.rules.attributes.RulesLanePositionAttributeType>(new ZserioElementFactory_availableAttributes()),
    ...
    {
        if (obj instanceof RulesLanePositionAttributeMetadata)
        {
            final RulesLanePositionAttributeMetadata that = (RulesLanePositionAttributeMetadata)obj;
            ...
            throws java.io.IOException
    {
        availableAttributes_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.EnumRawArray<>(nds.rules.attributes.RulesLanePositionAttributeType.class),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.rules.attributes.RulesLanePositionAttributeType>(new ZserioElementFactory_availableAttributes()),
                zserio.runtime.array.ArrayType.AUTO);
    ...
    private static final class ZserioElementFactory_availableAttributes implements zserio.runtime.array.PackableElementFactory<nds.rules.attributes.RulesLanePositionAttributeType>
    {
        @Override
        public nds.rules.attributes.RulesLanePositionAttributeType create(zserio.runtime.io.BitStreamReader in, int index)
                throws java.io.IOException
        {
            return nds.rules.attributes.RulesLanePositionAttributeType.readEnum(in);
        }
        ...
        @Override
        public nds.rules.attributes.RulesLanePositionAttributeType create(zserio.runtime.array.PackingContext context,
                zserio.runtime.io.BitStreamReader in, int index) throws java.io.IOException
        {
            return nds.rules.attributes.RulesLanePositionAttributeType.readEnum(context, in);
        }
    }
