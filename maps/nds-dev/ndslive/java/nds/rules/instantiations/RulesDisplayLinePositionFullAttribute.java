...
public class RulesDisplayLinePositionFullAttribute implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    public static final class ZserioPackingContext extends zserio.runtime.array.PackingContext
    {
        public ZserioPackingContext()
        {
            ...
            attributeValue_ = new nds.rules.attributes.RulesDisplayLinePositionAttributeValue.ZserioPackingContext();
        ...
        public nds.rules.attributes.RulesDisplayLinePositionAttributeValue.ZserioPackingContext getAttributeValue()
        {
        ...
        private nds.rules.attributes.RulesDisplayLinePositionAttributeValue.ZserioPackingContext attributeValue_;
    ...
    public RulesDisplayLinePositionFullAttribute()
    {
    }

    public RulesDisplayLinePositionFullAttribute(zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        read(in);
    }

    public RulesDisplayLinePositionFullAttribute(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        read(context, in);
    }
    ...
    public RulesDisplayLinePositionFullAttribute(
            ...
            nds.rules.attributes.RulesDisplayLinePositionAttributeValue attributeValue_,
    ...
    public nds.rules.attributes.RulesDisplayLinePositionAttributeValue getAttributeValue()
    {
        return attributeValue_;
    }

    public void setAttributeValue(nds.rules.attributes.RulesDisplayLinePositionAttributeValue attributeValue_)
    {
    ...
    {
        if (obj instanceof RulesDisplayLinePositionFullAttribute)
        {
            final RulesDisplayLinePositionFullAttribute that = (RulesDisplayLinePositionFullAttribute)obj;
            ...
            throws java.io.IOException
    {
        ...
        attributeValue_ = new nds.rules.attributes.RulesDisplayLinePositionAttributeValue(in, getAttributeTypeCode());
            ...
            throws java.io.IOException
    {
        ...
        attributeValue_ = new nds.rules.attributes.RulesDisplayLinePositionAttributeValue(zserioContext.getAttributeValue(), in, getAttributeTypeCode());
    ...
    public void write(zserio.runtime.io.BitStreamWriter out) throws java.io.IOException
    {
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Inconsistent parameter type for field RulesDisplayLinePositionFullAttribute.attributeValue!");
        }
    ...
    private nds.rules.attributes.RulesDisplayLinePositionAttributeValue attributeValue_;
