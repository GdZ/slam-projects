...
public class RulesRegionAttributeMetadata implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    ...
    public RulesRegionAttributeMetadata()
    {
    }

    public RulesRegionAttributeMetadata(zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        read(in);
    }

    public RulesRegionAttributeMetadata(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        read(context, in);
    }
    ...
    public RulesRegionAttributeMetadata(
            nds.rules.attributes.RulesRegionAttributeType[] availableAttributes_,
    ...
    public nds.rules.attributes.RulesRegionAttributeType[] getAvailableAttributes()
    {
        return (availableAttributes_ == null) ? null : availableAttributes_.getRawArray();
    }

    public void setAvailableAttributes(nds.rules.attributes.RulesRegionAttributeType[] availableAttributes_)
    {
        this.availableAttributes_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.EnumRawArray<>(nds.rules.attributes.RulesRegionAttributeType.class, availableAttributes_),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.rules.attributes.RulesRegionAttributeType>(new ZserioElementFactory_availableAttributes()),
    ...
    {
        if (obj instanceof RulesRegionAttributeMetadata)
        {
            final RulesRegionAttributeMetadata that = (RulesRegionAttributeMetadata)obj;
            ...
            throws java.io.IOException
    {
        availableAttributes_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.EnumRawArray<>(nds.rules.attributes.RulesRegionAttributeType.class),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.rules.attributes.RulesRegionAttributeType>(new ZserioElementFactory_availableAttributes()),
                zserio.runtime.array.ArrayType.AUTO);
    ...
    private static final class ZserioElementFactory_availableAttributes implements zserio.runtime.array.PackableElementFactory<nds.rules.attributes.RulesRegionAttributeType>
    {
        @Override
        public nds.rules.attributes.RulesRegionAttributeType create(zserio.runtime.io.BitStreamReader in, int index)
                throws java.io.IOException
        {
            return nds.rules.attributes.RulesRegionAttributeType.readEnum(in);
        }
        ...
        @Override
        public nds.rules.attributes.RulesRegionAttributeType create(zserio.runtime.array.PackingContext context,
                zserio.runtime.io.BitStreamReader in, int index) throws java.io.IOException
        {
            return nds.rules.attributes.RulesRegionAttributeType.readEnum(context, in);
        }
    }
