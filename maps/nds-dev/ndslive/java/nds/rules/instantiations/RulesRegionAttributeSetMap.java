...
public class RulesRegionAttributeSetMap implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    public static final class ZserioPackingContext extends zserio.runtime.array.PackingContext
    {
        public ZserioPackingContext()
        {
            attributeSet_ = new nds.rules.instantiations.RulesRegionAttributeSet.ZserioPackingContext();
            feature_ = new zserio.runtime.array.DeltaContext();
        }

        public nds.rules.instantiations.RulesRegionAttributeSet.ZserioPackingContext getAttributeSet()
        {
        ...
        private nds.rules.instantiations.RulesRegionAttributeSet.ZserioPackingContext attributeSet_;
        private zserio.runtime.array.DeltaContext feature_;
    };

    public RulesRegionAttributeSetMap(
            byte coordShift_)
    {
        this.coordShift_ = coordShift_;
    }

    public RulesRegionAttributeSetMap(zserio.runtime.io.BitStreamReader in,
            byte coordShift_)
    ...
    public RulesRegionAttributeSetMap(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in,
            byte coordShift_)
            throws java.io.IOException
    {
        this.coordShift_ = coordShift_;
    ...
    public RulesRegionAttributeSetMap(
            byte coordShift_,
            nds.rules.instantiations.RulesRegionAttributeSet attributeSet_,
            int feature_,
            int[] references_,
            nds.rules.types.RegionValidity[] validities_)
    {
        this(coordShift_);
    ...
    public nds.rules.instantiations.RulesRegionAttributeSet getAttributeSet()
    {
        return attributeSet_;
    }

    public void setAttributeSet(nds.rules.instantiations.RulesRegionAttributeSet attributeSet_)
    {
    ...
    public void setReferences(int[] references_)
    {
        this.references_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.IntRawArray(references_),
                new zserio.runtime.array.ArrayTraits.VarUInt32ArrayTraits(),
                zserio.runtime.array.ArrayType.NORMAL);
    }

    public nds.rules.types.RegionValidity[] getValidities()
    {
        return (validities_ == null) ? null : validities_.getRawArray();
    }

    public void setValidities(nds.rules.types.RegionValidity[] validities_)
    {
        this.validities_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.ObjectRawArray<>(nds.rules.types.RegionValidity.class, validities_),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.rules.types.RegionValidity>(new ZserioElementFactory_validities()),
                zserio.runtime.array.ArrayType.NORMAL);
    }
    ...
    {
        if (obj instanceof RulesRegionAttributeSetMap)
        {
            final RulesRegionAttributeSetMap that = (RulesRegionAttributeSetMap)obj;
    ...
    public void read(zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        attributeSet_ = new nds.rules.instantiations.RulesRegionAttributeSet(in);
    ...
    {
        final ZserioPackingContext zserioContext = context.cast();
        attributeSet_ = new nds.rules.instantiations.RulesRegionAttributeSet(zserioContext.getAttributeSet(), in);
    ...
    public void write(zserio.runtime.io.BitStreamWriter out) throws java.io.IOException
    {
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field RulesRegionAttributeSetMap.references: " +
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field RulesRegionAttributeSetMap.validities: " +
    ...
    private final class ZserioElementFactory_validities implements zserio.runtime.array.PackableElementFactory<nds.rules.types.RegionValidity>
    {
        @Override
    ...
    private nds.rules.instantiations.RulesRegionAttributeSet attributeSet_;
