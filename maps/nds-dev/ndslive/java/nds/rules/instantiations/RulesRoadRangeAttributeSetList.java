...
public class RulesRoadRangeAttributeSetList implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    ...
    public RulesRoadRangeAttributeSetList(
            byte coordShift_)
    {
        this.coordShift_ = coordShift_;
    }

    public RulesRoadRangeAttributeSetList(zserio.runtime.io.BitStreamReader in,
            byte coordShift_)
    ...
    public RulesRoadRangeAttributeSetList(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in,
            byte coordShift_)
            throws java.io.IOException
    {
        this.coordShift_ = coordShift_;
    ...
    public RulesRoadRangeAttributeSetList(
            ...
            nds.rules.instantiations.RulesRoadRangeAttributeSetMap[] sets_)
    {
        this(coordShift_);
    ...
    public nds.rules.instantiations.RulesRoadRangeAttributeSetMap[] getSets()
    {
        return (sets_ == null) ? null : sets_.getRawArray();
    }

    public void setSets(nds.rules.instantiations.RulesRoadRangeAttributeSetMap[] sets_)
    {
        this.sets_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.ObjectRawArray<>(nds.rules.instantiations.RulesRoadRangeAttributeSetMap.class, sets_),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.rules.instantiations.RulesRoadRangeAttributeSetMap>(new ZserioElementFactory_sets()),
    ...
    {
        if (obj instanceof RulesRoadRangeAttributeSetList)
        {
            final RulesRoadRangeAttributeSetList that = (RulesRoadRangeAttributeSetList)obj;
            ...
            throws java.io.IOException
    {
        ...
        sets_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.ObjectRawArray<>(nds.rules.instantiations.RulesRoadRangeAttributeSetMap.class),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.rules.instantiations.RulesRoadRangeAttributeSetMap>(new ZserioElementFactory_sets()),
                zserio.runtime.array.ArrayType.NORMAL);
    ...
    public void write(zserio.runtime.io.BitStreamWriter out) throws java.io.IOException
    {
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field RulesRoadRangeAttributeSetList.sets: " +
    ...
    private final class ZserioElementFactory_sets implements zserio.runtime.array.PackableElementFactory<nds.rules.instantiations.RulesRoadRangeAttributeSetMap>
    {
        @Override
        public nds.rules.instantiations.RulesRoadRangeAttributeSetMap create(zserio.runtime.io.BitStreamReader in, int index)
                throws java.io.IOException
        {
            return new nds.rules.instantiations.RulesRoadRangeAttributeSetMap(in, (byte)(getCoordShift()));
        }

        @Override
        public zserio.runtime.array.PackingContext createPackingContext()
        {
            return new nds.rules.instantiations.RulesRoadRangeAttributeSetMap.ZserioPackingContext();
        }

        @Override
        public nds.rules.instantiations.RulesRoadRangeAttributeSetMap create(zserio.runtime.array.PackingContext context,
                zserio.runtime.io.BitStreamReader in, int index) throws java.io.IOException
        {
            return new nds.rules.instantiations.RulesRoadRangeAttributeSetMap(context, in, (byte)(getCoordShift()));
        }
    }
