...
public class RulesLanePositionFullAttribute implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    public static final class ZserioPackingContext extends zserio.runtime.array.PackingContext
    {
        public ZserioPackingContext()
        {
            ...
            attributeValue_ = new nds.rules.attributes.RulesLanePositionAttributeValue.ZserioPackingContext();
        ...
        public nds.rules.attributes.RulesLanePositionAttributeValue.ZserioPackingContext getAttributeValue()
        {
        ...
        private nds.rules.attributes.RulesLanePositionAttributeValue.ZserioPackingContext attributeValue_;
    ...
    public RulesLanePositionFullAttribute()
    {
    }

    public RulesLanePositionFullAttribute(zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        read(in);
    }

    public RulesLanePositionFullAttribute(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        read(context, in);
    }
    ...
    public RulesLanePositionFullAttribute(
            ...
            nds.rules.attributes.RulesLanePositionAttributeValue attributeValue_,
    ...
    public nds.rules.attributes.RulesLanePositionAttributeValue getAttributeValue()
    {
        return attributeValue_;
    }

    public void setAttributeValue(nds.rules.attributes.RulesLanePositionAttributeValue attributeValue_)
    {
    ...
    {
        if (obj instanceof RulesLanePositionFullAttribute)
        {
            final RulesLanePositionFullAttribute that = (RulesLanePositionFullAttribute)obj;
            ...
            throws java.io.IOException
    {
        ...
        attributeValue_ = new nds.rules.attributes.RulesLanePositionAttributeValue(in, getAttributeTypeCode());
            ...
            throws java.io.IOException
    {
        ...
        attributeValue_ = new nds.rules.attributes.RulesLanePositionAttributeValue(zserioContext.getAttributeValue(), in, getAttributeTypeCode());
    ...
    public void write(zserio.runtime.io.BitStreamWriter out) throws java.io.IOException
    {
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Inconsistent parameter type for field RulesLanePositionFullAttribute.attributeValue!");
        }
    ...
    private nds.rules.attributes.RulesLanePositionAttributeValue attributeValue_;
