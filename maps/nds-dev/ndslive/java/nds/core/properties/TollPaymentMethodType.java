...
public enum TollPaymentMethodType implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf,
        zserio.runtime.ZserioEnum
{
    ...
    private TollPaymentMethodType(short value)
    {
        this.value = value;
    }
    ...
    public static TollPaymentMethodType readEnum(zserio.runtime.io.BitStreamReader in) throws java.io.IOException
    {
        return toEnum(in.readVarUInt16());
    }

    public static TollPaymentMethodType readEnum(zserio.runtime.array.PackingContext context,
    ...
    public static TollPaymentMethodType toEnum(short value)
    {
        switch (value)
        {
            case (short)0:
            ...
            default:
                throw new java.lang.IllegalArgumentException(
                        "Unknown value for enumeration TollPaymentMethodType: " + value + "!");
        }
    }

    public static TollPaymentMethodType toEnum(java.lang.String itemName)
    {
        ...
        if (itemName.equals("VIGNETTE"))
            return VIGNETTE;
        throw new java.lang.IllegalArgumentException(
                "Enum item '" + itemName + "' doesn't exist in enumeration TollPaymentMethodType!");
    }
