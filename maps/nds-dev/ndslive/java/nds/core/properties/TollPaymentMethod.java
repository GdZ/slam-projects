...
public class TollPaymentMethod implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    ...
    public TollPaymentMethod()
    {
    }

    public TollPaymentMethod(zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        read(in);
    }

    public TollPaymentMethod(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        read(context, in);
    }
    ...
    public nds.core.properties.TollPaymentMethodType getType()
    {
        return type_;
    }

    public void setType(nds.core.properties.TollPaymentMethodType type_)
    {
        this.type_ = type_;
    }
    ...
    {
        if (obj instanceof TollPaymentMethod)
        {
            final TollPaymentMethod that = (TollPaymentMethod)obj;
    ...
    public void read(zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        type_ = nds.core.properties.TollPaymentMethodType.readEnum(in);
    ...
    {
        final ZserioPackingContext zserioContext = context.cast();
        type_ = nds.core.properties.TollPaymentMethodType.readEnum(zserioContext.getType(), in);
    ...
    private nds.core.properties.TollPaymentMethodType type_;
