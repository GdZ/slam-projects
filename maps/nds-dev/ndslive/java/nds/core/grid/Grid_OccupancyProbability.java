...
public class Grid_OccupancyProbability implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    ...
    public Grid_OccupancyProbability(
            int size_,
            byte shift_)
    {
        this.size_ = size_;
    ...
    public Grid_OccupancyProbability(zserio.runtime.io.BitStreamReader in,
            int size_,
            byte shift_)
    ...
    public Grid_OccupancyProbability(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in,
            int size_,
            byte shift_)
            throws java.io.IOException
    {
    ...
    public Grid_OccupancyProbability(
            ...
            int numRows_,
            int numColumns_,
            nds.localization.types.OccupancyProbability[] grid_)
    {
        this(size_, shift_);
    ...
    public nds.localization.types.OccupancyProbability[] getGrid()
    {
        return (grid_ == null) ? null : grid_.getRawArray();
    }

    public void setGrid(nds.localization.types.OccupancyProbability[] grid_)
    {
        this.grid_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.ObjectRawArray<>(nds.localization.types.OccupancyProbability.class, grid_),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.localization.types.OccupancyProbability>(new ZserioElementFactory_grid()),
    ...
    {
        if (obj instanceof Grid_OccupancyProbability)
        {
            final Grid_OccupancyProbability that = (Grid_OccupancyProbability)obj;
            ...
            throws java.io.IOException
    {
        ...
        grid_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.ObjectRawArray<>(nds.localization.types.OccupancyProbability.class),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.localization.types.OccupancyProbability>(new ZserioElementFactory_grid()),
                zserio.runtime.array.ArrayType.NORMAL);
    ...
    public void write(zserio.runtime.io.BitStreamWriter out) throws java.io.IOException
    {
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong parameter shift for field Grid_OccupancyProbability.southWestCorner: " +
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field Grid_OccupancyProbability.grid: " +
    ...
    private static final class ZserioElementFactory_grid implements zserio.runtime.array.PackableElementFactory<nds.localization.types.OccupancyProbability>
    {
        @Override
        public nds.localization.types.OccupancyProbability create(zserio.runtime.io.BitStreamReader in, int index)
                throws java.io.IOException
        {
            return new nds.localization.types.OccupancyProbability(in);
        }

        @Override
        public zserio.runtime.array.PackingContext createPackingContext()
        {
            return new nds.localization.types.OccupancyProbability.ZserioPackingContext();
        }

        @Override
        public nds.localization.types.OccupancyProbability create(zserio.runtime.array.PackingContext context,
                zserio.runtime.io.BitStreamReader in, int index) throws java.io.IOException
        {
            return new nds.localization.types.OccupancyProbability(context, in);
        }
    }
