...
public class LineRange3D implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    ...
    public LineRange3D(zserio.runtime.io.BitStreamReader in,
            nds.core.geometry.Line3D line_)
    ...
    public LineRange3D(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in,
            nds.core.geometry.Line3D line_)
            throws java.io.IOException
    {
        this.line_ = line_;
    ...
    public nds.core.geometry.Line3D getLine()
    {
        return this.line_;
    }
    ...
    {
        if (obj instanceof LineRange3D)
        {
            final LineRange3D that = (LineRange3D)obj;
    ...
    private void checkConstraints()
    {
        if (!(getEnd() > getStart() && getEnd() <= getLine().funcLastPositionIdx()))
            throw new zserio.runtime.ConstraintError("Constraint violated at LineRange3D.end!");
    }

    private final nds.core.geometry.Line3D line_;
    private int start_;
    private int end_;
}
