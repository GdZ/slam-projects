...
public class TrailerLengthMetricCondition implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    ...
    public TrailerLengthMetricCondition()
    {
    }

    public TrailerLengthMetricCondition(zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        read(in);
    }

    public TrailerLengthMetricCondition(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        read(context, in);
    }
    ...
    {
        if (obj instanceof TrailerLengthMetricCondition)
        {
            final TrailerLengthMetricCondition that = (TrailerLengthMetricCondition)obj;
