...
public class TimeDurationHours implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    ...
    public TimeDurationHours()
    {
    }

    public TimeDurationHours(zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        read(in);
    }

    public TimeDurationHours(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        read(context, in);
    }
    ...
    {
        if (obj instanceof TimeDurationHours)
        {
            final TimeDurationHours that = (TimeDurationHours)obj;
    ...
    {
        if (!(getMinutes() < 60))
            throw new zserio.runtime.ConstraintError("Constraint violated at TimeDurationHours.minutes!");
    }
