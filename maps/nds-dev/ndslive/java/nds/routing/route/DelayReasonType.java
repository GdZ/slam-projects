...
public enum DelayReasonType implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf,
        zserio.runtime.ZserioEnum
{
    ...
    private DelayReasonType(short value)
    {
        this.value = value;
    }
    ...
    public static DelayReasonType readEnum(zserio.runtime.io.BitStreamReader in) throws java.io.IOException
    {
        return toEnum(in.readVarUInt16());
    }

    public static DelayReasonType readEnum(zserio.runtime.array.PackingContext context,
    ...
    public static DelayReasonType toEnum(short value)
    {
        switch (value)
        {
            case (short)0:
            ...
            default:
                throw new java.lang.IllegalArgumentException(
                        "Unknown value for enumeration DelayReasonType: " + value + "!");
        }
    }

    public static DelayReasonType toEnum(java.lang.String itemName)
    {
        ...
        if (itemName.equals("CLOSURE"))
            return CLOSURE;
        throw new java.lang.IllegalArgumentException(
                "Enum item '" + itemName + "' doesn't exist in enumeration DelayReasonType!");
    }
