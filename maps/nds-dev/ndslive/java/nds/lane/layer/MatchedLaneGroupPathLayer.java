...
public class MatchedLaneGroupPathLayer implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    ...
    public MatchedLaneGroupPathLayer()
    {
    }

    public MatchedLaneGroupPathLayer(zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        read(in);
    }

    public MatchedLaneGroupPathLayer(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        read(context, in);
    }
    ...
    public MatchedLaneGroupPathLayer(
            short numSegments_,
            nds.lane.lanegroups.MatchedLaneGroupSegment[] segments_,
            boolean pathEnds_)
    {
    ...
    public nds.lane.lanegroups.MatchedLaneGroupSegment[] getSegments()
    {
        return (segments_ == null) ? null : segments_.getRawArray();
    }

    public void setSegments(nds.lane.lanegroups.MatchedLaneGroupSegment[] segments_)
    {
        this.segments_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.ObjectRawArray<>(nds.lane.lanegroups.MatchedLaneGroupSegment.class, segments_),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.lane.lanegroups.MatchedLaneGroupSegment>(new ZserioElementFactory_segments()),
    ...
    {
        if (obj instanceof MatchedLaneGroupPathLayer)
        {
            final MatchedLaneGroupPathLayer that = (MatchedLaneGroupPathLayer)obj;
            ...
            throws java.io.IOException
    {
        ...
        segments_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.ObjectRawArray<>(nds.lane.lanegroups.MatchedLaneGroupSegment.class),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.lane.lanegroups.MatchedLaneGroupSegment>(new ZserioElementFactory_segments()),
                zserio.runtime.array.ArrayType.NORMAL);
    ...
    public void write(zserio.runtime.io.BitStreamWriter out) throws java.io.IOException
    {
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field MatchedLaneGroupPathLayer.segments: " +
    ...
    {
        if (!(getNumSegments() > 0))
            throw new zserio.runtime.ConstraintError("Constraint violated at MatchedLaneGroupPathLayer.numSegments!");
    }

    private static final class ZserioElementFactory_segments implements zserio.runtime.array.PackableElementFactory<nds.lane.lanegroups.MatchedLaneGroupSegment>
    {
        @Override
        public nds.lane.lanegroups.MatchedLaneGroupSegment create(zserio.runtime.io.BitStreamReader in, int index)
                throws java.io.IOException
        {
            return new nds.lane.lanegroups.MatchedLaneGroupSegment(in);
        }

        @Override
        public zserio.runtime.array.PackingContext createPackingContext()
        {
            return new nds.lane.lanegroups.MatchedLaneGroupSegment.ZserioPackingContext();
        }

        @Override
        public nds.lane.lanegroups.MatchedLaneGroupSegment create(zserio.runtime.array.PackingContext context,
                zserio.runtime.io.BitStreamReader in, int index) throws java.io.IOException
        {
            return new nds.lane.lanegroups.MatchedLaneGroupSegment(context, in);
        }
    }
