...
public class RoadSurfacePolygonGeometryLayer implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    ...
    public RoadSurfacePolygonGeometryLayer(
    ...
    public RoadSurfacePolygonGeometryLayer(zserio.runtime.io.BitStreamReader in,
            nds.core.geometry.GeometryLayerType type_,
            boolean hasIds_,
            boolean hasTypes_)
    ...
    public RoadSurfacePolygonGeometryLayer(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in,
            nds.core.geometry.GeometryLayerType type_,
            boolean hasIds_,
            boolean hasTypes_)
            throws java.io.IOException
    ...
    public RoadSurfacePolygonGeometryLayer(
            ...
            byte coordShiftZ_,
            int numElements_,
            nds.core.types.Var4ByteId[] identifier_,
            nds.lane.roadsurface.RoadSurfacePolygonType[] types_,
    ...
    public nds.core.types.Var4ByteId[] getIdentifier()
    {
        return (identifier_ == null) ? null : identifier_.getRawArray();
    }

    public void setIdentifier(nds.core.types.Var4ByteId[] identifier_)
    {
        if (identifier_ == null)
        {
        ...
        else
        {
            this.identifier_ = new zserio.runtime.array.Array(
                    new zserio.runtime.array.RawArray.ObjectRawArray<>(nds.core.types.Var4ByteId.class, identifier_),
                    new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.core.types.Var4ByteId>(new ZserioElementFactory_identifier()),
    ...
    public nds.lane.roadsurface.RoadSurfacePolygonType[] getTypes()
    {
        return (types_ == null) ? null : types_.getRawArray();
    }

    public void setTypes(nds.lane.roadsurface.RoadSurfacePolygonType[] types_)
    {
        if (types_ == null)
        {
            this.types_ = null;
        ...
        else
        {
            this.types_ = new zserio.runtime.array.Array(
                    new zserio.runtime.array.RawArray.ObjectRawArray<>(nds.lane.roadsurface.RoadSurfacePolygonType.class, types_),
                    new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.lane.roadsurface.RoadSurfacePolygonType>(new ZserioElementFactory_types()),
                    zserio.runtime.array.ArrayType.NORMAL);
        }
    }
    ...
    {
        if (obj instanceof RoadSurfacePolygonGeometryLayer)
        {
            final RoadSurfacePolygonGeometryLayer that = (RoadSurfacePolygonGeometryLayer)obj;
            ...
            throws java.io.IOException
    {
        ...
        if (getHasTypes())
        {
            ...
            types_ = new zserio.runtime.array.Array(
                    new zserio.runtime.array.RawArray.ObjectRawArray<>(nds.lane.roadsurface.RoadSurfacePolygonType.class),
                    new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.lane.roadsurface.RoadSurfacePolygonType>(new ZserioElementFactory_types()),
                    zserio.runtime.array.ArrayType.NORMAL);
    ...
    public void write(zserio.runtime.io.BitStreamWriter out) throws java.io.IOException
    {
        ...
        if (isIdentifierUsed())
        {
            ...
            {
                throw new zserio.runtime.ZserioError("Write: Wrong array length for field RoadSurfacePolygonGeometryLayer.identifier: " +
        ...
        if (isTypesUsed())
        {
            ...
            {
                throw new zserio.runtime.ZserioError("Write: Wrong array length for field RoadSurfacePolygonGeometryLayer.types: " +
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Inconsistent parameter type for field RoadSurfacePolygonGeometryLayer.buffers!");
        }
        if (buffers_.getShiftXY() != (byte)(getCoordShiftXY()))
        {
            throw new zserio.runtime.ZserioError("Write: Wrong parameter shiftXY for field RoadSurfacePolygonGeometryLayer.buffers: " +
                    buffers_.getShiftXY() + " != " + (byte)(getCoordShiftXY()) + "!");
        }
        if (buffers_.getShiftZ() != (byte)(getCoordShiftZ()))
        {
            throw new zserio.runtime.ZserioError("Write: Wrong parameter shiftZ for field RoadSurfacePolygonGeometryLayer.buffers: " +
                    buffers_.getShiftZ() + " != " + (byte)(getCoordShiftZ()) + "!");
        }
        if (buffers_.getNumElements() != (int)(getNumElements()))
        {
            throw new zserio.runtime.ZserioError("Write: Wrong parameter numElements for field RoadSurfacePolygonGeometryLayer.buffers: " +
    ...
    private static final class ZserioElementFactory_identifier implements zserio.runtime.array.PackableElementFactory<nds.core.types.Var4ByteId>
    {
        @Override
    ...
    private static final class ZserioElementFactory_types implements zserio.runtime.array.PackableElementFactory<nds.lane.roadsurface.RoadSurfacePolygonType>
    {
        @Override
        public nds.lane.roadsurface.RoadSurfacePolygonType create(zserio.runtime.io.BitStreamReader in, int index)
                throws java.io.IOException
        {
            return new nds.lane.roadsurface.RoadSurfacePolygonType(in);
        }

        @Override
        public zserio.runtime.array.PackingContext createPackingContext()
        {
            return new nds.lane.roadsurface.RoadSurfacePolygonType.ZserioPackingContext();
        }

        @Override
        public nds.lane.roadsurface.RoadSurfacePolygonType create(zserio.runtime.array.PackingContext context,
                zserio.runtime.io.BitStreamReader in, int index) throws java.io.IOException
        {
            return new nds.lane.roadsurface.RoadSurfacePolygonType(context, in);
        }
    }
