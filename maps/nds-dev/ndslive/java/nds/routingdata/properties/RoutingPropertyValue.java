...
public class RoutingPropertyValue implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    ...
    public RoutingPropertyValue(
            nds.routingdata.properties.RoutingPropertyType type_)
    {
        this.type_ = type_;
    }

    public RoutingPropertyValue(zserio.runtime.io.BitStreamReader in,
            nds.routingdata.properties.RoutingPropertyType type_)
    ...
    public RoutingPropertyValue(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in,
            nds.routingdata.properties.RoutingPropertyType type_)
            throws java.io.IOException
    {
        this.type_ = type_;
    ...
    public RoutingPropertyValue(
            nds.routingdata.properties.RoutingPropertyType type_,
            nds.routingdata.properties.PropertyValue value_,
    ...
    public nds.routingdata.properties.RoutingPropertyType getType()
    {
        return this.type_;
    }

    public nds.routingdata.properties.PropertyValue getValue()
    {
        return value_;
    }

    public void setValue(nds.routingdata.properties.PropertyValue value_)
    {
        this.value_ = value_;
    }
    ...
    {
        if (obj instanceof RoutingPropertyValue)
        {
            final RoutingPropertyValue that = (RoutingPropertyValue)obj;
            ...
            throws java.io.IOException
    {
        ...
        {
            value_ = new nds.routingdata.properties.PropertyValue(in, getType().getType());
        }
    ...
    public void write(zserio.runtime.io.BitStreamWriter out) throws java.io.IOException
    {
        if (isValueUsed())
        {
            ...
            {
                throw new zserio.runtime.ZserioError("Write: Inconsistent parameter type for field RoutingPropertyValue.value!");
            }
            value_.write(out);
        }
        ...
        if (isCoreValueUsed())
        {
            ...
            {
                throw new zserio.runtime.ZserioError("Write: Inconsistent parameter type for field RoutingPropertyValue.coreValue!");
            }
    ...
    private final nds.routingdata.properties.RoutingPropertyType type_;
    private nds.routingdata.properties.PropertyValue value_;
