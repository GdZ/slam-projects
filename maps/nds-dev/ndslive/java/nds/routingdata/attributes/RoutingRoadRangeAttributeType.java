...
public enum RoutingRoadRangeAttributeType implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf,
        zserio.runtime.ZserioEnum
{
    ...
    NUM_NORMAL_LANES((short)16),
    NUM_ENTRY_EXIT_LANES((short)17);

    private RoutingRoadRangeAttributeType(short value)
    {
        this.value = value;
    }
    ...
    public static RoutingRoadRangeAttributeType readEnum(zserio.runtime.io.BitStreamReader in) throws java.io.IOException
    {
        return toEnum(in.readVarUInt16());
    }

    public static RoutingRoadRangeAttributeType readEnum(zserio.runtime.array.PackingContext context,
    ...
    public static RoutingRoadRangeAttributeType toEnum(short value)
    {
        switch (value)
        {
            case (short)0:
            ...
            case (short)16:
                return NUM_NORMAL_LANES;
            case (short)17:
                return NUM_ENTRY_EXIT_LANES;
            default:
                throw new java.lang.IllegalArgumentException(
                        "Unknown value for enumeration RoutingRoadRangeAttributeType: " + value + "!");
        }
    }

    public static RoutingRoadRangeAttributeType toEnum(java.lang.String itemName)
    {
        ...
        if (itemName.equals("SPEED_PROFILES_DAYS"))
            return SPEED_PROFILES_DAYS;
        if (itemName.equals("NUM_NORMAL_LANES"))
            return NUM_NORMAL_LANES;
        if (itemName.equals("NUM_ENTRY_EXIT_LANES"))
            return NUM_ENTRY_EXIT_LANES;
        throw new java.lang.IllegalArgumentException(
                "Enum item '" + itemName + "' doesn't exist in enumeration RoutingRoadRangeAttributeType!");
    }
