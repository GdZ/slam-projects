...
public class RoutingRoadRangeAttributeValue implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    public static final class ZserioPackingContext extends zserio.runtime.array.PackingContext
    {
        public ZserioPackingContext()
        {
            ...
            numNormalLanes_ = new zserio.runtime.array.DeltaContext();
            numEntryExitLanes_ = new zserio.runtime.array.DeltaContext();
        }
        ...
        public zserio.runtime.array.DeltaContext getNumNormalLanes()
        {
            return numNormalLanes_;
        }

        public zserio.runtime.array.DeltaContext getNumEntryExitLanes()
        {
            return numEntryExitLanes_;
        }
        ...
        private zserio.runtime.array.DeltaContext numNormalLanes_;
        private zserio.runtime.array.DeltaContext numEntryExitLanes_;
    };

    public RoutingRoadRangeAttributeValue(
            nds.routingdata.attributes.RoutingRoadRangeAttributeType type_)
    {
        this.type_ = type_;
    }

    public RoutingRoadRangeAttributeValue(zserio.runtime.io.BitStreamReader in,
            nds.routingdata.attributes.RoutingRoadRangeAttributeType type_)
    ...
    public RoutingRoadRangeAttributeValue(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in,
            nds.routingdata.attributes.RoutingRoadRangeAttributeType type_)
            throws java.io.IOException
    {
        this.type_ = type_;
    ...
    public void initPackingContext(zserio.runtime.array.PackingContext context)
    {
        ...
        case SPEED_PROFILES_DAYS:
            ...
            break;
        case NUM_NORMAL_LANES:
            zserioContext.getNumNormalLanes().init(new zserio.runtime.array.ArrayTraits.BitFieldShortArrayTraits((int)(8)),
                    new zserio.runtime.array.ArrayElement.ShortArrayElement(getNumNormalLanes()));
            break;
        case NUM_ENTRY_EXIT_LANES:
            zserioContext.getNumEntryExitLanes().init(new zserio.runtime.array.ArrayTraits.BitFieldShortArrayTraits((int)(8)),
                    new zserio.runtime.array.ArrayElement.ShortArrayElement(getNumEntryExitLanes()));
            break;
        default:
            throw new zserio.runtime.ZserioError("No match in choice RoutingRoadRangeAttributeValue: " + getType() + "!");
        }
    }
    ...
    public int bitSizeOf(zserio.runtime.array.PackingContext context, long bitPosition)
    {
        ...
        case SPEED_PROFILES_DAYS:
            ...
            break;
        case NUM_NORMAL_LANES:
            endBitPosition += zserioContext.getNumNormalLanes().bitSizeOf(new zserio.runtime.array.ArrayTraits.BitFieldShortArrayTraits((int)(8)),
                    new zserio.runtime.array.ArrayElement.ShortArrayElement(getNumNormalLanes()));
            break;
        case NUM_ENTRY_EXIT_LANES:
            endBitPosition += zserioContext.getNumEntryExitLanes().bitSizeOf(new zserio.runtime.array.ArrayTraits.BitFieldShortArrayTraits((int)(8)),
                    new zserio.runtime.array.ArrayElement.ShortArrayElement(getNumEntryExitLanes()));
            break;
        default:
            throw new zserio.runtime.ZserioError("No match in choice RoutingRoadRangeAttributeValue: " + getType() + "!");
    ...
    public nds.routingdata.attributes.RoutingRoadRangeAttributeType getType()
    {
        return this.type_;
    }
    ...
    public short getNumNormalLanes()
    {
        return (java.lang.Short)objectChoice;
    }

    public void setNumNormalLanes(short numNormalLanes_)
    {
        objectChoice = numNormalLanes_;
    }

    public short getNumEntryExitLanes()
    {
        return (java.lang.Short)objectChoice;
    }

    public void setNumEntryExitLanes(short numEntryExitLanes_)
    {
        objectChoice = numEntryExitLanes_;
    }

    @Override
    public boolean equals(java.lang.Object obj)
    {
        if (obj instanceof RoutingRoadRangeAttributeValue)
        {
            final RoutingRoadRangeAttributeValue that = (RoutingRoadRangeAttributeValue)obj;
            ...
            throws java.io.IOException
    {
        ...
        case NUM_NORMAL_LANES:
            objectChoice = ((zserio.runtime.array.ArrayElement.ShortArrayElement)
                    zserioContext.getNumNormalLanes().read(new zserio.runtime.array.ArrayTraits.BitFieldShortArrayTraits((int)(8)), in)).get();
            break;
        case NUM_ENTRY_EXIT_LANES:
            objectChoice = ((zserio.runtime.array.ArrayElement.ShortArrayElement)
                    zserioContext.getNumEntryExitLanes().read(new zserio.runtime.array.ArrayTraits.BitFieldShortArrayTraits((int)(8)), in)).get();
            break;
        default:
            throw new zserio.runtime.ZserioError("No match in choice RoutingRoadRangeAttributeValue: " + getType() + "!");
        }
    ...
    public void write(zserio.runtime.io.BitStreamWriter out) throws java.io.IOException
    {
        ...
        case SPEED_PROFILES_DAYS:
            ...
            break;
        case NUM_NORMAL_LANES:
            out.writeUnsignedByte(getNumNormalLanes());
            break;
        case NUM_ENTRY_EXIT_LANES:
            out.writeUnsignedByte(getNumEntryExitLanes());
            break;
        default:
            throw new zserio.runtime.ZserioError("No match in choice RoutingRoadRangeAttributeValue: " + getType() + "!");
        }
            ...
            throws java.io.IOException
    {
        ...
        case SPEED_PROFILES_DAYS:
            ...
            break;
        case NUM_NORMAL_LANES:
            zserioContext.getNumNormalLanes().write(new zserio.runtime.array.ArrayTraits.BitFieldShortArrayTraits((int)(8)), out,
                    new zserio.runtime.array.ArrayElement.ShortArrayElement(getNumNormalLanes()));
            break;
        case NUM_ENTRY_EXIT_LANES:
            zserioContext.getNumEntryExitLanes().write(new zserio.runtime.array.ArrayTraits.BitFieldShortArrayTraits((int)(8)), out,
                    new zserio.runtime.array.ArrayElement.ShortArrayElement(getNumEntryExitLanes()));
            break;
        default:
            throw new zserio.runtime.ZserioError("No match in choice RoutingRoadRangeAttributeValue: " + getType() + "!");
    ...
    public static final int CHOICE_numNormalLanes = 16;
    public static final int CHOICE_numEntryExitLanes = 17;
    public static final int UNDEFINED_CHOICE = -1;

    private final nds.routingdata.attributes.RoutingRoadRangeAttributeType type_;
