...
public class RoutingLaneRangeFullAttribute implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    public static final class ZserioPackingContext extends zserio.runtime.array.PackingContext
    {
        public ZserioPackingContext()
        {
            ...
            attributeValue_ = new nds.routingdata.attributes.RoutingLaneRangeAttributeValue.ZserioPackingContext();
        ...
        public nds.routingdata.attributes.RoutingLaneRangeAttributeValue.ZserioPackingContext getAttributeValue()
        {
        ...
        private nds.routingdata.attributes.RoutingLaneRangeAttributeValue.ZserioPackingContext attributeValue_;
    ...
    public RoutingLaneRangeFullAttribute()
    {
    }

    public RoutingLaneRangeFullAttribute(zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        read(in);
    }

    public RoutingLaneRangeFullAttribute(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        read(context, in);
    }
    ...
    public RoutingLaneRangeFullAttribute(
            ...
            nds.routingdata.attributes.RoutingLaneRangeAttributeValue attributeValue_,
    ...
    public nds.routingdata.attributes.RoutingLaneRangeAttributeValue getAttributeValue()
    {
        return attributeValue_;
    }

    public void setAttributeValue(nds.routingdata.attributes.RoutingLaneRangeAttributeValue attributeValue_)
    {
    ...
    {
        if (obj instanceof RoutingLaneRangeFullAttribute)
        {
            final RoutingLaneRangeFullAttribute that = (RoutingLaneRangeFullAttribute)obj;
            ...
            throws java.io.IOException
    {
        ...
        attributeValue_ = new nds.routingdata.attributes.RoutingLaneRangeAttributeValue(in, getAttributeTypeCode());
            ...
            throws java.io.IOException
    {
        ...
        attributeValue_ = new nds.routingdata.attributes.RoutingLaneRangeAttributeValue(zserioContext.getAttributeValue(), in, getAttributeTypeCode());
    ...
    public void write(zserio.runtime.io.BitStreamWriter out) throws java.io.IOException
    {
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Inconsistent parameter type for field RoutingLaneRangeFullAttribute.attributeValue!");
        }
    ...
    private nds.routingdata.attributes.RoutingLaneRangeAttributeValue attributeValue_;
