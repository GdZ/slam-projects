...
public class RoutingRoadTransitionAttributeMap implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    ...
    public RoutingRoadTransitionAttributeMap(
            byte coordShift_)
    {
        this.coordShift_ = coordShift_;
    }

    public RoutingRoadTransitionAttributeMap(zserio.runtime.io.BitStreamReader in,
            byte coordShift_)
    ...
    public RoutingRoadTransitionAttributeMap(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in,
            byte coordShift_)
            throws java.io.IOException
    {
        this.coordShift_ = coordShift_;
    ...
    public RoutingRoadTransitionAttributeMap(
            ...
            int attribute_,
            nds.routingdata.instantiations.RoutingRoadTransitionAttribute[] attributeValues_,
    ...
    public void setAttributeTypeCode(nds.routingdata.attributes.RoutingRoadTransitionAttributeType attributeTypeCode_)
    {
    ...
    public nds.routingdata.instantiations.RoutingRoadTransitionAttribute[] getAttributeValues()
    {
        return (attributeValues_ == null) ? null : attributeValues_.getRawArray();
    }

    public void setAttributeValues(nds.routingdata.instantiations.RoutingRoadTransitionAttribute[] attributeValues_)
    {
        this.attributeValues_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.ObjectRawArray<>(nds.routingdata.instantiations.RoutingRoadTransitionAttribute.class, attributeValues_),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.routingdata.instantiations.RoutingRoadTransitionAttribute>(new ZserioElementFactory_attributeValues()),
                zserio.runtime.array.ArrayType.NORMAL);
    }
    ...
    {
        if (obj instanceof RoutingRoadTransitionAttributeMap)
        {
            final RoutingRoadTransitionAttributeMap that = (RoutingRoadTransitionAttributeMap)obj;
    ...
    public void read(zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        attributeTypeCode_ = nds.routingdata.attributes.RoutingRoadTransitionAttributeType.readEnum(in);
        ...
        attributeValues_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.ObjectRawArray<>(nds.routingdata.instantiations.RoutingRoadTransitionAttribute.class),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.routingdata.instantiations.RoutingRoadTransitionAttribute>(new ZserioElementFactory_attributeValues()),
                zserio.runtime.array.ArrayType.NORMAL);
    ...
    {
        final ZserioPackingContext zserioContext = context.cast();
        attributeTypeCode_ = nds.routingdata.attributes.RoutingRoadTransitionAttributeType.readEnum(zserioContext.getAttributeTypeCode(), in);
    ...
    public void write(zserio.runtime.io.BitStreamWriter out) throws java.io.IOException
    {
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field RoutingRoadTransitionAttributeMap.featureReferences: " +
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field RoutingRoadTransitionAttributeMap.featureValidities: " +
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field RoutingRoadTransitionAttributeMap.featureValuePtr: " +
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field RoutingRoadTransitionAttributeMap.attributeValues: " +
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field RoutingRoadTransitionAttributeMap.attributeProperties: " +
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field RoutingRoadTransitionAttributeMap.attributeConditions: " +
    ...
    private final class ZserioElementFactory_attributeValues implements zserio.runtime.array.PackableElementFactory<nds.routingdata.instantiations.RoutingRoadTransitionAttribute>
    {
        @Override
        public nds.routingdata.instantiations.RoutingRoadTransitionAttribute create(zserio.runtime.io.BitStreamReader in, int index)
                throws java.io.IOException
        {
            return new nds.routingdata.instantiations.RoutingRoadTransitionAttribute(in, getAttributeTypeCode());
        }

        @Override
        public zserio.runtime.array.PackingContext createPackingContext()
        {
            return new nds.routingdata.instantiations.RoutingRoadTransitionAttribute.ZserioPackingContext();
        }

        @Override
        public nds.routingdata.instantiations.RoutingRoadTransitionAttribute create(zserio.runtime.array.PackingContext context,
                zserio.runtime.io.BitStreamReader in, int index) throws java.io.IOException
        {
            return new nds.routingdata.instantiations.RoutingRoadTransitionAttribute(context, in, getAttributeTypeCode());
        }
    }
    ...
    private nds.routingdata.attributes.RoutingRoadTransitionAttributeType attributeTypeCode_;
