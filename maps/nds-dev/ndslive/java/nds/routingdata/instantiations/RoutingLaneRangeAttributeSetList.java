...
public class RoutingLaneRangeAttributeSetList implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    ...
    public RoutingLaneRangeAttributeSetList(
            byte coordShift_)
    {
        this.coordShift_ = coordShift_;
    }

    public RoutingLaneRangeAttributeSetList(zserio.runtime.io.BitStreamReader in,
            byte coordShift_)
    ...
    public RoutingLaneRangeAttributeSetList(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in,
            byte coordShift_)
            throws java.io.IOException
    {
        this.coordShift_ = coordShift_;
    ...
    public RoutingLaneRangeAttributeSetList(
            ...
            nds.routingdata.instantiations.RoutingLaneRangeAttributeSetMap[] sets_)
    {
        this(coordShift_);
    ...
    public nds.routingdata.instantiations.RoutingLaneRangeAttributeSetMap[] getSets()
    {
        return (sets_ == null) ? null : sets_.getRawArray();
    }

    public void setSets(nds.routingdata.instantiations.RoutingLaneRangeAttributeSetMap[] sets_)
    {
        this.sets_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.ObjectRawArray<>(nds.routingdata.instantiations.RoutingLaneRangeAttributeSetMap.class, sets_),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.routingdata.instantiations.RoutingLaneRangeAttributeSetMap>(new ZserioElementFactory_sets()),
    ...
    {
        if (obj instanceof RoutingLaneRangeAttributeSetList)
        {
            final RoutingLaneRangeAttributeSetList that = (RoutingLaneRangeAttributeSetList)obj;
            ...
            throws java.io.IOException
    {
        ...
        sets_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.ObjectRawArray<>(nds.routingdata.instantiations.RoutingLaneRangeAttributeSetMap.class),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.routingdata.instantiations.RoutingLaneRangeAttributeSetMap>(new ZserioElementFactory_sets()),
                zserio.runtime.array.ArrayType.NORMAL);
    ...
    public void write(zserio.runtime.io.BitStreamWriter out) throws java.io.IOException
    {
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field RoutingLaneRangeAttributeSetList.sets: " +
    ...
    private final class ZserioElementFactory_sets implements zserio.runtime.array.PackableElementFactory<nds.routingdata.instantiations.RoutingLaneRangeAttributeSetMap>
    {
        @Override
        public nds.routingdata.instantiations.RoutingLaneRangeAttributeSetMap create(zserio.runtime.io.BitStreamReader in, int index)
                throws java.io.IOException
        {
            return new nds.routingdata.instantiations.RoutingLaneRangeAttributeSetMap(in, (byte)(getCoordShift()));
        }

        @Override
        public zserio.runtime.array.PackingContext createPackingContext()
        {
            return new nds.routingdata.instantiations.RoutingLaneRangeAttributeSetMap.ZserioPackingContext();
        }

        @Override
        public nds.routingdata.instantiations.RoutingLaneRangeAttributeSetMap create(zserio.runtime.array.PackingContext context,
                zserio.runtime.io.BitStreamReader in, int index) throws java.io.IOException
        {
            return new nds.routingdata.instantiations.RoutingLaneRangeAttributeSetMap(context, in, (byte)(getCoordShift()));
        }
    }
