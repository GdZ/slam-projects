...
public class RoutingLaneTransitionAttributeSetMap implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    public static final class ZserioPackingContext extends zserio.runtime.array.PackingContext
    {
        public ZserioPackingContext()
        {
            attributeSet_ = new nds.routingdata.instantiations.RoutingLaneTransitionAttributeSet.ZserioPackingContext();
            feature_ = new zserio.runtime.array.DeltaContext();
        }

        public nds.routingdata.instantiations.RoutingLaneTransitionAttributeSet.ZserioPackingContext getAttributeSet()
        {
        ...
        private nds.routingdata.instantiations.RoutingLaneTransitionAttributeSet.ZserioPackingContext attributeSet_;
        private zserio.runtime.array.DeltaContext feature_;
    };

    public RoutingLaneTransitionAttributeSetMap(
            byte coordShift_)
    {
        this.coordShift_ = coordShift_;
    }

    public RoutingLaneTransitionAttributeSetMap(zserio.runtime.io.BitStreamReader in,
            byte coordShift_)
    ...
    public RoutingLaneTransitionAttributeSetMap(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in,
            byte coordShift_)
            throws java.io.IOException
    {
        this.coordShift_ = coordShift_;
    ...
    public RoutingLaneTransitionAttributeSetMap(
            byte coordShift_,
            nds.routingdata.instantiations.RoutingLaneTransitionAttributeSet attributeSet_,
            int feature_,
            nds.lane.reference.types.LaneGroupTransition[] references_,
    ...
    public nds.routingdata.instantiations.RoutingLaneTransitionAttributeSet getAttributeSet()
    {
        return attributeSet_;
    }

    public void setAttributeSet(nds.routingdata.instantiations.RoutingLaneTransitionAttributeSet attributeSet_)
    {
    ...
    public nds.lane.reference.types.LaneGroupTransition[] getReferences()
    {
        return (references_ == null) ? null : references_.getRawArray();
    }

    public void setReferences(nds.lane.reference.types.LaneGroupTransition[] references_)
    {
        this.references_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.ObjectRawArray<>(nds.lane.reference.types.LaneGroupTransition.class, references_),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.lane.reference.types.LaneGroupTransition>(new ZserioElementFactory_references()),
    ...
    {
        if (obj instanceof RoutingLaneTransitionAttributeSetMap)
        {
            final RoutingLaneTransitionAttributeSetMap that = (RoutingLaneTransitionAttributeSetMap)obj;
    ...
    public void read(zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        attributeSet_ = new nds.routingdata.instantiations.RoutingLaneTransitionAttributeSet(in);
    ...
    {
        final ZserioPackingContext zserioContext = context.cast();
        attributeSet_ = new nds.routingdata.instantiations.RoutingLaneTransitionAttributeSet(zserioContext.getAttributeSet(), in);
    ...
    public void write(zserio.runtime.io.BitStreamWriter out) throws java.io.IOException
    {
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field RoutingLaneTransitionAttributeSetMap.references: " +
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field RoutingLaneTransitionAttributeSetMap.validities: " +
    ...
    private static final class ZserioElementFactory_references implements zserio.runtime.array.PackableElementFactory<nds.lane.reference.types.LaneGroupTransition>
    {
        @Override
    ...
    private nds.routingdata.instantiations.RoutingLaneTransitionAttributeSet attributeSet_;
