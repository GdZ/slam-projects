...
public class RoutingRoadTransitionAttributeMapListHeader implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    public static final class ZserioPackingContext extends zserio.runtime.array.PackingContext
    {
    };

    public RoutingRoadTransitionAttributeMapListHeader(
            short numMaps_)
    {
        this.numMaps_ = numMaps_;
    }

    public RoutingRoadTransitionAttributeMapListHeader(zserio.runtime.io.BitStreamReader in,
            short numMaps_)
    ...
    public RoutingRoadTransitionAttributeMapListHeader(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in,
            short numMaps_)
            throws java.io.IOException
    {
        this.numMaps_ = numMaps_;
    ...
    public void setAttributeTypeCode(nds.routingdata.attributes.RoutingRoadTransitionAttributeType[] attributeTypeCode_)
    {
        this.attributeTypeCode_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.EnumRawArray<>(nds.routingdata.attributes.RoutingRoadTransitionAttributeType.class, attributeTypeCode_),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.routingdata.attributes.RoutingRoadTransitionAttributeType>(new ZserioElementFactory_attributeTypeCode()),
    ...
    {
        if (obj instanceof RoutingRoadTransitionAttributeMapListHeader)
        {
            final RoutingRoadTransitionAttributeMapListHeader that = (RoutingRoadTransitionAttributeMapListHeader)obj;
    ...
    public void write(zserio.runtime.io.BitStreamWriter out) throws java.io.IOException
    {
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field RoutingRoadTransitionAttributeMapListHeader.attributeTypeCode: " +
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field RoutingRoadTransitionAttributeMapListHeader.conditionType: " +
    ...
    private static final class ZserioElementFactory_attributeTypeCode implements zserio.runtime.array.PackableElementFactory<nds.routingdata.attributes.RoutingRoadTransitionAttributeType>
    {
        @Override
