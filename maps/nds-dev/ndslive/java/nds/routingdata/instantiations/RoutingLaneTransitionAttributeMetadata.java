...
public class RoutingLaneTransitionAttributeMetadata implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    ...
    public RoutingLaneTransitionAttributeMetadata()
    {
    }

    public RoutingLaneTransitionAttributeMetadata(zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        read(in);
    }

    public RoutingLaneTransitionAttributeMetadata(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        read(context, in);
    }
    ...
    public RoutingLaneTransitionAttributeMetadata(
            nds.routingdata.attributes.RoutingLaneTransitionAttributeType[] availableAttributes_,
    ...
    public nds.routingdata.attributes.RoutingLaneTransitionAttributeType[] getAvailableAttributes()
    {
        return (availableAttributes_ == null) ? null : availableAttributes_.getRawArray();
    }

    public void setAvailableAttributes(nds.routingdata.attributes.RoutingLaneTransitionAttributeType[] availableAttributes_)
    {
        this.availableAttributes_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.EnumRawArray<>(nds.routingdata.attributes.RoutingLaneTransitionAttributeType.class, availableAttributes_),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.routingdata.attributes.RoutingLaneTransitionAttributeType>(new ZserioElementFactory_availableAttributes()),
    ...
    {
        if (obj instanceof RoutingLaneTransitionAttributeMetadata)
        {
            final RoutingLaneTransitionAttributeMetadata that = (RoutingLaneTransitionAttributeMetadata)obj;
    ...
    private static final class ZserioElementFactory_availableAttributes implements zserio.runtime.array.PackableElementFactory<nds.routingdata.attributes.RoutingLaneTransitionAttributeType>
    {
        @Override
