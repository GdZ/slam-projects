...
public class RoutingRoadRangeAttributeSetList implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    ...
    public RoutingRoadRangeAttributeSetList(
            byte coordShift_)
    {
        this.coordShift_ = coordShift_;
    }

    public RoutingRoadRangeAttributeSetList(zserio.runtime.io.BitStreamReader in,
            byte coordShift_)
    ...
    public RoutingRoadRangeAttributeSetList(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in,
            byte coordShift_)
            throws java.io.IOException
    {
        this.coordShift_ = coordShift_;
    ...
    public RoutingRoadRangeAttributeSetList(
            ...
            nds.routingdata.instantiations.RoutingRoadRangeAttributeSetMap[] sets_)
    {
        this(coordShift_);
    ...
    public nds.routingdata.instantiations.RoutingRoadRangeAttributeSetMap[] getSets()
    {
        return (sets_ == null) ? null : sets_.getRawArray();
    }

    public void setSets(nds.routingdata.instantiations.RoutingRoadRangeAttributeSetMap[] sets_)
    {
        this.sets_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.ObjectRawArray<>(nds.routingdata.instantiations.RoutingRoadRangeAttributeSetMap.class, sets_),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.routingdata.instantiations.RoutingRoadRangeAttributeSetMap>(new ZserioElementFactory_sets()),
    ...
    {
        if (obj instanceof RoutingRoadRangeAttributeSetList)
        {
            final RoutingRoadRangeAttributeSetList that = (RoutingRoadRangeAttributeSetList)obj;
            ...
            throws java.io.IOException
    {
        ...
        sets_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.ObjectRawArray<>(nds.routingdata.instantiations.RoutingRoadRangeAttributeSetMap.class),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.routingdata.instantiations.RoutingRoadRangeAttributeSetMap>(new ZserioElementFactory_sets()),
                zserio.runtime.array.ArrayType.NORMAL);
    ...
    public void write(zserio.runtime.io.BitStreamWriter out) throws java.io.IOException
    {
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field RoutingRoadRangeAttributeSetList.sets: " +
    ...
    private final class ZserioElementFactory_sets implements zserio.runtime.array.PackableElementFactory<nds.routingdata.instantiations.RoutingRoadRangeAttributeSetMap>
    {
        @Override
        public nds.routingdata.instantiations.RoutingRoadRangeAttributeSetMap create(zserio.runtime.io.BitStreamReader in, int index)
                throws java.io.IOException
        {
            return new nds.routingdata.instantiations.RoutingRoadRangeAttributeSetMap(in, (byte)(getCoordShift()));
        }

        @Override
        public zserio.runtime.array.PackingContext createPackingContext()
        {
            return new nds.routingdata.instantiations.RoutingRoadRangeAttributeSetMap.ZserioPackingContext();
        }

        @Override
        public nds.routingdata.instantiations.RoutingRoadRangeAttributeSetMap create(zserio.runtime.array.PackingContext context,
                zserio.runtime.io.BitStreamReader in, int index) throws java.io.IOException
        {
            return new nds.routingdata.instantiations.RoutingRoadRangeAttributeSetMap(context, in, (byte)(getCoordShift()));
        }
    }
