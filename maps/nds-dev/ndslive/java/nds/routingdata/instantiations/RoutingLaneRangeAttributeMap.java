...
public class RoutingLaneRangeAttributeMap implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    ...
    public RoutingLaneRangeAttributeMap(
            byte coordShift_)
    {
        this.coordShift_ = coordShift_;
    }

    public RoutingLaneRangeAttributeMap(zserio.runtime.io.BitStreamReader in,
            byte coordShift_)
    ...
    public RoutingLaneRangeAttributeMap(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in,
            byte coordShift_)
            throws java.io.IOException
    {
        this.coordShift_ = coordShift_;
    ...
    public RoutingLaneRangeAttributeMap(
            ...
            int attribute_,
            nds.routingdata.instantiations.RoutingLaneRangeAttribute[] attributeValues_,
    ...
    public nds.routingdata.attributes.RoutingLaneRangeAttributeType getAttributeTypeCode()
    {
        return attributeTypeCode_;
    }

    public void setAttributeTypeCode(nds.routingdata.attributes.RoutingLaneRangeAttributeType attributeTypeCode_)
    {
    ...
    public nds.routingdata.instantiations.RoutingLaneRangeAttribute[] getAttributeValues()
    {
        return (attributeValues_ == null) ? null : attributeValues_.getRawArray();
    }

    public void setAttributeValues(nds.routingdata.instantiations.RoutingLaneRangeAttribute[] attributeValues_)
    {
        this.attributeValues_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.ObjectRawArray<>(nds.routingdata.instantiations.RoutingLaneRangeAttribute.class, attributeValues_),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.routingdata.instantiations.RoutingLaneRangeAttribute>(new ZserioElementFactory_attributeValues()),
                zserio.runtime.array.ArrayType.NORMAL);
    }
    ...
    {
        if (obj instanceof RoutingLaneRangeAttributeMap)
        {
            final RoutingLaneRangeAttributeMap that = (RoutingLaneRangeAttributeMap)obj;
    ...
    public void read(zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        attributeTypeCode_ = nds.routingdata.attributes.RoutingLaneRangeAttributeType.readEnum(in);
        ...
        attributeValues_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.ObjectRawArray<>(nds.routingdata.instantiations.RoutingLaneRangeAttribute.class),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.routingdata.instantiations.RoutingLaneRangeAttribute>(new ZserioElementFactory_attributeValues()),
                zserio.runtime.array.ArrayType.NORMAL);
    ...
    {
        final ZserioPackingContext zserioContext = context.cast();
        attributeTypeCode_ = nds.routingdata.attributes.RoutingLaneRangeAttributeType.readEnum(zserioContext.getAttributeTypeCode(), in);
    ...
    public void write(zserio.runtime.io.BitStreamWriter out) throws java.io.IOException
    {
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field RoutingLaneRangeAttributeMap.featureReferences: " +
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field RoutingLaneRangeAttributeMap.featureValidities: " +
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field RoutingLaneRangeAttributeMap.featureValuePtr: " +
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field RoutingLaneRangeAttributeMap.attributeValues: " +
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field RoutingLaneRangeAttributeMap.attributeProperties: " +
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field RoutingLaneRangeAttributeMap.attributeConditions: " +
    ...
    private final class ZserioElementFactory_attributeValues implements zserio.runtime.array.PackableElementFactory<nds.routingdata.instantiations.RoutingLaneRangeAttribute>
    {
        @Override
        public nds.routingdata.instantiations.RoutingLaneRangeAttribute create(zserio.runtime.io.BitStreamReader in, int index)
                throws java.io.IOException
        {
            return new nds.routingdata.instantiations.RoutingLaneRangeAttribute(in, getAttributeTypeCode());
        }

        @Override
        public zserio.runtime.array.PackingContext createPackingContext()
        {
            return new nds.routingdata.instantiations.RoutingLaneRangeAttribute.ZserioPackingContext();
        }

        @Override
        public nds.routingdata.instantiations.RoutingLaneRangeAttribute create(zserio.runtime.array.PackingContext context,
                zserio.runtime.io.BitStreamReader in, int index) throws java.io.IOException
        {
            return new nds.routingdata.instantiations.RoutingLaneRangeAttribute(context, in, getAttributeTypeCode());
        }
    }
    ...
    private nds.routingdata.attributes.RoutingLaneRangeAttributeType attributeTypeCode_;
