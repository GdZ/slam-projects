...
public class LandmarkColor implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    ...
    public LandmarkColor()
    {
    }

    public LandmarkColor(zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        read(in);
    }

    public LandmarkColor(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        read(context, in);
    }
    ...
    {
        if (obj instanceof LandmarkColor)
        {
            final LandmarkColor that = (LandmarkColor)obj;
