...
package nds.localization.properties;

public class LocalizationPropertyValue implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    ...
    public LocalizationPropertyValue(
            nds.localization.properties.LocalizationPropertyType type_)
    {
        this.type_ = type_;
    }

    public LocalizationPropertyValue(zserio.runtime.io.BitStreamReader in,
            nds.localization.properties.LocalizationPropertyType type_)
    ...
    public LocalizationPropertyValue(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in,
            nds.localization.properties.LocalizationPropertyType type_)
            throws java.io.IOException
    {
        this.type_ = type_;
    ...
    public LocalizationPropertyValue(
            nds.localization.properties.LocalizationPropertyType type_,
            nds.localization.properties.PropertyValue value_,
    ...
    public nds.localization.properties.LocalizationPropertyType getType()
    {
        return this.type_;
    }

    public nds.localization.properties.PropertyValue getValue()
    {
        return value_;
    }

    public void setValue(nds.localization.properties.PropertyValue value_)
    {
        this.value_ = value_;
    }
    ...
    {
        if (obj instanceof LocalizationPropertyValue)
        {
            final LocalizationPropertyValue that = (LocalizationPropertyValue)obj;
            ...
            throws java.io.IOException
    {
        ...
        {
            value_ = new nds.localization.properties.PropertyValue(in, getType().getType());
        }
    ...
    public void write(zserio.runtime.io.BitStreamWriter out) throws java.io.IOException
    {
        if (isValueUsed())
        {
            ...
            {
                throw new zserio.runtime.ZserioError("Write: Inconsistent parameter type for field LocalizationPropertyValue.value!");
            }
            value_.write(out);
        }
        ...
        if (isCoreValueUsed())
        {
            ...
            {
                throw new zserio.runtime.ZserioError("Write: Inconsistent parameter type for field LocalizationPropertyValue.coreValue!");
            }
    ...
    private final nds.localization.properties.LocalizationPropertyType type_;
    private nds.localization.properties.PropertyValue value_;
