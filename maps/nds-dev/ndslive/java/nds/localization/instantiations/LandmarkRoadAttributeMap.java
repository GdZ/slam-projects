...
public class LandmarkRoadAttributeMap implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    ...
    public LandmarkRoadAttributeMap(
            byte coordShift_)
    {
        this.coordShift_ = coordShift_;
    }

    public LandmarkRoadAttributeMap(zserio.runtime.io.BitStreamReader in,
            byte coordShift_)
    ...
    public LandmarkRoadAttributeMap(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in,
            byte coordShift_)
            throws java.io.IOException
    {
        this.coordShift_ = coordShift_;
    ...
    public LandmarkRoadAttributeMap(
            ...
            int attribute_,
            nds.localization.instantiations.LandmarkAttribute[] attributeValues_,
    ...
    public nds.localization.attributes.LandmarkRelationAttributeType getAttributeTypeCode()
    {
        return attributeTypeCode_;
    }

    public void setAttributeTypeCode(nds.localization.attributes.LandmarkRelationAttributeType attributeTypeCode_)
    {
    ...
    public nds.localization.instantiations.LandmarkAttribute[] getAttributeValues()
    {
        return (attributeValues_ == null) ? null : attributeValues_.getRawArray();
    }

    public void setAttributeValues(nds.localization.instantiations.LandmarkAttribute[] attributeValues_)
    {
        this.attributeValues_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.ObjectRawArray<>(nds.localization.instantiations.LandmarkAttribute.class, attributeValues_),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.localization.instantiations.LandmarkAttribute>(new ZserioElementFactory_attributeValues()),
                zserio.runtime.array.ArrayType.NORMAL);
    }
    ...
    {
        if (obj instanceof LandmarkRoadAttributeMap)
        {
            final LandmarkRoadAttributeMap that = (LandmarkRoadAttributeMap)obj;
    ...
    public void read(zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        attributeTypeCode_ = nds.localization.attributes.LandmarkRelationAttributeType.readEnum(in);
        ...
        attributeValues_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.ObjectRawArray<>(nds.localization.instantiations.LandmarkAttribute.class),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.localization.instantiations.LandmarkAttribute>(new ZserioElementFactory_attributeValues()),
                zserio.runtime.array.ArrayType.NORMAL);
    ...
    {
        final ZserioPackingContext zserioContext = context.cast();
        attributeTypeCode_ = nds.localization.attributes.LandmarkRelationAttributeType.readEnum(zserioContext.getAttributeTypeCode(), in);
    ...
    public void write(zserio.runtime.io.BitStreamWriter out) throws java.io.IOException
    {
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field LandmarkRoadAttributeMap.featureReferences: " +
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field LandmarkRoadAttributeMap.featureValidities: " +
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field LandmarkRoadAttributeMap.featureValuePtr: " +
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field LandmarkRoadAttributeMap.attributeValues: " +
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field LandmarkRoadAttributeMap.attributeProperties: " +
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field LandmarkRoadAttributeMap.attributeConditions: " +
    ...
    private final class ZserioElementFactory_attributeValues implements zserio.runtime.array.PackableElementFactory<nds.localization.instantiations.LandmarkAttribute>
    {
        @Override
        public nds.localization.instantiations.LandmarkAttribute create(zserio.runtime.io.BitStreamReader in, int index)
                throws java.io.IOException
        {
            return new nds.localization.instantiations.LandmarkAttribute(in, getAttributeTypeCode());
        }

        @Override
        public zserio.runtime.array.PackingContext createPackingContext()
        {
            return new nds.localization.instantiations.LandmarkAttribute.ZserioPackingContext();
        }

        @Override
        public nds.localization.instantiations.LandmarkAttribute create(zserio.runtime.array.PackingContext context,
                zserio.runtime.io.BitStreamReader in, int index) throws java.io.IOException
        {
            return new nds.localization.instantiations.LandmarkAttribute(context, in, getAttributeTypeCode());
        }
    }
    ...
    private nds.localization.attributes.LandmarkRelationAttributeType attributeTypeCode_;
