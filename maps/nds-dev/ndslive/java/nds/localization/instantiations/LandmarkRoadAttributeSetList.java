...
public class LandmarkRoadAttributeSetList implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    ...
    public LandmarkRoadAttributeSetList(
            byte coordShift_)
    {
        this.coordShift_ = coordShift_;
    }

    public LandmarkRoadAttributeSetList(zserio.runtime.io.BitStreamReader in,
            byte coordShift_)
    ...
    public LandmarkRoadAttributeSetList(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in,
            byte coordShift_)
            throws java.io.IOException
    {
        this.coordShift_ = coordShift_;
    ...
    public LandmarkRoadAttributeSetList(
            ...
            nds.localization.instantiations.LandmarkRoadAttributeSetMap[] sets_)
    {
        this(coordShift_);
    ...
    public nds.localization.instantiations.LandmarkRoadAttributeSetMap[] getSets()
    {
        return (sets_ == null) ? null : sets_.getRawArray();
    }

    public void setSets(nds.localization.instantiations.LandmarkRoadAttributeSetMap[] sets_)
    {
        this.sets_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.ObjectRawArray<>(nds.localization.instantiations.LandmarkRoadAttributeSetMap.class, sets_),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.localization.instantiations.LandmarkRoadAttributeSetMap>(new ZserioElementFactory_sets()),
    ...
    {
        if (obj instanceof LandmarkRoadAttributeSetList)
        {
            final LandmarkRoadAttributeSetList that = (LandmarkRoadAttributeSetList)obj;
            ...
            throws java.io.IOException
    {
        ...
        sets_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.ObjectRawArray<>(nds.localization.instantiations.LandmarkRoadAttributeSetMap.class),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.localization.instantiations.LandmarkRoadAttributeSetMap>(new ZserioElementFactory_sets()),
                zserio.runtime.array.ArrayType.NORMAL);
    ...
    public void write(zserio.runtime.io.BitStreamWriter out) throws java.io.IOException
    {
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field LandmarkRoadAttributeSetList.sets: " +
    ...
    private final class ZserioElementFactory_sets implements zserio.runtime.array.PackableElementFactory<nds.localization.instantiations.LandmarkRoadAttributeSetMap>
    {
        @Override
        public nds.localization.instantiations.LandmarkRoadAttributeSetMap create(zserio.runtime.io.BitStreamReader in, int index)
                throws java.io.IOException
        {
            return new nds.localization.instantiations.LandmarkRoadAttributeSetMap(in, (byte)(getCoordShift()));
        }

        @Override
        public zserio.runtime.array.PackingContext createPackingContext()
        {
            return new nds.localization.instantiations.LandmarkRoadAttributeSetMap.ZserioPackingContext();
        }

        @Override
        public nds.localization.instantiations.LandmarkRoadAttributeSetMap create(zserio.runtime.array.PackingContext context,
                zserio.runtime.io.BitStreamReader in, int index) throws java.io.IOException
        {
            return new nds.localization.instantiations.LandmarkRoadAttributeSetMap(context, in, (byte)(getCoordShift()));
        }
    }
