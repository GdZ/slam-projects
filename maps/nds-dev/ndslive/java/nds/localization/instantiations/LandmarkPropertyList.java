...
public class LandmarkPropertyList implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    ...
    public LandmarkPropertyList()
    {
    }

    public LandmarkPropertyList(zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        read(in);
    }

    public LandmarkPropertyList(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        read(context, in);
    }
    ...
    public LandmarkPropertyList(
            ...
            nds.localization.instantiations.LocalizationProperty[] property_)
    {
    ...
    public nds.localization.instantiations.LocalizationProperty[] getProperty()
    {
        return (property_ == null) ? null : property_.getRawArray();
    }

    public void setProperty(nds.localization.instantiations.LocalizationProperty[] property_)
    {
        if (property_ == null)
        {
            this.property_ = null;
        ...
        else
        {
            this.property_ = new zserio.runtime.array.Array(
                    new zserio.runtime.array.RawArray.ObjectRawArray<>(nds.localization.instantiations.LocalizationProperty.class, property_),
                    new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.localization.instantiations.LocalizationProperty>(new ZserioElementFactory_property()),
    ...
    {
        if (obj instanceof LandmarkPropertyList)
        {
            final LandmarkPropertyList that = (LandmarkPropertyList)obj;
            ...
            throws java.io.IOException
    {
        ...
        if (getNumProperties() > 0)
        {
            property_ = new zserio.runtime.array.Array(
                    new zserio.runtime.array.RawArray.ObjectRawArray<>(nds.localization.instantiations.LocalizationProperty.class),
                    new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.localization.instantiations.LocalizationProperty>(new ZserioElementFactory_property()),
                    zserio.runtime.array.ArrayType.NORMAL);
    ...
    public void write(zserio.runtime.io.BitStreamWriter out) throws java.io.IOException
    {
        ...
        if (isPropertyUsed())
        {
            ...
            {
                throw new zserio.runtime.ZserioError("Write: Wrong array length for field LandmarkPropertyList.property: " +
    ...
    private static final class ZserioElementFactory_property implements zserio.runtime.array.PackableElementFactory<nds.localization.instantiations.LocalizationProperty>
    {
        @Override
        public nds.localization.instantiations.LocalizationProperty create(zserio.runtime.io.BitStreamReader in, int index)
                throws java.io.IOException
        {
            return new nds.localization.instantiations.LocalizationProperty(in);
        }

        @Override
        public zserio.runtime.array.PackingContext createPackingContext()
        {
            return new nds.localization.instantiations.LocalizationProperty.ZserioPackingContext();
        }

        @Override
        public nds.localization.instantiations.LocalizationProperty create(zserio.runtime.array.PackingContext context,
                zserio.runtime.io.BitStreamReader in, int index) throws java.io.IOException
        {
            return new nds.localization.instantiations.LocalizationProperty(context, in);
        }
    }
