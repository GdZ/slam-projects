...
public class LandmarkFullAttribute implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    public static final class ZserioPackingContext extends zserio.runtime.array.PackingContext
    {
        public ZserioPackingContext()
        {
            ...
            attributeValue_ = new nds.localization.attributes.LandmarkRelationAttributeValue.ZserioPackingContext();
            properties_ = new nds.localization.instantiations.LandmarkPropertyList.ZserioPackingContext();
        ...
        public nds.localization.attributes.LandmarkRelationAttributeValue.ZserioPackingContext getAttributeValue()
        {
            return attributeValue_;
        }

        public nds.localization.instantiations.LandmarkPropertyList.ZserioPackingContext getProperties()
        {
            return properties_;
        }
        ...
        private nds.localization.attributes.LandmarkRelationAttributeValue.ZserioPackingContext attributeValue_;
        private nds.localization.instantiations.LandmarkPropertyList.ZserioPackingContext properties_;
        private nds.core.attributemap.ConditionList.ZserioPackingContext conditions_;
    };

    public LandmarkFullAttribute()
    {
    }

    public LandmarkFullAttribute(zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        read(in);
    }

    public LandmarkFullAttribute(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        read(context, in);
    }
    ...
    public LandmarkFullAttribute(
            ...
            nds.localization.attributes.LandmarkRelationAttributeValue attributeValue_,
            nds.localization.instantiations.LandmarkPropertyList properties_,
    ...
    public nds.localization.attributes.LandmarkRelationAttributeValue getAttributeValue()
    {
        return attributeValue_;
    }

    public void setAttributeValue(nds.localization.attributes.LandmarkRelationAttributeValue attributeValue_)
    {
        this.attributeValue_ = attributeValue_;
    }

    public nds.localization.instantiations.LandmarkPropertyList getProperties()
    {
        return properties_;
    }

    public void setProperties(nds.localization.instantiations.LandmarkPropertyList properties_)
    {
    ...
    {
        if (obj instanceof LandmarkFullAttribute)
        {
            final LandmarkFullAttribute that = (LandmarkFullAttribute)obj;
            ...
            throws java.io.IOException
    {
        ...
        attributeValue_ = new nds.localization.attributes.LandmarkRelationAttributeValue(in, getAttributeTypeCode());

        if (in.readBool())
        {
            properties_ = new nds.localization.instantiations.LandmarkPropertyList(in);
        }
            ...
            throws java.io.IOException
    {
        ...
        attributeValue_ = new nds.localization.attributes.LandmarkRelationAttributeValue(zserioContext.getAttributeValue(), in, getAttributeTypeCode());

        if (in.readBool())
        {
            properties_ = new nds.localization.instantiations.LandmarkPropertyList(zserioContext.getProperties(), in);
        }
    ...
    public void write(zserio.runtime.io.BitStreamWriter out) throws java.io.IOException
    {
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Inconsistent parameter type for field LandmarkFullAttribute.attributeValue!");
        }
    ...
    private nds.localization.attributes.LandmarkRelationAttributeValue attributeValue_;
    private nds.localization.instantiations.LandmarkPropertyList properties_;
