...
public class LandmarkMeshGeometryLayer implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    ...
    public LandmarkMeshGeometryLayer(
    ...
    public LandmarkMeshGeometryLayer(zserio.runtime.io.BitStreamReader in,
            nds.core.geometry.GeometryLayerType type_,
            boolean hasIds_,
            boolean hasTypes_)
    ...
    public LandmarkMeshGeometryLayer(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in,
            nds.core.geometry.GeometryLayerType type_,
            boolean hasIds_,
            boolean hasTypes_)
            throws java.io.IOException
    ...
    public LandmarkMeshGeometryLayer(
            ...
            int numElements_,
            int[] identifier_,
            nds.localization.types.LandmarkMesh[] types_,
    ...
    public nds.localization.types.LandmarkMesh[] getTypes()
    {
        return (types_ == null) ? null : types_.getRawArray();
    }

    public void setTypes(nds.localization.types.LandmarkMesh[] types_)
    {
        if (types_ == null)
        {
            this.types_ = null;
        ...
        else
        {
            this.types_ = new zserio.runtime.array.Array(
                    new zserio.runtime.array.RawArray.ObjectRawArray<>(nds.localization.types.LandmarkMesh.class, types_),
                    new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.localization.types.LandmarkMesh>(new ZserioElementFactory_types()),
                    zserio.runtime.array.ArrayType.NORMAL);
        }
    }
    ...
    {
        if (obj instanceof LandmarkMeshGeometryLayer)
        {
            final LandmarkMeshGeometryLayer that = (LandmarkMeshGeometryLayer)obj;
            ...
            throws java.io.IOException
    {
        ...
        if (getHasTypes())
        {
            ...
            types_ = new zserio.runtime.array.Array(
                    new zserio.runtime.array.RawArray.ObjectRawArray<>(nds.localization.types.LandmarkMesh.class),
                    new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.localization.types.LandmarkMesh>(new ZserioElementFactory_types()),
                    zserio.runtime.array.ArrayType.NORMAL);
    ...
    public void write(zserio.runtime.io.BitStreamWriter out) throws java.io.IOException
    {
        ...
        if (isIdentifierUsed())
        {
            ...
            {
                throw new zserio.runtime.ZserioError("Write: Wrong array length for field LandmarkMeshGeometryLayer.identifier: " +
        ...
        if (isTypesUsed())
        {
            ...
            {
                throw new zserio.runtime.ZserioError("Write: Wrong array length for field LandmarkMeshGeometryLayer.types: " +
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Inconsistent parameter type for field LandmarkMeshGeometryLayer.buffers!");
        }
        if (buffers_.getShiftXY() != (byte)(getCoordShiftXY()))
        {
            throw new zserio.runtime.ZserioError("Write: Wrong parameter shiftXY for field LandmarkMeshGeometryLayer.buffers: " +
                    buffers_.getShiftXY() + " != " + (byte)(getCoordShiftXY()) + "!");
        }
        if (buffers_.getShiftZ() != (byte)(getCoordShiftZ()))
        {
            throw new zserio.runtime.ZserioError("Write: Wrong parameter shiftZ for field LandmarkMeshGeometryLayer.buffers: " +
                    buffers_.getShiftZ() + " != " + (byte)(getCoordShiftZ()) + "!");
        }
        if (buffers_.getNumElements() != (int)(getNumElements()))
        {
            throw new zserio.runtime.ZserioError("Write: Wrong parameter numElements for field LandmarkMeshGeometryLayer.buffers: " +
    ...
    private static final class ZserioElementFactory_types implements zserio.runtime.array.PackableElementFactory<nds.localization.types.LandmarkMesh>
    {
        @Override
        public nds.localization.types.LandmarkMesh create(zserio.runtime.io.BitStreamReader in, int index)
                throws java.io.IOException
        {
            return new nds.localization.types.LandmarkMesh(in);
        }

        @Override
        public zserio.runtime.array.PackingContext createPackingContext()
        {
            return new nds.localization.types.LandmarkMesh.ZserioPackingContext();
        }

        @Override
        public nds.localization.types.LandmarkMesh create(zserio.runtime.array.PackingContext context,
                zserio.runtime.io.BitStreamReader in, int index) throws java.io.IOException
        {
            return new nds.localization.types.LandmarkMesh(context, in);
        }
    }
