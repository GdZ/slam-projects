...
public class LandmarkRoadAttributeSetMap implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    public static final class ZserioPackingContext extends zserio.runtime.array.PackingContext
    {
        public ZserioPackingContext()
        {
            attributeSet_ = new nds.localization.instantiations.LandmarkAttributeSet.ZserioPackingContext();
            feature_ = new zserio.runtime.array.DeltaContext();
        }

        public nds.localization.instantiations.LandmarkAttributeSet.ZserioPackingContext getAttributeSet()
        {
        ...
        private nds.localization.instantiations.LandmarkAttributeSet.ZserioPackingContext attributeSet_;
        private zserio.runtime.array.DeltaContext feature_;
    };

    public LandmarkRoadAttributeSetMap(
            byte coordShift_)
    {
        this.coordShift_ = coordShift_;
    }

    public LandmarkRoadAttributeSetMap(zserio.runtime.io.BitStreamReader in,
            byte coordShift_)
    ...
    public LandmarkRoadAttributeSetMap(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in,
            byte coordShift_)
            throws java.io.IOException
    {
        this.coordShift_ = coordShift_;
    ...
    public LandmarkRoadAttributeSetMap(
            byte coordShift_,
            nds.localization.instantiations.LandmarkAttributeSet attributeSet_,
            int feature_,
            nds.road.reference.types.RoadReference[] references_,
            nds.road.reference.types.RoadValidityRange[] validities_)
    {
        this(coordShift_);
    ...
    public nds.localization.instantiations.LandmarkAttributeSet getAttributeSet()
    {
        return attributeSet_;
    }

    public void setAttributeSet(nds.localization.instantiations.LandmarkAttributeSet attributeSet_)
    {
    ...
    public nds.road.reference.types.RoadValidityRange[] getValidities()
    {
        return (validities_ == null) ? null : validities_.getRawArray();
    }

    public void setValidities(nds.road.reference.types.RoadValidityRange[] validities_)
    {
        this.validities_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.ObjectRawArray<>(nds.road.reference.types.RoadValidityRange.class, validities_),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.road.reference.types.RoadValidityRange>(new ZserioElementFactory_validities()),
                zserio.runtime.array.ArrayType.NORMAL);
    }
    ...
    {
        if (obj instanceof LandmarkRoadAttributeSetMap)
        {
            final LandmarkRoadAttributeSetMap that = (LandmarkRoadAttributeSetMap)obj;
    ...
    public void read(zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        attributeSet_ = new nds.localization.instantiations.LandmarkAttributeSet(in);
    ...
    {
        final ZserioPackingContext zserioContext = context.cast();
        attributeSet_ = new nds.localization.instantiations.LandmarkAttributeSet(zserioContext.getAttributeSet(), in);
    ...
    public void write(zserio.runtime.io.BitStreamWriter out) throws java.io.IOException
    {
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field LandmarkRoadAttributeSetMap.references: " +
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field LandmarkRoadAttributeSetMap.validities: " +
    ...
    private final class ZserioElementFactory_validities implements zserio.runtime.array.PackableElementFactory<nds.road.reference.types.RoadValidityRange>
    {
        @Override
    ...
    private nds.localization.instantiations.LandmarkAttributeSet attributeSet_;
