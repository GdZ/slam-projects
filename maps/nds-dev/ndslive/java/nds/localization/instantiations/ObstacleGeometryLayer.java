...
public class ObstacleGeometryLayer implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    ...
    public ObstacleGeometryLayer(zserio.runtime.io.BitStreamReader in,
            nds.core.geometry.GeometryLayerType type_,
            boolean hasIds_,
            boolean hasTypes_)
    ...
    public ObstacleGeometryLayer(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in,
            nds.core.geometry.GeometryLayerType type_,
            boolean hasIds_,
            boolean hasTypes_)
            throws java.io.IOException
    ...
    public ObstacleGeometryLayer(
            ...
            byte coordShiftZ_,
            int numElements_,
            nds.core.types.Empty[] identifier_,
            nds.localization.types.ObstacleType[] types_,
    ...
    public int bitSizeOf(long bitPosition)
    {
        ...
        if (isIdentifierUsed())
        {
            endBitPosition += identifier_.bitSizeOf(endBitPosition);
        }
        if (isTypesUsed())
        {
            endBitPosition = zserio.runtime.BitPositionUtil.alignTo(8, endBitPosition);
    ...
    public nds.core.types.Empty[] getIdentifier()
    {
        return (identifier_ == null) ? null : identifier_.getRawArray();
    }

    public void setIdentifier(nds.core.types.Empty[] identifier_)
    {
        if (identifier_ == null)
        {
        ...
        else
        {
            this.identifier_ = new zserio.runtime.array.Array(
                    new zserio.runtime.array.RawArray.ObjectRawArray<>(nds.core.types.Empty.class, identifier_),
                    new zserio.runtime.array.ArrayTraits.WriteObjectArrayTraits<nds.core.types.Empty>(new ZserioElementFactory_identifier()),
    ...
    public nds.localization.types.ObstacleType[] getTypes()
    {
        return (types_ == null) ? null : types_.getRawArray();
    }

    public void setTypes(nds.localization.types.ObstacleType[] types_)
    {
        if (types_ == null)
        {
            this.types_ = null;
        ...
        else
        {
            this.types_ = new zserio.runtime.array.Array(
                    new zserio.runtime.array.RawArray.EnumRawArray<>(nds.localization.types.ObstacleType.class, types_),
                    new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.localization.types.ObstacleType>(new ZserioElementFactory_types()),
                    zserio.runtime.array.ArrayType.NORMAL);
        }
    }
    ...
    {
        if (obj instanceof ObstacleGeometryLayer)
        {
            final ObstacleGeometryLayer that = (ObstacleGeometryLayer)obj;
            ...
            throws java.io.IOException
    {
        ...
        if (getHasIds())
        {
            identifier_ = new zserio.runtime.array.Array(
                    ...
                    new zserio.runtime.array.ArrayTraits.WriteObjectArrayTraits<nds.core.types.Empty>(new ZserioElementFactory_identifier()),
                    zserio.runtime.array.ArrayType.NORMAL);
            identifier_.read(in, (int)(getNumElements()));
        }
    ...
    public long initializeOffsets(long bitPosition)
    {
        ...
        if (isIdentifierUsed())
        {
            endBitPosition = identifier_.initializeOffsets(endBitPosition);
        }
        if (isTypesUsed())
        {
            endBitPosition = zserio.runtime.BitPositionUtil.alignTo(8, endBitPosition);
    ...
    public void write(zserio.runtime.io.BitStreamWriter out) throws java.io.IOException
    {
        ...
        if (isIdentifierUsed())
        {
            ...
            {
                throw new zserio.runtime.ZserioError("Write: Wrong array length for field ObstacleGeometryLayer.identifier: " +
                        identifier_.size() + " != " + (int)(getNumElements()) + "!");
            }
            identifier_.write(out);
        }
        ...
        if (isTypesUsed())
        {
            ...
            {
                throw new zserio.runtime.ZserioError("Write: Wrong array length for field ObstacleGeometryLayer.types: " +
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Inconsistent parameter type for field ObstacleGeometryLayer.buffers!");
        }
        if (buffers_.getShiftXY() != (byte)(getCoordShiftXY()))
        {
            throw new zserio.runtime.ZserioError("Write: Wrong parameter shiftXY for field ObstacleGeometryLayer.buffers: " +
                    buffers_.getShiftXY() + " != " + (byte)(getCoordShiftXY()) + "!");
        }
        if (buffers_.getShiftZ() != (byte)(getCoordShiftZ()))
        {
            throw new zserio.runtime.ZserioError("Write: Wrong parameter shiftZ for field ObstacleGeometryLayer.buffers: " +
                    buffers_.getShiftZ() + " != " + (byte)(getCoordShiftZ()) + "!");
        }
        if (buffers_.getNumElements() != (int)(getNumElements()))
        {
            throw new zserio.runtime.ZserioError("Write: Wrong parameter numElements for field ObstacleGeometryLayer.buffers: " +
    ...
    private static final class ZserioElementFactory_identifier implements zserio.runtime.array.ElementFactory<nds.core.types.Empty>
    {
        @Override
    ...
    private static final class ZserioElementFactory_types implements zserio.runtime.array.PackableElementFactory<nds.localization.types.ObstacleType>
    {
        @Override
