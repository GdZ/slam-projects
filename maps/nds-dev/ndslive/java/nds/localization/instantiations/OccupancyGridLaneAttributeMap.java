...
public class OccupancyGridLaneAttributeMap implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    ...
    public OccupancyGridLaneAttributeMap(
            byte coordShift_)
    {
        this.coordShift_ = coordShift_;
    }

    public OccupancyGridLaneAttributeMap(zserio.runtime.io.BitStreamReader in,
            byte coordShift_)
    ...
    public OccupancyGridLaneAttributeMap(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in,
            byte coordShift_)
            throws java.io.IOException
    {
        this.coordShift_ = coordShift_;
    ...
    public OccupancyGridLaneAttributeMap(
            ...
            nds.lane.reference.types.LaneGroupRangeValidity[] featureValidities_,
    ...
    public nds.lane.reference.types.LaneGroupRangeValidity[] getFeatureValidities()
    {
        return (featureValidities_ == null) ? null : featureValidities_.getRawArray();
    }

    public void setFeatureValidities(nds.lane.reference.types.LaneGroupRangeValidity[] featureValidities_)
    {
        this.featureValidities_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.ObjectRawArray<>(nds.lane.reference.types.LaneGroupRangeValidity.class, featureValidities_),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.lane.reference.types.LaneGroupRangeValidity>(new ZserioElementFactory_featureValidities()),
                zserio.runtime.array.ArrayType.NORMAL);
    }
    ...
    {
        if (obj instanceof OccupancyGridLaneAttributeMap)
        {
            final OccupancyGridLaneAttributeMap that = (OccupancyGridLaneAttributeMap)obj;
    ...
    public void write(zserio.runtime.io.BitStreamWriter out) throws java.io.IOException
    {
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field OccupancyGridLaneAttributeMap.featureReferences: " +
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field OccupancyGridLaneAttributeMap.featureValidities: " +
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field OccupancyGridLaneAttributeMap.featureValuePtr: " +
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field OccupancyGridLaneAttributeMap.attributeValues: " +
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field OccupancyGridLaneAttributeMap.attributeProperties: " +
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field OccupancyGridLaneAttributeMap.attributeConditions: " +
    ...
    private final class ZserioElementFactory_featureValidities implements zserio.runtime.array.PackableElementFactory<nds.lane.reference.types.LaneGroupRangeValidity>
    {
        @Override
