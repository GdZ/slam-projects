...
public class LandmarkLaneAttributeSetList implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    ...
    public LandmarkLaneAttributeSetList(
            byte coordShift_)
    {
        this.coordShift_ = coordShift_;
    }

    public LandmarkLaneAttributeSetList(zserio.runtime.io.BitStreamReader in,
            byte coordShift_)
    ...
    public LandmarkLaneAttributeSetList(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in,
            byte coordShift_)
            throws java.io.IOException
    {
        this.coordShift_ = coordShift_;
    ...
    public LandmarkLaneAttributeSetList(
            ...
            nds.localization.instantiations.LandmarkLaneAttributeSetMap[] sets_)
    {
        this(coordShift_);
    ...
    public nds.localization.instantiations.LandmarkLaneAttributeSetMap[] getSets()
    {
        return (sets_ == null) ? null : sets_.getRawArray();
    }

    public void setSets(nds.localization.instantiations.LandmarkLaneAttributeSetMap[] sets_)
    {
        this.sets_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.ObjectRawArray<>(nds.localization.instantiations.LandmarkLaneAttributeSetMap.class, sets_),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.localization.instantiations.LandmarkLaneAttributeSetMap>(new ZserioElementFactory_sets()),
    ...
    {
        if (obj instanceof LandmarkLaneAttributeSetList)
        {
            final LandmarkLaneAttributeSetList that = (LandmarkLaneAttributeSetList)obj;
            ...
            throws java.io.IOException
    {
        ...
        sets_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.ObjectRawArray<>(nds.localization.instantiations.LandmarkLaneAttributeSetMap.class),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.localization.instantiations.LandmarkLaneAttributeSetMap>(new ZserioElementFactory_sets()),
                zserio.runtime.array.ArrayType.NORMAL);
    ...
    public void write(zserio.runtime.io.BitStreamWriter out) throws java.io.IOException
    {
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field LandmarkLaneAttributeSetList.sets: " +
    ...
    private final class ZserioElementFactory_sets implements zserio.runtime.array.PackableElementFactory<nds.localization.instantiations.LandmarkLaneAttributeSetMap>
    {
        @Override
        public nds.localization.instantiations.LandmarkLaneAttributeSetMap create(zserio.runtime.io.BitStreamReader in, int index)
                throws java.io.IOException
        {
            return new nds.localization.instantiations.LandmarkLaneAttributeSetMap(in, (byte)(getCoordShift()));
        }

        @Override
        public zserio.runtime.array.PackingContext createPackingContext()
        {
            return new nds.localization.instantiations.LandmarkLaneAttributeSetMap.ZserioPackingContext();
        }

        @Override
        public nds.localization.instantiations.LandmarkLaneAttributeSetMap create(zserio.runtime.array.PackingContext context,
                zserio.runtime.io.BitStreamReader in, int index) throws java.io.IOException
        {
            return new nds.localization.instantiations.LandmarkLaneAttributeSetMap(context, in, (byte)(getCoordShift()));
        }
    }
