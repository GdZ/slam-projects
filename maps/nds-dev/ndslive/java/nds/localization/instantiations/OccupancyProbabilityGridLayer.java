...
public class OccupancyProbabilityGridLayer implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    ...
    public OccupancyProbabilityGridLayer(
            boolean hasIds_,
            boolean hasTypes_)
    {
    ...
    public OccupancyProbabilityGridLayer(zserio.runtime.io.BitStreamReader in,
            boolean hasIds_,
            boolean hasTypes_)
    ...
    public OccupancyProbabilityGridLayer(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in,
            boolean hasIds_,
            boolean hasTypes_)
            throws java.io.IOException
    {
    ...
    public OccupancyProbabilityGridLayer(
            ...
            nds.core.grid.Grid_OccupancyProbability[] grids_)
    {
    ...
    public nds.core.grid.Grid_OccupancyProbability[] getGrids()
    {
        return (grids_ == null) ? null : grids_.getRawArray();
    }

    public void setGrids(nds.core.grid.Grid_OccupancyProbability[] grids_)
    {
        this.grids_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.ObjectRawArray<>(nds.core.grid.Grid_OccupancyProbability.class, grids_),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.core.grid.Grid_OccupancyProbability>(new ZserioElementFactory_grids()),
                zserio.runtime.array.ArrayType.NORMAL);
    }
    ...
    {
        if (obj instanceof OccupancyProbabilityGridLayer)
        {
            final OccupancyProbabilityGridLayer that = (OccupancyProbabilityGridLayer)obj;
            ...
            throws java.io.IOException
    {
        ...
        grids_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.ObjectRawArray<>(nds.core.grid.Grid_OccupancyProbability.class),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.core.grid.Grid_OccupancyProbability>(new ZserioElementFactory_grids()),
                zserio.runtime.array.ArrayType.NORMAL);
    ...
    public void write(zserio.runtime.io.BitStreamWriter out) throws java.io.IOException
    {
        ...
        if (isIdentifierUsed())
        {
            ...
            {
                throw new zserio.runtime.ZserioError("Write: Wrong array length for field OccupancyProbabilityGridLayer.identifier: " +
        ...
        if (isTypesUsed())
        {
            ...
            {
                throw new zserio.runtime.ZserioError("Write: Wrong array length for field OccupancyProbabilityGridLayer.types: " +
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field OccupancyProbabilityGridLayer.grids: " +
    ...
    private final class ZserioElementFactory_grids implements zserio.runtime.array.PackableElementFactory<nds.core.grid.Grid_OccupancyProbability>
    {
        @Override
        public nds.core.grid.Grid_OccupancyProbability create(zserio.runtime.io.BitStreamReader in, int index)
                throws java.io.IOException
        {
            return new nds.core.grid.Grid_OccupancyProbability(in, (int)(getCellSize()), (byte)(getCoordShiftXY()));
        }

        @Override
        public zserio.runtime.array.PackingContext createPackingContext()
        {
            return new nds.core.grid.Grid_OccupancyProbability.ZserioPackingContext();
        }

        @Override
        public nds.core.grid.Grid_OccupancyProbability create(zserio.runtime.array.PackingContext context,
                zserio.runtime.io.BitStreamReader in, int index) throws java.io.IOException
        {
            return new nds.core.grid.Grid_OccupancyProbability(context, in, (int)(getCellSize()), (byte)(getCoordShiftXY()));
        }
    }
