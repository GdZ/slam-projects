...
public class OccupancyGridRoadAttributeMap implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    ...
    public OccupancyGridRoadAttributeMap(
            byte coordShift_)
    {
        this.coordShift_ = coordShift_;
    }

    public OccupancyGridRoadAttributeMap(zserio.runtime.io.BitStreamReader in,
            byte coordShift_)
    ...
    public OccupancyGridRoadAttributeMap(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in,
            byte coordShift_)
            throws java.io.IOException
    {
        this.coordShift_ = coordShift_;
    ...
    public OccupancyGridRoadAttributeMap(
            ...
            nds.road.reference.types.RoadValidityRange[] featureValidities_,
            int[] featureValuePtr_,
            int attribute_,
            nds.localization.instantiations.OccupancyGridAttribute[] attributeValues_,
            nds.localization.instantiations.LandmarkPropertyList[] attributeProperties_,
    ...
    public void setAttributeTypeCode(nds.localization.attributes.OccupancyGridRelationAttributeType attributeTypeCode_)
    {
    ...
    public nds.road.reference.types.RoadValidityRange[] getFeatureValidities()
    {
        return (featureValidities_ == null) ? null : featureValidities_.getRawArray();
    }

    public void setFeatureValidities(nds.road.reference.types.RoadValidityRange[] featureValidities_)
    {
        this.featureValidities_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.ObjectRawArray<>(nds.road.reference.types.RoadValidityRange.class, featureValidities_),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.road.reference.types.RoadValidityRange>(new ZserioElementFactory_featureValidities()),
                zserio.runtime.array.ArrayType.NORMAL);
    }
    ...
    public nds.localization.instantiations.OccupancyGridAttribute[] getAttributeValues()
    {
        return (attributeValues_ == null) ? null : attributeValues_.getRawArray();
    }

    public void setAttributeValues(nds.localization.instantiations.OccupancyGridAttribute[] attributeValues_)
    {
        this.attributeValues_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.ObjectRawArray<>(nds.localization.instantiations.OccupancyGridAttribute.class, attributeValues_),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.localization.instantiations.OccupancyGridAttribute>(new ZserioElementFactory_attributeValues()),
                zserio.runtime.array.ArrayType.NORMAL);
    }

    public nds.localization.instantiations.LandmarkPropertyList[] getAttributeProperties()
    {
        return (attributeProperties_ == null) ? null : attributeProperties_.getRawArray();
    }

    public void setAttributeProperties(nds.localization.instantiations.LandmarkPropertyList[] attributeProperties_)
    {
        this.attributeProperties_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.ObjectRawArray<>(nds.localization.instantiations.LandmarkPropertyList.class, attributeProperties_),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.localization.instantiations.LandmarkPropertyList>(new ZserioElementFactory_attributeProperties()),
                zserio.runtime.array.ArrayType.NORMAL);
    }
    ...
    {
        if (obj instanceof OccupancyGridRoadAttributeMap)
        {
            final OccupancyGridRoadAttributeMap that = (OccupancyGridRoadAttributeMap)obj;
    ...
    public void read(zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        attributeTypeCode_ = nds.localization.attributes.OccupancyGridRelationAttributeType.readEnum(in);
        ...
        featureValidities_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.ObjectRawArray<>(nds.road.reference.types.RoadValidityRange.class),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.road.reference.types.RoadValidityRange>(new ZserioElementFactory_featureValidities()),
                zserio.runtime.array.ArrayType.NORMAL);
        ...
        attributeValues_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.ObjectRawArray<>(nds.localization.instantiations.OccupancyGridAttribute.class),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.localization.instantiations.OccupancyGridAttribute>(new ZserioElementFactory_attributeValues()),
                zserio.runtime.array.ArrayType.NORMAL);
        ...
        attributeProperties_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.ObjectRawArray<>(nds.localization.instantiations.LandmarkPropertyList.class),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.localization.instantiations.LandmarkPropertyList>(new ZserioElementFactory_attributeProperties()),
                zserio.runtime.array.ArrayType.NORMAL);
    ...
    {
        final ZserioPackingContext zserioContext = context.cast();
        attributeTypeCode_ = nds.localization.attributes.OccupancyGridRelationAttributeType.readEnum(zserioContext.getAttributeTypeCode(), in);
    ...
    public void write(zserio.runtime.io.BitStreamWriter out) throws java.io.IOException
    {
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field OccupancyGridRoadAttributeMap.featureReferences: " +
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field OccupancyGridRoadAttributeMap.featureValidities: " +
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field OccupancyGridRoadAttributeMap.featureValuePtr: " +
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field OccupancyGridRoadAttributeMap.attributeValues: " +
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field OccupancyGridRoadAttributeMap.attributeProperties: " +
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field OccupancyGridRoadAttributeMap.attributeConditions: " +
    ...
    private final class ZserioElementFactory_featureValidities implements zserio.runtime.array.PackableElementFactory<nds.road.reference.types.RoadValidityRange>
    {
        @Override
        public nds.road.reference.types.RoadValidityRange create(zserio.runtime.io.BitStreamReader in, int index)
                throws java.io.IOException
        {
            return new nds.road.reference.types.RoadValidityRange(in, (byte)(getCoordShift()));
        }

        @Override
        public zserio.runtime.array.PackingContext createPackingContext()
        {
            return new nds.road.reference.types.RoadValidityRange.ZserioPackingContext();
        }

        @Override
        public nds.road.reference.types.RoadValidityRange create(zserio.runtime.array.PackingContext context,
                zserio.runtime.io.BitStreamReader in, int index) throws java.io.IOException
        {
            return new nds.road.reference.types.RoadValidityRange(context, in, (byte)(getCoordShift()));
        }
    }

    private final class ZserioElementFactory_attributeValues implements zserio.runtime.array.PackableElementFactory<nds.localization.instantiations.OccupancyGridAttribute>
    {
        @Override
        public nds.localization.instantiations.OccupancyGridAttribute create(zserio.runtime.io.BitStreamReader in, int index)
                throws java.io.IOException
        {
            return new nds.localization.instantiations.OccupancyGridAttribute(in, getAttributeTypeCode());
        }

        @Override
        public zserio.runtime.array.PackingContext createPackingContext()
        {
            return new nds.localization.instantiations.OccupancyGridAttribute.ZserioPackingContext();
        }

        @Override
        public nds.localization.instantiations.OccupancyGridAttribute create(zserio.runtime.array.PackingContext context,
                zserio.runtime.io.BitStreamReader in, int index) throws java.io.IOException
        {
            return new nds.localization.instantiations.OccupancyGridAttribute(context, in, getAttributeTypeCode());
        }
    }

    private static final class ZserioElementFactory_attributeProperties implements zserio.runtime.array.PackableElementFactory<nds.localization.instantiations.LandmarkPropertyList>
    {
        @Override
        public nds.localization.instantiations.LandmarkPropertyList create(zserio.runtime.io.BitStreamReader in, int index)
                throws java.io.IOException
        {
            return new nds.localization.instantiations.LandmarkPropertyList(in);
        }

        @Override
        public zserio.runtime.array.PackingContext createPackingContext()
        {
            return new nds.localization.instantiations.LandmarkPropertyList.ZserioPackingContext();
        }

        @Override
        public nds.localization.instantiations.LandmarkPropertyList create(zserio.runtime.array.PackingContext context,
                zserio.runtime.io.BitStreamReader in, int index) throws java.io.IOException
        {
            return new nds.localization.instantiations.LandmarkPropertyList(context, in);
        }
    }
    ...
    private nds.localization.attributes.OccupancyGridRelationAttributeType attributeTypeCode_;
