...
public class LandmarkPolygonGeometryLayer implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    ...
    public LandmarkPolygonGeometryLayer(
    ...
    public LandmarkPolygonGeometryLayer(zserio.runtime.io.BitStreamReader in,
            nds.core.geometry.GeometryLayerType type_,
            boolean hasIds_,
            boolean hasTypes_)
    ...
    public LandmarkPolygonGeometryLayer(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in,
            nds.core.geometry.GeometryLayerType type_,
            boolean hasIds_,
            boolean hasTypes_)
            throws java.io.IOException
    ...
    public LandmarkPolygonGeometryLayer(
            ...
            int numElements_,
            int[] identifier_,
            nds.localization.types.LandmarkPolygon[] types_,
    ...
    public nds.localization.types.LandmarkPolygon[] getTypes()
    {
        return (types_ == null) ? null : types_.getRawArray();
    }

    public void setTypes(nds.localization.types.LandmarkPolygon[] types_)
    {
        if (types_ == null)
        {
            this.types_ = null;
        ...
        else
        {
            this.types_ = new zserio.runtime.array.Array(
                    new zserio.runtime.array.RawArray.ObjectRawArray<>(nds.localization.types.LandmarkPolygon.class, types_),
                    new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.localization.types.LandmarkPolygon>(new ZserioElementFactory_types()),
                    zserio.runtime.array.ArrayType.NORMAL);
        }
    }
    ...
    {
        if (obj instanceof LandmarkPolygonGeometryLayer)
        {
            final LandmarkPolygonGeometryLayer that = (LandmarkPolygonGeometryLayer)obj;
            ...
            throws java.io.IOException
    {
        ...
        if (getHasTypes())
        {
            ...
            types_ = new zserio.runtime.array.Array(
                    new zserio.runtime.array.RawArray.ObjectRawArray<>(nds.localization.types.LandmarkPolygon.class),
                    new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.localization.types.LandmarkPolygon>(new ZserioElementFactory_types()),
                    zserio.runtime.array.ArrayType.NORMAL);
    ...
    public void write(zserio.runtime.io.BitStreamWriter out) throws java.io.IOException
    {
        ...
        if (isIdentifierUsed())
        {
            ...
            {
                throw new zserio.runtime.ZserioError("Write: Wrong array length for field LandmarkPolygonGeometryLayer.identifier: " +
        ...
        if (isTypesUsed())
        {
            ...
            {
                throw new zserio.runtime.ZserioError("Write: Wrong array length for field LandmarkPolygonGeometryLayer.types: " +
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Inconsistent parameter type for field LandmarkPolygonGeometryLayer.buffers!");
        }
        if (buffers_.getShiftXY() != (byte)(getCoordShiftXY()))
        {
            throw new zserio.runtime.ZserioError("Write: Wrong parameter shiftXY for field LandmarkPolygonGeometryLayer.buffers: " +
                    buffers_.getShiftXY() + " != " + (byte)(getCoordShiftXY()) + "!");
        }
        if (buffers_.getShiftZ() != (byte)(getCoordShiftZ()))
        {
            throw new zserio.runtime.ZserioError("Write: Wrong parameter shiftZ for field LandmarkPolygonGeometryLayer.buffers: " +
                    buffers_.getShiftZ() + " != " + (byte)(getCoordShiftZ()) + "!");
        }
        if (buffers_.getNumElements() != (int)(getNumElements()))
        {
            throw new zserio.runtime.ZserioError("Write: Wrong parameter numElements for field LandmarkPolygonGeometryLayer.buffers: " +
    ...
    private static final class ZserioElementFactory_types implements zserio.runtime.array.PackableElementFactory<nds.localization.types.LandmarkPolygon>
    {
        @Override
        public nds.localization.types.LandmarkPolygon create(zserio.runtime.io.BitStreamReader in, int index)
                throws java.io.IOException
        {
            return new nds.localization.types.LandmarkPolygon(in);
        }

        @Override
        public zserio.runtime.array.PackingContext createPackingContext()
        {
            return new nds.localization.types.LandmarkPolygon.ZserioPackingContext();
        }

        @Override
        public nds.localization.types.LandmarkPolygon create(zserio.runtime.array.PackingContext context,
                zserio.runtime.io.BitStreamReader in, int index) throws java.io.IOException
        {
            return new nds.localization.types.LandmarkPolygon(context, in);
        }
    }
