...
public class RoadLandmarkLayer implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    public static final class ZserioPackingContext extends zserio.runtime.array.PackingContext
    {
        public ZserioPackingContext()
        {
            ...
            roadAttributeMaps_ = new nds.localization.instantiations.LandmarkRoadAttributeMapList.ZserioPackingContext();
        }
        ...
        public nds.localization.instantiations.LandmarkRoadAttributeMapList.ZserioPackingContext getRoadAttributeMaps()
        {
            return roadAttributeMaps_;
        }

        private zserio.runtime.array.DeltaContext shift_;
        private nds.localization.instantiations.LandmarkRoadAttributeMapList.ZserioPackingContext roadAttributeMaps_;
    };

    public RoadLandmarkLayer()
    {
    }

    public RoadLandmarkLayer(zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        read(in);
    }

    public RoadLandmarkLayer(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        read(context, in);
    }
    ...
    public RoadLandmarkLayer(
            byte shift_,
            nds.localization.instantiations.LandmarkRoadAttributeMapList roadAttributeMaps_)
    {
        setShift(shift_);
    ...
    public nds.localization.instantiations.LandmarkRoadAttributeMapList getRoadAttributeMaps()
    {
        return roadAttributeMaps_;
    }

    public void setRoadAttributeMaps(nds.localization.instantiations.LandmarkRoadAttributeMapList roadAttributeMaps_)
    {
    ...
    {
        if (obj instanceof RoadLandmarkLayer)
        {
            final RoadLandmarkLayer that = (RoadLandmarkLayer)obj;
            ...
            throws java.io.IOException
    {
        ...
        roadAttributeMaps_ = new nds.localization.instantiations.LandmarkRoadAttributeMapList(in, (byte)(getShift()));
    }
            ...
            throws java.io.IOException
    {
        ...
        roadAttributeMaps_ = new nds.localization.instantiations.LandmarkRoadAttributeMapList(zserioContext.getRoadAttributeMaps(), in, (byte)(getShift()));
    }
    ...
    public void write(zserio.runtime.io.BitStreamWriter out) throws java.io.IOException
    {
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong parameter coordShift for field RoadLandmarkLayer.roadAttributeMaps: " +
    ...
    private byte shift_;
    private nds.localization.instantiations.LandmarkRoadAttributeMapList roadAttributeMaps_;
}
