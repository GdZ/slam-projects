...
public class PoiDisplayMesh3DRelationMetadata implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    ...
    public PoiDisplayMesh3DRelationMetadata()
    {
    }

    public PoiDisplayMesh3DRelationMetadata(zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        read(in);
    }

    public PoiDisplayMesh3DRelationMetadata(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        read(context, in);
    }
    ...
    public PoiDisplayMesh3DRelationMetadata(
            nds.poi.poi.PoiDisplayMesh3DRelationType[] availableAttributes_,
    ...
    public nds.poi.poi.PoiDisplayMesh3DRelationType[] getAvailableAttributes()
    {
        return (availableAttributes_ == null) ? null : availableAttributes_.getRawArray();
    }

    public void setAvailableAttributes(nds.poi.poi.PoiDisplayMesh3DRelationType[] availableAttributes_)
    {
        this.availableAttributes_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.EnumRawArray<>(nds.poi.poi.PoiDisplayMesh3DRelationType.class, availableAttributes_),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.poi.poi.PoiDisplayMesh3DRelationType>(new ZserioElementFactory_availableAttributes()),
    ...
    {
        if (obj instanceof PoiDisplayMesh3DRelationMetadata)
        {
            final PoiDisplayMesh3DRelationMetadata that = (PoiDisplayMesh3DRelationMetadata)obj;
            ...
            throws java.io.IOException
    {
        availableAttributes_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.EnumRawArray<>(nds.poi.poi.PoiDisplayMesh3DRelationType.class),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.poi.poi.PoiDisplayMesh3DRelationType>(new ZserioElementFactory_availableAttributes()),
                zserio.runtime.array.ArrayType.AUTO);
    ...
    private static final class ZserioElementFactory_availableAttributes implements zserio.runtime.array.PackableElementFactory<nds.poi.poi.PoiDisplayMesh3DRelationType>
    {
        @Override
        public nds.poi.poi.PoiDisplayMesh3DRelationType create(zserio.runtime.io.BitStreamReader in, int index)
                throws java.io.IOException
        {
            return nds.poi.poi.PoiDisplayMesh3DRelationType.readEnum(in);
        }
        ...
        @Override
        public nds.poi.poi.PoiDisplayMesh3DRelationType create(zserio.runtime.array.PackingContext context,
                zserio.runtime.io.BitStreamReader in, int index) throws java.io.IOException
        {
            return nds.poi.poi.PoiDisplayMesh3DRelationType.readEnum(context, in);
        }
    }
