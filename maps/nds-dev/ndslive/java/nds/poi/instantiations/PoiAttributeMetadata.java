...
public class PoiAttributeMetadata implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    ...
    public PoiAttributeMetadata()
    {
    }

    public PoiAttributeMetadata(zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        read(in);
    }

    public PoiAttributeMetadata(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        read(context, in);
    }
    ...
    public PoiAttributeMetadata(
            nds.poi.attributes.PoiAttributeType[] availableAttributes_,
    ...
    public nds.poi.attributes.PoiAttributeType[] getAvailableAttributes()
    {
        return (availableAttributes_ == null) ? null : availableAttributes_.getRawArray();
    }

    public void setAvailableAttributes(nds.poi.attributes.PoiAttributeType[] availableAttributes_)
    {
        this.availableAttributes_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.EnumRawArray<>(nds.poi.attributes.PoiAttributeType.class, availableAttributes_),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.poi.attributes.PoiAttributeType>(new ZserioElementFactory_availableAttributes()),
    ...
    {
        if (obj instanceof PoiAttributeMetadata)
        {
            final PoiAttributeMetadata that = (PoiAttributeMetadata)obj;
    ...
    private static final class ZserioElementFactory_availableAttributes implements zserio.runtime.array.PackableElementFactory<nds.poi.attributes.PoiAttributeType>
    {
        @Override
