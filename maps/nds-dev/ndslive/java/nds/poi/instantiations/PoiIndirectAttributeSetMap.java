...
public class PoiIndirectAttributeSetMap implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    public static final class ZserioPackingContext extends zserio.runtime.array.PackingContext
    {
        public ZserioPackingContext()
        {
            attributeSet_ = new nds.poi.instantiations.PoiAttributeSet.ZserioPackingContext();
            feature_ = new zserio.runtime.array.DeltaContext();
        }

        public nds.poi.instantiations.PoiAttributeSet.ZserioPackingContext getAttributeSet()
        {
        ...
        private nds.poi.instantiations.PoiAttributeSet.ZserioPackingContext attributeSet_;
        private zserio.runtime.array.DeltaContext feature_;
    };

    public PoiIndirectAttributeSetMap(
            byte coordShift_)
    {
        this.coordShift_ = coordShift_;
    }

    public PoiIndirectAttributeSetMap(zserio.runtime.io.BitStreamReader in,
            byte coordShift_)
    ...
    public PoiIndirectAttributeSetMap(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in,
            byte coordShift_)
            throws java.io.IOException
    {
        this.coordShift_ = coordShift_;
    ...
    public PoiIndirectAttributeSetMap(
            byte coordShift_,
            nds.poi.instantiations.PoiAttributeSet attributeSet_,
            int feature_,
            nds.poi.reference.types.PoiReferenceIndirect[] references_,
    ...
    public nds.poi.instantiations.PoiAttributeSet getAttributeSet()
    {
        return attributeSet_;
    }

    public void setAttributeSet(nds.poi.instantiations.PoiAttributeSet attributeSet_)
    {
    ...
    public nds.poi.reference.types.PoiReferenceIndirect[] getReferences()
    {
        return (references_ == null) ? null : references_.getRawArray();
    }

    public void setReferences(nds.poi.reference.types.PoiReferenceIndirect[] references_)
    {
        this.references_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.ObjectRawArray<>(nds.poi.reference.types.PoiReferenceIndirect.class, references_),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.poi.reference.types.PoiReferenceIndirect>(new ZserioElementFactory_references()),
    ...
    {
        if (obj instanceof PoiIndirectAttributeSetMap)
        {
            final PoiIndirectAttributeSetMap that = (PoiIndirectAttributeSetMap)obj;
    ...
    public void read(zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        attributeSet_ = new nds.poi.instantiations.PoiAttributeSet(in);
    ...
    {
        final ZserioPackingContext zserioContext = context.cast();
        attributeSet_ = new nds.poi.instantiations.PoiAttributeSet(zserioContext.getAttributeSet(), in);
    ...
    public void write(zserio.runtime.io.BitStreamWriter out) throws java.io.IOException
    {
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field PoiIndirectAttributeSetMap.references: " +
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field PoiIndirectAttributeSetMap.validities: " +
    ...
    private static final class ZserioElementFactory_references implements zserio.runtime.array.PackableElementFactory<nds.poi.reference.types.PoiReferenceIndirect>
    {
        @Override
    ...
    private nds.poi.instantiations.PoiAttributeSet attributeSet_;
