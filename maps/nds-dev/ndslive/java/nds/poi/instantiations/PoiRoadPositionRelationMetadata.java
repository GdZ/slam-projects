...
public class PoiRoadPositionRelationMetadata implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    ...
    public PoiRoadPositionRelationMetadata()
    {
    }

    public PoiRoadPositionRelationMetadata(zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        read(in);
    }

    public PoiRoadPositionRelationMetadata(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        read(context, in);
    }
    ...
    public PoiRoadPositionRelationMetadata(
            nds.poi.poi.PoiRoadPositionRelationType[] availableAttributes_,
    ...
    public nds.poi.poi.PoiRoadPositionRelationType[] getAvailableAttributes()
    {
        return (availableAttributes_ == null) ? null : availableAttributes_.getRawArray();
    }

    public void setAvailableAttributes(nds.poi.poi.PoiRoadPositionRelationType[] availableAttributes_)
    {
        this.availableAttributes_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.EnumRawArray<>(nds.poi.poi.PoiRoadPositionRelationType.class, availableAttributes_),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.poi.poi.PoiRoadPositionRelationType>(new ZserioElementFactory_availableAttributes()),
    ...
    {
        if (obj instanceof PoiRoadPositionRelationMetadata)
        {
            final PoiRoadPositionRelationMetadata that = (PoiRoadPositionRelationMetadata)obj;
            ...
            throws java.io.IOException
    {
        availableAttributes_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.EnumRawArray<>(nds.poi.poi.PoiRoadPositionRelationType.class),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.poi.poi.PoiRoadPositionRelationType>(new ZserioElementFactory_availableAttributes()),
                zserio.runtime.array.ArrayType.AUTO);
    ...
    private static final class ZserioElementFactory_availableAttributes implements zserio.runtime.array.PackableElementFactory<nds.poi.poi.PoiRoadPositionRelationType>
    {
        @Override
        public nds.poi.poi.PoiRoadPositionRelationType create(zserio.runtime.io.BitStreamReader in, int index)
                throws java.io.IOException
        {
            return nds.poi.poi.PoiRoadPositionRelationType.readEnum(in);
        }
        ...
        @Override
        public nds.poi.poi.PoiRoadPositionRelationType create(zserio.runtime.array.PackingContext context,
                zserio.runtime.io.BitStreamReader in, int index) throws java.io.IOException
        {
            return nds.poi.poi.PoiRoadPositionRelationType.readEnum(context, in);
        }
    }
