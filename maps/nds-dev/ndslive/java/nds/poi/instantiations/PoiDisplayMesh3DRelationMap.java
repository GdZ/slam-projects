...
public class PoiDisplayMesh3DRelationMap implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    ...
    public PoiDisplayMesh3DRelationMap(
            byte coordShift_)
    {
        this.coordShift_ = coordShift_;
    }

    public PoiDisplayMesh3DRelationMap(zserio.runtime.io.BitStreamReader in,
            byte coordShift_)
    ...
    public PoiDisplayMesh3DRelationMap(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in,
            byte coordShift_)
            throws java.io.IOException
    {
        this.coordShift_ = coordShift_;
    ...
    public PoiDisplayMesh3DRelationMap(
            ...
            int attribute_,
            nds.poi.instantiations.PoiDisplayMesh3DRelation[] attributeValues_,
    ...
    public void setAttributeTypeCode(nds.poi.poi.PoiDisplayMesh3DRelationType attributeTypeCode_)
    {
    ...
    public nds.poi.instantiations.PoiDisplayMesh3DRelation[] getAttributeValues()
    {
        return (attributeValues_ == null) ? null : attributeValues_.getRawArray();
    }

    public void setAttributeValues(nds.poi.instantiations.PoiDisplayMesh3DRelation[] attributeValues_)
    {
        this.attributeValues_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.ObjectRawArray<>(nds.poi.instantiations.PoiDisplayMesh3DRelation.class, attributeValues_),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.poi.instantiations.PoiDisplayMesh3DRelation>(new ZserioElementFactory_attributeValues()),
                zserio.runtime.array.ArrayType.NORMAL);
    }
    ...
    {
        if (obj instanceof PoiDisplayMesh3DRelationMap)
        {
            final PoiDisplayMesh3DRelationMap that = (PoiDisplayMesh3DRelationMap)obj;
    ...
    public void read(zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        attributeTypeCode_ = nds.poi.poi.PoiDisplayMesh3DRelationType.readEnum(in);
        ...
        attributeValues_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.ObjectRawArray<>(nds.poi.instantiations.PoiDisplayMesh3DRelation.class),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.poi.instantiations.PoiDisplayMesh3DRelation>(new ZserioElementFactory_attributeValues()),
                zserio.runtime.array.ArrayType.NORMAL);
    ...
    {
        final ZserioPackingContext zserioContext = context.cast();
        attributeTypeCode_ = nds.poi.poi.PoiDisplayMesh3DRelationType.readEnum(zserioContext.getAttributeTypeCode(), in);
    ...
    public void write(zserio.runtime.io.BitStreamWriter out) throws java.io.IOException
    {
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field PoiDisplayMesh3DRelationMap.featureReferences: " +
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field PoiDisplayMesh3DRelationMap.featureValidities: " +
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field PoiDisplayMesh3DRelationMap.featureValuePtr: " +
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field PoiDisplayMesh3DRelationMap.attributeValues: " +
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field PoiDisplayMesh3DRelationMap.attributeProperties: " +
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field PoiDisplayMesh3DRelationMap.attributeConditions: " +
    ...
    private final class ZserioElementFactory_attributeValues implements zserio.runtime.array.PackableElementFactory<nds.poi.instantiations.PoiDisplayMesh3DRelation>
    {
        @Override
        public nds.poi.instantiations.PoiDisplayMesh3DRelation create(zserio.runtime.io.BitStreamReader in, int index)
                throws java.io.IOException
        {
            return new nds.poi.instantiations.PoiDisplayMesh3DRelation(in, getAttributeTypeCode());
        }

        @Override
        public zserio.runtime.array.PackingContext createPackingContext()
        {
            return new nds.poi.instantiations.PoiDisplayMesh3DRelation.ZserioPackingContext();
        }

        @Override
        public nds.poi.instantiations.PoiDisplayMesh3DRelation create(zserio.runtime.array.PackingContext context,
                zserio.runtime.io.BitStreamReader in, int index) throws java.io.IOException
        {
            return new nds.poi.instantiations.PoiDisplayMesh3DRelation(context, in, getAttributeTypeCode());
        }
    }
    ...
    private nds.poi.poi.PoiDisplayMesh3DRelationType attributeTypeCode_;
