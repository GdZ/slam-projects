...
public class PoiIndirectAttributeSetList implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    ...
    public PoiIndirectAttributeSetList(
            byte coordShift_)
    {
        this.coordShift_ = coordShift_;
    }

    public PoiIndirectAttributeSetList(zserio.runtime.io.BitStreamReader in,
            byte coordShift_)
    ...
    public PoiIndirectAttributeSetList(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in,
            byte coordShift_)
            throws java.io.IOException
    {
        this.coordShift_ = coordShift_;
    ...
    public PoiIndirectAttributeSetList(
            ...
            nds.poi.instantiations.PoiIndirectAttributeSetMap[] sets_)
    {
        this(coordShift_);
    ...
    public nds.poi.instantiations.PoiIndirectAttributeSetMap[] getSets()
    {
        return (sets_ == null) ? null : sets_.getRawArray();
    }

    public void setSets(nds.poi.instantiations.PoiIndirectAttributeSetMap[] sets_)
    {
        this.sets_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.ObjectRawArray<>(nds.poi.instantiations.PoiIndirectAttributeSetMap.class, sets_),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.poi.instantiations.PoiIndirectAttributeSetMap>(new ZserioElementFactory_sets()),
    ...
    {
        if (obj instanceof PoiIndirectAttributeSetList)
        {
            final PoiIndirectAttributeSetList that = (PoiIndirectAttributeSetList)obj;
            ...
            throws java.io.IOException
    {
        ...
        sets_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.ObjectRawArray<>(nds.poi.instantiations.PoiIndirectAttributeSetMap.class),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.poi.instantiations.PoiIndirectAttributeSetMap>(new ZserioElementFactory_sets()),
                zserio.runtime.array.ArrayType.NORMAL);
    ...
    public void write(zserio.runtime.io.BitStreamWriter out) throws java.io.IOException
    {
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field PoiIndirectAttributeSetList.sets: " +
    ...
    private final class ZserioElementFactory_sets implements zserio.runtime.array.PackableElementFactory<nds.poi.instantiations.PoiIndirectAttributeSetMap>
    {
        @Override
        public nds.poi.instantiations.PoiIndirectAttributeSetMap create(zserio.runtime.io.BitStreamReader in, int index)
                throws java.io.IOException
        {
            return new nds.poi.instantiations.PoiIndirectAttributeSetMap(in, (byte)(getCoordShift()));
        }

        @Override
        public zserio.runtime.array.PackingContext createPackingContext()
        {
            return new nds.poi.instantiations.PoiIndirectAttributeSetMap.ZserioPackingContext();
        }

        @Override
        public nds.poi.instantiations.PoiIndirectAttributeSetMap create(zserio.runtime.array.PackingContext context,
                zserio.runtime.io.BitStreamReader in, int index) throws java.io.IOException
        {
            return new nds.poi.instantiations.PoiIndirectAttributeSetMap(context, in, (byte)(getCoordShift()));
        }
    }
