...
public class PoiRoadIndirectPositionRelationMap implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    ...
    public PoiRoadIndirectPositionRelationMap(
            byte coordShift_)
    {
        this.coordShift_ = coordShift_;
    }

    public PoiRoadIndirectPositionRelationMap(zserio.runtime.io.BitStreamReader in,
            byte coordShift_)
    ...
    public PoiRoadIndirectPositionRelationMap(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in,
            byte coordShift_)
            throws java.io.IOException
    {
        this.coordShift_ = coordShift_;
    ...
    public PoiRoadIndirectPositionRelationMap(
            ...
            nds.road.reference.types.RoadPositionValidity[] featureValidities_,
    ...
    public nds.road.reference.types.RoadPositionValidity[] getFeatureValidities()
    {
        return (featureValidities_ == null) ? null : featureValidities_.getRawArray();
    }

    public void setFeatureValidities(nds.road.reference.types.RoadPositionValidity[] featureValidities_)
    {
        this.featureValidities_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.ObjectRawArray<>(nds.road.reference.types.RoadPositionValidity.class, featureValidities_),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.road.reference.types.RoadPositionValidity>(new ZserioElementFactory_featureValidities()),
                zserio.runtime.array.ArrayType.NORMAL);
    }
    ...
    {
        if (obj instanceof PoiRoadIndirectPositionRelationMap)
        {
            final PoiRoadIndirectPositionRelationMap that = (PoiRoadIndirectPositionRelationMap)obj;
    ...
    public void write(zserio.runtime.io.BitStreamWriter out) throws java.io.IOException
    {
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field PoiRoadIndirectPositionRelationMap.featureReferences: " +
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field PoiRoadIndirectPositionRelationMap.featureValidities: " +
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field PoiRoadIndirectPositionRelationMap.featureValuePtr: " +
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field PoiRoadIndirectPositionRelationMap.attributeValues: " +
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field PoiRoadIndirectPositionRelationMap.attributeProperties: " +
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field PoiRoadIndirectPositionRelationMap.attributeConditions: " +
    ...
    private final class ZserioElementFactory_featureValidities implements zserio.runtime.array.PackableElementFactory<nds.road.reference.types.RoadPositionValidity>
    {
        @Override
