...
public class PoiRoadPositionRelationMapList implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    ...
    public PoiRoadPositionRelationMapList(
            byte coordShift_)
    {
        this.coordShift_ = coordShift_;
    }

    public PoiRoadPositionRelationMapList(zserio.runtime.io.BitStreamReader in,
            byte coordShift_)
    ...
    public PoiRoadPositionRelationMapList(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in,
            byte coordShift_)
            throws java.io.IOException
    {
        this.coordShift_ = coordShift_;
    ...
    public PoiRoadPositionRelationMapList(
            ...
            nds.poi.instantiations.PoiRoadPositionRelationMap[] maps_)
    {
        this(coordShift_);
    ...
    public nds.poi.instantiations.PoiRoadPositionRelationMap[] getMaps()
    {
        return (maps_ == null) ? null : maps_.getRawArray();
    }

    public void setMaps(nds.poi.instantiations.PoiRoadPositionRelationMap[] maps_)
    {
        this.maps_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.ObjectRawArray<>(nds.poi.instantiations.PoiRoadPositionRelationMap.class, maps_),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.poi.instantiations.PoiRoadPositionRelationMap>(new ZserioElementFactory_maps()),
    ...
    {
        if (obj instanceof PoiRoadPositionRelationMapList)
        {
            final PoiRoadPositionRelationMapList that = (PoiRoadPositionRelationMapList)obj;
            ...
            throws java.io.IOException
    {
        ...
        maps_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.ObjectRawArray<>(nds.poi.instantiations.PoiRoadPositionRelationMap.class),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.poi.instantiations.PoiRoadPositionRelationMap>(new ZserioElementFactory_maps()),
                zserio.runtime.array.ArrayType.NORMAL);
    ...
    public void write(zserio.runtime.io.BitStreamWriter out) throws java.io.IOException
    {
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong parameter numMaps for field PoiRoadPositionRelationMapList.header: " +
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field PoiRoadPositionRelationMapList.maps: " +
    ...
    private final class ZserioElementFactory_maps implements zserio.runtime.array.PackableElementFactory<nds.poi.instantiations.PoiRoadPositionRelationMap>
    {
        @Override
        public nds.poi.instantiations.PoiRoadPositionRelationMap create(zserio.runtime.io.BitStreamReader in, int index)
                throws java.io.IOException
        {
            return new nds.poi.instantiations.PoiRoadPositionRelationMap(in, (byte)(getCoordShift()));
        }

        @Override
        public zserio.runtime.array.PackingContext createPackingContext()
        {
            return new nds.poi.instantiations.PoiRoadPositionRelationMap.ZserioPackingContext();
        }

        @Override
        public nds.poi.instantiations.PoiRoadPositionRelationMap create(zserio.runtime.array.PackingContext context,
                zserio.runtime.io.BitStreamReader in, int index) throws java.io.IOException
        {
            return new nds.poi.instantiations.PoiRoadPositionRelationMap(context, in, (byte)(getCoordShift()));
        }
    }
