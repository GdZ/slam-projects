...
public class PoiLaneIndirectPositionRelationMap implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    ...
    public PoiLaneIndirectPositionRelationMap(
            byte coordShift_)
    {
        this.coordShift_ = coordShift_;
    }

    public PoiLaneIndirectPositionRelationMap(zserio.runtime.io.BitStreamReader in,
            byte coordShift_)
    ...
    public PoiLaneIndirectPositionRelationMap(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in,
            byte coordShift_)
            throws java.io.IOException
    {
        this.coordShift_ = coordShift_;
    ...
    public PoiLaneIndirectPositionRelationMap(
            ...
            int feature_,
            nds.lane.reference.types.LaneGroupReferenceIndirect[] featureReferences_,
            nds.lane.reference.types.LaneGroupPositionValidity[] featureValidities_,
            int[] featureValuePtr_,
            int attribute_,
            nds.poi.instantiations.PoiLanePositionRelation[] attributeValues_,
    ...
    public nds.poi.poi.PoiLanePositionRelationType getAttributeTypeCode()
    {
        return attributeTypeCode_;
    }

    public void setAttributeTypeCode(nds.poi.poi.PoiLanePositionRelationType attributeTypeCode_)
    {
    ...
    public nds.lane.reference.types.LaneGroupReferenceIndirect[] getFeatureReferences()
    {
        return (featureReferences_ == null) ? null : featureReferences_.getRawArray();
    }

    public void setFeatureReferences(nds.lane.reference.types.LaneGroupReferenceIndirect[] featureReferences_)
    {
        this.featureReferences_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.ObjectRawArray<>(nds.lane.reference.types.LaneGroupReferenceIndirect.class, featureReferences_),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.lane.reference.types.LaneGroupReferenceIndirect>(new ZserioElementFactory_featureReferences()),
                zserio.runtime.array.ArrayType.NORMAL);
    }

    public nds.lane.reference.types.LaneGroupPositionValidity[] getFeatureValidities()
    {
        return (featureValidities_ == null) ? null : featureValidities_.getRawArray();
    }

    public void setFeatureValidities(nds.lane.reference.types.LaneGroupPositionValidity[] featureValidities_)
    {
        this.featureValidities_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.ObjectRawArray<>(nds.lane.reference.types.LaneGroupPositionValidity.class, featureValidities_),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.lane.reference.types.LaneGroupPositionValidity>(new ZserioElementFactory_featureValidities()),
                zserio.runtime.array.ArrayType.NORMAL);
    }
    ...
    public nds.poi.instantiations.PoiLanePositionRelation[] getAttributeValues()
    {
        return (attributeValues_ == null) ? null : attributeValues_.getRawArray();
    }

    public void setAttributeValues(nds.poi.instantiations.PoiLanePositionRelation[] attributeValues_)
    {
        this.attributeValues_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.ObjectRawArray<>(nds.poi.instantiations.PoiLanePositionRelation.class, attributeValues_),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.poi.instantiations.PoiLanePositionRelation>(new ZserioElementFactory_attributeValues()),
                zserio.runtime.array.ArrayType.NORMAL);
    }
    ...
    {
        if (obj instanceof PoiLaneIndirectPositionRelationMap)
        {
            final PoiLaneIndirectPositionRelationMap that = (PoiLaneIndirectPositionRelationMap)obj;
    ...
    public void read(zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        attributeTypeCode_ = nds.poi.poi.PoiLanePositionRelationType.readEnum(in);
        ...
        featureValidities_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.ObjectRawArray<>(nds.lane.reference.types.LaneGroupPositionValidity.class),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.lane.reference.types.LaneGroupPositionValidity>(new ZserioElementFactory_featureValidities()),
                zserio.runtime.array.ArrayType.NORMAL);
        ...
        attributeValues_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.ObjectRawArray<>(nds.poi.instantiations.PoiLanePositionRelation.class),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.poi.instantiations.PoiLanePositionRelation>(new ZserioElementFactory_attributeValues()),
                zserio.runtime.array.ArrayType.NORMAL);
    ...
    {
        final ZserioPackingContext zserioContext = context.cast();
        attributeTypeCode_ = nds.poi.poi.PoiLanePositionRelationType.readEnum(zserioContext.getAttributeTypeCode(), in);
    ...
    public void write(zserio.runtime.io.BitStreamWriter out) throws java.io.IOException
    {
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field PoiLaneIndirectPositionRelationMap.featureReferences: " +
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field PoiLaneIndirectPositionRelationMap.featureValidities: " +
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field PoiLaneIndirectPositionRelationMap.featureValuePtr: " +
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field PoiLaneIndirectPositionRelationMap.attributeValues: " +
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field PoiLaneIndirectPositionRelationMap.attributeProperties: " +
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field PoiLaneIndirectPositionRelationMap.attributeConditions: " +
    ...
    private static final class ZserioElementFactory_featureReferences implements zserio.runtime.array.PackableElementFactory<nds.lane.reference.types.LaneGroupReferenceIndirect>
    {
        @Override
    ...
    private final class ZserioElementFactory_featureValidities implements zserio.runtime.array.PackableElementFactory<nds.lane.reference.types.LaneGroupPositionValidity>
    {
        @Override
        public nds.lane.reference.types.LaneGroupPositionValidity create(zserio.runtime.io.BitStreamReader in, int index)
                throws java.io.IOException
        {
            return new nds.lane.reference.types.LaneGroupPositionValidity(in, (byte)(getCoordShift()));
        }

        @Override
        public zserio.runtime.array.PackingContext createPackingContext()
        {
            return new nds.lane.reference.types.LaneGroupPositionValidity.ZserioPackingContext();
        }

        @Override
        public nds.lane.reference.types.LaneGroupPositionValidity create(zserio.runtime.array.PackingContext context,
                zserio.runtime.io.BitStreamReader in, int index) throws java.io.IOException
        {
            return new nds.lane.reference.types.LaneGroupPositionValidity(context, in, (byte)(getCoordShift()));
        }
    }

    private final class ZserioElementFactory_attributeValues implements zserio.runtime.array.PackableElementFactory<nds.poi.instantiations.PoiLanePositionRelation>
    {
        @Override
        public nds.poi.instantiations.PoiLanePositionRelation create(zserio.runtime.io.BitStreamReader in, int index)
                throws java.io.IOException
        {
            return new nds.poi.instantiations.PoiLanePositionRelation(in, getAttributeTypeCode());
        }

        @Override
        public zserio.runtime.array.PackingContext createPackingContext()
        {
            return new nds.poi.instantiations.PoiLanePositionRelation.ZserioPackingContext();
        }

        @Override
        public nds.poi.instantiations.PoiLanePositionRelation create(zserio.runtime.array.PackingContext context,
                zserio.runtime.io.BitStreamReader in, int index) throws java.io.IOException
        {
            return new nds.poi.instantiations.PoiLanePositionRelation(context, in, getAttributeTypeCode());
        }
    }
    ...
    private nds.poi.poi.PoiLanePositionRelationType attributeTypeCode_;
