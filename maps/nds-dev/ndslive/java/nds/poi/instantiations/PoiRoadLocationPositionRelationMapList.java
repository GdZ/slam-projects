...
public class PoiRoadLocationPositionRelationMapList implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    ...
    public PoiRoadLocationPositionRelationMapList(
            byte coordShift_)
    {
        this.coordShift_ = coordShift_;
    }

    public PoiRoadLocationPositionRelationMapList(zserio.runtime.io.BitStreamReader in,
            byte coordShift_)
    ...
    public PoiRoadLocationPositionRelationMapList(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in,
            byte coordShift_)
            throws java.io.IOException
    {
        this.coordShift_ = coordShift_;
    ...
    public PoiRoadLocationPositionRelationMapList(
            ...
            nds.poi.instantiations.PoiRoadLocationPositionRelationMap[] maps_)
    {
        this(coordShift_);
    ...
    public nds.poi.instantiations.PoiRoadLocationPositionRelationMap[] getMaps()
    {
        return (maps_ == null) ? null : maps_.getRawArray();
    }

    public void setMaps(nds.poi.instantiations.PoiRoadLocationPositionRelationMap[] maps_)
    {
        this.maps_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.ObjectRawArray<>(nds.poi.instantiations.PoiRoadLocationPositionRelationMap.class, maps_),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.poi.instantiations.PoiRoadLocationPositionRelationMap>(new ZserioElementFactory_maps()),
    ...
    {
        if (obj instanceof PoiRoadLocationPositionRelationMapList)
        {
            final PoiRoadLocationPositionRelationMapList that = (PoiRoadLocationPositionRelationMapList)obj;
            ...
            throws java.io.IOException
    {
        ...
        maps_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.ObjectRawArray<>(nds.poi.instantiations.PoiRoadLocationPositionRelationMap.class),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.poi.instantiations.PoiRoadLocationPositionRelationMap>(new ZserioElementFactory_maps()),
                zserio.runtime.array.ArrayType.NORMAL);
    ...
    public void write(zserio.runtime.io.BitStreamWriter out) throws java.io.IOException
    {
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong parameter numMaps for field PoiRoadLocationPositionRelationMapList.header: " +
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field PoiRoadLocationPositionRelationMapList.maps: " +
    ...
    private final class ZserioElementFactory_maps implements zserio.runtime.array.PackableElementFactory<nds.poi.instantiations.PoiRoadLocationPositionRelationMap>
    {
        @Override
        public nds.poi.instantiations.PoiRoadLocationPositionRelationMap create(zserio.runtime.io.BitStreamReader in, int index)
                throws java.io.IOException
        {
            return new nds.poi.instantiations.PoiRoadLocationPositionRelationMap(in, (byte)(getCoordShift()));
        }

        @Override
        public zserio.runtime.array.PackingContext createPackingContext()
        {
            return new nds.poi.instantiations.PoiRoadLocationPositionRelationMap.ZserioPackingContext();
        }

        @Override
        public nds.poi.instantiations.PoiRoadLocationPositionRelationMap create(zserio.runtime.array.PackingContext context,
                zserio.runtime.io.BitStreamReader in, int index) throws java.io.IOException
        {
            return new nds.poi.instantiations.PoiRoadLocationPositionRelationMap(context, in, (byte)(getCoordShift()));
        }
    }
