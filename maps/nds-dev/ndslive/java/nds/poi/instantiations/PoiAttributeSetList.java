...
public class PoiAttributeSetList implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    ...
    public PoiAttributeSetList(
            byte coordShift_)
    {
        this.coordShift_ = coordShift_;
    }

    public PoiAttributeSetList(zserio.runtime.io.BitStreamReader in,
            byte coordShift_)
    ...
    public PoiAttributeSetList(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in,
            byte coordShift_)
            throws java.io.IOException
    {
        this.coordShift_ = coordShift_;
    ...
    public PoiAttributeSetList(
            ...
            nds.poi.instantiations.PoiAttributeSetMap[] sets_)
    {
        this(coordShift_);
    ...
    public nds.poi.instantiations.PoiAttributeSetMap[] getSets()
    {
        return (sets_ == null) ? null : sets_.getRawArray();
    }

    public void setSets(nds.poi.instantiations.PoiAttributeSetMap[] sets_)
    {
        this.sets_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.ObjectRawArray<>(nds.poi.instantiations.PoiAttributeSetMap.class, sets_),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.poi.instantiations.PoiAttributeSetMap>(new ZserioElementFactory_sets()),
    ...
    {
        if (obj instanceof PoiAttributeSetList)
        {
            final PoiAttributeSetList that = (PoiAttributeSetList)obj;
            ...
            throws java.io.IOException
    {
        ...
        sets_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.ObjectRawArray<>(nds.poi.instantiations.PoiAttributeSetMap.class),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.poi.instantiations.PoiAttributeSetMap>(new ZserioElementFactory_sets()),
                zserio.runtime.array.ArrayType.NORMAL);
    ...
    public void write(zserio.runtime.io.BitStreamWriter out) throws java.io.IOException
    {
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field PoiAttributeSetList.sets: " +
    ...
    private final class ZserioElementFactory_sets implements zserio.runtime.array.PackableElementFactory<nds.poi.instantiations.PoiAttributeSetMap>
    {
        @Override
        public nds.poi.instantiations.PoiAttributeSetMap create(zserio.runtime.io.BitStreamReader in, int index)
                throws java.io.IOException
        {
            return new nds.poi.instantiations.PoiAttributeSetMap(in, (byte)(getCoordShift()));
        }

        @Override
        public zserio.runtime.array.PackingContext createPackingContext()
        {
            return new nds.poi.instantiations.PoiAttributeSetMap.ZserioPackingContext();
        }

        @Override
        public nds.poi.instantiations.PoiAttributeSetMap create(zserio.runtime.array.PackingContext context,
                zserio.runtime.io.BitStreamReader in, int index) throws java.io.IOException
        {
            return new nds.poi.instantiations.PoiAttributeSetMap(context, in, (byte)(getCoordShift()));
        }
    }
