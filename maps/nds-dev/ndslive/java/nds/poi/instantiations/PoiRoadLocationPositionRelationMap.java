...
public class PoiRoadLocationPositionRelationMap implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    ...
    public PoiRoadLocationPositionRelationMap(
            byte coordShift_)
    {
        this.coordShift_ = coordShift_;
    }

    public PoiRoadLocationPositionRelationMap(zserio.runtime.io.BitStreamReader in,
            byte coordShift_)
    ...
    public PoiRoadLocationPositionRelationMap(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in,
            byte coordShift_)
            throws java.io.IOException
    {
        this.coordShift_ = coordShift_;
    ...
    public PoiRoadLocationPositionRelationMap(
            ...
            int feature_,
            nds.road.reference.location.RoadLocationReference[] featureReferences_,
            nds.road.reference.location.RoadLocationPositionValidity[] featureValidities_,
            int[] featureValuePtr_,
            int attribute_,
            nds.poi.instantiations.PoiRoadPositionRelation[] attributeValues_,
    ...
    public nds.poi.poi.PoiRoadPositionRelationType getAttributeTypeCode()
    {
        return attributeTypeCode_;
    }

    public void setAttributeTypeCode(nds.poi.poi.PoiRoadPositionRelationType attributeTypeCode_)
    {
    ...
    public nds.road.reference.location.RoadLocationReference[] getFeatureReferences()
    {
        return (featureReferences_ == null) ? null : featureReferences_.getRawArray();
    }

    public void setFeatureReferences(nds.road.reference.location.RoadLocationReference[] featureReferences_)
    {
        this.featureReferences_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.ObjectRawArray<>(nds.road.reference.location.RoadLocationReference.class, featureReferences_),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.road.reference.location.RoadLocationReference>(new ZserioElementFactory_featureReferences()),
                zserio.runtime.array.ArrayType.NORMAL);
    }

    public nds.road.reference.location.RoadLocationPositionValidity[] getFeatureValidities()
    {
        return (featureValidities_ == null) ? null : featureValidities_.getRawArray();
    }

    public void setFeatureValidities(nds.road.reference.location.RoadLocationPositionValidity[] featureValidities_)
    {
        this.featureValidities_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.ObjectRawArray<>(nds.road.reference.location.RoadLocationPositionValidity.class, featureValidities_),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.road.reference.location.RoadLocationPositionValidity>(new ZserioElementFactory_featureValidities()),
                zserio.runtime.array.ArrayType.NORMAL);
    }
    ...
    public nds.poi.instantiations.PoiRoadPositionRelation[] getAttributeValues()
    {
        return (attributeValues_ == null) ? null : attributeValues_.getRawArray();
    }

    public void setAttributeValues(nds.poi.instantiations.PoiRoadPositionRelation[] attributeValues_)
    {
        this.attributeValues_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.ObjectRawArray<>(nds.poi.instantiations.PoiRoadPositionRelation.class, attributeValues_),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.poi.instantiations.PoiRoadPositionRelation>(new ZserioElementFactory_attributeValues()),
                zserio.runtime.array.ArrayType.NORMAL);
    }
    ...
    {
        if (obj instanceof PoiRoadLocationPositionRelationMap)
        {
            final PoiRoadLocationPositionRelationMap that = (PoiRoadLocationPositionRelationMap)obj;
    ...
    public void read(zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        attributeTypeCode_ = nds.poi.poi.PoiRoadPositionRelationType.readEnum(in);

        in.alignTo(8);
        feature_ = in.readVarSize();

        featureReferences_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.ObjectRawArray<>(nds.road.reference.location.RoadLocationReference.class),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.road.reference.location.RoadLocationReference>(new ZserioElementFactory_featureReferences()),
                zserio.runtime.array.ArrayType.NORMAL);
        ...
        featureValidities_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.ObjectRawArray<>(nds.road.reference.location.RoadLocationPositionValidity.class),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.road.reference.location.RoadLocationPositionValidity>(new ZserioElementFactory_featureValidities()),
                zserio.runtime.array.ArrayType.NORMAL);
        ...
        attributeValues_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.ObjectRawArray<>(nds.poi.instantiations.PoiRoadPositionRelation.class),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.poi.instantiations.PoiRoadPositionRelation>(new ZserioElementFactory_attributeValues()),
                zserio.runtime.array.ArrayType.NORMAL);
    ...
    {
        final ZserioPackingContext zserioContext = context.cast();
        attributeTypeCode_ = nds.poi.poi.PoiRoadPositionRelationType.readEnum(zserioContext.getAttributeTypeCode(), in);
    ...
    public void write(zserio.runtime.io.BitStreamWriter out) throws java.io.IOException
    {
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field PoiRoadLocationPositionRelationMap.featureReferences: " +
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field PoiRoadLocationPositionRelationMap.featureValidities: " +
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field PoiRoadLocationPositionRelationMap.featureValuePtr: " +
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field PoiRoadLocationPositionRelationMap.attributeValues: " +
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field PoiRoadLocationPositionRelationMap.attributeProperties: " +
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field PoiRoadLocationPositionRelationMap.attributeConditions: " +
    ...
    private static final class ZserioElementFactory_featureReferences implements zserio.runtime.array.PackableElementFactory<nds.road.reference.location.RoadLocationReference>
    {
        @Override
        public nds.road.reference.location.RoadLocationReference create(zserio.runtime.io.BitStreamReader in, int index)
                throws java.io.IOException
        {
            return new nds.road.reference.location.RoadLocationReference(in);
        }

        @Override
        public zserio.runtime.array.PackingContext createPackingContext()
        {
            return new nds.road.reference.location.RoadLocationReference.ZserioPackingContext();
        }

        @Override
        public nds.road.reference.location.RoadLocationReference create(zserio.runtime.array.PackingContext context,
                zserio.runtime.io.BitStreamReader in, int index) throws java.io.IOException
        {
            return new nds.road.reference.location.RoadLocationReference(context, in);
        }
    }

    private final class ZserioElementFactory_featureValidities implements zserio.runtime.array.PackableElementFactory<nds.road.reference.location.RoadLocationPositionValidity>
    {
        @Override
        public nds.road.reference.location.RoadLocationPositionValidity create(zserio.runtime.io.BitStreamReader in, int index)
                throws java.io.IOException
        {
            return new nds.road.reference.location.RoadLocationPositionValidity(in, (byte)(getCoordShift()));
        }

        @Override
        public zserio.runtime.array.PackingContext createPackingContext()
        {
            return new nds.road.reference.location.RoadLocationPositionValidity.ZserioPackingContext();
        }

        @Override
        public nds.road.reference.location.RoadLocationPositionValidity create(zserio.runtime.array.PackingContext context,
                zserio.runtime.io.BitStreamReader in, int index) throws java.io.IOException
        {
            return new nds.road.reference.location.RoadLocationPositionValidity(context, in, (byte)(getCoordShift()));
        }
    }

    private final class ZserioElementFactory_attributeValues implements zserio.runtime.array.PackableElementFactory<nds.poi.instantiations.PoiRoadPositionRelation>
    {
        @Override
        public nds.poi.instantiations.PoiRoadPositionRelation create(zserio.runtime.io.BitStreamReader in, int index)
                throws java.io.IOException
        {
            return new nds.poi.instantiations.PoiRoadPositionRelation(in, getAttributeTypeCode());
        }

        @Override
        public zserio.runtime.array.PackingContext createPackingContext()
        {
            return new nds.poi.instantiations.PoiRoadPositionRelation.ZserioPackingContext();
        }

        @Override
        public nds.poi.instantiations.PoiRoadPositionRelation create(zserio.runtime.array.PackingContext context,
                zserio.runtime.io.BitStreamReader in, int index) throws java.io.IOException
        {
            return new nds.poi.instantiations.PoiRoadPositionRelation(context, in, getAttributeTypeCode());
        }
    }
    ...
    private nds.poi.poi.PoiRoadPositionRelationType attributeTypeCode_;
