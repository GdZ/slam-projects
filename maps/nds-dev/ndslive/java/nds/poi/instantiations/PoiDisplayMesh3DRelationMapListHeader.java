...
public class PoiDisplayMesh3DRelationMapListHeader implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    public static final class ZserioPackingContext extends zserio.runtime.array.PackingContext
    {
    };

    public PoiDisplayMesh3DRelationMapListHeader(
            short numMaps_)
    {
        this.numMaps_ = numMaps_;
    }

    public PoiDisplayMesh3DRelationMapListHeader(zserio.runtime.io.BitStreamReader in,
            short numMaps_)
    ...
    public PoiDisplayMesh3DRelationMapListHeader(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in,
            short numMaps_)
            throws java.io.IOException
    {
        this.numMaps_ = numMaps_;
    ...
    public void setAttributeTypeCode(nds.poi.poi.PoiDisplayMesh3DRelationType[] attributeTypeCode_)
    {
        this.attributeTypeCode_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.EnumRawArray<>(nds.poi.poi.PoiDisplayMesh3DRelationType.class, attributeTypeCode_),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.poi.poi.PoiDisplayMesh3DRelationType>(new ZserioElementFactory_attributeTypeCode()),
    ...
    {
        if (obj instanceof PoiDisplayMesh3DRelationMapListHeader)
        {
            final PoiDisplayMesh3DRelationMapListHeader that = (PoiDisplayMesh3DRelationMapListHeader)obj;
    ...
    public void write(zserio.runtime.io.BitStreamWriter out) throws java.io.IOException
    {
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field PoiDisplayMesh3DRelationMapListHeader.attributeTypeCode: " +
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field PoiDisplayMesh3DRelationMapListHeader.conditionType: " +
    ...
    private static final class ZserioElementFactory_attributeTypeCode implements zserio.runtime.array.PackableElementFactory<nds.poi.poi.PoiDisplayMesh3DRelationType>
    {
        @Override
