...
public class PoiDisplayAreaRelationMetadata implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    ...
    public PoiDisplayAreaRelationMetadata()
    {
    }

    public PoiDisplayAreaRelationMetadata(zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        read(in);
    }

    public PoiDisplayAreaRelationMetadata(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        read(context, in);
    }
    ...
    public PoiDisplayAreaRelationMetadata(
            nds.poi.poi.PoiDisplayAreaRelationType[] availableAttributes_,
    ...
    public nds.poi.poi.PoiDisplayAreaRelationType[] getAvailableAttributes()
    {
        return (availableAttributes_ == null) ? null : availableAttributes_.getRawArray();
    }

    public void setAvailableAttributes(nds.poi.poi.PoiDisplayAreaRelationType[] availableAttributes_)
    {
        this.availableAttributes_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.EnumRawArray<>(nds.poi.poi.PoiDisplayAreaRelationType.class, availableAttributes_),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.poi.poi.PoiDisplayAreaRelationType>(new ZserioElementFactory_availableAttributes()),
    ...
    {
        if (obj instanceof PoiDisplayAreaRelationMetadata)
        {
            final PoiDisplayAreaRelationMetadata that = (PoiDisplayAreaRelationMetadata)obj;
            ...
            throws java.io.IOException
    {
        availableAttributes_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.EnumRawArray<>(nds.poi.poi.PoiDisplayAreaRelationType.class),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.poi.poi.PoiDisplayAreaRelationType>(new ZserioElementFactory_availableAttributes()),
                zserio.runtime.array.ArrayType.AUTO);
    ...
    private static final class ZserioElementFactory_availableAttributes implements zserio.runtime.array.PackableElementFactory<nds.poi.poi.PoiDisplayAreaRelationType>
    {
        @Override
        public nds.poi.poi.PoiDisplayAreaRelationType create(zserio.runtime.io.BitStreamReader in, int index)
                throws java.io.IOException
        {
            return nds.poi.poi.PoiDisplayAreaRelationType.readEnum(in);
        }
        ...
        @Override
        public nds.poi.poi.PoiDisplayAreaRelationType create(zserio.runtime.array.PackingContext context,
                zserio.runtime.io.BitStreamReader in, int index) throws java.io.IOException
        {
            return nds.poi.poi.PoiDisplayAreaRelationType.readEnum(context, in);
        }
    }
