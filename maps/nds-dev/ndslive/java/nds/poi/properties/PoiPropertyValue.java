...
public class PoiPropertyValue implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    public static final class ZserioPackingContext extends zserio.runtime.array.PackingContext
    {
        public ZserioPackingContext()
        {
            value_ = new nds.poi.properties.PropertyValue.ZserioPackingContext();
            coreValue_ = new nds.core.properties.CorePropertyValue.ZserioPackingContext();
        }

        public nds.poi.properties.PropertyValue.ZserioPackingContext getValue()
        {
            return value_;
        }
        ...
        private nds.poi.properties.PropertyValue.ZserioPackingContext value_;
        private nds.core.properties.CorePropertyValue.ZserioPackingContext coreValue_;
    };

    public PoiPropertyValue(
            nds.poi.properties.PoiPropertyType type_)
    {
        this.type_ = type_;
    }

    public PoiPropertyValue(zserio.runtime.io.BitStreamReader in,
            nds.poi.properties.PoiPropertyType type_)
    ...
    public PoiPropertyValue(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in,
            nds.poi.properties.PoiPropertyType type_)
            throws java.io.IOException
    {
        this.type_ = type_;
    ...
    public PoiPropertyValue(
            nds.poi.properties.PoiPropertyType type_,
            nds.poi.properties.PropertyValue value_,
    ...
    public nds.poi.properties.PoiPropertyType getType()
    {
        return this.type_;
    }

    public nds.poi.properties.PropertyValue getValue()
    {
        return value_;
    }

    public void setValue(nds.poi.properties.PropertyValue value_)
    {
        this.value_ = value_;
    }
    ...
    {
        if (obj instanceof PoiPropertyValue)
        {
            final PoiPropertyValue that = (PoiPropertyValue)obj;
            ...
            throws java.io.IOException
    {
        ...
        {
            value_ = new nds.poi.properties.PropertyValue(in, getType().getType());
        }
            ...
            throws java.io.IOException
    {
        ...
        if (getType().getType() != nds.poi.properties.PropertyType.CORE)
        {
            value_ = new nds.poi.properties.PropertyValue(zserioContext.getValue(), in, getType().getType());
        }
    ...
    public void write(zserio.runtime.io.BitStreamWriter out) throws java.io.IOException
    {
        if (isValueUsed())
        {
            ...
            {
                throw new zserio.runtime.ZserioError("Write: Inconsistent parameter type for field PoiPropertyValue.value!");
            }
            value_.write(out);
        }
        ...
        if (isCoreValueUsed())
        {
            ...
            {
                throw new zserio.runtime.ZserioError("Write: Inconsistent parameter type for field PoiPropertyValue.coreValue!");
            }
    ...
    private final nds.poi.properties.PoiPropertyType type_;
    private nds.poi.properties.PropertyValue value_;
