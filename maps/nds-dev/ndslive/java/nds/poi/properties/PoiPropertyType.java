...
public class PoiPropertyType implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    ...
    public PoiPropertyType()
    {
    }

    public PoiPropertyType(zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        read(in);
    }

    public PoiPropertyType(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        read(context, in);
    }
    ...
    public void setType(nds.poi.properties.PropertyType type_)
    {
        this.type_ = type_;
    }
    ...
    {
        if (obj instanceof PoiPropertyType)
        {
            final PoiPropertyType that = (PoiPropertyType)obj;
    ...
    public void read(zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        type_ = nds.poi.properties.PropertyType.readEnum(in);
    ...
    {
        final ZserioPackingContext zserioContext = context.cast();
        type_ = nds.poi.properties.PropertyType.readEnum(zserioContext.getType(), in);
    ...
    private nds.poi.properties.PropertyType type_;
