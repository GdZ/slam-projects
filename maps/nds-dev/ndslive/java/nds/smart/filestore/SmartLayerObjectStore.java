...
public class SmartLayerObjectStore implements zserio.runtime.SqlDatabase
{
    public SmartLayerObjectStore(java.lang.String fileName) throws java.sql.SQLException
    {
        this(fileName, new java.util.HashMap<java.lang.String, java.lang.String>());
    }

    public SmartLayerObjectStore(java.lang.String fileName,
            ...
            throws java.sql.SQLException
    {
                ...
                tableToDbFileNameRelocationMap.entrySet())
        {
            ...
            {
                attachedDbName = "SmartLayerObjectStore" + "_" + relocatedTableName;
    ...
    public SmartLayerObjectStore(java.sql.Connection externalConnection)
    {
    ...
    public nds.smart.filestore.SmartLayerObjectTable getObjectTable()
    {
        return this.objectTable_;
    }
    ...
    private void initTables(java.util.Map<java.lang.String, java.lang.String> tableToAttachedDbNameRelocationMap)
    {
        this.metadataTable_ = new nds.smart.filestore.SmartLayerMetadataTable(connection,
                ...
                metadataTable_TABLE_NAME);
        this.objectTable_ = new nds.smart.filestore.SmartLayerObjectTable(connection,
                tableToAttachedDbNameRelocationMap.get(objectTable_TABLE_NAME),
                objectTable_TABLE_NAME);
    }
    ...
    private static final java.lang.String DATABASE_NAME = "SmartLayerObjectStore";
    private static final java.lang.String metadataTable_TABLE_NAME = "metadataTable";
    private static final java.lang.String objectTable_TABLE_NAME = "objectTable";
    ...
    private nds.smart.filestore.SmartLayerObjectTable objectTable_;
}
