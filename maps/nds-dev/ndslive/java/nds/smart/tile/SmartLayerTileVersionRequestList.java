...
public class SmartLayerTileVersionRequestList implements zserio.runtime.io.PackableWriter, zserio.runtime.PackableSizeOf
{
    ...
    public SmartLayerTileVersionRequestList()
    {
    }

    public SmartLayerTileVersionRequestList(zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        read(in);
    }

    public SmartLayerTileVersionRequestList(zserio.runtime.array.PackingContext context, zserio.runtime.io.BitStreamReader in)
            throws java.io.IOException
    {
        read(context, in);
    }
    ...
    public SmartLayerTileVersionRequestList(
            int numTiles_,
            nds.smart.tile.SmartLayerTileVersionRequest[] tileVersionRequests_)
    {
    ...
    public nds.smart.tile.SmartLayerTileVersionRequest[] getTileVersionRequests()
    {
        return (tileVersionRequests_ == null) ? null : tileVersionRequests_.getRawArray();
    }

    public void setTileVersionRequests(nds.smart.tile.SmartLayerTileVersionRequest[] tileVersionRequests_)
    {
        this.tileVersionRequests_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.ObjectRawArray<>(nds.smart.tile.SmartLayerTileVersionRequest.class, tileVersionRequests_),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.smart.tile.SmartLayerTileVersionRequest>(new ZserioElementFactory_tileVersionRequests()),
    ...
    {
        if (obj instanceof SmartLayerTileVersionRequestList)
        {
            final SmartLayerTileVersionRequestList that = (SmartLayerTileVersionRequestList)obj;
            ...
            throws java.io.IOException
    {
        ...
        tileVersionRequests_ = new zserio.runtime.array.Array(
                new zserio.runtime.array.RawArray.ObjectRawArray<>(nds.smart.tile.SmartLayerTileVersionRequest.class),
                new zserio.runtime.array.ArrayTraits.WritePackableObjectArrayTraits<nds.smart.tile.SmartLayerTileVersionRequest>(new ZserioElementFactory_tileVersionRequests()),
                zserio.runtime.array.ArrayType.NORMAL);
    ...
    public void write(zserio.runtime.io.BitStreamWriter out) throws java.io.IOException
    {
        ...
        {
            throw new zserio.runtime.ZserioError("Write: Wrong array length for field SmartLayerTileVersionRequestList.tileVersionRequests: " +
    ...
    private static final class ZserioElementFactory_tileVersionRequests implements zserio.runtime.array.PackableElementFactory<nds.smart.tile.SmartLayerTileVersionRequest>
    {
        @Override
        public nds.smart.tile.SmartLayerTileVersionRequest create(zserio.runtime.io.BitStreamReader in, int index)
                throws java.io.IOException
        {
            return new nds.smart.tile.SmartLayerTileVersionRequest(in);
        }

        @Override
        public zserio.runtime.array.PackingContext createPackingContext()
        {
            return new nds.smart.tile.SmartLayerTileVersionRequest.ZserioPackingContext();
        }

        @Override
        public nds.smart.tile.SmartLayerTileVersionRequest create(zserio.runtime.array.PackingContext context,
                zserio.runtime.io.BitStreamReader in, int index) throws java.io.IOException
        {
            return new nds.smart.tile.SmartLayerTileVersionRequest(context, in);
        }
    }
