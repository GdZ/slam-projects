...
struct RangeProjectionRequest
{
  ...
  Seconds timeBudget if (type & RangeProjectionType.TIME) == RangeProjectionType.TIME;

  /** Maximum distance budget for distance-based requests. */
  DistanceMeters distanceMeters if (type & RangeProjectionType.DISTANCE) == RangeProjectionType.DISTANCE;
