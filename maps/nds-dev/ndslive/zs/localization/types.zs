...
struct LandmarkSignDetails
{
  ...
  WarningSign meaning
      if (detailType & LandmarkSignDetailsType.MEANING) == LandmarkSignDetailsType.MEANING;

  /** Diameter of the sign. */
  WidthCentimeters diameter
      if (detailType & LandmarkSignDetailsType.DIAMETER) == LandmarkSignDetailsType.DIAMETER;

  /** Content of the sign represented as a number, for example, the value of a speed limit. */
  varuint64 number
      if (detailType & LandmarkSignDetailsType.NUMBER) == LandmarkSignDetailsType.NUMBER;

  /** Content of the sign represented as a string, for example, text or QR codes. */
  string text
      if (detailType & LandmarkSignDetailsType.TEXT) == LandmarkSignDetailsType.TEXT;
};
