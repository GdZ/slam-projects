...
RAILROAD_CROSSING_WITH_GATES           |A25                   |![Protected railroad crossing ahead (Germany).](assets/warning_railroadgates_de.png)                         |
RAILROAD_CROSSING_WITHOUT_GATES        |A26                   |![Unprotected railroad crossing ahead (Sweden).](assets/warning_railroadunguarded_sv.png)                    |![Unprotected railroad crossing ahead (Germany).](assets/warning_railroadunguarded_de.png)
RAILROAD_CROSSING                      |A28                   |![Railroad crossing ahead (UK).](assets/warning_railroadcrossing.png)                                        |
