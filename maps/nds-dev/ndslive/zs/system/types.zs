...
/** Universally unique identifier. 16 Byte, RFC 4122 version 5. **/
struct UUID
{
  uint8 uuid[16];
};
...
- `ModuleVersion` = \<Release year\>.\<incremental two-digit number with leading
  zero\>
    - Numbers are incremented with every release. If there are more than 99
      releases in a year, three digits are used.
    - Examples: `2020.05`, `2021.15`, `2022.101`
