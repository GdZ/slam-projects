...
ADAS attributes are assigned to positions or ranges on an ADAS geometry. The
ADAS geometry is independent of the road geometry and can contain different
positions than the corresponding road. For more information, see [ADAS
Geometry](types.zs).

The ADAS attributes can be assigned to roads, road locations, and lanes, using
...
const ModuleVersion VERSION = "2023.09";
