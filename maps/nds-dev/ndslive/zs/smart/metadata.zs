...
struct SmartLayerRegistryMetadata
{
  ...
  /** Metadata on the data layers served by the smart layer service. */
...
## Smart Layer Definition

The smart layer definition is the return value of the `SmartLayerTileService.getLayerDefinition`
and the `SmartLayerPathService.getLayerDefinition` API. The smart layer definition
provides the following information about the corresponding service:

- Filter criteria that describe for which road classes, vehicle classes or vehicle
  specifications the data of the smart layer is applicable. Filter criteria are
  defined in the `dataContents` field.
- The content of the data layers returned as part of `SmartLayer` results by the
  service. This information is defined in the `layerDefinitions` field.
...
{
  /** Metadata of data coverage that is valid for all layers within the smart layer. */
...
/**
  * Description of the content and coverage of the smart layer's data layers.
...
struct SmartLayerContent
{
  ...
  VehicleTypeInformation vehicleTypes;

  /** Detailed information on vehicles for which the smart layer applies. */
  optional VehicleClassSpecification vehicleClass;
};
