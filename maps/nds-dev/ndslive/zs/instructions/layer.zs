...
struct RoadInstructionsLayer
{
  ...
  InstructionsTransitionAttributeMapList(shift) transitionAttributeMaps
        if (content & RoadInstructionsLayerContent.TRANSITION_MAPS)
                   == RoadInstructionsLayerContent.TRANSITION_MAPS;

  /** Attribute sets for transition attributes. */
  InstructionsTransitionAttributeSetList(shift) transitionAttributeSets
        if (content & RoadInstructionsLayerContent.TRANSITION_SETS)
                   == RoadInstructionsLayerContent.TRANSITION_SETS;
...
struct LaneInstructionsLayer
{
  ...
  InstructionsLaneTransitionAttributeMapList(0) laneTransitionAttributeMaps
        if (content & LaneInstructionsLayerContent.LANE_TRANSITION_MAPS)
                   == LaneInstructionsLayerContent.LANE_TRANSITION_MAPS;

  /** Attribute sets for lane transition attributes. */
  InstructionsLaneTransitionAttributeSetList(0) laneTransitionAttributeSets
        if (content & LaneInstructionsLayerContent.LANE_TRANSITION_SETS)
                   == LaneInstructionsLayerContent.LANE_TRANSITION_SETS;
...
struct InstructionsImageLayer
{
  ...
  SignpostImageList signpostImageList
        if (content & InstructionsImageLayerContent.SIGNPOSTS)
                   == InstructionsImageLayerContent.SIGNPOSTS;

  /** Junction view images provided by the layer. */
  JunctionViewImageList junctionViewImageList
        if (content & InstructionsImageLayerContent.JUNCTION_VIEW)
                   == InstructionsImageLayerContent.JUNCTION_VIEW;
