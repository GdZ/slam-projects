...
- **Lanes**: A lane corresponds to the part of a real-world lane that is stored
  ...
  groups, border lane groups, and artificial intersection lane groups.
  Zero-length lanes exist for topology reasons and only store connectivity
  information.
...
const ModuleVersion VERSION = "2023.11";
