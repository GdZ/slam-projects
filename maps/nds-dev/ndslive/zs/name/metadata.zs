...
struct RoadNameLayerMetadata
{
  ...
  NameRoadRangeAttributeMetadata roadRangeAttributeMetadata
        if(content & RoadNameLayerContent.ROAD_RANGE_MAPS)
           == RoadNameLayerContent.ROAD_RANGE_MAPS
       || (content & RoadNameLayerContent.ROAD_RANGE_SETS)
           == RoadNameLayerContent.ROAD_RANGE_SETS;
  ...
  NameRoadPositionAttributeMetadata roadPositionAttributeMetadata
        if(content & RoadNameLayerContent.ROAD_POSITION_MAPS)
           == RoadNameLayerContent.ROAD_POSITION_MAPS
       || (content & RoadNameLayerContent.ROAD_POSITION_SETS)
           == RoadNameLayerContent.ROAD_POSITION_SETS;
  ...
  NameTransitionAttributeMetadata transitionAttributeMetadata
        if(content & RoadNameLayerContent.TRANSITION_MAPS)
           == RoadNameLayerContent.TRANSITION_MAPS
       || (content & RoadNameLayerContent.TRANSITION_SETS)
           == RoadNameLayerContent.TRANSITION_SETS;
...
struct LaneNameLayerMetadata
{
  ...
  NameLaneRangeAttributeMetadata laneRangeAttributeMetadata
        if(content & LaneNameLayerContent.LANE_RANGE_MAPS)
           == LaneNameLayerContent.LANE_RANGE_MAPS
       || (content & LaneNameLayerContent.LANE_RANGE_SETS)
           == LaneNameLayerContent.LANE_RANGE_SETS;
  ...
  NameLanePositionAttributeMetadata lanePositionAttributeMetadata
        if(content & LaneNameLayerContent.LANE_POSITION_MAPS)
           == LaneNameLayerContent.LANE_POSITION_MAPS
       || (content & LaneNameLayerContent.LANE_POSITION_SETS)
           == LaneNameLayerContent.LANE_POSITION_SETS;
...
struct DisplayNameLayerMetadata
{
  ...
  NameDisplayAreaAttributeMetadata displayAreaAttributeMetadata
       ...
       || (content & DisplayNameLayerContent.DISPLAY_AREA_SETS)
  ...
  NameDisplayPointAttributeMetadata displayPointAttributeMetadata
       ...
       || (content & DisplayNameLayerContent.DISPLAY_POINT_SETS)
...
struct AddressSearchResultDetails
{
  ...
  NameRoadRangeFullAttribute nameAttributes[]
    if(content & AddressSearchResultDetailsContent.ATTRIBUTES)
              == AddressSearchResultDetailsContent.ATTRIBUTES;
  ...
  AdministrativeHierarchyElement adminElements[]
    if(content & AddressSearchResultDetailsContent.ADMINISTRATIVE_HIERARCHY)
              == AddressSearchResultDetailsContent.ADMINISTRATIVE_HIERARCHY;

  /** Identifier of the address format that is used for detailed display. */
  AddressFormatId addressFormatId
    if(content & AddressSearchResultDetailsContent.ADDRESS_FORMAT_ID)
              == AddressSearchResultDetailsContent.ADDRESS_FORMAT_ID;
};
...
struct AddressSearchFilter
{
  ...
  AdminHierarchyElementType adminHierarchyElementType[]
    if(filterOptions & AddressSearchFilterOptions.ADMINISTRATIVE_HIERARCHY_FILTER)
                    == AddressSearchFilterOptions.ADMINISTRATIVE_HIERARCHY_FILTER;

  /** Address results are to be filtered by a dedicated address format. */
  AddressFormatId addressFormatId
    if(filterOptions & AddressSearchFilterOptions.ADDRESS_FORMAT_FILTER)
                    == AddressSearchFilterOptions.ADDRESS_FORMAT_FILTER;
};
...
struct PoiNameLayerMetadata
{
  ...
  NamePoiAttributeMetadata poiAttributeMetadata
        if(content & PoiNameLayerContent.POI_MAPS)
           == PoiNameLayerContent.POI_MAPS
       || (content & PoiNameLayerContent.POI_SETS)
           == PoiNameLayerContent.POI_SETS;
