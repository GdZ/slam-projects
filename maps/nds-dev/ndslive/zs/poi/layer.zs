...
struct PoiAttributeLayer
{
  ...
  PoiAttributeMapList(0) poiAttributeMaps
    if (content & PoiAttributeLayerContent.POI_ATTRIBUTE_MAPS)
    == PoiAttributeLayerContent.POI_ATTRIBUTE_MAPS;

  /** POI attribute sets. */
  PoiAttributeSetList(0) poiAttributeSets
    if (content & PoiAttributeLayerContent.POI_ATTRIBUTE_SETS)
    == PoiAttributeLayerContent.POI_ATTRIBUTE_SETS;
...
struct PoiRelationLayer
{
  ...
  PoiLaneIndirectPositionRelationMapList(0) poiLaneIndirectPositionRelationMapList
      if (content & PoiRelationLayerContent.LANE_INDIRECT_POSITION_MAPS)
  ...
  PoiRoadIndirectPositionRelationMapList(0) poiRoadIndirectPositionRelationMapList
      if (content & PoiRelationLayerContent.ROAD_INDIRECT_POSITION_MAPS)
  ...
  PoiRoadLocationPositionRelationMapList(0) poiRoadLocationPositionRelationMapList
      if (content & PoiRelationLayerContent.ROAD_LOCATION_POSITION_MAPS)
  ...
  PoiDisplayMesh3DRelationMapList(0) poiDisplayMesh3DRelationMapList
      if (content & PoiRelationLayerContent.DISPLAY_MESH_MAPS)
          == PoiRelationLayerContent.DISPLAY_MESH_MAPS;
