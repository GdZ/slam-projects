...
struct PoiSearchMetadata
{
  ...
  PoiCategory filterCategories[]
    if (supportedFilter & PoiSearchFilterOptions.CATEGORY_FILTER) == PoiSearchFilterOptions.CATEGORY_FILTER;
  ...
  PoiAttributeMetadata filterAttributes
    if (supportedFilter & PoiSearchFilterOptions.ATTRIBUTE_FILTER) == PoiSearchFilterOptions.ATTRIBUTE_FILTER;
};
...
struct PoiSearchFilter
{
  ...
  PoiCategoryId filterCategories[]
    if (filterOptions & PoiSearchFilterOptions.CATEGORY_FILTER) == PoiSearchFilterOptions.CATEGORY_FILTER;

  /** List of POI attributes to filter POI search results. */
  PoiFullAttribute filterAttributes[]
    if (filterOptions & PoiSearchFilterOptions.ATTRIBUTE_FILTER) == PoiSearchFilterOptions.ATTRIBUTE_FILTER;
};
...
struct PoiRelationLayerMetadata
{
  ...
  PoiRoadPositionRelationMetadata poiRoadPositionRelationMetadata
            if (content & PoiRelationLayerContent.ROAD_POSITION_MAPS)
                == PoiRelationLayerContent.ROAD_POSITION_MAPS ||
               (content & PoiRelationLayerContent.ROAD_INDIRECT_POSITION_MAPS)
                == PoiRelationLayerContent.ROAD_INDIRECT_POSITION_MAPS ||
               (content & PoiRelationLayerContent.ROAD_LOCATION_POSITION_MAPS)
                == PoiRelationLayerContent.ROAD_LOCATION_POSITION_MAPS;
  ...
  PoiLanePositionRelationMetadata poiLanePositionRelationMetadata
            if (content & PoiRelationLayerContent.LANE_POSITION_MAPS)
                == PoiRelationLayerContent.LANE_POSITION_MAPS ||
               (content & PoiRelationLayerContent.LANE_INDIRECT_POSITION_MAPS)
                == PoiRelationLayerContent.LANE_INDIRECT_POSITION_MAPS;
  ...
  PoiDisplayAreaRelationMetadata poiDisplayAreaRelationMetadata
            if (content & PoiRelationLayerContent.DISPLAY_AREA_MAPS)
                == PoiRelationLayerContent.DISPLAY_AREA_MAPS ||
               (content & PoiRelationLayerContent.DISPLAY_AREA_MAPS)
                == PoiRelationLayerContent.DISPLAY_AREA_MAPS;
};
