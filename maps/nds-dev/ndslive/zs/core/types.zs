...
/**
  *  Allowed travel direction of road users on a road or lane.
  *  @deprecated
  */
subtype Direction TravelDirection;
...
-----------------------------------------|--------------------------------------------------------------------------------|
`PARKING_LANE`                           |![Parking lane](assets/Lanes_LaneTypes_Parking.jpg)                       |
`TRUCK_PARKING_LANE`                     |![Truck parking lane](assets/Lanes_LaneTypes_TruckParking.jpg)            |
`WAITING_LANE`                           |![Waiting lane](assets/Lanes_LaneTypes_WaitingLane.jpg)                   |
`U_TURN_LANE`                            |![U-turn lane](assets/Lanes_LaneTypes_UTurnLane.png)                      |
...
enum varuint16 LaneFunctionalType
{
  ...
  /** Lane that is used as entry and exit.*/
  ENTRY_AND_EXIT_LANE,

  /**
  * A lane that is either a center turning lane, a two-way turning lane to the
  * right or left, or a shared turning lane. Turning lanes are used to enable
  * left or right turns without disrupting ongoing traffic.
  */
  TURNING_LANE,
