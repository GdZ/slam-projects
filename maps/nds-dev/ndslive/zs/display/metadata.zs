...
struct Display2DLayerMetadata
{
  ...
  DisplayAreaType availableDisplayAreaTypes[]
    ...
    || (content & Display2DContent.SIMPLE_AREAS) == Display2DContent.SIMPLE_AREAS
    || (content & Display2DContent.SIMPLE_AREA_SETS) == Display2DContent.SIMPLE_AREA_SETS;
  ...
  DisplayAreaTypeHierarchyRelation displayAreaTypeRelations[]
    if (content & Display2DContent.AREA_TYPE_RELATIONS)
               == Display2DContent.AREA_TYPE_RELATIONS;

  /** Relations between display line types. */
  DisplayLineTypeHierarchyRelation displayLineTypeRelations[]
    if (content & Display2DContent.LINE_TYPE_RELATIONS)
               == Display2DContent.LINE_TYPE_RELATIONS;

  /** Relations between display point types. */
  DisplayPointTypeHierarchyRelation displayPointTypeRelations[]
    if (content & Display2DContent.POINT_TYPE_RELATIONS)
               == Display2DContent.POINT_TYPE_RELATIONS;
