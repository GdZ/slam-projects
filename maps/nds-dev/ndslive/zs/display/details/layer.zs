...
struct DisplayAttributeLayer
{
  ...
  DisplayAreaAttributeMapList(0) displayAreaAttributeMaps
    if (content & DisplayAttributeLayerContent.DISPLAY_AREA_MAPS)
    == DisplayAttributeLayerContent.DISPLAY_AREA_MAPS;

  /** List of attribute sets for display areas. */
  DisplayAreaAttributeSetList(0) displayAreaAttributeSets
    if (content & DisplayAttributeLayerContent.DISPLAY_AREA_SETS)
    == DisplayAttributeLayerContent.DISPLAY_AREA_SETS;

  /** List of attribute maps for display lines. */
  DisplayLineAttributeMapList(0) displayLineAttributeMaps
    if (content & DisplayAttributeLayerContent.DISPLAY_LINE_MAPS)
    == DisplayAttributeLayerContent.DISPLAY_LINE_MAPS;

  /** List of attribute sets for display lines. */
  DisplayLineAttributeSetList(0) displayLineAttributeSets
    if (content & DisplayAttributeLayerContent.DISPLAY_LINE_SETS)
    == DisplayAttributeLayerContent.DISPLAY_LINE_SETS;

  /** List of attribute maps for display points. */
  DisplayPointAttributeMapList(0) displayPointAttributeMaps
    if (content & DisplayAttributeLayerContent.DISPLAY_POINT_MAPS)
    == DisplayAttributeLayerContent.DISPLAY_POINT_MAPS;

  /** List of attribute sets for display points. */
  DisplayPointAttributeSetList(0) displayPointAttributeSets
    if (content & DisplayAttributeLayerContent.DISPLAY_POINT_SETS)
    == DisplayAttributeLayerContent.DISPLAY_POINT_SETS;
...
struct Display3dAttributeLayer
{
  ...
  Display3dMeshAttributeMapList(0) display3dMeshAttributeMaps
    if (content & Display3dAttributeLayerContent.DISPLAY_MESH_MAPS)
               == Display3dAttributeLayerContent.DISPLAY_MESH_MAPS;

  Display3dMeshAttributeSetList(0) display3dMeshAttributeSets
    if (content & Display3dAttributeLayerContent.DISPLAY_MESH_SETS)
               == Display3dAttributeLayerContent.DISPLAY_MESH_SETS;
