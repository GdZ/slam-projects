...
#ifndef NDS_ROUTINGDATA_ATTRIBUTES_ROUTING_ROAD_RANGE_ATTRIBUTE_VALUE_H
#define NDS_ROUTINGDATA_ATTRIBUTES_ROUTING_ROAD_RANGE_ATTRIBUTE_VALUE_H
...
public:
    ...
    enum ChoiceTag : int32_t
    {
        ...
        CHOICE_numNormalLanes = 16,
        CHOICE_numEntryExitLanes = 17,
        UNDEFINED_CHOICE = -1
    };
    ...
    public:
        ...
        ::zserio::DeltaContext& getNumNormalLanes()
        {
            return m_numNormalLanes_;
        }

        ::zserio::DeltaContext& getNumEntryExitLanes()
        {
            return m_numEntryExitLanes_;
        }
    ...
    private:
        ...
        ::zserio::DeltaContext m_numNormalLanes_;
        ::zserio::DeltaContext m_numEntryExitLanes_;
    };

    RoutingRoadRangeAttributeValue() noexcept :
            RoutingRoadRangeAttributeValue(allocator_type())
    {}

    explicit RoutingRoadRangeAttributeValue(const allocator_type& allocator) noexcept;

    explicit RoutingRoadRangeAttributeValue(::zserio::BitStreamReader& in,
            ::nds::routingdata::attributes::RoutingRoadRangeAttributeType type_, const allocator_type& allocator = allocator_type());
    explicit RoutingRoadRangeAttributeValue(ZserioPackingContext& context,
            ::zserio::BitStreamReader& in,
            ::nds::routingdata::attributes::RoutingRoadRangeAttributeType type_, const allocator_type& allocator = allocator_type());

    ~RoutingRoadRangeAttributeValue() = default;

    RoutingRoadRangeAttributeValue(const RoutingRoadRangeAttributeValue& other);
    RoutingRoadRangeAttributeValue& operator=(const RoutingRoadRangeAttributeValue& other);

    RoutingRoadRangeAttributeValue(RoutingRoadRangeAttributeValue&& other);
    RoutingRoadRangeAttributeValue& operator=(RoutingRoadRangeAttributeValue&& other);

    RoutingRoadRangeAttributeValue(::zserio::PropagateAllocatorT,
    ...
    ::nds::routingdata::attributes::RoutingRoadRangeAttributeType getType() const;
    ...
    uint8_t getNumNormalLanes() const;
    void setNumNormalLanes(uint8_t numNormalLanes_);

    uint8_t getNumEntryExitLanes() const;
    void setNumEntryExitLanes(uint8_t numEntryExitLanes_);
    ...
    bool operator==(const RoutingRoadRangeAttributeValue& other) const;
...
private:
    ...
    ::nds::routingdata::attributes::RoutingRoadRangeAttributeType m_type_;
...
#endif // NDS_ROUTINGDATA_ATTRIBUTES_ROUTING_ROAD_RANGE_ATTRIBUTE_VALUE_H
