...
#ifndef NDS_ROUTINGDATA_INSTANTIATIONS_ROUTING_ROAD_TRANSITION_ATTRIBUTE_SET_MAP_H
#define NDS_ROUTINGDATA_INSTANTIATIONS_ROUTING_ROAD_TRANSITION_ATTRIBUTE_SET_MAP_H
...
public:
    ...
    {
    public:
        ::nds::routingdata::instantiations::RoutingRoadTransitionAttributeSet::ZserioPackingContext& getAttributeSet()
        {
    ...
    private:
        ::nds::routingdata::instantiations::RoutingRoadTransitionAttributeSet::ZserioPackingContext m_attributeSet_;
        ::zserio::DeltaContext m_feature_;
    };

    using allocator_type = ::std::allocator<uint8_t>;

    RoutingRoadTransitionAttributeSetMap() noexcept :
            RoutingRoadTransitionAttributeSetMap(allocator_type())
    {}

    explicit RoutingRoadTransitionAttributeSetMap(const allocator_type& allocator) noexcept;

    template <typename ZSERIO_T_attributeSet = ::nds::routingdata::instantiations::RoutingRoadTransitionAttributeSet,
            ...
            ::zserio::is_field_constructor_enabled_t<ZSERIO_T_attributeSet, RoutingRoadTransitionAttributeSetMap, allocator_type> = 0>
    RoutingRoadTransitionAttributeSetMap(
            ...
            RoutingRoadTransitionAttributeSetMap(allocator)
    {
    ...
    explicit RoutingRoadTransitionAttributeSetMap(::zserio::BitStreamReader& in,
            ::nds::core::geometry::CoordShift coordShift_, const allocator_type& allocator = allocator_type());
    explicit RoutingRoadTransitionAttributeSetMap(ZserioPackingContext& context,
            ::zserio::BitStreamReader& in,
            ::nds::core::geometry::CoordShift coordShift_, const allocator_type& allocator = allocator_type());

    ~RoutingRoadTransitionAttributeSetMap() = default;

    RoutingRoadTransitionAttributeSetMap(const RoutingRoadTransitionAttributeSetMap& other);
    RoutingRoadTransitionAttributeSetMap& operator=(const RoutingRoadTransitionAttributeSetMap& other);

    RoutingRoadTransitionAttributeSetMap(RoutingRoadTransitionAttributeSetMap&& other);
    RoutingRoadTransitionAttributeSetMap& operator=(RoutingRoadTransitionAttributeSetMap&& other);

    RoutingRoadTransitionAttributeSetMap(::zserio::PropagateAllocatorT,
    ...
    const ::nds::routingdata::instantiations::RoutingRoadTransitionAttributeSet& getAttributeSet() const;
    ::nds::routingdata::instantiations::RoutingRoadTransitionAttributeSet& getAttributeSet();
    void setAttributeSet(const ::nds::routingdata::instantiations::RoutingRoadTransitionAttributeSet& attributeSet_);
    void setAttributeSet(::nds::routingdata::instantiations::RoutingRoadTransitionAttributeSet&& attributeSet_);
    ...
    bool operator==(const RoutingRoadTransitionAttributeSetMap& other) const;
...
private:
    ...
    {
    public:
        using OwnerType = RoutingRoadTransitionAttributeSetMap;

        static void initializeElement(RoutingRoadTransitionAttributeSetMap& owner,
    ...
    public:
        ...
        static void create(RoutingRoadTransitionAttributeSetMap& owner,
    ...
    ::nds::routingdata::instantiations::RoutingRoadTransitionAttributeSet readAttributeSet(::zserio::BitStreamReader& in,
            const allocator_type& allocator);
    ::nds::routingdata::instantiations::RoutingRoadTransitionAttributeSet readAttributeSet(ZserioPackingContext& context,
    ...
    ::nds::routingdata::instantiations::RoutingRoadTransitionAttributeSet m_attributeSet_;
...
#endif // NDS_ROUTINGDATA_INSTANTIATIONS_ROUTING_ROAD_TRANSITION_ATTRIBUTE_SET_MAP_H
