...
#ifndef NDS_LANE_METADATA_GEOMETRY_LAYER_METADATA_H
#define NDS_LANE_METADATA_GEOMETRY_LAYER_METADATA_H
...
public:
    ...
    ::nds::lane::metadata::GeometryLayerType getLayerType() const;
    void setLayerType(::nds::lane::metadata::GeometryLayerType layerType_);
...
private:
    ::nds::lane::metadata::GeometryLayerType readLayerType(::zserio::BitStreamReader& in);
    ::nds::lane::metadata::GeometryLayerType readLayerType(ZserioPackingContext& context,
            ::zserio::BitStreamReader& in);

    ::nds::lane::metadata::GeometryLayerType m_layerType_;
};
...
#endif // NDS_LANE_METADATA_GEOMETRY_LAYER_METADATA_H
