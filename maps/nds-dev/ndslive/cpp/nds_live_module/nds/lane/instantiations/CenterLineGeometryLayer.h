...
#ifndef NDS_LANE_INSTANTIATIONS_CENTER_LINE_GEOMETRY_LAYER_H
#define NDS_LANE_INSTANTIATIONS_CENTER_LINE_GEOMETRY_LAYER_H
...
public:
    ...
    CenterLineGeometryLayer() noexcept :
            CenterLineGeometryLayer(allocator_type())
    {}

    explicit CenterLineGeometryLayer(const allocator_type& allocator) noexcept;

    template <typename ZSERIO_T_identifier = ::zserio::vector<::nds::lane::lanes::LaneCenterLineGeometryId>,
            typename ZSERIO_T_types = ::zserio::vector<::nds::core::geometry::GeometryType>,
            typename ZSERIO_T_buffers = ::nds::core::geometry::Buffers>
    CenterLineGeometryLayer(
            ...
            CenterLineGeometryLayer(allocator)
    {
    ...
    explicit CenterLineGeometryLayer(::zserio::BitStreamReader& in,
            ::nds::core::geometry::GeometryLayerType type_,
            bool hasIds_,
            bool hasTypes_, const allocator_type& allocator = allocator_type());
    explicit CenterLineGeometryLayer(ZserioPackingContext& context,
            ::zserio::BitStreamReader& in,
            ::nds::core::geometry::GeometryLayerType type_,
            bool hasIds_,
            bool hasTypes_, const allocator_type& allocator = allocator_type());

    ~CenterLineGeometryLayer() = default;

    CenterLineGeometryLayer(const CenterLineGeometryLayer& other);
    CenterLineGeometryLayer& operator=(const CenterLineGeometryLayer& other);

    CenterLineGeometryLayer(CenterLineGeometryLayer&& other);
    CenterLineGeometryLayer& operator=(CenterLineGeometryLayer&& other);

    CenterLineGeometryLayer(::zserio::PropagateAllocatorT,
    ...
    const ::zserio::vector<::nds::lane::lanes::LaneCenterLineGeometryId>& getIdentifier() const;
    ::zserio::vector<::nds::lane::lanes::LaneCenterLineGeometryId>& getIdentifier();
    void setIdentifier(const ::zserio::vector<::nds::lane::lanes::LaneCenterLineGeometryId>& identifier_);
    void setIdentifier(::zserio::vector<::nds::lane::lanes::LaneCenterLineGeometryId>&& identifier_);
    ...
    bool operator==(const CenterLineGeometryLayer& other) const;
...
private:
    ...
    {
    public:
        using OwnerType = CenterLineGeometryLayer;

        static void create(CenterLineGeometryLayer& owner,
                ::zserio::vector<::nds::core::geometry::GeometryType>& array,
                ::zserio::BitStreamReader& in, size_t index);
    };

    using ZserioArrayType_identifier = ::zserio::Array<::zserio::vector<::nds::lane::lanes::LaneCenterLineGeometryId>, ::zserio::VarIntNNArrayTraits<::nds::lane::lanes::LaneCenterLineGeometryId>, ::zserio::ArrayType::NORMAL>;
...
#endif // NDS_LANE_INSTANTIATIONS_CENTER_LINE_GEOMETRY_LAYER_H
