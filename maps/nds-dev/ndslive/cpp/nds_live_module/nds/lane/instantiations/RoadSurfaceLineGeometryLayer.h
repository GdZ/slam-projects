...
#ifndef NDS_LANE_INSTANTIATIONS_ROAD_SURFACE_LINE_GEOMETRY_LAYER_H
#define NDS_LANE_INSTANTIATIONS_ROAD_SURFACE_LINE_GEOMETRY_LAYER_H
...
public:
    ...
    RoadSurfaceLineGeometryLayer() noexcept :
            RoadSurfaceLineGeometryLayer(allocator_type())
    {}

    explicit RoadSurfaceLineGeometryLayer(const allocator_type& allocator) noexcept;

    template <typename ZSERIO_T_identifier = ::zserio::vector<::nds::lane::reference::types::RoadSurfaceId>,
            typename ZSERIO_T_types = ::zserio::vector<::nds::lane::roadsurface::RoadSurfaceLineType>,
            typename ZSERIO_T_buffers = ::nds::core::geometry::Buffers>
    RoadSurfaceLineGeometryLayer(
            ...
            RoadSurfaceLineGeometryLayer(allocator)
    {
    ...
    explicit RoadSurfaceLineGeometryLayer(::zserio::BitStreamReader& in,
            ::nds::core::geometry::GeometryLayerType type_,
            bool hasIds_,
            bool hasTypes_, const allocator_type& allocator = allocator_type());
    explicit RoadSurfaceLineGeometryLayer(ZserioPackingContext& context,
            ::zserio::BitStreamReader& in,
            ::nds::core::geometry::GeometryLayerType type_,
            bool hasIds_,
            bool hasTypes_, const allocator_type& allocator = allocator_type());

    ~RoadSurfaceLineGeometryLayer() = default;

    RoadSurfaceLineGeometryLayer(const RoadSurfaceLineGeometryLayer& other);
    RoadSurfaceLineGeometryLayer& operator=(const RoadSurfaceLineGeometryLayer& other);

    RoadSurfaceLineGeometryLayer(RoadSurfaceLineGeometryLayer&& other);
    RoadSurfaceLineGeometryLayer& operator=(RoadSurfaceLineGeometryLayer&& other);

    RoadSurfaceLineGeometryLayer(::zserio::PropagateAllocatorT,
    ...
    const ::zserio::vector<::nds::lane::roadsurface::RoadSurfaceLineType>& getTypes() const;
    ::zserio::vector<::nds::lane::roadsurface::RoadSurfaceLineType>& getTypes();
    void setTypes(const ::zserio::vector<::nds::lane::roadsurface::RoadSurfaceLineType>& types_);
    void setTypes(::zserio::vector<::nds::lane::roadsurface::RoadSurfaceLineType>&& types_);
    ...
    bool operator==(const RoadSurfaceLineGeometryLayer& other) const;
...
private:
    ...
    {
    public:
        using OwnerType = RoadSurfaceLineGeometryLayer;

        static void create(RoadSurfaceLineGeometryLayer& owner,
    ...
    public:
        ...
        static void create(RoadSurfaceLineGeometryLayer& owner,
                ::zserio::vector<::nds::lane::roadsurface::RoadSurfaceLineType>& array,
                ::nds::lane::roadsurface::RoadSurfaceLineType::ZserioPackingContext& context,
                ::zserio::BitStreamReader& in, size_t index);
    };
    ...
    using ZserioArrayType_types = ::zserio::Array<::zserio::vector<::nds::lane::roadsurface::RoadSurfaceLineType>, ::zserio::ObjectArrayTraits<::nds::lane::roadsurface::RoadSurfaceLineType, ZserioElementFactory_types>, ::zserio::ArrayType::NORMAL>;
...
#endif // NDS_LANE_INSTANTIATIONS_ROAD_SURFACE_LINE_GEOMETRY_LAYER_H
