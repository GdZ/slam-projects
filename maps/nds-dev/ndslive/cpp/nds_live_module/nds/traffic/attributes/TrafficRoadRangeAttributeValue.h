...
#ifndef NDS_TRAFFIC_ATTRIBUTES_TRAFFIC_ROAD_RANGE_ATTRIBUTE_VALUE_H
#define NDS_TRAFFIC_ATTRIBUTES_TRAFFIC_ROAD_RANGE_ATTRIBUTE_VALUE_H
...
public:
    ...
    TrafficRoadRangeAttributeValue() noexcept :
            TrafficRoadRangeAttributeValue(allocator_type())
    {}

    explicit TrafficRoadRangeAttributeValue(const allocator_type& allocator) noexcept;

    explicit TrafficRoadRangeAttributeValue(::zserio::BitStreamReader& in,
            ::nds::traffic::attributes::TrafficRoadRangeAttributeType type_, const allocator_type& allocator = allocator_type());
    explicit TrafficRoadRangeAttributeValue(ZserioPackingContext& context,
            ::zserio::BitStreamReader& in,
            ::nds::traffic::attributes::TrafficRoadRangeAttributeType type_, const allocator_type& allocator = allocator_type());

    ~TrafficRoadRangeAttributeValue() = default;

    TrafficRoadRangeAttributeValue(const TrafficRoadRangeAttributeValue& other);
    TrafficRoadRangeAttributeValue& operator=(const TrafficRoadRangeAttributeValue& other);

    TrafficRoadRangeAttributeValue(TrafficRoadRangeAttributeValue&& other);
    TrafficRoadRangeAttributeValue& operator=(TrafficRoadRangeAttributeValue&& other);

    TrafficRoadRangeAttributeValue(::zserio::PropagateAllocatorT,
    ...
    ::nds::traffic::attributes::TrafficRoadRangeAttributeType getType() const;
    ...
    bool operator==(const TrafficRoadRangeAttributeValue& other) const;
...
private:
    ...
    ::nds::traffic::attributes::TrafficRoadRangeAttributeType m_type_;
...
#endif // NDS_TRAFFIC_ATTRIBUTES_TRAFFIC_ROAD_RANGE_ATTRIBUTE_VALUE_H
