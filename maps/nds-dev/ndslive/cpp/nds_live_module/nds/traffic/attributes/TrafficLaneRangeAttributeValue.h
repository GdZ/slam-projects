...
#ifndef NDS_TRAFFIC_ATTRIBUTES_TRAFFIC_LANE_RANGE_ATTRIBUTE_VALUE_H
#define NDS_TRAFFIC_ATTRIBUTES_TRAFFIC_LANE_RANGE_ATTRIBUTE_VALUE_H
...
public:
    ...
    TrafficLaneRangeAttributeValue() noexcept :
            TrafficLaneRangeAttributeValue(allocator_type())
    {}

    explicit TrafficLaneRangeAttributeValue(const allocator_type& allocator) noexcept;

    explicit TrafficLaneRangeAttributeValue(::zserio::BitStreamReader& in,
            ::nds::traffic::attributes::TrafficLaneRangeAttributeType type_, const allocator_type& allocator = allocator_type());
    explicit TrafficLaneRangeAttributeValue(ZserioPackingContext& context,
            ::zserio::BitStreamReader& in,
            ::nds::traffic::attributes::TrafficLaneRangeAttributeType type_, const allocator_type& allocator = allocator_type());

    ~TrafficLaneRangeAttributeValue() = default;

    TrafficLaneRangeAttributeValue(const TrafficLaneRangeAttributeValue& other);
    TrafficLaneRangeAttributeValue& operator=(const TrafficLaneRangeAttributeValue& other);

    TrafficLaneRangeAttributeValue(TrafficLaneRangeAttributeValue&& other);
    TrafficLaneRangeAttributeValue& operator=(TrafficLaneRangeAttributeValue&& other);

    TrafficLaneRangeAttributeValue(::zserio::PropagateAllocatorT,
    ...
    ::nds::traffic::attributes::TrafficLaneRangeAttributeType getType() const;
    ...
    bool operator==(const TrafficLaneRangeAttributeValue& other) const;
...
private:
    ...
    ::nds::traffic::attributes::TrafficLaneRangeAttributeType m_type_;
...
#endif // NDS_TRAFFIC_ATTRIBUTES_TRAFFIC_LANE_RANGE_ATTRIBUTE_VALUE_H
