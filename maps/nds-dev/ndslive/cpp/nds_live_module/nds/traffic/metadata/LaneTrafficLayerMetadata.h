...
#ifndef NDS_TRAFFIC_METADATA_LANE_TRAFFIC_LAYER_METADATA_H
#define NDS_TRAFFIC_METADATA_LANE_TRAFFIC_LAYER_METADATA_H
...
public:
    ...
    LaneTrafficLayerMetadata() noexcept :
            LaneTrafficLayerMetadata(allocator_type())
    {}

    explicit LaneTrafficLayerMetadata(const allocator_type& allocator) noexcept;
    ...
    LaneTrafficLayerMetadata(
            ...
            LaneTrafficLayerMetadata(allocator)
    {
        m_content_ = content_;
    ...
    explicit LaneTrafficLayerMetadata(::zserio::BitStreamReader& in, const allocator_type& allocator = allocator_type());
    explicit LaneTrafficLayerMetadata(ZserioPackingContext& context,
            ::zserio::BitStreamReader& in, const allocator_type& allocator = allocator_type());

    ~LaneTrafficLayerMetadata() = default;

    LaneTrafficLayerMetadata(const LaneTrafficLayerMetadata&) = default;
    LaneTrafficLayerMetadata& operator=(const LaneTrafficLayerMetadata&) = default;

    LaneTrafficLayerMetadata(LaneTrafficLayerMetadata&&) = default;
    LaneTrafficLayerMetadata& operator=(LaneTrafficLayerMetadata&&) = default;

    LaneTrafficLayerMetadata(::zserio::PropagateAllocatorT,
    ...
    bool operator==(const LaneTrafficLayerMetadata& other) const;
...
private:
    ...
    {
    public:
        using OwnerType = LaneTrafficLayerMetadata;

        static void create(LaneTrafficLayerMetadata& owner,
...
#endif // NDS_TRAFFIC_METADATA_LANE_TRAFFIC_LAYER_METADATA_H
