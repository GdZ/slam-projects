...
#ifndef NDS_TRAFFIC_INSTANTIATIONS_TRAFFIC_INDIRECT_ROAD_RANGE_ATTRIBUTE_SET_MAP_H
#define NDS_TRAFFIC_INSTANTIATIONS_TRAFFIC_INDIRECT_ROAD_RANGE_ATTRIBUTE_SET_MAP_H
...
public:
    ...
    TrafficIndirectRoadRangeAttributeSetMap() noexcept :
            TrafficIndirectRoadRangeAttributeSetMap(allocator_type())
    {}

    explicit TrafficIndirectRoadRangeAttributeSetMap(const allocator_type& allocator) noexcept;
    ...
    template <typename ZSERIO_T_attributeSet = ::nds::traffic::instantiations::TrafficRoadRangeAttributeSet,
            ...
            ::zserio::is_field_constructor_enabled_t<ZSERIO_T_attributeSet, TrafficIndirectRoadRangeAttributeSetMap, allocator_type> = 0>
    TrafficIndirectRoadRangeAttributeSetMap(
            ...
            TrafficIndirectRoadRangeAttributeSetMap(allocator)
    {
    ...
    explicit TrafficIndirectRoadRangeAttributeSetMap(::zserio::BitStreamReader& in,
            ::nds::core::geometry::CoordShift coordShift_, const allocator_type& allocator = allocator_type());
    explicit TrafficIndirectRoadRangeAttributeSetMap(ZserioPackingContext& context,
            ::zserio::BitStreamReader& in,
            ::nds::core::geometry::CoordShift coordShift_, const allocator_type& allocator = allocator_type());

    ~TrafficIndirectRoadRangeAttributeSetMap() = default;

    TrafficIndirectRoadRangeAttributeSetMap(const TrafficIndirectRoadRangeAttributeSetMap& other);
    TrafficIndirectRoadRangeAttributeSetMap& operator=(const TrafficIndirectRoadRangeAttributeSetMap& other);

    TrafficIndirectRoadRangeAttributeSetMap(TrafficIndirectRoadRangeAttributeSetMap&& other);
    TrafficIndirectRoadRangeAttributeSetMap& operator=(TrafficIndirectRoadRangeAttributeSetMap&& other);

    TrafficIndirectRoadRangeAttributeSetMap(::zserio::PropagateAllocatorT,
    ...
    bool operator==(const TrafficIndirectRoadRangeAttributeSetMap& other) const;
...
private:
    ...
    {
    public:
        using OwnerType = TrafficIndirectRoadRangeAttributeSetMap;

        static void initializeElement(TrafficIndirectRoadRangeAttributeSetMap& owner,
    ...
    public:
        ...
        static void create(TrafficIndirectRoadRangeAttributeSetMap& owner,
...
#endif // NDS_TRAFFIC_INSTANTIATIONS_TRAFFIC_INDIRECT_ROAD_RANGE_ATTRIBUTE_SET_MAP_H
