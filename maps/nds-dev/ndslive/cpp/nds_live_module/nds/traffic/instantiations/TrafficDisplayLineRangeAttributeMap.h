...
#ifndef NDS_TRAFFIC_INSTANTIATIONS_TRAFFIC_DISPLAY_LINE_RANGE_ATTRIBUTE_MAP_H
#define NDS_TRAFFIC_INSTANTIATIONS_TRAFFIC_DISPLAY_LINE_RANGE_ATTRIBUTE_MAP_H
...
public:
    ...
    TrafficDisplayLineRangeAttributeMap() noexcept :
            TrafficDisplayLineRangeAttributeMap(allocator_type())
    {}

    explicit TrafficDisplayLineRangeAttributeMap(const allocator_type& allocator) noexcept;
    ...
    template <typename ZSERIO_T_featureReferences = ::zserio::vector<::nds::display::reference::types::DisplayLineReference>,
            ...
            typename ZSERIO_T_attributeValues = ::zserio::vector<::nds::traffic::instantiations::TrafficDisplayLineRangeAttribute>,
    ...
    TrafficDisplayLineRangeAttributeMap(
            ...
            TrafficDisplayLineRangeAttributeMap(allocator)
    {
    ...
    explicit TrafficDisplayLineRangeAttributeMap(::zserio::BitStreamReader& in,
            ::nds::core::geometry::CoordShift coordShift_, const allocator_type& allocator = allocator_type());
    explicit TrafficDisplayLineRangeAttributeMap(ZserioPackingContext& context,
            ::zserio::BitStreamReader& in,
            ::nds::core::geometry::CoordShift coordShift_, const allocator_type& allocator = allocator_type());

    ~TrafficDisplayLineRangeAttributeMap() = default;

    TrafficDisplayLineRangeAttributeMap(const TrafficDisplayLineRangeAttributeMap& other);
    TrafficDisplayLineRangeAttributeMap& operator=(const TrafficDisplayLineRangeAttributeMap& other);

    TrafficDisplayLineRangeAttributeMap(TrafficDisplayLineRangeAttributeMap&& other);
    TrafficDisplayLineRangeAttributeMap& operator=(TrafficDisplayLineRangeAttributeMap&& other);

    TrafficDisplayLineRangeAttributeMap(::zserio::PropagateAllocatorT,
    ...
    ::nds::traffic::attributes::TrafficDisplayLineRangeAttributeType getAttributeTypeCode() const;
    void setAttributeTypeCode(::nds::traffic::attributes::TrafficDisplayLineRangeAttributeType attributeTypeCode_);
    ...
    const ::zserio::vector<::nds::traffic::instantiations::TrafficDisplayLineRangeAttribute>& getAttributeValues() const;
    ::zserio::vector<::nds::traffic::instantiations::TrafficDisplayLineRangeAttribute>& getAttributeValues();
    void setAttributeValues(const ::zserio::vector<::nds::traffic::instantiations::TrafficDisplayLineRangeAttribute>& attributeValues_);
    void setAttributeValues(::zserio::vector<::nds::traffic::instantiations::TrafficDisplayLineRangeAttribute>&& attributeValues_);
    ...
    bool operator==(const TrafficDisplayLineRangeAttributeMap& other) const;
...
private:
    ...
    {
    public:
        using OwnerType = TrafficDisplayLineRangeAttributeMap;

        static void create(TrafficDisplayLineRangeAttributeMap& owner,
    ...
    public:
        ...
        static void initializeElement(TrafficDisplayLineRangeAttributeMap& owner,
    ...
    public:
        ...
        static void initializeElement(TrafficDisplayLineRangeAttributeMap& owner,
                ::nds::traffic::instantiations::TrafficDisplayLineRangeAttribute& element, size_t index);
    };
    ...
    public:
        ...
        static void create(TrafficDisplayLineRangeAttributeMap& owner,
                ::zserio::vector<::nds::traffic::instantiations::TrafficDisplayLineRangeAttribute>& array,
                ::nds::traffic::instantiations::TrafficDisplayLineRangeAttribute::ZserioPackingContext& context,
                ::zserio::BitStreamReader& in, size_t index);
    };
    ...
    using ZserioArrayType_attributeValues = ::zserio::Array<::zserio::vector<::nds::traffic::instantiations::TrafficDisplayLineRangeAttribute>, ::zserio::ObjectArrayTraits<::nds::traffic::instantiations::TrafficDisplayLineRangeAttribute, ZserioElementFactory_attributeValues>, ::zserio::ArrayType::NORMAL, ZserioArrayExpressions_attributeValues>;
    ...
    ::nds::traffic::attributes::TrafficDisplayLineRangeAttributeType readAttributeTypeCode(::zserio::BitStreamReader& in);
    ::nds::traffic::attributes::TrafficDisplayLineRangeAttributeType readAttributeTypeCode(ZserioPackingContext& context,
            ::zserio::BitStreamReader& in);
    ...
    ::nds::traffic::attributes::TrafficDisplayLineRangeAttributeType m_attributeTypeCode_;
...
#endif // NDS_TRAFFIC_INSTANTIATIONS_TRAFFIC_DISPLAY_LINE_RANGE_ATTRIBUTE_MAP_H
