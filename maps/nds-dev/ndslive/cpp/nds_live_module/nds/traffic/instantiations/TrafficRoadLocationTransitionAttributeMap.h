...
#ifndef NDS_TRAFFIC_INSTANTIATIONS_TRAFFIC_ROAD_LOCATION_TRANSITION_ATTRIBUTE_MAP_H
#define NDS_TRAFFIC_INSTANTIATIONS_TRAFFIC_ROAD_LOCATION_TRANSITION_ATTRIBUTE_MAP_H
...
public:
    ...
    TrafficRoadLocationTransitionAttributeMap() noexcept :
            TrafficRoadLocationTransitionAttributeMap(allocator_type())
    {}

    explicit TrafficRoadLocationTransitionAttributeMap(const allocator_type& allocator) noexcept;
    ...
    template <typename ZSERIO_T_featureReferences = ::zserio::vector<::nds::road::reference::location::RoadLocationTransitionReference>,
            ...
            typename ZSERIO_T_attributeValues = ::zserio::vector<::nds::traffic::instantiations::TrafficTransitionAttribute>,
    ...
    TrafficRoadLocationTransitionAttributeMap(
            ...
            TrafficRoadLocationTransitionAttributeMap(allocator)
    {
    ...
    explicit TrafficRoadLocationTransitionAttributeMap(::zserio::BitStreamReader& in,
            ::nds::core::geometry::CoordShift coordShift_, const allocator_type& allocator = allocator_type());
    explicit TrafficRoadLocationTransitionAttributeMap(ZserioPackingContext& context,
            ::zserio::BitStreamReader& in,
            ::nds::core::geometry::CoordShift coordShift_, const allocator_type& allocator = allocator_type());

    ~TrafficRoadLocationTransitionAttributeMap() = default;

    TrafficRoadLocationTransitionAttributeMap(const TrafficRoadLocationTransitionAttributeMap& other);
    TrafficRoadLocationTransitionAttributeMap& operator=(const TrafficRoadLocationTransitionAttributeMap& other);

    TrafficRoadLocationTransitionAttributeMap(TrafficRoadLocationTransitionAttributeMap&& other);
    TrafficRoadLocationTransitionAttributeMap& operator=(TrafficRoadLocationTransitionAttributeMap&& other);

    TrafficRoadLocationTransitionAttributeMap(::zserio::PropagateAllocatorT,
    ...
    const ::zserio::vector<::nds::traffic::instantiations::TrafficTransitionAttribute>& getAttributeValues() const;
    ::zserio::vector<::nds::traffic::instantiations::TrafficTransitionAttribute>& getAttributeValues();
    void setAttributeValues(const ::zserio::vector<::nds::traffic::instantiations::TrafficTransitionAttribute>& attributeValues_);
    void setAttributeValues(::zserio::vector<::nds::traffic::instantiations::TrafficTransitionAttribute>&& attributeValues_);
    ...
    bool operator==(const TrafficRoadLocationTransitionAttributeMap& other) const;
...
private:
    ...
    {
    public:
        using OwnerType = TrafficRoadLocationTransitionAttributeMap;

        static void create(TrafficRoadLocationTransitionAttributeMap& owner,
    ...
    public:
        ...
        static void initializeElement(TrafficRoadLocationTransitionAttributeMap& owner,
    ...
    public:
        ...
        static void initializeElement(TrafficRoadLocationTransitionAttributeMap& owner,
                ::nds::traffic::instantiations::TrafficTransitionAttribute& element, size_t index);
    };
    ...
    public:
        ...
        static void create(TrafficRoadLocationTransitionAttributeMap& owner,
                ::zserio::vector<::nds::traffic::instantiations::TrafficTransitionAttribute>& array,
                ::nds::traffic::instantiations::TrafficTransitionAttribute::ZserioPackingContext& context,
                ::zserio::BitStreamReader& in, size_t index);
    };
    ...
    using ZserioArrayType_attributeValues = ::zserio::Array<::zserio::vector<::nds::traffic::instantiations::TrafficTransitionAttribute>, ::zserio::ObjectArrayTraits<::nds::traffic::instantiations::TrafficTransitionAttribute, ZserioElementFactory_attributeValues>, ::zserio::ArrayType::NORMAL, ZserioArrayExpressions_attributeValues>;
...
#endif // NDS_TRAFFIC_INSTANTIATIONS_TRAFFIC_ROAD_LOCATION_TRANSITION_ATTRIBUTE_MAP_H
