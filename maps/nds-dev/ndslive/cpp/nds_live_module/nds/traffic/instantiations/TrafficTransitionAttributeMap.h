...
#ifndef NDS_TRAFFIC_INSTANTIATIONS_TRAFFIC_TRANSITION_ATTRIBUTE_MAP_H
#define NDS_TRAFFIC_INSTANTIATIONS_TRAFFIC_TRANSITION_ATTRIBUTE_MAP_H
...
public:
    ...
    TrafficTransitionAttributeMap() noexcept :
            TrafficTransitionAttributeMap(allocator_type())
    {}

    explicit TrafficTransitionAttributeMap(const allocator_type& allocator) noexcept;
    ...
    TrafficTransitionAttributeMap(
            ...
            TrafficTransitionAttributeMap(allocator)
    {
    ...
    explicit TrafficTransitionAttributeMap(::zserio::BitStreamReader& in,
            ::nds::core::geometry::CoordShift coordShift_, const allocator_type& allocator = allocator_type());
    explicit TrafficTransitionAttributeMap(ZserioPackingContext& context,
            ::zserio::BitStreamReader& in,
            ::nds::core::geometry::CoordShift coordShift_, const allocator_type& allocator = allocator_type());

    ~TrafficTransitionAttributeMap() = default;

    TrafficTransitionAttributeMap(const TrafficTransitionAttributeMap& other);
    TrafficTransitionAttributeMap& operator=(const TrafficTransitionAttributeMap& other);

    TrafficTransitionAttributeMap(TrafficTransitionAttributeMap&& other);
    TrafficTransitionAttributeMap& operator=(TrafficTransitionAttributeMap&& other);

    TrafficTransitionAttributeMap(::zserio::PropagateAllocatorT,
    ...
    bool operator==(const TrafficTransitionAttributeMap& other) const;
...
private:
    ...
    {
    public:
        using OwnerType = TrafficTransitionAttributeMap;

        static void initializeElement(TrafficTransitionAttributeMap& owner,
    ...
    public:
        ...
        static void create(TrafficTransitionAttributeMap& owner,
...
#endif // NDS_TRAFFIC_INSTANTIATIONS_TRAFFIC_TRANSITION_ATTRIBUTE_MAP_H
