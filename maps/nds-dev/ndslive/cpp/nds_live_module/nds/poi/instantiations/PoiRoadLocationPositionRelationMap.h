...
#ifndef NDS_POI_INSTANTIATIONS_POI_ROAD_LOCATION_POSITION_RELATION_MAP_H
#define NDS_POI_INSTANTIATIONS_POI_ROAD_LOCATION_POSITION_RELATION_MAP_H
...
public:
    ...
    PoiRoadLocationPositionRelationMap() noexcept :
            PoiRoadLocationPositionRelationMap(allocator_type())
    {}

    explicit PoiRoadLocationPositionRelationMap(const allocator_type& allocator) noexcept;

    template <typename ZSERIO_T_featureReferences = ::zserio::vector<::nds::road::reference::location::RoadLocationReference>,
            typename ZSERIO_T_featureValidities = ::zserio::vector<::nds::road::reference::location::RoadLocationPositionValidity>,
    ...
    PoiRoadLocationPositionRelationMap(
            ...
            PoiRoadLocationPositionRelationMap(allocator)
    {
    ...
    explicit PoiRoadLocationPositionRelationMap(::zserio::BitStreamReader& in,
            ::nds::core::geometry::CoordShift coordShift_, const allocator_type& allocator = allocator_type());
    explicit PoiRoadLocationPositionRelationMap(ZserioPackingContext& context,
            ::zserio::BitStreamReader& in,
            ::nds::core::geometry::CoordShift coordShift_, const allocator_type& allocator = allocator_type());

    ~PoiRoadLocationPositionRelationMap() = default;

    PoiRoadLocationPositionRelationMap(const PoiRoadLocationPositionRelationMap& other);
    PoiRoadLocationPositionRelationMap& operator=(const PoiRoadLocationPositionRelationMap& other);

    PoiRoadLocationPositionRelationMap(PoiRoadLocationPositionRelationMap&& other);
    PoiRoadLocationPositionRelationMap& operator=(PoiRoadLocationPositionRelationMap&& other);

    PoiRoadLocationPositionRelationMap(::zserio::PropagateAllocatorT,
    ...
    const ::zserio::vector<::nds::road::reference::location::RoadLocationPositionValidity>& getFeatureValidities() const;
    ::zserio::vector<::nds::road::reference::location::RoadLocationPositionValidity>& getFeatureValidities();
    void setFeatureValidities(const ::zserio::vector<::nds::road::reference::location::RoadLocationPositionValidity>& featureValidities_);
    void setFeatureValidities(::zserio::vector<::nds::road::reference::location::RoadLocationPositionValidity>&& featureValidities_);
    ...
    bool operator==(const PoiRoadLocationPositionRelationMap& other) const;
...
private:
    ...
    {
    public:
        using OwnerType = PoiRoadLocationPositionRelationMap;

        static void create(PoiRoadLocationPositionRelationMap& owner,
    ...
    public:
        ...
        static void initializeElement(PoiRoadLocationPositionRelationMap& owner,
                ::nds::road::reference::location::RoadLocationPositionValidity& element, size_t index);
    };
    ...
    public:
        ...
        static void create(PoiRoadLocationPositionRelationMap& owner,
                ::zserio::vector<::nds::road::reference::location::RoadLocationPositionValidity>& array,
                ::nds::road::reference::location::RoadLocationPositionValidity::ZserioPackingContext& context,
                ::zserio::BitStreamReader& in, size_t index);
    };
    ...
    using ZserioArrayType_featureValidities = ::zserio::Array<::zserio::vector<::nds::road::reference::location::RoadLocationPositionValidity>, ::zserio::ObjectArrayTraits<::nds::road::reference::location::RoadLocationPositionValidity, ZserioElementFactory_featureValidities>, ::zserio::ArrayType::NORMAL, ZserioArrayExpressions_featureValidities>;
...
#endif // NDS_POI_INSTANTIATIONS_POI_ROAD_LOCATION_POSITION_RELATION_MAP_H
