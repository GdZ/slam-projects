...
#ifndef NDS_POI_INSTANTIATIONS_POI_LANE_POSITION_RELATION_MAP_H
#define NDS_POI_INSTANTIATIONS_POI_LANE_POSITION_RELATION_MAP_H
...
public:
    ...
    PoiLanePositionRelationMap() noexcept :
            PoiLanePositionRelationMap(allocator_type())
    {}

    explicit PoiLanePositionRelationMap(const allocator_type& allocator) noexcept;
    ...
    PoiLanePositionRelationMap(
            ...
            PoiLanePositionRelationMap(allocator)
    {
    ...
    explicit PoiLanePositionRelationMap(::zserio::BitStreamReader& in,
            ::nds::core::geometry::CoordShift coordShift_, const allocator_type& allocator = allocator_type());
    explicit PoiLanePositionRelationMap(ZserioPackingContext& context,
            ::zserio::BitStreamReader& in,
            ::nds::core::geometry::CoordShift coordShift_, const allocator_type& allocator = allocator_type());

    ~PoiLanePositionRelationMap() = default;

    PoiLanePositionRelationMap(const PoiLanePositionRelationMap& other);
    PoiLanePositionRelationMap& operator=(const PoiLanePositionRelationMap& other);

    PoiLanePositionRelationMap(PoiLanePositionRelationMap&& other);
    PoiLanePositionRelationMap& operator=(PoiLanePositionRelationMap&& other);

    PoiLanePositionRelationMap(::zserio::PropagateAllocatorT,
    ...
    bool operator==(const PoiLanePositionRelationMap& other) const;
...
private:
    ...
    {
    public:
        using OwnerType = PoiLanePositionRelationMap;

        static void create(PoiLanePositionRelationMap& owner,
    ...
    public:
        ...
        static void initializeElement(PoiLanePositionRelationMap& owner,
...
#endif // NDS_POI_INSTANTIATIONS_POI_LANE_POSITION_RELATION_MAP_H
