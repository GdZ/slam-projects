...
#ifndef NDS_POI_INSTANTIATIONS_POI_LANE_INDIRECT_POSITION_RELATION_MAP_H
#define NDS_POI_INSTANTIATIONS_POI_LANE_INDIRECT_POSITION_RELATION_MAP_H
...
public:
    ...
    PoiLaneIndirectPositionRelationMap() noexcept :
            PoiLaneIndirectPositionRelationMap(allocator_type())
    {}

    explicit PoiLaneIndirectPositionRelationMap(const allocator_type& allocator) noexcept;
    ...
    template <typename ZSERIO_T_featureReferences = ::zserio::vector<::nds::lane::reference::types::LaneGroupReferenceIndirect>,
            ...
            typename ZSERIO_T_attributeValues = ::zserio::vector<::nds::poi::instantiations::PoiLanePositionRelation>,
    ...
    PoiLaneIndirectPositionRelationMap(
            ...
            PoiLaneIndirectPositionRelationMap(allocator)
    {
    ...
    explicit PoiLaneIndirectPositionRelationMap(::zserio::BitStreamReader& in,
            ::nds::core::geometry::CoordShift coordShift_, const allocator_type& allocator = allocator_type());
    explicit PoiLaneIndirectPositionRelationMap(ZserioPackingContext& context,
            ::zserio::BitStreamReader& in,
            ::nds::core::geometry::CoordShift coordShift_, const allocator_type& allocator = allocator_type());

    ~PoiLaneIndirectPositionRelationMap() = default;

    PoiLaneIndirectPositionRelationMap(const PoiLaneIndirectPositionRelationMap& other);
    PoiLaneIndirectPositionRelationMap& operator=(const PoiLaneIndirectPositionRelationMap& other);

    PoiLaneIndirectPositionRelationMap(PoiLaneIndirectPositionRelationMap&& other);
    PoiLaneIndirectPositionRelationMap& operator=(PoiLaneIndirectPositionRelationMap&& other);

    PoiLaneIndirectPositionRelationMap(::zserio::PropagateAllocatorT,
    ...
    ::nds::poi::poi::PoiLanePositionRelationType getAttributeTypeCode() const;
    void setAttributeTypeCode(::nds::poi::poi::PoiLanePositionRelationType attributeTypeCode_);
    ...
    const ::zserio::vector<::nds::poi::instantiations::PoiLanePositionRelation>& getAttributeValues() const;
    ::zserio::vector<::nds::poi::instantiations::PoiLanePositionRelation>& getAttributeValues();
    void setAttributeValues(const ::zserio::vector<::nds::poi::instantiations::PoiLanePositionRelation>& attributeValues_);
    void setAttributeValues(::zserio::vector<::nds::poi::instantiations::PoiLanePositionRelation>&& attributeValues_);
    ...
    bool operator==(const PoiLaneIndirectPositionRelationMap& other) const;
...
private:
    ...
    {
    public:
        using OwnerType = PoiLaneIndirectPositionRelationMap;

        static void initializeElement(PoiLaneIndirectPositionRelationMap& owner,
    ...
    public:
        ...
        static void create(PoiLaneIndirectPositionRelationMap& owner,
    ...
    public:
        ...
        static void initializeElement(PoiLaneIndirectPositionRelationMap& owner,
                ::nds::poi::instantiations::PoiLanePositionRelation& element, size_t index);
    };
    ...
    public:
        ...
        static void create(PoiLaneIndirectPositionRelationMap& owner,
                ::zserio::vector<::nds::poi::instantiations::PoiLanePositionRelation>& array,
                ::nds::poi::instantiations::PoiLanePositionRelation::ZserioPackingContext& context,
                ::zserio::BitStreamReader& in, size_t index);
    };
    ...
    using ZserioArrayType_attributeValues = ::zserio::Array<::zserio::vector<::nds::poi::instantiations::PoiLanePositionRelation>, ::zserio::ObjectArrayTraits<::nds::poi::instantiations::PoiLanePositionRelation, ZserioElementFactory_attributeValues>, ::zserio::ArrayType::NORMAL, ZserioArrayExpressions_attributeValues>;
    ...
    ::nds::poi::poi::PoiLanePositionRelationType readAttributeTypeCode(::zserio::BitStreamReader& in);
    ::nds::poi::poi::PoiLanePositionRelationType readAttributeTypeCode(ZserioPackingContext& context,
            ::zserio::BitStreamReader& in);
    ...
    ::nds::poi::poi::PoiLanePositionRelationType m_attributeTypeCode_;
...
#endif // NDS_POI_INSTANTIATIONS_POI_LANE_INDIRECT_POSITION_RELATION_MAP_H
