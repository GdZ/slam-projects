...
#ifndef NDS_POI_INSTANTIATIONS_POI_DISPLAY_AREA_RELATION_MAP_H
#define NDS_POI_INSTANTIATIONS_POI_DISPLAY_AREA_RELATION_MAP_H
...
public:
    ...
    PoiDisplayAreaRelationMap() noexcept :
            PoiDisplayAreaRelationMap(allocator_type())
    {}

    explicit PoiDisplayAreaRelationMap(const allocator_type& allocator) noexcept;
    ...
    template <typename ZSERIO_T_featureReferences = ::zserio::vector<::nds::display::reference::types::DisplayAreaId>,
            ...
            typename ZSERIO_T_attributeValues = ::zserio::vector<::nds::poi::instantiations::PoiDisplayAreaRelation>,
    ...
    PoiDisplayAreaRelationMap(
            ...
            PoiDisplayAreaRelationMap(allocator)
    {
    ...
    explicit PoiDisplayAreaRelationMap(::zserio::BitStreamReader& in,
            ::nds::core::geometry::CoordShift coordShift_, const allocator_type& allocator = allocator_type());
    explicit PoiDisplayAreaRelationMap(ZserioPackingContext& context,
            ::zserio::BitStreamReader& in,
            ::nds::core::geometry::CoordShift coordShift_, const allocator_type& allocator = allocator_type());

    ~PoiDisplayAreaRelationMap() = default;

    PoiDisplayAreaRelationMap(const PoiDisplayAreaRelationMap& other);
    PoiDisplayAreaRelationMap& operator=(const PoiDisplayAreaRelationMap& other);

    PoiDisplayAreaRelationMap(PoiDisplayAreaRelationMap&& other);
    PoiDisplayAreaRelationMap& operator=(PoiDisplayAreaRelationMap&& other);

    PoiDisplayAreaRelationMap(::zserio::PropagateAllocatorT,
    ...
    void setAttributeTypeCode(::nds::poi::poi::PoiDisplayAreaRelationType attributeTypeCode_);
    ...
    const ::zserio::vector<::nds::poi::instantiations::PoiDisplayAreaRelation>& getAttributeValues() const;
    ::zserio::vector<::nds::poi::instantiations::PoiDisplayAreaRelation>& getAttributeValues();
    void setAttributeValues(const ::zserio::vector<::nds::poi::instantiations::PoiDisplayAreaRelation>& attributeValues_);
    void setAttributeValues(::zserio::vector<::nds::poi::instantiations::PoiDisplayAreaRelation>&& attributeValues_);
    ...
    bool operator==(const PoiDisplayAreaRelationMap& other) const;
...
private:
    ...
    {
    public:
        using OwnerType = PoiDisplayAreaRelationMap;

        static void create(PoiDisplayAreaRelationMap& owner,
    ...
    public:
        ...
        static void initializeElement(PoiDisplayAreaRelationMap& owner,
    ...
    public:
        ...
        static void initializeElement(PoiDisplayAreaRelationMap& owner,
                ::nds::poi::instantiations::PoiDisplayAreaRelation& element, size_t index);
    };
    ...
    public:
        ...
        static void create(PoiDisplayAreaRelationMap& owner,
                ::zserio::vector<::nds::poi::instantiations::PoiDisplayAreaRelation>& array,
                ::nds::poi::instantiations::PoiDisplayAreaRelation::ZserioPackingContext& context,
                ::zserio::BitStreamReader& in, size_t index);
    };
    ...
    using ZserioArrayType_attributeValues = ::zserio::Array<::zserio::vector<::nds::poi::instantiations::PoiDisplayAreaRelation>, ::zserio::ObjectArrayTraits<::nds::poi::instantiations::PoiDisplayAreaRelation, ZserioElementFactory_attributeValues>, ::zserio::ArrayType::NORMAL, ZserioArrayExpressions_attributeValues>;
    ...
    ::nds::poi::poi::PoiDisplayAreaRelationType readAttributeTypeCode(::zserio::BitStreamReader& in);
    ::nds::poi::poi::PoiDisplayAreaRelationType readAttributeTypeCode(ZserioPackingContext& context,
            ::zserio::BitStreamReader& in);
...
#endif // NDS_POI_INSTANTIATIONS_POI_DISPLAY_AREA_RELATION_MAP_H
