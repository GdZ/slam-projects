...
#ifndef NDS_POI_INSTANTIATIONS_POI_INDIRECT_ATTRIBUTE_SET_MAP_H
#define NDS_POI_INSTANTIATIONS_POI_INDIRECT_ATTRIBUTE_SET_MAP_H
...
public:
    ...
    PoiIndirectAttributeSetMap() noexcept :
            PoiIndirectAttributeSetMap(allocator_type())
    {}

    explicit PoiIndirectAttributeSetMap(const allocator_type& allocator) noexcept;

    template <typename ZSERIO_T_attributeSet = ::nds::poi::instantiations::PoiAttributeSet,
            typename ZSERIO_T_references = ::zserio::vector<::nds::poi::reference::types::PoiReferenceIndirect>,
            typename ZSERIO_T_validities = ::zserio::vector<::nds::core::attributemap::Validity>,
            ::zserio::is_field_constructor_enabled_t<ZSERIO_T_attributeSet, PoiIndirectAttributeSetMap, allocator_type> = 0>
    PoiIndirectAttributeSetMap(
            ...
            PoiIndirectAttributeSetMap(allocator)
    {
    ...
    explicit PoiIndirectAttributeSetMap(::zserio::BitStreamReader& in,
            ::nds::core::geometry::CoordShift coordShift_, const allocator_type& allocator = allocator_type());
    explicit PoiIndirectAttributeSetMap(ZserioPackingContext& context,
            ::zserio::BitStreamReader& in,
            ::nds::core::geometry::CoordShift coordShift_, const allocator_type& allocator = allocator_type());

    ~PoiIndirectAttributeSetMap() = default;

    PoiIndirectAttributeSetMap(const PoiIndirectAttributeSetMap& other);
    PoiIndirectAttributeSetMap& operator=(const PoiIndirectAttributeSetMap& other);

    PoiIndirectAttributeSetMap(PoiIndirectAttributeSetMap&& other);
    PoiIndirectAttributeSetMap& operator=(PoiIndirectAttributeSetMap&& other);

    PoiIndirectAttributeSetMap(::zserio::PropagateAllocatorT,
    ...
    const ::zserio::vector<::nds::poi::reference::types::PoiReferenceIndirect>& getReferences() const;
    ::zserio::vector<::nds::poi::reference::types::PoiReferenceIndirect>& getReferences();
    void setReferences(const ::zserio::vector<::nds::poi::reference::types::PoiReferenceIndirect>& references_);
    void setReferences(::zserio::vector<::nds::poi::reference::types::PoiReferenceIndirect>&& references_);
    ...
    bool operator==(const PoiIndirectAttributeSetMap& other) const;
...
private:
    ...
    {
    public:
        using OwnerType = PoiIndirectAttributeSetMap;

        static void initializeElement(PoiIndirectAttributeSetMap& owner,
    ...
    public:
        ...
        static void create(PoiIndirectAttributeSetMap& owner,
    ...
    using ZserioArrayType_references = ::zserio::Array<::zserio::vector<::nds::poi::reference::types::PoiReferenceIndirect>, ::zserio::ObjectArrayTraits<::nds::poi::reference::types::PoiReferenceIndirect, ZserioElementFactory_references>, ::zserio::ArrayType::NORMAL, ZserioArrayExpressions_references>;
...
#endif // NDS_POI_INSTANTIATIONS_POI_INDIRECT_ATTRIBUTE_SET_MAP_H
