...
#ifndef NDS_RULES_INSTANTIATIONS_RULES_ROAD_RANGE_ATTRIBUTE_SET_MAP_H
#define NDS_RULES_INSTANTIATIONS_RULES_ROAD_RANGE_ATTRIBUTE_SET_MAP_H
...
public:
    ...
    RulesRoadRangeAttributeSetMap() noexcept :
            RulesRoadRangeAttributeSetMap(allocator_type())
    {}

    explicit RulesRoadRangeAttributeSetMap(const allocator_type& allocator) noexcept;
    ...
    template <typename ZSERIO_T_attributeSet = ::nds::rules::instantiations::RulesRoadRangeAttributeSet,
            ...
            ::zserio::is_field_constructor_enabled_t<ZSERIO_T_attributeSet, RulesRoadRangeAttributeSetMap, allocator_type> = 0>
    RulesRoadRangeAttributeSetMap(
            ...
            RulesRoadRangeAttributeSetMap(allocator)
    {
    ...
    explicit RulesRoadRangeAttributeSetMap(::zserio::BitStreamReader& in,
            ::nds::core::geometry::CoordShift coordShift_, const allocator_type& allocator = allocator_type());
    explicit RulesRoadRangeAttributeSetMap(ZserioPackingContext& context,
            ::zserio::BitStreamReader& in,
            ::nds::core::geometry::CoordShift coordShift_, const allocator_type& allocator = allocator_type());

    ~RulesRoadRangeAttributeSetMap() = default;

    RulesRoadRangeAttributeSetMap(const RulesRoadRangeAttributeSetMap& other);
    RulesRoadRangeAttributeSetMap& operator=(const RulesRoadRangeAttributeSetMap& other);

    RulesRoadRangeAttributeSetMap(RulesRoadRangeAttributeSetMap&& other);
    RulesRoadRangeAttributeSetMap& operator=(RulesRoadRangeAttributeSetMap&& other);

    RulesRoadRangeAttributeSetMap(::zserio::PropagateAllocatorT,
    ...
    bool operator==(const RulesRoadRangeAttributeSetMap& other) const;
...
private:
    ...
    {
    public:
        using OwnerType = RulesRoadRangeAttributeSetMap;

        static void create(RulesRoadRangeAttributeSetMap& owner,
    ...
    public:
        ...
        static void initializeElement(RulesRoadRangeAttributeSetMap& owner,
...
#endif // NDS_RULES_INSTANTIATIONS_RULES_ROAD_RANGE_ATTRIBUTE_SET_MAP_H
