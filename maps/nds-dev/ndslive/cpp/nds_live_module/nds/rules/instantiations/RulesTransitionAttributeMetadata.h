...
#ifndef NDS_RULES_INSTANTIATIONS_RULES_TRANSITION_ATTRIBUTE_METADATA_H
#define NDS_RULES_INSTANTIATIONS_RULES_TRANSITION_ATTRIBUTE_METADATA_H
...
class RulesTransitionAttributeMetadata
{
public:
    ...
    RulesTransitionAttributeMetadata() noexcept :
            RulesTransitionAttributeMetadata(allocator_type())
    {}

    explicit RulesTransitionAttributeMetadata(const allocator_type& allocator) noexcept;

    template <typename ZSERIO_T_availableAttributes = ::zserio::vector<::nds::rules::attributes::RulesTransitionAttributeType>,
            ...
            ::zserio::is_field_constructor_enabled_t<ZSERIO_T_availableAttributes, RulesTransitionAttributeMetadata, allocator_type> = 0>
    RulesTransitionAttributeMetadata(
            ...
            RulesTransitionAttributeMetadata(allocator)
    {
    ...
    explicit RulesTransitionAttributeMetadata(::zserio::BitStreamReader& in, const allocator_type& allocator = allocator_type());
    explicit RulesTransitionAttributeMetadata(ZserioPackingContext& context,
            ::zserio::BitStreamReader& in, const allocator_type& allocator = allocator_type());

    ~RulesTransitionAttributeMetadata() = default;

    RulesTransitionAttributeMetadata(const RulesTransitionAttributeMetadata&) = default;
    RulesTransitionAttributeMetadata& operator=(const RulesTransitionAttributeMetadata&) = default;

    RulesTransitionAttributeMetadata(RulesTransitionAttributeMetadata&&) = default;
    RulesTransitionAttributeMetadata& operator=(RulesTransitionAttributeMetadata&&) = default;

    RulesTransitionAttributeMetadata(::zserio::PropagateAllocatorT,
            const RulesTransitionAttributeMetadata& other, const allocator_type& allocator);

    const ::zserio::vector<::nds::rules::attributes::RulesTransitionAttributeType>& getAvailableAttributes() const;
    ::zserio::vector<::nds::rules::attributes::RulesTransitionAttributeType>& getAvailableAttributes();
    void setAvailableAttributes(const ::zserio::vector<::nds::rules::attributes::RulesTransitionAttributeType>& availableAttributes_);
    void setAvailableAttributes(::zserio::vector<::nds::rules::attributes::RulesTransitionAttributeType>&& availableAttributes_);
    ...
    bool operator==(const RulesTransitionAttributeMetadata& other) const;
...
private:
    ...
    {
    public:
        using OwnerType = RulesTransitionAttributeMetadata;

        static void create(RulesTransitionAttributeMetadata& owner,
    ...
    using ZserioArrayType_availableAttributes = ::zserio::Array<::zserio::vector<::nds::rules::attributes::RulesTransitionAttributeType>, ::zserio::EnumArrayTraits<::nds::rules::attributes::RulesTransitionAttributeType>, ::zserio::ArrayType::AUTO>;
...
#endif // NDS_RULES_INSTANTIATIONS_RULES_TRANSITION_ATTRIBUTE_METADATA_H
