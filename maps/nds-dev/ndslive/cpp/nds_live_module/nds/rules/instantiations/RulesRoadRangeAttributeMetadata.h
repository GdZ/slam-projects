...
#ifndef NDS_RULES_INSTANTIATIONS_RULES_ROAD_RANGE_ATTRIBUTE_METADATA_H
#define NDS_RULES_INSTANTIATIONS_RULES_ROAD_RANGE_ATTRIBUTE_METADATA_H
...
class RulesRoadRangeAttributeMetadata
{
public:
    ...
    RulesRoadRangeAttributeMetadata() noexcept :
            RulesRoadRangeAttributeMetadata(allocator_type())
    {}

    explicit RulesRoadRangeAttributeMetadata(const allocator_type& allocator) noexcept;

    template <typename ZSERIO_T_availableAttributes = ::zserio::vector<::nds::rules::attributes::RulesRoadRangeAttributeType>,
            ...
            ::zserio::is_field_constructor_enabled_t<ZSERIO_T_availableAttributes, RulesRoadRangeAttributeMetadata, allocator_type> = 0>
    RulesRoadRangeAttributeMetadata(
            ...
            RulesRoadRangeAttributeMetadata(allocator)
    {
    ...
    explicit RulesRoadRangeAttributeMetadata(::zserio::BitStreamReader& in, const allocator_type& allocator = allocator_type());
    explicit RulesRoadRangeAttributeMetadata(ZserioPackingContext& context,
            ::zserio::BitStreamReader& in, const allocator_type& allocator = allocator_type());

    ~RulesRoadRangeAttributeMetadata() = default;

    RulesRoadRangeAttributeMetadata(const RulesRoadRangeAttributeMetadata&) = default;
    RulesRoadRangeAttributeMetadata& operator=(const RulesRoadRangeAttributeMetadata&) = default;

    RulesRoadRangeAttributeMetadata(RulesRoadRangeAttributeMetadata&&) = default;
    RulesRoadRangeAttributeMetadata& operator=(RulesRoadRangeAttributeMetadata&&) = default;

    RulesRoadRangeAttributeMetadata(::zserio::PropagateAllocatorT,
            const RulesRoadRangeAttributeMetadata& other, const allocator_type& allocator);

    const ::zserio::vector<::nds::rules::attributes::RulesRoadRangeAttributeType>& getAvailableAttributes() const;
    ::zserio::vector<::nds::rules::attributes::RulesRoadRangeAttributeType>& getAvailableAttributes();
    void setAvailableAttributes(const ::zserio::vector<::nds::rules::attributes::RulesRoadRangeAttributeType>& availableAttributes_);
    void setAvailableAttributes(::zserio::vector<::nds::rules::attributes::RulesRoadRangeAttributeType>&& availableAttributes_);
    ...
    bool operator==(const RulesRoadRangeAttributeMetadata& other) const;
...
private:
    ...
    {
    public:
        using OwnerType = RulesRoadRangeAttributeMetadata;

        static void create(RulesRoadRangeAttributeMetadata& owner,
    ...
    using ZserioArrayType_availableAttributes = ::zserio::Array<::zserio::vector<::nds::rules::attributes::RulesRoadRangeAttributeType>, ::zserio::EnumArrayTraits<::nds::rules::attributes::RulesRoadRangeAttributeType>, ::zserio::ArrayType::AUTO>;
...
#endif // NDS_RULES_INSTANTIATIONS_RULES_ROAD_RANGE_ATTRIBUTE_METADATA_H
