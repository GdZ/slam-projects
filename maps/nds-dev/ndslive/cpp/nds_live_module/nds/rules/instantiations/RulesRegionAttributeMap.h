...
#ifndef NDS_RULES_INSTANTIATIONS_RULES_REGION_ATTRIBUTE_MAP_H
#define NDS_RULES_INSTANTIATIONS_RULES_REGION_ATTRIBUTE_MAP_H
...
public:
    ...
    RulesRegionAttributeMap() noexcept :
            RulesRegionAttributeMap(allocator_type())
    {}

    explicit RulesRegionAttributeMap(const allocator_type& allocator) noexcept;

    template <typename ZSERIO_T_featureReferences = ::zserio::vector<::nds::core::types::RegionId>,
            typename ZSERIO_T_featureValidities = ::zserio::vector<::nds::rules::types::RegionValidity>,
            typename ZSERIO_T_featureValuePtr = ::zserio::vector<::nds::core::attributemap::AttributeIterator>,
            typename ZSERIO_T_attributeValues = ::zserio::vector<::nds::rules::instantiations::RulesRegionAttribute>,
    ...
    RulesRegionAttributeMap(
            ...
            RulesRegionAttributeMap(allocator)
    {
    ...
    explicit RulesRegionAttributeMap(::zserio::BitStreamReader& in,
            ::nds::core::geometry::CoordShift coordShift_, const allocator_type& allocator = allocator_type());
    explicit RulesRegionAttributeMap(ZserioPackingContext& context,
            ::zserio::BitStreamReader& in,
            ::nds::core::geometry::CoordShift coordShift_, const allocator_type& allocator = allocator_type());

    ~RulesRegionAttributeMap() = default;

    RulesRegionAttributeMap(const RulesRegionAttributeMap& other);
    RulesRegionAttributeMap& operator=(const RulesRegionAttributeMap& other);

    RulesRegionAttributeMap(RulesRegionAttributeMap&& other);
    RulesRegionAttributeMap& operator=(RulesRegionAttributeMap&& other);

    RulesRegionAttributeMap(::zserio::PropagateAllocatorT,
    ...
    const ::zserio::vector<::nds::core::types::RegionId>& getFeatureReferences() const;
    ::zserio::vector<::nds::core::types::RegionId>& getFeatureReferences();
    void setFeatureReferences(const ::zserio::vector<::nds::core::types::RegionId>& featureReferences_);
    void setFeatureReferences(::zserio::vector<::nds::core::types::RegionId>&& featureReferences_);

    const ::zserio::vector<::nds::rules::types::RegionValidity>& getFeatureValidities() const;
    ::zserio::vector<::nds::rules::types::RegionValidity>& getFeatureValidities();
    void setFeatureValidities(const ::zserio::vector<::nds::rules::types::RegionValidity>& featureValidities_);
    void setFeatureValidities(::zserio::vector<::nds::rules::types::RegionValidity>&& featureValidities_);
    ...
    const ::zserio::vector<::nds::rules::instantiations::RulesRegionAttribute>& getAttributeValues() const;
    ::zserio::vector<::nds::rules::instantiations::RulesRegionAttribute>& getAttributeValues();
    void setAttributeValues(const ::zserio::vector<::nds::rules::instantiations::RulesRegionAttribute>& attributeValues_);
    void setAttributeValues(::zserio::vector<::nds::rules::instantiations::RulesRegionAttribute>&& attributeValues_);
    ...
    bool operator==(const RulesRegionAttributeMap& other) const;
...
private:
    ...
    {
    public:
        using OwnerType = RulesRegionAttributeMap;

        static void initializeElement(RulesRegionAttributeMap& owner,
    ...
    public:
        ...
        static void create(RulesRegionAttributeMap& owner,
    ...
    public:
        ...
        static void initializeElement(RulesRegionAttributeMap& owner,
                ::nds::rules::instantiations::RulesRegionAttribute& element, size_t index);
    };
    ...
    public:
        ...
        static void create(RulesRegionAttributeMap& owner,
                ::zserio::vector<::nds::rules::instantiations::RulesRegionAttribute>& array,
                ::nds::rules::instantiations::RulesRegionAttribute::ZserioPackingContext& context,
                ::zserio::BitStreamReader& in, size_t index);
    };
    ...
    using ZserioArrayType_featureReferences = ::zserio::Array<::zserio::vector<::nds::core::types::RegionId>, ::zserio::VarIntNNArrayTraits<::nds::core::types::RegionId>, ::zserio::ArrayType::NORMAL>;
    using ZserioArrayType_featureValidities = ::zserio::Array<::zserio::vector<::nds::rules::types::RegionValidity>, ::zserio::ObjectArrayTraits<::nds::rules::types::RegionValidity, ZserioElementFactory_featureValidities>, ::zserio::ArrayType::NORMAL, ZserioArrayExpressions_featureValidities>;
    ...
    using ZserioArrayType_attributeValues = ::zserio::Array<::zserio::vector<::nds::rules::instantiations::RulesRegionAttribute>, ::zserio::ObjectArrayTraits<::nds::rules::instantiations::RulesRegionAttribute, ZserioElementFactory_attributeValues>, ::zserio::ArrayType::NORMAL, ZserioArrayExpressions_attributeValues>;
...
#endif // NDS_RULES_INSTANTIATIONS_RULES_REGION_ATTRIBUTE_MAP_H
