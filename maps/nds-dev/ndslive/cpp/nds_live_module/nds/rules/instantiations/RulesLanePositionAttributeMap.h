...
#ifndef NDS_RULES_INSTANTIATIONS_RULES_LANE_POSITION_ATTRIBUTE_MAP_H
#define NDS_RULES_INSTANTIATIONS_RULES_LANE_POSITION_ATTRIBUTE_MAP_H
...
public:
    ...
    RulesLanePositionAttributeMap() noexcept :
            RulesLanePositionAttributeMap(allocator_type())
    {}

    explicit RulesLanePositionAttributeMap(const allocator_type& allocator) noexcept;
    ...
    RulesLanePositionAttributeMap(
            ...
            RulesLanePositionAttributeMap(allocator)
    {
    ...
    explicit RulesLanePositionAttributeMap(::zserio::BitStreamReader& in,
            ::nds::core::geometry::CoordShift coordShift_, const allocator_type& allocator = allocator_type());
    explicit RulesLanePositionAttributeMap(ZserioPackingContext& context,
            ::zserio::BitStreamReader& in,
            ::nds::core::geometry::CoordShift coordShift_, const allocator_type& allocator = allocator_type());

    ~RulesLanePositionAttributeMap() = default;

    RulesLanePositionAttributeMap(const RulesLanePositionAttributeMap& other);
    RulesLanePositionAttributeMap& operator=(const RulesLanePositionAttributeMap& other);

    RulesLanePositionAttributeMap(RulesLanePositionAttributeMap&& other);
    RulesLanePositionAttributeMap& operator=(RulesLanePositionAttributeMap&& other);

    RulesLanePositionAttributeMap(::zserio::PropagateAllocatorT,
    ...
    bool operator==(const RulesLanePositionAttributeMap& other) const;
...
private:
    ...
    {
    public:
        using OwnerType = RulesLanePositionAttributeMap;

        static void create(RulesLanePositionAttributeMap& owner,
    ...
    public:
        ...
        static void initializeElement(RulesLanePositionAttributeMap& owner,
...
#endif // NDS_RULES_INSTANTIATIONS_RULES_LANE_POSITION_ATTRIBUTE_MAP_H
