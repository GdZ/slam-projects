...
#ifndef NDS_RULES_INSTANTIATIONS_RULES_ROAD_LOCATION_TRANSITION_ATTRIBUTE_SET_MAP_H
#define NDS_RULES_INSTANTIATIONS_RULES_ROAD_LOCATION_TRANSITION_ATTRIBUTE_SET_MAP_H
...
public:
    ...
    RulesRoadLocationTransitionAttributeSetMap() noexcept :
            RulesRoadLocationTransitionAttributeSetMap(allocator_type())
    {}

    explicit RulesRoadLocationTransitionAttributeSetMap(const allocator_type& allocator) noexcept;
    ...
    template <typename ZSERIO_T_attributeSet = ::nds::rules::instantiations::RulesTransitionAttributeSet,
            ...
            ::zserio::is_field_constructor_enabled_t<ZSERIO_T_attributeSet, RulesRoadLocationTransitionAttributeSetMap, allocator_type> = 0>
    RulesRoadLocationTransitionAttributeSetMap(
            ...
            RulesRoadLocationTransitionAttributeSetMap(allocator)
    {
    ...
    explicit RulesRoadLocationTransitionAttributeSetMap(::zserio::BitStreamReader& in,
            ::nds::core::geometry::CoordShift coordShift_, const allocator_type& allocator = allocator_type());
    explicit RulesRoadLocationTransitionAttributeSetMap(ZserioPackingContext& context,
            ::zserio::BitStreamReader& in,
            ::nds::core::geometry::CoordShift coordShift_, const allocator_type& allocator = allocator_type());

    ~RulesRoadLocationTransitionAttributeSetMap() = default;

    RulesRoadLocationTransitionAttributeSetMap(const RulesRoadLocationTransitionAttributeSetMap& other);
    RulesRoadLocationTransitionAttributeSetMap& operator=(const RulesRoadLocationTransitionAttributeSetMap& other);

    RulesRoadLocationTransitionAttributeSetMap(RulesRoadLocationTransitionAttributeSetMap&& other);
    RulesRoadLocationTransitionAttributeSetMap& operator=(RulesRoadLocationTransitionAttributeSetMap&& other);

    RulesRoadLocationTransitionAttributeSetMap(::zserio::PropagateAllocatorT,
    ...
    bool operator==(const RulesRoadLocationTransitionAttributeSetMap& other) const;
...
private:
    ...
    {
    public:
        using OwnerType = RulesRoadLocationTransitionAttributeSetMap;

        static void create(RulesRoadLocationTransitionAttributeSetMap& owner,
    ...
    public:
        ...
        static void initializeElement(RulesRoadLocationTransitionAttributeSetMap& owner,
...
#endif // NDS_RULES_INSTANTIATIONS_RULES_ROAD_LOCATION_TRANSITION_ATTRIBUTE_SET_MAP_H
