...
#ifndef NDS_RULES_INSTANTIATIONS_RULES_LANE_RANGE_ATTRIBUTE_METADATA_H
#define NDS_RULES_INSTANTIATIONS_RULES_LANE_RANGE_ATTRIBUTE_METADATA_H
...
public:
    ...
    RulesLaneRangeAttributeMetadata() noexcept :
            RulesLaneRangeAttributeMetadata(allocator_type())
    {}

    explicit RulesLaneRangeAttributeMetadata(const allocator_type& allocator) noexcept;

    template <typename ZSERIO_T_availableAttributes = ::zserio::vector<::nds::rules::attributes::RulesLaneRangeAttributeType>,
            ...
            ::zserio::is_field_constructor_enabled_t<ZSERIO_T_availableAttributes, RulesLaneRangeAttributeMetadata, allocator_type> = 0>
    RulesLaneRangeAttributeMetadata(
            ...
            RulesLaneRangeAttributeMetadata(allocator)
    {
    ...
    explicit RulesLaneRangeAttributeMetadata(::zserio::BitStreamReader& in, const allocator_type& allocator = allocator_type());
    explicit RulesLaneRangeAttributeMetadata(ZserioPackingContext& context,
            ::zserio::BitStreamReader& in, const allocator_type& allocator = allocator_type());

    ~RulesLaneRangeAttributeMetadata() = default;

    RulesLaneRangeAttributeMetadata(const RulesLaneRangeAttributeMetadata&) = default;
    RulesLaneRangeAttributeMetadata& operator=(const RulesLaneRangeAttributeMetadata&) = default;

    RulesLaneRangeAttributeMetadata(RulesLaneRangeAttributeMetadata&&) = default;
    RulesLaneRangeAttributeMetadata& operator=(RulesLaneRangeAttributeMetadata&&) = default;

    RulesLaneRangeAttributeMetadata(::zserio::PropagateAllocatorT,
            const RulesLaneRangeAttributeMetadata& other, const allocator_type& allocator);

    const ::zserio::vector<::nds::rules::attributes::RulesLaneRangeAttributeType>& getAvailableAttributes() const;
    ::zserio::vector<::nds::rules::attributes::RulesLaneRangeAttributeType>& getAvailableAttributes();
    void setAvailableAttributes(const ::zserio::vector<::nds::rules::attributes::RulesLaneRangeAttributeType>& availableAttributes_);
    void setAvailableAttributes(::zserio::vector<::nds::rules::attributes::RulesLaneRangeAttributeType>&& availableAttributes_);
    ...
    bool operator==(const RulesLaneRangeAttributeMetadata& other) const;
...
private:
    ...
    {
    public:
        using OwnerType = RulesLaneRangeAttributeMetadata;

        static void create(RulesLaneRangeAttributeMetadata& owner,
    ...
    using ZserioArrayType_availableAttributes = ::zserio::Array<::zserio::vector<::nds::rules::attributes::RulesLaneRangeAttributeType>, ::zserio::EnumArrayTraits<::nds::rules::attributes::RulesLaneRangeAttributeType>, ::zserio::ArrayType::AUTO>;
...
#endif // NDS_RULES_INSTANTIATIONS_RULES_LANE_RANGE_ATTRIBUTE_METADATA_H
