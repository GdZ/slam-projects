...
#ifndef NDS_RULES_INSTANTIATIONS_RULES_REGION_ATTRIBUTE_METADATA_H
#define NDS_RULES_INSTANTIATIONS_RULES_REGION_ATTRIBUTE_METADATA_H
...
class RulesRegionAttributeMetadata
{
public:
    ...
    RulesRegionAttributeMetadata() noexcept :
            RulesRegionAttributeMetadata(allocator_type())
    {}

    explicit RulesRegionAttributeMetadata(const allocator_type& allocator) noexcept;

    template <typename ZSERIO_T_availableAttributes = ::zserio::vector<::nds::rules::attributes::RulesRegionAttributeType>,
            ...
            ::zserio::is_field_constructor_enabled_t<ZSERIO_T_availableAttributes, RulesRegionAttributeMetadata, allocator_type> = 0>
    RulesRegionAttributeMetadata(
            ...
            RulesRegionAttributeMetadata(allocator)
    {
    ...
    explicit RulesRegionAttributeMetadata(::zserio::BitStreamReader& in, const allocator_type& allocator = allocator_type());
    explicit RulesRegionAttributeMetadata(ZserioPackingContext& context,
            ::zserio::BitStreamReader& in, const allocator_type& allocator = allocator_type());

    ~RulesRegionAttributeMetadata() = default;

    RulesRegionAttributeMetadata(const RulesRegionAttributeMetadata&) = default;
    RulesRegionAttributeMetadata& operator=(const RulesRegionAttributeMetadata&) = default;

    RulesRegionAttributeMetadata(RulesRegionAttributeMetadata&&) = default;
    RulesRegionAttributeMetadata& operator=(RulesRegionAttributeMetadata&&) = default;

    RulesRegionAttributeMetadata(::zserio::PropagateAllocatorT,
            const RulesRegionAttributeMetadata& other, const allocator_type& allocator);

    const ::zserio::vector<::nds::rules::attributes::RulesRegionAttributeType>& getAvailableAttributes() const;
    ::zserio::vector<::nds::rules::attributes::RulesRegionAttributeType>& getAvailableAttributes();
    void setAvailableAttributes(const ::zserio::vector<::nds::rules::attributes::RulesRegionAttributeType>& availableAttributes_);
    void setAvailableAttributes(::zserio::vector<::nds::rules::attributes::RulesRegionAttributeType>&& availableAttributes_);
    ...
    bool operator==(const RulesRegionAttributeMetadata& other) const;
...
private:
    ...
    {
    public:
        using OwnerType = RulesRegionAttributeMetadata;

        static void create(RulesRegionAttributeMetadata& owner,
    ...
    using ZserioArrayType_availableAttributes = ::zserio::Array<::zserio::vector<::nds::rules::attributes::RulesRegionAttributeType>, ::zserio::EnumArrayTraits<::nds::rules::attributes::RulesRegionAttributeType>, ::zserio::ArrayType::AUTO>;
...
#endif // NDS_RULES_INSTANTIATIONS_RULES_REGION_ATTRIBUTE_METADATA_H
