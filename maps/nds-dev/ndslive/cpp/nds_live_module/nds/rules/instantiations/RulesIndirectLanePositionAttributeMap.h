...
#ifndef NDS_RULES_INSTANTIATIONS_RULES_INDIRECT_LANE_POSITION_ATTRIBUTE_MAP_H
#define NDS_RULES_INSTANTIATIONS_RULES_INDIRECT_LANE_POSITION_ATTRIBUTE_MAP_H
...
public:
    ...
    RulesIndirectLanePositionAttributeMap() noexcept :
            RulesIndirectLanePositionAttributeMap(allocator_type())
    {}

    explicit RulesIndirectLanePositionAttributeMap(const allocator_type& allocator) noexcept;

    template <typename ZSERIO_T_featureReferences = ::zserio::vector<::nds::lane::reference::types::LaneGroupReferenceIndirect>,
            ...
            typename ZSERIO_T_attributeValues = ::zserio::vector<::nds::rules::instantiations::RulesLanePositionAttribute>,
    ...
    RulesIndirectLanePositionAttributeMap(
            ...
            RulesIndirectLanePositionAttributeMap(allocator)
    {
    ...
    explicit RulesIndirectLanePositionAttributeMap(::zserio::BitStreamReader& in,
            ::nds::core::geometry::CoordShift coordShift_, const allocator_type& allocator = allocator_type());
    explicit RulesIndirectLanePositionAttributeMap(ZserioPackingContext& context,
            ::zserio::BitStreamReader& in,
            ::nds::core::geometry::CoordShift coordShift_, const allocator_type& allocator = allocator_type());

    ~RulesIndirectLanePositionAttributeMap() = default;

    RulesIndirectLanePositionAttributeMap(const RulesIndirectLanePositionAttributeMap& other);
    RulesIndirectLanePositionAttributeMap& operator=(const RulesIndirectLanePositionAttributeMap& other);

    RulesIndirectLanePositionAttributeMap(RulesIndirectLanePositionAttributeMap&& other);
    RulesIndirectLanePositionAttributeMap& operator=(RulesIndirectLanePositionAttributeMap&& other);

    RulesIndirectLanePositionAttributeMap(::zserio::PropagateAllocatorT,
    ...
    const ::zserio::vector<::nds::lane::reference::types::LaneGroupReferenceIndirect>& getFeatureReferences() const;
    ::zserio::vector<::nds::lane::reference::types::LaneGroupReferenceIndirect>& getFeatureReferences();
    void setFeatureReferences(const ::zserio::vector<::nds::lane::reference::types::LaneGroupReferenceIndirect>& featureReferences_);
    void setFeatureReferences(::zserio::vector<::nds::lane::reference::types::LaneGroupReferenceIndirect>&& featureReferences_);
    ...
    const ::zserio::vector<::nds::rules::instantiations::RulesLanePositionAttribute>& getAttributeValues() const;
    ::zserio::vector<::nds::rules::instantiations::RulesLanePositionAttribute>& getAttributeValues();
    void setAttributeValues(const ::zserio::vector<::nds::rules::instantiations::RulesLanePositionAttribute>& attributeValues_);
    void setAttributeValues(::zserio::vector<::nds::rules::instantiations::RulesLanePositionAttribute>&& attributeValues_);
    ...
    bool operator==(const RulesIndirectLanePositionAttributeMap& other) const;
...
private:
    ...
    {
    public:
        using OwnerType = RulesIndirectLanePositionAttributeMap;

        static void initializeElement(RulesIndirectLanePositionAttributeMap& owner,
    ...
    public:
        ...
        static void create(RulesIndirectLanePositionAttributeMap& owner,
    ...
    public:
        ...
        static void initializeElement(RulesIndirectLanePositionAttributeMap& owner,
                ::nds::rules::instantiations::RulesLanePositionAttribute& element, size_t index);
    };
    ...
    public:
        ...
        static void create(RulesIndirectLanePositionAttributeMap& owner,
                ::zserio::vector<::nds::rules::instantiations::RulesLanePositionAttribute>& array,
                ::nds::rules::instantiations::RulesLanePositionAttribute::ZserioPackingContext& context,
                ::zserio::BitStreamReader& in, size_t index);
    };
    ...
    using ZserioArrayType_featureReferences = ::zserio::Array<::zserio::vector<::nds::lane::reference::types::LaneGroupReferenceIndirect>, ::zserio::ObjectArrayTraits<::nds::lane::reference::types::LaneGroupReferenceIndirect, ZserioElementFactory_featureReferences>, ::zserio::ArrayType::NORMAL, ZserioArrayExpressions_featureReferences>;
    ...
    using ZserioArrayType_attributeValues = ::zserio::Array<::zserio::vector<::nds::rules::instantiations::RulesLanePositionAttribute>, ::zserio::ObjectArrayTraits<::nds::rules::instantiations::RulesLanePositionAttribute, ZserioElementFactory_attributeValues>, ::zserio::ArrayType::NORMAL, ZserioArrayExpressions_attributeValues>;
...
#endif // NDS_RULES_INSTANTIATIONS_RULES_INDIRECT_LANE_POSITION_ATTRIBUTE_MAP_H
