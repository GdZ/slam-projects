...
#ifndef NDS_RULES_INSTANTIATIONS_RULES_DISPLAY_LINE_POSITION_ATTRIBUTE_METADATA_H
#define NDS_RULES_INSTANTIATIONS_RULES_DISPLAY_LINE_POSITION_ATTRIBUTE_METADATA_H
...
class RulesDisplayLinePositionAttributeMetadata
{
public:
    ...
    RulesDisplayLinePositionAttributeMetadata() noexcept :
            RulesDisplayLinePositionAttributeMetadata(allocator_type())
    {}

    explicit RulesDisplayLinePositionAttributeMetadata(const allocator_type& allocator) noexcept;

    template <typename ZSERIO_T_availableAttributes = ::zserio::vector<::nds::rules::attributes::RulesDisplayLinePositionAttributeType>,
            ...
            ::zserio::is_field_constructor_enabled_t<ZSERIO_T_availableAttributes, RulesDisplayLinePositionAttributeMetadata, allocator_type> = 0>
    RulesDisplayLinePositionAttributeMetadata(
            ...
            RulesDisplayLinePositionAttributeMetadata(allocator)
    {
    ...
    explicit RulesDisplayLinePositionAttributeMetadata(::zserio::BitStreamReader& in, const allocator_type& allocator = allocator_type());
    explicit RulesDisplayLinePositionAttributeMetadata(ZserioPackingContext& context,
            ::zserio::BitStreamReader& in, const allocator_type& allocator = allocator_type());

    ~RulesDisplayLinePositionAttributeMetadata() = default;

    RulesDisplayLinePositionAttributeMetadata(const RulesDisplayLinePositionAttributeMetadata&) = default;
    RulesDisplayLinePositionAttributeMetadata& operator=(const RulesDisplayLinePositionAttributeMetadata&) = default;

    RulesDisplayLinePositionAttributeMetadata(RulesDisplayLinePositionAttributeMetadata&&) = default;
    RulesDisplayLinePositionAttributeMetadata& operator=(RulesDisplayLinePositionAttributeMetadata&&) = default;

    RulesDisplayLinePositionAttributeMetadata(::zserio::PropagateAllocatorT,
            const RulesDisplayLinePositionAttributeMetadata& other, const allocator_type& allocator);

    const ::zserio::vector<::nds::rules::attributes::RulesDisplayLinePositionAttributeType>& getAvailableAttributes() const;
    ::zserio::vector<::nds::rules::attributes::RulesDisplayLinePositionAttributeType>& getAvailableAttributes();
    void setAvailableAttributes(const ::zserio::vector<::nds::rules::attributes::RulesDisplayLinePositionAttributeType>& availableAttributes_);
    void setAvailableAttributes(::zserio::vector<::nds::rules::attributes::RulesDisplayLinePositionAttributeType>&& availableAttributes_);
    ...
    bool operator==(const RulesDisplayLinePositionAttributeMetadata& other) const;
...
private:
    ...
    {
    public:
        using OwnerType = RulesDisplayLinePositionAttributeMetadata;

        static void create(RulesDisplayLinePositionAttributeMetadata& owner,
    ...
    using ZserioArrayType_availableAttributes = ::zserio::Array<::zserio::vector<::nds::rules::attributes::RulesDisplayLinePositionAttributeType>, ::zserio::EnumArrayTraits<::nds::rules::attributes::RulesDisplayLinePositionAttributeType>, ::zserio::ArrayType::AUTO>;
...
#endif // NDS_RULES_INSTANTIATIONS_RULES_DISPLAY_LINE_POSITION_ATTRIBUTE_METADATA_H
