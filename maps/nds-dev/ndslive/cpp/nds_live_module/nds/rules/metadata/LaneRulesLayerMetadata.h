...
#ifndef NDS_RULES_METADATA_LANE_RULES_LAYER_METADATA_H
#define NDS_RULES_METADATA_LANE_RULES_LAYER_METADATA_H
...
public:
    ...
    public:
        ...
        ::nds::rules::instantiations::RulesLaneTransitionAttributeMetadata::ZserioPackingContext& getLaneTransitionAttributeMetadata()
        {
    ...
    private:
        ...
        ::nds::rules::instantiations::RulesLaneTransitionAttributeMetadata::ZserioPackingContext m_laneTransitionAttributeMetadata_;
        ::nds::core::language::AvailableLanguages::ZserioPackingContext m_availableLanguages_;
    };

    using allocator_type = ::std::allocator<uint8_t>;

    LaneRulesLayerMetadata() noexcept :
            LaneRulesLayerMetadata(allocator_type())
    {}

    explicit LaneRulesLayerMetadata(const allocator_type& allocator) noexcept;
    ...
    template <typename ZSERIO_T_laneRangeAttributeMetadata = ::nds::rules::instantiations::RulesLaneRangeAttributeMetadata,
            ...
            typename ZSERIO_T_laneTransitionAttributeMetadata = ::nds::rules::instantiations::RulesLaneTransitionAttributeMetadata,
    ...
    LaneRulesLayerMetadata(
            ...
            LaneRulesLayerMetadata(allocator)
    {
        m_content_ = content_;
    ...
    explicit LaneRulesLayerMetadata(::zserio::BitStreamReader& in, const allocator_type& allocator = allocator_type());
    explicit LaneRulesLayerMetadata(ZserioPackingContext& context,
            ::zserio::BitStreamReader& in, const allocator_type& allocator = allocator_type());

    ~LaneRulesLayerMetadata() = default;

    LaneRulesLayerMetadata(const LaneRulesLayerMetadata&) = default;
    LaneRulesLayerMetadata& operator=(const LaneRulesLayerMetadata&) = default;

    LaneRulesLayerMetadata(LaneRulesLayerMetadata&&) = default;
    LaneRulesLayerMetadata& operator=(LaneRulesLayerMetadata&&) = default;

    LaneRulesLayerMetadata(::zserio::PropagateAllocatorT,
    ...
    const ::nds::rules::instantiations::RulesLaneTransitionAttributeMetadata& getLaneTransitionAttributeMetadata() const;
    ::nds::rules::instantiations::RulesLaneTransitionAttributeMetadata& getLaneTransitionAttributeMetadata();
    void setLaneTransitionAttributeMetadata(const ::nds::rules::instantiations::RulesLaneTransitionAttributeMetadata& laneTransitionAttributeMetadata_);
    void setLaneTransitionAttributeMetadata(::nds::rules::instantiations::RulesLaneTransitionAttributeMetadata&& laneTransitionAttributeMetadata_);
    ...
    bool operator==(const LaneRulesLayerMetadata& other) const;
...
private:
    ...
    {
    public:
        using OwnerType = LaneRulesLayerMetadata;

        static void create(LaneRulesLayerMetadata& owner,
    ...
    ::zserio::InplaceOptionalHolder<::nds::rules::instantiations::RulesLanePositionAttributeMetadata> readLanePositionAttributeMetadata(ZserioPackingContext& context,
            ::zserio::BitStreamReader& in, const allocator_type& allocator);
    ::zserio::InplaceOptionalHolder<::nds::rules::instantiations::RulesLaneTransitionAttributeMetadata> readLaneTransitionAttributeMetadata(::zserio::BitStreamReader& in,
            const allocator_type& allocator);
    ::zserio::InplaceOptionalHolder<::nds::rules::instantiations::RulesLaneTransitionAttributeMetadata> readLaneTransitionAttributeMetadata(ZserioPackingContext& context,
            ::zserio::BitStreamReader& in, const allocator_type& allocator);
    ...
    ::zserio::InplaceOptionalHolder<::nds::rules::instantiations::RulesLaneTransitionAttributeMetadata> m_laneTransitionAttributeMetadata_;
...
#endif // NDS_RULES_METADATA_LANE_RULES_LAYER_METADATA_H
