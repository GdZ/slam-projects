...
#ifndef NDS_DISPLAY_DETAILS_INSTANTIATIONS_DISPLAY3D_MESH_ATTRIBUTE_MAP_H
#define NDS_DISPLAY_DETAILS_INSTANTIATIONS_DISPLAY3D_MESH_ATTRIBUTE_MAP_H
...
public:
    ...
    Display3dMeshAttributeMap() noexcept :
            Display3dMeshAttributeMap(allocator_type())
    {}

    explicit Display3dMeshAttributeMap(const allocator_type& allocator) noexcept;
    ...
    template <typename ZSERIO_T_featureReferences = ::zserio::vector<::nds::display::reference::types::DisplayMesh3dId>,
            ...
            typename ZSERIO_T_attributeValues = ::zserio::vector<::nds::display::details::instantiations::Display3dMeshAttribute>,
    ...
    Display3dMeshAttributeMap(
            ...
            Display3dMeshAttributeMap(allocator)
    {
    ...
    explicit Display3dMeshAttributeMap(::zserio::BitStreamReader& in,
            ::nds::core::geometry::CoordShift coordShift_, const allocator_type& allocator = allocator_type());
    explicit Display3dMeshAttributeMap(ZserioPackingContext& context,
            ::zserio::BitStreamReader& in,
            ::nds::core::geometry::CoordShift coordShift_, const allocator_type& allocator = allocator_type());

    ~Display3dMeshAttributeMap() = default;

    Display3dMeshAttributeMap(const Display3dMeshAttributeMap& other);
    Display3dMeshAttributeMap& operator=(const Display3dMeshAttributeMap& other);

    Display3dMeshAttributeMap(Display3dMeshAttributeMap&& other);
    Display3dMeshAttributeMap& operator=(Display3dMeshAttributeMap&& other);

    Display3dMeshAttributeMap(::zserio::PropagateAllocatorT,
    ...
    const ::zserio::vector<::nds::display::details::instantiations::Display3dMeshAttribute>& getAttributeValues() const;
    ::zserio::vector<::nds::display::details::instantiations::Display3dMeshAttribute>& getAttributeValues();
    void setAttributeValues(const ::zserio::vector<::nds::display::details::instantiations::Display3dMeshAttribute>& attributeValues_);
    void setAttributeValues(::zserio::vector<::nds::display::details::instantiations::Display3dMeshAttribute>&& attributeValues_);
    ...
    bool operator==(const Display3dMeshAttributeMap& other) const;
...
private:
    ...
    {
    public:
        using OwnerType = Display3dMeshAttributeMap;

        static void create(Display3dMeshAttributeMap& owner,
    ...
    public:
        ...
        static void initializeElement(Display3dMeshAttributeMap& owner,
    ...
    public:
        ...
        static void initializeElement(Display3dMeshAttributeMap& owner,
                ::nds::display::details::instantiations::Display3dMeshAttribute& element, size_t index);
    };
    ...
    public:
        ...
        static void create(Display3dMeshAttributeMap& owner,
                ::zserio::vector<::nds::display::details::instantiations::Display3dMeshAttribute>& array,
                ::nds::display::details::instantiations::Display3dMeshAttribute::ZserioPackingContext& context,
                ::zserio::BitStreamReader& in, size_t index);
    };
    ...
    using ZserioArrayType_attributeValues = ::zserio::Array<::zserio::vector<::nds::display::details::instantiations::Display3dMeshAttribute>, ::zserio::ObjectArrayTraits<::nds::display::details::instantiations::Display3dMeshAttribute, ZserioElementFactory_attributeValues>, ::zserio::ArrayType::NORMAL, ZserioArrayExpressions_attributeValues>;
...
#endif // NDS_DISPLAY_DETAILS_INSTANTIATIONS_DISPLAY3D_MESH_ATTRIBUTE_MAP_H
