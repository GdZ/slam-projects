...
#ifndef NDS_DISPLAY_DETAILS_INSTANTIATIONS_DISPLAY_POINT_ATTRIBUTE_MAP_H
#define NDS_DISPLAY_DETAILS_INSTANTIATIONS_DISPLAY_POINT_ATTRIBUTE_MAP_H
...
public:
    ...
    DisplayPointAttributeMap() noexcept :
            DisplayPointAttributeMap(allocator_type())
    {}

    explicit DisplayPointAttributeMap(const allocator_type& allocator) noexcept;

    template <typename ZSERIO_T_featureReferences = ::zserio::vector<::nds::display::reference::types::DisplayPointId>,
            ...
            typename ZSERIO_T_attributeValues = ::zserio::vector<::nds::display::details::instantiations::DisplayPointAttribute>,
    ...
    DisplayPointAttributeMap(
            ...
            DisplayPointAttributeMap(allocator)
    {
    ...
    explicit DisplayPointAttributeMap(::zserio::BitStreamReader& in,
            ::nds::core::geometry::CoordShift coordShift_, const allocator_type& allocator = allocator_type());
    explicit DisplayPointAttributeMap(ZserioPackingContext& context,
            ::zserio::BitStreamReader& in,
            ::nds::core::geometry::CoordShift coordShift_, const allocator_type& allocator = allocator_type());

    ~DisplayPointAttributeMap() = default;

    DisplayPointAttributeMap(const DisplayPointAttributeMap& other);
    DisplayPointAttributeMap& operator=(const DisplayPointAttributeMap& other);

    DisplayPointAttributeMap(DisplayPointAttributeMap&& other);
    DisplayPointAttributeMap& operator=(DisplayPointAttributeMap&& other);

    DisplayPointAttributeMap(::zserio::PropagateAllocatorT,
    ...
    void setAttributeTypeCode(::nds::display::details::attributes::DisplayPointAttributeType attributeTypeCode_);

    ::nds::core::attributemap::FeatureIterator getFeature() const;
    void setFeature(::nds::core::attributemap::FeatureIterator feature_);

    const ::zserio::vector<::nds::display::reference::types::DisplayPointId>& getFeatureReferences() const;
    ::zserio::vector<::nds::display::reference::types::DisplayPointId>& getFeatureReferences();
    void setFeatureReferences(const ::zserio::vector<::nds::display::reference::types::DisplayPointId>& featureReferences_);
    void setFeatureReferences(::zserio::vector<::nds::display::reference::types::DisplayPointId>&& featureReferences_);
    ...
    const ::zserio::vector<::nds::display::details::instantiations::DisplayPointAttribute>& getAttributeValues() const;
    ::zserio::vector<::nds::display::details::instantiations::DisplayPointAttribute>& getAttributeValues();
    void setAttributeValues(const ::zserio::vector<::nds::display::details::instantiations::DisplayPointAttribute>& attributeValues_);
    void setAttributeValues(::zserio::vector<::nds::display::details::instantiations::DisplayPointAttribute>&& attributeValues_);
    ...
    bool operator==(const DisplayPointAttributeMap& other) const;
...
private:
    ...
    {
    public:
        using OwnerType = DisplayPointAttributeMap;

        static void create(DisplayPointAttributeMap& owner,
    ...
    public:
        ...
        static void initializeElement(DisplayPointAttributeMap& owner,
    ...
    public:
        ...
        static void initializeElement(DisplayPointAttributeMap& owner,
                ::nds::display::details::instantiations::DisplayPointAttribute& element, size_t index);
    };
    ...
    public:
        ...
        static void create(DisplayPointAttributeMap& owner,
                ::zserio::vector<::nds::display::details::instantiations::DisplayPointAttribute>& array,
                ::nds::display::details::instantiations::DisplayPointAttribute::ZserioPackingContext& context,
                ::zserio::BitStreamReader& in, size_t index);
    };
    ...
    using ZserioArrayType_featureReferences = ::zserio::Array<::zserio::vector<::nds::display::reference::types::DisplayPointId>, ::zserio::ObjectArrayTraits<::nds::display::reference::types::DisplayPointId, ZserioElementFactory_featureReferences>, ::zserio::ArrayType::NORMAL>;
    ...
    using ZserioArrayType_attributeValues = ::zserio::Array<::zserio::vector<::nds::display::details::instantiations::DisplayPointAttribute>, ::zserio::ObjectArrayTraits<::nds::display::details::instantiations::DisplayPointAttribute, ZserioElementFactory_attributeValues>, ::zserio::ArrayType::NORMAL, ZserioArrayExpressions_attributeValues>;
    ...
    ::nds::display::details::attributes::DisplayPointAttributeType readAttributeTypeCode(::zserio::BitStreamReader& in);
    ::nds::display::details::attributes::DisplayPointAttributeType readAttributeTypeCode(ZserioPackingContext& context,
            ::zserio::BitStreamReader& in);
...
#endif // NDS_DISPLAY_DETAILS_INSTANTIATIONS_DISPLAY_POINT_ATTRIBUTE_MAP_H
