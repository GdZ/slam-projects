...
#ifndef NDS_DISPLAY_REFERENCE_TYPES_DISPLAY_LINE_RANGE_VALIDITY_H
#define NDS_DISPLAY_REFERENCE_TYPES_DISPLAY_LINE_RANGE_VALIDITY_H
...
public:
    ...
    DisplayLineRangeValidity() noexcept :
            DisplayLineRangeValidity(allocator_type())
    {}

    explicit DisplayLineRangeValidity(const allocator_type& allocator) noexcept;

    template <typename ZSERIO_T_numRanges = uint32_t,
            typename ZSERIO_T_ranges = ::zserio::vector<::nds::display::reference::types::DisplayLineRangeChoice>>
    DisplayLineRangeValidity(
            ...
            DisplayLineRangeValidity(allocator)
    {
        m_type_ = type_;
    ...
    explicit DisplayLineRangeValidity(::zserio::BitStreamReader& in,
            ::nds::core::geometry::CoordShift shift_, const allocator_type& allocator = allocator_type());
    explicit DisplayLineRangeValidity(ZserioPackingContext& context,
            ::zserio::BitStreamReader& in,
            ::nds::core::geometry::CoordShift shift_, const allocator_type& allocator = allocator_type());

    ~DisplayLineRangeValidity() = default;

    DisplayLineRangeValidity(const DisplayLineRangeValidity& other);
    DisplayLineRangeValidity& operator=(const DisplayLineRangeValidity& other);

    DisplayLineRangeValidity(DisplayLineRangeValidity&& other);
    DisplayLineRangeValidity& operator=(DisplayLineRangeValidity&& other);

    DisplayLineRangeValidity(::zserio::PropagateAllocatorT,
    ...
    const ::zserio::vector<::nds::display::reference::types::DisplayLineRangeChoice>& getRanges() const;
    ::zserio::vector<::nds::display::reference::types::DisplayLineRangeChoice>& getRanges();
    void setRanges(const ::zserio::vector<::nds::display::reference::types::DisplayLineRangeChoice>& ranges_);
    void setRanges(::zserio::vector<::nds::display::reference::types::DisplayLineRangeChoice>&& ranges_);
    ...
    bool operator==(const DisplayLineRangeValidity& other) const;
...
private:
    ...
    {
    public:
        using OwnerType = DisplayLineRangeValidity;

        static void initializeElement(DisplayLineRangeValidity& owner,
                ::nds::display::reference::types::DisplayLineRangeChoice& element, size_t index);
    };
    ...
    public:
        ...
        static void create(DisplayLineRangeValidity& owner,
                ::zserio::vector<::nds::display::reference::types::DisplayLineRangeChoice>& array,
                ::zserio::BitStreamReader& in, size_t index);

        static void create(DisplayLineRangeValidity& owner,
                ::zserio::vector<::nds::display::reference::types::DisplayLineRangeChoice>& array,
                ::nds::display::reference::types::DisplayLineRangeChoice::ZserioPackingContext& context,
                ::zserio::BitStreamReader& in, size_t index);
    };

    using ZserioArrayType_ranges = ::zserio::Array<::zserio::vector<::nds::display::reference::types::DisplayLineRangeChoice>, ::zserio::ObjectArrayTraits<::nds::display::reference::types::DisplayLineRangeChoice, ZserioElementFactory_ranges>, ::zserio::ArrayType::NORMAL, ZserioArrayExpressions_ranges>;
...
#endif // NDS_DISPLAY_REFERENCE_TYPES_DISPLAY_LINE_RANGE_VALIDITY_H
