...
#ifndef NDS_DISPLAY_INSTANTIATIONS_MESH3D_DISPLAY_GEOMETRY_LAYER_H
#define NDS_DISPLAY_INSTANTIATIONS_MESH3D_DISPLAY_GEOMETRY_LAYER_H
...
public:
    ...
    Mesh3dDisplayGeometryLayer() noexcept :
            Mesh3dDisplayGeometryLayer(allocator_type())
    {}

    explicit Mesh3dDisplayGeometryLayer(const allocator_type& allocator) noexcept;

    template <typename ZSERIO_T_identifier = ::zserio::vector<::nds::display::reference::types::DisplayMesh3dId>,
            typename ZSERIO_T_types = ::zserio::vector<::nds::display::types::DisplayMesh3dType>,
            typename ZSERIO_T_buffers = ::nds::core::geometry::Buffers>
    Mesh3dDisplayGeometryLayer(
            ...
            Mesh3dDisplayGeometryLayer(allocator)
    {
    ...
    explicit Mesh3dDisplayGeometryLayer(::zserio::BitStreamReader& in,
            ::nds::core::geometry::GeometryLayerType type_,
            bool hasIds_,
            bool hasTypes_, const allocator_type& allocator = allocator_type());
    explicit Mesh3dDisplayGeometryLayer(ZserioPackingContext& context,
            ::zserio::BitStreamReader& in,
            ::nds::core::geometry::GeometryLayerType type_,
            bool hasIds_,
            bool hasTypes_, const allocator_type& allocator = allocator_type());

    ~Mesh3dDisplayGeometryLayer() = default;

    Mesh3dDisplayGeometryLayer(const Mesh3dDisplayGeometryLayer& other);
    Mesh3dDisplayGeometryLayer& operator=(const Mesh3dDisplayGeometryLayer& other);

    Mesh3dDisplayGeometryLayer(Mesh3dDisplayGeometryLayer&& other);
    Mesh3dDisplayGeometryLayer& operator=(Mesh3dDisplayGeometryLayer&& other);

    Mesh3dDisplayGeometryLayer(::zserio::PropagateAllocatorT,
    ...
    const ::zserio::vector<::nds::display::reference::types::DisplayMesh3dId>& getIdentifier() const;
    ::zserio::vector<::nds::display::reference::types::DisplayMesh3dId>& getIdentifier();
    void setIdentifier(const ::zserio::vector<::nds::display::reference::types::DisplayMesh3dId>& identifier_);
    void setIdentifier(::zserio::vector<::nds::display::reference::types::DisplayMesh3dId>&& identifier_);
    bool isIdentifierUsed() const;
    bool isIdentifierSet() const;
    void resetIdentifier();

    const ::zserio::vector<::nds::display::types::DisplayMesh3dType>& getTypes() const;
    ::zserio::vector<::nds::display::types::DisplayMesh3dType>& getTypes();
    void setTypes(const ::zserio::vector<::nds::display::types::DisplayMesh3dType>& types_);
    void setTypes(::zserio::vector<::nds::display::types::DisplayMesh3dType>&& types_);
    ...
    bool operator==(const Mesh3dDisplayGeometryLayer& other) const;
...
private:
    ...
    {
    public:
        using OwnerType = Mesh3dDisplayGeometryLayer;

        static void create(Mesh3dDisplayGeometryLayer& owner,
    ...
    using ZserioArrayType_identifier = ::zserio::Array<::zserio::vector<::nds::display::reference::types::DisplayMesh3dId>, ::zserio::ObjectArrayTraits<::nds::display::reference::types::DisplayMesh3dId, ZserioElementFactory_identifier>, ::zserio::ArrayType::NORMAL>;
    using ZserioArrayType_types = ::zserio::Array<::zserio::vector<::nds::display::types::DisplayMesh3dType>, ::zserio::EnumArrayTraits<::nds::display::types::DisplayMesh3dType>, ::zserio::ArrayType::NORMAL>;
...
#endif // NDS_DISPLAY_INSTANTIATIONS_MESH3D_DISPLAY_GEOMETRY_LAYER_H
