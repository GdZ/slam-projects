...
#ifndef NDS_SMART_TILE_SMART_LAYER_TILE_VERSION_REQUEST_H
#define NDS_SMART_TILE_SMART_LAYER_TILE_VERSION_REQUEST_H
...
public:
    ...
    SmartLayerTileVersionRequest() noexcept :
            SmartLayerTileVersionRequest(allocator_type())
    {}

    explicit SmartLayerTileVersionRequest(const allocator_type& allocator) noexcept;
    ...
    template <typename ZSERIO_T_id = ::nds::core::types::TileId,
            ...
            ::zserio::is_field_constructor_enabled_t<ZSERIO_T_id, SmartLayerTileVersionRequest, allocator_type> = 0>
    SmartLayerTileVersionRequest(
            ZSERIO_T_id&& id_,
            uint16_t numDataLayers_,
            ZSERIO_T_layerIds&& layerIds_,
            ZSERIO_T_lifetimeInfo&& lifetimeInfo_,
            const allocator_type& allocator = allocator_type()) :
            SmartLayerTileVersionRequest(allocator)
    {
    ...
    explicit SmartLayerTileVersionRequest(::zserio::BitStreamReader& in, const allocator_type& allocator = allocator_type());
    explicit SmartLayerTileVersionRequest(ZserioPackingContext& context,
            ::zserio::BitStreamReader& in, const allocator_type& allocator = allocator_type());

    ~SmartLayerTileVersionRequest() = default;

    SmartLayerTileVersionRequest(const SmartLayerTileVersionRequest&) = default;
    SmartLayerTileVersionRequest& operator=(const SmartLayerTileVersionRequest&) = default;

    SmartLayerTileVersionRequest(SmartLayerTileVersionRequest&&) = default;
    SmartLayerTileVersionRequest& operator=(SmartLayerTileVersionRequest&&) = default;

    SmartLayerTileVersionRequest(::zserio::PropagateAllocatorT,
    ...
    bool operator==(const SmartLayerTileVersionRequest& other) const;
...
private:
    ...
    {
    public:
        using OwnerType = SmartLayerTileVersionRequest;

        static void initializeElement(SmartLayerTileVersionRequest& owner,
    ...
    public:
        ...
        static void create(SmartLayerTileVersionRequest& owner,
...
#endif // NDS_SMART_TILE_SMART_LAYER_TILE_VERSION_REQUEST_H
