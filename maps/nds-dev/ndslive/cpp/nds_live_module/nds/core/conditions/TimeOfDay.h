...
#ifndef NDS_CORE_CONDITIONS_TIME_OF_DAY_H
#define NDS_CORE_CONDITIONS_TIME_OF_DAY_H
...
public:
    ...
    TimeOfDay() noexcept :
            TimeOfDay(allocator_type())
    {}

    explicit TimeOfDay(const allocator_type& allocator) noexcept;
    ...
    explicit TimeOfDay(::zserio::BitStreamReader& in, const allocator_type& allocator = allocator_type());
    explicit TimeOfDay(ZserioPackingContext& context,
    ...
    TimeOfDay(::zserio::PropagateAllocatorT,
...
#endif // NDS_CORE_CONDITIONS_TIME_OF_DAY_H
