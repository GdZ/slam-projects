...
#ifndef NDS_CORE_GEOMETRY_LINE_RANGE3_D_H
#define NDS_CORE_GEOMETRY_LINE_RANGE3_D_H
...
public:
    ...
    LineRange3D() noexcept :
            LineRange3D(allocator_type())
    {}

    explicit LineRange3D(const allocator_type& allocator) noexcept;

    LineRange3D(
            ::nds::core::geometry::LinePosition start_,
            ::nds::core::geometry::LinePosition end_,
            const allocator_type& allocator = allocator_type()) :
            LineRange3D(allocator)
    {
        m_start_ = start_;
        m_end_ = end_;
    }

    explicit LineRange3D(::zserio::BitStreamReader& in,
            ::nds::core::geometry::Line3D& line_, const allocator_type& allocator = allocator_type());
    explicit LineRange3D(ZserioPackingContext& context,
            ::zserio::BitStreamReader& in,
            ::nds::core::geometry::Line3D& line_, const allocator_type& allocator = allocator_type());

    ~LineRange3D() = default;

    LineRange3D(const LineRange3D& other);
    LineRange3D& operator=(const LineRange3D& other);

    LineRange3D(LineRange3D&& other);
    LineRange3D& operator=(LineRange3D&& other);

    LineRange3D(::zserio::PropagateAllocatorT,
    ...
    ::nds::core::geometry::Line3D& getLine();
    const ::nds::core::geometry::Line3D& getLine() const;
    ...
    bool operator==(const LineRange3D& other) const;
...
private:
    ...
    ::nds::core::geometry::Line3D* m_line_;
...
#endif // NDS_CORE_GEOMETRY_LINE_RANGE3_D_H
