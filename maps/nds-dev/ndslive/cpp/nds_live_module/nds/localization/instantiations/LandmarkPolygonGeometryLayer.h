...
#ifndef NDS_LOCALIZATION_INSTANTIATIONS_LANDMARK_POLYGON_GEOMETRY_LAYER_H
#define NDS_LOCALIZATION_INSTANTIATIONS_LANDMARK_POLYGON_GEOMETRY_LAYER_H
...
public:
    ...
    LandmarkPolygonGeometryLayer() noexcept :
            LandmarkPolygonGeometryLayer(allocator_type())
    {}

    explicit LandmarkPolygonGeometryLayer(const allocator_type& allocator) noexcept;

    template <typename ZSERIO_T_identifier = ::zserio::vector<::nds::localization::types::LandmarkId>,
            typename ZSERIO_T_types = ::zserio::vector<::nds::localization::types::LandmarkPolygon>,
    ...
    LandmarkPolygonGeometryLayer(
            ...
            LandmarkPolygonGeometryLayer(allocator)
    {
    ...
    explicit LandmarkPolygonGeometryLayer(::zserio::BitStreamReader& in,
            ::nds::core::geometry::GeometryLayerType type_,
            bool hasIds_,
            bool hasTypes_, const allocator_type& allocator = allocator_type());
    explicit LandmarkPolygonGeometryLayer(ZserioPackingContext& context,
            ::zserio::BitStreamReader& in,
            ::nds::core::geometry::GeometryLayerType type_,
            bool hasIds_,
            bool hasTypes_, const allocator_type& allocator = allocator_type());

    ~LandmarkPolygonGeometryLayer() = default;

    LandmarkPolygonGeometryLayer(const LandmarkPolygonGeometryLayer& other);
    LandmarkPolygonGeometryLayer& operator=(const LandmarkPolygonGeometryLayer& other);

    LandmarkPolygonGeometryLayer(LandmarkPolygonGeometryLayer&& other);
    LandmarkPolygonGeometryLayer& operator=(LandmarkPolygonGeometryLayer&& other);

    LandmarkPolygonGeometryLayer(::zserio::PropagateAllocatorT,
    ...
    const ::zserio::vector<::nds::localization::types::LandmarkPolygon>& getTypes() const;
    ::zserio::vector<::nds::localization::types::LandmarkPolygon>& getTypes();
    void setTypes(const ::zserio::vector<::nds::localization::types::LandmarkPolygon>& types_);
    void setTypes(::zserio::vector<::nds::localization::types::LandmarkPolygon>&& types_);
    ...
    bool operator==(const LandmarkPolygonGeometryLayer& other) const;
...
private:
    ...
    {
    public:
        using OwnerType = LandmarkPolygonGeometryLayer;

        static void create(LandmarkPolygonGeometryLayer& owner,
                ::zserio::vector<::nds::localization::types::LandmarkPolygon>& array,
                ::zserio::BitStreamReader& in, size_t index);

        static void create(LandmarkPolygonGeometryLayer& owner,
                ::zserio::vector<::nds::localization::types::LandmarkPolygon>& array,
                ::nds::localization::types::LandmarkPolygon::ZserioPackingContext& context,
                ::zserio::BitStreamReader& in, size_t index);
    };
    ...
    using ZserioArrayType_types = ::zserio::Array<::zserio::vector<::nds::localization::types::LandmarkPolygon>, ::zserio::ObjectArrayTraits<::nds::localization::types::LandmarkPolygon, ZserioElementFactory_types>, ::zserio::ArrayType::NORMAL>;
...
#endif // NDS_LOCALIZATION_INSTANTIATIONS_LANDMARK_POLYGON_GEOMETRY_LAYER_H
