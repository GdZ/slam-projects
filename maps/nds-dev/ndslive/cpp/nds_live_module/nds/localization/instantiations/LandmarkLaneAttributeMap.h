...
#ifndef NDS_LOCALIZATION_INSTANTIATIONS_LANDMARK_LANE_ATTRIBUTE_MAP_H
#define NDS_LOCALIZATION_INSTANTIATIONS_LANDMARK_LANE_ATTRIBUTE_MAP_H
...
public:
    ...
    LandmarkLaneAttributeMap() noexcept :
            LandmarkLaneAttributeMap(allocator_type())
    {}

    explicit LandmarkLaneAttributeMap(const allocator_type& allocator) noexcept;
    ...
    LandmarkLaneAttributeMap(
            ...
            LandmarkLaneAttributeMap(allocator)
    {
    ...
    explicit LandmarkLaneAttributeMap(::zserio::BitStreamReader& in,
            ::nds::core::geometry::CoordShift coordShift_, const allocator_type& allocator = allocator_type());
    explicit LandmarkLaneAttributeMap(ZserioPackingContext& context,
            ::zserio::BitStreamReader& in,
            ::nds::core::geometry::CoordShift coordShift_, const allocator_type& allocator = allocator_type());

    ~LandmarkLaneAttributeMap() = default;

    LandmarkLaneAttributeMap(const LandmarkLaneAttributeMap& other);
    LandmarkLaneAttributeMap& operator=(const LandmarkLaneAttributeMap& other);

    LandmarkLaneAttributeMap(LandmarkLaneAttributeMap&& other);
    LandmarkLaneAttributeMap& operator=(LandmarkLaneAttributeMap&& other);

    LandmarkLaneAttributeMap(::zserio::PropagateAllocatorT,
    ...
    bool operator==(const LandmarkLaneAttributeMap& other) const;
...
private:
    ...
    {
    public:
        using OwnerType = LandmarkLaneAttributeMap;

        static void create(LandmarkLaneAttributeMap& owner,
    ...
    public:
        ...
        static void initializeElement(LandmarkLaneAttributeMap& owner,
...
#endif // NDS_LOCALIZATION_INSTANTIATIONS_LANDMARK_LANE_ATTRIBUTE_MAP_H
