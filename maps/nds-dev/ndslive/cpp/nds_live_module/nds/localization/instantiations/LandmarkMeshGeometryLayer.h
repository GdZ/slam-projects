...
#ifndef NDS_LOCALIZATION_INSTANTIATIONS_LANDMARK_MESH_GEOMETRY_LAYER_H
#define NDS_LOCALIZATION_INSTANTIATIONS_LANDMARK_MESH_GEOMETRY_LAYER_H
...
public:
    ...
    LandmarkMeshGeometryLayer() noexcept :
            LandmarkMeshGeometryLayer(allocator_type())
    {}

    explicit LandmarkMeshGeometryLayer(const allocator_type& allocator) noexcept;

    template <typename ZSERIO_T_identifier = ::zserio::vector<::nds::localization::types::LandmarkId>,
            typename ZSERIO_T_types = ::zserio::vector<::nds::localization::types::LandmarkMesh>,
    ...
    LandmarkMeshGeometryLayer(
            ...
            LandmarkMeshGeometryLayer(allocator)
    {
    ...
    explicit LandmarkMeshGeometryLayer(::zserio::BitStreamReader& in,
            ::nds::core::geometry::GeometryLayerType type_,
            bool hasIds_,
            bool hasTypes_, const allocator_type& allocator = allocator_type());
    explicit LandmarkMeshGeometryLayer(ZserioPackingContext& context,
            ::zserio::BitStreamReader& in,
            ::nds::core::geometry::GeometryLayerType type_,
            bool hasIds_,
            bool hasTypes_, const allocator_type& allocator = allocator_type());

    ~LandmarkMeshGeometryLayer() = default;

    LandmarkMeshGeometryLayer(const LandmarkMeshGeometryLayer& other);
    LandmarkMeshGeometryLayer& operator=(const LandmarkMeshGeometryLayer& other);

    LandmarkMeshGeometryLayer(LandmarkMeshGeometryLayer&& other);
    LandmarkMeshGeometryLayer& operator=(LandmarkMeshGeometryLayer&& other);

    LandmarkMeshGeometryLayer(::zserio::PropagateAllocatorT,
    ...
    const ::zserio::vector<::nds::localization::types::LandmarkMesh>& getTypes() const;
    ::zserio::vector<::nds::localization::types::LandmarkMesh>& getTypes();
    void setTypes(const ::zserio::vector<::nds::localization::types::LandmarkMesh>& types_);
    void setTypes(::zserio::vector<::nds::localization::types::LandmarkMesh>&& types_);
    ...
    bool operator==(const LandmarkMeshGeometryLayer& other) const;
...
private:
    ...
    {
    public:
        using OwnerType = LandmarkMeshGeometryLayer;

        static void create(LandmarkMeshGeometryLayer& owner,
                ::zserio::vector<::nds::localization::types::LandmarkMesh>& array,
                ::zserio::BitStreamReader& in, size_t index);

        static void create(LandmarkMeshGeometryLayer& owner,
                ::zserio::vector<::nds::localization::types::LandmarkMesh>& array,
                ::nds::localization::types::LandmarkMesh::ZserioPackingContext& context,
                ::zserio::BitStreamReader& in, size_t index);
    };
    ...
    using ZserioArrayType_types = ::zserio::Array<::zserio::vector<::nds::localization::types::LandmarkMesh>, ::zserio::ObjectArrayTraits<::nds::localization::types::LandmarkMesh, ZserioElementFactory_types>, ::zserio::ArrayType::NORMAL>;
...
#endif // NDS_LOCALIZATION_INSTANTIATIONS_LANDMARK_MESH_GEOMETRY_LAYER_H
