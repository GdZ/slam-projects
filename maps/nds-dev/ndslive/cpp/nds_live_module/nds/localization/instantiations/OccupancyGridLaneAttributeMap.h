...
#ifndef NDS_LOCALIZATION_INSTANTIATIONS_OCCUPANCY_GRID_LANE_ATTRIBUTE_MAP_H
#define NDS_LOCALIZATION_INSTANTIATIONS_OCCUPANCY_GRID_LANE_ATTRIBUTE_MAP_H
...
public:
    ...
    OccupancyGridLaneAttributeMap() noexcept :
            OccupancyGridLaneAttributeMap(allocator_type())
    {}

    explicit OccupancyGridLaneAttributeMap(const allocator_type& allocator) noexcept;
    ...
    OccupancyGridLaneAttributeMap(
            ...
            OccupancyGridLaneAttributeMap(allocator)
    {
    ...
    explicit OccupancyGridLaneAttributeMap(::zserio::BitStreamReader& in,
            ::nds::core::geometry::CoordShift coordShift_, const allocator_type& allocator = allocator_type());
    explicit OccupancyGridLaneAttributeMap(ZserioPackingContext& context,
            ::zserio::BitStreamReader& in,
            ::nds::core::geometry::CoordShift coordShift_, const allocator_type& allocator = allocator_type());

    ~OccupancyGridLaneAttributeMap() = default;

    OccupancyGridLaneAttributeMap(const OccupancyGridLaneAttributeMap& other);
    OccupancyGridLaneAttributeMap& operator=(const OccupancyGridLaneAttributeMap& other);

    OccupancyGridLaneAttributeMap(OccupancyGridLaneAttributeMap&& other);
    OccupancyGridLaneAttributeMap& operator=(OccupancyGridLaneAttributeMap&& other);

    OccupancyGridLaneAttributeMap(::zserio::PropagateAllocatorT,
    ...
    bool operator==(const OccupancyGridLaneAttributeMap& other) const;
...
private:
    ...
    {
    public:
        using OwnerType = OccupancyGridLaneAttributeMap;

        static void create(OccupancyGridLaneAttributeMap& owner,
    ...
    public:
        ...
        static void initializeElement(OccupancyGridLaneAttributeMap& owner,
...
#endif // NDS_LOCALIZATION_INSTANTIATIONS_OCCUPANCY_GRID_LANE_ATTRIBUTE_MAP_H
