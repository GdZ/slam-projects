...
#ifndef NDS_LOCALIZATION_INSTANTIATIONS_OBSTACLE_GEOMETRY_LAYER_H
#define NDS_LOCALIZATION_INSTANTIATIONS_OBSTACLE_GEOMETRY_LAYER_H
...
#include <nds/core/geometry/GeometryId.h>
...
public:
    ...
    ObstacleGeometryLayer() noexcept :
            ObstacleGeometryLayer(allocator_type())
    {}

    explicit ObstacleGeometryLayer(const allocator_type& allocator) noexcept;

    template <typename ZSERIO_T_identifier = ::zserio::vector<::nds::core::geometry::GeometryId>,
            typename ZSERIO_T_types = ::zserio::vector<::nds::localization::types::ObstacleType>,
            typename ZSERIO_T_buffers = ::nds::core::geometry::Buffers>
    ObstacleGeometryLayer(
            ...
            ObstacleGeometryLayer(allocator)
    {
    ...
    explicit ObstacleGeometryLayer(::zserio::BitStreamReader& in,
            ::nds::core::geometry::GeometryLayerType type_,
            bool hasIds_,
            bool hasTypes_, const allocator_type& allocator = allocator_type());
    explicit ObstacleGeometryLayer(ZserioPackingContext& context,
            ::zserio::BitStreamReader& in,
            ::nds::core::geometry::GeometryLayerType type_,
            bool hasIds_,
            bool hasTypes_, const allocator_type& allocator = allocator_type());

    ~ObstacleGeometryLayer() = default;

    ObstacleGeometryLayer(const ObstacleGeometryLayer& other);
    ObstacleGeometryLayer& operator=(const ObstacleGeometryLayer& other);

    ObstacleGeometryLayer(ObstacleGeometryLayer&& other);
    ObstacleGeometryLayer& operator=(ObstacleGeometryLayer&& other);

    ObstacleGeometryLayer(::zserio::PropagateAllocatorT,
    ...
    const ::zserio::vector<::nds::core::geometry::GeometryId>& getIdentifier() const;
    ::zserio::vector<::nds::core::geometry::GeometryId>& getIdentifier();
    void setIdentifier(const ::zserio::vector<::nds::core::geometry::GeometryId>& identifier_);
    void setIdentifier(::zserio::vector<::nds::core::geometry::GeometryId>&& identifier_);
    bool isIdentifierUsed() const;
    bool isIdentifierSet() const;
    void resetIdentifier();

    const ::zserio::vector<::nds::localization::types::ObstacleType>& getTypes() const;
    ::zserio::vector<::nds::localization::types::ObstacleType>& getTypes();
    void setTypes(const ::zserio::vector<::nds::localization::types::ObstacleType>& types_);
    void setTypes(::zserio::vector<::nds::localization::types::ObstacleType>&& types_);
    ...
    bool operator==(const ObstacleGeometryLayer& other) const;
...
private:
    ...
    {
    public:
        using OwnerType = ObstacleGeometryLayer;

        static void create(ObstacleGeometryLayer& owner,
                ::zserio::vector<::nds::core::geometry::GeometryId>& array,
                ::zserio::BitStreamReader& in, size_t index);
    };

    using ZserioArrayType_identifier = ::zserio::Array<::zserio::vector<::nds::core::geometry::GeometryId>, ::zserio::ObjectArrayTraits<::nds::core::geometry::GeometryId, ZserioElementFactory_identifier>, ::zserio::ArrayType::NORMAL>;
    using ZserioArrayType_types = ::zserio::Array<::zserio::vector<::nds::localization::types::ObstacleType>, ::zserio::EnumArrayTraits<::nds::localization::types::ObstacleType>, ::zserio::ArrayType::NORMAL>;
...
#endif // NDS_LOCALIZATION_INSTANTIATIONS_OBSTACLE_GEOMETRY_LAYER_H
