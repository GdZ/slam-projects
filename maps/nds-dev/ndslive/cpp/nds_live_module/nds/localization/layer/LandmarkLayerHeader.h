...
#ifndef NDS_LOCALIZATION_LAYER_LANDMARK_LAYER_HEADER_H
#define NDS_LOCALIZATION_LAYER_LANDMARK_LAYER_HEADER_H
...
public:
    ...
    LandmarkLayerHeader() noexcept :
            LandmarkLayerHeader(allocator_type())
    {}

    explicit LandmarkLayerHeader(const allocator_type& allocator) noexcept;
    ...
    template <typename ZSERIO_T_availableLineTypes = ::zserio::vector<::nds::localization::types::LandmarkLineType>,
            ...
            ::zserio::is_field_constructor_enabled_t<ZSERIO_T_availableLineTypes, LandmarkLayerHeader, allocator_type> = 0>
    LandmarkLayerHeader(
    ...
    explicit LandmarkLayerHeader(::zserio::BitStreamReader& in, const allocator_type& allocator = allocator_type());
    explicit LandmarkLayerHeader(ZserioPackingContext& context,
            ::zserio::BitStreamReader& in, const allocator_type& allocator = allocator_type());

    ~LandmarkLayerHeader() = default;

    LandmarkLayerHeader(const LandmarkLayerHeader&) = default;
    LandmarkLayerHeader& operator=(const LandmarkLayerHeader&) = default;

    LandmarkLayerHeader(LandmarkLayerHeader&&) = default;
    LandmarkLayerHeader& operator=(LandmarkLayerHeader&&) = default;

    LandmarkLayerHeader(::zserio::PropagateAllocatorT,
    ...
    bool operator==(const LandmarkLayerHeader& other) const;
...
#endif // NDS_LOCALIZATION_LAYER_LANDMARK_LAYER_HEADER_H
