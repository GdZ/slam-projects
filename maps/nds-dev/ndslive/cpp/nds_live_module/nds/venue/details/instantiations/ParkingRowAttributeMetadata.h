...
#ifndef NDS_VENUE_DETAILS_INSTANTIATIONS_PARKING_ROW_ATTRIBUTE_METADATA_H
#define NDS_VENUE_DETAILS_INSTANTIATIONS_PARKING_ROW_ATTRIBUTE_METADATA_H
...
public:
    ...
    ParkingRowAttributeMetadata() noexcept :
            ParkingRowAttributeMetadata(allocator_type())
    {}

    explicit ParkingRowAttributeMetadata(const allocator_type& allocator) noexcept;

    template <typename ZSERIO_T_availableAttributes = ::zserio::vector<::nds::venue::details::attributes::ParkingRowAttributeType>,
            ...
            ::zserio::is_field_constructor_enabled_t<ZSERIO_T_availableAttributes, ParkingRowAttributeMetadata, allocator_type> = 0>
    ParkingRowAttributeMetadata(
            ...
            ParkingRowAttributeMetadata(allocator)
    {
    ...
    explicit ParkingRowAttributeMetadata(::zserio::BitStreamReader& in, const allocator_type& allocator = allocator_type());
    explicit ParkingRowAttributeMetadata(ZserioPackingContext& context,
            ::zserio::BitStreamReader& in, const allocator_type& allocator = allocator_type());

    ~ParkingRowAttributeMetadata() = default;

    ParkingRowAttributeMetadata(const ParkingRowAttributeMetadata&) = default;
    ParkingRowAttributeMetadata& operator=(const ParkingRowAttributeMetadata&) = default;

    ParkingRowAttributeMetadata(ParkingRowAttributeMetadata&&) = default;
    ParkingRowAttributeMetadata& operator=(ParkingRowAttributeMetadata&&) = default;

    ParkingRowAttributeMetadata(::zserio::PropagateAllocatorT,
            const ParkingRowAttributeMetadata& other, const allocator_type& allocator);

    const ::zserio::vector<::nds::venue::details::attributes::ParkingRowAttributeType>& getAvailableAttributes() const;
    ::zserio::vector<::nds::venue::details::attributes::ParkingRowAttributeType>& getAvailableAttributes();
    void setAvailableAttributes(const ::zserio::vector<::nds::venue::details::attributes::ParkingRowAttributeType>& availableAttributes_);
    void setAvailableAttributes(::zserio::vector<::nds::venue::details::attributes::ParkingRowAttributeType>&& availableAttributes_);
    ...
    bool operator==(const ParkingRowAttributeMetadata& other) const;
...
private:
    ...
    {
    public:
        using OwnerType = ParkingRowAttributeMetadata;

        static void create(ParkingRowAttributeMetadata& owner,
    ...
    using ZserioArrayType_availableAttributes = ::zserio::Array<::zserio::vector<::nds::venue::details::attributes::ParkingRowAttributeType>, ::zserio::EnumArrayTraits<::nds::venue::details::attributes::ParkingRowAttributeType>, ::zserio::ArrayType::AUTO>;
...
#endif // NDS_VENUE_DETAILS_INSTANTIATIONS_PARKING_ROW_ATTRIBUTE_METADATA_H
