...
#ifndef NDS_VENUE_DETAILS_INSTANTIATIONS_PARKING_ROW_ATTRIBUTE_MAP_H
#define NDS_VENUE_DETAILS_INSTANTIATIONS_PARKING_ROW_ATTRIBUTE_MAP_H
...
public:
    ...
    ParkingRowAttributeMap() noexcept :
            ParkingRowAttributeMap(allocator_type())
    {}

    explicit ParkingRowAttributeMap(const allocator_type& allocator) noexcept;

    template <typename ZSERIO_T_featureReferences = ::zserio::vector<::nds::venue::reference::types::ParkingRowId>,
            ...
            typename ZSERIO_T_attributeValues = ::zserio::vector<::nds::venue::details::instantiations::ParkingRowAttribute>,
    ...
    ParkingRowAttributeMap(
            ...
            ParkingRowAttributeMap(allocator)
    {
    ...
    explicit ParkingRowAttributeMap(::zserio::BitStreamReader& in,
            ::nds::core::geometry::CoordShift coordShift_, const allocator_type& allocator = allocator_type());
    explicit ParkingRowAttributeMap(ZserioPackingContext& context,
            ::zserio::BitStreamReader& in,
            ::nds::core::geometry::CoordShift coordShift_, const allocator_type& allocator = allocator_type());

    ~ParkingRowAttributeMap() = default;

    ParkingRowAttributeMap(const ParkingRowAttributeMap& other);
    ParkingRowAttributeMap& operator=(const ParkingRowAttributeMap& other);

    ParkingRowAttributeMap(ParkingRowAttributeMap&& other);
    ParkingRowAttributeMap& operator=(ParkingRowAttributeMap&& other);

    ParkingRowAttributeMap(::zserio::PropagateAllocatorT,
    ...
    const ::zserio::vector<::nds::venue::reference::types::ParkingRowId>& getFeatureReferences() const;
    ::zserio::vector<::nds::venue::reference::types::ParkingRowId>& getFeatureReferences();
    void setFeatureReferences(const ::zserio::vector<::nds::venue::reference::types::ParkingRowId>& featureReferences_);
    void setFeatureReferences(::zserio::vector<::nds::venue::reference::types::ParkingRowId>&& featureReferences_);
    ...
    const ::zserio::vector<::nds::venue::details::instantiations::ParkingRowAttribute>& getAttributeValues() const;
    ::zserio::vector<::nds::venue::details::instantiations::ParkingRowAttribute>& getAttributeValues();
    void setAttributeValues(const ::zserio::vector<::nds::venue::details::instantiations::ParkingRowAttribute>& attributeValues_);
    void setAttributeValues(::zserio::vector<::nds::venue::details::instantiations::ParkingRowAttribute>&& attributeValues_);
    ...
    bool operator==(const ParkingRowAttributeMap& other) const;
...
private:
    ...
    {
    public:
        using OwnerType = ParkingRowAttributeMap;

        static void create(ParkingRowAttributeMap& owner,
    ...
    public:
        ...
        static void initializeElement(ParkingRowAttributeMap& owner,
    ...
    public:
        ...
        static void initializeElement(ParkingRowAttributeMap& owner,
                ::nds::venue::details::instantiations::ParkingRowAttribute& element, size_t index);
    };
    ...
    public:
        ...
        static void create(ParkingRowAttributeMap& owner,
                ::zserio::vector<::nds::venue::details::instantiations::ParkingRowAttribute>& array,
                ::nds::venue::details::instantiations::ParkingRowAttribute::ZserioPackingContext& context,
                ::zserio::BitStreamReader& in, size_t index);
    };
    ...
    using ZserioArrayType_featureReferences = ::zserio::Array<::zserio::vector<::nds::venue::reference::types::ParkingRowId>, ::zserio::ObjectArrayTraits<::nds::venue::reference::types::ParkingRowId, ZserioElementFactory_featureReferences>, ::zserio::ArrayType::NORMAL>;
    ...
    using ZserioArrayType_attributeValues = ::zserio::Array<::zserio::vector<::nds::venue::details::instantiations::ParkingRowAttribute>, ::zserio::ObjectArrayTraits<::nds::venue::details::instantiations::ParkingRowAttribute, ZserioElementFactory_attributeValues>, ::zserio::ArrayType::NORMAL, ZserioArrayExpressions_attributeValues>;
...
#endif // NDS_VENUE_DETAILS_INSTANTIATIONS_PARKING_ROW_ATTRIBUTE_MAP_H
