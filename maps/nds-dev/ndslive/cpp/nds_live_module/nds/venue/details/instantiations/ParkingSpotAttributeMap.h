...
#ifndef NDS_VENUE_DETAILS_INSTANTIATIONS_PARKING_SPOT_ATTRIBUTE_MAP_H
#define NDS_VENUE_DETAILS_INSTANTIATIONS_PARKING_SPOT_ATTRIBUTE_MAP_H
...
public:
    ...
    ParkingSpotAttributeMap() noexcept :
            ParkingSpotAttributeMap(allocator_type())
    {}

    explicit ParkingSpotAttributeMap(const allocator_type& allocator) noexcept;

    template <typename ZSERIO_T_featureReferences = ::zserio::vector<::nds::venue::reference::types::ParkingSpotId>,
            ...
            typename ZSERIO_T_attributeValues = ::zserio::vector<::nds::venue::details::instantiations::ParkingSpotAttribute>,
    ...
    ParkingSpotAttributeMap(
            ...
            ParkingSpotAttributeMap(allocator)
    {
    ...
    explicit ParkingSpotAttributeMap(::zserio::BitStreamReader& in,
            ::nds::core::geometry::CoordShift coordShift_, const allocator_type& allocator = allocator_type());
    explicit ParkingSpotAttributeMap(ZserioPackingContext& context,
            ::zserio::BitStreamReader& in,
            ::nds::core::geometry::CoordShift coordShift_, const allocator_type& allocator = allocator_type());

    ~ParkingSpotAttributeMap() = default;

    ParkingSpotAttributeMap(const ParkingSpotAttributeMap& other);
    ParkingSpotAttributeMap& operator=(const ParkingSpotAttributeMap& other);

    ParkingSpotAttributeMap(ParkingSpotAttributeMap&& other);
    ParkingSpotAttributeMap& operator=(ParkingSpotAttributeMap&& other);

    ParkingSpotAttributeMap(::zserio::PropagateAllocatorT,
    ...
    const ::zserio::vector<::nds::venue::reference::types::ParkingSpotId>& getFeatureReferences() const;
    ::zserio::vector<::nds::venue::reference::types::ParkingSpotId>& getFeatureReferences();
    void setFeatureReferences(const ::zserio::vector<::nds::venue::reference::types::ParkingSpotId>& featureReferences_);
    void setFeatureReferences(::zserio::vector<::nds::venue::reference::types::ParkingSpotId>&& featureReferences_);
    ...
    const ::zserio::vector<::nds::venue::details::instantiations::ParkingSpotAttribute>& getAttributeValues() const;
    ::zserio::vector<::nds::venue::details::instantiations::ParkingSpotAttribute>& getAttributeValues();
    void setAttributeValues(const ::zserio::vector<::nds::venue::details::instantiations::ParkingSpotAttribute>& attributeValues_);
    void setAttributeValues(::zserio::vector<::nds::venue::details::instantiations::ParkingSpotAttribute>&& attributeValues_);
    ...
    bool operator==(const ParkingSpotAttributeMap& other) const;
...
private:
    ...
    {
    public:
        using OwnerType = ParkingSpotAttributeMap;

        static void create(ParkingSpotAttributeMap& owner,
                ::zserio::vector<::nds::venue::reference::types::ParkingSpotId>& array,
                ::zserio::BitStreamReader& in, size_t index);

        static void create(ParkingSpotAttributeMap& owner,
                ::zserio::vector<::nds::venue::reference::types::ParkingSpotId>& array,
                ::nds::venue::reference::types::ParkingSpotId::ZserioPackingContext& context,
                ::zserio::BitStreamReader& in, size_t index);
    };
    ...
    public:
        ...
        static void initializeElement(ParkingSpotAttributeMap& owner,
    ...
    public:
        ...
        static void initializeElement(ParkingSpotAttributeMap& owner,
                ::nds::venue::details::instantiations::ParkingSpotAttribute& element, size_t index);
    };
    ...
    public:
        ...
        static void create(ParkingSpotAttributeMap& owner,
                ::zserio::vector<::nds::venue::details::instantiations::ParkingSpotAttribute>& array,
                ::nds::venue::details::instantiations::ParkingSpotAttribute::ZserioPackingContext& context,
                ::zserio::BitStreamReader& in, size_t index);
    };
    ...
    using ZserioArrayType_featureReferences = ::zserio::Array<::zserio::vector<::nds::venue::reference::types::ParkingSpotId>, ::zserio::ObjectArrayTraits<::nds::venue::reference::types::ParkingSpotId, ZserioElementFactory_featureReferences>, ::zserio::ArrayType::NORMAL>;
    ...
    using ZserioArrayType_attributeValues = ::zserio::Array<::zserio::vector<::nds::venue::details::instantiations::ParkingSpotAttribute>, ::zserio::ObjectArrayTraits<::nds::venue::details::instantiations::ParkingSpotAttribute, ZserioElementFactory_attributeValues>, ::zserio::ArrayType::NORMAL, ZserioArrayExpressions_attributeValues>;
...
#endif // NDS_VENUE_DETAILS_INSTANTIATIONS_PARKING_SPOT_ATTRIBUTE_MAP_H
