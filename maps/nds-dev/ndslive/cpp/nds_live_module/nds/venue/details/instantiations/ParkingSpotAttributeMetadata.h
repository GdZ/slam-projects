...
#ifndef NDS_VENUE_DETAILS_INSTANTIATIONS_PARKING_SPOT_ATTRIBUTE_METADATA_H
#define NDS_VENUE_DETAILS_INSTANTIATIONS_PARKING_SPOT_ATTRIBUTE_METADATA_H
...
public:
    ...
    ParkingSpotAttributeMetadata() noexcept :
            ParkingSpotAttributeMetadata(allocator_type())
    {}

    explicit ParkingSpotAttributeMetadata(const allocator_type& allocator) noexcept;

    template <typename ZSERIO_T_availableAttributes = ::zserio::vector<::nds::venue::details::attributes::ParkingSpotAttributeType>,
            ...
            ::zserio::is_field_constructor_enabled_t<ZSERIO_T_availableAttributes, ParkingSpotAttributeMetadata, allocator_type> = 0>
    ParkingSpotAttributeMetadata(
            ...
            ParkingSpotAttributeMetadata(allocator)
    {
    ...
    explicit ParkingSpotAttributeMetadata(::zserio::BitStreamReader& in, const allocator_type& allocator = allocator_type());
    explicit ParkingSpotAttributeMetadata(ZserioPackingContext& context,
            ::zserio::BitStreamReader& in, const allocator_type& allocator = allocator_type());

    ~ParkingSpotAttributeMetadata() = default;

    ParkingSpotAttributeMetadata(const ParkingSpotAttributeMetadata&) = default;
    ParkingSpotAttributeMetadata& operator=(const ParkingSpotAttributeMetadata&) = default;

    ParkingSpotAttributeMetadata(ParkingSpotAttributeMetadata&&) = default;
    ParkingSpotAttributeMetadata& operator=(ParkingSpotAttributeMetadata&&) = default;

    ParkingSpotAttributeMetadata(::zserio::PropagateAllocatorT,
            const ParkingSpotAttributeMetadata& other, const allocator_type& allocator);

    const ::zserio::vector<::nds::venue::details::attributes::ParkingSpotAttributeType>& getAvailableAttributes() const;
    ::zserio::vector<::nds::venue::details::attributes::ParkingSpotAttributeType>& getAvailableAttributes();
    void setAvailableAttributes(const ::zserio::vector<::nds::venue::details::attributes::ParkingSpotAttributeType>& availableAttributes_);
    void setAvailableAttributes(::zserio::vector<::nds::venue::details::attributes::ParkingSpotAttributeType>&& availableAttributes_);
    ...
    bool operator==(const ParkingSpotAttributeMetadata& other) const;
...
private:
    ...
    {
    public:
        using OwnerType = ParkingSpotAttributeMetadata;

        static void create(ParkingSpotAttributeMetadata& owner,
    ...
    using ZserioArrayType_availableAttributes = ::zserio::Array<::zserio::vector<::nds::venue::details::attributes::ParkingSpotAttributeType>, ::zserio::EnumArrayTraits<::nds::venue::details::attributes::ParkingSpotAttributeType>, ::zserio::ArrayType::AUTO>;
...
#endif // NDS_VENUE_DETAILS_INSTANTIATIONS_PARKING_SPOT_ATTRIBUTE_METADATA_H
