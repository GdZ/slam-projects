...
#ifndef NDS_VENUE_DETAILS_INSTANTIATIONS_PARKING_SECTION_ATTRIBUTE_METADATA_H
#define NDS_VENUE_DETAILS_INSTANTIATIONS_PARKING_SECTION_ATTRIBUTE_METADATA_H
...
public:
    ...
    ParkingSectionAttributeMetadata() noexcept :
            ParkingSectionAttributeMetadata(allocator_type())
    {}

    explicit ParkingSectionAttributeMetadata(const allocator_type& allocator) noexcept;

    template <typename ZSERIO_T_availableAttributes = ::zserio::vector<::nds::venue::details::attributes::ParkingSectionAttributeType>,
            ...
            ::zserio::is_field_constructor_enabled_t<ZSERIO_T_availableAttributes, ParkingSectionAttributeMetadata, allocator_type> = 0>
    ParkingSectionAttributeMetadata(
            ...
            ParkingSectionAttributeMetadata(allocator)
    {
    ...
    explicit ParkingSectionAttributeMetadata(::zserio::BitStreamReader& in, const allocator_type& allocator = allocator_type());
    explicit ParkingSectionAttributeMetadata(ZserioPackingContext& context,
            ::zserio::BitStreamReader& in, const allocator_type& allocator = allocator_type());

    ~ParkingSectionAttributeMetadata() = default;

    ParkingSectionAttributeMetadata(const ParkingSectionAttributeMetadata&) = default;
    ParkingSectionAttributeMetadata& operator=(const ParkingSectionAttributeMetadata&) = default;

    ParkingSectionAttributeMetadata(ParkingSectionAttributeMetadata&&) = default;
    ParkingSectionAttributeMetadata& operator=(ParkingSectionAttributeMetadata&&) = default;

    ParkingSectionAttributeMetadata(::zserio::PropagateAllocatorT,
            const ParkingSectionAttributeMetadata& other, const allocator_type& allocator);

    const ::zserio::vector<::nds::venue::details::attributes::ParkingSectionAttributeType>& getAvailableAttributes() const;
    ::zserio::vector<::nds::venue::details::attributes::ParkingSectionAttributeType>& getAvailableAttributes();
    void setAvailableAttributes(const ::zserio::vector<::nds::venue::details::attributes::ParkingSectionAttributeType>& availableAttributes_);
    void setAvailableAttributes(::zserio::vector<::nds::venue::details::attributes::ParkingSectionAttributeType>&& availableAttributes_);
    ...
    bool operator==(const ParkingSectionAttributeMetadata& other) const;
...
private:
    ...
    {
    public:
        using OwnerType = ParkingSectionAttributeMetadata;

        static void create(ParkingSectionAttributeMetadata& owner,
    ...
    using ZserioArrayType_availableAttributes = ::zserio::Array<::zserio::vector<::nds::venue::details::attributes::ParkingSectionAttributeType>, ::zserio::EnumArrayTraits<::nds::venue::details::attributes::ParkingSectionAttributeType>, ::zserio::ArrayType::AUTO>;
...
#endif // NDS_VENUE_DETAILS_INSTANTIATIONS_PARKING_SECTION_ATTRIBUTE_METADATA_H
