...
#ifndef NDS_VENUE_INSTANTIATIONS_PARKING_ROAD_SURFACE_RELATION_MAP_H
#define NDS_VENUE_INSTANTIATIONS_PARKING_ROAD_SURFACE_RELATION_MAP_H
...
class ParkingRoadSurfaceRelationMap
{
public:
    ...
    ParkingRoadSurfaceRelationMap() noexcept :
            ParkingRoadSurfaceRelationMap(allocator_type())
    {}

    explicit ParkingRoadSurfaceRelationMap(const allocator_type& allocator) noexcept;
    ...
    template <typename ZSERIO_T_featureReferences = ::zserio::vector<::nds::lane::reference::types::RoadSurfaceId>,
            ...
            typename ZSERIO_T_attributeValues = ::zserio::vector<::nds::venue::instantiations::ParkingRelation>,
    ...
    ParkingRoadSurfaceRelationMap(
            ...
            ParkingRoadSurfaceRelationMap(allocator)
    {
    ...
    explicit ParkingRoadSurfaceRelationMap(::zserio::BitStreamReader& in,
            ::nds::core::geometry::CoordShift coordShift_, const allocator_type& allocator = allocator_type());
    explicit ParkingRoadSurfaceRelationMap(ZserioPackingContext& context,
            ::zserio::BitStreamReader& in,
            ::nds::core::geometry::CoordShift coordShift_, const allocator_type& allocator = allocator_type());

    ~ParkingRoadSurfaceRelationMap() = default;

    ParkingRoadSurfaceRelationMap(const ParkingRoadSurfaceRelationMap& other);
    ParkingRoadSurfaceRelationMap& operator=(const ParkingRoadSurfaceRelationMap& other);

    ParkingRoadSurfaceRelationMap(ParkingRoadSurfaceRelationMap&& other);
    ParkingRoadSurfaceRelationMap& operator=(ParkingRoadSurfaceRelationMap&& other);

    ParkingRoadSurfaceRelationMap(::zserio::PropagateAllocatorT,
    ...
    void setAttributeTypeCode(::nds::venue::parking::ParkingRelationType attributeTypeCode_);
    ...
    const ::zserio::vector<::nds::venue::instantiations::ParkingRelation>& getAttributeValues() const;
    ::zserio::vector<::nds::venue::instantiations::ParkingRelation>& getAttributeValues();
    void setAttributeValues(const ::zserio::vector<::nds::venue::instantiations::ParkingRelation>& attributeValues_);
    void setAttributeValues(::zserio::vector<::nds::venue::instantiations::ParkingRelation>&& attributeValues_);
    ...
    bool operator==(const ParkingRoadSurfaceRelationMap& other) const;
...
private:
    ...
    {
    public:
        using OwnerType = ParkingRoadSurfaceRelationMap;

        static void create(ParkingRoadSurfaceRelationMap& owner,
    ...
    public:
        ...
        static void initializeElement(ParkingRoadSurfaceRelationMap& owner,
    ...
    public:
        ...
        static void initializeElement(ParkingRoadSurfaceRelationMap& owner,
                ::nds::venue::instantiations::ParkingRelation& element, size_t index);
    };
    ...
    public:
        ...
        static void create(ParkingRoadSurfaceRelationMap& owner,
                ::zserio::vector<::nds::venue::instantiations::ParkingRelation>& array,
                ::nds::venue::instantiations::ParkingRelation::ZserioPackingContext& context,
                ::zserio::BitStreamReader& in, size_t index);
    };
    ...
    using ZserioArrayType_attributeValues = ::zserio::Array<::zserio::vector<::nds::venue::instantiations::ParkingRelation>, ::zserio::ObjectArrayTraits<::nds::venue::instantiations::ParkingRelation, ZserioElementFactory_attributeValues>, ::zserio::ArrayType::NORMAL, ZserioArrayExpressions_attributeValues>;
    ...
    ::nds::venue::parking::ParkingRelationType readAttributeTypeCode(::zserio::BitStreamReader& in);
    ::nds::venue::parking::ParkingRelationType readAttributeTypeCode(ZserioPackingContext& context,
            ::zserio::BitStreamReader& in);
...
#endif // NDS_VENUE_INSTANTIATIONS_PARKING_ROAD_SURFACE_RELATION_MAP_H
