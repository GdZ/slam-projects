...
#ifndef NDS_VENUE_INSTANTIATIONS_PARKING_RELATION_MAP_LIST_HEADER_H
#define NDS_VENUE_INSTANTIATIONS_PARKING_RELATION_MAP_LIST_HEADER_H
...
class ParkingRelationMapListHeader
{
public:
    ...
    ParkingRelationMapListHeader() noexcept :
            ParkingRelationMapListHeader(allocator_type())
    {}

    explicit ParkingRelationMapListHeader(const allocator_type& allocator) noexcept;

    template <typename ZSERIO_T_attributeTypeCode = ::zserio::vector<::nds::venue::parking::ParkingRelationType>,
            typename ZSERIO_T_conditionType = ::zserio::vector<::nds::core::attributemap::ConditionTypeCodeCollection>,
            ::zserio::is_field_constructor_enabled_t<ZSERIO_T_attributeTypeCode, ParkingRelationMapListHeader, allocator_type> = 0>
    ParkingRelationMapListHeader(
            ZSERIO_T_attributeTypeCode&& attributeTypeCode_,
            ZSERIO_T_conditionType&& conditionType_,
            const allocator_type& allocator = allocator_type()) :
            ParkingRelationMapListHeader(allocator)
    {
    ...
    explicit ParkingRelationMapListHeader(::zserio::BitStreamReader& in,
            uint16_t numMaps_, const allocator_type& allocator = allocator_type());
    explicit ParkingRelationMapListHeader(ZserioPackingContext& context,
            ::zserio::BitStreamReader& in,
            uint16_t numMaps_, const allocator_type& allocator = allocator_type());

    ~ParkingRelationMapListHeader() = default;

    ParkingRelationMapListHeader(const ParkingRelationMapListHeader& other);
    ParkingRelationMapListHeader& operator=(const ParkingRelationMapListHeader& other);

    ParkingRelationMapListHeader(ParkingRelationMapListHeader&& other);
    ParkingRelationMapListHeader& operator=(ParkingRelationMapListHeader&& other);

    ParkingRelationMapListHeader(::zserio::PropagateAllocatorT,
    ...
    const ::zserio::vector<::nds::venue::parking::ParkingRelationType>& getAttributeTypeCode() const;
    ::zserio::vector<::nds::venue::parking::ParkingRelationType>& getAttributeTypeCode();
    void setAttributeTypeCode(const ::zserio::vector<::nds::venue::parking::ParkingRelationType>& attributeTypeCode_);
    void setAttributeTypeCode(::zserio::vector<::nds::venue::parking::ParkingRelationType>&& attributeTypeCode_);
    ...
    bool operator==(const ParkingRelationMapListHeader& other) const;
...
private:
    ...
    {
    public:
        using OwnerType = ParkingRelationMapListHeader;

        static void create(ParkingRelationMapListHeader& owner,
    ...
    using ZserioArrayType_attributeTypeCode = ::zserio::Array<::zserio::vector<::nds::venue::parking::ParkingRelationType>, ::zserio::EnumArrayTraits<::nds::venue::parking::ParkingRelationType>, ::zserio::ArrayType::NORMAL>;
...
#endif // NDS_VENUE_INSTANTIATIONS_PARKING_RELATION_MAP_LIST_HEADER_H
