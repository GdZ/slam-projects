...
#ifndef NDS_VENUE_INSTANTIATIONS_PARKING_LANE_POSITION_RELATION_MAP_H
#define NDS_VENUE_INSTANTIATIONS_PARKING_LANE_POSITION_RELATION_MAP_H
...
public:
    ...
    ParkingLanePositionRelationMap() noexcept :
            ParkingLanePositionRelationMap(allocator_type())
    {}

    explicit ParkingLanePositionRelationMap(const allocator_type& allocator) noexcept;
    ...
    template <typename ZSERIO_T_featureReferences = ::zserio::vector<::nds::lane::reference::types::LaneGroupId>,
            ...
            typename ZSERIO_T_attributeValues = ::zserio::vector<::nds::venue::instantiations::ParkingPositionRelation>,
    ...
    ParkingLanePositionRelationMap(
            ...
            ParkingLanePositionRelationMap(allocator)
    {
    ...
    explicit ParkingLanePositionRelationMap(::zserio::BitStreamReader& in,
            ::nds::core::geometry::CoordShift coordShift_, const allocator_type& allocator = allocator_type());
    explicit ParkingLanePositionRelationMap(ZserioPackingContext& context,
            ::zserio::BitStreamReader& in,
            ::nds::core::geometry::CoordShift coordShift_, const allocator_type& allocator = allocator_type());

    ~ParkingLanePositionRelationMap() = default;

    ParkingLanePositionRelationMap(const ParkingLanePositionRelationMap& other);
    ParkingLanePositionRelationMap& operator=(const ParkingLanePositionRelationMap& other);

    ParkingLanePositionRelationMap(ParkingLanePositionRelationMap&& other);
    ParkingLanePositionRelationMap& operator=(ParkingLanePositionRelationMap&& other);

    ParkingLanePositionRelationMap(::zserio::PropagateAllocatorT,
    ...
    void setAttributeTypeCode(::nds::venue::parking::ParkingPositionRelationType attributeTypeCode_);
    ...
    const ::zserio::vector<::nds::venue::instantiations::ParkingPositionRelation>& getAttributeValues() const;
    ::zserio::vector<::nds::venue::instantiations::ParkingPositionRelation>& getAttributeValues();
    void setAttributeValues(const ::zserio::vector<::nds::venue::instantiations::ParkingPositionRelation>& attributeValues_);
    void setAttributeValues(::zserio::vector<::nds::venue::instantiations::ParkingPositionRelation>&& attributeValues_);
    ...
    bool operator==(const ParkingLanePositionRelationMap& other) const;
...
private:
    ...
    {
    public:
        using OwnerType = ParkingLanePositionRelationMap;

        static void create(ParkingLanePositionRelationMap& owner,
    ...
    public:
        ...
        static void initializeElement(ParkingLanePositionRelationMap& owner,
    ...
    public:
        ...
        static void initializeElement(ParkingLanePositionRelationMap& owner,
                ::nds::venue::instantiations::ParkingPositionRelation& element, size_t index);
    };
    ...
    public:
        ...
        static void create(ParkingLanePositionRelationMap& owner,
                ::zserio::vector<::nds::venue::instantiations::ParkingPositionRelation>& array,
                ::nds::venue::instantiations::ParkingPositionRelation::ZserioPackingContext& context,
                ::zserio::BitStreamReader& in, size_t index);
    };
    ...
    using ZserioArrayType_attributeValues = ::zserio::Array<::zserio::vector<::nds::venue::instantiations::ParkingPositionRelation>, ::zserio::ObjectArrayTraits<::nds::venue::instantiations::ParkingPositionRelation, ZserioElementFactory_attributeValues>, ::zserio::ArrayType::NORMAL, ZserioArrayExpressions_attributeValues>;
    ...
    ::nds::venue::parking::ParkingPositionRelationType readAttributeTypeCode(::zserio::BitStreamReader& in);
    ::nds::venue::parking::ParkingPositionRelationType readAttributeTypeCode(ZserioPackingContext& context,
            ::zserio::BitStreamReader& in);
...
#endif // NDS_VENUE_INSTANTIATIONS_PARKING_LANE_POSITION_RELATION_MAP_H
