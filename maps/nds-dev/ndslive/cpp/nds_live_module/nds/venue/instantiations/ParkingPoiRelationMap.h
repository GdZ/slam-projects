...
#ifndef NDS_VENUE_INSTANTIATIONS_PARKING_POI_RELATION_MAP_H
#define NDS_VENUE_INSTANTIATIONS_PARKING_POI_RELATION_MAP_H
...
public:
    ...
    ParkingPoiRelationMap() noexcept :
            ParkingPoiRelationMap(allocator_type())
    {}

    explicit ParkingPoiRelationMap(const allocator_type& allocator) noexcept;

    template <typename ZSERIO_T_featureReferences = ::zserio::vector<::nds::poi::reference::types::PoiId>,
    ...
    ParkingPoiRelationMap(
            ...
            ParkingPoiRelationMap(allocator)
    {
    ...
    explicit ParkingPoiRelationMap(::zserio::BitStreamReader& in,
            ::nds::core::geometry::CoordShift coordShift_, const allocator_type& allocator = allocator_type());
    explicit ParkingPoiRelationMap(ZserioPackingContext& context,
            ::zserio::BitStreamReader& in,
            ::nds::core::geometry::CoordShift coordShift_, const allocator_type& allocator = allocator_type());

    ~ParkingPoiRelationMap() = default;

    ParkingPoiRelationMap(const ParkingPoiRelationMap& other);
    ParkingPoiRelationMap& operator=(const ParkingPoiRelationMap& other);

    ParkingPoiRelationMap(ParkingPoiRelationMap&& other);
    ParkingPoiRelationMap& operator=(ParkingPoiRelationMap&& other);

    ParkingPoiRelationMap(::zserio::PropagateAllocatorT,
    ...
    const ::zserio::vector<::nds::poi::reference::types::PoiId>& getFeatureReferences() const;
    ::zserio::vector<::nds::poi::reference::types::PoiId>& getFeatureReferences();
    void setFeatureReferences(const ::zserio::vector<::nds::poi::reference::types::PoiId>& featureReferences_);
    void setFeatureReferences(::zserio::vector<::nds::poi::reference::types::PoiId>&& featureReferences_);
    ...
    bool operator==(const ParkingPoiRelationMap& other) const;
...
private:
    ...
    {
    public:
        using OwnerType = ParkingPoiRelationMap;

        static void initializeElement(ParkingPoiRelationMap& owner,
    ...
    public:
        ...
        static void create(ParkingPoiRelationMap& owner,
    ...
    using ZserioArrayType_featureReferences = ::zserio::Array<::zserio::vector<::nds::poi::reference::types::PoiId>, ::zserio::VarIntNNArrayTraits<::nds::poi::reference::types::PoiId>, ::zserio::ArrayType::NORMAL>;
...
#endif // NDS_VENUE_INSTANTIATIONS_PARKING_POI_RELATION_MAP_H
