...
#ifndef NDS_INSTRUCTIONS_ATTRIBUTES_INSTRUCTIONS_LANE_TRANSITION_ATTRIBUTE_VALUE_H
#define NDS_INSTRUCTIONS_ATTRIBUTES_INSTRUCTIONS_LANE_TRANSITION_ATTRIBUTE_VALUE_H
...
public:
    ...
    InstructionsLaneTransitionAttributeValue() noexcept :
            InstructionsLaneTransitionAttributeValue(allocator_type())
    {}

    explicit InstructionsLaneTransitionAttributeValue(const allocator_type& allocator) noexcept;

    explicit InstructionsLaneTransitionAttributeValue(::zserio::BitStreamReader& in,
            ::nds::instructions::attributes::InstructionsLaneTransitionAttributeType type_, const allocator_type& allocator = allocator_type());
    explicit InstructionsLaneTransitionAttributeValue(ZserioPackingContext& context,
            ::zserio::BitStreamReader& in,
            ::nds::instructions::attributes::InstructionsLaneTransitionAttributeType type_, const allocator_type& allocator = allocator_type());

    ~InstructionsLaneTransitionAttributeValue() = default;

    InstructionsLaneTransitionAttributeValue(const InstructionsLaneTransitionAttributeValue& other);
    InstructionsLaneTransitionAttributeValue& operator=(const InstructionsLaneTransitionAttributeValue& other);

    InstructionsLaneTransitionAttributeValue(InstructionsLaneTransitionAttributeValue&& other);
    InstructionsLaneTransitionAttributeValue& operator=(InstructionsLaneTransitionAttributeValue&& other);

    InstructionsLaneTransitionAttributeValue(::zserio::PropagateAllocatorT,
    ...
    ::nds::instructions::attributes::InstructionsLaneTransitionAttributeType getType() const;
    ...
    bool operator==(const InstructionsLaneTransitionAttributeValue& other) const;
...
private:
    ...
    ::nds::instructions::attributes::InstructionsLaneTransitionAttributeType m_type_;
...
#endif // NDS_INSTRUCTIONS_ATTRIBUTES_INSTRUCTIONS_LANE_TRANSITION_ATTRIBUTE_VALUE_H
