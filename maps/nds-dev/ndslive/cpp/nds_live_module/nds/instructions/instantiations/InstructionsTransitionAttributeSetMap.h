...
#ifndef NDS_INSTRUCTIONS_INSTANTIATIONS_INSTRUCTIONS_TRANSITION_ATTRIBUTE_SET_MAP_H
#define NDS_INSTRUCTIONS_INSTANTIATIONS_INSTRUCTIONS_TRANSITION_ATTRIBUTE_SET_MAP_H
...
class InstructionsTransitionAttributeSetMap
{
public:
    class ZserioPackingContext
    {
    public:
        ::nds::instructions::instantiations::InstructionsTransitionAttributeSet::ZserioPackingContext& getAttributeSet()
        {
    ...
    private:
        ::nds::instructions::instantiations::InstructionsTransitionAttributeSet::ZserioPackingContext m_attributeSet_;
        ::zserio::DeltaContext m_feature_;
    };

    using allocator_type = ::std::allocator<uint8_t>;

    InstructionsTransitionAttributeSetMap() noexcept :
            InstructionsTransitionAttributeSetMap(allocator_type())
    {}

    explicit InstructionsTransitionAttributeSetMap(const allocator_type& allocator) noexcept;

    template <typename ZSERIO_T_attributeSet = ::nds::instructions::instantiations::InstructionsTransitionAttributeSet,
            ...
            ::zserio::is_field_constructor_enabled_t<ZSERIO_T_attributeSet, InstructionsTransitionAttributeSetMap, allocator_type> = 0>
    InstructionsTransitionAttributeSetMap(
            ...
            InstructionsTransitionAttributeSetMap(allocator)
    {
    ...
    explicit InstructionsTransitionAttributeSetMap(::zserio::BitStreamReader& in,
            ::nds::core::geometry::CoordShift coordShift_, const allocator_type& allocator = allocator_type());
    explicit InstructionsTransitionAttributeSetMap(ZserioPackingContext& context,
            ::zserio::BitStreamReader& in,
            ::nds::core::geometry::CoordShift coordShift_, const allocator_type& allocator = allocator_type());

    ~InstructionsTransitionAttributeSetMap() = default;

    InstructionsTransitionAttributeSetMap(const InstructionsTransitionAttributeSetMap& other);
    InstructionsTransitionAttributeSetMap& operator=(const InstructionsTransitionAttributeSetMap& other);

    InstructionsTransitionAttributeSetMap(InstructionsTransitionAttributeSetMap&& other);
    InstructionsTransitionAttributeSetMap& operator=(InstructionsTransitionAttributeSetMap&& other);

    InstructionsTransitionAttributeSetMap(::zserio::PropagateAllocatorT,
    ...
    const ::nds::instructions::instantiations::InstructionsTransitionAttributeSet& getAttributeSet() const;
    ::nds::instructions::instantiations::InstructionsTransitionAttributeSet& getAttributeSet();
    void setAttributeSet(const ::nds::instructions::instantiations::InstructionsTransitionAttributeSet& attributeSet_);
    void setAttributeSet(::nds::instructions::instantiations::InstructionsTransitionAttributeSet&& attributeSet_);
    ...
    bool operator==(const InstructionsTransitionAttributeSetMap& other) const;
...
private:
    ...
    {
    public:
        using OwnerType = InstructionsTransitionAttributeSetMap;

        static void initializeElement(InstructionsTransitionAttributeSetMap& owner,
    ...
    public:
        ...
        static void create(InstructionsTransitionAttributeSetMap& owner,
    ...
    ::nds::instructions::instantiations::InstructionsTransitionAttributeSet readAttributeSet(::zserio::BitStreamReader& in,
            const allocator_type& allocator);
    ::nds::instructions::instantiations::InstructionsTransitionAttributeSet readAttributeSet(ZserioPackingContext& context,
    ...
    ::nds::instructions::instantiations::InstructionsTransitionAttributeSet m_attributeSet_;
...
#endif // NDS_INSTRUCTIONS_INSTANTIATIONS_INSTRUCTIONS_TRANSITION_ATTRIBUTE_SET_MAP_H
