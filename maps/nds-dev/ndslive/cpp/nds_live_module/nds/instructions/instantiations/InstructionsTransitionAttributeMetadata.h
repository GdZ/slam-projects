...
#ifndef NDS_INSTRUCTIONS_INSTANTIATIONS_INSTRUCTIONS_TRANSITION_ATTRIBUTE_METADATA_H
#define NDS_INSTRUCTIONS_INSTANTIATIONS_INSTRUCTIONS_TRANSITION_ATTRIBUTE_METADATA_H
...
public:
    ...
    InstructionsTransitionAttributeMetadata() noexcept :
            InstructionsTransitionAttributeMetadata(allocator_type())
    {}

    explicit InstructionsTransitionAttributeMetadata(const allocator_type& allocator) noexcept;

    template <typename ZSERIO_T_availableAttributes = ::zserio::vector<::nds::instructions::attributes::InstructionsTransitionAttributeType>,
            ...
            ::zserio::is_field_constructor_enabled_t<ZSERIO_T_availableAttributes, InstructionsTransitionAttributeMetadata, allocator_type> = 0>
    InstructionsTransitionAttributeMetadata(
            ...
            InstructionsTransitionAttributeMetadata(allocator)
    {
    ...
    explicit InstructionsTransitionAttributeMetadata(::zserio::BitStreamReader& in, const allocator_type& allocator = allocator_type());
    explicit InstructionsTransitionAttributeMetadata(ZserioPackingContext& context,
            ::zserio::BitStreamReader& in, const allocator_type& allocator = allocator_type());

    ~InstructionsTransitionAttributeMetadata() = default;

    InstructionsTransitionAttributeMetadata(const InstructionsTransitionAttributeMetadata&) = default;
    InstructionsTransitionAttributeMetadata& operator=(const InstructionsTransitionAttributeMetadata&) = default;

    InstructionsTransitionAttributeMetadata(InstructionsTransitionAttributeMetadata&&) = default;
    InstructionsTransitionAttributeMetadata& operator=(InstructionsTransitionAttributeMetadata&&) = default;

    InstructionsTransitionAttributeMetadata(::zserio::PropagateAllocatorT,
            const InstructionsTransitionAttributeMetadata& other, const allocator_type& allocator);

    const ::zserio::vector<::nds::instructions::attributes::InstructionsTransitionAttributeType>& getAvailableAttributes() const;
    ::zserio::vector<::nds::instructions::attributes::InstructionsTransitionAttributeType>& getAvailableAttributes();
    void setAvailableAttributes(const ::zserio::vector<::nds::instructions::attributes::InstructionsTransitionAttributeType>& availableAttributes_);
    void setAvailableAttributes(::zserio::vector<::nds::instructions::attributes::InstructionsTransitionAttributeType>&& availableAttributes_);
    ...
    bool operator==(const InstructionsTransitionAttributeMetadata& other) const;
...
private:
    ...
    {
    public:
        using OwnerType = InstructionsTransitionAttributeMetadata;

        static void create(InstructionsTransitionAttributeMetadata& owner,
    ...
    using ZserioArrayType_availableAttributes = ::zserio::Array<::zserio::vector<::nds::instructions::attributes::InstructionsTransitionAttributeType>, ::zserio::EnumArrayTraits<::nds::instructions::attributes::InstructionsTransitionAttributeType>, ::zserio::ArrayType::AUTO>;
...
#endif // NDS_INSTRUCTIONS_INSTANTIATIONS_INSTRUCTIONS_TRANSITION_ATTRIBUTE_METADATA_H
