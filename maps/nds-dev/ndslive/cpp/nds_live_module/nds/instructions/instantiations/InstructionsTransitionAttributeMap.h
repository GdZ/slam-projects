...
#ifndef NDS_INSTRUCTIONS_INSTANTIATIONS_INSTRUCTIONS_TRANSITION_ATTRIBUTE_MAP_H
#define NDS_INSTRUCTIONS_INSTANTIATIONS_INSTRUCTIONS_TRANSITION_ATTRIBUTE_MAP_H
...
public:
    ...
    InstructionsTransitionAttributeMap() noexcept :
            InstructionsTransitionAttributeMap(allocator_type())
    {}

    explicit InstructionsTransitionAttributeMap(const allocator_type& allocator) noexcept;
    ...
    template <typename ZSERIO_T_featureReferences = ::zserio::vector<::nds::road::reference::types::TransitionReference>,
            ...
            typename ZSERIO_T_attributeValues = ::zserio::vector<::nds::instructions::instantiations::InstructionsTransitionAttribute>,
    ...
    InstructionsTransitionAttributeMap(
            ...
            InstructionsTransitionAttributeMap(allocator)
    {
    ...
    explicit InstructionsTransitionAttributeMap(::zserio::BitStreamReader& in,
            ::nds::core::geometry::CoordShift coordShift_, const allocator_type& allocator = allocator_type());
    explicit InstructionsTransitionAttributeMap(ZserioPackingContext& context,
            ::zserio::BitStreamReader& in,
            ::nds::core::geometry::CoordShift coordShift_, const allocator_type& allocator = allocator_type());

    ~InstructionsTransitionAttributeMap() = default;

    InstructionsTransitionAttributeMap(const InstructionsTransitionAttributeMap& other);
    InstructionsTransitionAttributeMap& operator=(const InstructionsTransitionAttributeMap& other);

    InstructionsTransitionAttributeMap(InstructionsTransitionAttributeMap&& other);
    InstructionsTransitionAttributeMap& operator=(InstructionsTransitionAttributeMap&& other);

    InstructionsTransitionAttributeMap(::zserio::PropagateAllocatorT,
    ...
    const ::zserio::vector<::nds::instructions::instantiations::InstructionsTransitionAttribute>& getAttributeValues() const;
    ::zserio::vector<::nds::instructions::instantiations::InstructionsTransitionAttribute>& getAttributeValues();
    void setAttributeValues(const ::zserio::vector<::nds::instructions::instantiations::InstructionsTransitionAttribute>& attributeValues_);
    void setAttributeValues(::zserio::vector<::nds::instructions::instantiations::InstructionsTransitionAttribute>&& attributeValues_);
    ...
    bool operator==(const InstructionsTransitionAttributeMap& other) const;
...
private:
    ...
    {
    public:
        using OwnerType = InstructionsTransitionAttributeMap;

        static void initializeElement(InstructionsTransitionAttributeMap& owner,
    ...
    public:
        ...
        static void create(InstructionsTransitionAttributeMap& owner,
    ...
    public:
        ...
        static void initializeElement(InstructionsTransitionAttributeMap& owner,
                ::nds::instructions::instantiations::InstructionsTransitionAttribute& element, size_t index);
    };
    ...
    public:
        ...
        static void create(InstructionsTransitionAttributeMap& owner,
                ::zserio::vector<::nds::instructions::instantiations::InstructionsTransitionAttribute>& array,
                ::nds::instructions::instantiations::InstructionsTransitionAttribute::ZserioPackingContext& context,
                ::zserio::BitStreamReader& in, size_t index);
    };
    ...
    using ZserioArrayType_attributeValues = ::zserio::Array<::zserio::vector<::nds::instructions::instantiations::InstructionsTransitionAttribute>, ::zserio::ObjectArrayTraits<::nds::instructions::instantiations::InstructionsTransitionAttribute, ZserioElementFactory_attributeValues>, ::zserio::ArrayType::NORMAL, ZserioArrayExpressions_attributeValues>;
...
#endif // NDS_INSTRUCTIONS_INSTANTIATIONS_INSTRUCTIONS_TRANSITION_ATTRIBUTE_MAP_H
