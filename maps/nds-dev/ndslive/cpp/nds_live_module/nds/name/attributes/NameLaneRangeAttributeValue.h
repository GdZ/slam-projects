...
#ifndef NDS_NAME_ATTRIBUTES_NAME_LANE_RANGE_ATTRIBUTE_VALUE_H
#define NDS_NAME_ATTRIBUTES_NAME_LANE_RANGE_ATTRIBUTE_VALUE_H
...
public:
    ...
    NameLaneRangeAttributeValue() noexcept :
            NameLaneRangeAttributeValue(allocator_type())
    {}

    explicit NameLaneRangeAttributeValue(const allocator_type& allocator) noexcept;

    explicit NameLaneRangeAttributeValue(::zserio::BitStreamReader& in,
            ::nds::name::attributes::NameLaneRangeAttributeType type_, const allocator_type& allocator = allocator_type());
    explicit NameLaneRangeAttributeValue(ZserioPackingContext& context,
            ::zserio::BitStreamReader& in,
            ::nds::name::attributes::NameLaneRangeAttributeType type_, const allocator_type& allocator = allocator_type());

    ~NameLaneRangeAttributeValue() = default;

    NameLaneRangeAttributeValue(const NameLaneRangeAttributeValue& other);
    NameLaneRangeAttributeValue& operator=(const NameLaneRangeAttributeValue& other);

    NameLaneRangeAttributeValue(NameLaneRangeAttributeValue&& other);
    NameLaneRangeAttributeValue& operator=(NameLaneRangeAttributeValue&& other);

    NameLaneRangeAttributeValue(::zserio::PropagateAllocatorT,
    ...
    ::nds::name::attributes::NameLaneRangeAttributeType getType() const;
    ...
    bool operator==(const NameLaneRangeAttributeValue& other) const;
...
private:
    ...
    ::nds::name::attributes::NameLaneRangeAttributeType m_type_;
...
#endif // NDS_NAME_ATTRIBUTES_NAME_LANE_RANGE_ATTRIBUTE_VALUE_H
