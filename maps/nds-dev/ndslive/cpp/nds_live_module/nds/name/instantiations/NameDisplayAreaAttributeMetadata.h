...
#ifndef NDS_NAME_INSTANTIATIONS_NAME_DISPLAY_AREA_ATTRIBUTE_METADATA_H
#define NDS_NAME_INSTANTIATIONS_NAME_DISPLAY_AREA_ATTRIBUTE_METADATA_H
...
class NameDisplayAreaAttributeMetadata
{
public:
    ...
    NameDisplayAreaAttributeMetadata() noexcept :
            NameDisplayAreaAttributeMetadata(allocator_type())
    {}

    explicit NameDisplayAreaAttributeMetadata(const allocator_type& allocator) noexcept;

    template <typename ZSERIO_T_availableAttributes = ::zserio::vector<::nds::name::attributes::NameDisplayAreaAttributeType>,
            ...
            ::zserio::is_field_constructor_enabled_t<ZSERIO_T_availableAttributes, NameDisplayAreaAttributeMetadata, allocator_type> = 0>
    NameDisplayAreaAttributeMetadata(
            ...
            NameDisplayAreaAttributeMetadata(allocator)
    {
    ...
    explicit NameDisplayAreaAttributeMetadata(::zserio::BitStreamReader& in, const allocator_type& allocator = allocator_type());
    explicit NameDisplayAreaAttributeMetadata(ZserioPackingContext& context,
            ::zserio::BitStreamReader& in, const allocator_type& allocator = allocator_type());

    ~NameDisplayAreaAttributeMetadata() = default;

    NameDisplayAreaAttributeMetadata(const NameDisplayAreaAttributeMetadata&) = default;
    NameDisplayAreaAttributeMetadata& operator=(const NameDisplayAreaAttributeMetadata&) = default;

    NameDisplayAreaAttributeMetadata(NameDisplayAreaAttributeMetadata&&) = default;
    NameDisplayAreaAttributeMetadata& operator=(NameDisplayAreaAttributeMetadata&&) = default;

    NameDisplayAreaAttributeMetadata(::zserio::PropagateAllocatorT,
            const NameDisplayAreaAttributeMetadata& other, const allocator_type& allocator);

    const ::zserio::vector<::nds::name::attributes::NameDisplayAreaAttributeType>& getAvailableAttributes() const;
    ::zserio::vector<::nds::name::attributes::NameDisplayAreaAttributeType>& getAvailableAttributes();
    void setAvailableAttributes(const ::zserio::vector<::nds::name::attributes::NameDisplayAreaAttributeType>& availableAttributes_);
    void setAvailableAttributes(::zserio::vector<::nds::name::attributes::NameDisplayAreaAttributeType>&& availableAttributes_);
    ...
    bool operator==(const NameDisplayAreaAttributeMetadata& other) const;
...
private:
    ...
    {
    public:
        using OwnerType = NameDisplayAreaAttributeMetadata;

        static void create(NameDisplayAreaAttributeMetadata& owner,
    ...
    using ZserioArrayType_availableAttributes = ::zserio::Array<::zserio::vector<::nds::name::attributes::NameDisplayAreaAttributeType>, ::zserio::EnumArrayTraits<::nds::name::attributes::NameDisplayAreaAttributeType>, ::zserio::ArrayType::AUTO>;
...
#endif // NDS_NAME_INSTANTIATIONS_NAME_DISPLAY_AREA_ATTRIBUTE_METADATA_H
