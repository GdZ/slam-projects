...
#ifndef NDS_NAME_INSTANTIATIONS_NAME_LANE_POSITION_ATTRIBUTE_METADATA_H
#define NDS_NAME_INSTANTIATIONS_NAME_LANE_POSITION_ATTRIBUTE_METADATA_H
...
class NameLanePositionAttributeMetadata
{
public:
    ...
    NameLanePositionAttributeMetadata() noexcept :
            NameLanePositionAttributeMetadata(allocator_type())
    {}

    explicit NameLanePositionAttributeMetadata(const allocator_type& allocator) noexcept;

    template <typename ZSERIO_T_availableAttributes = ::zserio::vector<::nds::name::attributes::NameLanePositionAttributeType>,
            ...
            ::zserio::is_field_constructor_enabled_t<ZSERIO_T_availableAttributes, NameLanePositionAttributeMetadata, allocator_type> = 0>
    NameLanePositionAttributeMetadata(
            ...
            NameLanePositionAttributeMetadata(allocator)
    {
    ...
    explicit NameLanePositionAttributeMetadata(::zserio::BitStreamReader& in, const allocator_type& allocator = allocator_type());
    explicit NameLanePositionAttributeMetadata(ZserioPackingContext& context,
            ::zserio::BitStreamReader& in, const allocator_type& allocator = allocator_type());

    ~NameLanePositionAttributeMetadata() = default;

    NameLanePositionAttributeMetadata(const NameLanePositionAttributeMetadata&) = default;
    NameLanePositionAttributeMetadata& operator=(const NameLanePositionAttributeMetadata&) = default;

    NameLanePositionAttributeMetadata(NameLanePositionAttributeMetadata&&) = default;
    NameLanePositionAttributeMetadata& operator=(NameLanePositionAttributeMetadata&&) = default;

    NameLanePositionAttributeMetadata(::zserio::PropagateAllocatorT,
            const NameLanePositionAttributeMetadata& other, const allocator_type& allocator);

    const ::zserio::vector<::nds::name::attributes::NameLanePositionAttributeType>& getAvailableAttributes() const;
    ::zserio::vector<::nds::name::attributes::NameLanePositionAttributeType>& getAvailableAttributes();
    void setAvailableAttributes(const ::zserio::vector<::nds::name::attributes::NameLanePositionAttributeType>& availableAttributes_);
    void setAvailableAttributes(::zserio::vector<::nds::name::attributes::NameLanePositionAttributeType>&& availableAttributes_);
    ...
    bool operator==(const NameLanePositionAttributeMetadata& other) const;
...
private:
    ...
    {
    public:
        using OwnerType = NameLanePositionAttributeMetadata;

        static void create(NameLanePositionAttributeMetadata& owner,
    ...
    using ZserioArrayType_availableAttributes = ::zserio::Array<::zserio::vector<::nds::name::attributes::NameLanePositionAttributeType>, ::zserio::EnumArrayTraits<::nds::name::attributes::NameLanePositionAttributeType>, ::zserio::ArrayType::AUTO>;
...
#endif // NDS_NAME_INSTANTIATIONS_NAME_LANE_POSITION_ATTRIBUTE_METADATA_H
