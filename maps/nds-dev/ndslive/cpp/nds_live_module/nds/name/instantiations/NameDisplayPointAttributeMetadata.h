...
#ifndef NDS_NAME_INSTANTIATIONS_NAME_DISPLAY_POINT_ATTRIBUTE_METADATA_H
#define NDS_NAME_INSTANTIATIONS_NAME_DISPLAY_POINT_ATTRIBUTE_METADATA_H
...
class NameDisplayPointAttributeMetadata
{
public:
    ...
    NameDisplayPointAttributeMetadata() noexcept :
            NameDisplayPointAttributeMetadata(allocator_type())
    {}

    explicit NameDisplayPointAttributeMetadata(const allocator_type& allocator) noexcept;

    template <typename ZSERIO_T_availableAttributes = ::zserio::vector<::nds::name::attributes::NameDisplayPointAttributeType>,
            ...
            ::zserio::is_field_constructor_enabled_t<ZSERIO_T_availableAttributes, NameDisplayPointAttributeMetadata, allocator_type> = 0>
    NameDisplayPointAttributeMetadata(
            ...
            NameDisplayPointAttributeMetadata(allocator)
    {
    ...
    explicit NameDisplayPointAttributeMetadata(::zserio::BitStreamReader& in, const allocator_type& allocator = allocator_type());
    explicit NameDisplayPointAttributeMetadata(ZserioPackingContext& context,
            ::zserio::BitStreamReader& in, const allocator_type& allocator = allocator_type());

    ~NameDisplayPointAttributeMetadata() = default;

    NameDisplayPointAttributeMetadata(const NameDisplayPointAttributeMetadata&) = default;
    NameDisplayPointAttributeMetadata& operator=(const NameDisplayPointAttributeMetadata&) = default;

    NameDisplayPointAttributeMetadata(NameDisplayPointAttributeMetadata&&) = default;
    NameDisplayPointAttributeMetadata& operator=(NameDisplayPointAttributeMetadata&&) = default;

    NameDisplayPointAttributeMetadata(::zserio::PropagateAllocatorT,
            const NameDisplayPointAttributeMetadata& other, const allocator_type& allocator);

    const ::zserio::vector<::nds::name::attributes::NameDisplayPointAttributeType>& getAvailableAttributes() const;
    ::zserio::vector<::nds::name::attributes::NameDisplayPointAttributeType>& getAvailableAttributes();
    void setAvailableAttributes(const ::zserio::vector<::nds::name::attributes::NameDisplayPointAttributeType>& availableAttributes_);
    void setAvailableAttributes(::zserio::vector<::nds::name::attributes::NameDisplayPointAttributeType>&& availableAttributes_);
    ...
    bool operator==(const NameDisplayPointAttributeMetadata& other) const;
...
private:
    ...
    {
    public:
        using OwnerType = NameDisplayPointAttributeMetadata;

        static void create(NameDisplayPointAttributeMetadata& owner,
    ...
    using ZserioArrayType_availableAttributes = ::zserio::Array<::zserio::vector<::nds::name::attributes::NameDisplayPointAttributeType>, ::zserio::EnumArrayTraits<::nds::name::attributes::NameDisplayPointAttributeType>, ::zserio::ArrayType::AUTO>;
...
#endif // NDS_NAME_INSTANTIATIONS_NAME_DISPLAY_POINT_ATTRIBUTE_METADATA_H
