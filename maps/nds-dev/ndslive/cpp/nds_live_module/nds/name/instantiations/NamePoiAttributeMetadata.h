...
#ifndef NDS_NAME_INSTANTIATIONS_NAME_POI_ATTRIBUTE_METADATA_H
#define NDS_NAME_INSTANTIATIONS_NAME_POI_ATTRIBUTE_METADATA_H
...
public:
    ...
    NamePoiAttributeMetadata() noexcept :
            NamePoiAttributeMetadata(allocator_type())
    {}

    explicit NamePoiAttributeMetadata(const allocator_type& allocator) noexcept;

    template <typename ZSERIO_T_availableAttributes = ::zserio::vector<::nds::name::attributes::NamePoiAttributeType>,
            ...
            ::zserio::is_field_constructor_enabled_t<ZSERIO_T_availableAttributes, NamePoiAttributeMetadata, allocator_type> = 0>
    NamePoiAttributeMetadata(
            ...
            NamePoiAttributeMetadata(allocator)
    {
    ...
    explicit NamePoiAttributeMetadata(::zserio::BitStreamReader& in, const allocator_type& allocator = allocator_type());
    explicit NamePoiAttributeMetadata(ZserioPackingContext& context,
            ::zserio::BitStreamReader& in, const allocator_type& allocator = allocator_type());

    ~NamePoiAttributeMetadata() = default;

    NamePoiAttributeMetadata(const NamePoiAttributeMetadata&) = default;
    NamePoiAttributeMetadata& operator=(const NamePoiAttributeMetadata&) = default;

    NamePoiAttributeMetadata(NamePoiAttributeMetadata&&) = default;
    NamePoiAttributeMetadata& operator=(NamePoiAttributeMetadata&&) = default;

    NamePoiAttributeMetadata(::zserio::PropagateAllocatorT,
            const NamePoiAttributeMetadata& other, const allocator_type& allocator);

    const ::zserio::vector<::nds::name::attributes::NamePoiAttributeType>& getAvailableAttributes() const;
    ::zserio::vector<::nds::name::attributes::NamePoiAttributeType>& getAvailableAttributes();
    void setAvailableAttributes(const ::zserio::vector<::nds::name::attributes::NamePoiAttributeType>& availableAttributes_);
    void setAvailableAttributes(::zserio::vector<::nds::name::attributes::NamePoiAttributeType>&& availableAttributes_);
    ...
    bool operator==(const NamePoiAttributeMetadata& other) const;
...
private:
    ...
    {
    public:
        using OwnerType = NamePoiAttributeMetadata;

        static void create(NamePoiAttributeMetadata& owner,
    ...
    using ZserioArrayType_availableAttributes = ::zserio::Array<::zserio::vector<::nds::name::attributes::NamePoiAttributeType>, ::zserio::EnumArrayTraits<::nds::name::attributes::NamePoiAttributeType>, ::zserio::ArrayType::AUTO>;
...
#endif // NDS_NAME_INSTANTIATIONS_NAME_POI_ATTRIBUTE_METADATA_H
