...
#ifndef NDS_NAME_INSTANTIATIONS_NAME_ROAD_POSITION_ATTRIBUTE_SET_MAP_H
#define NDS_NAME_INSTANTIATIONS_NAME_ROAD_POSITION_ATTRIBUTE_SET_MAP_H
...
public:
    ...
    {
    public:
        ::nds::name::instantiations::NameRoadPositionAttributeSet::ZserioPackingContext& getAttributeSet()
        {
    ...
    private:
        ::nds::name::instantiations::NameRoadPositionAttributeSet::ZserioPackingContext m_attributeSet_;
        ::zserio::DeltaContext m_feature_;
    };

    using allocator_type = ::std::allocator<uint8_t>;

    NameRoadPositionAttributeSetMap() noexcept :
            NameRoadPositionAttributeSetMap(allocator_type())
    {}

    explicit NameRoadPositionAttributeSetMap(const allocator_type& allocator) noexcept;

    template <typename ZSERIO_T_attributeSet = ::nds::name::instantiations::NameRoadPositionAttributeSet,
            ...
            ::zserio::is_field_constructor_enabled_t<ZSERIO_T_attributeSet, NameRoadPositionAttributeSetMap, allocator_type> = 0>
    NameRoadPositionAttributeSetMap(
            ...
            NameRoadPositionAttributeSetMap(allocator)
    {
    ...
    explicit NameRoadPositionAttributeSetMap(::zserio::BitStreamReader& in,
            ::nds::core::geometry::CoordShift coordShift_, const allocator_type& allocator = allocator_type());
    explicit NameRoadPositionAttributeSetMap(ZserioPackingContext& context,
            ::zserio::BitStreamReader& in,
            ::nds::core::geometry::CoordShift coordShift_, const allocator_type& allocator = allocator_type());

    ~NameRoadPositionAttributeSetMap() = default;

    NameRoadPositionAttributeSetMap(const NameRoadPositionAttributeSetMap& other);
    NameRoadPositionAttributeSetMap& operator=(const NameRoadPositionAttributeSetMap& other);

    NameRoadPositionAttributeSetMap(NameRoadPositionAttributeSetMap&& other);
    NameRoadPositionAttributeSetMap& operator=(NameRoadPositionAttributeSetMap&& other);

    NameRoadPositionAttributeSetMap(::zserio::PropagateAllocatorT,
    ...
    const ::nds::name::instantiations::NameRoadPositionAttributeSet& getAttributeSet() const;
    ::nds::name::instantiations::NameRoadPositionAttributeSet& getAttributeSet();
    void setAttributeSet(const ::nds::name::instantiations::NameRoadPositionAttributeSet& attributeSet_);
    void setAttributeSet(::nds::name::instantiations::NameRoadPositionAttributeSet&& attributeSet_);
    ...
    bool operator==(const NameRoadPositionAttributeSetMap& other) const;
...
private:
    ...
    {
    public:
        using OwnerType = NameRoadPositionAttributeSetMap;

        static void create(NameRoadPositionAttributeSetMap& owner,
    ...
    public:
        ...
        static void initializeElement(NameRoadPositionAttributeSetMap& owner,
    ...
    ::nds::name::instantiations::NameRoadPositionAttributeSet readAttributeSet(::zserio::BitStreamReader& in,
            const allocator_type& allocator);
    ::nds::name::instantiations::NameRoadPositionAttributeSet readAttributeSet(ZserioPackingContext& context,
    ...
    ::nds::name::instantiations::NameRoadPositionAttributeSet m_attributeSet_;
...
#endif // NDS_NAME_INSTANTIATIONS_NAME_ROAD_POSITION_ATTRIBUTE_SET_MAP_H
