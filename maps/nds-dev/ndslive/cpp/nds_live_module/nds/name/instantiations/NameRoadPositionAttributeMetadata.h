...
#ifndef NDS_NAME_INSTANTIATIONS_NAME_ROAD_POSITION_ATTRIBUTE_METADATA_H
#define NDS_NAME_INSTANTIATIONS_NAME_ROAD_POSITION_ATTRIBUTE_METADATA_H
...
class NameRoadPositionAttributeMetadata
{
public:
    ...
    NameRoadPositionAttributeMetadata() noexcept :
            NameRoadPositionAttributeMetadata(allocator_type())
    {}

    explicit NameRoadPositionAttributeMetadata(const allocator_type& allocator) noexcept;

    template <typename ZSERIO_T_availableAttributes = ::zserio::vector<::nds::name::attributes::NameRoadPositionAttributeType>,
            ...
            ::zserio::is_field_constructor_enabled_t<ZSERIO_T_availableAttributes, NameRoadPositionAttributeMetadata, allocator_type> = 0>
    NameRoadPositionAttributeMetadata(
            ...
            NameRoadPositionAttributeMetadata(allocator)
    {
    ...
    explicit NameRoadPositionAttributeMetadata(::zserio::BitStreamReader& in, const allocator_type& allocator = allocator_type());
    explicit NameRoadPositionAttributeMetadata(ZserioPackingContext& context,
            ::zserio::BitStreamReader& in, const allocator_type& allocator = allocator_type());

    ~NameRoadPositionAttributeMetadata() = default;

    NameRoadPositionAttributeMetadata(const NameRoadPositionAttributeMetadata&) = default;
    NameRoadPositionAttributeMetadata& operator=(const NameRoadPositionAttributeMetadata&) = default;

    NameRoadPositionAttributeMetadata(NameRoadPositionAttributeMetadata&&) = default;
    NameRoadPositionAttributeMetadata& operator=(NameRoadPositionAttributeMetadata&&) = default;

    NameRoadPositionAttributeMetadata(::zserio::PropagateAllocatorT,
            const NameRoadPositionAttributeMetadata& other, const allocator_type& allocator);

    const ::zserio::vector<::nds::name::attributes::NameRoadPositionAttributeType>& getAvailableAttributes() const;
    ::zserio::vector<::nds::name::attributes::NameRoadPositionAttributeType>& getAvailableAttributes();
    void setAvailableAttributes(const ::zserio::vector<::nds::name::attributes::NameRoadPositionAttributeType>& availableAttributes_);
    void setAvailableAttributes(::zserio::vector<::nds::name::attributes::NameRoadPositionAttributeType>&& availableAttributes_);
    ...
    bool operator==(const NameRoadPositionAttributeMetadata& other) const;
...
private:
    ...
    {
    public:
        using OwnerType = NameRoadPositionAttributeMetadata;

        static void create(NameRoadPositionAttributeMetadata& owner,
    ...
    using ZserioArrayType_availableAttributes = ::zserio::Array<::zserio::vector<::nds::name::attributes::NameRoadPositionAttributeType>, ::zserio::EnumArrayTraits<::nds::name::attributes::NameRoadPositionAttributeType>, ::zserio::ArrayType::AUTO>;
...
#endif // NDS_NAME_INSTANTIATIONS_NAME_ROAD_POSITION_ATTRIBUTE_METADATA_H
