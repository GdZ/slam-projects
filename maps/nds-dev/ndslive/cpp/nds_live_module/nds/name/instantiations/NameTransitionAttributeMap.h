...
#ifndef NDS_NAME_INSTANTIATIONS_NAME_TRANSITION_ATTRIBUTE_MAP_H
#define NDS_NAME_INSTANTIATIONS_NAME_TRANSITION_ATTRIBUTE_MAP_H
...
public:
    ...
    NameTransitionAttributeMap() noexcept :
            NameTransitionAttributeMap(allocator_type())
    {}

    explicit NameTransitionAttributeMap(const allocator_type& allocator) noexcept;
    ...
    template <typename ZSERIO_T_featureReferences = ::zserio::vector<::nds::road::reference::types::TransitionReference>,
            ...
            typename ZSERIO_T_attributeValues = ::zserio::vector<::nds::name::instantiations::NameTransitionAttribute>,
    ...
    NameTransitionAttributeMap(
            ...
            NameTransitionAttributeMap(allocator)
    {
    ...
    explicit NameTransitionAttributeMap(::zserio::BitStreamReader& in,
            ::nds::core::geometry::CoordShift coordShift_, const allocator_type& allocator = allocator_type());
    explicit NameTransitionAttributeMap(ZserioPackingContext& context,
            ::zserio::BitStreamReader& in,
            ::nds::core::geometry::CoordShift coordShift_, const allocator_type& allocator = allocator_type());

    ~NameTransitionAttributeMap() = default;

    NameTransitionAttributeMap(const NameTransitionAttributeMap& other);
    NameTransitionAttributeMap& operator=(const NameTransitionAttributeMap& other);

    NameTransitionAttributeMap(NameTransitionAttributeMap&& other);
    NameTransitionAttributeMap& operator=(NameTransitionAttributeMap&& other);

    NameTransitionAttributeMap(::zserio::PropagateAllocatorT,
    ...
    const ::zserio::vector<::nds::name::instantiations::NameTransitionAttribute>& getAttributeValues() const;
    ::zserio::vector<::nds::name::instantiations::NameTransitionAttribute>& getAttributeValues();
    void setAttributeValues(const ::zserio::vector<::nds::name::instantiations::NameTransitionAttribute>& attributeValues_);
    void setAttributeValues(::zserio::vector<::nds::name::instantiations::NameTransitionAttribute>&& attributeValues_);
    ...
    bool operator==(const NameTransitionAttributeMap& other) const;
...
private:
    ...
    {
    public:
        using OwnerType = NameTransitionAttributeMap;

        static void initializeElement(NameTransitionAttributeMap& owner,
    ...
    public:
        ...
        static void create(NameTransitionAttributeMap& owner,
    ...
    public:
        ...
        static void initializeElement(NameTransitionAttributeMap& owner,
                ::nds::name::instantiations::NameTransitionAttribute& element, size_t index);
    };
    ...
    using ZserioArrayType_attributeValues = ::zserio::Array<::zserio::vector<::nds::name::instantiations::NameTransitionAttribute>, ::zserio::ObjectArrayTraits<::nds::name::instantiations::NameTransitionAttribute, ZserioElementFactory_attributeValues>, ::zserio::ArrayType::NORMAL, ZserioArrayExpressions_attributeValues>;
...
#endif // NDS_NAME_INSTANTIATIONS_NAME_TRANSITION_ATTRIBUTE_MAP_H
