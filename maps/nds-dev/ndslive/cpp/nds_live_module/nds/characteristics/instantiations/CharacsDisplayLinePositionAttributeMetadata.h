...
#ifndef NDS_CHARACTERISTICS_INSTANTIATIONS_CHARACS_DISPLAY_LINE_POSITION_ATTRIBUTE_METADATA_H
#define NDS_CHARACTERISTICS_INSTANTIATIONS_CHARACS_DISPLAY_LINE_POSITION_ATTRIBUTE_METADATA_H
...
class CharacsDisplayLinePositionAttributeMetadata
{
public:
    ...
    CharacsDisplayLinePositionAttributeMetadata() noexcept :
            CharacsDisplayLinePositionAttributeMetadata(allocator_type())
    {}

    explicit CharacsDisplayLinePositionAttributeMetadata(const allocator_type& allocator) noexcept;

    template <typename ZSERIO_T_availableAttributes = ::zserio::vector<::nds::characteristics::attributes::CharacsDisplayLinePositionAttributeType>,
            ...
            ::zserio::is_field_constructor_enabled_t<ZSERIO_T_availableAttributes, CharacsDisplayLinePositionAttributeMetadata, allocator_type> = 0>
    CharacsDisplayLinePositionAttributeMetadata(
            ...
            CharacsDisplayLinePositionAttributeMetadata(allocator)
    {
    ...
    explicit CharacsDisplayLinePositionAttributeMetadata(::zserio::BitStreamReader& in, const allocator_type& allocator = allocator_type());
    explicit CharacsDisplayLinePositionAttributeMetadata(ZserioPackingContext& context,
            ::zserio::BitStreamReader& in, const allocator_type& allocator = allocator_type());

    ~CharacsDisplayLinePositionAttributeMetadata() = default;

    CharacsDisplayLinePositionAttributeMetadata(const CharacsDisplayLinePositionAttributeMetadata&) = default;
    CharacsDisplayLinePositionAttributeMetadata& operator=(const CharacsDisplayLinePositionAttributeMetadata&) = default;

    CharacsDisplayLinePositionAttributeMetadata(CharacsDisplayLinePositionAttributeMetadata&&) = default;
    CharacsDisplayLinePositionAttributeMetadata& operator=(CharacsDisplayLinePositionAttributeMetadata&&) = default;

    CharacsDisplayLinePositionAttributeMetadata(::zserio::PropagateAllocatorT,
            const CharacsDisplayLinePositionAttributeMetadata& other, const allocator_type& allocator);

    const ::zserio::vector<::nds::characteristics::attributes::CharacsDisplayLinePositionAttributeType>& getAvailableAttributes() const;
    ::zserio::vector<::nds::characteristics::attributes::CharacsDisplayLinePositionAttributeType>& getAvailableAttributes();
    void setAvailableAttributes(const ::zserio::vector<::nds::characteristics::attributes::CharacsDisplayLinePositionAttributeType>& availableAttributes_);
    void setAvailableAttributes(::zserio::vector<::nds::characteristics::attributes::CharacsDisplayLinePositionAttributeType>&& availableAttributes_);
    ...
    bool operator==(const CharacsDisplayLinePositionAttributeMetadata& other) const;
...
private:
    ...
    {
    public:
        using OwnerType = CharacsDisplayLinePositionAttributeMetadata;

        static void create(CharacsDisplayLinePositionAttributeMetadata& owner,
    ...
    using ZserioArrayType_availableAttributes = ::zserio::Array<::zserio::vector<::nds::characteristics::attributes::CharacsDisplayLinePositionAttributeType>, ::zserio::EnumArrayTraits<::nds::characteristics::attributes::CharacsDisplayLinePositionAttributeType>, ::zserio::ArrayType::AUTO>;
...
#endif // NDS_CHARACTERISTICS_INSTANTIATIONS_CHARACS_DISPLAY_LINE_POSITION_ATTRIBUTE_METADATA_H
