...
#ifndef NDS_CHARACTERISTICS_INSTANTIATIONS_CHARACS_INDIRECT_ROAD_RANGE_ATTRIBUTE_SET_MAP_H
#define NDS_CHARACTERISTICS_INSTANTIATIONS_CHARACS_INDIRECT_ROAD_RANGE_ATTRIBUTE_SET_MAP_H
...
public:
    ...
    CharacsIndirectRoadRangeAttributeSetMap() noexcept :
            CharacsIndirectRoadRangeAttributeSetMap(allocator_type())
    {}

    explicit CharacsIndirectRoadRangeAttributeSetMap(const allocator_type& allocator) noexcept;
    ...
    template <typename ZSERIO_T_attributeSet = ::nds::characteristics::instantiations::CharacsRoadRangeAttributeSet,
            ...
            ::zserio::is_field_constructor_enabled_t<ZSERIO_T_attributeSet, CharacsIndirectRoadRangeAttributeSetMap, allocator_type> = 0>
    CharacsIndirectRoadRangeAttributeSetMap(
            ...
            CharacsIndirectRoadRangeAttributeSetMap(allocator)
    {
    ...
    explicit CharacsIndirectRoadRangeAttributeSetMap(::zserio::BitStreamReader& in,
            ::nds::core::geometry::CoordShift coordShift_, const allocator_type& allocator = allocator_type());
    explicit CharacsIndirectRoadRangeAttributeSetMap(ZserioPackingContext& context,
            ::zserio::BitStreamReader& in,
            ::nds::core::geometry::CoordShift coordShift_, const allocator_type& allocator = allocator_type());

    ~CharacsIndirectRoadRangeAttributeSetMap() = default;

    CharacsIndirectRoadRangeAttributeSetMap(const CharacsIndirectRoadRangeAttributeSetMap& other);
    CharacsIndirectRoadRangeAttributeSetMap& operator=(const CharacsIndirectRoadRangeAttributeSetMap& other);

    CharacsIndirectRoadRangeAttributeSetMap(CharacsIndirectRoadRangeAttributeSetMap&& other);
    CharacsIndirectRoadRangeAttributeSetMap& operator=(CharacsIndirectRoadRangeAttributeSetMap&& other);

    CharacsIndirectRoadRangeAttributeSetMap(::zserio::PropagateAllocatorT,
    ...
    bool operator==(const CharacsIndirectRoadRangeAttributeSetMap& other) const;
...
private:
    ...
    {
    public:
        using OwnerType = CharacsIndirectRoadRangeAttributeSetMap;

        static void initializeElement(CharacsIndirectRoadRangeAttributeSetMap& owner,
    ...
    public:
        ...
        static void create(CharacsIndirectRoadRangeAttributeSetMap& owner,
...
#endif // NDS_CHARACTERISTICS_INSTANTIATIONS_CHARACS_INDIRECT_ROAD_RANGE_ATTRIBUTE_SET_MAP_H
