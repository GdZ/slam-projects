...
#ifndef NDS_CHARACTERISTICS_INSTANTIATIONS_CHARACS_DISPLAY_LINE_RANGE_ATTRIBUTE_METADATA_H
#define NDS_CHARACTERISTICS_INSTANTIATIONS_CHARACS_DISPLAY_LINE_RANGE_ATTRIBUTE_METADATA_H
...
class CharacsDisplayLineRangeAttributeMetadata
{
public:
    ...
    CharacsDisplayLineRangeAttributeMetadata() noexcept :
            CharacsDisplayLineRangeAttributeMetadata(allocator_type())
    {}

    explicit CharacsDisplayLineRangeAttributeMetadata(const allocator_type& allocator) noexcept;

    template <typename ZSERIO_T_availableAttributes = ::zserio::vector<::nds::characteristics::attributes::CharacsDisplayLineRangeAttributeType>,
            ...
            ::zserio::is_field_constructor_enabled_t<ZSERIO_T_availableAttributes, CharacsDisplayLineRangeAttributeMetadata, allocator_type> = 0>
    CharacsDisplayLineRangeAttributeMetadata(
            ...
            CharacsDisplayLineRangeAttributeMetadata(allocator)
    {
    ...
    explicit CharacsDisplayLineRangeAttributeMetadata(::zserio::BitStreamReader& in, const allocator_type& allocator = allocator_type());
    explicit CharacsDisplayLineRangeAttributeMetadata(ZserioPackingContext& context,
            ::zserio::BitStreamReader& in, const allocator_type& allocator = allocator_type());

    ~CharacsDisplayLineRangeAttributeMetadata() = default;

    CharacsDisplayLineRangeAttributeMetadata(const CharacsDisplayLineRangeAttributeMetadata&) = default;
    CharacsDisplayLineRangeAttributeMetadata& operator=(const CharacsDisplayLineRangeAttributeMetadata&) = default;

    CharacsDisplayLineRangeAttributeMetadata(CharacsDisplayLineRangeAttributeMetadata&&) = default;
    CharacsDisplayLineRangeAttributeMetadata& operator=(CharacsDisplayLineRangeAttributeMetadata&&) = default;

    CharacsDisplayLineRangeAttributeMetadata(::zserio::PropagateAllocatorT,
            const CharacsDisplayLineRangeAttributeMetadata& other, const allocator_type& allocator);

    const ::zserio::vector<::nds::characteristics::attributes::CharacsDisplayLineRangeAttributeType>& getAvailableAttributes() const;
    ::zserio::vector<::nds::characteristics::attributes::CharacsDisplayLineRangeAttributeType>& getAvailableAttributes();
    void setAvailableAttributes(const ::zserio::vector<::nds::characteristics::attributes::CharacsDisplayLineRangeAttributeType>& availableAttributes_);
    void setAvailableAttributes(::zserio::vector<::nds::characteristics::attributes::CharacsDisplayLineRangeAttributeType>&& availableAttributes_);
    ...
    bool operator==(const CharacsDisplayLineRangeAttributeMetadata& other) const;
...
private:
    ...
    {
    public:
        using OwnerType = CharacsDisplayLineRangeAttributeMetadata;

        static void create(CharacsDisplayLineRangeAttributeMetadata& owner,
    ...
    using ZserioArrayType_availableAttributes = ::zserio::Array<::zserio::vector<::nds::characteristics::attributes::CharacsDisplayLineRangeAttributeType>, ::zserio::EnumArrayTraits<::nds::characteristics::attributes::CharacsDisplayLineRangeAttributeType>, ::zserio::ArrayType::AUTO>;
...
#endif // NDS_CHARACTERISTICS_INSTANTIATIONS_CHARACS_DISPLAY_LINE_RANGE_ATTRIBUTE_METADATA_H
