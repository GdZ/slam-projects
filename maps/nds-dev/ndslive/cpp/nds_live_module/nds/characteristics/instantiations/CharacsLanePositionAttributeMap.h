...
#ifndef NDS_CHARACTERISTICS_INSTANTIATIONS_CHARACS_LANE_POSITION_ATTRIBUTE_MAP_H
#define NDS_CHARACTERISTICS_INSTANTIATIONS_CHARACS_LANE_POSITION_ATTRIBUTE_MAP_H
...
class CharacsLanePositionAttributeMap
{
public:
    ...
    CharacsLanePositionAttributeMap() noexcept :
            CharacsLanePositionAttributeMap(allocator_type())
    {}

    explicit CharacsLanePositionAttributeMap(const allocator_type& allocator) noexcept;

    template <typename ZSERIO_T_featureReferences = ::zserio::vector<::nds::lane::reference::types::LaneGroupId>,
            typename ZSERIO_T_featureValidities = ::zserio::vector<::nds::lane::reference::types::LaneGroupPositionValidity>,
            typename ZSERIO_T_featureValuePtr = ::zserio::vector<::nds::core::attributemap::AttributeIterator>,
            typename ZSERIO_T_attributeValues = ::zserio::vector<::nds::characteristics::instantiations::CharacsLanePositionAttribute>,
    ...
    CharacsLanePositionAttributeMap(
            ...
            CharacsLanePositionAttributeMap(allocator)
    {
    ...
    explicit CharacsLanePositionAttributeMap(::zserio::BitStreamReader& in,
            ::nds::core::geometry::CoordShift coordShift_, const allocator_type& allocator = allocator_type());
    explicit CharacsLanePositionAttributeMap(ZserioPackingContext& context,
            ::zserio::BitStreamReader& in,
            ::nds::core::geometry::CoordShift coordShift_, const allocator_type& allocator = allocator_type());

    ~CharacsLanePositionAttributeMap() = default;

    CharacsLanePositionAttributeMap(const CharacsLanePositionAttributeMap& other);
    CharacsLanePositionAttributeMap& operator=(const CharacsLanePositionAttributeMap& other);

    CharacsLanePositionAttributeMap(CharacsLanePositionAttributeMap&& other);
    CharacsLanePositionAttributeMap& operator=(CharacsLanePositionAttributeMap&& other);

    CharacsLanePositionAttributeMap(::zserio::PropagateAllocatorT,
    ...
    void setAttributeTypeCode(::nds::characteristics::attributes::CharacsLanePositionAttributeType attributeTypeCode_);
    ...
    const ::zserio::vector<::nds::lane::reference::types::LaneGroupPositionValidity>& getFeatureValidities() const;
    ::zserio::vector<::nds::lane::reference::types::LaneGroupPositionValidity>& getFeatureValidities();
    void setFeatureValidities(const ::zserio::vector<::nds::lane::reference::types::LaneGroupPositionValidity>& featureValidities_);
    void setFeatureValidities(::zserio::vector<::nds::lane::reference::types::LaneGroupPositionValidity>&& featureValidities_);
    ...
    const ::zserio::vector<::nds::characteristics::instantiations::CharacsLanePositionAttribute>& getAttributeValues() const;
    ::zserio::vector<::nds::characteristics::instantiations::CharacsLanePositionAttribute>& getAttributeValues();
    void setAttributeValues(const ::zserio::vector<::nds::characteristics::instantiations::CharacsLanePositionAttribute>& attributeValues_);
    void setAttributeValues(::zserio::vector<::nds::characteristics::instantiations::CharacsLanePositionAttribute>&& attributeValues_);
    ...
    bool operator==(const CharacsLanePositionAttributeMap& other) const;
...
private:
    ...
    {
    public:
        using OwnerType = CharacsLanePositionAttributeMap;

        static void create(CharacsLanePositionAttributeMap& owner,
    ...
    public:
        ...
        static void initializeElement(CharacsLanePositionAttributeMap& owner,
    ...
    public:
        ...
        static void initializeElement(CharacsLanePositionAttributeMap& owner,
                ::nds::characteristics::instantiations::CharacsLanePositionAttribute& element, size_t index);
    };
    ...
    public:
        ...
        static void create(CharacsLanePositionAttributeMap& owner,
                ::zserio::vector<::nds::characteristics::instantiations::CharacsLanePositionAttribute>& array,
                ::nds::characteristics::instantiations::CharacsLanePositionAttribute::ZserioPackingContext& context,
                ::zserio::BitStreamReader& in, size_t index);
    };
    ...
    using ZserioArrayType_featureValidities = ::zserio::Array<::zserio::vector<::nds::lane::reference::types::LaneGroupPositionValidity>, ::zserio::ObjectArrayTraits<::nds::lane::reference::types::LaneGroupPositionValidity, ZserioElementFactory_featureValidities>, ::zserio::ArrayType::NORMAL, ZserioArrayExpressions_featureValidities>;
    ...
    using ZserioArrayType_attributeValues = ::zserio::Array<::zserio::vector<::nds::characteristics::instantiations::CharacsLanePositionAttribute>, ::zserio::ObjectArrayTraits<::nds::characteristics::instantiations::CharacsLanePositionAttribute, ZserioElementFactory_attributeValues>, ::zserio::ArrayType::NORMAL, ZserioArrayExpressions_attributeValues>;
    ...
    ::nds::characteristics::attributes::CharacsLanePositionAttributeType readAttributeTypeCode(::zserio::BitStreamReader& in);
    ::nds::characteristics::attributes::CharacsLanePositionAttributeType readAttributeTypeCode(ZserioPackingContext& context,
            ::zserio::BitStreamReader& in);
...
#endif // NDS_CHARACTERISTICS_INSTANTIATIONS_CHARACS_LANE_POSITION_ATTRIBUTE_MAP_H
