...
#ifndef NDS_CHARACTERISTICS_INSTANTIATIONS_CHARACS_ROAD_POSITION_ATTRIBUTE_METADATA_H
#define NDS_CHARACTERISTICS_INSTANTIATIONS_CHARACS_ROAD_POSITION_ATTRIBUTE_METADATA_H
...
class CharacsRoadPositionAttributeMetadata
{
public:
    ...
    CharacsRoadPositionAttributeMetadata() noexcept :
            CharacsRoadPositionAttributeMetadata(allocator_type())
    {}

    explicit CharacsRoadPositionAttributeMetadata(const allocator_type& allocator) noexcept;

    template <typename ZSERIO_T_availableAttributes = ::zserio::vector<::nds::characteristics::attributes::CharacsRoadPositionAttributeType>,
            ...
            ::zserio::is_field_constructor_enabled_t<ZSERIO_T_availableAttributes, CharacsRoadPositionAttributeMetadata, allocator_type> = 0>
    CharacsRoadPositionAttributeMetadata(
            ...
            CharacsRoadPositionAttributeMetadata(allocator)
    {
    ...
    explicit CharacsRoadPositionAttributeMetadata(::zserio::BitStreamReader& in, const allocator_type& allocator = allocator_type());
    explicit CharacsRoadPositionAttributeMetadata(ZserioPackingContext& context,
            ::zserio::BitStreamReader& in, const allocator_type& allocator = allocator_type());

    ~CharacsRoadPositionAttributeMetadata() = default;

    CharacsRoadPositionAttributeMetadata(const CharacsRoadPositionAttributeMetadata&) = default;
    CharacsRoadPositionAttributeMetadata& operator=(const CharacsRoadPositionAttributeMetadata&) = default;

    CharacsRoadPositionAttributeMetadata(CharacsRoadPositionAttributeMetadata&&) = default;
    CharacsRoadPositionAttributeMetadata& operator=(CharacsRoadPositionAttributeMetadata&&) = default;

    CharacsRoadPositionAttributeMetadata(::zserio::PropagateAllocatorT,
            const CharacsRoadPositionAttributeMetadata& other, const allocator_type& allocator);

    const ::zserio::vector<::nds::characteristics::attributes::CharacsRoadPositionAttributeType>& getAvailableAttributes() const;
    ::zserio::vector<::nds::characteristics::attributes::CharacsRoadPositionAttributeType>& getAvailableAttributes();
    void setAvailableAttributes(const ::zserio::vector<::nds::characteristics::attributes::CharacsRoadPositionAttributeType>& availableAttributes_);
    void setAvailableAttributes(::zserio::vector<::nds::characteristics::attributes::CharacsRoadPositionAttributeType>&& availableAttributes_);
    ...
    bool operator==(const CharacsRoadPositionAttributeMetadata& other) const;
...
private:
    ...
    {
    public:
        using OwnerType = CharacsRoadPositionAttributeMetadata;

        static void create(CharacsRoadPositionAttributeMetadata& owner,
    ...
    using ZserioArrayType_availableAttributes = ::zserio::Array<::zserio::vector<::nds::characteristics::attributes::CharacsRoadPositionAttributeType>, ::zserio::EnumArrayTraits<::nds::characteristics::attributes::CharacsRoadPositionAttributeType>, ::zserio::ArrayType::AUTO>;
...
#endif // NDS_CHARACTERISTICS_INSTANTIATIONS_CHARACS_ROAD_POSITION_ATTRIBUTE_METADATA_H
