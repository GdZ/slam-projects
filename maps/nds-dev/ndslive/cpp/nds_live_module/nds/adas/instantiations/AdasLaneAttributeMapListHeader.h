...
#ifndef NDS_ADAS_INSTANTIATIONS_ADAS_LANE_ATTRIBUTE_MAP_LIST_HEADER_H
#define NDS_ADAS_INSTANTIATIONS_ADAS_LANE_ATTRIBUTE_MAP_LIST_HEADER_H
...
class AdasLaneAttributeMapListHeader
{
public:
    ...
    AdasLaneAttributeMapListHeader() noexcept :
            AdasLaneAttributeMapListHeader(allocator_type())
    {}

    explicit AdasLaneAttributeMapListHeader(const allocator_type& allocator) noexcept;

    template <typename ZSERIO_T_attributeTypeCode = ::zserio::vector<::nds::adas::attributes::AdasLaneAttributeType>,
            typename ZSERIO_T_conditionType = ::zserio::vector<::nds::core::attributemap::ConditionTypeCodeCollection>,
            ::zserio::is_field_constructor_enabled_t<ZSERIO_T_attributeTypeCode, AdasLaneAttributeMapListHeader, allocator_type> = 0>
    AdasLaneAttributeMapListHeader(
            ...
            AdasLaneAttributeMapListHeader(allocator)
    {
    ...
    explicit AdasLaneAttributeMapListHeader(::zserio::BitStreamReader& in,
            uint16_t numMaps_, const allocator_type& allocator = allocator_type());
    explicit AdasLaneAttributeMapListHeader(ZserioPackingContext& context,
            ::zserio::BitStreamReader& in,
            uint16_t numMaps_, const allocator_type& allocator = allocator_type());

    ~AdasLaneAttributeMapListHeader() = default;

    AdasLaneAttributeMapListHeader(const AdasLaneAttributeMapListHeader& other);
    AdasLaneAttributeMapListHeader& operator=(const AdasLaneAttributeMapListHeader& other);

    AdasLaneAttributeMapListHeader(AdasLaneAttributeMapListHeader&& other);
    AdasLaneAttributeMapListHeader& operator=(AdasLaneAttributeMapListHeader&& other);

    AdasLaneAttributeMapListHeader(::zserio::PropagateAllocatorT,
    ...
    const ::zserio::vector<::nds::adas::attributes::AdasLaneAttributeType>& getAttributeTypeCode() const;
    ::zserio::vector<::nds::adas::attributes::AdasLaneAttributeType>& getAttributeTypeCode();
    void setAttributeTypeCode(const ::zserio::vector<::nds::adas::attributes::AdasLaneAttributeType>& attributeTypeCode_);
    void setAttributeTypeCode(::zserio::vector<::nds::adas::attributes::AdasLaneAttributeType>&& attributeTypeCode_);
    ...
    bool operator==(const AdasLaneAttributeMapListHeader& other) const;
...
private:
    ...
    {
    public:
        using OwnerType = AdasLaneAttributeMapListHeader;

        static void create(AdasLaneAttributeMapListHeader& owner,
    ...
    using ZserioArrayType_attributeTypeCode = ::zserio::Array<::zserio::vector<::nds::adas::attributes::AdasLaneAttributeType>, ::zserio::EnumArrayTraits<::nds::adas::attributes::AdasLaneAttributeType>, ::zserio::ArrayType::NORMAL>;
...
#endif // NDS_ADAS_INSTANTIATIONS_ADAS_LANE_ATTRIBUTE_MAP_LIST_HEADER_H
