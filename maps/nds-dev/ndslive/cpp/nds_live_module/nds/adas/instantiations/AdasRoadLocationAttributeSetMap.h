...
#ifndef NDS_ADAS_INSTANTIATIONS_ADAS_ROAD_LOCATION_ATTRIBUTE_SET_MAP_H
#define NDS_ADAS_INSTANTIATIONS_ADAS_ROAD_LOCATION_ATTRIBUTE_SET_MAP_H
...
public:
    ...
    AdasRoadLocationAttributeSetMap() noexcept :
            AdasRoadLocationAttributeSetMap(allocator_type())
    {}

    explicit AdasRoadLocationAttributeSetMap(const allocator_type& allocator) noexcept;
    ...
    template <typename ZSERIO_T_attributeSet = ::nds::adas::instantiations::AdasRoadAttributeSet,
            ...
            ::zserio::is_field_constructor_enabled_t<ZSERIO_T_attributeSet, AdasRoadLocationAttributeSetMap, allocator_type> = 0>
    AdasRoadLocationAttributeSetMap(
            ...
            AdasRoadLocationAttributeSetMap(allocator)
    {
    ...
    explicit AdasRoadLocationAttributeSetMap(::zserio::BitStreamReader& in,
            ::nds::core::geometry::CoordShift coordShift_, const allocator_type& allocator = allocator_type());
    explicit AdasRoadLocationAttributeSetMap(ZserioPackingContext& context,
            ::zserio::BitStreamReader& in,
            ::nds::core::geometry::CoordShift coordShift_, const allocator_type& allocator = allocator_type());

    ~AdasRoadLocationAttributeSetMap() = default;

    AdasRoadLocationAttributeSetMap(const AdasRoadLocationAttributeSetMap& other);
    AdasRoadLocationAttributeSetMap& operator=(const AdasRoadLocationAttributeSetMap& other);

    AdasRoadLocationAttributeSetMap(AdasRoadLocationAttributeSetMap&& other);
    AdasRoadLocationAttributeSetMap& operator=(AdasRoadLocationAttributeSetMap&& other);

    AdasRoadLocationAttributeSetMap(::zserio::PropagateAllocatorT,
    ...
    bool operator==(const AdasRoadLocationAttributeSetMap& other) const;
...
private:
    ...
    {
    public:
        using OwnerType = AdasRoadLocationAttributeSetMap;

        static void create(AdasRoadLocationAttributeSetMap& owner,
    ...
    public:
        ...
        static void initializeElement(AdasRoadLocationAttributeSetMap& owner,
...
#endif // NDS_ADAS_INSTANTIATIONS_ADAS_ROAD_LOCATION_ATTRIBUTE_SET_MAP_H
