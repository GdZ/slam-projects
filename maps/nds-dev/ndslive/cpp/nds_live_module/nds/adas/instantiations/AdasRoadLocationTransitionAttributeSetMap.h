...
#ifndef NDS_ADAS_INSTANTIATIONS_ADAS_ROAD_LOCATION_TRANSITION_ATTRIBUTE_SET_MAP_H
#define NDS_ADAS_INSTANTIATIONS_ADAS_ROAD_LOCATION_TRANSITION_ATTRIBUTE_SET_MAP_H
...
public:
    ...
    AdasRoadLocationTransitionAttributeSetMap() noexcept :
            AdasRoadLocationTransitionAttributeSetMap(allocator_type())
    {}

    explicit AdasRoadLocationTransitionAttributeSetMap(const allocator_type& allocator) noexcept;
    ...
    template <typename ZSERIO_T_attributeSet = ::nds::adas::instantiations::AdasTransitionAttributeSet,
            ...
            ::zserio::is_field_constructor_enabled_t<ZSERIO_T_attributeSet, AdasRoadLocationTransitionAttributeSetMap, allocator_type> = 0>
    AdasRoadLocationTransitionAttributeSetMap(
            ...
            AdasRoadLocationTransitionAttributeSetMap(allocator)
    {
    ...
    explicit AdasRoadLocationTransitionAttributeSetMap(::zserio::BitStreamReader& in,
            ::nds::core::geometry::CoordShift coordShift_, const allocator_type& allocator = allocator_type());
    explicit AdasRoadLocationTransitionAttributeSetMap(ZserioPackingContext& context,
            ::zserio::BitStreamReader& in,
            ::nds::core::geometry::CoordShift coordShift_, const allocator_type& allocator = allocator_type());

    ~AdasRoadLocationTransitionAttributeSetMap() = default;

    AdasRoadLocationTransitionAttributeSetMap(const AdasRoadLocationTransitionAttributeSetMap& other);
    AdasRoadLocationTransitionAttributeSetMap& operator=(const AdasRoadLocationTransitionAttributeSetMap& other);

    AdasRoadLocationTransitionAttributeSetMap(AdasRoadLocationTransitionAttributeSetMap&& other);
    AdasRoadLocationTransitionAttributeSetMap& operator=(AdasRoadLocationTransitionAttributeSetMap&& other);

    AdasRoadLocationTransitionAttributeSetMap(::zserio::PropagateAllocatorT,
    ...
    bool operator==(const AdasRoadLocationTransitionAttributeSetMap& other) const;
...
private:
    ...
    {
    public:
        using OwnerType = AdasRoadLocationTransitionAttributeSetMap;

        static void create(AdasRoadLocationTransitionAttributeSetMap& owner,
    ...
    public:
        ...
        static void initializeElement(AdasRoadLocationTransitionAttributeSetMap& owner,
...
#endif // NDS_ADAS_INSTANTIATIONS_ADAS_ROAD_LOCATION_TRANSITION_ATTRIBUTE_SET_MAP_H
