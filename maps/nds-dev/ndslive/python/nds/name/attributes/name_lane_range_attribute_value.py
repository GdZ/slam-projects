...
class NameLaneRangeAttributeValue:
    def __init__(
            self,
            type_: nds.name.attributes.name_lane_range_attribute_type.NameLaneRangeAttributeType,
            *,
        ...
        if bridge_name_ is not None:
            if self._choice != None:
                raise zserio.PythonRuntimeException("Calling constructor of choice NameLaneRangeAttributeValue is ambiguous!")
    ...
    @classmethod
    def from_reader(
            cls: typing.Type['NameLaneRangeAttributeValue'],
            zserio_reader: zserio.BitStreamReader,
            type_: nds.name.attributes.name_lane_range_attribute_type.NameLaneRangeAttributeType) -> 'NameLaneRangeAttributeValue':
    ...
    def from_reader_packed(
            cls: typing.Type['NameLaneRangeAttributeValue'],
            zserio_context: NameLaneRangeAttributeValue.ZserioPackingContext,
            zserio_reader: zserio.BitStreamReader,
            type_: nds.name.attributes.name_lane_range_attribute_type.NameLaneRangeAttributeType) -> 'NameLaneRangeAttributeValue':
        self = object.__new__(cls)
        self._type_ = type_
    ...
    def __eq__(self, other: object) -> bool:
        if isinstance(other, NameLaneRangeAttributeValue):
    ...
    def __hash__(self) -> int:
        ...
        if selector == (nds.name.attributes.name_lane_range_attribute_type.NameLaneRangeAttributeType.ROAD_NAME):
            result = zserio.hashcode.calc_hashcode_string(result, self._choice)
        elif selector == (nds.name.attributes.name_lane_range_attribute_type.NameLaneRangeAttributeType.BRIDGE_NAME):
            result = zserio.hashcode.calc_hashcode_string(result, self._choice)
        elif selector == (nds.name.attributes.name_lane_range_attribute_type.NameLaneRangeAttributeType.TUNNEL_NAME):
            result = zserio.hashcode.calc_hashcode_string(result, self._choice)
        elif selector == (nds.name.attributes.name_lane_range_attribute_type.NameLaneRangeAttributeType.ROUTE_NAME):
            result = zserio.hashcode.calc_hashcode_string(result, self._choice)
        elif selector == (nds.name.attributes.name_lane_range_attribute_type.NameLaneRangeAttributeType.ROAD_NUMBER):
            result = zserio.hashcode.calc_hashcode_string(result, self._choice)
        elif selector == (nds.name.attributes.name_lane_range_attribute_type.NameLaneRangeAttributeType.ADMINISTRATIVE_HIERARCHY):
            result = zserio.hashcode.calc_hashcode_object(result, self._choice)
        elif selector == (nds.name.attributes.name_lane_range_attribute_type.NameLaneRangeAttributeType.HOUSE_NUMBER_RANGE):
            result = zserio.hashcode.calc_hashcode_object(result, self._choice)
        elif selector == (nds.name.attributes.name_lane_range_attribute_type.NameLaneRangeAttributeType.SERVICE_AREA_NAME):
            result = zserio.hashcode.calc_hashcode_string(result, self._choice)
        elif selector == (nds.name.attributes.name_lane_range_attribute_type.NameLaneRangeAttributeType.INTERSECTION_NAME):
            result = zserio.hashcode.calc_hashcode_string(result, self._choice)
        else:
            pass
    ...
    @property
    def type(self) -> nds.name.attributes.name_lane_range_attribute_type.NameLaneRangeAttributeType:
        return self._type_
    ...
    def init_packing_context(self, zserio_context: NameLaneRangeAttributeValue.ZserioPackingContext) -> None:
        selector = self._type_
        ...
        if selector == (nds.name.attributes.name_lane_range_attribute_type.NameLaneRangeAttributeType.ROAD_NAME):
            ...
            raise zserio.PythonRuntimeException("No match in choice NameLaneRangeAttributeValue!")
    ...
    def bitsizeof_packed(self, zserio_context: NameLaneRangeAttributeValue.ZserioPackingContext,
    ...
    def initialize_offsets_packed(self, zserio_context: NameLaneRangeAttributeValue.ZserioPackingContext,
                                  bitposition: int) -> int:
        end_bitposition = bitposition
    ...
    def read_packed(self, zserio_context: NameLaneRangeAttributeValue.ZserioPackingContext,
    ...
    def write_packed(self, zserio_context: NameLaneRangeAttributeValue.ZserioPackingContext,
