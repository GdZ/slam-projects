...
import nds.name.types.road_address_point_reference

class RoadAddressPoint:
    def __init__(
            self,
            type_: typing.Union[nds.name.types.address_point_type.AddressPointType, None] = None,
            access_positions_: typing.Optional[typing.List[nds.name.types.road_address_point_reference.RoadAddressPointReference]] = None,
            postal_position_: typing.Optional[nds.name.types.road_address_point_reference.RoadAddressPointReference] = None) -> None:
        self._type_ = type_
    ...
    @classmethod
    def from_reader(
            cls: typing.Type['RoadAddressPoint'],
            zserio_reader: zserio.BitStreamReader) -> 'RoadAddressPoint':
    ...
    def from_reader_packed(
            cls: typing.Type['RoadAddressPoint'],
            zserio_context: RoadAddressPoint.ZserioPackingContext,
            zserio_reader: zserio.BitStreamReader) -> 'RoadAddressPoint':
        self = object.__new__(cls)
    ...
    def __eq__(self, other: object) -> bool:
        if isinstance(other, RoadAddressPoint):
    ...
    @property
    def access_positions(self) -> typing.Optional[typing.List[nds.name.types.road_address_point_reference.RoadAddressPointReference]]:
        return None if self._access_positions_ is None else self._access_positions_.raw_array

    @access_positions.setter
    def access_positions(self, access_positions_: typing.Optional[typing.List[nds.name.types.road_address_point_reference.RoadAddressPointReference]]) -> None:
        if access_positions_ is None:
            self._access_positions_ = None
        else:
            self._access_positions_ = zserio.array.Array(zserio.array.ObjectArrayTraits(self._ZserioElementFactory_access_positions()), access_positions_, is_auto=True)
    ...
    @property
    def postal_position(self) -> typing.Optional[nds.name.types.road_address_point_reference.RoadAddressPointReference]:
        return self._postal_position_

    @postal_position.setter
    def postal_position(self, postal_position_: typing.Optional[nds.name.types.road_address_point_reference.RoadAddressPointReference]) -> None:
        self._postal_position_ = postal_position_
    ...
    def init_packing_context(self, zserio_context: RoadAddressPoint.ZserioPackingContext) -> None:
    ...
    def bitsizeof_packed(self, zserio_context: RoadAddressPoint.ZserioPackingContext, bitposition: int = 0) -> int:
        end_bitposition = bitposition
    ...
    def initialize_offsets_packed(self, zserio_context: RoadAddressPoint.ZserioPackingContext, bitposition: int) -> int:
        end_bitposition = bitposition
    ...
    def read(self, zserio_reader: zserio.BitStreamReader) -> None:
        ...
        if self.is_access_positions_used():
            ...
            self._access_positions_ = None
        if self.is_postal_position_used():
            self._postal_position_ = nds.name.types.road_address_point_reference.RoadAddressPointReference.from_reader(zserio_reader)
        else:
            self._postal_position_ = None

    def read_packed(self, zserio_context: RoadAddressPoint.ZserioPackingContext, zserio_reader: zserio.BitStreamReader) -> None:
        ...
        if self.is_postal_position_used():
            self._postal_position_ = nds.name.types.road_address_point_reference.RoadAddressPointReference.from_reader_packed(zserio_context.postal_position, zserio_reader)
        else:
            self._postal_position_ = None
    ...
    def write_packed(self, zserio_context: RoadAddressPoint.ZserioPackingContext,
    ...
    class ZserioPackingContext:
        def __init__(self):
            ...
            self._postal_position_ = nds.name.types.road_address_point_reference.RoadAddressPointReference.ZserioPackingContext()
    ...
    class _ZserioElementFactory_access_positions:
        ...
        @staticmethod
        def create(zserio_reader: zserio.BitStreamReader, zserio_index: int) -> nds.name.types.road_address_point_reference.RoadAddressPointReference:
            del zserio_index
            return nds.name.types.road_address_point_reference.RoadAddressPointReference.from_reader(zserio_reader)

        @staticmethod
        def create_packing_context() -> nds.name.types.road_address_point_reference.RoadAddressPointReference.ZserioPackingContext:
            return nds.name.types.road_address_point_reference.RoadAddressPointReference.ZserioPackingContext()

        @staticmethod
        def create_packed(zserio_context: nds.name.types.road_address_point_reference.RoadAddressPointReference.ZserioPackingContext,
                          zserio_reader: zserio.BitStreamReader, zserio_index: int) -> nds.name.types.road_address_point_reference.RoadAddressPointReference:
            del zserio_index
            return nds.name.types.road_address_point_reference.RoadAddressPointReference.from_reader_packed(zserio_context, zserio_reader)
