...
import nds.name.instantiations.name_road_position_attribute_set
import nds.road.reference.types.road_position_validity
import nds.road.reference.types.road_reference

class NameRoadPositionAttributeSetMap:
    def __init__(
            self,
            coord_shift_: nds.core.geometry.coord_shift.CoordShift,
            attribute_set_: typing.Union[nds.name.instantiations.name_road_position_attribute_set.NameRoadPositionAttributeSet, None] = None,
    ...
    @classmethod
    def from_reader(
            cls: typing.Type['NameRoadPositionAttributeSetMap'],
            zserio_reader: zserio.BitStreamReader,
            coord_shift_: nds.core.geometry.coord_shift.CoordShift) -> 'NameRoadPositionAttributeSetMap':
    ...
    def from_reader_packed(
            cls: typing.Type['NameRoadPositionAttributeSetMap'],
            zserio_context: NameRoadPositionAttributeSetMap.ZserioPackingContext,
            zserio_reader: zserio.BitStreamReader,
            coord_shift_: nds.core.geometry.coord_shift.CoordShift) -> 'NameRoadPositionAttributeSetMap':
        self = object.__new__(cls)
        self._coord_shift_ = coord_shift_
    ...
    def __eq__(self, other: object) -> bool:
        if isinstance(other, NameRoadPositionAttributeSetMap):
    ...
    @property
    def attribute_set(self) -> typing.Union[nds.name.instantiations.name_road_position_attribute_set.NameRoadPositionAttributeSet, None]:
        return self._attribute_set_

    @attribute_set.setter
    def attribute_set(self, attribute_set_: typing.Union[nds.name.instantiations.name_road_position_attribute_set.NameRoadPositionAttributeSet, None]) -> None:
        self._attribute_set_ = attribute_set_
    ...
    def init_packing_context(self, zserio_context: NameRoadPositionAttributeSetMap.ZserioPackingContext) -> None:
    ...
    def bitsizeof_packed(self, zserio_context: NameRoadPositionAttributeSetMap.ZserioPackingContext, bitposition: int = 0) -> int:
        end_bitposition = bitposition
    ...
    def initialize_offsets_packed(self, zserio_context: NameRoadPositionAttributeSetMap.ZserioPackingContext, bitposition: int) -> int:
        end_bitposition = bitposition
    ...
    def read(self, zserio_reader: zserio.BitStreamReader) -> None:
        self._attribute_set_ = nds.name.instantiations.name_road_position_attribute_set.NameRoadPositionAttributeSet.from_reader(zserio_reader)
    ...
    def read_packed(self, zserio_context: NameRoadPositionAttributeSetMap.ZserioPackingContext, zserio_reader: zserio.BitStreamReader) -> None:
        self._attribute_set_ = nds.name.instantiations.name_road_position_attribute_set.NameRoadPositionAttributeSet.from_reader_packed(zserio_context.attribute_set, zserio_reader)
    ...
    def write(self, zserio_writer: zserio.BitStreamWriter) -> None:
        ...
        if len(self._references_) != (self._feature_):
            raise zserio.PythonRuntimeException("Wrong array length for field NameRoadPositionAttributeSetMap.references: "
        ...
        if len(self._validities_) != (self._feature_):
            raise zserio.PythonRuntimeException("Wrong array length for field NameRoadPositionAttributeSetMap.validities: "
                                                f"{len(self._validities_)} != {self._feature_}!")
        self._validities_.write_packed(zserio_writer)

    def write_packed(self, zserio_context: NameRoadPositionAttributeSetMap.ZserioPackingContext,
    ...
    class ZserioPackingContext:
        def __init__(self):
            self._attribute_set_ = nds.name.instantiations.name_road_position_attribute_set.NameRoadPositionAttributeSet.ZserioPackingContext()
