...
class NameRoadRangeAttributeMetadata:
    def __init__(
            self,
            available_attributes_: typing.List[nds.name.attributes.name_road_range_attribute_type.NameRoadRangeAttributeType] = None,
    ...
    @classmethod
    def from_reader(
            cls: typing.Type['NameRoadRangeAttributeMetadata'],
            zserio_reader: zserio.BitStreamReader) -> 'NameRoadRangeAttributeMetadata':
    ...
    def from_reader_packed(
            cls: typing.Type['NameRoadRangeAttributeMetadata'],
            zserio_context: NameRoadRangeAttributeMetadata.ZserioPackingContext,
            zserio_reader: zserio.BitStreamReader) -> 'NameRoadRangeAttributeMetadata':
        self = object.__new__(cls)
    ...
    def __eq__(self, other: object) -> bool:
        if isinstance(other, NameRoadRangeAttributeMetadata):
    ...
    @property
    def available_attributes(self) -> typing.List[nds.name.attributes.name_road_range_attribute_type.NameRoadRangeAttributeType]:
        return self._available_attributes_.raw_array

    @available_attributes.setter
    def available_attributes(self, available_attributes_: typing.List[nds.name.attributes.name_road_range_attribute_type.NameRoadRangeAttributeType]) -> None:
        self._available_attributes_ = zserio.array.Array(zserio.array.ObjectArrayTraits(self._ZserioElementFactory_available_attributes()), available_attributes_, is_auto=True)
    ...
    def init_packing_context(self, zserio_context: NameRoadRangeAttributeMetadata.ZserioPackingContext) -> None:
    ...
    def bitsizeof_packed(self, zserio_context: NameRoadRangeAttributeMetadata.ZserioPackingContext, bitposition: int = 0) -> int:
        end_bitposition = bitposition
        end_bitposition += self._available_attributes_.bitsizeof_packed(end_bitposition)
        end_bitposition += self._available_properties_.bitsizeof_packed(end_bitposition)
    ...
    def initialize_offsets_packed(self, zserio_context: NameRoadRangeAttributeMetadata.ZserioPackingContext, bitposition: int) -> int:
        end_bitposition = bitposition
        end_bitposition = self._available_attributes_.initialize_offsets_packed(end_bitposition)
        end_bitposition = self._available_properties_.initialize_offsets_packed(end_bitposition)
    ...
    def read_packed(self, zserio_context: NameRoadRangeAttributeMetadata.ZserioPackingContext, zserio_reader: zserio.BitStreamReader) -> None:
        self._available_attributes_ = zserio.array.Array.from_reader_packed(zserio.array.ObjectArrayTraits(self._ZserioElementFactory_available_attributes()), zserio_reader, is_auto=True)
    ...
    def write_packed(self, zserio_context: NameRoadRangeAttributeMetadata.ZserioPackingContext,
