...
import nds.display.reference.types.display_area_id
import nds.display.reference.types.display_area_validity
import nds.name.attributes.name_display_area_attribute_type
import nds.name.instantiations.name_display_area_attribute
...
class NameDisplayAreaAttributeMap:
    def __init__(
            ...
            attribute_type_code_: typing.Union[nds.name.attributes.name_display_area_attribute_type.NameDisplayAreaAttributeType, None] = None,
            feature_: nds.core.attributemap.feature_iterator.FeatureIterator = nds.core.attributemap.feature_iterator.FeatureIterator(),
            feature_references_: typing.List[nds.display.reference.types.display_area_id.DisplayAreaId] = None,
            feature_validities_: typing.List[nds.display.reference.types.display_area_validity.DisplayAreaValidity] = None,
            ...
            attribute_values_: typing.List[nds.name.instantiations.name_display_area_attribute.NameDisplayAreaAttribute] = None,
    ...
    @classmethod
    def from_reader(
            cls: typing.Type['NameDisplayAreaAttributeMap'],
            zserio_reader: zserio.BitStreamReader,
            coord_shift_: nds.core.geometry.coord_shift.CoordShift) -> 'NameDisplayAreaAttributeMap':
    ...
    def from_reader_packed(
            cls: typing.Type['NameDisplayAreaAttributeMap'],
            zserio_context: NameDisplayAreaAttributeMap.ZserioPackingContext,
            zserio_reader: zserio.BitStreamReader,
            coord_shift_: nds.core.geometry.coord_shift.CoordShift) -> 'NameDisplayAreaAttributeMap':
        self = object.__new__(cls)
        self._coord_shift_ = coord_shift_
    ...
    def __eq__(self, other: object) -> bool:
        if isinstance(other, NameDisplayAreaAttributeMap):
    ...
    @property
    def attribute_type_code(self) -> typing.Union[nds.name.attributes.name_display_area_attribute_type.NameDisplayAreaAttributeType, None]:
        return self._attribute_type_code_

    @attribute_type_code.setter
    def attribute_type_code(self, attribute_type_code_: typing.Union[nds.name.attributes.name_display_area_attribute_type.NameDisplayAreaAttributeType, None]) -> None:
        self._attribute_type_code_ = attribute_type_code_
    ...
    @property
    def feature_references(self) -> typing.List[nds.display.reference.types.display_area_id.DisplayAreaId]:
        return self._feature_references_.raw_array

    @feature_references.setter
    def feature_references(self, feature_references_: typing.List[nds.display.reference.types.display_area_id.DisplayAreaId]) -> None:
        self._feature_references_ = zserio.array.Array(zserio.array.ObjectArrayTraits(self._ZserioElementFactory_feature_references()), feature_references_)

    @property
    def feature_validities(self) -> typing.List[nds.display.reference.types.display_area_validity.DisplayAreaValidity]:
        return self._feature_validities_.raw_array

    @feature_validities.setter
    def feature_validities(self, feature_validities_: typing.List[nds.display.reference.types.display_area_validity.DisplayAreaValidity]) -> None:
        self._feature_validities_ = zserio.array.Array(zserio.array.ObjectArrayTraits(self._ZserioElementFactory_feature_validities(self)), feature_validities_)
    ...
    @property
    def attribute_values(self) -> typing.List[nds.name.instantiations.name_display_area_attribute.NameDisplayAreaAttribute]:
        return self._attribute_values_.raw_array

    @attribute_values.setter
    def attribute_values(self, attribute_values_: typing.List[nds.name.instantiations.name_display_area_attribute.NameDisplayAreaAttribute]) -> None:
        self._attribute_values_ = zserio.array.Array(zserio.array.ObjectArrayTraits(self._ZserioElementFactory_attribute_values(self)), attribute_values_)
    ...
    def init_packing_context(self, zserio_context: NameDisplayAreaAttributeMap.ZserioPackingContext) -> None:
    ...
    def bitsizeof_packed(self, zserio_context: NameDisplayAreaAttributeMap.ZserioPackingContext, bitposition: int = 0) -> int:
        end_bitposition = bitposition
    ...
    def initialize_offsets_packed(self, zserio_context: NameDisplayAreaAttributeMap.ZserioPackingContext, bitposition: int) -> int:
        end_bitposition = bitposition
    ...
    def read(self, zserio_reader: zserio.BitStreamReader) -> None:
        self._attribute_type_code_ = nds.name.attributes.name_display_area_attribute_type.NameDisplayAreaAttributeType.from_reader(zserio_reader)
    ...
    def read_packed(self, zserio_context: NameDisplayAreaAttributeMap.ZserioPackingContext, zserio_reader: zserio.BitStreamReader) -> None:
        self._attribute_type_code_ = nds.name.attributes.name_display_area_attribute_type.NameDisplayAreaAttributeType.from_reader_packed(zserio_context.attribute_type_code, zserio_reader)
    ...
    def write(self, zserio_writer: zserio.BitStreamWriter) -> None:
        ...
        if len(self._feature_references_) != (self._feature_):
            raise zserio.PythonRuntimeException("Wrong array length for field NameDisplayAreaAttributeMap.featureReferences: "
        ...
        if len(self._feature_validities_) != (self._feature_):
            raise zserio.PythonRuntimeException("Wrong array length for field NameDisplayAreaAttributeMap.featureValidities: "
        ...
        if len(self._feature_value_ptr_) != (self._feature_):
            raise zserio.PythonRuntimeException("Wrong array length for field NameDisplayAreaAttributeMap.featureValuePtr: "
        ...
        if len(self._attribute_values_) != (self._attribute_):
            raise zserio.PythonRuntimeException("Wrong array length for field NameDisplayAreaAttributeMap.attributeValues: "
        ...
        if len(self._attribute_properties_) != (self._attribute_):
            raise zserio.PythonRuntimeException("Wrong array length for field NameDisplayAreaAttributeMap.attributeProperties: "
        ...
        if len(self._attribute_conditions_) != (self._attribute_):
            raise zserio.PythonRuntimeException("Wrong array length for field NameDisplayAreaAttributeMap.attributeConditions: "
                                                f"{len(self._attribute_conditions_)} != {self._attribute_}!")
        self._attribute_conditions_.write_packed(zserio_writer)

    def write_packed(self, zserio_context: NameDisplayAreaAttributeMap.ZserioPackingContext,
    ...
    class _ZserioElementFactory_feature_references:
        ...
        @staticmethod
        def create(zserio_reader: zserio.BitStreamReader, zserio_index: int) -> nds.display.reference.types.display_area_id.DisplayAreaId:
            del zserio_index
            return nds.display.reference.types.display_area_id.DisplayAreaId.from_reader(zserio_reader)

        @staticmethod
        def create_packing_context() -> nds.display.reference.types.display_area_id.DisplayAreaId.ZserioPackingContext:
            return nds.display.reference.types.display_area_id.DisplayAreaId.ZserioPackingContext()

        @staticmethod
        def create_packed(zserio_context: nds.display.reference.types.display_area_id.DisplayAreaId.ZserioPackingContext,
                          zserio_reader: zserio.BitStreamReader, zserio_index: int) -> nds.display.reference.types.display_area_id.DisplayAreaId:
            del zserio_index
            return nds.display.reference.types.display_area_id.DisplayAreaId.from_reader_packed(zserio_context, zserio_reader)
    ...
    class _ZserioElementFactory_feature_validities:
        ...
        def create(self, zserio_reader: zserio.BitStreamReader, zserio_index: int) -> nds.display.reference.types.display_area_validity.DisplayAreaValidity:
            del zserio_index
            return nds.display.reference.types.display_area_validity.DisplayAreaValidity.from_reader(zserio_reader, self._owner._coord_shift_)

        @staticmethod
        def create_packing_context() -> nds.display.reference.types.display_area_validity.DisplayAreaValidity.ZserioPackingContext:
            return nds.display.reference.types.display_area_validity.DisplayAreaValidity.ZserioPackingContext()

        def create_packed(self, zserio_context: nds.display.reference.types.display_area_validity.DisplayAreaValidity.ZserioPackingContext,
                          zserio_reader: zserio.BitStreamReader, zserio_index: int) -> nds.display.reference.types.display_area_validity.DisplayAreaValidity:
            del zserio_index
            return nds.display.reference.types.display_area_validity.DisplayAreaValidity.from_reader_packed(zserio_context, zserio_reader, self._owner._coord_shift_)
    ...
    class _ZserioElementFactory_attribute_values:
        ...
        def create(self, zserio_reader: zserio.BitStreamReader, zserio_index: int) -> nds.name.instantiations.name_display_area_attribute.NameDisplayAreaAttribute:
            del zserio_index
            return nds.name.instantiations.name_display_area_attribute.NameDisplayAreaAttribute.from_reader(zserio_reader, self._owner._attribute_type_code_)

        @staticmethod
        def create_packing_context() -> nds.name.instantiations.name_display_area_attribute.NameDisplayAreaAttribute.ZserioPackingContext:
            return nds.name.instantiations.name_display_area_attribute.NameDisplayAreaAttribute.ZserioPackingContext()

        def create_packed(self, zserio_context: nds.name.instantiations.name_display_area_attribute.NameDisplayAreaAttribute.ZserioPackingContext,
                          zserio_reader: zserio.BitStreamReader, zserio_index: int) -> nds.name.instantiations.name_display_area_attribute.NameDisplayAreaAttribute:
            del zserio_index
            return nds.name.instantiations.name_display_area_attribute.NameDisplayAreaAttribute.from_reader_packed(zserio_context, zserio_reader, self._owner._attribute_type_code_)
