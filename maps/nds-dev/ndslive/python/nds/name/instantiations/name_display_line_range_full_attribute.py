...
import nds.name.attributes.name_display_line_range_attribute_value
import nds.name.instantiations.name_property_list

class NameDisplayLineRangeFullAttribute:
    def __init__(
            self,
            ...
            attribute_value_: typing.Union[nds.name.attributes.name_display_line_range_attribute_value.NameDisplayLineRangeAttributeValue, None] = None,
            properties_: typing.Optional[nds.name.instantiations.name_property_list.NamePropertyList] = None,
    ...
    @classmethod
    def from_reader(
            cls: typing.Type['NameDisplayLineRangeFullAttribute'],
            zserio_reader: zserio.BitStreamReader) -> 'NameDisplayLineRangeFullAttribute':
    ...
    def from_reader_packed(
            cls: typing.Type['NameDisplayLineRangeFullAttribute'],
            zserio_context: NameDisplayLineRangeFullAttribute.ZserioPackingContext,
            zserio_reader: zserio.BitStreamReader) -> 'NameDisplayLineRangeFullAttribute':
        self = object.__new__(cls)
    ...
    def __eq__(self, other: object) -> bool:
        if isinstance(other, NameDisplayLineRangeFullAttribute):
    ...
    @property
    def attribute_value(self) -> typing.Union[nds.name.attributes.name_display_line_range_attribute_value.NameDisplayLineRangeAttributeValue, None]:
        return self._attribute_value_

    @attribute_value.setter
    def attribute_value(self, attribute_value_: typing.Union[nds.name.attributes.name_display_line_range_attribute_value.NameDisplayLineRangeAttributeValue, None]) -> None:
        self._attribute_value_ = attribute_value_

    @property
    def properties(self) -> typing.Optional[nds.name.instantiations.name_property_list.NamePropertyList]:
        return self._properties_

    @properties.setter
    def properties(self, properties_: typing.Optional[nds.name.instantiations.name_property_list.NamePropertyList]) -> None:
        self._properties_ = properties_
    ...
    def init_packing_context(self, zserio_context: NameDisplayLineRangeFullAttribute.ZserioPackingContext) -> None:
    ...
    def bitsizeof_packed(self, zserio_context: NameDisplayLineRangeFullAttribute.ZserioPackingContext, bitposition: int = 0) -> int:
        end_bitposition = bitposition
    ...
    def initialize_offsets_packed(self, zserio_context: NameDisplayLineRangeFullAttribute.ZserioPackingContext, bitposition: int) -> int:
        end_bitposition = bitposition
    ...
    def read(self, zserio_reader: zserio.BitStreamReader) -> None:
        ...
        self._attribute_value_ = nds.name.attributes.name_display_line_range_attribute_value.NameDisplayLineRangeAttributeValue.from_reader(zserio_reader, self._attribute_type_code_)
        if zserio_reader.read_bool():
            self._properties_ = nds.name.instantiations.name_property_list.NamePropertyList.from_reader(zserio_reader)
        else:
            self._properties_ = None
        if zserio_reader.read_bool():
    ...
    def read_packed(self, zserio_context: NameDisplayLineRangeFullAttribute.ZserioPackingContext, zserio_reader: zserio.BitStreamReader) -> None:
        ...
        self._attribute_value_ = nds.name.attributes.name_display_line_range_attribute_value.NameDisplayLineRangeAttributeValue.from_reader_packed(zserio_context.attribute_value, zserio_reader, self._attribute_type_code_)

        if zserio_reader.read_bool():
            self._properties_ = nds.name.instantiations.name_property_list.NamePropertyList.from_reader_packed(zserio_context.properties, zserio_reader)
        else:
            self._properties_ = None
    ...
    def write(self, zserio_writer: zserio.BitStreamWriter) -> None:
        ...
        if self._attribute_value_.type is not (self._attribute_type_code_):
            raise zserio.PythonRuntimeException("Wrong parameter type for field NameDisplayLineRangeFullAttribute.attributeValue: "
    ...
    def write_packed(self, zserio_context: NameDisplayLineRangeFullAttribute.ZserioPackingContext,
    ...
    class ZserioPackingContext:
        def __init__(self):
            ...
            self._attribute_value_ = nds.name.attributes.name_display_line_range_attribute_value.NameDisplayLineRangeAttributeValue.ZserioPackingContext()
            self._properties_ = nds.name.instantiations.name_property_list.NamePropertyList.ZserioPackingContext()
