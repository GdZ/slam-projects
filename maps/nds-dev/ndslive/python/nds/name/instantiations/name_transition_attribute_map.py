...
import nds.name.instantiations.name_transition_attribute
import nds.road.reference.types.transition_reference

class NameTransitionAttributeMap:
    def __init__(
            self,
            coord_shift_: nds.core.geometry.coord_shift.CoordShift,
            attribute_type_code_: typing.Union[nds.name.attributes.name_transition_attribute_type.NameTransitionAttributeType, None] = None,
            ...
            attribute_values_: typing.List[nds.name.instantiations.name_transition_attribute.NameTransitionAttribute] = None,
    ...
    @classmethod
    def from_reader(
            cls: typing.Type['NameTransitionAttributeMap'],
            zserio_reader: zserio.BitStreamReader,
            coord_shift_: nds.core.geometry.coord_shift.CoordShift) -> 'NameTransitionAttributeMap':
    ...
    def from_reader_packed(
            cls: typing.Type['NameTransitionAttributeMap'],
            zserio_context: NameTransitionAttributeMap.ZserioPackingContext,
            zserio_reader: zserio.BitStreamReader,
            coord_shift_: nds.core.geometry.coord_shift.CoordShift) -> 'NameTransitionAttributeMap':
        self = object.__new__(cls)
        self._coord_shift_ = coord_shift_
    ...
    def __eq__(self, other: object) -> bool:
        if isinstance(other, NameTransitionAttributeMap):
    ...
    @property
    def attribute_type_code(self) -> typing.Union[nds.name.attributes.name_transition_attribute_type.NameTransitionAttributeType, None]:
        return self._attribute_type_code_

    @attribute_type_code.setter
    def attribute_type_code(self, attribute_type_code_: typing.Union[nds.name.attributes.name_transition_attribute_type.NameTransitionAttributeType, None]) -> None:
        self._attribute_type_code_ = attribute_type_code_
    ...
    @property
    def attribute_values(self) -> typing.List[nds.name.instantiations.name_transition_attribute.NameTransitionAttribute]:
        return self._attribute_values_.raw_array

    @attribute_values.setter
    def attribute_values(self, attribute_values_: typing.List[nds.name.instantiations.name_transition_attribute.NameTransitionAttribute]) -> None:
        self._attribute_values_ = zserio.array.Array(zserio.array.ObjectArrayTraits(self._ZserioElementFactory_attribute_values(self)), attribute_values_)
    ...
    def init_packing_context(self, zserio_context: NameTransitionAttributeMap.ZserioPackingContext) -> None:
    ...
    def bitsizeof(self, bitposition: int = 0) -> int:
        ...
        end_bitposition += self._attribute_values_.bitsizeof(end_bitposition)
        end_bitposition = zserio.bitposition.alignto(8, end_bitposition)
    ...
    def bitsizeof_packed(self, zserio_context: NameTransitionAttributeMap.ZserioPackingContext, bitposition: int = 0) -> int:
        end_bitposition = bitposition
    ...
    def initialize_offsets(self, bitposition: int = 0) -> int:
        ...
        end_bitposition += zserio.bitsizeof.bitsizeof_varsize(self._attribute_)
        end_bitposition = self._attribute_values_.initialize_offsets(end_bitposition)
        end_bitposition = zserio.bitposition.alignto(8, end_bitposition)
    ...
    def initialize_offsets_packed(self, zserio_context: NameTransitionAttributeMap.ZserioPackingContext, bitposition: int) -> int:
        end_bitposition = bitposition
    ...
    def read(self, zserio_reader: zserio.BitStreamReader) -> None:
        self._attribute_type_code_ = nds.name.attributes.name_transition_attribute_type.NameTransitionAttributeType.from_reader(zserio_reader)
        ...
        self._attribute_values_ = zserio.array.Array.from_reader(zserio.array.ObjectArrayTraits(self._ZserioElementFactory_attribute_values(self)), zserio_reader, self._attribute_)
        zserio_reader.alignto(8)
    ...
    def read_packed(self, zserio_context: NameTransitionAttributeMap.ZserioPackingContext, zserio_reader: zserio.BitStreamReader) -> None:
        self._attribute_type_code_ = nds.name.attributes.name_transition_attribute_type.NameTransitionAttributeType.from_reader_packed(zserio_context.attribute_type_code, zserio_reader)
    ...
    def write(self, zserio_writer: zserio.BitStreamWriter) -> None:
        ...
        if len(self._feature_references_) != (self._feature_):
            raise zserio.PythonRuntimeException("Wrong array length for field NameTransitionAttributeMap.featureReferences: "
        ...
        if len(self._feature_validities_) != (self._feature_):
            raise zserio.PythonRuntimeException("Wrong array length for field NameTransitionAttributeMap.featureValidities: "
        ...
        if len(self._feature_value_ptr_) != (self._feature_):
            raise zserio.PythonRuntimeException("Wrong array length for field NameTransitionAttributeMap.featureValuePtr: "
        ...
        if len(self._attribute_values_) != (self._attribute_):
            raise zserio.PythonRuntimeException("Wrong array length for field NameTransitionAttributeMap.attributeValues: "
                                                f"{len(self._attribute_values_)} != {self._attribute_}!")
        self._attribute_values_.write(zserio_writer)

        zserio_writer.alignto(8)
        # check array length
        if len(self._attribute_properties_) != (self._attribute_):
            raise zserio.PythonRuntimeException("Wrong array length for field NameTransitionAttributeMap.attributeProperties: "
        ...
        if len(self._attribute_conditions_) != (self._attribute_):
            raise zserio.PythonRuntimeException("Wrong array length for field NameTransitionAttributeMap.attributeConditions: "
                                                f"{len(self._attribute_conditions_)} != {self._attribute_}!")
        self._attribute_conditions_.write_packed(zserio_writer)

    def write_packed(self, zserio_context: NameTransitionAttributeMap.ZserioPackingContext,
    ...
    class _ZserioElementFactory_attribute_values:
        ...
        def create(self, zserio_reader: zserio.BitStreamReader, zserio_index: int) -> nds.name.instantiations.name_transition_attribute.NameTransitionAttribute:
            del zserio_index
            return nds.name.instantiations.name_transition_attribute.NameTransitionAttribute.from_reader(zserio_reader, self._owner._attribute_type_code_)
