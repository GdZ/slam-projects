...
import nds.name.instantiations.name_transition_attribute_set
...
class NameTransitionAttributeSetMap:
    def __init__(
            ...
            attribute_set_: typing.Union[nds.name.instantiations.name_transition_attribute_set.NameTransitionAttributeSet, None] = None,
    ...
    @classmethod
    def from_reader(
            cls: typing.Type['NameTransitionAttributeSetMap'],
            zserio_reader: zserio.BitStreamReader,
            coord_shift_: nds.core.geometry.coord_shift.CoordShift) -> 'NameTransitionAttributeSetMap':
    ...
    def from_reader_packed(
            cls: typing.Type['NameTransitionAttributeSetMap'],
            zserio_context: NameTransitionAttributeSetMap.ZserioPackingContext,
            zserio_reader: zserio.BitStreamReader,
            coord_shift_: nds.core.geometry.coord_shift.CoordShift) -> 'NameTransitionAttributeSetMap':
        self = object.__new__(cls)
        self._coord_shift_ = coord_shift_
    ...
    def __eq__(self, other: object) -> bool:
        if isinstance(other, NameTransitionAttributeSetMap):
    ...
    @property
    def attribute_set(self) -> typing.Union[nds.name.instantiations.name_transition_attribute_set.NameTransitionAttributeSet, None]:
        return self._attribute_set_

    @attribute_set.setter
    def attribute_set(self, attribute_set_: typing.Union[nds.name.instantiations.name_transition_attribute_set.NameTransitionAttributeSet, None]) -> None:
        self._attribute_set_ = attribute_set_
    ...
    def init_packing_context(self, zserio_context: NameTransitionAttributeSetMap.ZserioPackingContext) -> None:
    ...
    def bitsizeof_packed(self, zserio_context: NameTransitionAttributeSetMap.ZserioPackingContext, bitposition: int = 0) -> int:
        end_bitposition = bitposition
    ...
    def initialize_offsets_packed(self, zserio_context: NameTransitionAttributeSetMap.ZserioPackingContext, bitposition: int) -> int:
        end_bitposition = bitposition
    ...
    def read(self, zserio_reader: zserio.BitStreamReader) -> None:
        self._attribute_set_ = nds.name.instantiations.name_transition_attribute_set.NameTransitionAttributeSet.from_reader(zserio_reader)
    ...
    def read_packed(self, zserio_context: NameTransitionAttributeSetMap.ZserioPackingContext, zserio_reader: zserio.BitStreamReader) -> None:
        self._attribute_set_ = nds.name.instantiations.name_transition_attribute_set.NameTransitionAttributeSet.from_reader_packed(zserio_context.attribute_set, zserio_reader)
    ...
    def write(self, zserio_writer: zserio.BitStreamWriter) -> None:
        ...
        if len(self._references_) != (self._feature_):
            raise zserio.PythonRuntimeException("Wrong array length for field NameTransitionAttributeSetMap.references: "
        ...
        if len(self._validities_) != (self._feature_):
            raise zserio.PythonRuntimeException("Wrong array length for field NameTransitionAttributeSetMap.validities: "
                                                f"{len(self._validities_)} != {self._feature_}!")
        self._validities_.write(zserio_writer)

    def write_packed(self, zserio_context: NameTransitionAttributeSetMap.ZserioPackingContext,
    ...
    class ZserioPackingContext:
        def __init__(self):
            self._attribute_set_ = nds.name.instantiations.name_transition_attribute_set.NameTransitionAttributeSet.ZserioPackingContext()
