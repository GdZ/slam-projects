...
import nds.name.instantiations.name_road_range_attribute_set
...
class NameRoadRangeAttributeSetMap:
    def __init__(
            ...
            attribute_set_: typing.Union[nds.name.instantiations.name_road_range_attribute_set.NameRoadRangeAttributeSet, None] = None,
    ...
    @classmethod
    def from_reader(
            cls: typing.Type['NameRoadRangeAttributeSetMap'],
            zserio_reader: zserio.BitStreamReader,
            coord_shift_: nds.core.geometry.coord_shift.CoordShift) -> 'NameRoadRangeAttributeSetMap':
    ...
    def from_reader_packed(
            cls: typing.Type['NameRoadRangeAttributeSetMap'],
            zserio_context: NameRoadRangeAttributeSetMap.ZserioPackingContext,
            zserio_reader: zserio.BitStreamReader,
            coord_shift_: nds.core.geometry.coord_shift.CoordShift) -> 'NameRoadRangeAttributeSetMap':
        self = object.__new__(cls)
        self._coord_shift_ = coord_shift_
    ...
    def __eq__(self, other: object) -> bool:
        if isinstance(other, NameRoadRangeAttributeSetMap):
    ...
    @property
    def attribute_set(self) -> typing.Union[nds.name.instantiations.name_road_range_attribute_set.NameRoadRangeAttributeSet, None]:
        return self._attribute_set_

    @attribute_set.setter
    def attribute_set(self, attribute_set_: typing.Union[nds.name.instantiations.name_road_range_attribute_set.NameRoadRangeAttributeSet, None]) -> None:
        self._attribute_set_ = attribute_set_
    ...
    def init_packing_context(self, zserio_context: NameRoadRangeAttributeSetMap.ZserioPackingContext) -> None:
    ...
    def bitsizeof_packed(self, zserio_context: NameRoadRangeAttributeSetMap.ZserioPackingContext, bitposition: int = 0) -> int:
        end_bitposition = bitposition
    ...
    def initialize_offsets_packed(self, zserio_context: NameRoadRangeAttributeSetMap.ZserioPackingContext, bitposition: int) -> int:
        end_bitposition = bitposition
    ...
    def read(self, zserio_reader: zserio.BitStreamReader) -> None:
        self._attribute_set_ = nds.name.instantiations.name_road_range_attribute_set.NameRoadRangeAttributeSet.from_reader(zserio_reader)
    ...
    def read_packed(self, zserio_context: NameRoadRangeAttributeSetMap.ZserioPackingContext, zserio_reader: zserio.BitStreamReader) -> None:
        self._attribute_set_ = nds.name.instantiations.name_road_range_attribute_set.NameRoadRangeAttributeSet.from_reader_packed(zserio_context.attribute_set, zserio_reader)
    ...
    def write(self, zserio_writer: zserio.BitStreamWriter) -> None:
        ...
        if len(self._references_) != (self._feature_):
            raise zserio.PythonRuntimeException("Wrong array length for field NameRoadRangeAttributeSetMap.references: "
        ...
        if len(self._validities_) != (self._feature_):
            raise zserio.PythonRuntimeException("Wrong array length for field NameRoadRangeAttributeSetMap.validities: "
                                                f"{len(self._validities_)} != {self._feature_}!")
        self._validities_.write_packed(zserio_writer)

    def write_packed(self, zserio_context: NameRoadRangeAttributeSetMap.ZserioPackingContext,
    ...
    class ZserioPackingContext:
        def __init__(self):
            self._attribute_set_ = nds.name.instantiations.name_road_range_attribute_set.NameRoadRangeAttributeSet.ZserioPackingContext()
