...
import nds.name.instantiations.name_display_line_range_attribute
import nds.name.instantiations.name_property_list

class NameDisplayLineRangeAttributeMap:
    def __init__(
            self,
            coord_shift_: nds.core.geometry.coord_shift.CoordShift,
            attribute_type_code_: typing.Union[nds.name.attributes.name_display_line_range_attribute_type.NameDisplayLineRangeAttributeType, None] = None,
            ...
            attribute_values_: typing.List[nds.name.instantiations.name_display_line_range_attribute.NameDisplayLineRangeAttribute] = None,
            attribute_properties_: typing.List[nds.name.instantiations.name_property_list.NamePropertyList] = None,
    ...
    @classmethod
    def from_reader(
            cls: typing.Type['NameDisplayLineRangeAttributeMap'],
            zserio_reader: zserio.BitStreamReader,
            coord_shift_: nds.core.geometry.coord_shift.CoordShift) -> 'NameDisplayLineRangeAttributeMap':
    ...
    def from_reader_packed(
            cls: typing.Type['NameDisplayLineRangeAttributeMap'],
            zserio_context: NameDisplayLineRangeAttributeMap.ZserioPackingContext,
            zserio_reader: zserio.BitStreamReader,
            coord_shift_: nds.core.geometry.coord_shift.CoordShift) -> 'NameDisplayLineRangeAttributeMap':
        self = object.__new__(cls)
        self._coord_shift_ = coord_shift_
    ...
    def __eq__(self, other: object) -> bool:
        if isinstance(other, NameDisplayLineRangeAttributeMap):
    ...
    @property
    def attribute_type_code(self) -> typing.Union[nds.name.attributes.name_display_line_range_attribute_type.NameDisplayLineRangeAttributeType, None]:
        return self._attribute_type_code_

    @attribute_type_code.setter
    def attribute_type_code(self, attribute_type_code_: typing.Union[nds.name.attributes.name_display_line_range_attribute_type.NameDisplayLineRangeAttributeType, None]) -> None:
        self._attribute_type_code_ = attribute_type_code_
    ...
    @property
    def attribute_values(self) -> typing.List[nds.name.instantiations.name_display_line_range_attribute.NameDisplayLineRangeAttribute]:
        return self._attribute_values_.raw_array

    @attribute_values.setter
    def attribute_values(self, attribute_values_: typing.List[nds.name.instantiations.name_display_line_range_attribute.NameDisplayLineRangeAttribute]) -> None:
        self._attribute_values_ = zserio.array.Array(zserio.array.ObjectArrayTraits(self._ZserioElementFactory_attribute_values(self)), attribute_values_)

    @property
    def attribute_properties(self) -> typing.List[nds.name.instantiations.name_property_list.NamePropertyList]:
        return self._attribute_properties_.raw_array

    @attribute_properties.setter
    def attribute_properties(self, attribute_properties_: typing.List[nds.name.instantiations.name_property_list.NamePropertyList]) -> None:
        self._attribute_properties_ = zserio.array.Array(zserio.array.ObjectArrayTraits(self._ZserioElementFactory_attribute_properties()), attribute_properties_)
    ...
    def init_packing_context(self, zserio_context: NameDisplayLineRangeAttributeMap.ZserioPackingContext) -> None:
    ...
    def bitsizeof_packed(self, zserio_context: NameDisplayLineRangeAttributeMap.ZserioPackingContext, bitposition: int = 0) -> int:
        end_bitposition = bitposition
    ...
    def initialize_offsets_packed(self, zserio_context: NameDisplayLineRangeAttributeMap.ZserioPackingContext, bitposition: int) -> int:
        end_bitposition = bitposition
    ...
    def read(self, zserio_reader: zserio.BitStreamReader) -> None:
        self._attribute_type_code_ = nds.name.attributes.name_display_line_range_attribute_type.NameDisplayLineRangeAttributeType.from_reader(zserio_reader)
    ...
    def read_packed(self, zserio_context: NameDisplayLineRangeAttributeMap.ZserioPackingContext, zserio_reader: zserio.BitStreamReader) -> None:
        self._attribute_type_code_ = nds.name.attributes.name_display_line_range_attribute_type.NameDisplayLineRangeAttributeType.from_reader_packed(zserio_context.attribute_type_code, zserio_reader)
    ...
    def write(self, zserio_writer: zserio.BitStreamWriter) -> None:
        ...
        if len(self._feature_references_) != (self._feature_):
            raise zserio.PythonRuntimeException("Wrong array length for field NameDisplayLineRangeAttributeMap.featureReferences: "
        ...
        if len(self._feature_validities_) != (self._feature_):
            raise zserio.PythonRuntimeException("Wrong array length for field NameDisplayLineRangeAttributeMap.featureValidities: "
        ...
        if len(self._feature_value_ptr_) != (self._feature_):
            raise zserio.PythonRuntimeException("Wrong array length for field NameDisplayLineRangeAttributeMap.featureValuePtr: "
        ...
        if len(self._attribute_values_) != (self._attribute_):
            raise zserio.PythonRuntimeException("Wrong array length for field NameDisplayLineRangeAttributeMap.attributeValues: "
        ...
        if len(self._attribute_properties_) != (self._attribute_):
            raise zserio.PythonRuntimeException("Wrong array length for field NameDisplayLineRangeAttributeMap.attributeProperties: "
        ...
        if len(self._attribute_conditions_) != (self._attribute_):
            raise zserio.PythonRuntimeException("Wrong array length for field NameDisplayLineRangeAttributeMap.attributeConditions: "
                                                f"{len(self._attribute_conditions_)} != {self._attribute_}!")
        self._attribute_conditions_.write_packed(zserio_writer)

    def write_packed(self, zserio_context: NameDisplayLineRangeAttributeMap.ZserioPackingContext,
    ...
    class _ZserioElementFactory_attribute_values:
        ...
        def create(self, zserio_reader: zserio.BitStreamReader, zserio_index: int) -> nds.name.instantiations.name_display_line_range_attribute.NameDisplayLineRangeAttribute:
            del zserio_index
            return nds.name.instantiations.name_display_line_range_attribute.NameDisplayLineRangeAttribute.from_reader(zserio_reader, self._owner._attribute_type_code_)

        @staticmethod
        def create_packing_context() -> nds.name.instantiations.name_display_line_range_attribute.NameDisplayLineRangeAttribute.ZserioPackingContext:
            return nds.name.instantiations.name_display_line_range_attribute.NameDisplayLineRangeAttribute.ZserioPackingContext()

        def create_packed(self, zserio_context: nds.name.instantiations.name_display_line_range_attribute.NameDisplayLineRangeAttribute.ZserioPackingContext,
                          zserio_reader: zserio.BitStreamReader, zserio_index: int) -> nds.name.instantiations.name_display_line_range_attribute.NameDisplayLineRangeAttribute:
            del zserio_index
            return nds.name.instantiations.name_display_line_range_attribute.NameDisplayLineRangeAttribute.from_reader_packed(zserio_context, zserio_reader, self._owner._attribute_type_code_)

    class _ZserioElementFactory_attribute_properties:
        IS_OBJECT_PACKABLE = True

        @staticmethod
        def create(zserio_reader: zserio.BitStreamReader, zserio_index: int) -> nds.name.instantiations.name_property_list.NamePropertyList:
            del zserio_index
            return nds.name.instantiations.name_property_list.NamePropertyList.from_reader(zserio_reader)

        @staticmethod
        def create_packing_context() -> nds.name.instantiations.name_property_list.NamePropertyList.ZserioPackingContext:
            return nds.name.instantiations.name_property_list.NamePropertyList.ZserioPackingContext()

        @staticmethod
        def create_packed(zserio_context: nds.name.instantiations.name_property_list.NamePropertyList.ZserioPackingContext,
                          zserio_reader: zserio.BitStreamReader, zserio_index: int) -> nds.name.instantiations.name_property_list.NamePropertyList:
            del zserio_index
            return nds.name.instantiations.name_property_list.NamePropertyList.from_reader_packed(zserio_context, zserio_reader)
