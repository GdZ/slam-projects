...
class NameDisplayPointAttributeMapListHeader:
    def __init__(
            self,
            num_maps_: int,
            attribute_type_code_: typing.List[nds.name.attributes.name_display_point_attribute_type.NameDisplayPointAttributeType] = None,
    ...
    @classmethod
    def from_reader(
            cls: typing.Type['NameDisplayPointAttributeMapListHeader'],
            zserio_reader: zserio.BitStreamReader,
            num_maps_: int) -> 'NameDisplayPointAttributeMapListHeader':
    ...
    def from_reader_packed(
            cls: typing.Type['NameDisplayPointAttributeMapListHeader'],
            zserio_context: NameDisplayPointAttributeMapListHeader.ZserioPackingContext,
            zserio_reader: zserio.BitStreamReader,
            num_maps_: int) -> 'NameDisplayPointAttributeMapListHeader':
        self = object.__new__(cls)
        self._num_maps_ = num_maps_
    ...
    def __eq__(self, other: object) -> bool:
        if isinstance(other, NameDisplayPointAttributeMapListHeader):
    ...
    @property
    def attribute_type_code(self) -> typing.List[nds.name.attributes.name_display_point_attribute_type.NameDisplayPointAttributeType]:
        return self._attribute_type_code_.raw_array

    @attribute_type_code.setter
    def attribute_type_code(self, attribute_type_code_: typing.List[nds.name.attributes.name_display_point_attribute_type.NameDisplayPointAttributeType]) -> None:
        self._attribute_type_code_ = zserio.array.Array(zserio.array.ObjectArrayTraits(self._ZserioElementFactory_attribute_type_code()), attribute_type_code_)
    ...
    def init_packing_context(self, zserio_context: NameDisplayPointAttributeMapListHeader.ZserioPackingContext) -> None:
        del zserio_context
    ...
    def bitsizeof_packed(self, zserio_context: NameDisplayPointAttributeMapListHeader.ZserioPackingContext, bitposition: int = 0) -> int:
        del zserio_context
    ...
    def initialize_offsets_packed(self, zserio_context: NameDisplayPointAttributeMapListHeader.ZserioPackingContext, bitposition: int) -> int:
        del zserio_context
    ...
    def read_packed(self, zserio_context: NameDisplayPointAttributeMapListHeader.ZserioPackingContext, zserio_reader: zserio.BitStreamReader) -> None:
        del zserio_context
    ...
    def write(self, zserio_writer: zserio.BitStreamWriter) -> None:
        ...
        if len(self._attribute_type_code_) != (self._num_maps_):
            raise zserio.PythonRuntimeException("Wrong array length for field NameDisplayPointAttributeMapListHeader.attributeTypeCode: "
        ...
        if len(self._condition_type_) != (self._num_maps_):
            raise zserio.PythonRuntimeException("Wrong array length for field NameDisplayPointAttributeMapListHeader.conditionType: "
                                                f"{len(self._condition_type_)} != {self._num_maps_}!")
        self._condition_type_.write_packed(zserio_writer)

    def write_packed(self, zserio_context: NameDisplayPointAttributeMapListHeader.ZserioPackingContext,
    ...
    class _ZserioElementFactory_attribute_type_code:
        ...
        @staticmethod
        def create(zserio_reader: zserio.BitStreamReader, zserio_index: int) -> nds.name.attributes.name_display_point_attribute_type.NameDisplayPointAttributeType:
            del zserio_index
            return nds.name.attributes.name_display_point_attribute_type.NameDisplayPointAttributeType.from_reader(zserio_reader)
        ...
        def create_packed(zserio_context: zserio.array.DeltaContext,
                          zserio_reader: zserio.BitStreamReader, zserio_index: int) -> nds.name.attributes.name_display_point_attribute_type.NameDisplayPointAttributeType:
            del zserio_index
            return nds.name.attributes.name_display_point_attribute_type.NameDisplayPointAttributeType.from_reader_packed(zserio_context, zserio_reader)
