...
class NameRoadRangeAttributeSet:
    def __init__(
            ...
            attributes_: typing.List[nds.name.instantiations.name_road_range_full_attribute.NameRoadRangeFullAttribute] = None) -> None:
    ...
    @classmethod
    def from_reader(
            cls: typing.Type['NameRoadRangeAttributeSet'],
            zserio_reader: zserio.BitStreamReader) -> 'NameRoadRangeAttributeSet':
    ...
    def from_reader_packed(
            cls: typing.Type['NameRoadRangeAttributeSet'],
            zserio_context: NameRoadRangeAttributeSet.ZserioPackingContext,
            zserio_reader: zserio.BitStreamReader) -> 'NameRoadRangeAttributeSet':
        self = object.__new__(cls)
    ...
    def __eq__(self, other: object) -> bool:
        if isinstance(other, NameRoadRangeAttributeSet):
    ...
    @property
    def attributes(self) -> typing.List[nds.name.instantiations.name_road_range_full_attribute.NameRoadRangeFullAttribute]:
        return self._attributes_.raw_array

    @attributes.setter
    def attributes(self, attributes_: typing.List[nds.name.instantiations.name_road_range_full_attribute.NameRoadRangeFullAttribute]) -> None:
        self._attributes_ = zserio.array.Array(zserio.array.ObjectArrayTraits(self._ZserioElementFactory_attributes()), attributes_)

    def init_packing_context(self, zserio_context: NameRoadRangeAttributeSet.ZserioPackingContext) -> None:
    ...
    def bitsizeof_packed(self, zserio_context: NameRoadRangeAttributeSet.ZserioPackingContext, bitposition: int = 0) -> int:
        end_bitposition = bitposition
    ...
    def initialize_offsets_packed(self, zserio_context: NameRoadRangeAttributeSet.ZserioPackingContext, bitposition: int) -> int:
        end_bitposition = bitposition
        end_bitposition += zserio_context.num_entries.bitsizeof(zserio.array.VarSizeArrayTraits(), self._num_entries_)
        end_bitposition = self._attributes_.initialize_offsets_packed(end_bitposition)
    ...
    def read_packed(self, zserio_context: NameRoadRangeAttributeSet.ZserioPackingContext, zserio_reader: zserio.BitStreamReader) -> None:
    ...
    def write(self, zserio_writer: zserio.BitStreamWriter) -> None:
        ...
        if len(self._attributes_) != (self._num_entries_):
            raise zserio.PythonRuntimeException("Wrong array length for field NameRoadRangeAttributeSet.attributes: "
                                                f"{len(self._attributes_)} != {self._num_entries_}!")
        self._attributes_.write_packed(zserio_writer)

    def write_packed(self, zserio_context: NameRoadRangeAttributeSet.ZserioPackingContext,
