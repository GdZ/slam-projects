...
import nds.poi.instantiations.poi_property

class PoiPropertyList:
    def __init__(
            self,
            num_properties_: int = int(),
            property_: typing.Optional[typing.List[nds.poi.instantiations.poi_property.PoiProperty]] = None) -> None:
    ...
    @classmethod
    def from_reader(
            cls: typing.Type['PoiPropertyList'],
            zserio_reader: zserio.BitStreamReader) -> 'PoiPropertyList':
    ...
    def from_reader_packed(
            cls: typing.Type['PoiPropertyList'],
            zserio_context: PoiPropertyList.ZserioPackingContext,
            zserio_reader: zserio.BitStreamReader) -> 'PoiPropertyList':
        self = object.__new__(cls)
    ...
    def __eq__(self, other: object) -> bool:
        if isinstance(other, PoiPropertyList):
    ...
    @property
    def property(self) -> typing.Optional[typing.List[nds.poi.instantiations.poi_property.PoiProperty]]:
        return None if self._property_ is None else self._property_.raw_array

    @property.setter
    def property(self, property_: typing.Optional[typing.List[nds.poi.instantiations.poi_property.PoiProperty]]) -> None:
        if property_ is None:
            self._property_ = None
        else:
            self._property_ = zserio.array.Array(zserio.array.ObjectArrayTraits(self._ZserioElementFactory_property()), property_)
    ...
    def init_packing_context(self, zserio_context: PoiPropertyList.ZserioPackingContext) -> None:
    ...
    def bitsizeof_packed(self, zserio_context: PoiPropertyList.ZserioPackingContext, bitposition: int = 0) -> int:
        end_bitposition = bitposition
    ...
    def initialize_offsets_packed(self, zserio_context: PoiPropertyList.ZserioPackingContext, bitposition: int) -> int:
        end_bitposition = bitposition
        end_bitposition += zserio_context.num_properties.bitsizeof(zserio.array.BitFieldArrayTraits(8), self._num_properties_)
        if self.is_property_used():
            end_bitposition = self._property_.initialize_offsets_packed(end_bitposition)
    ...
    def read_packed(self, zserio_context: PoiPropertyList.ZserioPackingContext, zserio_reader: zserio.BitStreamReader) -> None:
    ...
    def write(self, zserio_writer: zserio.BitStreamWriter) -> None:
        ...
        if self.is_property_used():
            ...
            if len(self._property_) != (self._num_properties_):
                raise zserio.PythonRuntimeException("Wrong array length for field PoiPropertyList.property: "
                                                    f"{len(self._property_)} != {self._num_properties_}!")
            self._property_.write_packed(zserio_writer)

    def write_packed(self, zserio_context: PoiPropertyList.ZserioPackingContext,
    ...
    class _ZserioElementFactory_property:
        ...
        @staticmethod
        def create(zserio_reader: zserio.BitStreamReader, zserio_index: int) -> nds.poi.instantiations.poi_property.PoiProperty:
            del zserio_index
            return nds.poi.instantiations.poi_property.PoiProperty.from_reader(zserio_reader)

        @staticmethod
        def create_packing_context() -> nds.poi.instantiations.poi_property.PoiProperty.ZserioPackingContext:
            return nds.poi.instantiations.poi_property.PoiProperty.ZserioPackingContext()

        @staticmethod
        def create_packed(zserio_context: nds.poi.instantiations.poi_property.PoiProperty.ZserioPackingContext,
                          zserio_reader: zserio.BitStreamReader, zserio_index: int) -> nds.poi.instantiations.poi_property.PoiProperty:
            del zserio_index
            return nds.poi.instantiations.poi_property.PoiProperty.from_reader_packed(zserio_context, zserio_reader)
