...
import nds.core.attributemap.property_list_core_property_type_core_property_value
import nds.core.geometry.coord_shift
import nds.poi.instantiations.poi_road_position_relation
import nds.poi.poi.poi_road_position_relation_type
import nds.road.reference.location.road_location_position_validity
import nds.road.reference.location.road_location_reference

class PoiRoadLocationPositionRelationMap:
    def __init__(
            self,
            coord_shift_: nds.core.geometry.coord_shift.CoordShift,
            attribute_type_code_: typing.Union[nds.poi.poi.poi_road_position_relation_type.PoiRoadPositionRelationType, None] = None,
            feature_: nds.core.attributemap.feature_iterator.FeatureIterator = nds.core.attributemap.feature_iterator.FeatureIterator(),
            feature_references_: typing.List[nds.road.reference.location.road_location_reference.RoadLocationReference] = None,
            feature_validities_: typing.List[nds.road.reference.location.road_location_position_validity.RoadLocationPositionValidity] = None,
            ...
            attribute_values_: typing.List[nds.poi.instantiations.poi_road_position_relation.PoiRoadPositionRelation] = None,
            attribute_properties_: typing.List[nds.core.attributemap.property_list_core_property_type_core_property_value.PropertyList_CorePropertyType_CorePropertyValue] = None,
    ...
    @classmethod
    def from_reader(
            cls: typing.Type['PoiRoadLocationPositionRelationMap'],
            zserio_reader: zserio.BitStreamReader,
            coord_shift_: nds.core.geometry.coord_shift.CoordShift) -> 'PoiRoadLocationPositionRelationMap':
    ...
    def from_reader_packed(
            cls: typing.Type['PoiRoadLocationPositionRelationMap'],
            zserio_context: PoiRoadLocationPositionRelationMap.ZserioPackingContext,
            zserio_reader: zserio.BitStreamReader,
            coord_shift_: nds.core.geometry.coord_shift.CoordShift) -> 'PoiRoadLocationPositionRelationMap':
        self = object.__new__(cls)
        self._coord_shift_ = coord_shift_
    ...
    def __eq__(self, other: object) -> bool:
        if isinstance(other, PoiRoadLocationPositionRelationMap):
    ...
    @property
    def attribute_type_code(self) -> typing.Union[nds.poi.poi.poi_road_position_relation_type.PoiRoadPositionRelationType, None]:
        return self._attribute_type_code_

    @attribute_type_code.setter
    def attribute_type_code(self, attribute_type_code_: typing.Union[nds.poi.poi.poi_road_position_relation_type.PoiRoadPositionRelationType, None]) -> None:
        self._attribute_type_code_ = attribute_type_code_
    ...
    @property
    def feature_references(self) -> typing.List[nds.road.reference.location.road_location_reference.RoadLocationReference]:
        return self._feature_references_.raw_array

    @feature_references.setter
    def feature_references(self, feature_references_: typing.List[nds.road.reference.location.road_location_reference.RoadLocationReference]) -> None:
        self._feature_references_ = zserio.array.Array(zserio.array.ObjectArrayTraits(self._ZserioElementFactory_feature_references()), feature_references_)

    @property
    def feature_validities(self) -> typing.List[nds.road.reference.location.road_location_position_validity.RoadLocationPositionValidity]:
        return self._feature_validities_.raw_array

    @feature_validities.setter
    def feature_validities(self, feature_validities_: typing.List[nds.road.reference.location.road_location_position_validity.RoadLocationPositionValidity]) -> None:
        self._feature_validities_ = zserio.array.Array(zserio.array.ObjectArrayTraits(self._ZserioElementFactory_feature_validities(self)), feature_validities_)
    ...
    @property
    def attribute_values(self) -> typing.List[nds.poi.instantiations.poi_road_position_relation.PoiRoadPositionRelation]:
        return self._attribute_values_.raw_array

    @attribute_values.setter
    def attribute_values(self, attribute_values_: typing.List[nds.poi.instantiations.poi_road_position_relation.PoiRoadPositionRelation]) -> None:
        self._attribute_values_ = zserio.array.Array(zserio.array.ObjectArrayTraits(self._ZserioElementFactory_attribute_values(self)), attribute_values_)

    @property
    def attribute_properties(self) -> typing.List[nds.core.attributemap.property_list_core_property_type_core_property_value.PropertyList_CorePropertyType_CorePropertyValue]:
        return self._attribute_properties_.raw_array

    @attribute_properties.setter
    def attribute_properties(self, attribute_properties_: typing.List[nds.core.attributemap.property_list_core_property_type_core_property_value.PropertyList_CorePropertyType_CorePropertyValue]) -> None:
        self._attribute_properties_ = zserio.array.Array(zserio.array.ObjectArrayTraits(self._ZserioElementFactory_attribute_properties()), attribute_properties_)
    ...
    def init_packing_context(self, zserio_context: PoiRoadLocationPositionRelationMap.ZserioPackingContext) -> None:
    ...
    def bitsizeof_packed(self, zserio_context: PoiRoadLocationPositionRelationMap.ZserioPackingContext, bitposition: int = 0) -> int:
        end_bitposition = bitposition
    ...
    def initialize_offsets_packed(self, zserio_context: PoiRoadLocationPositionRelationMap.ZserioPackingContext, bitposition: int) -> int:
        end_bitposition = bitposition
    ...
    def read(self, zserio_reader: zserio.BitStreamReader) -> None:
        self._attribute_type_code_ = nds.poi.poi.poi_road_position_relation_type.PoiRoadPositionRelationType.from_reader(zserio_reader)
    ...
    def read_packed(self, zserio_context: PoiRoadLocationPositionRelationMap.ZserioPackingContext, zserio_reader: zserio.BitStreamReader) -> None:
        self._attribute_type_code_ = nds.poi.poi.poi_road_position_relation_type.PoiRoadPositionRelationType.from_reader_packed(zserio_context.attribute_type_code, zserio_reader)
    ...
    def write(self, zserio_writer: zserio.BitStreamWriter) -> None:
        ...
        if len(self._feature_references_) != (self._feature_):
            raise zserio.PythonRuntimeException("Wrong array length for field PoiRoadLocationPositionRelationMap.featureReferences: "
        ...
        if len(self._feature_validities_) != (self._feature_):
            raise zserio.PythonRuntimeException("Wrong array length for field PoiRoadLocationPositionRelationMap.featureValidities: "
        ...
        if len(self._feature_value_ptr_) != (self._feature_):
            raise zserio.PythonRuntimeException("Wrong array length for field PoiRoadLocationPositionRelationMap.featureValuePtr: "
        ...
        if len(self._attribute_values_) != (self._attribute_):
            raise zserio.PythonRuntimeException("Wrong array length for field PoiRoadLocationPositionRelationMap.attributeValues: "
        ...
        if len(self._attribute_properties_) != (self._attribute_):
            raise zserio.PythonRuntimeException("Wrong array length for field PoiRoadLocationPositionRelationMap.attributeProperties: "
        ...
        if len(self._attribute_conditions_) != (self._attribute_):
            raise zserio.PythonRuntimeException("Wrong array length for field PoiRoadLocationPositionRelationMap.attributeConditions: "
                                                f"{len(self._attribute_conditions_)} != {self._attribute_}!")
        self._attribute_conditions_.write_packed(zserio_writer)

    def write_packed(self, zserio_context: PoiRoadLocationPositionRelationMap.ZserioPackingContext,
    ...
    class _ZserioElementFactory_feature_validities:
        ...
        def create(self, zserio_reader: zserio.BitStreamReader, zserio_index: int) -> nds.road.reference.location.road_location_position_validity.RoadLocationPositionValidity:
            del zserio_index
            return nds.road.reference.location.road_location_position_validity.RoadLocationPositionValidity.from_reader(zserio_reader, self._owner._coord_shift_)

        @staticmethod
        def create_packing_context() -> nds.road.reference.location.road_location_position_validity.RoadLocationPositionValidity.ZserioPackingContext:
            return nds.road.reference.location.road_location_position_validity.RoadLocationPositionValidity.ZserioPackingContext()

        def create_packed(self, zserio_context: nds.road.reference.location.road_location_position_validity.RoadLocationPositionValidity.ZserioPackingContext,
                          zserio_reader: zserio.BitStreamReader, zserio_index: int) -> nds.road.reference.location.road_location_position_validity.RoadLocationPositionValidity:
            del zserio_index
            return nds.road.reference.location.road_location_position_validity.RoadLocationPositionValidity.from_reader_packed(zserio_context, zserio_reader, self._owner._coord_shift_)
    ...
    class _ZserioElementFactory_attribute_values:
        ...
        def create(self, zserio_reader: zserio.BitStreamReader, zserio_index: int) -> nds.poi.instantiations.poi_road_position_relation.PoiRoadPositionRelation:
            del zserio_index
            return nds.poi.instantiations.poi_road_position_relation.PoiRoadPositionRelation.from_reader(zserio_reader, self._owner._attribute_type_code_)

        @staticmethod
        def create_packing_context() -> nds.poi.instantiations.poi_road_position_relation.PoiRoadPositionRelation.ZserioPackingContext:
            return nds.poi.instantiations.poi_road_position_relation.PoiRoadPositionRelation.ZserioPackingContext()

        def create_packed(self, zserio_context: nds.poi.instantiations.poi_road_position_relation.PoiRoadPositionRelation.ZserioPackingContext,
                          zserio_reader: zserio.BitStreamReader, zserio_index: int) -> nds.poi.instantiations.poi_road_position_relation.PoiRoadPositionRelation:
            del zserio_index
            return nds.poi.instantiations.poi_road_position_relation.PoiRoadPositionRelation.from_reader_packed(zserio_context, zserio_reader, self._owner._attribute_type_code_)

    class _ZserioElementFactory_attribute_properties:
        IS_OBJECT_PACKABLE = True

        @staticmethod
        def create(zserio_reader: zserio.BitStreamReader, zserio_index: int) -> nds.core.attributemap.property_list_core_property_type_core_property_value.PropertyList_CorePropertyType_CorePropertyValue:
            del zserio_index
            return nds.core.attributemap.property_list_core_property_type_core_property_value.PropertyList_CorePropertyType_CorePropertyValue.from_reader(zserio_reader)

        @staticmethod
        def create_packing_context() -> nds.core.attributemap.property_list_core_property_type_core_property_value.PropertyList_CorePropertyType_CorePropertyValue.ZserioPackingContext:
            return nds.core.attributemap.property_list_core_property_type_core_property_value.PropertyList_CorePropertyType_CorePropertyValue.ZserioPackingContext()

        @staticmethod
        def create_packed(zserio_context: nds.core.attributemap.property_list_core_property_type_core_property_value.PropertyList_CorePropertyType_CorePropertyValue.ZserioPackingContext,
                          zserio_reader: zserio.BitStreamReader, zserio_index: int) -> nds.core.attributemap.property_list_core_property_type_core_property_value.PropertyList_CorePropertyType_CorePropertyValue:
            del zserio_index
            return nds.core.attributemap.property_list_core_property_type_core_property_value.PropertyList_CorePropertyType_CorePropertyValue.from_reader_packed(zserio_context, zserio_reader)
