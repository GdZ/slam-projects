...
import nds.display.reference.types.display_mesh3d_id
import nds.poi.instantiations.poi_display_mesh3d_relation
...
class PoiDisplayMesh3DRelationMap:
    def __init__(
            ...
            attribute_type_code_: typing.Union[nds.poi.poi.poi_display_mesh3d_relation_type.PoiDisplayMesh3DRelationType, None] = None,
            feature_: nds.core.attributemap.feature_iterator.FeatureIterator = nds.core.attributemap.feature_iterator.FeatureIterator(),
            feature_references_: typing.List[nds.display.reference.types.display_mesh3d_id.DisplayMesh3dId] = None,
            ...
            attribute_values_: typing.List[nds.poi.instantiations.poi_display_mesh3d_relation.PoiDisplayMesh3DRelation] = None,
    ...
    @classmethod
    def from_reader(
            cls: typing.Type['PoiDisplayMesh3DRelationMap'],
            zserio_reader: zserio.BitStreamReader,
            coord_shift_: nds.core.geometry.coord_shift.CoordShift) -> 'PoiDisplayMesh3DRelationMap':
    ...
    def from_reader_packed(
            cls: typing.Type['PoiDisplayMesh3DRelationMap'],
            zserio_context: PoiDisplayMesh3DRelationMap.ZserioPackingContext,
            zserio_reader: zserio.BitStreamReader,
            coord_shift_: nds.core.geometry.coord_shift.CoordShift) -> 'PoiDisplayMesh3DRelationMap':
        self = object.__new__(cls)
        self._coord_shift_ = coord_shift_
    ...
    def __eq__(self, other: object) -> bool:
        if isinstance(other, PoiDisplayMesh3DRelationMap):
    ...
    @property
    def attribute_type_code(self) -> typing.Union[nds.poi.poi.poi_display_mesh3d_relation_type.PoiDisplayMesh3DRelationType, None]:
        return self._attribute_type_code_

    @attribute_type_code.setter
    def attribute_type_code(self, attribute_type_code_: typing.Union[nds.poi.poi.poi_display_mesh3d_relation_type.PoiDisplayMesh3DRelationType, None]) -> None:
        self._attribute_type_code_ = attribute_type_code_
    ...
    @property
    def feature_references(self) -> typing.List[nds.display.reference.types.display_mesh3d_id.DisplayMesh3dId]:
        return self._feature_references_.raw_array

    @feature_references.setter
    def feature_references(self, feature_references_: typing.List[nds.display.reference.types.display_mesh3d_id.DisplayMesh3dId]) -> None:
        self._feature_references_ = zserio.array.Array(zserio.array.ObjectArrayTraits(self._ZserioElementFactory_feature_references()), feature_references_)
    ...
    @property
    def attribute_values(self) -> typing.List[nds.poi.instantiations.poi_display_mesh3d_relation.PoiDisplayMesh3DRelation]:
        return self._attribute_values_.raw_array

    @attribute_values.setter
    def attribute_values(self, attribute_values_: typing.List[nds.poi.instantiations.poi_display_mesh3d_relation.PoiDisplayMesh3DRelation]) -> None:
        self._attribute_values_ = zserio.array.Array(zserio.array.ObjectArrayTraits(self._ZserioElementFactory_attribute_values(self)), attribute_values_)
    ...
    def init_packing_context(self, zserio_context: PoiDisplayMesh3DRelationMap.ZserioPackingContext) -> None:
    ...
    def bitsizeof_packed(self, zserio_context: PoiDisplayMesh3DRelationMap.ZserioPackingContext, bitposition: int = 0) -> int:
        end_bitposition = bitposition
    ...
    def initialize_offsets_packed(self, zserio_context: PoiDisplayMesh3DRelationMap.ZserioPackingContext, bitposition: int) -> int:
        end_bitposition = bitposition
    ...
    def read(self, zserio_reader: zserio.BitStreamReader) -> None:
        self._attribute_type_code_ = nds.poi.poi.poi_display_mesh3d_relation_type.PoiDisplayMesh3DRelationType.from_reader(zserio_reader)
    ...
    def read_packed(self, zserio_context: PoiDisplayMesh3DRelationMap.ZserioPackingContext, zserio_reader: zserio.BitStreamReader) -> None:
        self._attribute_type_code_ = nds.poi.poi.poi_display_mesh3d_relation_type.PoiDisplayMesh3DRelationType.from_reader_packed(zserio_context.attribute_type_code, zserio_reader)
    ...
    def write(self, zserio_writer: zserio.BitStreamWriter) -> None:
        ...
        if len(self._feature_references_) != (self._feature_):
            raise zserio.PythonRuntimeException("Wrong array length for field PoiDisplayMesh3DRelationMap.featureReferences: "
        ...
        if len(self._feature_validities_) != (self._feature_):
            raise zserio.PythonRuntimeException("Wrong array length for field PoiDisplayMesh3DRelationMap.featureValidities: "
        ...
        if len(self._feature_value_ptr_) != (self._feature_):
            raise zserio.PythonRuntimeException("Wrong array length for field PoiDisplayMesh3DRelationMap.featureValuePtr: "
        ...
        if len(self._attribute_values_) != (self._attribute_):
            raise zserio.PythonRuntimeException("Wrong array length for field PoiDisplayMesh3DRelationMap.attributeValues: "
        ...
        if len(self._attribute_properties_) != (self._attribute_):
            raise zserio.PythonRuntimeException("Wrong array length for field PoiDisplayMesh3DRelationMap.attributeProperties: "
        ...
        if len(self._attribute_conditions_) != (self._attribute_):
            raise zserio.PythonRuntimeException("Wrong array length for field PoiDisplayMesh3DRelationMap.attributeConditions: "
                                                f"{len(self._attribute_conditions_)} != {self._attribute_}!")
        self._attribute_conditions_.write_packed(zserio_writer)

    def write_packed(self, zserio_context: PoiDisplayMesh3DRelationMap.ZserioPackingContext,
    ...
    class _ZserioElementFactory_feature_references:
        ...
        @staticmethod
        def create(zserio_reader: zserio.BitStreamReader, zserio_index: int) -> nds.display.reference.types.display_mesh3d_id.DisplayMesh3dId:
            del zserio_index
            return nds.display.reference.types.display_mesh3d_id.DisplayMesh3dId.from_reader(zserio_reader)

        @staticmethod
        def create_packing_context() -> nds.display.reference.types.display_mesh3d_id.DisplayMesh3dId.ZserioPackingContext:
            return nds.display.reference.types.display_mesh3d_id.DisplayMesh3dId.ZserioPackingContext()

        @staticmethod
        def create_packed(zserio_context: nds.display.reference.types.display_mesh3d_id.DisplayMesh3dId.ZserioPackingContext,
                          zserio_reader: zserio.BitStreamReader, zserio_index: int) -> nds.display.reference.types.display_mesh3d_id.DisplayMesh3dId:
            del zserio_index
            return nds.display.reference.types.display_mesh3d_id.DisplayMesh3dId.from_reader_packed(zserio_context, zserio_reader)
    ...
    class _ZserioElementFactory_attribute_values:
        ...
        def create(self, zserio_reader: zserio.BitStreamReader, zserio_index: int) -> nds.poi.instantiations.poi_display_mesh3d_relation.PoiDisplayMesh3DRelation:
            del zserio_index
            return nds.poi.instantiations.poi_display_mesh3d_relation.PoiDisplayMesh3DRelation.from_reader(zserio_reader, self._owner._attribute_type_code_)

        @staticmethod
        def create_packing_context() -> nds.poi.instantiations.poi_display_mesh3d_relation.PoiDisplayMesh3DRelation.ZserioPackingContext:
            return nds.poi.instantiations.poi_display_mesh3d_relation.PoiDisplayMesh3DRelation.ZserioPackingContext()

        def create_packed(self, zserio_context: nds.poi.instantiations.poi_display_mesh3d_relation.PoiDisplayMesh3DRelation.ZserioPackingContext,
                          zserio_reader: zserio.BitStreamReader, zserio_index: int) -> nds.poi.instantiations.poi_display_mesh3d_relation.PoiDisplayMesh3DRelation:
            del zserio_index
            return nds.poi.instantiations.poi_display_mesh3d_relation.PoiDisplayMesh3DRelation.from_reader_packed(zserio_context, zserio_reader, self._owner._attribute_type_code_)
