...
import nds.poi.instantiations.poi_lane_position_relation
import nds.poi.poi.poi_lane_position_relation_type

class PoiLaneIndirectPositionRelationMap:
    def __init__(
            self,
            coord_shift_: nds.core.geometry.coord_shift.CoordShift,
            attribute_type_code_: typing.Union[nds.poi.poi.poi_lane_position_relation_type.PoiLanePositionRelationType, None] = None,
            ...
            attribute_values_: typing.List[nds.poi.instantiations.poi_lane_position_relation.PoiLanePositionRelation] = None,
    ...
    @classmethod
    def from_reader(
            cls: typing.Type['PoiLaneIndirectPositionRelationMap'],
            zserio_reader: zserio.BitStreamReader,
            coord_shift_: nds.core.geometry.coord_shift.CoordShift) -> 'PoiLaneIndirectPositionRelationMap':
    ...
    def from_reader_packed(
            cls: typing.Type['PoiLaneIndirectPositionRelationMap'],
            zserio_context: PoiLaneIndirectPositionRelationMap.ZserioPackingContext,
            zserio_reader: zserio.BitStreamReader,
            coord_shift_: nds.core.geometry.coord_shift.CoordShift) -> 'PoiLaneIndirectPositionRelationMap':
        self = object.__new__(cls)
        self._coord_shift_ = coord_shift_
    ...
    def __eq__(self, other: object) -> bool:
        if isinstance(other, PoiLaneIndirectPositionRelationMap):
    ...
    @property
    def attribute_type_code(self) -> typing.Union[nds.poi.poi.poi_lane_position_relation_type.PoiLanePositionRelationType, None]:
        return self._attribute_type_code_

    @attribute_type_code.setter
    def attribute_type_code(self, attribute_type_code_: typing.Union[nds.poi.poi.poi_lane_position_relation_type.PoiLanePositionRelationType, None]) -> None:
        self._attribute_type_code_ = attribute_type_code_
    ...
    @property
    def attribute_values(self) -> typing.List[nds.poi.instantiations.poi_lane_position_relation.PoiLanePositionRelation]:
        return self._attribute_values_.raw_array

    @attribute_values.setter
    def attribute_values(self, attribute_values_: typing.List[nds.poi.instantiations.poi_lane_position_relation.PoiLanePositionRelation]) -> None:
        self._attribute_values_ = zserio.array.Array(zserio.array.ObjectArrayTraits(self._ZserioElementFactory_attribute_values(self)), attribute_values_)
    ...
    def init_packing_context(self, zserio_context: PoiLaneIndirectPositionRelationMap.ZserioPackingContext) -> None:
    ...
    def bitsizeof_packed(self, zserio_context: PoiLaneIndirectPositionRelationMap.ZserioPackingContext, bitposition: int = 0) -> int:
        end_bitposition = bitposition
    ...
    def initialize_offsets_packed(self, zserio_context: PoiLaneIndirectPositionRelationMap.ZserioPackingContext, bitposition: int) -> int:
        end_bitposition = bitposition
    ...
    def read(self, zserio_reader: zserio.BitStreamReader) -> None:
        self._attribute_type_code_ = nds.poi.poi.poi_lane_position_relation_type.PoiLanePositionRelationType.from_reader(zserio_reader)
    ...
    def read_packed(self, zserio_context: PoiLaneIndirectPositionRelationMap.ZserioPackingContext, zserio_reader: zserio.BitStreamReader) -> None:
        self._attribute_type_code_ = nds.poi.poi.poi_lane_position_relation_type.PoiLanePositionRelationType.from_reader_packed(zserio_context.attribute_type_code, zserio_reader)
    ...
    def write(self, zserio_writer: zserio.BitStreamWriter) -> None:
        ...
        if len(self._feature_references_) != (self._feature_):
            raise zserio.PythonRuntimeException("Wrong array length for field PoiLaneIndirectPositionRelationMap.featureReferences: "
        ...
        if len(self._feature_validities_) != (self._feature_):
            raise zserio.PythonRuntimeException("Wrong array length for field PoiLaneIndirectPositionRelationMap.featureValidities: "
        ...
        if len(self._feature_value_ptr_) != (self._feature_):
            raise zserio.PythonRuntimeException("Wrong array length for field PoiLaneIndirectPositionRelationMap.featureValuePtr: "
        ...
        if len(self._attribute_values_) != (self._attribute_):
            raise zserio.PythonRuntimeException("Wrong array length for field PoiLaneIndirectPositionRelationMap.attributeValues: "
        ...
        if len(self._attribute_properties_) != (self._attribute_):
            raise zserio.PythonRuntimeException("Wrong array length for field PoiLaneIndirectPositionRelationMap.attributeProperties: "
        ...
        if len(self._attribute_conditions_) != (self._attribute_):
            raise zserio.PythonRuntimeException("Wrong array length for field PoiLaneIndirectPositionRelationMap.attributeConditions: "
                                                f"{len(self._attribute_conditions_)} != {self._attribute_}!")
        self._attribute_conditions_.write_packed(zserio_writer)

    def write_packed(self, zserio_context: PoiLaneIndirectPositionRelationMap.ZserioPackingContext,
    ...
    class _ZserioElementFactory_attribute_values:
        ...
        def create(self, zserio_reader: zserio.BitStreamReader, zserio_index: int) -> nds.poi.instantiations.poi_lane_position_relation.PoiLanePositionRelation:
            del zserio_index
            return nds.poi.instantiations.poi_lane_position_relation.PoiLanePositionRelation.from_reader(zserio_reader, self._owner._attribute_type_code_)

        @staticmethod
        def create_packing_context() -> nds.poi.instantiations.poi_lane_position_relation.PoiLanePositionRelation.ZserioPackingContext:
            return nds.poi.instantiations.poi_lane_position_relation.PoiLanePositionRelation.ZserioPackingContext()

        def create_packed(self, zserio_context: nds.poi.instantiations.poi_lane_position_relation.PoiLanePositionRelation.ZserioPackingContext,
                          zserio_reader: zserio.BitStreamReader, zserio_index: int) -> nds.poi.instantiations.poi_lane_position_relation.PoiLanePositionRelation:
            del zserio_index
            return nds.poi.instantiations.poi_lane_position_relation.PoiLanePositionRelation.from_reader_packed(zserio_context, zserio_reader, self._owner._attribute_type_code_)
