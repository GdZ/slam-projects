...
class PoiFullAttribute:
    def __init__(
            ...
            attribute_value_: typing.Union[nds.poi.attributes.poi_attribute_value.PoiAttributeValue, None] = None,
            properties_: typing.Optional[nds.poi.instantiations.poi_property_list.PoiPropertyList] = None,
    ...
    @classmethod
    def from_reader(
            cls: typing.Type['PoiFullAttribute'],
            zserio_reader: zserio.BitStreamReader) -> 'PoiFullAttribute':
    ...
    def from_reader_packed(
            cls: typing.Type['PoiFullAttribute'],
            zserio_context: PoiFullAttribute.ZserioPackingContext,
            zserio_reader: zserio.BitStreamReader) -> 'PoiFullAttribute':
        self = object.__new__(cls)
    ...
    def __eq__(self, other: object) -> bool:
        if isinstance(other, PoiFullAttribute):
    ...
    @property
    def properties(self) -> typing.Optional[nds.poi.instantiations.poi_property_list.PoiPropertyList]:
        return self._properties_

    @properties.setter
    def properties(self, properties_: typing.Optional[nds.poi.instantiations.poi_property_list.PoiPropertyList]) -> None:
        self._properties_ = properties_
    ...
    def init_packing_context(self, zserio_context: PoiFullAttribute.ZserioPackingContext) -> None:
    ...
    def bitsizeof_packed(self, zserio_context: PoiFullAttribute.ZserioPackingContext, bitposition: int = 0) -> int:
        end_bitposition = bitposition
    ...
    def initialize_offsets_packed(self, zserio_context: PoiFullAttribute.ZserioPackingContext, bitposition: int) -> int:
        end_bitposition = bitposition
    ...
    def read(self, zserio_reader: zserio.BitStreamReader) -> None:
        ...
        if zserio_reader.read_bool():
            self._properties_ = nds.poi.instantiations.poi_property_list.PoiPropertyList.from_reader(zserio_reader)
        else:
            self._properties_ = None
        if zserio_reader.read_bool():
    ...
    def read_packed(self, zserio_context: PoiFullAttribute.ZserioPackingContext, zserio_reader: zserio.BitStreamReader) -> None:
        ...
        if zserio_reader.read_bool():
            self._properties_ = nds.poi.instantiations.poi_property_list.PoiPropertyList.from_reader_packed(zserio_context.properties, zserio_reader)
        else:
            self._properties_ = None
    ...
    def write(self, zserio_writer: zserio.BitStreamWriter) -> None:
        ...
        if self._attribute_value_.type is not (self._attribute_type_code_):
            raise zserio.PythonRuntimeException("Wrong parameter type for field PoiFullAttribute.attributeValue: "
    ...
    def write_packed(self, zserio_context: PoiFullAttribute.ZserioPackingContext,
    ...
    class ZserioPackingContext:
        def __init__(self):
            ...
            self._properties_ = nds.poi.instantiations.poi_property_list.PoiPropertyList.ZserioPackingContext()
