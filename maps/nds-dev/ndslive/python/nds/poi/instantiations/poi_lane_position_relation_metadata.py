...
class PoiLanePositionRelationMetadata:
    def __init__(
            self,
            available_attributes_: typing.List[nds.poi.poi.poi_lane_position_relation_type.PoiLanePositionRelationType] = None,
            available_properties_: typing.List[nds.poi.properties.poi_property_type.PoiPropertyType] = None,
    ...
    @classmethod
    def from_reader(
            cls: typing.Type['PoiLanePositionRelationMetadata'],
            zserio_reader: zserio.BitStreamReader) -> 'PoiLanePositionRelationMetadata':
    ...
    def from_reader_packed(
            cls: typing.Type['PoiLanePositionRelationMetadata'],
            zserio_context: PoiLanePositionRelationMetadata.ZserioPackingContext,
            zserio_reader: zserio.BitStreamReader) -> 'PoiLanePositionRelationMetadata':
        self = object.__new__(cls)
    ...
    def __eq__(self, other: object) -> bool:
        if isinstance(other, PoiLanePositionRelationMetadata):
    ...
    @property
    def available_attributes(self) -> typing.List[nds.poi.poi.poi_lane_position_relation_type.PoiLanePositionRelationType]:
        return self._available_attributes_.raw_array

    @available_attributes.setter
    def available_attributes(self, available_attributes_: typing.List[nds.poi.poi.poi_lane_position_relation_type.PoiLanePositionRelationType]) -> None:
        self._available_attributes_ = zserio.array.Array(zserio.array.ObjectArrayTraits(self._ZserioElementFactory_available_attributes()), available_attributes_, is_auto=True)

    @property
    def available_properties(self) -> typing.List[nds.poi.properties.poi_property_type.PoiPropertyType]:
        return self._available_properties_.raw_array

    @available_properties.setter
    def available_properties(self, available_properties_: typing.List[nds.poi.properties.poi_property_type.PoiPropertyType]) -> None:
        self._available_properties_ = zserio.array.Array(zserio.array.ObjectArrayTraits(self._ZserioElementFactory_available_properties()), available_properties_, is_auto=True)
    ...
    def init_packing_context(self, zserio_context: PoiLanePositionRelationMetadata.ZserioPackingContext) -> None:
    ...
    def bitsizeof_packed(self, zserio_context: PoiLanePositionRelationMetadata.ZserioPackingContext, bitposition: int = 0) -> int:
        end_bitposition = bitposition
        end_bitposition += self._available_attributes_.bitsizeof_packed(end_bitposition)
        end_bitposition += self._available_properties_.bitsizeof_packed(end_bitposition)
    ...
    def initialize_offsets_packed(self, zserio_context: PoiLanePositionRelationMetadata.ZserioPackingContext, bitposition: int) -> int:
        end_bitposition = bitposition
        end_bitposition = self._available_attributes_.initialize_offsets_packed(end_bitposition)
        end_bitposition = self._available_properties_.initialize_offsets_packed(end_bitposition)
    ...
    def read_packed(self, zserio_context: PoiLanePositionRelationMetadata.ZserioPackingContext, zserio_reader: zserio.BitStreamReader) -> None:
        self._available_attributes_ = zserio.array.Array.from_reader_packed(zserio.array.ObjectArrayTraits(self._ZserioElementFactory_available_attributes()), zserio_reader, is_auto=True)
    ...
    def write_packed(self, zserio_context: PoiLanePositionRelationMetadata.ZserioPackingContext,
    ...
    class _ZserioElementFactory_available_attributes:
        ...
        @staticmethod
        def create(zserio_reader: zserio.BitStreamReader, zserio_index: int) -> nds.poi.poi.poi_lane_position_relation_type.PoiLanePositionRelationType:
            del zserio_index
            return nds.poi.poi.poi_lane_position_relation_type.PoiLanePositionRelationType.from_reader(zserio_reader)
        ...
        def create_packed(zserio_context: zserio.array.DeltaContext,
                          zserio_reader: zserio.BitStreamReader, zserio_index: int) -> nds.poi.poi.poi_lane_position_relation_type.PoiLanePositionRelationType:
            del zserio_index
            return nds.poi.poi.poi_lane_position_relation_type.PoiLanePositionRelationType.from_reader_packed(zserio_context, zserio_reader)

    class _ZserioElementFactory_available_properties:
        IS_OBJECT_PACKABLE = True

        @staticmethod
        def create(zserio_reader: zserio.BitStreamReader, zserio_index: int) -> nds.poi.properties.poi_property_type.PoiPropertyType:
            del zserio_index
            return nds.poi.properties.poi_property_type.PoiPropertyType.from_reader(zserio_reader)

        @staticmethod
        def create_packing_context() -> nds.poi.properties.poi_property_type.PoiPropertyType.ZserioPackingContext:
            return nds.poi.properties.poi_property_type.PoiPropertyType.ZserioPackingContext()

        @staticmethod
        def create_packed(zserio_context: nds.poi.properties.poi_property_type.PoiPropertyType.ZserioPackingContext,
                          zserio_reader: zserio.BitStreamReader, zserio_index: int) -> nds.poi.properties.poi_property_type.PoiPropertyType:
            del zserio_index
            return nds.poi.properties.poi_property_type.PoiPropertyType.from_reader_packed(zserio_context, zserio_reader)
