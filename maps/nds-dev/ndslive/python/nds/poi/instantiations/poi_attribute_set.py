...
class PoiAttributeSet:
    def __init__(
            ...
            attributes_: typing.List[nds.poi.instantiations.poi_full_attribute.PoiFullAttribute] = None) -> None:
    ...
    @classmethod
    def from_reader(
            cls: typing.Type['PoiAttributeSet'],
            zserio_reader: zserio.BitStreamReader) -> 'PoiAttributeSet':
    ...
    def from_reader_packed(
            cls: typing.Type['PoiAttributeSet'],
            zserio_context: PoiAttributeSet.ZserioPackingContext,
            zserio_reader: zserio.BitStreamReader) -> 'PoiAttributeSet':
        self = object.__new__(cls)
    ...
    def __eq__(self, other: object) -> bool:
        if isinstance(other, PoiAttributeSet):
    ...
    @property
    def attributes(self) -> typing.List[nds.poi.instantiations.poi_full_attribute.PoiFullAttribute]:
        return self._attributes_.raw_array

    @attributes.setter
    def attributes(self, attributes_: typing.List[nds.poi.instantiations.poi_full_attribute.PoiFullAttribute]) -> None:
        self._attributes_ = zserio.array.Array(zserio.array.ObjectArrayTraits(self._ZserioElementFactory_attributes()), attributes_)

    def init_packing_context(self, zserio_context: PoiAttributeSet.ZserioPackingContext) -> None:
    ...
    def bitsizeof_packed(self, zserio_context: PoiAttributeSet.ZserioPackingContext, bitposition: int = 0) -> int:
        end_bitposition = bitposition
    ...
    def initialize_offsets_packed(self, zserio_context: PoiAttributeSet.ZserioPackingContext, bitposition: int) -> int:
        end_bitposition = bitposition
        end_bitposition += zserio_context.num_entries.bitsizeof(zserio.array.VarSizeArrayTraits(), self._num_entries_)
        end_bitposition = self._attributes_.initialize_offsets_packed(end_bitposition)
    ...
    def read_packed(self, zserio_context: PoiAttributeSet.ZserioPackingContext, zserio_reader: zserio.BitStreamReader) -> None:
    ...
    def write(self, zserio_writer: zserio.BitStreamWriter) -> None:
        ...
        if len(self._attributes_) != (self._num_entries_):
            raise zserio.PythonRuntimeException("Wrong array length for field PoiAttributeSet.attributes: "
                                                f"{len(self._attributes_)} != {self._num_entries_}!")
        self._attributes_.write_packed(zserio_writer)

    def write_packed(self, zserio_context: PoiAttributeSet.ZserioPackingContext,
