...
import nds.poi.instantiations.poi_attribute_set_map
...
class PoiAttributeSetList:
    def __init__(
            ...
            sets_: typing.List[nds.poi.instantiations.poi_attribute_set_map.PoiAttributeSetMap] = None) -> None:
    ...
    @classmethod
    def from_reader(
            cls: typing.Type['PoiAttributeSetList'],
            zserio_reader: zserio.BitStreamReader,
            coord_shift_: nds.core.geometry.coord_shift.CoordShift) -> 'PoiAttributeSetList':
    ...
    def from_reader_packed(
            cls: typing.Type['PoiAttributeSetList'],
            zserio_context: PoiAttributeSetList.ZserioPackingContext,
            zserio_reader: zserio.BitStreamReader,
            coord_shift_: nds.core.geometry.coord_shift.CoordShift) -> 'PoiAttributeSetList':
        self = object.__new__(cls)
        self._coord_shift_ = coord_shift_
    ...
    def __eq__(self, other: object) -> bool:
        if isinstance(other, PoiAttributeSetList):
    ...
    @property
    def sets(self) -> typing.List[nds.poi.instantiations.poi_attribute_set_map.PoiAttributeSetMap]:
        return self._sets_.raw_array

    @sets.setter
    def sets(self, sets_: typing.List[nds.poi.instantiations.poi_attribute_set_map.PoiAttributeSetMap]) -> None:
        self._sets_ = zserio.array.Array(zserio.array.ObjectArrayTraits(self._ZserioElementFactory_sets(self)), sets_)

    def init_packing_context(self, zserio_context: PoiAttributeSetList.ZserioPackingContext) -> None:
    ...
    def bitsizeof_packed(self, zserio_context: PoiAttributeSetList.ZserioPackingContext, bitposition: int = 0) -> int:
        end_bitposition = bitposition
    ...
    def initialize_offsets_packed(self, zserio_context: PoiAttributeSetList.ZserioPackingContext, bitposition: int) -> int:
        end_bitposition = bitposition
        end_bitposition += zserio_context.num_attribute_sets.bitsizeof(zserio.array.VarSizeArrayTraits(), self._num_attribute_sets_)
        end_bitposition = self._sets_.initialize_offsets_packed(end_bitposition)
    ...
    def read_packed(self, zserio_context: PoiAttributeSetList.ZserioPackingContext, zserio_reader: zserio.BitStreamReader) -> None:
    ...
    def write(self, zserio_writer: zserio.BitStreamWriter) -> None:
        ...
        if len(self._sets_) != (self._num_attribute_sets_):
            raise zserio.PythonRuntimeException("Wrong array length for field PoiAttributeSetList.sets: "
                                                f"{len(self._sets_)} != {self._num_attribute_sets_}!")
        self._sets_.write_packed(zserio_writer)

    def write_packed(self, zserio_context: PoiAttributeSetList.ZserioPackingContext,
    ...
    class _ZserioElementFactory_sets:
        ...
        def create(self, zserio_reader: zserio.BitStreamReader, zserio_index: int) -> nds.poi.instantiations.poi_attribute_set_map.PoiAttributeSetMap:
            del zserio_index
            return nds.poi.instantiations.poi_attribute_set_map.PoiAttributeSetMap.from_reader(zserio_reader, self._owner._coord_shift_)

        @staticmethod
        def create_packing_context() -> nds.poi.instantiations.poi_attribute_set_map.PoiAttributeSetMap.ZserioPackingContext:
            return nds.poi.instantiations.poi_attribute_set_map.PoiAttributeSetMap.ZserioPackingContext()

        def create_packed(self, zserio_context: nds.poi.instantiations.poi_attribute_set_map.PoiAttributeSetMap.ZserioPackingContext,
                          zserio_reader: zserio.BitStreamReader, zserio_index: int) -> nds.poi.instantiations.poi_attribute_set_map.PoiAttributeSetMap:
            del zserio_index
            return nds.poi.instantiations.poi_attribute_set_map.PoiAttributeSetMap.from_reader_packed(zserio_context, zserio_reader, self._owner._coord_shift_)
