...
import nds.poi.instantiations.poi_attribute
import nds.poi.instantiations.poi_property_list
...
class PoiIndirectAttributeMap:
    def __init__(
            ...
            attribute_type_code_: typing.Union[nds.poi.attributes.poi_attribute_type.PoiAttributeType, None] = None,
            feature_: nds.core.attributemap.feature_iterator.FeatureIterator = nds.core.attributemap.feature_iterator.FeatureIterator(),
            feature_references_: typing.List[nds.poi.reference.types.poi_reference_indirect.PoiReferenceIndirect] = None,
            ...
            attribute_values_: typing.List[nds.poi.instantiations.poi_attribute.PoiAttribute] = None,
            attribute_properties_: typing.List[nds.poi.instantiations.poi_property_list.PoiPropertyList] = None,
    ...
    @classmethod
    def from_reader(
            cls: typing.Type['PoiIndirectAttributeMap'],
            zserio_reader: zserio.BitStreamReader,
            coord_shift_: nds.core.geometry.coord_shift.CoordShift) -> 'PoiIndirectAttributeMap':
    ...
    def from_reader_packed(
            cls: typing.Type['PoiIndirectAttributeMap'],
            zserio_context: PoiIndirectAttributeMap.ZserioPackingContext,
            zserio_reader: zserio.BitStreamReader,
            coord_shift_: nds.core.geometry.coord_shift.CoordShift) -> 'PoiIndirectAttributeMap':
        self = object.__new__(cls)
        self._coord_shift_ = coord_shift_
    ...
    def __eq__(self, other: object) -> bool:
        if isinstance(other, PoiIndirectAttributeMap):
    ...
    @property
    def attribute_type_code(self) -> typing.Union[nds.poi.attributes.poi_attribute_type.PoiAttributeType, None]:
        return self._attribute_type_code_

    @attribute_type_code.setter
    def attribute_type_code(self, attribute_type_code_: typing.Union[nds.poi.attributes.poi_attribute_type.PoiAttributeType, None]) -> None:
        self._attribute_type_code_ = attribute_type_code_
    ...
    @property
    def feature_references(self) -> typing.List[nds.poi.reference.types.poi_reference_indirect.PoiReferenceIndirect]:
        return self._feature_references_.raw_array

    @feature_references.setter
    def feature_references(self, feature_references_: typing.List[nds.poi.reference.types.poi_reference_indirect.PoiReferenceIndirect]) -> None:
        self._feature_references_ = zserio.array.Array(zserio.array.ObjectArrayTraits(self._ZserioElementFactory_feature_references()), feature_references_)
    ...
    @property
    def attribute_values(self) -> typing.List[nds.poi.instantiations.poi_attribute.PoiAttribute]:
        return self._attribute_values_.raw_array

    @attribute_values.setter
    def attribute_values(self, attribute_values_: typing.List[nds.poi.instantiations.poi_attribute.PoiAttribute]) -> None:
        self._attribute_values_ = zserio.array.Array(zserio.array.ObjectArrayTraits(self._ZserioElementFactory_attribute_values(self)), attribute_values_)

    @property
    def attribute_properties(self) -> typing.List[nds.poi.instantiations.poi_property_list.PoiPropertyList]:
        return self._attribute_properties_.raw_array

    @attribute_properties.setter
    def attribute_properties(self, attribute_properties_: typing.List[nds.poi.instantiations.poi_property_list.PoiPropertyList]) -> None:
        self._attribute_properties_ = zserio.array.Array(zserio.array.ObjectArrayTraits(self._ZserioElementFactory_attribute_properties()), attribute_properties_)
    ...
    def init_packing_context(self, zserio_context: PoiIndirectAttributeMap.ZserioPackingContext) -> None:
    ...
    def bitsizeof_packed(self, zserio_context: PoiIndirectAttributeMap.ZserioPackingContext, bitposition: int = 0) -> int:
        end_bitposition = bitposition
    ...
    def initialize_offsets_packed(self, zserio_context: PoiIndirectAttributeMap.ZserioPackingContext, bitposition: int) -> int:
        end_bitposition = bitposition
    ...
    def read(self, zserio_reader: zserio.BitStreamReader) -> None:
        self._attribute_type_code_ = nds.poi.attributes.poi_attribute_type.PoiAttributeType.from_reader(zserio_reader)
    ...
    def read_packed(self, zserio_context: PoiIndirectAttributeMap.ZserioPackingContext, zserio_reader: zserio.BitStreamReader) -> None:
        self._attribute_type_code_ = nds.poi.attributes.poi_attribute_type.PoiAttributeType.from_reader_packed(zserio_context.attribute_type_code, zserio_reader)
    ...
    def write(self, zserio_writer: zserio.BitStreamWriter) -> None:
        ...
        if len(self._feature_references_) != (self._feature_):
            raise zserio.PythonRuntimeException("Wrong array length for field PoiIndirectAttributeMap.featureReferences: "
        ...
        if len(self._feature_validities_) != (self._feature_):
            raise zserio.PythonRuntimeException("Wrong array length for field PoiIndirectAttributeMap.featureValidities: "
        ...
        if len(self._feature_value_ptr_) != (self._feature_):
            raise zserio.PythonRuntimeException("Wrong array length for field PoiIndirectAttributeMap.featureValuePtr: "
        ...
        if len(self._attribute_values_) != (self._attribute_):
            raise zserio.PythonRuntimeException("Wrong array length for field PoiIndirectAttributeMap.attributeValues: "
        ...
        if len(self._attribute_properties_) != (self._attribute_):
            raise zserio.PythonRuntimeException("Wrong array length for field PoiIndirectAttributeMap.attributeProperties: "
        ...
        if len(self._attribute_conditions_) != (self._attribute_):
            raise zserio.PythonRuntimeException("Wrong array length for field PoiIndirectAttributeMap.attributeConditions: "
                                                f"{len(self._attribute_conditions_)} != {self._attribute_}!")
        self._attribute_conditions_.write_packed(zserio_writer)

    def write_packed(self, zserio_context: PoiIndirectAttributeMap.ZserioPackingContext,
    ...
    class _ZserioElementFactory_feature_references:
        ...
        @staticmethod
        def create(zserio_reader: zserio.BitStreamReader, zserio_index: int) -> nds.poi.reference.types.poi_reference_indirect.PoiReferenceIndirect:
            del zserio_index
            return nds.poi.reference.types.poi_reference_indirect.PoiReferenceIndirect.from_reader(zserio_reader)

        @staticmethod
        def create_packing_context() -> nds.poi.reference.types.poi_reference_indirect.PoiReferenceIndirect.ZserioPackingContext:
            return nds.poi.reference.types.poi_reference_indirect.PoiReferenceIndirect.ZserioPackingContext()

        @staticmethod
        def create_packed(zserio_context: nds.poi.reference.types.poi_reference_indirect.PoiReferenceIndirect.ZserioPackingContext,
                          zserio_reader: zserio.BitStreamReader, zserio_index: int) -> nds.poi.reference.types.poi_reference_indirect.PoiReferenceIndirect:
            del zserio_index
            return nds.poi.reference.types.poi_reference_indirect.PoiReferenceIndirect.from_reader_packed(zserio_context, zserio_reader)
    ...
    class _ZserioElementFactory_attribute_values:
        ...
        def create(self, zserio_reader: zserio.BitStreamReader, zserio_index: int) -> nds.poi.instantiations.poi_attribute.PoiAttribute:
            del zserio_index
            return nds.poi.instantiations.poi_attribute.PoiAttribute.from_reader(zserio_reader, self._owner._attribute_type_code_)

        @staticmethod
        def create_packing_context() -> nds.poi.instantiations.poi_attribute.PoiAttribute.ZserioPackingContext:
            return nds.poi.instantiations.poi_attribute.PoiAttribute.ZserioPackingContext()

        def create_packed(self, zserio_context: nds.poi.instantiations.poi_attribute.PoiAttribute.ZserioPackingContext,
                          zserio_reader: zserio.BitStreamReader, zserio_index: int) -> nds.poi.instantiations.poi_attribute.PoiAttribute:
            del zserio_index
            return nds.poi.instantiations.poi_attribute.PoiAttribute.from_reader_packed(zserio_context, zserio_reader, self._owner._attribute_type_code_)

    class _ZserioElementFactory_attribute_properties:
        IS_OBJECT_PACKABLE = True

        @staticmethod
        def create(zserio_reader: zserio.BitStreamReader, zserio_index: int) -> nds.poi.instantiations.poi_property_list.PoiPropertyList:
            del zserio_index
            return nds.poi.instantiations.poi_property_list.PoiPropertyList.from_reader(zserio_reader)

        @staticmethod
        def create_packing_context() -> nds.poi.instantiations.poi_property_list.PoiPropertyList.ZserioPackingContext:
            return nds.poi.instantiations.poi_property_list.PoiPropertyList.ZserioPackingContext()

        @staticmethod
        def create_packed(zserio_context: nds.poi.instantiations.poi_property_list.PoiPropertyList.ZserioPackingContext,
                          zserio_reader: zserio.BitStreamReader, zserio_index: int) -> nds.poi.instantiations.poi_property_list.PoiPropertyList:
            del zserio_index
            return nds.poi.instantiations.poi_property_list.PoiPropertyList.from_reader_packed(zserio_context, zserio_reader)
