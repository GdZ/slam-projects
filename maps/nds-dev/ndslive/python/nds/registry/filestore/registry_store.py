...
import nds.registry.filestore.registry_node_table
...
class RegistryStore:
    ...
    @classmethod
    def from_file(cls: typing.Type['RegistryStore'], filename: str, table_to_db_filename_relocation_map: typing.Dict[str, str] = None) -> 'RegistryStore':
    ...
    @property
    def node_table(self) -> nds.registry.filestore.registry_node_table.RegistryNodeTable:
        return self._node_table_
    ...
    def create_schema(self) -> None:
        ...
        self._node_table_.create_table()
    ...
    def delete_schema(self) -> None:
        ...
        self._node_table_.delete_table()

        if has_autocommit:
            cursor.execute("COMMIT")

    def _init_tables(self, table_name_to_attached_db_name_map: typing.Dict[str, str]) -> None:
        self._node_table_ = nds.registry.filestore.registry_node_table.RegistryNodeTable(
            self._connection, self.TABLE_NAME_NODE_TABLE, table_name_to_attached_db_name_map.get(self.TABLE_NAME_NODE_TABLE))
    ...
    DATABASE_NAME = "RegistryStore"
    TABLE_NAME_NODE_TABLE = "nodeTable"
