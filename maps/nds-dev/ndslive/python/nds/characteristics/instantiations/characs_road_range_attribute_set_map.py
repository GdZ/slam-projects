...
class CharacsRoadRangeAttributeSetMap:
    def __init__(
            ...
            references_: typing.List[nds.road.reference.types.road_reference.RoadReference] = None,
    ...
    @classmethod
    def from_reader(
            cls: typing.Type['CharacsRoadRangeAttributeSetMap'],
            zserio_reader: zserio.BitStreamReader,
            coord_shift_: nds.core.geometry.coord_shift.CoordShift) -> 'CharacsRoadRangeAttributeSetMap':
    ...
    def from_reader_packed(
            cls: typing.Type['CharacsRoadRangeAttributeSetMap'],
            zserio_context: CharacsRoadRangeAttributeSetMap.ZserioPackingContext,
            zserio_reader: zserio.BitStreamReader,
            coord_shift_: nds.core.geometry.coord_shift.CoordShift) -> 'CharacsRoadRangeAttributeSetMap':
        self = object.__new__(cls)
        self._coord_shift_ = coord_shift_
    ...
    def __eq__(self, other: object) -> bool:
        if isinstance(other, CharacsRoadRangeAttributeSetMap):
    ...
    @property
    def references(self) -> typing.List[nds.road.reference.types.road_reference.RoadReference]:
        return self._references_.raw_array

    @references.setter
    def references(self, references_: typing.List[nds.road.reference.types.road_reference.RoadReference]) -> None:
        self._references_ = zserio.array.Array(zserio.array.ObjectArrayTraits(self._ZserioElementFactory_references()), references_)
    ...
    def init_packing_context(self, zserio_context: CharacsRoadRangeAttributeSetMap.ZserioPackingContext) -> None:
    ...
    def bitsizeof_packed(self, zserio_context: CharacsRoadRangeAttributeSetMap.ZserioPackingContext, bitposition: int = 0) -> int:
        end_bitposition = bitposition
    ...
    def initialize_offsets_packed(self, zserio_context: CharacsRoadRangeAttributeSetMap.ZserioPackingContext, bitposition: int) -> int:
        end_bitposition = bitposition
    ...
    def read_packed(self, zserio_context: CharacsRoadRangeAttributeSetMap.ZserioPackingContext, zserio_reader: zserio.BitStreamReader) -> None:
    ...
    def write(self, zserio_writer: zserio.BitStreamWriter) -> None:
        ...
        if len(self._references_) != (self._feature_):
            raise zserio.PythonRuntimeException("Wrong array length for field CharacsRoadRangeAttributeSetMap.references: "
        ...
        if len(self._validities_) != (self._feature_):
            raise zserio.PythonRuntimeException("Wrong array length for field CharacsRoadRangeAttributeSetMap.validities: "
                                                f"{len(self._validities_)} != {self._feature_}!")
        self._validities_.write_packed(zserio_writer)

    def write_packed(self, zserio_context: CharacsRoadRangeAttributeSetMap.ZserioPackingContext,
