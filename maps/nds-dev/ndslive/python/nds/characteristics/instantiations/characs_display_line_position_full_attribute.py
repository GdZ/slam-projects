...
class CharacsDisplayLinePositionFullAttribute:
    def __init__(
            ...
            attribute_value_: typing.Union[nds.characteristics.attributes.characs_display_line_position_attribute_value.CharacsDisplayLinePositionAttributeValue, None] = None,
    ...
    @classmethod
    def from_reader(
            cls: typing.Type['CharacsDisplayLinePositionFullAttribute'],
            zserio_reader: zserio.BitStreamReader) -> 'CharacsDisplayLinePositionFullAttribute':
    ...
    def from_reader_packed(
            cls: typing.Type['CharacsDisplayLinePositionFullAttribute'],
            zserio_context: CharacsDisplayLinePositionFullAttribute.ZserioPackingContext,
            zserio_reader: zserio.BitStreamReader) -> 'CharacsDisplayLinePositionFullAttribute':
        self = object.__new__(cls)
    ...
    def __eq__(self, other: object) -> bool:
        if isinstance(other, CharacsDisplayLinePositionFullAttribute):
    ...
    def init_packing_context(self, zserio_context: CharacsDisplayLinePositionFullAttribute.ZserioPackingContext) -> None:
    ...
    def bitsizeof_packed(self, zserio_context: CharacsDisplayLinePositionFullAttribute.ZserioPackingContext, bitposition: int = 0) -> int:
        end_bitposition = bitposition
    ...
    def initialize_offsets_packed(self, zserio_context: CharacsDisplayLinePositionFullAttribute.ZserioPackingContext, bitposition: int) -> int:
        end_bitposition = bitposition
    ...
    def read_packed(self, zserio_context: CharacsDisplayLinePositionFullAttribute.ZserioPackingContext, zserio_reader: zserio.BitStreamReader) -> None:
    ...
    def write(self, zserio_writer: zserio.BitStreamWriter) -> None:
        ...
        if self._attribute_value_.type is not (self._attribute_type_code_):
            raise zserio.PythonRuntimeException("Wrong parameter type for field CharacsDisplayLinePositionFullAttribute.attributeValue: "
    ...
    def write_packed(self, zserio_context: CharacsDisplayLinePositionFullAttribute.ZserioPackingContext,
