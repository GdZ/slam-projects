...
import nds.characteristics.instantiations.characs_road_position_attribute_set
...
class CharacsIndirectRoadPositionAttributeSetMap:
    def __init__(
            ...
            attribute_set_: typing.Union[nds.characteristics.instantiations.characs_road_position_attribute_set.CharacsRoadPositionAttributeSet, None] = None,
            ...
            validities_: typing.List[nds.road.reference.types.road_position_validity.RoadPositionValidity] = None) -> None:
    ...
    @classmethod
    def from_reader(
            cls: typing.Type['CharacsIndirectRoadPositionAttributeSetMap'],
            zserio_reader: zserio.BitStreamReader,
            coord_shift_: nds.core.geometry.coord_shift.CoordShift) -> 'CharacsIndirectRoadPositionAttributeSetMap':
    ...
    def from_reader_packed(
            cls: typing.Type['CharacsIndirectRoadPositionAttributeSetMap'],
            zserio_context: CharacsIndirectRoadPositionAttributeSetMap.ZserioPackingContext,
            zserio_reader: zserio.BitStreamReader,
            coord_shift_: nds.core.geometry.coord_shift.CoordShift) -> 'CharacsIndirectRoadPositionAttributeSetMap':
        self = object.__new__(cls)
        self._coord_shift_ = coord_shift_
    ...
    def __eq__(self, other: object) -> bool:
        if isinstance(other, CharacsIndirectRoadPositionAttributeSetMap):
    ...
    @property
    def attribute_set(self) -> typing.Union[nds.characteristics.instantiations.characs_road_position_attribute_set.CharacsRoadPositionAttributeSet, None]:
        return self._attribute_set_

    @attribute_set.setter
    def attribute_set(self, attribute_set_: typing.Union[nds.characteristics.instantiations.characs_road_position_attribute_set.CharacsRoadPositionAttributeSet, None]) -> None:
        self._attribute_set_ = attribute_set_
    ...
    @property
    def validities(self) -> typing.List[nds.road.reference.types.road_position_validity.RoadPositionValidity]:
        return self._validities_.raw_array

    @validities.setter
    def validities(self, validities_: typing.List[nds.road.reference.types.road_position_validity.RoadPositionValidity]) -> None:
        self._validities_ = zserio.array.Array(zserio.array.ObjectArrayTraits(self._ZserioElementFactory_validities(self)), validities_)

    def init_packing_context(self, zserio_context: CharacsIndirectRoadPositionAttributeSetMap.ZserioPackingContext) -> None:
    ...
    def bitsizeof_packed(self, zserio_context: CharacsIndirectRoadPositionAttributeSetMap.ZserioPackingContext, bitposition: int = 0) -> int:
        end_bitposition = bitposition
    ...
    def initialize_offsets_packed(self, zserio_context: CharacsIndirectRoadPositionAttributeSetMap.ZserioPackingContext, bitposition: int) -> int:
        end_bitposition = bitposition
    ...
    def read(self, zserio_reader: zserio.BitStreamReader) -> None:
        self._attribute_set_ = nds.characteristics.instantiations.characs_road_position_attribute_set.CharacsRoadPositionAttributeSet.from_reader(zserio_reader)
    ...
    def read_packed(self, zserio_context: CharacsIndirectRoadPositionAttributeSetMap.ZserioPackingContext, zserio_reader: zserio.BitStreamReader) -> None:
        self._attribute_set_ = nds.characteristics.instantiations.characs_road_position_attribute_set.CharacsRoadPositionAttributeSet.from_reader_packed(zserio_context.attribute_set, zserio_reader)
    ...
    def write(self, zserio_writer: zserio.BitStreamWriter) -> None:
        ...
        if len(self._references_) != (self._feature_):
            raise zserio.PythonRuntimeException("Wrong array length for field CharacsIndirectRoadPositionAttributeSetMap.references: "
        ...
        if len(self._validities_) != (self._feature_):
            raise zserio.PythonRuntimeException("Wrong array length for field CharacsIndirectRoadPositionAttributeSetMap.validities: "
                                                f"{len(self._validities_)} != {self._feature_}!")
        self._validities_.write_packed(zserio_writer)

    def write_packed(self, zserio_context: CharacsIndirectRoadPositionAttributeSetMap.ZserioPackingContext,
    ...
    class ZserioPackingContext:
        def __init__(self):
            self._attribute_set_ = nds.characteristics.instantiations.characs_road_position_attribute_set.CharacsRoadPositionAttributeSet.ZserioPackingContext()
