...
import nds.characteristics.attributes.characs_road_position_attribute_value
...
class CharacsRoadPositionFullAttribute:
    def __init__(
            ...
            attribute_value_: typing.Union[nds.characteristics.attributes.characs_road_position_attribute_value.CharacsRoadPositionAttributeValue, None] = None,
    ...
    @classmethod
    def from_reader(
            cls: typing.Type['CharacsRoadPositionFullAttribute'],
            zserio_reader: zserio.BitStreamReader) -> 'CharacsRoadPositionFullAttribute':
    ...
    def from_reader_packed(
            cls: typing.Type['CharacsRoadPositionFullAttribute'],
            zserio_context: CharacsRoadPositionFullAttribute.ZserioPackingContext,
            zserio_reader: zserio.BitStreamReader) -> 'CharacsRoadPositionFullAttribute':
        self = object.__new__(cls)
    ...
    def __eq__(self, other: object) -> bool:
        if isinstance(other, CharacsRoadPositionFullAttribute):
    ...
    @property
    def attribute_value(self) -> typing.Union[nds.characteristics.attributes.characs_road_position_attribute_value.CharacsRoadPositionAttributeValue, None]:
        return self._attribute_value_

    @attribute_value.setter
    def attribute_value(self, attribute_value_: typing.Union[nds.characteristics.attributes.characs_road_position_attribute_value.CharacsRoadPositionAttributeValue, None]) -> None:
        self._attribute_value_ = attribute_value_
    ...
    def init_packing_context(self, zserio_context: CharacsRoadPositionFullAttribute.ZserioPackingContext) -> None:
    ...
    def bitsizeof_packed(self, zserio_context: CharacsRoadPositionFullAttribute.ZserioPackingContext, bitposition: int = 0) -> int:
        end_bitposition = bitposition
    ...
    def initialize_offsets_packed(self, zserio_context: CharacsRoadPositionFullAttribute.ZserioPackingContext, bitposition: int) -> int:
        end_bitposition = bitposition
    ...
    def read(self, zserio_reader: zserio.BitStreamReader) -> None:
        ...
        self._attribute_value_ = nds.characteristics.attributes.characs_road_position_attribute_value.CharacsRoadPositionAttributeValue.from_reader(zserio_reader, self._attribute_type_code_)
    ...
    def read_packed(self, zserio_context: CharacsRoadPositionFullAttribute.ZserioPackingContext, zserio_reader: zserio.BitStreamReader) -> None:
        ...
        self._attribute_value_ = nds.characteristics.attributes.characs_road_position_attribute_value.CharacsRoadPositionAttributeValue.from_reader_packed(zserio_context.attribute_value, zserio_reader, self._attribute_type_code_)
    ...
    def write(self, zserio_writer: zserio.BitStreamWriter) -> None:
        ...
        if self._attribute_value_.type is not (self._attribute_type_code_):
            raise zserio.PythonRuntimeException("Wrong parameter type for field CharacsRoadPositionFullAttribute.attributeValue: "
    ...
    def write_packed(self, zserio_context: CharacsRoadPositionFullAttribute.ZserioPackingContext,
    ...
    class ZserioPackingContext:
        def __init__(self):
            ...
            self._attribute_value_ = nds.characteristics.attributes.characs_road_position_attribute_value.CharacsRoadPositionAttributeValue.ZserioPackingContext()
