...
import nds.characteristics.instantiations.characs_display_line_range_attribute
...
class CharacsDisplayLineRangeAttributeMap:
    def __init__(
            ...
            attribute_values_: typing.List[nds.characteristics.instantiations.characs_display_line_range_attribute.CharacsDisplayLineRangeAttribute] = None,
    ...
    @classmethod
    def from_reader(
            cls: typing.Type['CharacsDisplayLineRangeAttributeMap'],
            zserio_reader: zserio.BitStreamReader,
            coord_shift_: nds.core.geometry.coord_shift.CoordShift) -> 'CharacsDisplayLineRangeAttributeMap':
    ...
    def from_reader_packed(
            cls: typing.Type['CharacsDisplayLineRangeAttributeMap'],
            zserio_context: CharacsDisplayLineRangeAttributeMap.ZserioPackingContext,
            zserio_reader: zserio.BitStreamReader,
            coord_shift_: nds.core.geometry.coord_shift.CoordShift) -> 'CharacsDisplayLineRangeAttributeMap':
        self = object.__new__(cls)
        self._coord_shift_ = coord_shift_
    ...
    def __eq__(self, other: object) -> bool:
        if isinstance(other, CharacsDisplayLineRangeAttributeMap):
    ...
    @property
    def attribute_values(self) -> typing.List[nds.characteristics.instantiations.characs_display_line_range_attribute.CharacsDisplayLineRangeAttribute]:
        return self._attribute_values_.raw_array

    @attribute_values.setter
    def attribute_values(self, attribute_values_: typing.List[nds.characteristics.instantiations.characs_display_line_range_attribute.CharacsDisplayLineRangeAttribute]) -> None:
        self._attribute_values_ = zserio.array.Array(zserio.array.ObjectArrayTraits(self._ZserioElementFactory_attribute_values(self)), attribute_values_)
    ...
    def init_packing_context(self, zserio_context: CharacsDisplayLineRangeAttributeMap.ZserioPackingContext) -> None:
    ...
    def bitsizeof_packed(self, zserio_context: CharacsDisplayLineRangeAttributeMap.ZserioPackingContext, bitposition: int = 0) -> int:
        end_bitposition = bitposition
    ...
    def initialize_offsets_packed(self, zserio_context: CharacsDisplayLineRangeAttributeMap.ZserioPackingContext, bitposition: int) -> int:
        end_bitposition = bitposition
    ...
    def read_packed(self, zserio_context: CharacsDisplayLineRangeAttributeMap.ZserioPackingContext, zserio_reader: zserio.BitStreamReader) -> None:
    ...
    def write(self, zserio_writer: zserio.BitStreamWriter) -> None:
        ...
        if len(self._feature_references_) != (self._feature_):
            raise zserio.PythonRuntimeException("Wrong array length for field CharacsDisplayLineRangeAttributeMap.featureReferences: "
        ...
        if len(self._feature_validities_) != (self._feature_):
            raise zserio.PythonRuntimeException("Wrong array length for field CharacsDisplayLineRangeAttributeMap.featureValidities: "
        ...
        if len(self._feature_value_ptr_) != (self._feature_):
            raise zserio.PythonRuntimeException("Wrong array length for field CharacsDisplayLineRangeAttributeMap.featureValuePtr: "
        ...
        if len(self._attribute_values_) != (self._attribute_):
            raise zserio.PythonRuntimeException("Wrong array length for field CharacsDisplayLineRangeAttributeMap.attributeValues: "
        ...
        if len(self._attribute_properties_) != (self._attribute_):
            raise zserio.PythonRuntimeException("Wrong array length for field CharacsDisplayLineRangeAttributeMap.attributeProperties: "
        ...
        if len(self._attribute_conditions_) != (self._attribute_):
            raise zserio.PythonRuntimeException("Wrong array length for field CharacsDisplayLineRangeAttributeMap.attributeConditions: "
                                                f"{len(self._attribute_conditions_)} != {self._attribute_}!")
        self._attribute_conditions_.write_packed(zserio_writer)

    def write_packed(self, zserio_context: CharacsDisplayLineRangeAttributeMap.ZserioPackingContext,
    ...
    class _ZserioElementFactory_attribute_values:
        ...
        def create(self, zserio_reader: zserio.BitStreamReader, zserio_index: int) -> nds.characteristics.instantiations.characs_display_line_range_attribute.CharacsDisplayLineRangeAttribute:
            del zserio_index
            return nds.characteristics.instantiations.characs_display_line_range_attribute.CharacsDisplayLineRangeAttribute.from_reader(zserio_reader, self._owner._attribute_type_code_)

        @staticmethod
        def create_packing_context() -> nds.characteristics.instantiations.characs_display_line_range_attribute.CharacsDisplayLineRangeAttribute.ZserioPackingContext:
            return nds.characteristics.instantiations.characs_display_line_range_attribute.CharacsDisplayLineRangeAttribute.ZserioPackingContext()

        def create_packed(self, zserio_context: nds.characteristics.instantiations.characs_display_line_range_attribute.CharacsDisplayLineRangeAttribute.ZserioPackingContext,
                          zserio_reader: zserio.BitStreamReader, zserio_index: int) -> nds.characteristics.instantiations.characs_display_line_range_attribute.CharacsDisplayLineRangeAttribute:
            del zserio_index
            return nds.characteristics.instantiations.characs_display_line_range_attribute.CharacsDisplayLineRangeAttribute.from_reader_packed(zserio_context, zserio_reader, self._owner._attribute_type_code_)
