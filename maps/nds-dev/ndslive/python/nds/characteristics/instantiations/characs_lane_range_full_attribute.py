...
import nds.characteristics.attributes.characs_lane_range_attribute_value
import nds.characteristics.instantiations.characs_property_list
import nds.core.attributemap.condition_list

class CharacsLaneRangeFullAttribute:
    def __init__(
            self,
            ...
            attribute_value_: typing.Union[nds.characteristics.attributes.characs_lane_range_attribute_value.CharacsLaneRangeAttributeValue, None] = None,
    ...
    @classmethod
    def from_reader(
            cls: typing.Type['CharacsLaneRangeFullAttribute'],
            zserio_reader: zserio.BitStreamReader) -> 'CharacsLaneRangeFullAttribute':
    ...
    def from_reader_packed(
            cls: typing.Type['CharacsLaneRangeFullAttribute'],
            zserio_context: CharacsLaneRangeFullAttribute.ZserioPackingContext,
            zserio_reader: zserio.BitStreamReader) -> 'CharacsLaneRangeFullAttribute':
        self = object.__new__(cls)
    ...
    def __eq__(self, other: object) -> bool:
        if isinstance(other, CharacsLaneRangeFullAttribute):
    ...
    @property
    def attribute_value(self) -> typing.Union[nds.characteristics.attributes.characs_lane_range_attribute_value.CharacsLaneRangeAttributeValue, None]:
        return self._attribute_value_

    @attribute_value.setter
    def attribute_value(self, attribute_value_: typing.Union[nds.characteristics.attributes.characs_lane_range_attribute_value.CharacsLaneRangeAttributeValue, None]) -> None:
        self._attribute_value_ = attribute_value_
    ...
    def init_packing_context(self, zserio_context: CharacsLaneRangeFullAttribute.ZserioPackingContext) -> None:
    ...
    def bitsizeof_packed(self, zserio_context: CharacsLaneRangeFullAttribute.ZserioPackingContext, bitposition: int = 0) -> int:
        end_bitposition = bitposition
    ...
    def initialize_offsets_packed(self, zserio_context: CharacsLaneRangeFullAttribute.ZserioPackingContext, bitposition: int) -> int:
        end_bitposition = bitposition
    ...
    def read(self, zserio_reader: zserio.BitStreamReader) -> None:
        ...
        self._attribute_value_ = nds.characteristics.attributes.characs_lane_range_attribute_value.CharacsLaneRangeAttributeValue.from_reader(zserio_reader, self._attribute_type_code_)
    ...
    def read_packed(self, zserio_context: CharacsLaneRangeFullAttribute.ZserioPackingContext, zserio_reader: zserio.BitStreamReader) -> None:
        ...
        self._attribute_value_ = nds.characteristics.attributes.characs_lane_range_attribute_value.CharacsLaneRangeAttributeValue.from_reader_packed(zserio_context.attribute_value, zserio_reader, self._attribute_type_code_)
    ...
    def write(self, zserio_writer: zserio.BitStreamWriter) -> None:
        ...
        if self._attribute_value_.type is not (self._attribute_type_code_):
            raise zserio.PythonRuntimeException("Wrong parameter type for field CharacsLaneRangeFullAttribute.attributeValue: "
    ...
    def write_packed(self, zserio_context: CharacsLaneRangeFullAttribute.ZserioPackingContext,
    ...
    class ZserioPackingContext:
        def __init__(self):
            ...
            self._attribute_value_ = nds.characteristics.attributes.characs_lane_range_attribute_value.CharacsLaneRangeAttributeValue.ZserioPackingContext()
