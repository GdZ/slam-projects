...
import nds.characteristics.attributes.characs_lane_range_attribute_type
...
import nds.characteristics.types.lane_width_state
import nds.characteristics.types.metric_lane_width
import nds.characteristics.types.movable_bridge
import nds.characteristics.types.multi_digitized_lane_group_reference
...
class CharacsLaneRangeAttributeValue:
    def __init__(
            self,
            type_: nds.characteristics.attributes.characs_lane_range_attribute_type.CharacsLaneRangeAttributeType,
            *,
            lane_type_: typing.Union[nds.core.types.lane_type.LaneType, None] = None,
            ...
            lane_width_state_: typing.Union[nds.characteristics.types.lane_width_state.LaneWidthState, None] = None,
            ...
            multi_digitized_lane_group_reference_: typing.Union[nds.characteristics.types.multi_digitized_lane_group_reference.MultiDigitizedLaneGroupReference, None] = None,
            global_source_id_: typing.Union[nds.core.types.global_source_id.GlobalSourceId, None] = None) -> None:
        self._type_ = type_
        self._choice: typing.Any = None
        if lane_type_ is not None:
            self._choice = lane_type_
        if metric_lane_width_ is not None:
            if self._choice != None:
                raise zserio.PythonRuntimeException("Calling constructor of choice CharacsLaneRangeAttributeValue is ambiguous!")
        ...
        if lane_width_state_ is not None:
            if self._choice != None:
                raise zserio.PythonRuntimeException("Calling constructor of choice CharacsLaneRangeAttributeValue is ambiguous!")
            self._choice = lane_width_state_
        ...
        if multi_digitized_lane_group_reference_ is not None:
            if self._choice != None:
                raise zserio.PythonRuntimeException("Calling constructor of choice CharacsLaneRangeAttributeValue is ambiguous!")
            self._choice = multi_digitized_lane_group_reference_
    ...
    @classmethod
    def from_reader(
            cls: typing.Type['CharacsLaneRangeAttributeValue'],
            zserio_reader: zserio.BitStreamReader,
            type_: nds.characteristics.attributes.characs_lane_range_attribute_type.CharacsLaneRangeAttributeType) -> 'CharacsLaneRangeAttributeValue':
    ...
    def from_reader_packed(
            cls: typing.Type['CharacsLaneRangeAttributeValue'],
            zserio_context: CharacsLaneRangeAttributeValue.ZserioPackingContext,
            zserio_reader: zserio.BitStreamReader,
            type_: nds.characteristics.attributes.characs_lane_range_attribute_type.CharacsLaneRangeAttributeType) -> 'CharacsLaneRangeAttributeValue':
        self = object.__new__(cls)
        self._type_ = type_
    ...
    def __eq__(self, other: object) -> bool:
        if isinstance(other, CharacsLaneRangeAttributeValue):
    ...
    def __hash__(self) -> int:
        ...
        if selector == (nds.characteristics.attributes.characs_lane_range_attribute_type.CharacsLaneRangeAttributeType.LANE_TYPE):
            result = zserio.hashcode.calc_hashcode_object(result, self._choice)
        elif selector == (nds.characteristics.attributes.characs_lane_range_attribute_type.CharacsLaneRangeAttributeType.PHYSICAL_WIDTH_METRIC):
            result = zserio.hashcode.calc_hashcode_int32(result, self._choice)
        elif selector == (nds.characteristics.attributes.characs_lane_range_attribute_type.CharacsLaneRangeAttributeType.TYPE_OF_PAVEMENT):
            result = zserio.hashcode.calc_hashcode_object(result, self._choice)
        elif selector == (nds.characteristics.attributes.characs_lane_range_attribute_type.CharacsLaneRangeAttributeType.DIVIDER_TYPE):
            result = zserio.hashcode.calc_hashcode_object(result, self._choice)
        elif selector == (nds.characteristics.attributes.characs_lane_range_attribute_type.CharacsLaneRangeAttributeType.GRADE_TYPE):
            result = zserio.hashcode.calc_hashcode_object(result, self._choice)
        elif selector == (nds.characteristics.attributes.characs_lane_range_attribute_type.CharacsLaneRangeAttributeType.RAILWAY_CROSSING):
            result = zserio.hashcode.calc_hashcode_object(result, self._choice)
        elif selector == (nds.characteristics.attributes.characs_lane_range_attribute_type.CharacsLaneRangeAttributeType.PEDESTRIAN_CROSSING):
            result = zserio.hashcode.calc_hashcode_object(result, self._choice)
        elif selector == (nds.characteristics.attributes.characs_lane_range_attribute_type.CharacsLaneRangeAttributeType.TRAFFIC_CALMING):
            result = zserio.hashcode.calc_hashcode_object(result, self._choice)
        elif selector == (nds.characteristics.attributes.characs_lane_range_attribute_type.CharacsLaneRangeAttributeType.MOVABLE_BRIDGE):
            result = zserio.hashcode.calc_hashcode_object(result, self._choice)
        elif selector == (nds.characteristics.attributes.characs_lane_range_attribute_type.CharacsLaneRangeAttributeType.SUPERELEVATION):
            result = zserio.hashcode.calc_hashcode_object(result, self._choice)
        elif selector == (nds.characteristics.attributes.characs_lane_range_attribute_type.CharacsLaneRangeAttributeType.ROAD_MEDIAN):
            result = zserio.hashcode.calc_hashcode_object(result, self._choice)
        elif selector == (nds.characteristics.attributes.characs_lane_range_attribute_type.CharacsLaneRangeAttributeType.HAS_SIDEWALK):
            result = zserio.hashcode.calc_hashcode_object(result, self._choice)
        elif selector == (nds.characteristics.attributes.characs_lane_range_attribute_type.CharacsLaneRangeAttributeType.FRICTION):
            result = zserio.hashcode.calc_hashcode_float32(result, self._choice)
        elif selector == (nds.characteristics.attributes.characs_lane_range_attribute_type.CharacsLaneRangeAttributeType.STATION_PLAZA_TYPE):
            result = zserio.hashcode.calc_hashcode_object(result, self._choice)
        elif selector == (nds.characteristics.attributes.characs_lane_range_attribute_type.CharacsLaneRangeAttributeType.AVERAGE_SPEED):
            result = zserio.hashcode.calc_hashcode_int32(result, self._choice)
        elif selector == (nds.characteristics.attributes.characs_lane_range_attribute_type.CharacsLaneRangeAttributeType.FUNCTIONAL_ROAD_CLASS):
            result = zserio.hashcode.calc_hashcode_int32(result, self._choice)
        elif selector == (nds.characteristics.attributes.characs_lane_range_attribute_type.CharacsLaneRangeAttributeType.PRIORITY_ROAD_CLASS):
            result = zserio.hashcode.calc_hashcode_int32(result, self._choice)
        elif selector == (nds.characteristics.attributes.characs_lane_range_attribute_type.CharacsLaneRangeAttributeType.LANE_WIDTH_STATE):
            result = zserio.hashcode.calc_hashcode_object(result, self._choice)
        elif selector == (nds.characteristics.attributes.characs_lane_range_attribute_type.CharacsLaneRangeAttributeType.COMPLEX_INTERSECTION_TYPE):
            result = zserio.hashcode.calc_hashcode_object(result, self._choice)
        elif selector == (nds.characteristics.attributes.characs_lane_range_attribute_type.CharacsLaneRangeAttributeType.START_OR_DESTINATION_ROAD_ONLY):
            result = zserio.hashcode.calc_hashcode_object(result, self._choice)
        elif selector == (nds.characteristics.attributes.characs_lane_range_attribute_type.CharacsLaneRangeAttributeType.ROAD_LOCATION_ID):
            result = zserio.hashcode.calc_hashcode_object(result, self._choice)
        elif selector == (nds.characteristics.attributes.characs_lane_range_attribute_type.CharacsLaneRangeAttributeType.HAS_STREET_LIGHTS):
            result = zserio.hashcode.calc_hashcode_object(result, self._choice)
        elif selector == (nds.characteristics.attributes.characs_lane_range_attribute_type.CharacsLaneRangeAttributeType.SHARED_ROAD_SURFACE_WITH_PEDESTRIANS):
            result = zserio.hashcode.calc_hashcode_object(result, self._choice)
        elif selector == (nds.characteristics.attributes.characs_lane_range_attribute_type.CharacsLaneRangeAttributeType.IN_BUSINESS_DISTRICT):
            result = zserio.hashcode.calc_hashcode_object(result, self._choice)
        elif selector == (nds.characteristics.attributes.characs_lane_range_attribute_type.CharacsLaneRangeAttributeType.FERRY_TYPE):
            result = zserio.hashcode.calc_hashcode_object(result, self._choice)
        elif selector == (nds.characteristics.attributes.characs_lane_range_attribute_type.CharacsLaneRangeAttributeType.STUBBLE):
            result = zserio.hashcode.calc_hashcode_object(result, self._choice)
        elif selector == (nds.characteristics.attributes.characs_lane_range_attribute_type.CharacsLaneRangeAttributeType.MIDDLE_DIVIDER_TYPE):
            result = zserio.hashcode.calc_hashcode_object(result, self._choice)
        elif selector == (nds.characteristics.attributes.characs_lane_range_attribute_type.CharacsLaneRangeAttributeType.MULTI_DIGITIZED_LANE_GROUP_REFERENCE):
            result = zserio.hashcode.calc_hashcode_object(result, self._choice)
        elif selector == (nds.characteristics.attributes.characs_lane_range_attribute_type.CharacsLaneRangeAttributeType.GLOBAL_SOURCE_ID):
    ...
    @property
    def type(self) -> nds.characteristics.attributes.characs_lane_range_attribute_type.CharacsLaneRangeAttributeType:
        return self._type_

    @property
    def lane_type(self) -> typing.Union[nds.core.types.lane_type.LaneType, None]:
        return self._choice

    @lane_type.setter
    def lane_type(self, lane_type_: typing.Union[nds.core.types.lane_type.LaneType, None]) -> None:
        self._choice = lane_type_
    ...
    @property
    def lane_width_state(self) -> typing.Union[nds.characteristics.types.lane_width_state.LaneWidthState, None]:
        return self._choice

    @lane_width_state.setter
    def lane_width_state(self, lane_width_state_: typing.Union[nds.characteristics.types.lane_width_state.LaneWidthState, None]) -> None:
        self._choice = lane_width_state_
    ...
    @property
    def multi_digitized_lane_group_reference(self) -> typing.Union[nds.characteristics.types.multi_digitized_lane_group_reference.MultiDigitizedLaneGroupReference, None]:
        return self._choice

    @multi_digitized_lane_group_reference.setter
    def multi_digitized_lane_group_reference(self, multi_digitized_lane_group_reference_: typing.Union[nds.characteristics.types.multi_digitized_lane_group_reference.MultiDigitizedLaneGroupReference, None]) -> None:
        self._choice = multi_digitized_lane_group_reference_
    ...
    def choice_tag(self) -> int:
        ...
        if selector == (nds.characteristics.attributes.characs_lane_range_attribute_type.CharacsLaneRangeAttributeType.LANE_TYPE):
            ...
            return self.CHOICE_LANE_WIDTH_STATE
        elif selector == (nds.characteristics.attributes.characs_lane_range_attribute_type.CharacsLaneRangeAttributeType.COMPLEX_INTERSECTION_TYPE):
            ...
            return self.CHOICE_MULTI_DIGITIZED_LANE_GROUP_REFERENCE
        elif selector == (nds.characteristics.attributes.characs_lane_range_attribute_type.CharacsLaneRangeAttributeType.GLOBAL_SOURCE_ID):
            return self.CHOICE_GLOBAL_SOURCE_ID
        else:
            return self.UNDEFINED_CHOICE

    def init_packing_context(self, zserio_context: CharacsLaneRangeAttributeValue.ZserioPackingContext) -> None:
        selector = self._type_

        if selector == (nds.characteristics.attributes.characs_lane_range_attribute_type.CharacsLaneRangeAttributeType.LANE_TYPE):
            self._choice.init_packing_context(zserio_context.lane_type)
        elif selector == (nds.characteristics.attributes.characs_lane_range_attribute_type.CharacsLaneRangeAttributeType.PHYSICAL_WIDTH_METRIC):
            ...
            self._choice.init_packing_context(zserio_context.lane_width_state)
        elif selector == (nds.characteristics.attributes.characs_lane_range_attribute_type.CharacsLaneRangeAttributeType.COMPLEX_INTERSECTION_TYPE):
            ...
            self._choice.init_packing_context(zserio_context.multi_digitized_lane_group_reference)
        elif selector == (nds.characteristics.attributes.characs_lane_range_attribute_type.CharacsLaneRangeAttributeType.GLOBAL_SOURCE_ID):
            pass
        else:
            raise zserio.PythonRuntimeException("No match in choice CharacsLaneRangeAttributeValue!")
    ...
    def bitsizeof_packed(self, zserio_context: CharacsLaneRangeAttributeValue.ZserioPackingContext,
        ...
        if selector == (nds.characteristics.attributes.characs_lane_range_attribute_type.CharacsLaneRangeAttributeType.LANE_TYPE):
            end_bitposition += self._choice.bitsizeof_packed(zserio_context.lane_type, end_bitposition)
        elif selector == (nds.characteristics.attributes.characs_lane_range_attribute_type.CharacsLaneRangeAttributeType.PHYSICAL_WIDTH_METRIC):
            ...
            end_bitposition += self._choice.bitsizeof_packed(zserio_context.lane_width_state, end_bitposition)
        elif selector == (nds.characteristics.attributes.characs_lane_range_attribute_type.CharacsLaneRangeAttributeType.COMPLEX_INTERSECTION_TYPE):
            ...
            end_bitposition += self._choice.bitsizeof_packed(zserio_context.multi_digitized_lane_group_reference, end_bitposition)
        elif selector == (nds.characteristics.attributes.characs_lane_range_attribute_type.CharacsLaneRangeAttributeType.GLOBAL_SOURCE_ID):
            end_bitposition += zserio.bitsizeof.bitsizeof_string(self._choice)
        else:
            raise zserio.PythonRuntimeException("No match in choice CharacsLaneRangeAttributeValue!")
    ...
    def initialize_offsets_packed(self, zserio_context: CharacsLaneRangeAttributeValue.ZserioPackingContext,
                                  bitposition: int) -> int:
        end_bitposition = bitposition
        ...
        if selector == (nds.characteristics.attributes.characs_lane_range_attribute_type.CharacsLaneRangeAttributeType.LANE_TYPE):
            end_bitposition = self._choice.initialize_offsets_packed(zserio_context.lane_type, end_bitposition)
        elif selector == (nds.characteristics.attributes.characs_lane_range_attribute_type.CharacsLaneRangeAttributeType.PHYSICAL_WIDTH_METRIC):
            end_bitposition += zserio_context.metric_lane_width.bitsizeof(zserio.array.VarUInt32ArrayTraits(), self._choice)
        elif selector == (nds.characteristics.attributes.characs_lane_range_attribute_type.CharacsLaneRangeAttributeType.TYPE_OF_PAVEMENT):
            ...
            end_bitposition = self._choice.initialize_offsets_packed(zserio_context.lane_width_state, end_bitposition)
        elif selector == (nds.characteristics.attributes.characs_lane_range_attribute_type.CharacsLaneRangeAttributeType.COMPLEX_INTERSECTION_TYPE):
            ...
            end_bitposition = self._choice.initialize_offsets_packed(zserio_context.multi_digitized_lane_group_reference, end_bitposition)
        elif selector == (nds.characteristics.attributes.characs_lane_range_attribute_type.CharacsLaneRangeAttributeType.GLOBAL_SOURCE_ID):
            end_bitposition += zserio.bitsizeof.bitsizeof_string(self._choice)
        else:
            raise zserio.PythonRuntimeException("No match in choice CharacsLaneRangeAttributeValue!")
    ...
    def read(self, zserio_reader: zserio.BitStreamReader) -> None:
        ...
        if selector == (nds.characteristics.attributes.characs_lane_range_attribute_type.CharacsLaneRangeAttributeType.LANE_TYPE):
            self._choice = nds.core.types.lane_type.LaneType.from_reader(zserio_reader)
        elif selector == (nds.characteristics.attributes.characs_lane_range_attribute_type.CharacsLaneRangeAttributeType.PHYSICAL_WIDTH_METRIC):
            ...
            self._choice = nds.characteristics.types.lane_width_state.LaneWidthState.from_reader(zserio_reader)
        elif selector == (nds.characteristics.attributes.characs_lane_range_attribute_type.CharacsLaneRangeAttributeType.COMPLEX_INTERSECTION_TYPE):
            ...
            self._choice = nds.characteristics.types.multi_digitized_lane_group_reference.MultiDigitizedLaneGroupReference.from_reader(zserio_reader)
        elif selector == (nds.characteristics.attributes.characs_lane_range_attribute_type.CharacsLaneRangeAttributeType.GLOBAL_SOURCE_ID):
            self._choice = zserio_reader.read_string()
        else:
            raise zserio.PythonRuntimeException("No match in choice CharacsLaneRangeAttributeValue!")

    def read_packed(self, zserio_context: CharacsLaneRangeAttributeValue.ZserioPackingContext,
                    zserio_reader: zserio.BitStreamReader) -> None:
        selector = self._type_

        if selector == (nds.characteristics.attributes.characs_lane_range_attribute_type.CharacsLaneRangeAttributeType.LANE_TYPE):
            self._choice = nds.core.types.lane_type.LaneType.from_reader_packed(zserio_context.lane_type, zserio_reader)
        elif selector == (nds.characteristics.attributes.characs_lane_range_attribute_type.CharacsLaneRangeAttributeType.PHYSICAL_WIDTH_METRIC):
            ...
            self._choice = nds.characteristics.types.lane_width_state.LaneWidthState.from_reader_packed(zserio_context.lane_width_state, zserio_reader)
        elif selector == (nds.characteristics.attributes.characs_lane_range_attribute_type.CharacsLaneRangeAttributeType.COMPLEX_INTERSECTION_TYPE):
            ...
            self._choice = nds.characteristics.types.multi_digitized_lane_group_reference.MultiDigitizedLaneGroupReference.from_reader_packed(zserio_context.multi_digitized_lane_group_reference, zserio_reader)
        elif selector == (nds.characteristics.attributes.characs_lane_range_attribute_type.CharacsLaneRangeAttributeType.GLOBAL_SOURCE_ID):
            self._choice = zserio_reader.read_string()
        else:
            raise zserio.PythonRuntimeException("No match in choice CharacsLaneRangeAttributeValue!")
    ...
    def write_packed(self, zserio_context: CharacsLaneRangeAttributeValue.ZserioPackingContext,
                     zserio_writer: zserio.BitStreamWriter) -> None:
        selector = self._type_

        if selector == (nds.characteristics.attributes.characs_lane_range_attribute_type.CharacsLaneRangeAttributeType.LANE_TYPE):
            self._choice.write_packed(zserio_context.lane_type, zserio_writer)
        elif selector == (nds.characteristics.attributes.characs_lane_range_attribute_type.CharacsLaneRangeAttributeType.PHYSICAL_WIDTH_METRIC):
            ...
            self._choice.write_packed(zserio_context.lane_width_state, zserio_writer)
        elif selector == (nds.characteristics.attributes.characs_lane_range_attribute_type.CharacsLaneRangeAttributeType.COMPLEX_INTERSECTION_TYPE):
            ...
            self._choice.write_packed(zserio_context.multi_digitized_lane_group_reference, zserio_writer)
        elif selector == (nds.characteristics.attributes.characs_lane_range_attribute_type.CharacsLaneRangeAttributeType.GLOBAL_SOURCE_ID):
            zserio_writer.write_string(self._choice)
        else:
            raise zserio.PythonRuntimeException("No match in choice CharacsLaneRangeAttributeValue!")
    ...
    class ZserioPackingContext:
        def __init__(self):
            self._lane_type_ = nds.core.types.lane_type.LaneType.ZserioPackingContext()
            ...
            self._lane_width_state_ = zserio.array.DeltaContext()
            ...
            self._multi_digitized_lane_group_reference_ = nds.characteristics.types.multi_digitized_lane_group_reference.MultiDigitizedLaneGroupReference.ZserioPackingContext()

        @property
        def lane_type(self):
            return self._lane_type_
        ...
        @property
        def lane_width_state(self):
            return self._lane_width_state_
        ...
        @property
        def multi_digitized_lane_group_reference(self):
            return self._multi_digitized_lane_group_reference_

    CHOICE_LANE_TYPE = 0
    CHOICE_METRIC_LANE_WIDTH = 1
    CHOICE_PAVEMENT_TYPE = 2
    CHOICE_DIVIDER_TYPE = 3
    CHOICE_GRADE_TYPE = 4
    CHOICE_RAILWAY_CROSSING = 5
    CHOICE_PEDESTRIAN_CROSSING = 6
    CHOICE_TRAFFIC_CALMING = 7
    CHOICE_MOVABLE_BRIDGE = 8
    CHOICE_SUPER_ELEVATION = 9
    CHOICE_ROAD_MEDIAN = 10
    CHOICE_HAS_SIDEWALK = 11
    CHOICE_FRICTION_COEFFICIENT = 12
    CHOICE_STATION_PLAZA_TYPE = 13
    CHOICE_AVERAGE_SPEED = 14
    CHOICE_FUNCTIONAL_ROAD_CLASS = 15
    CHOICE_PRIORITY_ROAD_CLASS = 16
    CHOICE_LANE_WIDTH_STATE = 17
    CHOICE_COMPLEX_INTERSECTION_TYPE = 18
    CHOICE_START_OR_DESTINATION_ROAD_ONLY = 19
    CHOICE_ROAD_LOCATION_ID = 20
    CHOICE_HAS_STREET_LIGHTS = 21
    CHOICE_SHARED_ROAD_SURFACE_WITH_PEDESTRIANS = 22
    CHOICE_IN_BUSINESS_DISTRICT = 23
    CHOICE_FERRY_TYPE = 24
    CHOICE_STUBBLE = 25
    CHOICE_MIDDLE_DIVIDER_TYPE = 26
    CHOICE_MULTI_DIGITIZED_LANE_GROUP_REFERENCE = 27
    CHOICE_GLOBAL_SOURCE_ID = 28
    UNDEFINED_CHOICE = -1
