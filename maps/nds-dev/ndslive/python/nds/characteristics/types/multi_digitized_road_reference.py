...
class MultiDigitizedRoadReference:
    def __init__(
            ...
            counterpart_reference_: typing.Optional[nds.road.reference.types.road_reference.RoadReference] = None,
            counterpart_reference_indirect_: typing.Optional[nds.road.reference.types.road_reference_indirect.RoadReferenceIndirect] = None) -> None:
    ...
    @classmethod
    def from_reader(
            cls: typing.Type['MultiDigitizedRoadReference'],
            zserio_reader: zserio.BitStreamReader) -> 'MultiDigitizedRoadReference':
    ...
    def from_reader_packed(
            cls: typing.Type['MultiDigitizedRoadReference'],
            zserio_context: MultiDigitizedRoadReference.ZserioPackingContext,
            zserio_reader: zserio.BitStreamReader) -> 'MultiDigitizedRoadReference':
        self = object.__new__(cls)
    ...
    def __eq__(self, other: object) -> bool:
        if isinstance(other, MultiDigitizedRoadReference):
    ...
    @property
    def counterpart_reference(self) -> typing.Optional[nds.road.reference.types.road_reference.RoadReference]:
        return self._counterpart_reference_

    @counterpart_reference.setter
    def counterpart_reference(self, counterpart_reference_: typing.Optional[nds.road.reference.types.road_reference.RoadReference]) -> None:
        self._counterpart_reference_ = counterpart_reference_
    ...
    @property
    def counterpart_reference_indirect(self) -> typing.Optional[nds.road.reference.types.road_reference_indirect.RoadReferenceIndirect]:
        return self._counterpart_reference_indirect_

    @counterpart_reference_indirect.setter
    def counterpart_reference_indirect(self, counterpart_reference_indirect_: typing.Optional[nds.road.reference.types.road_reference_indirect.RoadReferenceIndirect]) -> None:
        self._counterpart_reference_indirect_ = counterpart_reference_indirect_
    ...
    def init_packing_context(self, zserio_context: MultiDigitizedRoadReference.ZserioPackingContext) -> None:
        if self.is_counterpart_reference_used():
    ...
    def bitsizeof_packed(self, zserio_context: MultiDigitizedRoadReference.ZserioPackingContext, bitposition: int = 0) -> int:
        end_bitposition = bitposition
        end_bitposition += 1
        if self.is_counterpart_reference_used():
    ...
    def initialize_offsets_packed(self, zserio_context: MultiDigitizedRoadReference.ZserioPackingContext, bitposition: int) -> int:
        end_bitposition = bitposition
        end_bitposition += 1
        if self.is_counterpart_reference_used():
    ...
    def read(self, zserio_reader: zserio.BitStreamReader) -> None:
        ...
        if self.is_counterpart_reference_used():
            self._counterpart_reference_ = nds.road.reference.types.road_reference.RoadReference.from_reader(zserio_reader)
        else:
            self._counterpart_reference_ = None
        if self.is_counterpart_reference_indirect_used():
            self._counterpart_reference_indirect_ = nds.road.reference.types.road_reference_indirect.RoadReferenceIndirect.from_reader(zserio_reader)
        else:
            self._counterpart_reference_indirect_ = None

    def read_packed(self, zserio_context: MultiDigitizedRoadReference.ZserioPackingContext, zserio_reader: zserio.BitStreamReader) -> None:
        self._is_direct_reference_ = zserio_reader.read_bool()

        if self.is_counterpart_reference_used():
            self._counterpart_reference_ = nds.road.reference.types.road_reference.RoadReference.from_reader_packed(zserio_context.counterpart_reference, zserio_reader)
        else:
            self._counterpart_reference_ = None

        if self.is_counterpart_reference_indirect_used():
            self._counterpart_reference_indirect_ = nds.road.reference.types.road_reference_indirect.RoadReferenceIndirect.from_reader_packed(zserio_context.counterpart_reference_indirect, zserio_reader)
        else:
            self._counterpart_reference_indirect_ = None
    ...
    def write_packed(self, zserio_context: MultiDigitizedRoadReference.ZserioPackingContext,
    ...
    class ZserioPackingContext:
        def __init__(self):
            self._counterpart_reference_ = nds.road.reference.types.road_reference.RoadReference.ZserioPackingContext()
            self._counterpart_reference_indirect_ = nds.road.reference.types.road_reference_indirect.RoadReferenceIndirect.ZserioPackingContext()
