...
class RoadLocationCharacteristicsLayerMetadata:
    def __init__(
            ...
            road_location_attribute_metadata_: typing.Union[nds.characteristics.instantiations.characs_road_range_attribute_metadata.CharacsRoadRangeAttributeMetadata, None] = None,
    ...
    @classmethod
    def from_reader(
            cls: typing.Type['RoadLocationCharacteristicsLayerMetadata'],
            zserio_reader: zserio.BitStreamReader) -> 'RoadLocationCharacteristicsLayerMetadata':
    ...
    def from_reader_packed(
            cls: typing.Type['RoadLocationCharacteristicsLayerMetadata'],
            zserio_context: RoadLocationCharacteristicsLayerMetadata.ZserioPackingContext,
            zserio_reader: zserio.BitStreamReader) -> 'RoadLocationCharacteristicsLayerMetadata':
        self = object.__new__(cls)
    ...
    def __eq__(self, other: object) -> bool:
        if isinstance(other, RoadLocationCharacteristicsLayerMetadata):
            return ((self._content_ == other._content_) and
                    (self._road_location_attribute_metadata_ == other._road_location_attribute_metadata_) and
    ...
    @property
    def road_location_attribute_metadata(self) -> typing.Union[nds.characteristics.instantiations.characs_road_range_attribute_metadata.CharacsRoadRangeAttributeMetadata, None]:
        return self._road_location_attribute_metadata_

    @road_location_attribute_metadata.setter
    def road_location_attribute_metadata(self, road_location_attribute_metadata_: typing.Union[nds.characteristics.instantiations.characs_road_range_attribute_metadata.CharacsRoadRangeAttributeMetadata, None]) -> None:
        self._road_location_attribute_metadata_ = road_location_attribute_metadata_
    ...
    def init_packing_context(self, zserio_context: RoadLocationCharacteristicsLayerMetadata.ZserioPackingContext) -> None:
    ...
    def bitsizeof_packed(self, zserio_context: RoadLocationCharacteristicsLayerMetadata.ZserioPackingContext, bitposition: int = 0) -> int:
        end_bitposition = bitposition
    ...
    def initialize_offsets_packed(self, zserio_context: RoadLocationCharacteristicsLayerMetadata.ZserioPackingContext, bitposition: int) -> int:
        end_bitposition = bitposition
    ...
    def read(self, zserio_reader: zserio.BitStreamReader) -> None:
        ...
        self._road_location_attribute_metadata_ = nds.characteristics.instantiations.characs_road_range_attribute_metadata.CharacsRoadRangeAttributeMetadata.from_reader(zserio_reader)
    ...
    def read_packed(self, zserio_context: RoadLocationCharacteristicsLayerMetadata.ZserioPackingContext, zserio_reader: zserio.BitStreamReader) -> None:
        ...
        self._road_location_attribute_metadata_ = nds.characteristics.instantiations.characs_road_range_attribute_metadata.CharacsRoadRangeAttributeMetadata.from_reader_packed(zserio_context.road_location_attribute_metadata, zserio_reader)
    ...
    def write_packed(self, zserio_context: RoadLocationCharacteristicsLayerMetadata.ZserioPackingContext,
    ...
    class ZserioPackingContext:
        def __init__(self):
            ...
            self._road_location_attribute_metadata_ = nds.characteristics.instantiations.characs_road_range_attribute_metadata.CharacsRoadRangeAttributeMetadata.ZserioPackingContext()
