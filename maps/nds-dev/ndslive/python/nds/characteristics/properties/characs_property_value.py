...
import nds.characteristics.properties.property_value
...
class CharacsPropertyValue:
    def __init__(
            self,
            type_: nds.characteristics.properties.characs_property_type.CharacsPropertyType,
            value_: typing.Optional[nds.characteristics.properties.property_value.PropertyValue] = None,
    ...
    @classmethod
    def from_reader(
            cls: typing.Type['CharacsPropertyValue'],
            zserio_reader: zserio.BitStreamReader,
            type_: nds.characteristics.properties.characs_property_type.CharacsPropertyType) -> 'CharacsPropertyValue':
    ...
    def from_reader_packed(
            cls: typing.Type['CharacsPropertyValue'],
            zserio_context: CharacsPropertyValue.ZserioPackingContext,
            zserio_reader: zserio.BitStreamReader,
            type_: nds.characteristics.properties.characs_property_type.CharacsPropertyType) -> 'CharacsPropertyValue':
        self = object.__new__(cls)
        self._type_ = type_
    ...
    def __eq__(self, other: object) -> bool:
        if isinstance(other, CharacsPropertyValue):
    ...
    @property
    def type(self) -> nds.characteristics.properties.characs_property_type.CharacsPropertyType:
        return self._type_

    @property
    def value(self) -> typing.Optional[nds.characteristics.properties.property_value.PropertyValue]:
        return self._value_

    @value.setter
    def value(self, value_: typing.Optional[nds.characteristics.properties.property_value.PropertyValue]) -> None:
        self._value_ = value_

    def is_value_used(self) -> bool:
        return self._type_.type != nds.characteristics.properties.property_type.PropertyType.CORE
    ...
    def init_packing_context(self, zserio_context: CharacsPropertyValue.ZserioPackingContext) -> None:
        if self.is_value_used():
    ...
    def bitsizeof_packed(self, zserio_context: CharacsPropertyValue.ZserioPackingContext, bitposition: int = 0) -> int:
        end_bitposition = bitposition
        if self.is_value_used():
    ...
    def initialize_offsets_packed(self, zserio_context: CharacsPropertyValue.ZserioPackingContext, bitposition: int) -> int:
        end_bitposition = bitposition
        if self.is_value_used():
    ...
    def read(self, zserio_reader: zserio.BitStreamReader) -> None:
        if self.is_value_used():
            self._value_ = nds.characteristics.properties.property_value.PropertyValue.from_reader(zserio_reader, self._type_.type)
        else:
            self._value_ = None
        if self.is_core_value_used():
    ...
    def read_packed(self, zserio_context: CharacsPropertyValue.ZserioPackingContext, zserio_reader: zserio.BitStreamReader) -> None:
        if self.is_value_used():
            self._value_ = nds.characteristics.properties.property_value.PropertyValue.from_reader_packed(zserio_context.value, zserio_reader, self._type_.type)
        else:
            self._value_ = None
    ...
    def write(self, zserio_writer: zserio.BitStreamWriter) -> None:
        if self.is_value_used():
            ...
            if self._value_.type is not (self._type_.type):
                raise zserio.PythonRuntimeException("Wrong parameter type for field CharacsPropertyValue.value: "
        ...
        if self.is_core_value_used():
            ...
            if self._core_value_.type is not (self._type_.core_type):
                raise zserio.PythonRuntimeException("Wrong parameter type for field CharacsPropertyValue.coreValue: "
                                                    f"{self._core_value_.type} != {self._type_.core_type}!")
            self._core_value_.write(zserio_writer)

    def write_packed(self, zserio_context: CharacsPropertyValue.ZserioPackingContext,
    ...
    class ZserioPackingContext:
        def __init__(self):
            self._value_ = nds.characteristics.properties.property_value.PropertyValue.ZserioPackingContext()
