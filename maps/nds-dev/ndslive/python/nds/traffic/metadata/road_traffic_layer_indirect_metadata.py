...
class RoadTrafficLayerIndirectMetadata:
    ...
    @classmethod
    def from_reader(
            cls: typing.Type['RoadTrafficLayerIndirectMetadata'],
            zserio_reader: zserio.BitStreamReader) -> 'RoadTrafficLayerIndirectMetadata':
    ...
    def from_reader_packed(
            cls: typing.Type['RoadTrafficLayerIndirectMetadata'],
            zserio_context: RoadTrafficLayerIndirectMetadata.ZserioPackingContext,
            zserio_reader: zserio.BitStreamReader) -> 'RoadTrafficLayerIndirectMetadata':
        self = object.__new__(cls)
    ...
    def __eq__(self, other: object) -> bool:
        if isinstance(other, RoadTrafficLayerIndirectMetadata):
    ...
    def is_road_range_attribute_metadata_used(self) -> bool:
        return (self._content_ & nds.traffic.metadata.road_traffic_layer_content.RoadTrafficLayerContent.Values.ROAD_RANGE_MAPS) == nds.traffic.metadata.road_traffic_layer_content.RoadTrafficLayerContent.Values.ROAD_RANGE_MAPS or (self._content_ & nds.traffic.metadata.road_traffic_layer_content.RoadTrafficLayerContent.Values.ROAD_RANGE_SETS) == nds.traffic.metadata.road_traffic_layer_content.RoadTrafficLayerContent.Values.ROAD_RANGE_SETS
    ...
    def is_transition_attribute_metadata_used(self) -> bool:
        return (self._content_ & nds.traffic.metadata.road_traffic_layer_content.RoadTrafficLayerContent.Values.TRANSITION_MAPS) == nds.traffic.metadata.road_traffic_layer_content.RoadTrafficLayerContent.Values.TRANSITION_MAPS or (self._content_ & nds.traffic.metadata.road_traffic_layer_content.RoadTrafficLayerContent.Values.TRANSITION_SETS) == nds.traffic.metadata.road_traffic_layer_content.RoadTrafficLayerContent.Values.TRANSITION_SETS
    ...
    def init_packing_context(self, zserio_context: RoadTrafficLayerIndirectMetadata.ZserioPackingContext) -> None:
    ...
    def bitsizeof_packed(self, zserio_context: RoadTrafficLayerIndirectMetadata.ZserioPackingContext, bitposition: int = 0) -> int:
        end_bitposition = bitposition
    ...
    def initialize_offsets_packed(self, zserio_context: RoadTrafficLayerIndirectMetadata.ZserioPackingContext, bitposition: int) -> int:
        end_bitposition = bitposition
    ...
    def read_packed(self, zserio_context: RoadTrafficLayerIndirectMetadata.ZserioPackingContext, zserio_reader: zserio.BitStreamReader) -> None:
    ...
    def write_packed(self, zserio_context: RoadTrafficLayerIndirectMetadata.ZserioPackingContext,
