...
class TrafficPropertyType:
    def __init__(
            self,
            type_: typing.Union[nds.traffic.properties.property_type.PropertyType, None] = None,
    ...
    @classmethod
    def from_reader(
            cls: typing.Type['TrafficPropertyType'],
            zserio_reader: zserio.BitStreamReader) -> 'TrafficPropertyType':
    ...
    def from_reader_packed(
            cls: typing.Type['TrafficPropertyType'],
            zserio_context: TrafficPropertyType.ZserioPackingContext,
            zserio_reader: zserio.BitStreamReader) -> 'TrafficPropertyType':
        self = object.__new__(cls)
    ...
    def __eq__(self, other: object) -> bool:
        if isinstance(other, TrafficPropertyType):
    ...
    @property
    def type(self) -> typing.Union[nds.traffic.properties.property_type.PropertyType, None]:
        return self._type_

    @type.setter
    def type(self, type_: typing.Union[nds.traffic.properties.property_type.PropertyType, None]) -> None:
        self._type_ = type_
    ...
    def is_core_type_used(self) -> bool:
        return self._type_ == nds.traffic.properties.property_type.PropertyType.CORE
    ...
    def init_packing_context(self, zserio_context: TrafficPropertyType.ZserioPackingContext) -> None:
    ...
    def bitsizeof_packed(self, zserio_context: TrafficPropertyType.ZserioPackingContext, bitposition: int = 0) -> int:
        end_bitposition = bitposition
    ...
    def initialize_offsets_packed(self, zserio_context: TrafficPropertyType.ZserioPackingContext, bitposition: int) -> int:
        end_bitposition = bitposition
    ...
    def read(self, zserio_reader: zserio.BitStreamReader) -> None:
        self._type_ = nds.traffic.properties.property_type.PropertyType.from_reader(zserio_reader)
        if self.is_core_type_used():
            self._core_type_ = nds.core.properties.core_property_type.CorePropertyType.from_reader(zserio_reader)
        else:
            self._core_type_ = None

    def read_packed(self, zserio_context: TrafficPropertyType.ZserioPackingContext, zserio_reader: zserio.BitStreamReader) -> None:
        self._type_ = nds.traffic.properties.property_type.PropertyType.from_reader_packed(zserio_context.type, zserio_reader)
    ...
    def write_packed(self, zserio_context: TrafficPropertyType.ZserioPackingContext,
