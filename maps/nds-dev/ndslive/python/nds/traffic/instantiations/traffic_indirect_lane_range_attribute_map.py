...
import nds.traffic.instantiations.traffic_lane_range_attribute
import nds.traffic.instantiations.traffic_property_list

class TrafficIndirectLaneRangeAttributeMap:
    def __init__(
            self,
            coord_shift_: nds.core.geometry.coord_shift.CoordShift,
            attribute_type_code_: typing.Union[nds.traffic.attributes.traffic_lane_range_attribute_type.TrafficLaneRangeAttributeType, None] = None,
            feature_: nds.core.attributemap.feature_iterator.FeatureIterator = nds.core.attributemap.feature_iterator.FeatureIterator(),
            feature_references_: typing.List[nds.lane.reference.types.lane_group_reference_indirect.LaneGroupReferenceIndirect] = None,
            feature_validities_: typing.List[nds.lane.reference.types.lane_group_range_validity.LaneGroupRangeValidity] = None,
            ...
            attribute_values_: typing.List[nds.traffic.instantiations.traffic_lane_range_attribute.TrafficLaneRangeAttribute] = None,
    ...
    @classmethod
    def from_reader(
            cls: typing.Type['TrafficIndirectLaneRangeAttributeMap'],
            zserio_reader: zserio.BitStreamReader,
            coord_shift_: nds.core.geometry.coord_shift.CoordShift) -> 'TrafficIndirectLaneRangeAttributeMap':
    ...
    def from_reader_packed(
            cls: typing.Type['TrafficIndirectLaneRangeAttributeMap'],
            zserio_context: TrafficIndirectLaneRangeAttributeMap.ZserioPackingContext,
            zserio_reader: zserio.BitStreamReader,
            coord_shift_: nds.core.geometry.coord_shift.CoordShift) -> 'TrafficIndirectLaneRangeAttributeMap':
        self = object.__new__(cls)
        self._coord_shift_ = coord_shift_
    ...
    def __eq__(self, other: object) -> bool:
        if isinstance(other, TrafficIndirectLaneRangeAttributeMap):
    ...
    @property
    def attribute_type_code(self) -> typing.Union[nds.traffic.attributes.traffic_lane_range_attribute_type.TrafficLaneRangeAttributeType, None]:
        return self._attribute_type_code_

    @attribute_type_code.setter
    def attribute_type_code(self, attribute_type_code_: typing.Union[nds.traffic.attributes.traffic_lane_range_attribute_type.TrafficLaneRangeAttributeType, None]) -> None:
        self._attribute_type_code_ = attribute_type_code_
    ...
    @property
    def feature_references(self) -> typing.List[nds.lane.reference.types.lane_group_reference_indirect.LaneGroupReferenceIndirect]:
        return self._feature_references_.raw_array

    @feature_references.setter
    def feature_references(self, feature_references_: typing.List[nds.lane.reference.types.lane_group_reference_indirect.LaneGroupReferenceIndirect]) -> None:
        self._feature_references_ = zserio.array.Array(zserio.array.ObjectArrayTraits(self._ZserioElementFactory_feature_references()), feature_references_)

    @property
    def feature_validities(self) -> typing.List[nds.lane.reference.types.lane_group_range_validity.LaneGroupRangeValidity]:
        return self._feature_validities_.raw_array

    @feature_validities.setter
    def feature_validities(self, feature_validities_: typing.List[nds.lane.reference.types.lane_group_range_validity.LaneGroupRangeValidity]) -> None:
        self._feature_validities_ = zserio.array.Array(zserio.array.ObjectArrayTraits(self._ZserioElementFactory_feature_validities(self)), feature_validities_)
    ...
    @property
    def attribute_values(self) -> typing.List[nds.traffic.instantiations.traffic_lane_range_attribute.TrafficLaneRangeAttribute]:
        return self._attribute_values_.raw_array

    @attribute_values.setter
    def attribute_values(self, attribute_values_: typing.List[nds.traffic.instantiations.traffic_lane_range_attribute.TrafficLaneRangeAttribute]) -> None:
        self._attribute_values_ = zserio.array.Array(zserio.array.ObjectArrayTraits(self._ZserioElementFactory_attribute_values(self)), attribute_values_)
    ...
    def init_packing_context(self, zserio_context: TrafficIndirectLaneRangeAttributeMap.ZserioPackingContext) -> None:
    ...
    def bitsizeof_packed(self, zserio_context: TrafficIndirectLaneRangeAttributeMap.ZserioPackingContext, bitposition: int = 0) -> int:
        end_bitposition = bitposition
    ...
    def initialize_offsets_packed(self, zserio_context: TrafficIndirectLaneRangeAttributeMap.ZserioPackingContext, bitposition: int) -> int:
        end_bitposition = bitposition
    ...
    def read(self, zserio_reader: zserio.BitStreamReader) -> None:
        self._attribute_type_code_ = nds.traffic.attributes.traffic_lane_range_attribute_type.TrafficLaneRangeAttributeType.from_reader(zserio_reader)
    ...
    def read_packed(self, zserio_context: TrafficIndirectLaneRangeAttributeMap.ZserioPackingContext, zserio_reader: zserio.BitStreamReader) -> None:
        self._attribute_type_code_ = nds.traffic.attributes.traffic_lane_range_attribute_type.TrafficLaneRangeAttributeType.from_reader_packed(zserio_context.attribute_type_code, zserio_reader)
    ...
    def write(self, zserio_writer: zserio.BitStreamWriter) -> None:
        ...
        if len(self._feature_references_) != (self._feature_):
            raise zserio.PythonRuntimeException("Wrong array length for field TrafficIndirectLaneRangeAttributeMap.featureReferences: "
        ...
        if len(self._feature_validities_) != (self._feature_):
            raise zserio.PythonRuntimeException("Wrong array length for field TrafficIndirectLaneRangeAttributeMap.featureValidities: "
        ...
        if len(self._feature_value_ptr_) != (self._feature_):
            raise zserio.PythonRuntimeException("Wrong array length for field TrafficIndirectLaneRangeAttributeMap.featureValuePtr: "
        ...
        if len(self._attribute_values_) != (self._attribute_):
            raise zserio.PythonRuntimeException("Wrong array length for field TrafficIndirectLaneRangeAttributeMap.attributeValues: "
        ...
        if len(self._attribute_properties_) != (self._attribute_):
            raise zserio.PythonRuntimeException("Wrong array length for field TrafficIndirectLaneRangeAttributeMap.attributeProperties: "
        ...
        if len(self._attribute_conditions_) != (self._attribute_):
            raise zserio.PythonRuntimeException("Wrong array length for field TrafficIndirectLaneRangeAttributeMap.attributeConditions: "
                                                f"{len(self._attribute_conditions_)} != {self._attribute_}!")
        self._attribute_conditions_.write_packed(zserio_writer)

    def write_packed(self, zserio_context: TrafficIndirectLaneRangeAttributeMap.ZserioPackingContext,
    ...
    class _ZserioElementFactory_feature_references:
        ...
        @staticmethod
        def create(zserio_reader: zserio.BitStreamReader, zserio_index: int) -> nds.lane.reference.types.lane_group_reference_indirect.LaneGroupReferenceIndirect:
            del zserio_index
            return nds.lane.reference.types.lane_group_reference_indirect.LaneGroupReferenceIndirect.from_reader(zserio_reader)

        @staticmethod
        def create_packing_context() -> nds.lane.reference.types.lane_group_reference_indirect.LaneGroupReferenceIndirect.ZserioPackingContext:
            return nds.lane.reference.types.lane_group_reference_indirect.LaneGroupReferenceIndirect.ZserioPackingContext()

        @staticmethod
        def create_packed(zserio_context: nds.lane.reference.types.lane_group_reference_indirect.LaneGroupReferenceIndirect.ZserioPackingContext,
                          zserio_reader: zserio.BitStreamReader, zserio_index: int) -> nds.lane.reference.types.lane_group_reference_indirect.LaneGroupReferenceIndirect:
            del zserio_index
            return nds.lane.reference.types.lane_group_reference_indirect.LaneGroupReferenceIndirect.from_reader_packed(zserio_context, zserio_reader)
    ...
    class _ZserioElementFactory_feature_validities:
        ...
        def create(self, zserio_reader: zserio.BitStreamReader, zserio_index: int) -> nds.lane.reference.types.lane_group_range_validity.LaneGroupRangeValidity:
            del zserio_index
            return nds.lane.reference.types.lane_group_range_validity.LaneGroupRangeValidity.from_reader(zserio_reader, self._owner._coord_shift_)
        ...
        def create_packed(self, zserio_context: nds.lane.reference.types.lane_group_range_validity.LaneGroupRangeValidity.ZserioPackingContext,
            ...
            del zserio_index
            return nds.lane.reference.types.lane_group_range_validity.LaneGroupRangeValidity.from_reader_packed(zserio_context, zserio_reader, self._owner._coord_shift_)
    ...
    class _ZserioElementFactory_attribute_values:
        ...
        def create(self, zserio_reader: zserio.BitStreamReader, zserio_index: int) -> nds.traffic.instantiations.traffic_lane_range_attribute.TrafficLaneRangeAttribute:
            del zserio_index
            return nds.traffic.instantiations.traffic_lane_range_attribute.TrafficLaneRangeAttribute.from_reader(zserio_reader, self._owner._attribute_type_code_)

        @staticmethod
        def create_packing_context() -> nds.traffic.instantiations.traffic_lane_range_attribute.TrafficLaneRangeAttribute.ZserioPackingContext:
            return nds.traffic.instantiations.traffic_lane_range_attribute.TrafficLaneRangeAttribute.ZserioPackingContext()

        def create_packed(self, zserio_context: nds.traffic.instantiations.traffic_lane_range_attribute.TrafficLaneRangeAttribute.ZserioPackingContext,
                          zserio_reader: zserio.BitStreamReader, zserio_index: int) -> nds.traffic.instantiations.traffic_lane_range_attribute.TrafficLaneRangeAttribute:
            del zserio_index
            return nds.traffic.instantiations.traffic_lane_range_attribute.TrafficLaneRangeAttribute.from_reader_packed(zserio_context, zserio_reader, self._owner._attribute_type_code_)
