...
import nds.traffic.attributes.traffic_lane_range_attribute_value
import nds.traffic.instantiations.traffic_property_list

class TrafficLaneRangeFullAttribute:
    def __init__(
            self,
            ...
            attribute_value_: typing.Union[nds.traffic.attributes.traffic_lane_range_attribute_value.TrafficLaneRangeAttributeValue, None] = None,
    ...
    @classmethod
    def from_reader(
            cls: typing.Type['TrafficLaneRangeFullAttribute'],
            zserio_reader: zserio.BitStreamReader) -> 'TrafficLaneRangeFullAttribute':
    ...
    def from_reader_packed(
            cls: typing.Type['TrafficLaneRangeFullAttribute'],
            zserio_context: TrafficLaneRangeFullAttribute.ZserioPackingContext,
            zserio_reader: zserio.BitStreamReader) -> 'TrafficLaneRangeFullAttribute':
        self = object.__new__(cls)
    ...
    def __eq__(self, other: object) -> bool:
        if isinstance(other, TrafficLaneRangeFullAttribute):
    ...
    @property
    def attribute_value(self) -> typing.Union[nds.traffic.attributes.traffic_lane_range_attribute_value.TrafficLaneRangeAttributeValue, None]:
        return self._attribute_value_

    @attribute_value.setter
    def attribute_value(self, attribute_value_: typing.Union[nds.traffic.attributes.traffic_lane_range_attribute_value.TrafficLaneRangeAttributeValue, None]) -> None:
        self._attribute_value_ = attribute_value_
    ...
    def init_packing_context(self, zserio_context: TrafficLaneRangeFullAttribute.ZserioPackingContext) -> None:
    ...
    def bitsizeof_packed(self, zserio_context: TrafficLaneRangeFullAttribute.ZserioPackingContext, bitposition: int = 0) -> int:
        end_bitposition = bitposition
    ...
    def initialize_offsets_packed(self, zserio_context: TrafficLaneRangeFullAttribute.ZserioPackingContext, bitposition: int) -> int:
        end_bitposition = bitposition
    ...
    def read(self, zserio_reader: zserio.BitStreamReader) -> None:
        ...
        self._attribute_value_ = nds.traffic.attributes.traffic_lane_range_attribute_value.TrafficLaneRangeAttributeValue.from_reader(zserio_reader, self._attribute_type_code_)
    ...
    def read_packed(self, zserio_context: TrafficLaneRangeFullAttribute.ZserioPackingContext, zserio_reader: zserio.BitStreamReader) -> None:
        ...
        self._attribute_value_ = nds.traffic.attributes.traffic_lane_range_attribute_value.TrafficLaneRangeAttributeValue.from_reader_packed(zserio_context.attribute_value, zserio_reader, self._attribute_type_code_)
    ...
    def write(self, zserio_writer: zserio.BitStreamWriter) -> None:
        ...
        if self._attribute_value_.type is not (self._attribute_type_code_):
            raise zserio.PythonRuntimeException("Wrong parameter type for field TrafficLaneRangeFullAttribute.attributeValue: "
    ...
    def write_packed(self, zserio_context: TrafficLaneRangeFullAttribute.ZserioPackingContext,
    ...
    class ZserioPackingContext:
        def __init__(self):
            ...
            self._attribute_value_ = nds.traffic.attributes.traffic_lane_range_attribute_value.TrafficLaneRangeAttributeValue.ZserioPackingContext()
