...
import nds.traffic.attributes.traffic_road_range_attribute_type
import nds.traffic.instantiations.traffic_property_list
import nds.traffic.instantiations.traffic_road_range_attribute

class TrafficIndirectRoadRangeAttributeMap:
    def __init__(
            self,
            coord_shift_: nds.core.geometry.coord_shift.CoordShift,
            attribute_type_code_: typing.Union[nds.traffic.attributes.traffic_road_range_attribute_type.TrafficRoadRangeAttributeType, None] = None,
            feature_: nds.core.attributemap.feature_iterator.FeatureIterator = nds.core.attributemap.feature_iterator.FeatureIterator(),
            feature_references_: typing.List[nds.road.reference.types.road_reference_indirect.RoadReferenceIndirect] = None,
            feature_validities_: typing.List[nds.road.reference.types.road_range_validity.RoadRangeValidity] = None,
            ...
            attribute_values_: typing.List[nds.traffic.instantiations.traffic_road_range_attribute.TrafficRoadRangeAttribute] = None,
    ...
    @classmethod
    def from_reader(
            cls: typing.Type['TrafficIndirectRoadRangeAttributeMap'],
            zserio_reader: zserio.BitStreamReader,
            coord_shift_: nds.core.geometry.coord_shift.CoordShift) -> 'TrafficIndirectRoadRangeAttributeMap':
    ...
    def from_reader_packed(
            cls: typing.Type['TrafficIndirectRoadRangeAttributeMap'],
            zserio_context: TrafficIndirectRoadRangeAttributeMap.ZserioPackingContext,
            zserio_reader: zserio.BitStreamReader,
            coord_shift_: nds.core.geometry.coord_shift.CoordShift) -> 'TrafficIndirectRoadRangeAttributeMap':
        self = object.__new__(cls)
        self._coord_shift_ = coord_shift_
    ...
    def __eq__(self, other: object) -> bool:
        if isinstance(other, TrafficIndirectRoadRangeAttributeMap):
    ...
    @property
    def attribute_type_code(self) -> typing.Union[nds.traffic.attributes.traffic_road_range_attribute_type.TrafficRoadRangeAttributeType, None]:
        return self._attribute_type_code_

    @attribute_type_code.setter
    def attribute_type_code(self, attribute_type_code_: typing.Union[nds.traffic.attributes.traffic_road_range_attribute_type.TrafficRoadRangeAttributeType, None]) -> None:
        self._attribute_type_code_ = attribute_type_code_
    ...
    @property
    def feature_references(self) -> typing.List[nds.road.reference.types.road_reference_indirect.RoadReferenceIndirect]:
        return self._feature_references_.raw_array

    @feature_references.setter
    def feature_references(self, feature_references_: typing.List[nds.road.reference.types.road_reference_indirect.RoadReferenceIndirect]) -> None:
        self._feature_references_ = zserio.array.Array(zserio.array.ObjectArrayTraits(self._ZserioElementFactory_feature_references()), feature_references_)

    @property
    def feature_validities(self) -> typing.List[nds.road.reference.types.road_range_validity.RoadRangeValidity]:
        return self._feature_validities_.raw_array

    @feature_validities.setter
    def feature_validities(self, feature_validities_: typing.List[nds.road.reference.types.road_range_validity.RoadRangeValidity]) -> None:
        self._feature_validities_ = zserio.array.Array(zserio.array.ObjectArrayTraits(self._ZserioElementFactory_feature_validities(self)), feature_validities_)
    ...
    @property
    def attribute_values(self) -> typing.List[nds.traffic.instantiations.traffic_road_range_attribute.TrafficRoadRangeAttribute]:
        return self._attribute_values_.raw_array

    @attribute_values.setter
    def attribute_values(self, attribute_values_: typing.List[nds.traffic.instantiations.traffic_road_range_attribute.TrafficRoadRangeAttribute]) -> None:
        self._attribute_values_ = zserio.array.Array(zserio.array.ObjectArrayTraits(self._ZserioElementFactory_attribute_values(self)), attribute_values_)
    ...
    def init_packing_context(self, zserio_context: TrafficIndirectRoadRangeAttributeMap.ZserioPackingContext) -> None:
    ...
    def bitsizeof_packed(self, zserio_context: TrafficIndirectRoadRangeAttributeMap.ZserioPackingContext, bitposition: int = 0) -> int:
        end_bitposition = bitposition
    ...
    def initialize_offsets_packed(self, zserio_context: TrafficIndirectRoadRangeAttributeMap.ZserioPackingContext, bitposition: int) -> int:
        end_bitposition = bitposition
    ...
    def read(self, zserio_reader: zserio.BitStreamReader) -> None:
        self._attribute_type_code_ = nds.traffic.attributes.traffic_road_range_attribute_type.TrafficRoadRangeAttributeType.from_reader(zserio_reader)
    ...
    def read_packed(self, zserio_context: TrafficIndirectRoadRangeAttributeMap.ZserioPackingContext, zserio_reader: zserio.BitStreamReader) -> None:
        self._attribute_type_code_ = nds.traffic.attributes.traffic_road_range_attribute_type.TrafficRoadRangeAttributeType.from_reader_packed(zserio_context.attribute_type_code, zserio_reader)
    ...
    def write(self, zserio_writer: zserio.BitStreamWriter) -> None:
        ...
        if len(self._feature_references_) != (self._feature_):
            raise zserio.PythonRuntimeException("Wrong array length for field TrafficIndirectRoadRangeAttributeMap.featureReferences: "
        ...
        if len(self._feature_validities_) != (self._feature_):
            raise zserio.PythonRuntimeException("Wrong array length for field TrafficIndirectRoadRangeAttributeMap.featureValidities: "
        ...
        if len(self._feature_value_ptr_) != (self._feature_):
            raise zserio.PythonRuntimeException("Wrong array length for field TrafficIndirectRoadRangeAttributeMap.featureValuePtr: "
        ...
        if len(self._attribute_values_) != (self._attribute_):
            raise zserio.PythonRuntimeException("Wrong array length for field TrafficIndirectRoadRangeAttributeMap.attributeValues: "
        ...
        if len(self._attribute_properties_) != (self._attribute_):
            raise zserio.PythonRuntimeException("Wrong array length for field TrafficIndirectRoadRangeAttributeMap.attributeProperties: "
        ...
        if len(self._attribute_conditions_) != (self._attribute_):
            raise zserio.PythonRuntimeException("Wrong array length for field TrafficIndirectRoadRangeAttributeMap.attributeConditions: "
                                                f"{len(self._attribute_conditions_)} != {self._attribute_}!")
        self._attribute_conditions_.write_packed(zserio_writer)

    def write_packed(self, zserio_context: TrafficIndirectRoadRangeAttributeMap.ZserioPackingContext,
    ...
    class _ZserioElementFactory_feature_references:
        ...
        @staticmethod
        def create(zserio_reader: zserio.BitStreamReader, zserio_index: int) -> nds.road.reference.types.road_reference_indirect.RoadReferenceIndirect:
            del zserio_index
            return nds.road.reference.types.road_reference_indirect.RoadReferenceIndirect.from_reader(zserio_reader)

        @staticmethod
        def create_packing_context() -> nds.road.reference.types.road_reference_indirect.RoadReferenceIndirect.ZserioPackingContext:
            return nds.road.reference.types.road_reference_indirect.RoadReferenceIndirect.ZserioPackingContext()

        @staticmethod
        def create_packed(zserio_context: nds.road.reference.types.road_reference_indirect.RoadReferenceIndirect.ZserioPackingContext,
                          zserio_reader: zserio.BitStreamReader, zserio_index: int) -> nds.road.reference.types.road_reference_indirect.RoadReferenceIndirect:
            del zserio_index
            return nds.road.reference.types.road_reference_indirect.RoadReferenceIndirect.from_reader_packed(zserio_context, zserio_reader)
    ...
    class _ZserioElementFactory_feature_validities:
        ...
        def create(self, zserio_reader: zserio.BitStreamReader, zserio_index: int) -> nds.road.reference.types.road_range_validity.RoadRangeValidity:
            del zserio_index
            return nds.road.reference.types.road_range_validity.RoadRangeValidity.from_reader(zserio_reader, self._owner._coord_shift_)
        ...
        def create_packed(self, zserio_context: nds.road.reference.types.road_range_validity.RoadRangeValidity.ZserioPackingContext,
            ...
            del zserio_index
            return nds.road.reference.types.road_range_validity.RoadRangeValidity.from_reader_packed(zserio_context, zserio_reader, self._owner._coord_shift_)
    ...
    class _ZserioElementFactory_attribute_values:
        ...
        def create(self, zserio_reader: zserio.BitStreamReader, zserio_index: int) -> nds.traffic.instantiations.traffic_road_range_attribute.TrafficRoadRangeAttribute:
            del zserio_index
            return nds.traffic.instantiations.traffic_road_range_attribute.TrafficRoadRangeAttribute.from_reader(zserio_reader, self._owner._attribute_type_code_)

        @staticmethod
        def create_packing_context() -> nds.traffic.instantiations.traffic_road_range_attribute.TrafficRoadRangeAttribute.ZserioPackingContext:
            return nds.traffic.instantiations.traffic_road_range_attribute.TrafficRoadRangeAttribute.ZserioPackingContext()

        def create_packed(self, zserio_context: nds.traffic.instantiations.traffic_road_range_attribute.TrafficRoadRangeAttribute.ZserioPackingContext,
                          zserio_reader: zserio.BitStreamReader, zserio_index: int) -> nds.traffic.instantiations.traffic_road_range_attribute.TrafficRoadRangeAttribute:
            del zserio_index
            return nds.traffic.instantiations.traffic_road_range_attribute.TrafficRoadRangeAttribute.from_reader_packed(zserio_context, zserio_reader, self._owner._attribute_type_code_)
