...
import nds.road.reference.location.road_location_transition_reference
import nds.traffic.attributes.traffic_transition_attribute_type
import nds.traffic.instantiations.traffic_property_list
import nds.traffic.instantiations.traffic_transition_attribute

class TrafficRoadLocationTransitionAttributeMap:
    def __init__(
            self,
            coord_shift_: nds.core.geometry.coord_shift.CoordShift,
            attribute_type_code_: typing.Union[nds.traffic.attributes.traffic_transition_attribute_type.TrafficTransitionAttributeType, None] = None,
            feature_: nds.core.attributemap.feature_iterator.FeatureIterator = nds.core.attributemap.feature_iterator.FeatureIterator(),
            feature_references_: typing.List[nds.road.reference.location.road_location_transition_reference.RoadLocationTransitionReference] = None,
            ...
            attribute_values_: typing.List[nds.traffic.instantiations.traffic_transition_attribute.TrafficTransitionAttribute] = None,
    ...
    @classmethod
    def from_reader(
            cls: typing.Type['TrafficRoadLocationTransitionAttributeMap'],
            zserio_reader: zserio.BitStreamReader,
            coord_shift_: nds.core.geometry.coord_shift.CoordShift) -> 'TrafficRoadLocationTransitionAttributeMap':
    ...
    def from_reader_packed(
            cls: typing.Type['TrafficRoadLocationTransitionAttributeMap'],
            zserio_context: TrafficRoadLocationTransitionAttributeMap.ZserioPackingContext,
            zserio_reader: zserio.BitStreamReader,
            coord_shift_: nds.core.geometry.coord_shift.CoordShift) -> 'TrafficRoadLocationTransitionAttributeMap':
        self = object.__new__(cls)
        self._coord_shift_ = coord_shift_
    ...
    def __eq__(self, other: object) -> bool:
        if isinstance(other, TrafficRoadLocationTransitionAttributeMap):
    ...
    @property
    def attribute_type_code(self) -> typing.Union[nds.traffic.attributes.traffic_transition_attribute_type.TrafficTransitionAttributeType, None]:
        return self._attribute_type_code_

    @attribute_type_code.setter
    def attribute_type_code(self, attribute_type_code_: typing.Union[nds.traffic.attributes.traffic_transition_attribute_type.TrafficTransitionAttributeType, None]) -> None:
        self._attribute_type_code_ = attribute_type_code_
    ...
    @property
    def feature_references(self) -> typing.List[nds.road.reference.location.road_location_transition_reference.RoadLocationTransitionReference]:
        return self._feature_references_.raw_array

    @feature_references.setter
    def feature_references(self, feature_references_: typing.List[nds.road.reference.location.road_location_transition_reference.RoadLocationTransitionReference]) -> None:
        self._feature_references_ = zserio.array.Array(zserio.array.ObjectArrayTraits(self._ZserioElementFactory_feature_references()), feature_references_)
    ...
    @property
    def attribute_values(self) -> typing.List[nds.traffic.instantiations.traffic_transition_attribute.TrafficTransitionAttribute]:
        return self._attribute_values_.raw_array

    @attribute_values.setter
    def attribute_values(self, attribute_values_: typing.List[nds.traffic.instantiations.traffic_transition_attribute.TrafficTransitionAttribute]) -> None:
        self._attribute_values_ = zserio.array.Array(zserio.array.ObjectArrayTraits(self._ZserioElementFactory_attribute_values(self)), attribute_values_)
    ...
    def init_packing_context(self, zserio_context: TrafficRoadLocationTransitionAttributeMap.ZserioPackingContext) -> None:
    ...
    def bitsizeof_packed(self, zserio_context: TrafficRoadLocationTransitionAttributeMap.ZserioPackingContext, bitposition: int = 0) -> int:
        end_bitposition = bitposition
    ...
    def initialize_offsets_packed(self, zserio_context: TrafficRoadLocationTransitionAttributeMap.ZserioPackingContext, bitposition: int) -> int:
        end_bitposition = bitposition
    ...
    def read(self, zserio_reader: zserio.BitStreamReader) -> None:
        self._attribute_type_code_ = nds.traffic.attributes.traffic_transition_attribute_type.TrafficTransitionAttributeType.from_reader(zserio_reader)
    ...
    def read_packed(self, zserio_context: TrafficRoadLocationTransitionAttributeMap.ZserioPackingContext, zserio_reader: zserio.BitStreamReader) -> None:
        self._attribute_type_code_ = nds.traffic.attributes.traffic_transition_attribute_type.TrafficTransitionAttributeType.from_reader_packed(zserio_context.attribute_type_code, zserio_reader)
    ...
    def write(self, zserio_writer: zserio.BitStreamWriter) -> None:
        ...
        if len(self._feature_references_) != (self._feature_):
            raise zserio.PythonRuntimeException("Wrong array length for field TrafficRoadLocationTransitionAttributeMap.featureReferences: "
        ...
        if len(self._feature_validities_) != (self._feature_):
            raise zserio.PythonRuntimeException("Wrong array length for field TrafficRoadLocationTransitionAttributeMap.featureValidities: "
        ...
        if len(self._feature_value_ptr_) != (self._feature_):
            raise zserio.PythonRuntimeException("Wrong array length for field TrafficRoadLocationTransitionAttributeMap.featureValuePtr: "
        ...
        if len(self._attribute_values_) != (self._attribute_):
            raise zserio.PythonRuntimeException("Wrong array length for field TrafficRoadLocationTransitionAttributeMap.attributeValues: "
        ...
        if len(self._attribute_properties_) != (self._attribute_):
            raise zserio.PythonRuntimeException("Wrong array length for field TrafficRoadLocationTransitionAttributeMap.attributeProperties: "
        ...
        if len(self._attribute_conditions_) != (self._attribute_):
            raise zserio.PythonRuntimeException("Wrong array length for field TrafficRoadLocationTransitionAttributeMap.attributeConditions: "
                                                f"{len(self._attribute_conditions_)} != {self._attribute_}!")
        self._attribute_conditions_.write_packed(zserio_writer)

    def write_packed(self, zserio_context: TrafficRoadLocationTransitionAttributeMap.ZserioPackingContext,
    ...
    class _ZserioElementFactory_feature_references:
        ...
        @staticmethod
        def create(zserio_reader: zserio.BitStreamReader, zserio_index: int) -> nds.road.reference.location.road_location_transition_reference.RoadLocationTransitionReference:
            del zserio_index
            return nds.road.reference.location.road_location_transition_reference.RoadLocationTransitionReference.from_reader(zserio_reader)

        @staticmethod
        def create_packing_context() -> nds.road.reference.location.road_location_transition_reference.RoadLocationTransitionReference.ZserioPackingContext:
            return nds.road.reference.location.road_location_transition_reference.RoadLocationTransitionReference.ZserioPackingContext()

        @staticmethod
        def create_packed(zserio_context: nds.road.reference.location.road_location_transition_reference.RoadLocationTransitionReference.ZserioPackingContext,
                          zserio_reader: zserio.BitStreamReader, zserio_index: int) -> nds.road.reference.location.road_location_transition_reference.RoadLocationTransitionReference:
            del zserio_index
            return nds.road.reference.location.road_location_transition_reference.RoadLocationTransitionReference.from_reader_packed(zserio_context, zserio_reader)
    ...
    class _ZserioElementFactory_attribute_values:
        ...
        def create(self, zserio_reader: zserio.BitStreamReader, zserio_index: int) -> nds.traffic.instantiations.traffic_transition_attribute.TrafficTransitionAttribute:
            del zserio_index
            return nds.traffic.instantiations.traffic_transition_attribute.TrafficTransitionAttribute.from_reader(zserio_reader, self._owner._attribute_type_code_)

        @staticmethod
        def create_packing_context() -> nds.traffic.instantiations.traffic_transition_attribute.TrafficTransitionAttribute.ZserioPackingContext:
            return nds.traffic.instantiations.traffic_transition_attribute.TrafficTransitionAttribute.ZserioPackingContext()

        def create_packed(self, zserio_context: nds.traffic.instantiations.traffic_transition_attribute.TrafficTransitionAttribute.ZserioPackingContext,
                          zserio_reader: zserio.BitStreamReader, zserio_index: int) -> nds.traffic.instantiations.traffic_transition_attribute.TrafficTransitionAttribute:
            del zserio_index
            return nds.traffic.instantiations.traffic_transition_attribute.TrafficTransitionAttribute.from_reader_packed(zserio_context, zserio_reader, self._owner._attribute_type_code_)
