...
import nds.display.reference.types.display_line_range_validity
import nds.display.reference.types.display_line_reference
import nds.traffic.attributes.traffic_display_line_range_attribute_type
import nds.traffic.instantiations.traffic_display_line_range_attribute
import nds.traffic.instantiations.traffic_property_list

class TrafficDisplayLineRangeAttributeMap:
    def __init__(
            self,
            coord_shift_: nds.core.geometry.coord_shift.CoordShift,
            attribute_type_code_: typing.Union[nds.traffic.attributes.traffic_display_line_range_attribute_type.TrafficDisplayLineRangeAttributeType, None] = None,
            feature_: nds.core.attributemap.feature_iterator.FeatureIterator = nds.core.attributemap.feature_iterator.FeatureIterator(),
            feature_references_: typing.List[nds.display.reference.types.display_line_reference.DisplayLineReference] = None,
            feature_validities_: typing.List[nds.display.reference.types.display_line_range_validity.DisplayLineRangeValidity] = None,
            ...
            attribute_values_: typing.List[nds.traffic.instantiations.traffic_display_line_range_attribute.TrafficDisplayLineRangeAttribute] = None,
            attribute_properties_: typing.List[nds.traffic.instantiations.traffic_property_list.TrafficPropertyList] = None,
    ...
    @classmethod
    def from_reader(
            cls: typing.Type['TrafficDisplayLineRangeAttributeMap'],
            zserio_reader: zserio.BitStreamReader,
            coord_shift_: nds.core.geometry.coord_shift.CoordShift) -> 'TrafficDisplayLineRangeAttributeMap':
    ...
    def from_reader_packed(
            cls: typing.Type['TrafficDisplayLineRangeAttributeMap'],
            zserio_context: TrafficDisplayLineRangeAttributeMap.ZserioPackingContext,
            zserio_reader: zserio.BitStreamReader,
            coord_shift_: nds.core.geometry.coord_shift.CoordShift) -> 'TrafficDisplayLineRangeAttributeMap':
        self = object.__new__(cls)
        self._coord_shift_ = coord_shift_
    ...
    def __eq__(self, other: object) -> bool:
        if isinstance(other, TrafficDisplayLineRangeAttributeMap):
    ...
    @property
    def attribute_type_code(self) -> typing.Union[nds.traffic.attributes.traffic_display_line_range_attribute_type.TrafficDisplayLineRangeAttributeType, None]:
        return self._attribute_type_code_

    @attribute_type_code.setter
    def attribute_type_code(self, attribute_type_code_: typing.Union[nds.traffic.attributes.traffic_display_line_range_attribute_type.TrafficDisplayLineRangeAttributeType, None]) -> None:
        self._attribute_type_code_ = attribute_type_code_
    ...
    @property
    def feature_references(self) -> typing.List[nds.display.reference.types.display_line_reference.DisplayLineReference]:
        return self._feature_references_.raw_array

    @feature_references.setter
    def feature_references(self, feature_references_: typing.List[nds.display.reference.types.display_line_reference.DisplayLineReference]) -> None:
        self._feature_references_ = zserio.array.Array(zserio.array.ObjectArrayTraits(self._ZserioElementFactory_feature_references()), feature_references_)

    @property
    def feature_validities(self) -> typing.List[nds.display.reference.types.display_line_range_validity.DisplayLineRangeValidity]:
        return self._feature_validities_.raw_array

    @feature_validities.setter
    def feature_validities(self, feature_validities_: typing.List[nds.display.reference.types.display_line_range_validity.DisplayLineRangeValidity]) -> None:
        self._feature_validities_ = zserio.array.Array(zserio.array.ObjectArrayTraits(self._ZserioElementFactory_feature_validities(self)), feature_validities_)
    ...
    @property
    def attribute_values(self) -> typing.List[nds.traffic.instantiations.traffic_display_line_range_attribute.TrafficDisplayLineRangeAttribute]:
        return self._attribute_values_.raw_array

    @attribute_values.setter
    def attribute_values(self, attribute_values_: typing.List[nds.traffic.instantiations.traffic_display_line_range_attribute.TrafficDisplayLineRangeAttribute]) -> None:
        self._attribute_values_ = zserio.array.Array(zserio.array.ObjectArrayTraits(self._ZserioElementFactory_attribute_values(self)), attribute_values_)

    @property
    def attribute_properties(self) -> typing.List[nds.traffic.instantiations.traffic_property_list.TrafficPropertyList]:
        return self._attribute_properties_.raw_array

    @attribute_properties.setter
    def attribute_properties(self, attribute_properties_: typing.List[nds.traffic.instantiations.traffic_property_list.TrafficPropertyList]) -> None:
        self._attribute_properties_ = zserio.array.Array(zserio.array.ObjectArrayTraits(self._ZserioElementFactory_attribute_properties()), attribute_properties_)
    ...
    def init_packing_context(self, zserio_context: TrafficDisplayLineRangeAttributeMap.ZserioPackingContext) -> None:
    ...
    def bitsizeof_packed(self, zserio_context: TrafficDisplayLineRangeAttributeMap.ZserioPackingContext, bitposition: int = 0) -> int:
        end_bitposition = bitposition
    ...
    def initialize_offsets_packed(self, zserio_context: TrafficDisplayLineRangeAttributeMap.ZserioPackingContext, bitposition: int) -> int:
        end_bitposition = bitposition
    ...
    def read(self, zserio_reader: zserio.BitStreamReader) -> None:
        self._attribute_type_code_ = nds.traffic.attributes.traffic_display_line_range_attribute_type.TrafficDisplayLineRangeAttributeType.from_reader(zserio_reader)
    ...
    def read_packed(self, zserio_context: TrafficDisplayLineRangeAttributeMap.ZserioPackingContext, zserio_reader: zserio.BitStreamReader) -> None:
        self._attribute_type_code_ = nds.traffic.attributes.traffic_display_line_range_attribute_type.TrafficDisplayLineRangeAttributeType.from_reader_packed(zserio_context.attribute_type_code, zserio_reader)
    ...
    def write(self, zserio_writer: zserio.BitStreamWriter) -> None:
        ...
        if len(self._feature_references_) != (self._feature_):
            raise zserio.PythonRuntimeException("Wrong array length for field TrafficDisplayLineRangeAttributeMap.featureReferences: "
        ...
        if len(self._feature_validities_) != (self._feature_):
            raise zserio.PythonRuntimeException("Wrong array length for field TrafficDisplayLineRangeAttributeMap.featureValidities: "
        ...
        if len(self._feature_value_ptr_) != (self._feature_):
            raise zserio.PythonRuntimeException("Wrong array length for field TrafficDisplayLineRangeAttributeMap.featureValuePtr: "
        ...
        if len(self._attribute_values_) != (self._attribute_):
            raise zserio.PythonRuntimeException("Wrong array length for field TrafficDisplayLineRangeAttributeMap.attributeValues: "
        ...
        if len(self._attribute_properties_) != (self._attribute_):
            raise zserio.PythonRuntimeException("Wrong array length for field TrafficDisplayLineRangeAttributeMap.attributeProperties: "
        ...
        if len(self._attribute_conditions_) != (self._attribute_):
            raise zserio.PythonRuntimeException("Wrong array length for field TrafficDisplayLineRangeAttributeMap.attributeConditions: "
                                                f"{len(self._attribute_conditions_)} != {self._attribute_}!")
        self._attribute_conditions_.write_packed(zserio_writer)

    def write_packed(self, zserio_context: TrafficDisplayLineRangeAttributeMap.ZserioPackingContext,
    ...
    class _ZserioElementFactory_feature_references:
        ...
        @staticmethod
        def create(zserio_reader: zserio.BitStreamReader, zserio_index: int) -> nds.display.reference.types.display_line_reference.DisplayLineReference:
            del zserio_index
            return nds.display.reference.types.display_line_reference.DisplayLineReference.from_reader(zserio_reader)

        @staticmethod
        def create_packing_context() -> nds.display.reference.types.display_line_reference.DisplayLineReference.ZserioPackingContext:
            return nds.display.reference.types.display_line_reference.DisplayLineReference.ZserioPackingContext()

        @staticmethod
        def create_packed(zserio_context: nds.display.reference.types.display_line_reference.DisplayLineReference.ZserioPackingContext,
                          zserio_reader: zserio.BitStreamReader, zserio_index: int) -> nds.display.reference.types.display_line_reference.DisplayLineReference:
            del zserio_index
            return nds.display.reference.types.display_line_reference.DisplayLineReference.from_reader_packed(zserio_context, zserio_reader)
    ...
    class _ZserioElementFactory_feature_validities:
        ...
        def create(self, zserio_reader: zserio.BitStreamReader, zserio_index: int) -> nds.display.reference.types.display_line_range_validity.DisplayLineRangeValidity:
            del zserio_index
            return nds.display.reference.types.display_line_range_validity.DisplayLineRangeValidity.from_reader(zserio_reader, self._owner._coord_shift_)

        @staticmethod
        def create_packing_context() -> nds.display.reference.types.display_line_range_validity.DisplayLineRangeValidity.ZserioPackingContext:
            return nds.display.reference.types.display_line_range_validity.DisplayLineRangeValidity.ZserioPackingContext()

        def create_packed(self, zserio_context: nds.display.reference.types.display_line_range_validity.DisplayLineRangeValidity.ZserioPackingContext,
                          zserio_reader: zserio.BitStreamReader, zserio_index: int) -> nds.display.reference.types.display_line_range_validity.DisplayLineRangeValidity:
            del zserio_index
            return nds.display.reference.types.display_line_range_validity.DisplayLineRangeValidity.from_reader_packed(zserio_context, zserio_reader, self._owner._coord_shift_)
    ...
    class _ZserioElementFactory_attribute_values:
        ...
        def create(self, zserio_reader: zserio.BitStreamReader, zserio_index: int) -> nds.traffic.instantiations.traffic_display_line_range_attribute.TrafficDisplayLineRangeAttribute:
            del zserio_index
            return nds.traffic.instantiations.traffic_display_line_range_attribute.TrafficDisplayLineRangeAttribute.from_reader(zserio_reader, self._owner._attribute_type_code_)

        @staticmethod
        def create_packing_context() -> nds.traffic.instantiations.traffic_display_line_range_attribute.TrafficDisplayLineRangeAttribute.ZserioPackingContext:
            return nds.traffic.instantiations.traffic_display_line_range_attribute.TrafficDisplayLineRangeAttribute.ZserioPackingContext()

        def create_packed(self, zserio_context: nds.traffic.instantiations.traffic_display_line_range_attribute.TrafficDisplayLineRangeAttribute.ZserioPackingContext,
                          zserio_reader: zserio.BitStreamReader, zserio_index: int) -> nds.traffic.instantiations.traffic_display_line_range_attribute.TrafficDisplayLineRangeAttribute:
            del zserio_index
            return nds.traffic.instantiations.traffic_display_line_range_attribute.TrafficDisplayLineRangeAttribute.from_reader_packed(zserio_context, zserio_reader, self._owner._attribute_type_code_)

    class _ZserioElementFactory_attribute_properties:
        IS_OBJECT_PACKABLE = True

        @staticmethod
        def create(zserio_reader: zserio.BitStreamReader, zserio_index: int) -> nds.traffic.instantiations.traffic_property_list.TrafficPropertyList:
            del zserio_index
            return nds.traffic.instantiations.traffic_property_list.TrafficPropertyList.from_reader(zserio_reader)

        @staticmethod
        def create_packing_context() -> nds.traffic.instantiations.traffic_property_list.TrafficPropertyList.ZserioPackingContext:
            return nds.traffic.instantiations.traffic_property_list.TrafficPropertyList.ZserioPackingContext()

        @staticmethod
        def create_packed(zserio_context: nds.traffic.instantiations.traffic_property_list.TrafficPropertyList.ZserioPackingContext,
                          zserio_reader: zserio.BitStreamReader, zserio_index: int) -> nds.traffic.instantiations.traffic_property_list.TrafficPropertyList:
            del zserio_index
            return nds.traffic.instantiations.traffic_property_list.TrafficPropertyList.from_reader_packed(zserio_context, zserio_reader)
