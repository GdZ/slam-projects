...
import nds.traffic.instantiations.traffic_lane_range_attribute_map
...
class TrafficLaneRangeAttributeMapList:
    def __init__(
            ...
            maps_: typing.List[nds.traffic.instantiations.traffic_lane_range_attribute_map.TrafficLaneRangeAttributeMap] = None) -> None:
    ...
    @classmethod
    def from_reader(
            cls: typing.Type['TrafficLaneRangeAttributeMapList'],
            zserio_reader: zserio.BitStreamReader,
            coord_shift_: nds.core.geometry.coord_shift.CoordShift) -> 'TrafficLaneRangeAttributeMapList':
    ...
    def from_reader_packed(
            cls: typing.Type['TrafficLaneRangeAttributeMapList'],
            zserio_context: TrafficLaneRangeAttributeMapList.ZserioPackingContext,
            zserio_reader: zserio.BitStreamReader,
            coord_shift_: nds.core.geometry.coord_shift.CoordShift) -> 'TrafficLaneRangeAttributeMapList':
        self = object.__new__(cls)
        self._coord_shift_ = coord_shift_
    ...
    def __eq__(self, other: object) -> bool:
        if isinstance(other, TrafficLaneRangeAttributeMapList):
    ...
    @property
    def maps(self) -> typing.List[nds.traffic.instantiations.traffic_lane_range_attribute_map.TrafficLaneRangeAttributeMap]:
        return self._maps_.raw_array

    @maps.setter
    def maps(self, maps_: typing.List[nds.traffic.instantiations.traffic_lane_range_attribute_map.TrafficLaneRangeAttributeMap]) -> None:
        self._maps_ = zserio.array.Array(zserio.array.ObjectArrayTraits(self._ZserioElementFactory_maps(self)), maps_)

    def init_packing_context(self, zserio_context: TrafficLaneRangeAttributeMapList.ZserioPackingContext) -> None:
    ...
    def bitsizeof_packed(self, zserio_context: TrafficLaneRangeAttributeMapList.ZserioPackingContext, bitposition: int = 0) -> int:
        end_bitposition = bitposition
    ...
    def initialize_offsets_packed(self, zserio_context: TrafficLaneRangeAttributeMapList.ZserioPackingContext, bitposition: int) -> int:
        end_bitposition = bitposition
        end_bitposition += zserio_context.num_maps.bitsizeof(zserio.array.VarSizeArrayTraits(), self._num_maps_)
    ...
    def read_packed(self, zserio_context: TrafficLaneRangeAttributeMapList.ZserioPackingContext, zserio_reader: zserio.BitStreamReader) -> None:
    ...
    def write(self, zserio_writer: zserio.BitStreamWriter) -> None:
        ...
        if self._header_.num_maps != (self._num_maps_):
            raise zserio.PythonRuntimeException("Wrong parameter numMaps for field TrafficLaneRangeAttributeMapList.header: "
                                                f"{self._header_.num_maps} != {self._num_maps_}!")
        self._header_.write(zserio_writer)

        # check array length
        if len(self._maps_) != (self._num_maps_):
            raise zserio.PythonRuntimeException("Wrong array length for field TrafficLaneRangeAttributeMapList.maps: "
                                                f"{len(self._maps_)} != {self._num_maps_}!")
        self._maps_.write_packed(zserio_writer)

    def write_packed(self, zserio_context: TrafficLaneRangeAttributeMapList.ZserioPackingContext,
    ...
    class _ZserioElementFactory_maps:
        ...
        def create(self, zserio_reader: zserio.BitStreamReader, zserio_index: int) -> nds.traffic.instantiations.traffic_lane_range_attribute_map.TrafficLaneRangeAttributeMap:
            del zserio_index
            return nds.traffic.instantiations.traffic_lane_range_attribute_map.TrafficLaneRangeAttributeMap.from_reader(zserio_reader, self._owner._coord_shift_)

        @staticmethod
        def create_packing_context() -> nds.traffic.instantiations.traffic_lane_range_attribute_map.TrafficLaneRangeAttributeMap.ZserioPackingContext:
            return nds.traffic.instantiations.traffic_lane_range_attribute_map.TrafficLaneRangeAttributeMap.ZserioPackingContext()

        def create_packed(self, zserio_context: nds.traffic.instantiations.traffic_lane_range_attribute_map.TrafficLaneRangeAttributeMap.ZserioPackingContext,
                          zserio_reader: zserio.BitStreamReader, zserio_index: int) -> nds.traffic.instantiations.traffic_lane_range_attribute_map.TrafficLaneRangeAttributeMap:
            del zserio_index
            return nds.traffic.instantiations.traffic_lane_range_attribute_map.TrafficLaneRangeAttributeMap.from_reader_packed(zserio_context, zserio_reader, self._owner._coord_shift_)
