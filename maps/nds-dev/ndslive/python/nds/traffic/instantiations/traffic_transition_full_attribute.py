...
import nds.traffic.attributes.traffic_transition_attribute_value
...
class TrafficTransitionFullAttribute:
    def __init__(
            ...
            attribute_value_: typing.Union[nds.traffic.attributes.traffic_transition_attribute_value.TrafficTransitionAttributeValue, None] = None,
    ...
    @classmethod
    def from_reader(
            cls: typing.Type['TrafficTransitionFullAttribute'],
            zserio_reader: zserio.BitStreamReader) -> 'TrafficTransitionFullAttribute':
    ...
    def from_reader_packed(
            cls: typing.Type['TrafficTransitionFullAttribute'],
            zserio_context: TrafficTransitionFullAttribute.ZserioPackingContext,
            zserio_reader: zserio.BitStreamReader) -> 'TrafficTransitionFullAttribute':
        self = object.__new__(cls)
    ...
    def __eq__(self, other: object) -> bool:
        if isinstance(other, TrafficTransitionFullAttribute):
    ...
    @property
    def attribute_value(self) -> typing.Union[nds.traffic.attributes.traffic_transition_attribute_value.TrafficTransitionAttributeValue, None]:
        return self._attribute_value_

    @attribute_value.setter
    def attribute_value(self, attribute_value_: typing.Union[nds.traffic.attributes.traffic_transition_attribute_value.TrafficTransitionAttributeValue, None]) -> None:
        self._attribute_value_ = attribute_value_
    ...
    def init_packing_context(self, zserio_context: TrafficTransitionFullAttribute.ZserioPackingContext) -> None:
    ...
    def bitsizeof_packed(self, zserio_context: TrafficTransitionFullAttribute.ZserioPackingContext, bitposition: int = 0) -> int:
        end_bitposition = bitposition
    ...
    def initialize_offsets_packed(self, zserio_context: TrafficTransitionFullAttribute.ZserioPackingContext, bitposition: int) -> int:
        end_bitposition = bitposition
    ...
    def read(self, zserio_reader: zserio.BitStreamReader) -> None:
        ...
        self._attribute_value_ = nds.traffic.attributes.traffic_transition_attribute_value.TrafficTransitionAttributeValue.from_reader(zserio_reader, self._attribute_type_code_)
    ...
    def read_packed(self, zserio_context: TrafficTransitionFullAttribute.ZserioPackingContext, zserio_reader: zserio.BitStreamReader) -> None:
        ...
        self._attribute_value_ = nds.traffic.attributes.traffic_transition_attribute_value.TrafficTransitionAttributeValue.from_reader_packed(zserio_context.attribute_value, zserio_reader, self._attribute_type_code_)
    ...
    def write(self, zserio_writer: zserio.BitStreamWriter) -> None:
        ...
        if self._attribute_value_.type is not (self._attribute_type_code_):
            raise zserio.PythonRuntimeException("Wrong parameter type for field TrafficTransitionFullAttribute.attributeValue: "
    ...
    def write_packed(self, zserio_context: TrafficTransitionFullAttribute.ZserioPackingContext,
    ...
    class ZserioPackingContext:
        def __init__(self):
            ...
            self._attribute_value_ = nds.traffic.attributes.traffic_transition_attribute_value.TrafficTransitionAttributeValue.ZserioPackingContext()
