...
class SmartLayerTileList:
    ...
    @classmethod
    def from_reader(
            cls: typing.Type['SmartLayerTileList'],
            zserio_reader: zserio.BitStreamReader) -> 'SmartLayerTileList':
    ...
    def from_reader_packed(
            cls: typing.Type['SmartLayerTileList'],
            zserio_context: SmartLayerTileList.ZserioPackingContext,
            zserio_reader: zserio.BitStreamReader) -> 'SmartLayerTileList':
        self = object.__new__(cls)
    ...
    def __eq__(self, other: object) -> bool:
        if isinstance(other, SmartLayerTileList):
    ...
    def init_packing_context(self, zserio_context: SmartLayerTileList.ZserioPackingContext) -> None:
    ...
    def bitsizeof_packed(self, zserio_context: SmartLayerTileList.ZserioPackingContext, bitposition: int = 0) -> int:
        end_bitposition = bitposition
    ...
    def initialize_offsets_packed(self, zserio_context: SmartLayerTileList.ZserioPackingContext, bitposition: int) -> int:
        end_bitposition = bitposition
        end_bitposition += zserio_context.num_tiles.bitsizeof(zserio.array.VarSizeArrayTraits(), self._num_tiles_)
    ...
    def read_packed(self, zserio_context: SmartLayerTileList.ZserioPackingContext, zserio_reader: zserio.BitStreamReader) -> None:
    ...
    def write(self, zserio_writer: zserio.BitStreamWriter) -> None:
        ...
        if len(self._tile_list_) != (self._num_tiles_):
            raise zserio.PythonRuntimeException("Wrong array length for field SmartLayerTileList.tileList: "
                                                f"{len(self._tile_list_)} != {self._num_tiles_}!")
        self._tile_list_.write(zserio_writer)

    def write_packed(self, zserio_context: SmartLayerTileList.ZserioPackingContext,
