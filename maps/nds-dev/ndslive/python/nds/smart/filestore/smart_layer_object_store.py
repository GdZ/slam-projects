...
import nds.smart.filestore.smart_layer_object_table

class SmartLayerObjectStore:
    ...
    @classmethod
    def from_file(cls: typing.Type['SmartLayerObjectStore'], filename: str, table_to_db_filename_relocation_map: typing.Dict[str, str] = None) -> 'SmartLayerObjectStore':
    ...
    @property
    def object_table(self) -> nds.smart.filestore.smart_layer_object_table.SmartLayerObjectTable:
        return self._object_table_
    ...
    def create_schema(self) -> None:
        ...
        self._object_table_.create_table()
    ...
    def delete_schema(self) -> None:
        ...
        self._object_table_.delete_table()
    ...
    def _init_tables(self, table_name_to_attached_db_name_map: typing.Dict[str, str]) -> None:
        ...
        self._object_table_ = nds.smart.filestore.smart_layer_object_table.SmartLayerObjectTable(
            self._connection, self.TABLE_NAME_OBJECT_TABLE, table_name_to_attached_db_name_map.get(self.TABLE_NAME_OBJECT_TABLE))
    ...
    DATABASE_NAME = "SmartLayerObjectStore"
    TABLE_NAME_METADATA_TABLE = "metadataTable"
    TABLE_NAME_OBJECT_TABLE = "objectTable"
