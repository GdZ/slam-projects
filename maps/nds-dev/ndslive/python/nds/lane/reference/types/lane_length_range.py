...
class LaneLengthRange:
    ...
    @classmethod
    def from_reader(
            cls: typing.Type['LaneLengthRange'],
            zserio_reader: zserio.BitStreamReader) -> 'LaneLengthRange':
    ...
    def from_reader_packed(
            cls: typing.Type['LaneLengthRange'],
            zserio_context: LaneLengthRange.ZserioPackingContext,
            zserio_reader: zserio.BitStreamReader) -> 'LaneLengthRange':
        self = object.__new__(cls)
    ...
    def __eq__(self, other: object) -> bool:
        if isinstance(other, LaneLengthRange):
    ...
    def init_packing_context(self, zserio_context: LaneLengthRange.ZserioPackingContext) -> None:
    ...
    def bitsizeof_packed(self, zserio_context: LaneLengthRange.ZserioPackingContext, bitposition: int = 0) -> int:
        end_bitposition = bitposition
    ...
    def initialize_offsets_packed(self, zserio_context: LaneLengthRange.ZserioPackingContext, bitposition: int) -> int:
        end_bitposition = bitposition
        end_bitposition += zserio_context.length.bitsizeof(zserio.array.VarUInt32ArrayTraits(), self._length_)
    ...
    def read_packed(self, zserio_context: LaneLengthRange.ZserioPackingContext, zserio_reader: zserio.BitStreamReader) -> None:
    ...
    def write(self, zserio_writer: zserio.BitStreamWriter) -> None:
        ...
        if self._range_.length != (self._length_):
            raise zserio.PythonRuntimeException("Wrong parameter length for field LaneLengthRange.range: "
                                                f"{self._range_.length} != {self._length_}!")
        self._range_.write(zserio_writer)

    def write_packed(self, zserio_context: LaneLengthRange.ZserioPackingContext,
