...
class LaneBoundaryGeometryOnPathTopic:
    ...
    @classmethod
    def from_reader(
            cls: typing.Type['LaneBoundaryGeometryOnPathTopic'],
            zserio_reader: zserio.BitStreamReader) -> 'LaneBoundaryGeometryOnPathTopic':
    ...
    def from_reader_packed(
            cls: typing.Type['LaneBoundaryGeometryOnPathTopic'],
            zserio_context: LaneBoundaryGeometryOnPathTopic.ZserioPackingContext,
            zserio_reader: zserio.BitStreamReader) -> 'LaneBoundaryGeometryOnPathTopic':
        self = object.__new__(cls)
    ...
    def __eq__(self, other: object) -> bool:
        if isinstance(other, LaneBoundaryGeometryOnPathTopic):
    ...
    def init_packing_context(self, zserio_context: LaneBoundaryGeometryOnPathTopic.ZserioPackingContext) -> None:
    ...
    def bitsizeof_packed(self, zserio_context: LaneBoundaryGeometryOnPathTopic.ZserioPackingContext, bitposition: int = 0) -> int:
        end_bitposition = bitposition
    ...
    def initialize_offsets_packed(self, zserio_context: LaneBoundaryGeometryOnPathTopic.ZserioPackingContext, bitposition: int) -> int:
        end_bitposition = bitposition
    ...
    def read_packed(self, zserio_context: LaneBoundaryGeometryOnPathTopic.ZserioPackingContext, zserio_reader: zserio.BitStreamReader) -> None:
    ...
    def write(self, zserio_writer: zserio.BitStreamWriter) -> None:
        ...
        if self._boundary_geometry_layer_.type is not (nds.core.geometry.geometry_layer_type.GeometryLayerType.LINE_3D):
            raise zserio.PythonRuntimeException("Wrong parameter type for field LaneBoundaryGeometryOnPathTopic.boundaryGeometryLayer: "
        ...
        if self._boundary_geometry_layer_.has_ids != (True):
            raise zserio.PythonRuntimeException("Wrong parameter hasIds for field LaneBoundaryGeometryOnPathTopic.boundaryGeometryLayer: "
                                                f"{self._boundary_geometry_layer_.has_ids} != {True}!")
        if self._boundary_geometry_layer_.has_types != (False):
            raise zserio.PythonRuntimeException("Wrong parameter hasTypes for field LaneBoundaryGeometryOnPathTopic.boundaryGeometryLayer: "
                                                f"{self._boundary_geometry_layer_.has_types} != {False}!")
        self._boundary_geometry_layer_.write(zserio_writer)

    def write_packed(self, zserio_context: LaneBoundaryGeometryOnPathTopic.ZserioPackingContext,
