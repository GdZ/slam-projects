...
import nds.lane.roadsurface.road_surface_line_type

class RoadSurfaceLineGeometryLayer:
    def __init__(
            self,
            ...
            types_: typing.Optional[typing.List[nds.lane.roadsurface.road_surface_line_type.RoadSurfaceLineType]] = None,
    ...
    @classmethod
    def from_reader(
            cls: typing.Type['RoadSurfaceLineGeometryLayer'],
            zserio_reader: zserio.BitStreamReader,
            type_: nds.core.geometry.geometry_layer_type.GeometryLayerType,
            has_ids_: bool,
            has_types_: bool) -> 'RoadSurfaceLineGeometryLayer':
    ...
    def from_reader_packed(
            cls: typing.Type['RoadSurfaceLineGeometryLayer'],
            zserio_context: RoadSurfaceLineGeometryLayer.ZserioPackingContext,
            zserio_reader: zserio.BitStreamReader,
            type_: nds.core.geometry.geometry_layer_type.GeometryLayerType,
            has_ids_: bool,
            has_types_: bool) -> 'RoadSurfaceLineGeometryLayer':
    ...
    def __eq__(self, other: object) -> bool:
        if isinstance(other, RoadSurfaceLineGeometryLayer):
    ...
    @property
    def types(self) -> typing.Optional[typing.List[nds.lane.roadsurface.road_surface_line_type.RoadSurfaceLineType]]:
        return None if self._types_ is None else self._types_.raw_array

    @types.setter
    def types(self, types_: typing.Optional[typing.List[nds.lane.roadsurface.road_surface_line_type.RoadSurfaceLineType]]) -> None:
        if types_ is None:
            self._types_ = None
        else:
            self._types_ = zserio.array.Array(zserio.array.ObjectArrayTraits(self._ZserioElementFactory_types()), types_)
    ...
    def init_packing_context(self, zserio_context: RoadSurfaceLineGeometryLayer.ZserioPackingContext) -> None:
    ...
    def bitsizeof_packed(self, zserio_context: RoadSurfaceLineGeometryLayer.ZserioPackingContext, bitposition: int = 0) -> int:
        end_bitposition = bitposition
    ...
    def initialize_offsets_packed(self, zserio_context: RoadSurfaceLineGeometryLayer.ZserioPackingContext, bitposition: int) -> int:
        end_bitposition = bitposition
        end_bitposition += zserio_context.coord_shift_xy.bitsizeof(zserio.array.BitFieldArrayTraits(5), self._coord_shift_xy_)
        end_bitposition += zserio_context.coord_shift_z.bitsizeof(zserio.array.BitFieldArrayTraits(5), self._coord_shift_z_)
        end_bitposition = zserio.bitposition.alignto(8, end_bitposition)
    ...
    def read_packed(self, zserio_context: RoadSurfaceLineGeometryLayer.ZserioPackingContext, zserio_reader: zserio.BitStreamReader) -> None:
    ...
    def write(self, zserio_writer: zserio.BitStreamWriter) -> None:
        ...
        if self.is_identifier_used():
            ...
            if len(self._identifier_) != (self._num_elements_):
                raise zserio.PythonRuntimeException("Wrong array length for field RoadSurfaceLineGeometryLayer.identifier: "
        ...
        if self.is_types_used():
            ...
            if len(self._types_) != (self._num_elements_):
                raise zserio.PythonRuntimeException("Wrong array length for field RoadSurfaceLineGeometryLayer.types: "
        ...
        if self._buffers_.type is not (self._type_):
            raise zserio.PythonRuntimeException("Wrong parameter type for field RoadSurfaceLineGeometryLayer.buffers: "
                                                f"{self._buffers_.type} != {self._type_}!")
        if self._buffers_.shift_xy != (self._coord_shift_xy_):
            raise zserio.PythonRuntimeException("Wrong parameter shiftXY for field RoadSurfaceLineGeometryLayer.buffers: "
                                                f"{self._buffers_.shift_xy} != {self._coord_shift_xy_}!")
        if self._buffers_.shift_z != (self._coord_shift_z_):
            raise zserio.PythonRuntimeException("Wrong parameter shiftZ for field RoadSurfaceLineGeometryLayer.buffers: "
                                                f"{self._buffers_.shift_z} != {self._coord_shift_z_}!")
        if self._buffers_.num_elements != (self._num_elements_):
            raise zserio.PythonRuntimeException("Wrong parameter numElements for field RoadSurfaceLineGeometryLayer.buffers: "
                                                f"{self._buffers_.num_elements} != {self._num_elements_}!")
        self._buffers_.write(zserio_writer)

    def write_packed(self, zserio_context: RoadSurfaceLineGeometryLayer.ZserioPackingContext,
    ...
    class _ZserioElementFactory_types:
        ...
        @staticmethod
        def create(zserio_reader: zserio.BitStreamReader, zserio_index: int) -> nds.lane.roadsurface.road_surface_line_type.RoadSurfaceLineType:
            del zserio_index
            return nds.lane.roadsurface.road_surface_line_type.RoadSurfaceLineType.from_reader(zserio_reader)

        @staticmethod
        def create_packing_context() -> nds.lane.roadsurface.road_surface_line_type.RoadSurfaceLineType.ZserioPackingContext:
            return nds.lane.roadsurface.road_surface_line_type.RoadSurfaceLineType.ZserioPackingContext()

        @staticmethod
        def create_packed(zserio_context: nds.lane.roadsurface.road_surface_line_type.RoadSurfaceLineType.ZserioPackingContext,
                          zserio_reader: zserio.BitStreamReader, zserio_index: int) -> nds.lane.roadsurface.road_surface_line_type.RoadSurfaceLineType:
            del zserio_index
            return nds.lane.roadsurface.road_surface_line_type.RoadSurfaceLineType.from_reader_packed(zserio_context, zserio_reader)
