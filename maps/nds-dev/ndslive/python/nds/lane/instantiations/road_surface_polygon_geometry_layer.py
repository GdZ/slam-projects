...
import nds.lane.roadsurface.road_surface_polygon_type
...
class RoadSurfacePolygonGeometryLayer:
    def __init__(
            ...
            identifier_: typing.Optional[typing.List[nds.lane.reference.types.road_surface_id.RoadSurfaceId]] = None,
            types_: typing.Optional[typing.List[nds.lane.roadsurface.road_surface_polygon_type.RoadSurfacePolygonType]] = None,
    ...
    @classmethod
    def from_reader(
            cls: typing.Type['RoadSurfacePolygonGeometryLayer'],
            zserio_reader: zserio.BitStreamReader,
            type_: nds.core.geometry.geometry_layer_type.GeometryLayerType,
            has_ids_: bool,
            has_types_: bool) -> 'RoadSurfacePolygonGeometryLayer':
    ...
    def from_reader_packed(
            cls: typing.Type['RoadSurfacePolygonGeometryLayer'],
            zserio_context: RoadSurfacePolygonGeometryLayer.ZserioPackingContext,
            zserio_reader: zserio.BitStreamReader,
            type_: nds.core.geometry.geometry_layer_type.GeometryLayerType,
            has_ids_: bool,
            has_types_: bool) -> 'RoadSurfacePolygonGeometryLayer':
    ...
    def __eq__(self, other: object) -> bool:
        if isinstance(other, RoadSurfacePolygonGeometryLayer):
    ...
    @property
    def identifier(self) -> typing.Optional[typing.List[nds.lane.reference.types.road_surface_id.RoadSurfaceId]]:
        return None if self._identifier_ is None else self._identifier_.raw_array

    @identifier.setter
    def identifier(self, identifier_: typing.Optional[typing.List[nds.lane.reference.types.road_surface_id.RoadSurfaceId]]) -> None:
        if identifier_ is None:
            self._identifier_ = None
        else:
            self._identifier_ = zserio.array.Array(zserio.array.ObjectArrayTraits(self._ZserioElementFactory_identifier()), identifier_)
    ...
    @property
    def types(self) -> typing.Optional[typing.List[nds.lane.roadsurface.road_surface_polygon_type.RoadSurfacePolygonType]]:
        return None if self._types_ is None else self._types_.raw_array

    @types.setter
    def types(self, types_: typing.Optional[typing.List[nds.lane.roadsurface.road_surface_polygon_type.RoadSurfacePolygonType]]) -> None:
        if types_ is None:
            self._types_ = None
        else:
            self._types_ = zserio.array.Array(zserio.array.ObjectArrayTraits(self._ZserioElementFactory_types()), types_)
    ...
    def init_packing_context(self, zserio_context: RoadSurfacePolygonGeometryLayer.ZserioPackingContext) -> None:
    ...
    def bitsizeof_packed(self, zserio_context: RoadSurfacePolygonGeometryLayer.ZserioPackingContext, bitposition: int = 0) -> int:
        end_bitposition = bitposition
    ...
    def initialize_offsets_packed(self, zserio_context: RoadSurfacePolygonGeometryLayer.ZserioPackingContext, bitposition: int) -> int:
        end_bitposition = bitposition
        end_bitposition += zserio_context.coord_shift_xy.bitsizeof(zserio.array.BitFieldArrayTraits(5), self._coord_shift_xy_)
        end_bitposition += zserio_context.coord_shift_z.bitsizeof(zserio.array.BitFieldArrayTraits(5), self._coord_shift_z_)
        end_bitposition = zserio.bitposition.alignto(8, end_bitposition)
    ...
    def read_packed(self, zserio_context: RoadSurfacePolygonGeometryLayer.ZserioPackingContext, zserio_reader: zserio.BitStreamReader) -> None:
    ...
    def write(self, zserio_writer: zserio.BitStreamWriter) -> None:
        ...
        if self.is_identifier_used():
            ...
            if len(self._identifier_) != (self._num_elements_):
                raise zserio.PythonRuntimeException("Wrong array length for field RoadSurfacePolygonGeometryLayer.identifier: "
        ...
        if self.is_types_used():
            ...
            if len(self._types_) != (self._num_elements_):
                raise zserio.PythonRuntimeException("Wrong array length for field RoadSurfacePolygonGeometryLayer.types: "
        ...
        if self._buffers_.type is not (self._type_):
            raise zserio.PythonRuntimeException("Wrong parameter type for field RoadSurfacePolygonGeometryLayer.buffers: "
                                                f"{self._buffers_.type} != {self._type_}!")
        if self._buffers_.shift_xy != (self._coord_shift_xy_):
            raise zserio.PythonRuntimeException("Wrong parameter shiftXY for field RoadSurfacePolygonGeometryLayer.buffers: "
                                                f"{self._buffers_.shift_xy} != {self._coord_shift_xy_}!")
        if self._buffers_.shift_z != (self._coord_shift_z_):
            raise zserio.PythonRuntimeException("Wrong parameter shiftZ for field RoadSurfacePolygonGeometryLayer.buffers: "
                                                f"{self._buffers_.shift_z} != {self._coord_shift_z_}!")
        if self._buffers_.num_elements != (self._num_elements_):
            raise zserio.PythonRuntimeException("Wrong parameter numElements for field RoadSurfacePolygonGeometryLayer.buffers: "
                                                f"{self._buffers_.num_elements} != {self._num_elements_}!")
        self._buffers_.write(zserio_writer)

    def write_packed(self, zserio_context: RoadSurfacePolygonGeometryLayer.ZserioPackingContext,
    ...
    class _ZserioElementFactory_types:
        ...
        @staticmethod
        def create(zserio_reader: zserio.BitStreamReader, zserio_index: int) -> nds.lane.roadsurface.road_surface_polygon_type.RoadSurfacePolygonType:
            del zserio_index
            return nds.lane.roadsurface.road_surface_polygon_type.RoadSurfacePolygonType.from_reader(zserio_reader)

        @staticmethod
        def create_packing_context() -> nds.lane.roadsurface.road_surface_polygon_type.RoadSurfacePolygonType.ZserioPackingContext:
            return nds.lane.roadsurface.road_surface_polygon_type.RoadSurfacePolygonType.ZserioPackingContext()

        @staticmethod
        def create_packed(zserio_context: nds.lane.roadsurface.road_surface_polygon_type.RoadSurfacePolygonType.ZserioPackingContext,
                          zserio_reader: zserio.BitStreamReader, zserio_index: int) -> nds.lane.roadsurface.road_surface_polygon_type.RoadSurfacePolygonType:
            del zserio_index
            return nds.lane.roadsurface.road_surface_polygon_type.RoadSurfacePolygonType.from_reader_packed(zserio_context, zserio_reader)
