...
class CenterLineGeometryLayer:
    def __init__(
            ...
            identifier_: typing.Optional[typing.List[nds.lane.lanes.lane_center_line_geometry_id.LaneCenterLineGeometryId]] = None,
    ...
    @classmethod
    def from_reader(
            cls: typing.Type['CenterLineGeometryLayer'],
            zserio_reader: zserio.BitStreamReader,
            type_: nds.core.geometry.geometry_layer_type.GeometryLayerType,
            has_ids_: bool,
            has_types_: bool) -> 'CenterLineGeometryLayer':
    ...
    def from_reader_packed(
            cls: typing.Type['CenterLineGeometryLayer'],
            zserio_context: CenterLineGeometryLayer.ZserioPackingContext,
            zserio_reader: zserio.BitStreamReader,
            type_: nds.core.geometry.geometry_layer_type.GeometryLayerType,
            has_ids_: bool,
            has_types_: bool) -> 'CenterLineGeometryLayer':
    ...
    def __eq__(self, other: object) -> bool:
        if isinstance(other, CenterLineGeometryLayer):
    ...
    @property
    def identifier(self) -> typing.Optional[typing.List[nds.lane.lanes.lane_center_line_geometry_id.LaneCenterLineGeometryId]]:
        return None if self._identifier_ is None else self._identifier_.raw_array

    @identifier.setter
    def identifier(self, identifier_: typing.Optional[typing.List[nds.lane.lanes.lane_center_line_geometry_id.LaneCenterLineGeometryId]]) -> None:
        if identifier_ is None:
            self._identifier_ = None
        else:
            self._identifier_ = zserio.array.Array(zserio.array.VarUInt32ArrayTraits(), identifier_)
    ...
    def init_packing_context(self, zserio_context: CenterLineGeometryLayer.ZserioPackingContext) -> None:
    ...
    def bitsizeof_packed(self, zserio_context: CenterLineGeometryLayer.ZserioPackingContext, bitposition: int = 0) -> int:
        end_bitposition = bitposition
    ...
    def initialize_offsets_packed(self, zserio_context: CenterLineGeometryLayer.ZserioPackingContext, bitposition: int) -> int:
        end_bitposition = bitposition
        end_bitposition += zserio_context.coord_shift_xy.bitsizeof(zserio.array.BitFieldArrayTraits(5), self._coord_shift_xy_)
        end_bitposition += zserio_context.coord_shift_z.bitsizeof(zserio.array.BitFieldArrayTraits(5), self._coord_shift_z_)
        end_bitposition = zserio.bitposition.alignto(8, end_bitposition)
    ...
    def read_packed(self, zserio_context: CenterLineGeometryLayer.ZserioPackingContext, zserio_reader: zserio.BitStreamReader) -> None:
    ...
    def write(self, zserio_writer: zserio.BitStreamWriter) -> None:
        ...
        if self.is_identifier_used():
            ...
            if len(self._identifier_) != (self._num_elements_):
                raise zserio.PythonRuntimeException("Wrong array length for field CenterLineGeometryLayer.identifier: "
        ...
        if self.is_types_used():
            ...
            if len(self._types_) != (self._num_elements_):
                raise zserio.PythonRuntimeException("Wrong array length for field CenterLineGeometryLayer.types: "
        ...
        if self._buffers_.type is not (self._type_):
            raise zserio.PythonRuntimeException("Wrong parameter type for field CenterLineGeometryLayer.buffers: "
                                                f"{self._buffers_.type} != {self._type_}!")
        if self._buffers_.shift_xy != (self._coord_shift_xy_):
            raise zserio.PythonRuntimeException("Wrong parameter shiftXY for field CenterLineGeometryLayer.buffers: "
                                                f"{self._buffers_.shift_xy} != {self._coord_shift_xy_}!")
        if self._buffers_.shift_z != (self._coord_shift_z_):
            raise zserio.PythonRuntimeException("Wrong parameter shiftZ for field CenterLineGeometryLayer.buffers: "
                                                f"{self._buffers_.shift_z} != {self._coord_shift_z_}!")
        if self._buffers_.num_elements != (self._num_elements_):
            raise zserio.PythonRuntimeException("Wrong parameter numElements for field CenterLineGeometryLayer.buffers: "
                                                f"{self._buffers_.num_elements} != {self._num_elements_}!")
        self._buffers_.write(zserio_writer)

    def write_packed(self, zserio_context: CenterLineGeometryLayer.ZserioPackingContext,
