...
class BorderLaneGroup:
    def __init__(
            ...
            end_connector_border_: typing.Union[nds.lane.lanegroups.lane_group_connector.LaneGroupConnector, None] = None,
        ...
        self._end_connector_border_ = end_connector_border_
        self._lanes_ = zserio.array.Array(zserio.array.ObjectArrayTraits(self._ZserioElementFactory_lanes()), lanes_, is_auto=True)

    @classmethod
    def from_reader(
            cls: typing.Type['BorderLaneGroup'],
            zserio_reader: zserio.BitStreamReader) -> 'BorderLaneGroup':
    ...
    def from_reader_packed(
            cls: typing.Type['BorderLaneGroup'],
            zserio_context: BorderLaneGroup.ZserioPackingContext,
            zserio_reader: zserio.BitStreamReader) -> 'BorderLaneGroup':
        self = object.__new__(cls)
    ...
    def __eq__(self, other: object) -> bool:
        if isinstance(other, BorderLaneGroup):
            return ((self._start_connector_ == other._start_connector_) and
                    (self._end_connector_border_ == other._end_connector_border_) and
    ...
    def __hash__(self) -> int:
        ...
        result = zserio.hashcode.calc_hashcode_object(result, self._end_connector_border_)
    ...
    @property
    def end_connector_border(self) -> typing.Union[nds.lane.lanegroups.lane_group_connector.LaneGroupConnector, None]:
        return self._end_connector_border_

    @end_connector_border.setter
    def end_connector_border(self, end_connector_border_: typing.Union[nds.lane.lanegroups.lane_group_connector.LaneGroupConnector, None]) -> None:
        self._end_connector_border_ = end_connector_border_
    ...
    def init_packing_context(self, zserio_context: BorderLaneGroup.ZserioPackingContext) -> None:
        self._end_connector_border_.init_packing_context(zserio_context.end_connector_border)

    def bitsizeof(self, bitposition: int = 0) -> int:
        end_bitposition = bitposition
        end_bitposition += self._start_connector_.bitsizeof(end_bitposition)
        end_bitposition += self._end_connector_border_.bitsizeof(end_bitposition)
        end_bitposition += self._lanes_.bitsizeof(end_bitposition)

        return end_bitposition - bitposition

    def bitsizeof_packed(self, zserio_context: BorderLaneGroup.ZserioPackingContext, bitposition: int = 0) -> int:
        end_bitposition = bitposition
        end_bitposition += self._start_connector_.bitsizeof_packed(end_bitposition)
        end_bitposition += self._end_connector_border_.bitsizeof_packed(zserio_context.end_connector_border, end_bitposition)
    ...
    def initialize_offsets(self, bitposition: int = 0) -> int:
        ...
        end_bitposition = self._end_connector_border_.initialize_offsets(end_bitposition)
        end_bitposition = self._lanes_.initialize_offsets(end_bitposition)

        return end_bitposition

    def initialize_offsets_packed(self, zserio_context: BorderLaneGroup.ZserioPackingContext, bitposition: int) -> int:
        end_bitposition = bitposition
        end_bitposition = self._start_connector_.initialize_offsets_packed(end_bitposition)
        end_bitposition = self._end_connector_border_.initialize_offsets_packed(zserio_context.end_connector_border, end_bitposition)
    ...
    def read(self, zserio_reader: zserio.BitStreamReader) -> None:
        ...
        if not (len(self._start_connector_) > 0):
            raise zserio.PythonRuntimeException("Constraint violated for field BorderLaneGroup.startConnector!")

        self._end_connector_border_ = nds.lane.lanegroups.lane_group_connector.LaneGroupConnector.from_reader(zserio_reader, True)
    ...
    def read_packed(self, zserio_context: BorderLaneGroup.ZserioPackingContext, zserio_reader: zserio.BitStreamReader) -> None:
        ...
        self._end_connector_border_ = nds.lane.lanegroups.lane_group_connector.LaneGroupConnector.from_reader_packed(zserio_context.end_connector_border, zserio_reader, True)
    ...
    def write(self, zserio_writer: zserio.BitStreamWriter) -> None:
        ...
        # check parameters
        if self._end_connector_border_.on_border != (True):
            raise zserio.PythonRuntimeException("Wrong parameter onBorder for field BorderLaneGroup.endConnectorBorder: "
                                                f"{self._end_connector_border_.on_border} != {True}!")
        self._end_connector_border_.write(zserio_writer)

        self._lanes_.write(zserio_writer)

    def write_packed(self, zserio_context: BorderLaneGroup.ZserioPackingContext,
        ...
        if self._end_connector_border_.on_border != (True):
            raise zserio.PythonRuntimeException("Wrong parameter onBorder for field BorderLaneGroup.endConnectorBorder: "
                                                f"{self._end_connector_border_.on_border} != {True}!")
        self._end_connector_border_.write_packed(zserio_context.end_connector_border, zserio_writer)

        self._lanes_.write_packed(zserio_writer)

    class ZserioPackingContext:
        def __init__(self):
            self._end_connector_border_ = nds.lane.lanegroups.lane_group_connector.LaneGroupConnector.ZserioPackingContext()

        @property
        def end_connector_border(self):
            return self._end_connector_border_
    ...
    class _ZserioElementFactory_lanes:
        ...
        def create(zserio_reader: zserio.BitStreamReader, zserio_index: int) -> nds.lane.lanes.zero_length_lane.ZeroLengthLane:
            del zserio_index
            return nds.lane.lanes.zero_length_lane.ZeroLengthLane.from_reader(zserio_reader, True)
        ...
        def create_packed(zserio_context: nds.lane.lanes.zero_length_lane.ZeroLengthLane.ZserioPackingContext,
            ...
            del zserio_index
            return nds.lane.lanes.zero_length_lane.ZeroLengthLane.from_reader_packed(zserio_context, zserio_reader, True)
