...
class RoadLaneGroup:
    ...
    @classmethod
    def from_reader(
            cls: typing.Type['RoadLaneGroup'],
            zserio_reader: zserio.BitStreamReader,
            has_boundary_geometry_: bool) -> 'RoadLaneGroup':
    ...
    def from_reader_packed(
            cls: typing.Type['RoadLaneGroup'],
            zserio_context: RoadLaneGroup.ZserioPackingContext,
            zserio_reader: zserio.BitStreamReader,
            has_boundary_geometry_: bool) -> 'RoadLaneGroup':
        self = object.__new__(cls)
        self._has_boundary_geometry_ = has_boundary_geometry_
    ...
    def __eq__(self, other: object) -> bool:
        if isinstance(other, RoadLaneGroup):
    ...
    def init_packing_context(self, zserio_context: RoadLaneGroup.ZserioPackingContext) -> None:
    ...
    def bitsizeof_packed(self, zserio_context: RoadLaneGroup.ZserioPackingContext, bitposition: int = 0) -> int:
        end_bitposition = bitposition
        end_bitposition += 1
        end_bitposition += 1
    ...
    def initialize_offsets_packed(self, zserio_context: RoadLaneGroup.ZserioPackingContext, bitposition: int) -> int:
        end_bitposition = bitposition
        end_bitposition += 1
        end_bitposition += 1
    ...
    def read_packed(self, zserio_context: RoadLaneGroup.ZserioPackingContext, zserio_reader: zserio.BitStreamReader) -> None:
        self._start_on_border_ = zserio_reader.read_bool()
    ...
    def write(self, zserio_writer: zserio.BitStreamWriter) -> None:
        ...
        if self._start_connector_.on_border != (self._start_on_border_):
            raise zserio.PythonRuntimeException("Wrong parameter onBorder for field RoadLaneGroup.startConnector: "
        ...
        if self._end_connector_.on_border != (self._end_on_border_):
            raise zserio.PythonRuntimeException("Wrong parameter onBorder for field RoadLaneGroup.endConnector: "
    ...
    def write_packed(self, zserio_context: RoadLaneGroup.ZserioPackingContext,
