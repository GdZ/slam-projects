...
import nds.localization.instantiations.landmark_road_attribute_map_list
...
class RoadLandmarkLayer:
    def __init__(
            ...
            road_attribute_maps_: typing.Union[nds.localization.instantiations.landmark_road_attribute_map_list.LandmarkRoadAttributeMapList, None] = None) -> None:
        self._shift_ = shift_
        self._road_attribute_maps_ = road_attribute_maps_

    @classmethod
    def from_reader(
            cls: typing.Type['RoadLandmarkLayer'],
            zserio_reader: zserio.BitStreamReader) -> 'RoadLandmarkLayer':
    ...
    def from_reader_packed(
            cls: typing.Type['RoadLandmarkLayer'],
            zserio_context: RoadLandmarkLayer.ZserioPackingContext,
            zserio_reader: zserio.BitStreamReader) -> 'RoadLandmarkLayer':
        self = object.__new__(cls)
    ...
    def __eq__(self, other: object) -> bool:
        if isinstance(other, RoadLandmarkLayer):
    ...
    @property
    def road_attribute_maps(self) -> typing.Union[nds.localization.instantiations.landmark_road_attribute_map_list.LandmarkRoadAttributeMapList, None]:
        return self._road_attribute_maps_

    @road_attribute_maps.setter
    def road_attribute_maps(self, road_attribute_maps_: typing.Union[nds.localization.instantiations.landmark_road_attribute_map_list.LandmarkRoadAttributeMapList, None]) -> None:
        self._road_attribute_maps_ = road_attribute_maps_

    def get_layer_type(self) -> nds.system.types.layer_type.LayerType:
        return nds.system.types.layer_type.LayerType.RELATION

    def init_packing_context(self, zserio_context: RoadLandmarkLayer.ZserioPackingContext) -> None:
    ...
    def bitsizeof_packed(self, zserio_context: RoadLandmarkLayer.ZserioPackingContext, bitposition: int = 0) -> int:
        end_bitposition = bitposition
    ...
    def initialize_offsets_packed(self, zserio_context: RoadLandmarkLayer.ZserioPackingContext, bitposition: int) -> int:
        end_bitposition = bitposition
        end_bitposition += zserio_context.shift.bitsizeof(zserio.array.BitFieldArrayTraits(5), self._shift_)
    ...
    def read(self, zserio_reader: zserio.BitStreamReader) -> None:
        ...
        self._road_attribute_maps_ = nds.localization.instantiations.landmark_road_attribute_map_list.LandmarkRoadAttributeMapList.from_reader(zserio_reader, self._shift_)

    def read_packed(self, zserio_context: RoadLandmarkLayer.ZserioPackingContext, zserio_reader: zserio.BitStreamReader) -> None:
        self._shift_ = zserio_context.shift.read(zserio.array.BitFieldArrayTraits(5), zserio_reader)

        self._road_attribute_maps_ = nds.localization.instantiations.landmark_road_attribute_map_list.LandmarkRoadAttributeMapList.from_reader_packed(zserio_context.road_attribute_maps, zserio_reader, self._shift_)
    ...
    def write(self, zserio_writer: zserio.BitStreamWriter) -> None:
        ...
        if self._road_attribute_maps_.coord_shift != (self._shift_):
            raise zserio.PythonRuntimeException("Wrong parameter coordShift for field RoadLandmarkLayer.roadAttributeMaps: "
                                                f"{self._road_attribute_maps_.coord_shift} != {self._shift_}!")
        self._road_attribute_maps_.write(zserio_writer)

    def write_packed(self, zserio_context: RoadLandmarkLayer.ZserioPackingContext,
    ...
    class ZserioPackingContext:
        def __init__(self):
            ...
            self._road_attribute_maps_ = nds.localization.instantiations.landmark_road_attribute_map_list.LandmarkRoadAttributeMapList.ZserioPackingContext()
