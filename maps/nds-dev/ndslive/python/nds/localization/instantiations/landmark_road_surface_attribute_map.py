...
class LandmarkRoadSurfaceAttributeMap:
    def __init__(
            ...
            feature_references_: typing.List[nds.lane.reference.types.road_surface_id.RoadSurfaceId] = None,
    ...
    @classmethod
    def from_reader(
            cls: typing.Type['LandmarkRoadSurfaceAttributeMap'],
            zserio_reader: zserio.BitStreamReader,
            coord_shift_: nds.core.geometry.coord_shift.CoordShift) -> 'LandmarkRoadSurfaceAttributeMap':
    ...
    def from_reader_packed(
            cls: typing.Type['LandmarkRoadSurfaceAttributeMap'],
            zserio_context: LandmarkRoadSurfaceAttributeMap.ZserioPackingContext,
            zserio_reader: zserio.BitStreamReader,
            coord_shift_: nds.core.geometry.coord_shift.CoordShift) -> 'LandmarkRoadSurfaceAttributeMap':
        self = object.__new__(cls)
        self._coord_shift_ = coord_shift_
    ...
    def __eq__(self, other: object) -> bool:
        if isinstance(other, LandmarkRoadSurfaceAttributeMap):
    ...
    @property
    def feature_references(self) -> typing.List[nds.lane.reference.types.road_surface_id.RoadSurfaceId]:
        return self._feature_references_.raw_array

    @feature_references.setter
    def feature_references(self, feature_references_: typing.List[nds.lane.reference.types.road_surface_id.RoadSurfaceId]) -> None:
        self._feature_references_ = zserio.array.Array(zserio.array.ObjectArrayTraits(self._ZserioElementFactory_feature_references()), feature_references_)
    ...
    def init_packing_context(self, zserio_context: LandmarkRoadSurfaceAttributeMap.ZserioPackingContext) -> None:
    ...
    def bitsizeof_packed(self, zserio_context: LandmarkRoadSurfaceAttributeMap.ZserioPackingContext, bitposition: int = 0) -> int:
        end_bitposition = bitposition
    ...
    def initialize_offsets_packed(self, zserio_context: LandmarkRoadSurfaceAttributeMap.ZserioPackingContext, bitposition: int) -> int:
        end_bitposition = bitposition
    ...
    def read_packed(self, zserio_context: LandmarkRoadSurfaceAttributeMap.ZserioPackingContext, zserio_reader: zserio.BitStreamReader) -> None:
    ...
    def write(self, zserio_writer: zserio.BitStreamWriter) -> None:
        ...
        if len(self._feature_references_) != (self._feature_):
            raise zserio.PythonRuntimeException("Wrong array length for field LandmarkRoadSurfaceAttributeMap.featureReferences: "
        ...
        if len(self._feature_validities_) != (self._feature_):
            raise zserio.PythonRuntimeException("Wrong array length for field LandmarkRoadSurfaceAttributeMap.featureValidities: "
        ...
        if len(self._feature_value_ptr_) != (self._feature_):
            raise zserio.PythonRuntimeException("Wrong array length for field LandmarkRoadSurfaceAttributeMap.featureValuePtr: "
        ...
        if len(self._attribute_values_) != (self._attribute_):
            raise zserio.PythonRuntimeException("Wrong array length for field LandmarkRoadSurfaceAttributeMap.attributeValues: "
        ...
        if len(self._attribute_properties_) != (self._attribute_):
            raise zserio.PythonRuntimeException("Wrong array length for field LandmarkRoadSurfaceAttributeMap.attributeProperties: "
        ...
        if len(self._attribute_conditions_) != (self._attribute_):
            raise zserio.PythonRuntimeException("Wrong array length for field LandmarkRoadSurfaceAttributeMap.attributeConditions: "
                                                f"{len(self._attribute_conditions_)} != {self._attribute_}!")
        self._attribute_conditions_.write_packed(zserio_writer)

    def write_packed(self, zserio_context: LandmarkRoadSurfaceAttributeMap.ZserioPackingContext,
