...
class LandmarkAttributeMapListHeader:
    def __init__(
            self,
            num_maps_: int,
            attribute_type_code_: typing.List[nds.localization.attributes.landmark_relation_attribute_type.LandmarkRelationAttributeType] = None,
    ...
    @classmethod
    def from_reader(
            cls: typing.Type['LandmarkAttributeMapListHeader'],
            zserio_reader: zserio.BitStreamReader,
            num_maps_: int) -> 'LandmarkAttributeMapListHeader':
    ...
    def from_reader_packed(
            cls: typing.Type['LandmarkAttributeMapListHeader'],
            zserio_context: LandmarkAttributeMapListHeader.ZserioPackingContext,
            zserio_reader: zserio.BitStreamReader,
            num_maps_: int) -> 'LandmarkAttributeMapListHeader':
        self = object.__new__(cls)
        self._num_maps_ = num_maps_
    ...
    def __eq__(self, other: object) -> bool:
        if isinstance(other, LandmarkAttributeMapListHeader):
    ...
    @property
    def attribute_type_code(self) -> typing.List[nds.localization.attributes.landmark_relation_attribute_type.LandmarkRelationAttributeType]:
        return self._attribute_type_code_.raw_array

    @attribute_type_code.setter
    def attribute_type_code(self, attribute_type_code_: typing.List[nds.localization.attributes.landmark_relation_attribute_type.LandmarkRelationAttributeType]) -> None:
        self._attribute_type_code_ = zserio.array.Array(zserio.array.ObjectArrayTraits(self._ZserioElementFactory_attribute_type_code()), attribute_type_code_)
    ...
    def init_packing_context(self, zserio_context: LandmarkAttributeMapListHeader.ZserioPackingContext) -> None:
        del zserio_context
    ...
    def bitsizeof_packed(self, zserio_context: LandmarkAttributeMapListHeader.ZserioPackingContext, bitposition: int = 0) -> int:
        del zserio_context
    ...
    def initialize_offsets_packed(self, zserio_context: LandmarkAttributeMapListHeader.ZserioPackingContext, bitposition: int) -> int:
        del zserio_context
    ...
    def read_packed(self, zserio_context: LandmarkAttributeMapListHeader.ZserioPackingContext, zserio_reader: zserio.BitStreamReader) -> None:
        del zserio_context
    ...
    def write(self, zserio_writer: zserio.BitStreamWriter) -> None:
        ...
        if len(self._attribute_type_code_) != (self._num_maps_):
            raise zserio.PythonRuntimeException("Wrong array length for field LandmarkAttributeMapListHeader.attributeTypeCode: "
        ...
        if len(self._condition_type_) != (self._num_maps_):
            raise zserio.PythonRuntimeException("Wrong array length for field LandmarkAttributeMapListHeader.conditionType: "
                                                f"{len(self._condition_type_)} != {self._num_maps_}!")
        self._condition_type_.write_packed(zserio_writer)

    def write_packed(self, zserio_context: LandmarkAttributeMapListHeader.ZserioPackingContext,
