...
import nds.localization.attributes.landmark_relation_attribute_value
...
class LandmarkFullAttribute:
    def __init__(
            ...
            attribute_value_: typing.Union[nds.localization.attributes.landmark_relation_attribute_value.LandmarkRelationAttributeValue, None] = None,
            properties_: typing.Optional[nds.localization.instantiations.landmark_property_list.LandmarkPropertyList] = None,
    ...
    @classmethod
    def from_reader(
            cls: typing.Type['LandmarkFullAttribute'],
            zserio_reader: zserio.BitStreamReader) -> 'LandmarkFullAttribute':
    ...
    def from_reader_packed(
            cls: typing.Type['LandmarkFullAttribute'],
            zserio_context: LandmarkFullAttribute.ZserioPackingContext,
            zserio_reader: zserio.BitStreamReader) -> 'LandmarkFullAttribute':
        self = object.__new__(cls)
    ...
    def __eq__(self, other: object) -> bool:
        if isinstance(other, LandmarkFullAttribute):
    ...
    @property
    def attribute_value(self) -> typing.Union[nds.localization.attributes.landmark_relation_attribute_value.LandmarkRelationAttributeValue, None]:
        return self._attribute_value_

    @attribute_value.setter
    def attribute_value(self, attribute_value_: typing.Union[nds.localization.attributes.landmark_relation_attribute_value.LandmarkRelationAttributeValue, None]) -> None:
        self._attribute_value_ = attribute_value_

    @property
    def properties(self) -> typing.Optional[nds.localization.instantiations.landmark_property_list.LandmarkPropertyList]:
        return self._properties_

    @properties.setter
    def properties(self, properties_: typing.Optional[nds.localization.instantiations.landmark_property_list.LandmarkPropertyList]) -> None:
        self._properties_ = properties_
    ...
    def init_packing_context(self, zserio_context: LandmarkFullAttribute.ZserioPackingContext) -> None:
    ...
    def bitsizeof_packed(self, zserio_context: LandmarkFullAttribute.ZserioPackingContext, bitposition: int = 0) -> int:
        end_bitposition = bitposition
    ...
    def initialize_offsets_packed(self, zserio_context: LandmarkFullAttribute.ZserioPackingContext, bitposition: int) -> int:
        end_bitposition = bitposition
    ...
    def read(self, zserio_reader: zserio.BitStreamReader) -> None:
        ...
        self._attribute_value_ = nds.localization.attributes.landmark_relation_attribute_value.LandmarkRelationAttributeValue.from_reader(zserio_reader, self._attribute_type_code_)
        if zserio_reader.read_bool():
            self._properties_ = nds.localization.instantiations.landmark_property_list.LandmarkPropertyList.from_reader(zserio_reader)
        else:
            self._properties_ = None
        if zserio_reader.read_bool():
    ...
    def read_packed(self, zserio_context: LandmarkFullAttribute.ZserioPackingContext, zserio_reader: zserio.BitStreamReader) -> None:
        ...
        self._attribute_value_ = nds.localization.attributes.landmark_relation_attribute_value.LandmarkRelationAttributeValue.from_reader_packed(zserio_context.attribute_value, zserio_reader, self._attribute_type_code_)

        if zserio_reader.read_bool():
            self._properties_ = nds.localization.instantiations.landmark_property_list.LandmarkPropertyList.from_reader_packed(zserio_context.properties, zserio_reader)
        else:
            self._properties_ = None
    ...
    def write(self, zserio_writer: zserio.BitStreamWriter) -> None:
        ...
        if self._attribute_value_.type is not (self._attribute_type_code_):
            raise zserio.PythonRuntimeException("Wrong parameter type for field LandmarkFullAttribute.attributeValue: "
    ...
    def write_packed(self, zserio_context: LandmarkFullAttribute.ZserioPackingContext,
    ...
    class ZserioPackingContext:
        def __init__(self):
            ...
            self._attribute_value_ = nds.localization.attributes.landmark_relation_attribute_value.LandmarkRelationAttributeValue.ZserioPackingContext()
            self._properties_ = nds.localization.instantiations.landmark_property_list.LandmarkPropertyList.ZserioPackingContext()
