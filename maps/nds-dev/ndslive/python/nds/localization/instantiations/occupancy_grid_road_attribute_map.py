...
import nds.localization.instantiations.landmark_property_list
import nds.localization.instantiations.occupancy_grid_attribute
...
class OccupancyGridRoadAttributeMap:
    def __init__(
            ...
            attribute_type_code_: typing.Union[nds.localization.attributes.occupancy_grid_relation_attribute_type.OccupancyGridRelationAttributeType, None] = None,
            ...
            feature_validities_: typing.List[nds.road.reference.types.road_validity_range.RoadValidityRange] = None,
            ...
            attribute_values_: typing.List[nds.localization.instantiations.occupancy_grid_attribute.OccupancyGridAttribute] = None,
            attribute_properties_: typing.List[nds.localization.instantiations.landmark_property_list.LandmarkPropertyList] = None,
    ...
    @classmethod
    def from_reader(
            cls: typing.Type['OccupancyGridRoadAttributeMap'],
            zserio_reader: zserio.BitStreamReader,
            coord_shift_: nds.core.geometry.coord_shift.CoordShift) -> 'OccupancyGridRoadAttributeMap':
    ...
    def from_reader_packed(
            cls: typing.Type['OccupancyGridRoadAttributeMap'],
            zserio_context: OccupancyGridRoadAttributeMap.ZserioPackingContext,
            zserio_reader: zserio.BitStreamReader,
            coord_shift_: nds.core.geometry.coord_shift.CoordShift) -> 'OccupancyGridRoadAttributeMap':
        self = object.__new__(cls)
        self._coord_shift_ = coord_shift_
    ...
    def __eq__(self, other: object) -> bool:
        if isinstance(other, OccupancyGridRoadAttributeMap):
    ...
    @property
    def attribute_type_code(self) -> typing.Union[nds.localization.attributes.occupancy_grid_relation_attribute_type.OccupancyGridRelationAttributeType, None]:
        return self._attribute_type_code_

    @attribute_type_code.setter
    def attribute_type_code(self, attribute_type_code_: typing.Union[nds.localization.attributes.occupancy_grid_relation_attribute_type.OccupancyGridRelationAttributeType, None]) -> None:
        self._attribute_type_code_ = attribute_type_code_
    ...
    @property
    def feature_validities(self) -> typing.List[nds.road.reference.types.road_validity_range.RoadValidityRange]:
        return self._feature_validities_.raw_array

    @feature_validities.setter
    def feature_validities(self, feature_validities_: typing.List[nds.road.reference.types.road_validity_range.RoadValidityRange]) -> None:
        self._feature_validities_ = zserio.array.Array(zserio.array.ObjectArrayTraits(self._ZserioElementFactory_feature_validities(self)), feature_validities_)
    ...
    @property
    def attribute_values(self) -> typing.List[nds.localization.instantiations.occupancy_grid_attribute.OccupancyGridAttribute]:
        return self._attribute_values_.raw_array

    @attribute_values.setter
    def attribute_values(self, attribute_values_: typing.List[nds.localization.instantiations.occupancy_grid_attribute.OccupancyGridAttribute]) -> None:
        self._attribute_values_ = zserio.array.Array(zserio.array.ObjectArrayTraits(self._ZserioElementFactory_attribute_values(self)), attribute_values_)

    @property
    def attribute_properties(self) -> typing.List[nds.localization.instantiations.landmark_property_list.LandmarkPropertyList]:
        return self._attribute_properties_.raw_array

    @attribute_properties.setter
    def attribute_properties(self, attribute_properties_: typing.List[nds.localization.instantiations.landmark_property_list.LandmarkPropertyList]) -> None:
        self._attribute_properties_ = zserio.array.Array(zserio.array.ObjectArrayTraits(self._ZserioElementFactory_attribute_properties()), attribute_properties_)
    ...
    def init_packing_context(self, zserio_context: OccupancyGridRoadAttributeMap.ZserioPackingContext) -> None:
    ...
    def bitsizeof_packed(self, zserio_context: OccupancyGridRoadAttributeMap.ZserioPackingContext, bitposition: int = 0) -> int:
        end_bitposition = bitposition
    ...
    def initialize_offsets_packed(self, zserio_context: OccupancyGridRoadAttributeMap.ZserioPackingContext, bitposition: int) -> int:
        end_bitposition = bitposition
    ...
    def read(self, zserio_reader: zserio.BitStreamReader) -> None:
        self._attribute_type_code_ = nds.localization.attributes.occupancy_grid_relation_attribute_type.OccupancyGridRelationAttributeType.from_reader(zserio_reader)
    ...
    def read_packed(self, zserio_context: OccupancyGridRoadAttributeMap.ZserioPackingContext, zserio_reader: zserio.BitStreamReader) -> None:
        self._attribute_type_code_ = nds.localization.attributes.occupancy_grid_relation_attribute_type.OccupancyGridRelationAttributeType.from_reader_packed(zserio_context.attribute_type_code, zserio_reader)
    ...
    def write(self, zserio_writer: zserio.BitStreamWriter) -> None:
        ...
        if len(self._feature_references_) != (self._feature_):
            raise zserio.PythonRuntimeException("Wrong array length for field OccupancyGridRoadAttributeMap.featureReferences: "
        ...
        if len(self._feature_validities_) != (self._feature_):
            raise zserio.PythonRuntimeException("Wrong array length for field OccupancyGridRoadAttributeMap.featureValidities: "
        ...
        if len(self._feature_value_ptr_) != (self._feature_):
            raise zserio.PythonRuntimeException("Wrong array length for field OccupancyGridRoadAttributeMap.featureValuePtr: "
        ...
        if len(self._attribute_values_) != (self._attribute_):
            raise zserio.PythonRuntimeException("Wrong array length for field OccupancyGridRoadAttributeMap.attributeValues: "
        ...
        if len(self._attribute_properties_) != (self._attribute_):
            raise zserio.PythonRuntimeException("Wrong array length for field OccupancyGridRoadAttributeMap.attributeProperties: "
        ...
        if len(self._attribute_conditions_) != (self._attribute_):
            raise zserio.PythonRuntimeException("Wrong array length for field OccupancyGridRoadAttributeMap.attributeConditions: "
                                                f"{len(self._attribute_conditions_)} != {self._attribute_}!")
        self._attribute_conditions_.write_packed(zserio_writer)

    def write_packed(self, zserio_context: OccupancyGridRoadAttributeMap.ZserioPackingContext,
    ...
    class _ZserioElementFactory_feature_validities:
        ...
        def create(self, zserio_reader: zserio.BitStreamReader, zserio_index: int) -> nds.road.reference.types.road_validity_range.RoadValidityRange:
            del zserio_index
            return nds.road.reference.types.road_validity_range.RoadValidityRange.from_reader(zserio_reader, self._owner._coord_shift_)

        @staticmethod
        def create_packing_context() -> nds.road.reference.types.road_validity_range.RoadValidityRange.ZserioPackingContext:
            return nds.road.reference.types.road_validity_range.RoadValidityRange.ZserioPackingContext()

        def create_packed(self, zserio_context: nds.road.reference.types.road_validity_range.RoadValidityRange.ZserioPackingContext,
                          zserio_reader: zserio.BitStreamReader, zserio_index: int) -> nds.road.reference.types.road_validity_range.RoadValidityRange:
            del zserio_index
            return nds.road.reference.types.road_validity_range.RoadValidityRange.from_reader_packed(zserio_context, zserio_reader, self._owner._coord_shift_)
    ...
    class _ZserioElementFactory_attribute_values:
        ...
        def create(self, zserio_reader: zserio.BitStreamReader, zserio_index: int) -> nds.localization.instantiations.occupancy_grid_attribute.OccupancyGridAttribute:
            del zserio_index
            return nds.localization.instantiations.occupancy_grid_attribute.OccupancyGridAttribute.from_reader(zserio_reader, self._owner._attribute_type_code_)

        @staticmethod
        def create_packing_context() -> nds.localization.instantiations.occupancy_grid_attribute.OccupancyGridAttribute.ZserioPackingContext:
            return nds.localization.instantiations.occupancy_grid_attribute.OccupancyGridAttribute.ZserioPackingContext()

        def create_packed(self, zserio_context: nds.localization.instantiations.occupancy_grid_attribute.OccupancyGridAttribute.ZserioPackingContext,
                          zserio_reader: zserio.BitStreamReader, zserio_index: int) -> nds.localization.instantiations.occupancy_grid_attribute.OccupancyGridAttribute:
            del zserio_index
            return nds.localization.instantiations.occupancy_grid_attribute.OccupancyGridAttribute.from_reader_packed(zserio_context, zserio_reader, self._owner._attribute_type_code_)

    class _ZserioElementFactory_attribute_properties:
        IS_OBJECT_PACKABLE = True

        @staticmethod
        def create(zserio_reader: zserio.BitStreamReader, zserio_index: int) -> nds.localization.instantiations.landmark_property_list.LandmarkPropertyList:
            del zserio_index
            return nds.localization.instantiations.landmark_property_list.LandmarkPropertyList.from_reader(zserio_reader)

        @staticmethod
        def create_packing_context() -> nds.localization.instantiations.landmark_property_list.LandmarkPropertyList.ZserioPackingContext:
            return nds.localization.instantiations.landmark_property_list.LandmarkPropertyList.ZserioPackingContext()

        @staticmethod
        def create_packed(zserio_context: nds.localization.instantiations.landmark_property_list.LandmarkPropertyList.ZserioPackingContext,
                          zserio_reader: zserio.BitStreamReader, zserio_index: int) -> nds.localization.instantiations.landmark_property_list.LandmarkPropertyList:
            del zserio_index
            return nds.localization.instantiations.landmark_property_list.LandmarkPropertyList.from_reader_packed(zserio_context, zserio_reader)
