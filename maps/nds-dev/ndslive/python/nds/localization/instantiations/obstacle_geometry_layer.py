...
class ObstacleGeometryLayer:
    def __init__(
            ...
            identifier_: typing.Optional[typing.List[nds.core.geometry.geometry_id.GeometryId]] = None,
            types_: typing.Optional[typing.List[nds.localization.types.obstacle_type.ObstacleType]] = None,
    ...
    @classmethod
    def from_reader(
            cls: typing.Type['ObstacleGeometryLayer'],
            zserio_reader: zserio.BitStreamReader,
            type_: nds.core.geometry.geometry_layer_type.GeometryLayerType,
            has_ids_: bool,
            has_types_: bool) -> 'ObstacleGeometryLayer':
    ...
    def from_reader_packed(
            cls: typing.Type['ObstacleGeometryLayer'],
            zserio_context: ObstacleGeometryLayer.ZserioPackingContext,
            zserio_reader: zserio.BitStreamReader,
            type_: nds.core.geometry.geometry_layer_type.GeometryLayerType,
            has_ids_: bool,
            has_types_: bool) -> 'ObstacleGeometryLayer':
    ...
    def __eq__(self, other: object) -> bool:
        if isinstance(other, ObstacleGeometryLayer):
    ...
    @property
    def identifier(self) -> typing.Optional[typing.List[nds.core.geometry.geometry_id.GeometryId]]:
        return None if self._identifier_ is None else self._identifier_.raw_array

    @identifier.setter
    def identifier(self, identifier_: typing.Optional[typing.List[nds.core.geometry.geometry_id.GeometryId]]) -> None:
        if identifier_ is None:
            self._identifier_ = None
        else:
            self._identifier_ = zserio.array.Array(zserio.array.ObjectArrayTraits(self._ZserioElementFactory_identifier()), identifier_)
    ...
    @property
    def types(self) -> typing.Optional[typing.List[nds.localization.types.obstacle_type.ObstacleType]]:
        return None if self._types_ is None else self._types_.raw_array

    @types.setter
    def types(self, types_: typing.Optional[typing.List[nds.localization.types.obstacle_type.ObstacleType]]) -> None:
        if types_ is None:
            self._types_ = None
        else:
            self._types_ = zserio.array.Array(zserio.array.ObjectArrayTraits(self._ZserioElementFactory_types()), types_)
    ...
    def init_packing_context(self, zserio_context: ObstacleGeometryLayer.ZserioPackingContext) -> None:
    ...
    def bitsizeof(self, bitposition: int = 0) -> int:
        ...
        if self.is_identifier_used():
            end_bitposition += self._identifier_.bitsizeof(end_bitposition)
        if self.is_types_used():
            end_bitposition = zserio.bitposition.alignto(8, end_bitposition)
    ...
    def bitsizeof_packed(self, zserio_context: ObstacleGeometryLayer.ZserioPackingContext, bitposition: int = 0) -> int:
        end_bitposition = bitposition
    ...
    def initialize_offsets(self, bitposition: int = 0) -> int:
        ...
        end_bitposition += zserio.bitsizeof.bitsizeof_varsize(self._num_elements_)
        if self.is_identifier_used():
            end_bitposition = self._identifier_.initialize_offsets(end_bitposition)
        if self.is_types_used():
            end_bitposition = zserio.bitposition.alignto(8, end_bitposition)
    ...
    def initialize_offsets_packed(self, zserio_context: ObstacleGeometryLayer.ZserioPackingContext, bitposition: int) -> int:
        end_bitposition = bitposition
        end_bitposition += zserio_context.coord_shift_xy.bitsizeof(zserio.array.BitFieldArrayTraits(5), self._coord_shift_xy_)
        end_bitposition += zserio_context.coord_shift_z.bitsizeof(zserio.array.BitFieldArrayTraits(5), self._coord_shift_z_)
        end_bitposition = zserio.bitposition.alignto(8, end_bitposition)
    ...
    def read(self, zserio_reader: zserio.BitStreamReader) -> None:
        ...
        if self.is_identifier_used():
            self._identifier_ = zserio.array.Array.from_reader(zserio.array.ObjectArrayTraits(self._ZserioElementFactory_identifier()), zserio_reader, self._num_elements_)
        else:
            self._identifier_ = None
        if self.is_types_used():
            zserio_reader.alignto(8)
    ...
    def read_packed(self, zserio_context: ObstacleGeometryLayer.ZserioPackingContext, zserio_reader: zserio.BitStreamReader) -> None:
    ...
    def write(self, zserio_writer: zserio.BitStreamWriter) -> None:
        ...
        if self.is_identifier_used():
            ...
            if len(self._identifier_) != (self._num_elements_):
                raise zserio.PythonRuntimeException("Wrong array length for field ObstacleGeometryLayer.identifier: "
                                                    f"{len(self._identifier_)} != {self._num_elements_}!")
            self._identifier_.write(zserio_writer)

        if self.is_types_used():
            zserio_writer.alignto(8)
            # check array length
            if len(self._types_) != (self._num_elements_):
                raise zserio.PythonRuntimeException("Wrong array length for field ObstacleGeometryLayer.types: "
        ...
        if self._buffers_.type is not (self._type_):
            raise zserio.PythonRuntimeException("Wrong parameter type for field ObstacleGeometryLayer.buffers: "
                                                f"{self._buffers_.type} != {self._type_}!")
        if self._buffers_.shift_xy != (self._coord_shift_xy_):
            raise zserio.PythonRuntimeException("Wrong parameter shiftXY for field ObstacleGeometryLayer.buffers: "
                                                f"{self._buffers_.shift_xy} != {self._coord_shift_xy_}!")
        if self._buffers_.shift_z != (self._coord_shift_z_):
            raise zserio.PythonRuntimeException("Wrong parameter shiftZ for field ObstacleGeometryLayer.buffers: "
                                                f"{self._buffers_.shift_z} != {self._coord_shift_z_}!")
        if self._buffers_.num_elements != (self._num_elements_):
            raise zserio.PythonRuntimeException("Wrong parameter numElements for field ObstacleGeometryLayer.buffers: "
                                                f"{self._buffers_.num_elements} != {self._num_elements_}!")
        self._buffers_.write(zserio_writer)

    def write_packed(self, zserio_context: ObstacleGeometryLayer.ZserioPackingContext,
    ...
    class _ZserioElementFactory_identifier:
        ...
        @staticmethod
        def create(zserio_reader: zserio.BitStreamReader, zserio_index: int) -> nds.core.geometry.geometry_id.GeometryId:
            del zserio_index
            return nds.core.geometry.geometry_id.GeometryId.from_reader(zserio_reader)
