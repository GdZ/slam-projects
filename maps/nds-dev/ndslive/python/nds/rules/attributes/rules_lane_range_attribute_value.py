...
import nds.rules.types.lane_right_of_way_regulation
import nds.rules.types.lane_traffic_priority
...
class RulesLaneRangeAttributeValue:
    def __init__(
            self,
            type_: nds.rules.attributes.rules_lane_range_attribute_type.RulesLaneRangeAttributeType,
            *,
            ...
            roadworks_: typing.Union[nds.rules.types.roadworks.Roadworks, None] = None,
            lane_right_of_way_regulation_: typing.Union[nds.rules.types.lane_right_of_way_regulation.LaneRightOfWayRegulation, None] = None,
            lane_traffic_priority_: typing.Union[nds.rules.types.lane_traffic_priority.LaneTrafficPriority, None] = None) -> None:
        self._type_ = type_
        ...
        if overtaking_prohibition_ is not None:
            if self._choice != None:
                raise zserio.PythonRuntimeException("Calling constructor of choice RulesLaneRangeAttributeValue is ambiguous!")
        ...
        if lane_right_of_way_regulation_ is not None:
            if self._choice != None:
                raise zserio.PythonRuntimeException("Calling constructor of choice RulesLaneRangeAttributeValue is ambiguous!")
            self._choice = lane_right_of_way_regulation_
        if lane_traffic_priority_ is not None:
            if self._choice != None:
                raise zserio.PythonRuntimeException("Calling constructor of choice RulesLaneRangeAttributeValue is ambiguous!")
            self._choice = lane_traffic_priority_

    @classmethod
    def from_reader(
            cls: typing.Type['RulesLaneRangeAttributeValue'],
            zserio_reader: zserio.BitStreamReader,
            type_: nds.rules.attributes.rules_lane_range_attribute_type.RulesLaneRangeAttributeType) -> 'RulesLaneRangeAttributeValue':
    ...
    def from_reader_packed(
            cls: typing.Type['RulesLaneRangeAttributeValue'],
            zserio_context: RulesLaneRangeAttributeValue.ZserioPackingContext,
            zserio_reader: zserio.BitStreamReader,
            type_: nds.rules.attributes.rules_lane_range_attribute_type.RulesLaneRangeAttributeType) -> 'RulesLaneRangeAttributeValue':
        self = object.__new__(cls)
        self._type_ = type_
    ...
    def __eq__(self, other: object) -> bool:
        if isinstance(other, RulesLaneRangeAttributeValue):
    ...
    def __hash__(self) -> int:
        ...
        if selector == (nds.rules.attributes.rules_lane_range_attribute_type.RulesLaneRangeAttributeType.PROHIBITED_PASSAGE):
            result = zserio.hashcode.calc_hashcode_object(result, self._choice)
        elif selector == (nds.rules.attributes.rules_lane_range_attribute_type.RulesLaneRangeAttributeType.OVERTAKING_PROHIBITION):
            result = zserio.hashcode.calc_hashcode_object(result, self._choice)
        elif selector == (nds.rules.attributes.rules_lane_range_attribute_type.RulesLaneRangeAttributeType.SPEED_LIMIT_METRIC):
            result = zserio.hashcode.calc_hashcode_int32(result, self._choice)
        elif selector == (nds.rules.attributes.rules_lane_range_attribute_type.RulesLaneRangeAttributeType.SPEED_LIMIT_IMPERIAL):
            result = zserio.hashcode.calc_hashcode_int32(result, self._choice)
        elif selector == (nds.rules.attributes.rules_lane_range_attribute_type.RulesLaneRangeAttributeType.MINIMUM_SPEED_METRIC):
            result = zserio.hashcode.calc_hashcode_int32(result, self._choice)
        elif selector == (nds.rules.attributes.rules_lane_range_attribute_type.RulesLaneRangeAttributeType.MINIMUM_SPEED_IMPERIAL):
            result = zserio.hashcode.calc_hashcode_int32(result, self._choice)
        elif selector == (nds.rules.attributes.rules_lane_range_attribute_type.RulesLaneRangeAttributeType.ADVISORY_SPEED_LIMIT_METRIC):
            result = zserio.hashcode.calc_hashcode_int32(result, self._choice)
        elif selector == (nds.rules.attributes.rules_lane_range_attribute_type.RulesLaneRangeAttributeType.ADVISORY_SPEED_LIMIT_IMPERIAL):
            result = zserio.hashcode.calc_hashcode_int32(result, self._choice)
        elif selector == (nds.rules.attributes.rules_lane_range_attribute_type.RulesLaneRangeAttributeType.TRAFFIC_ENFORCEMENT_ZONE):
            result = zserio.hashcode.calc_hashcode_object(result, self._choice)
        elif selector == (nds.rules.attributes.rules_lane_range_attribute_type.RulesLaneRangeAttributeType.TRAFFIC_ZONE):
            result = zserio.hashcode.calc_hashcode_object(result, self._choice)
        elif selector == (nds.rules.attributes.rules_lane_range_attribute_type.RulesLaneRangeAttributeType.SEASONAL_CLOSED):
            result = zserio.hashcode.calc_hashcode_object(result, self._choice)
        elif selector == (nds.rules.attributes.rules_lane_range_attribute_type.RulesLaneRangeAttributeType.DONT_STOP_ZONE):
            result = zserio.hashcode.calc_hashcode_object(result, self._choice)
        elif selector == (nds.rules.attributes.rules_lane_range_attribute_type.RulesLaneRangeAttributeType.PROHIBITED_PARKING):
            result = zserio.hashcode.calc_hashcode_object(result, self._choice)
        elif selector == (nds.rules.attributes.rules_lane_range_attribute_type.RulesLaneRangeAttributeType.PROHIBITED_STOPPING):
            result = zserio.hashcode.calc_hashcode_object(result, self._choice)
        elif selector == (nds.rules.attributes.rules_lane_range_attribute_type.RulesLaneRangeAttributeType.AUTOMATED_DRIVING_CLEARANCE):
            result = zserio.hashcode.calc_hashcode_object(result, self._choice)
        elif selector == (nds.rules.attributes.rules_lane_range_attribute_type.RulesLaneRangeAttributeType.ROADWORKS):
            result = zserio.hashcode.calc_hashcode_object(result, self._choice)
        elif selector == (nds.rules.attributes.rules_lane_range_attribute_type.RulesLaneRangeAttributeType.LANE_RIGHT_OF_WAY_REGULATION):
            result = zserio.hashcode.calc_hashcode_object(result, self._choice)
        elif selector == (nds.rules.attributes.rules_lane_range_attribute_type.RulesLaneRangeAttributeType.LANE_TRAFFIC_PRIORITY):
            result = zserio.hashcode.calc_hashcode_object(result, self._choice)
        else:
            pass
    ...
    @property
    def type(self) -> nds.rules.attributes.rules_lane_range_attribute_type.RulesLaneRangeAttributeType:
        return self._type_
    ...
    @property
    def lane_right_of_way_regulation(self) -> typing.Union[nds.rules.types.lane_right_of_way_regulation.LaneRightOfWayRegulation, None]:
        return self._choice

    @lane_right_of_way_regulation.setter
    def lane_right_of_way_regulation(self, lane_right_of_way_regulation_: typing.Union[nds.rules.types.lane_right_of_way_regulation.LaneRightOfWayRegulation, None]) -> None:
        self._choice = lane_right_of_way_regulation_

    @property
    def lane_traffic_priority(self) -> typing.Union[nds.rules.types.lane_traffic_priority.LaneTrafficPriority, None]:
        return self._choice

    @lane_traffic_priority.setter
    def lane_traffic_priority(self, lane_traffic_priority_: typing.Union[nds.rules.types.lane_traffic_priority.LaneTrafficPriority, None]) -> None:
        self._choice = lane_traffic_priority_
    ...
    def choice_tag(self) -> int:
        ...
        if selector == (nds.rules.attributes.rules_lane_range_attribute_type.RulesLaneRangeAttributeType.PROHIBITED_PASSAGE):
            ...
            return self.CHOICE_LANE_RIGHT_OF_WAY_REGULATION
        elif selector == (nds.rules.attributes.rules_lane_range_attribute_type.RulesLaneRangeAttributeType.LANE_TRAFFIC_PRIORITY):
            return self.CHOICE_LANE_TRAFFIC_PRIORITY
        else:
            return self.UNDEFINED_CHOICE

    def init_packing_context(self, zserio_context: RulesLaneRangeAttributeValue.ZserioPackingContext) -> None:
        selector = self._type_
        ...
        if selector == (nds.rules.attributes.rules_lane_range_attribute_type.RulesLaneRangeAttributeType.PROHIBITED_PASSAGE):
            ...
            self._choice.init_packing_context(zserio_context.lane_right_of_way_regulation)
        elif selector == (nds.rules.attributes.rules_lane_range_attribute_type.RulesLaneRangeAttributeType.LANE_TRAFFIC_PRIORITY):
            self._choice.init_packing_context(zserio_context.lane_traffic_priority)
        else:
            raise zserio.PythonRuntimeException("No match in choice RulesLaneRangeAttributeValue!")
    ...
    def bitsizeof_packed(self, zserio_context: RulesLaneRangeAttributeValue.ZserioPackingContext,
        ...
        if selector == (nds.rules.attributes.rules_lane_range_attribute_type.RulesLaneRangeAttributeType.PROHIBITED_PASSAGE):
            ...
            end_bitposition += self._choice.bitsizeof_packed(zserio_context.lane_right_of_way_regulation, end_bitposition)
        elif selector == (nds.rules.attributes.rules_lane_range_attribute_type.RulesLaneRangeAttributeType.LANE_TRAFFIC_PRIORITY):
            end_bitposition += self._choice.bitsizeof_packed(zserio_context.lane_traffic_priority, end_bitposition)
        else:
            raise zserio.PythonRuntimeException("No match in choice RulesLaneRangeAttributeValue!")
    ...
    def initialize_offsets_packed(self, zserio_context: RulesLaneRangeAttributeValue.ZserioPackingContext,
                                  bitposition: int) -> int:
        end_bitposition = bitposition
        ...
        if selector == (nds.rules.attributes.rules_lane_range_attribute_type.RulesLaneRangeAttributeType.PROHIBITED_PASSAGE):
            ...
            end_bitposition = self._choice.initialize_offsets_packed(zserio_context.lane_right_of_way_regulation, end_bitposition)
        elif selector == (nds.rules.attributes.rules_lane_range_attribute_type.RulesLaneRangeAttributeType.LANE_TRAFFIC_PRIORITY):
            end_bitposition = self._choice.initialize_offsets_packed(zserio_context.lane_traffic_priority, end_bitposition)
        else:
            raise zserio.PythonRuntimeException("No match in choice RulesLaneRangeAttributeValue!")
    ...
    def read(self, zserio_reader: zserio.BitStreamReader) -> None:
        ...
        if selector == (nds.rules.attributes.rules_lane_range_attribute_type.RulesLaneRangeAttributeType.PROHIBITED_PASSAGE):
            ...
            self._choice = nds.rules.types.lane_right_of_way_regulation.LaneRightOfWayRegulation.from_reader(zserio_reader)
        elif selector == (nds.rules.attributes.rules_lane_range_attribute_type.RulesLaneRangeAttributeType.LANE_TRAFFIC_PRIORITY):
            self._choice = nds.rules.types.lane_traffic_priority.LaneTrafficPriority.from_reader(zserio_reader)
        else:
            raise zserio.PythonRuntimeException("No match in choice RulesLaneRangeAttributeValue!")

    def read_packed(self, zserio_context: RulesLaneRangeAttributeValue.ZserioPackingContext,
        ...
        if selector == (nds.rules.attributes.rules_lane_range_attribute_type.RulesLaneRangeAttributeType.PROHIBITED_PASSAGE):
            ...
            self._choice = nds.rules.types.lane_right_of_way_regulation.LaneRightOfWayRegulation.from_reader_packed(zserio_context.lane_right_of_way_regulation, zserio_reader)
        elif selector == (nds.rules.attributes.rules_lane_range_attribute_type.RulesLaneRangeAttributeType.LANE_TRAFFIC_PRIORITY):
            self._choice = nds.rules.types.lane_traffic_priority.LaneTrafficPriority.from_reader_packed(zserio_context.lane_traffic_priority, zserio_reader)
        else:
            raise zserio.PythonRuntimeException("No match in choice RulesLaneRangeAttributeValue!")
    ...
    def write_packed(self, zserio_context: RulesLaneRangeAttributeValue.ZserioPackingContext,
        ...
        if selector == (nds.rules.attributes.rules_lane_range_attribute_type.RulesLaneRangeAttributeType.PROHIBITED_PASSAGE):
            ...
            self._choice.write_packed(zserio_context.lane_right_of_way_regulation, zserio_writer)
        elif selector == (nds.rules.attributes.rules_lane_range_attribute_type.RulesLaneRangeAttributeType.LANE_TRAFFIC_PRIORITY):
            self._choice.write_packed(zserio_context.lane_traffic_priority, zserio_writer)
        else:
            raise zserio.PythonRuntimeException("No match in choice RulesLaneRangeAttributeValue!")
    ...
    class ZserioPackingContext:
        def __init__(self):
            ...
            self._lane_right_of_way_regulation_ = nds.rules.types.lane_right_of_way_regulation.LaneRightOfWayRegulation.ZserioPackingContext()
            self._lane_traffic_priority_ = nds.rules.types.lane_traffic_priority.LaneTrafficPriority.ZserioPackingContext()
        ...
        @property
        def lane_right_of_way_regulation(self):
            return self._lane_right_of_way_regulation_

        @property
        def lane_traffic_priority(self):
            return self._lane_traffic_priority_
    ...
    CHOICE_TRAFFIC_ZONE = 9
    CHOICE_SEASONAL_CLOSED = 10
    CHOICE_DONT_STOP_ZONE = 11
    CHOICE_PROHIBITED_PARKING = 12
    CHOICE_PROHIBITED_STOPPING = 13
    CHOICE_AUTOMATED_DRIVING_CLEARANCE = 14
    CHOICE_ROADWORKS = 15
    CHOICE_LANE_RIGHT_OF_WAY_REGULATION = 16
    CHOICE_LANE_TRAFFIC_PRIORITY = 17
    UNDEFINED_CHOICE = -1
