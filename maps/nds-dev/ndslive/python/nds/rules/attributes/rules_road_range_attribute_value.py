...
class RulesRoadRangeAttributeValue:
    def __init__(
            self,
            type_: nds.rules.attributes.rules_road_range_attribute_type.RulesRoadRangeAttributeType,
            *,
        ...
        if overtaking_prohibition_ is not None:
            if self._choice != None:
                raise zserio.PythonRuntimeException("Calling constructor of choice RulesRoadRangeAttributeValue is ambiguous!")
    ...
    @classmethod
    def from_reader(
            cls: typing.Type['RulesRoadRangeAttributeValue'],
            zserio_reader: zserio.BitStreamReader,
            type_: nds.rules.attributes.rules_road_range_attribute_type.RulesRoadRangeAttributeType) -> 'RulesRoadRangeAttributeValue':
    ...
    def from_reader_packed(
            cls: typing.Type['RulesRoadRangeAttributeValue'],
            zserio_context: RulesRoadRangeAttributeValue.ZserioPackingContext,
            zserio_reader: zserio.BitStreamReader,
            type_: nds.rules.attributes.rules_road_range_attribute_type.RulesRoadRangeAttributeType) -> 'RulesRoadRangeAttributeValue':
        self = object.__new__(cls)
        self._type_ = type_
    ...
    def __eq__(self, other: object) -> bool:
        if isinstance(other, RulesRoadRangeAttributeValue):
    ...
    def __hash__(self) -> int:
        ...
        if selector == (nds.rules.attributes.rules_road_range_attribute_type.RulesRoadRangeAttributeType.PROHIBITED_PASSAGE):
            result = zserio.hashcode.calc_hashcode_object(result, self._choice)
        elif selector == (nds.rules.attributes.rules_road_range_attribute_type.RulesRoadRangeAttributeType.OVERTAKING_PROHIBITION):
            result = zserio.hashcode.calc_hashcode_object(result, self._choice)
        elif selector == (nds.rules.attributes.rules_road_range_attribute_type.RulesRoadRangeAttributeType.SPEED_LIMIT_METRIC):
            result = zserio.hashcode.calc_hashcode_int32(result, self._choice)
        elif selector == (nds.rules.attributes.rules_road_range_attribute_type.RulesRoadRangeAttributeType.SPEED_LIMIT_IMPERIAL):
            result = zserio.hashcode.calc_hashcode_int32(result, self._choice)
        elif selector == (nds.rules.attributes.rules_road_range_attribute_type.RulesRoadRangeAttributeType.MINIMUM_SPEED_METRIC):
            result = zserio.hashcode.calc_hashcode_int32(result, self._choice)
        elif selector == (nds.rules.attributes.rules_road_range_attribute_type.RulesRoadRangeAttributeType.MINIMUM_SPEED_IMPERIAL):
            result = zserio.hashcode.calc_hashcode_int32(result, self._choice)
        elif selector == (nds.rules.attributes.rules_road_range_attribute_type.RulesRoadRangeAttributeType.ADVISORY_SPEED_LIMIT_METRIC):
            result = zserio.hashcode.calc_hashcode_int32(result, self._choice)
        elif selector == (nds.rules.attributes.rules_road_range_attribute_type.RulesRoadRangeAttributeType.ADVISORY_SPEED_LIMIT_IMPERIAL):
            result = zserio.hashcode.calc_hashcode_int32(result, self._choice)
        elif selector == (nds.rules.attributes.rules_road_range_attribute_type.RulesRoadRangeAttributeType.TRAFFIC_ENFORCEMENT_ZONE):
            result = zserio.hashcode.calc_hashcode_object(result, self._choice)
        elif selector == (nds.rules.attributes.rules_road_range_attribute_type.RulesRoadRangeAttributeType.NON_DEFAULT_DRIVING_SIDE):
            result = zserio.hashcode.calc_hashcode_object(result, self._choice)
        elif selector == (nds.rules.attributes.rules_road_range_attribute_type.RulesRoadRangeAttributeType.TRAFFIC_ZONE):
            result = zserio.hashcode.calc_hashcode_object(result, self._choice)
        elif selector == (nds.rules.attributes.rules_road_range_attribute_type.RulesRoadRangeAttributeType.ADR_TUNNEL_CATEGORY):
            result = zserio.hashcode.calc_hashcode_object(result, self._choice)
        elif selector == (nds.rules.attributes.rules_road_range_attribute_type.RulesRoadRangeAttributeType.LICENSE_PLATE_RESTRICTION):
            result = zserio.hashcode.calc_hashcode_object(result, self._choice)
        elif selector == (nds.rules.attributes.rules_road_range_attribute_type.RulesRoadRangeAttributeType.SEASONAL_CLOSED):
            result = zserio.hashcode.calc_hashcode_object(result, self._choice)
        elif selector == (nds.rules.attributes.rules_road_range_attribute_type.RulesRoadRangeAttributeType.PROHIBITED_PARKING):
            result = zserio.hashcode.calc_hashcode_object(result, self._choice)
        elif selector == (nds.rules.attributes.rules_road_range_attribute_type.RulesRoadRangeAttributeType.PROHIBITED_STOPPING):
            result = zserio.hashcode.calc_hashcode_object(result, self._choice)
        elif selector == (nds.rules.attributes.rules_road_range_attribute_type.RulesRoadRangeAttributeType.DONT_STOP_ZONE):
            result = zserio.hashcode.calc_hashcode_object(result, self._choice)
        elif selector == (nds.rules.attributes.rules_road_range_attribute_type.RulesRoadRangeAttributeType.AUTOMATED_DRIVING_CLEARANCE):
            result = zserio.hashcode.calc_hashcode_object(result, self._choice)
        elif selector == (nds.rules.attributes.rules_road_range_attribute_type.RulesRoadRangeAttributeType.ROADWORKS):
            result = zserio.hashcode.calc_hashcode_object(result, self._choice)
        else:
            pass
    ...
    @property
    def type(self) -> nds.rules.attributes.rules_road_range_attribute_type.RulesRoadRangeAttributeType:
        return self._type_
    ...
    def init_packing_context(self, zserio_context: RulesRoadRangeAttributeValue.ZserioPackingContext) -> None:
        selector = self._type_
        ...
        if selector == (nds.rules.attributes.rules_road_range_attribute_type.RulesRoadRangeAttributeType.PROHIBITED_PASSAGE):
            ...
            raise zserio.PythonRuntimeException("No match in choice RulesRoadRangeAttributeValue!")
    ...
    def bitsizeof_packed(self, zserio_context: RulesRoadRangeAttributeValue.ZserioPackingContext,
    ...
    def initialize_offsets_packed(self, zserio_context: RulesRoadRangeAttributeValue.ZserioPackingContext,
                                  bitposition: int) -> int:
        end_bitposition = bitposition
    ...
    def read_packed(self, zserio_context: RulesRoadRangeAttributeValue.ZserioPackingContext,
    ...
    def write_packed(self, zserio_context: RulesRoadRangeAttributeValue.ZserioPackingContext,
