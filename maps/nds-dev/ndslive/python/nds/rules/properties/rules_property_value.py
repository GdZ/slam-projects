...
import nds.rules.properties.property_value
import nds.rules.properties.rules_property_type

class RulesPropertyValue:
    def __init__(
            self,
            type_: nds.rules.properties.rules_property_type.RulesPropertyType,
            value_: typing.Optional[nds.rules.properties.property_value.PropertyValue] = None,
    ...
    @classmethod
    def from_reader(
            cls: typing.Type['RulesPropertyValue'],
            zserio_reader: zserio.BitStreamReader,
            type_: nds.rules.properties.rules_property_type.RulesPropertyType) -> 'RulesPropertyValue':
    ...
    def from_reader_packed(
            cls: typing.Type['RulesPropertyValue'],
            zserio_context: RulesPropertyValue.ZserioPackingContext,
            zserio_reader: zserio.BitStreamReader,
            type_: nds.rules.properties.rules_property_type.RulesPropertyType) -> 'RulesPropertyValue':
        self = object.__new__(cls)
        self._type_ = type_
    ...
    def __eq__(self, other: object) -> bool:
        if isinstance(other, RulesPropertyValue):
    ...
    @property
    def type(self) -> nds.rules.properties.rules_property_type.RulesPropertyType:
        return self._type_

    @property
    def value(self) -> typing.Optional[nds.rules.properties.property_value.PropertyValue]:
        return self._value_

    @value.setter
    def value(self, value_: typing.Optional[nds.rules.properties.property_value.PropertyValue]) -> None:
        self._value_ = value_

    def is_value_used(self) -> bool:
        return self._type_.type != nds.rules.properties.property_type.PropertyType.CORE
    ...
    def init_packing_context(self, zserio_context: RulesPropertyValue.ZserioPackingContext) -> None:
        if self.is_value_used():
    ...
    def bitsizeof_packed(self, zserio_context: RulesPropertyValue.ZserioPackingContext, bitposition: int = 0) -> int:
        end_bitposition = bitposition
        if self.is_value_used():
    ...
    def initialize_offsets_packed(self, zserio_context: RulesPropertyValue.ZserioPackingContext, bitposition: int) -> int:
        end_bitposition = bitposition
        if self.is_value_used():
    ...
    def read(self, zserio_reader: zserio.BitStreamReader) -> None:
        if self.is_value_used():
            self._value_ = nds.rules.properties.property_value.PropertyValue.from_reader(zserio_reader, self._type_.type)
        else:
            self._value_ = None
        if self.is_core_value_used():
    ...
    def read_packed(self, zserio_context: RulesPropertyValue.ZserioPackingContext, zserio_reader: zserio.BitStreamReader) -> None:
        if self.is_value_used():
            self._value_ = nds.rules.properties.property_value.PropertyValue.from_reader_packed(zserio_context.value, zserio_reader, self._type_.type)
        else:
            self._value_ = None
    ...
    def write(self, zserio_writer: zserio.BitStreamWriter) -> None:
        if self.is_value_used():
            ...
            if self._value_.type is not (self._type_.type):
                raise zserio.PythonRuntimeException("Wrong parameter type for field RulesPropertyValue.value: "
        ...
        if self.is_core_value_used():
            ...
            if self._core_value_.type is not (self._type_.core_type):
                raise zserio.PythonRuntimeException("Wrong parameter type for field RulesPropertyValue.coreValue: "
                                                    f"{self._core_value_.type} != {self._type_.core_type}!")
            self._core_value_.write(zserio_writer)

    def write_packed(self, zserio_context: RulesPropertyValue.ZserioPackingContext,
    ...
    class ZserioPackingContext:
        def __init__(self):
            self._value_ = nds.rules.properties.property_value.PropertyValue.ZserioPackingContext()
