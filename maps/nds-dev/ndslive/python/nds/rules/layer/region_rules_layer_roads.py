...
import nds.rules.layer.region_road_relation_list
...
class RegionRulesLayerRoads:
    def __init__(
            ...
            feature_relations_: typing.Optional[typing.List[nds.rules.layer.region_road_relation_list.RegionRoadRelationList]] = None) -> None:
    ...
    @classmethod
    def from_reader(
            cls: typing.Type['RegionRulesLayerRoads'],
            zserio_reader: zserio.BitStreamReader) -> 'RegionRulesLayerRoads':
    ...
    def from_reader_packed(
            cls: typing.Type['RegionRulesLayerRoads'],
            zserio_context: RegionRulesLayerRoads.ZserioPackingContext,
            zserio_reader: zserio.BitStreamReader) -> 'RegionRulesLayerRoads':
        self = object.__new__(cls)
    ...
    def __eq__(self, other: object) -> bool:
        if isinstance(other, RegionRulesLayerRoads):
    ...
    @property
    def feature_relations(self) -> typing.Optional[typing.List[nds.rules.layer.region_road_relation_list.RegionRoadRelationList]]:
        return None if self._feature_relations_ is None else self._feature_relations_.raw_array

    @feature_relations.setter
    def feature_relations(self, feature_relations_: typing.Optional[typing.List[nds.rules.layer.region_road_relation_list.RegionRoadRelationList]]) -> None:
        if feature_relations_ is None:
            self._feature_relations_ = None
        else:
            self._feature_relations_ = zserio.array.Array(zserio.array.ObjectArrayTraits(self._ZserioElementFactory_feature_relations()), feature_relations_)
    ...
    def init_packing_context(self, zserio_context: RegionRulesLayerRoads.ZserioPackingContext) -> None:
    ...
    def bitsizeof_packed(self, zserio_context: RegionRulesLayerRoads.ZserioPackingContext, bitposition: int = 0) -> int:
        end_bitposition = bitposition
    ...
    def initialize_offsets_packed(self, zserio_context: RegionRulesLayerRoads.ZserioPackingContext, bitposition: int) -> int:
        end_bitposition = bitposition
        end_bitposition += zserio_context.num_regions.bitsizeof(zserio.array.VarUInt16ArrayTraits(), self._num_regions_)
    ...
    def read(self, zserio_reader: zserio.BitStreamReader) -> None:
        ...
        if not (self._num_regions_ > 0):
            raise zserio.PythonRuntimeException("Constraint violated for field RegionRulesLayerRoads.numRegions!")
    ...
    def read_packed(self, zserio_context: RegionRulesLayerRoads.ZserioPackingContext, zserio_reader: zserio.BitStreamReader) -> None:
    ...
    def write(self, zserio_writer: zserio.BitStreamWriter) -> None:
        ...
        if len(self._region_id_) != (self._num_regions_):
            raise zserio.PythonRuntimeException("Wrong array length for field RegionRulesLayerRoads.regionId: "
        ...
        if self.is_region_rules_attribute_maps_used():
            ...
            if self._region_rules_attribute_maps_.coord_shift != (0):
                raise zserio.PythonRuntimeException("Wrong parameter coordShift for field RegionRulesLayerRoads.regionRulesAttributeMaps: "
        ...
        if self.is_region_rules_attribute_sets_used():
            ...
            if self._region_rules_attribute_sets_.coord_shift != (0):
                raise zserio.PythonRuntimeException("Wrong parameter coordShift for field RegionRulesLayerRoads.regionRulesAttributeSets: "
        ...
        if self.is_feature_relations_used():
            ...
            if len(self._feature_relations_) != (self._num_regions_):
                raise zserio.PythonRuntimeException("Wrong array length for field RegionRulesLayerRoads.featureRelations: "
                                                    f"{len(self._feature_relations_)} != {self._num_regions_}!")
            self._feature_relations_.write(zserio_writer)

    def write_packed(self, zserio_context: RegionRulesLayerRoads.ZserioPackingContext,
    ...
    class _ZserioElementFactory_feature_relations:
        ...
        @staticmethod
        def create(zserio_reader: zserio.BitStreamReader, zserio_index: int) -> nds.rules.layer.region_road_relation_list.RegionRoadRelationList:
            del zserio_index
            return nds.rules.layer.region_road_relation_list.RegionRoadRelationList.from_reader(zserio_reader)

        @staticmethod
        def create_packing_context() -> nds.rules.layer.region_road_relation_list.RegionRoadRelationList.ZserioPackingContext:
            return nds.rules.layer.region_road_relation_list.RegionRoadRelationList.ZserioPackingContext()

        @staticmethod
        def create_packed(zserio_context: nds.rules.layer.region_road_relation_list.RegionRoadRelationList.ZserioPackingContext,
                          zserio_reader: zserio.BitStreamReader, zserio_index: int) -> nds.rules.layer.region_road_relation_list.RegionRoadRelationList:
            del zserio_index
            return nds.rules.layer.region_road_relation_list.RegionRoadRelationList.from_reader_packed(zserio_context, zserio_reader)
