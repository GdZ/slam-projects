...
import nds.rules.instantiations.rules_property

class RulesPropertyList:
    def __init__(
            self,
            num_properties_: int = int(),
            property_: typing.Optional[typing.List[nds.rules.instantiations.rules_property.RulesProperty]] = None) -> None:
    ...
    @classmethod
    def from_reader(
            cls: typing.Type['RulesPropertyList'],
            zserio_reader: zserio.BitStreamReader) -> 'RulesPropertyList':
    ...
    def from_reader_packed(
            cls: typing.Type['RulesPropertyList'],
            zserio_context: RulesPropertyList.ZserioPackingContext,
            zserio_reader: zserio.BitStreamReader) -> 'RulesPropertyList':
        self = object.__new__(cls)
    ...
    def __eq__(self, other: object) -> bool:
        if isinstance(other, RulesPropertyList):
    ...
    @property
    def property(self) -> typing.Optional[typing.List[nds.rules.instantiations.rules_property.RulesProperty]]:
        return None if self._property_ is None else self._property_.raw_array

    @property.setter
    def property(self, property_: typing.Optional[typing.List[nds.rules.instantiations.rules_property.RulesProperty]]) -> None:
        if property_ is None:
            self._property_ = None
        else:
            self._property_ = zserio.array.Array(zserio.array.ObjectArrayTraits(self._ZserioElementFactory_property()), property_)
    ...
    def init_packing_context(self, zserio_context: RulesPropertyList.ZserioPackingContext) -> None:
    ...
    def bitsizeof_packed(self, zserio_context: RulesPropertyList.ZserioPackingContext, bitposition: int = 0) -> int:
        end_bitposition = bitposition
    ...
    def initialize_offsets_packed(self, zserio_context: RulesPropertyList.ZserioPackingContext, bitposition: int) -> int:
        end_bitposition = bitposition
        end_bitposition += zserio_context.num_properties.bitsizeof(zserio.array.BitFieldArrayTraits(8), self._num_properties_)
        if self.is_property_used():
            end_bitposition = self._property_.initialize_offsets_packed(end_bitposition)
    ...
    def read_packed(self, zserio_context: RulesPropertyList.ZserioPackingContext, zserio_reader: zserio.BitStreamReader) -> None:
    ...
    def write(self, zserio_writer: zserio.BitStreamWriter) -> None:
        ...
        if self.is_property_used():
            ...
            if len(self._property_) != (self._num_properties_):
                raise zserio.PythonRuntimeException("Wrong array length for field RulesPropertyList.property: "
                                                    f"{len(self._property_)} != {self._num_properties_}!")
            self._property_.write_packed(zserio_writer)

    def write_packed(self, zserio_context: RulesPropertyList.ZserioPackingContext,
    ...
    class _ZserioElementFactory_property:
        ...
        @staticmethod
        def create(zserio_reader: zserio.BitStreamReader, zserio_index: int) -> nds.rules.instantiations.rules_property.RulesProperty:
            del zserio_index
            return nds.rules.instantiations.rules_property.RulesProperty.from_reader(zserio_reader)

        @staticmethod
        def create_packing_context() -> nds.rules.instantiations.rules_property.RulesProperty.ZserioPackingContext:
            return nds.rules.instantiations.rules_property.RulesProperty.ZserioPackingContext()

        @staticmethod
        def create_packed(zserio_context: nds.rules.instantiations.rules_property.RulesProperty.ZserioPackingContext,
                          zserio_reader: zserio.BitStreamReader, zserio_index: int) -> nds.rules.instantiations.rules_property.RulesProperty:
            del zserio_index
            return nds.rules.instantiations.rules_property.RulesProperty.from_reader_packed(zserio_context, zserio_reader)
