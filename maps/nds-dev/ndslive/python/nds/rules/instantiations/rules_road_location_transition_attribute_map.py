...
import nds.rules.instantiations.rules_transition_attribute

class RulesRoadLocationTransitionAttributeMap:
    def __init__(
            self,
            coord_shift_: nds.core.geometry.coord_shift.CoordShift,
            attribute_type_code_: typing.Union[nds.rules.attributes.rules_transition_attribute_type.RulesTransitionAttributeType, None] = None,
            ...
            attribute_values_: typing.List[nds.rules.instantiations.rules_transition_attribute.RulesTransitionAttribute] = None,
    ...
    @classmethod
    def from_reader(
            cls: typing.Type['RulesRoadLocationTransitionAttributeMap'],
            zserio_reader: zserio.BitStreamReader,
            coord_shift_: nds.core.geometry.coord_shift.CoordShift) -> 'RulesRoadLocationTransitionAttributeMap':
    ...
    def from_reader_packed(
            cls: typing.Type['RulesRoadLocationTransitionAttributeMap'],
            zserio_context: RulesRoadLocationTransitionAttributeMap.ZserioPackingContext,
            zserio_reader: zserio.BitStreamReader,
            coord_shift_: nds.core.geometry.coord_shift.CoordShift) -> 'RulesRoadLocationTransitionAttributeMap':
        self = object.__new__(cls)
        self._coord_shift_ = coord_shift_
    ...
    def __eq__(self, other: object) -> bool:
        if isinstance(other, RulesRoadLocationTransitionAttributeMap):
    ...
    @property
    def attribute_type_code(self) -> typing.Union[nds.rules.attributes.rules_transition_attribute_type.RulesTransitionAttributeType, None]:
        return self._attribute_type_code_

    @attribute_type_code.setter
    def attribute_type_code(self, attribute_type_code_: typing.Union[nds.rules.attributes.rules_transition_attribute_type.RulesTransitionAttributeType, None]) -> None:
        self._attribute_type_code_ = attribute_type_code_
    ...
    @property
    def attribute_values(self) -> typing.List[nds.rules.instantiations.rules_transition_attribute.RulesTransitionAttribute]:
        return self._attribute_values_.raw_array

    @attribute_values.setter
    def attribute_values(self, attribute_values_: typing.List[nds.rules.instantiations.rules_transition_attribute.RulesTransitionAttribute]) -> None:
        self._attribute_values_ = zserio.array.Array(zserio.array.ObjectArrayTraits(self._ZserioElementFactory_attribute_values(self)), attribute_values_)
    ...
    def init_packing_context(self, zserio_context: RulesRoadLocationTransitionAttributeMap.ZserioPackingContext) -> None:
    ...
    def bitsizeof_packed(self, zserio_context: RulesRoadLocationTransitionAttributeMap.ZserioPackingContext, bitposition: int = 0) -> int:
        end_bitposition = bitposition
    ...
    def initialize_offsets_packed(self, zserio_context: RulesRoadLocationTransitionAttributeMap.ZserioPackingContext, bitposition: int) -> int:
        end_bitposition = bitposition
    ...
    def read(self, zserio_reader: zserio.BitStreamReader) -> None:
        self._attribute_type_code_ = nds.rules.attributes.rules_transition_attribute_type.RulesTransitionAttributeType.from_reader(zserio_reader)
    ...
    def read_packed(self, zserio_context: RulesRoadLocationTransitionAttributeMap.ZserioPackingContext, zserio_reader: zserio.BitStreamReader) -> None:
        self._attribute_type_code_ = nds.rules.attributes.rules_transition_attribute_type.RulesTransitionAttributeType.from_reader_packed(zserio_context.attribute_type_code, zserio_reader)
    ...
    def write(self, zserio_writer: zserio.BitStreamWriter) -> None:
        ...
        if len(self._feature_references_) != (self._feature_):
            raise zserio.PythonRuntimeException("Wrong array length for field RulesRoadLocationTransitionAttributeMap.featureReferences: "
        ...
        if len(self._feature_validities_) != (self._feature_):
            raise zserio.PythonRuntimeException("Wrong array length for field RulesRoadLocationTransitionAttributeMap.featureValidities: "
        ...
        if len(self._feature_value_ptr_) != (self._feature_):
            raise zserio.PythonRuntimeException("Wrong array length for field RulesRoadLocationTransitionAttributeMap.featureValuePtr: "
        ...
        if len(self._attribute_values_) != (self._attribute_):
            raise zserio.PythonRuntimeException("Wrong array length for field RulesRoadLocationTransitionAttributeMap.attributeValues: "
        ...
        if len(self._attribute_properties_) != (self._attribute_):
            raise zserio.PythonRuntimeException("Wrong array length for field RulesRoadLocationTransitionAttributeMap.attributeProperties: "
        ...
        if len(self._attribute_conditions_) != (self._attribute_):
            raise zserio.PythonRuntimeException("Wrong array length for field RulesRoadLocationTransitionAttributeMap.attributeConditions: "
                                                f"{len(self._attribute_conditions_)} != {self._attribute_}!")
        self._attribute_conditions_.write_packed(zserio_writer)

    def write_packed(self, zserio_context: RulesRoadLocationTransitionAttributeMap.ZserioPackingContext,
    ...
    class _ZserioElementFactory_attribute_values:
        ...
        def create(self, zserio_reader: zserio.BitStreamReader, zserio_index: int) -> nds.rules.instantiations.rules_transition_attribute.RulesTransitionAttribute:
            del zserio_index
            return nds.rules.instantiations.rules_transition_attribute.RulesTransitionAttribute.from_reader(zserio_reader, self._owner._attribute_type_code_)

        @staticmethod
        def create_packing_context() -> nds.rules.instantiations.rules_transition_attribute.RulesTransitionAttribute.ZserioPackingContext:
            return nds.rules.instantiations.rules_transition_attribute.RulesTransitionAttribute.ZserioPackingContext()

        def create_packed(self, zserio_context: nds.rules.instantiations.rules_transition_attribute.RulesTransitionAttribute.ZserioPackingContext,
                          zserio_reader: zserio.BitStreamReader, zserio_index: int) -> nds.rules.instantiations.rules_transition_attribute.RulesTransitionAttribute:
            del zserio_index
            return nds.rules.instantiations.rules_transition_attribute.RulesTransitionAttribute.from_reader_packed(zserio_context, zserio_reader, self._owner._attribute_type_code_)
