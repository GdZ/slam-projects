...
import nds.rules.instantiations.rules_lane_position_attribute_set

class RulesIndirectLanePositionAttributeSetMap:
    def __init__(
            self,
            coord_shift_: nds.core.geometry.coord_shift.CoordShift,
            attribute_set_: typing.Union[nds.rules.instantiations.rules_lane_position_attribute_set.RulesLanePositionAttributeSet, None] = None,
            ...
            validities_: typing.List[nds.lane.reference.types.lane_group_position_validity.LaneGroupPositionValidity] = None) -> None:
    ...
    @classmethod
    def from_reader(
            cls: typing.Type['RulesIndirectLanePositionAttributeSetMap'],
            zserio_reader: zserio.BitStreamReader,
            coord_shift_: nds.core.geometry.coord_shift.CoordShift) -> 'RulesIndirectLanePositionAttributeSetMap':
    ...
    def from_reader_packed(
            cls: typing.Type['RulesIndirectLanePositionAttributeSetMap'],
            zserio_context: RulesIndirectLanePositionAttributeSetMap.ZserioPackingContext,
            zserio_reader: zserio.BitStreamReader,
            coord_shift_: nds.core.geometry.coord_shift.CoordShift) -> 'RulesIndirectLanePositionAttributeSetMap':
        self = object.__new__(cls)
        self._coord_shift_ = coord_shift_
    ...
    def __eq__(self, other: object) -> bool:
        if isinstance(other, RulesIndirectLanePositionAttributeSetMap):
    ...
    @property
    def attribute_set(self) -> typing.Union[nds.rules.instantiations.rules_lane_position_attribute_set.RulesLanePositionAttributeSet, None]:
        return self._attribute_set_

    @attribute_set.setter
    def attribute_set(self, attribute_set_: typing.Union[nds.rules.instantiations.rules_lane_position_attribute_set.RulesLanePositionAttributeSet, None]) -> None:
        self._attribute_set_ = attribute_set_
    ...
    @property
    def validities(self) -> typing.List[nds.lane.reference.types.lane_group_position_validity.LaneGroupPositionValidity]:
        return self._validities_.raw_array

    @validities.setter
    def validities(self, validities_: typing.List[nds.lane.reference.types.lane_group_position_validity.LaneGroupPositionValidity]) -> None:
        self._validities_ = zserio.array.Array(zserio.array.ObjectArrayTraits(self._ZserioElementFactory_validities(self)), validities_)

    def init_packing_context(self, zserio_context: RulesIndirectLanePositionAttributeSetMap.ZserioPackingContext) -> None:
    ...
    def bitsizeof_packed(self, zserio_context: RulesIndirectLanePositionAttributeSetMap.ZserioPackingContext, bitposition: int = 0) -> int:
        end_bitposition = bitposition
    ...
    def initialize_offsets_packed(self, zserio_context: RulesIndirectLanePositionAttributeSetMap.ZserioPackingContext, bitposition: int) -> int:
        end_bitposition = bitposition
    ...
    def read(self, zserio_reader: zserio.BitStreamReader) -> None:
        self._attribute_set_ = nds.rules.instantiations.rules_lane_position_attribute_set.RulesLanePositionAttributeSet.from_reader(zserio_reader)
    ...
    def read_packed(self, zserio_context: RulesIndirectLanePositionAttributeSetMap.ZserioPackingContext, zserio_reader: zserio.BitStreamReader) -> None:
        self._attribute_set_ = nds.rules.instantiations.rules_lane_position_attribute_set.RulesLanePositionAttributeSet.from_reader_packed(zserio_context.attribute_set, zserio_reader)
    ...
    def write(self, zserio_writer: zserio.BitStreamWriter) -> None:
        ...
        if len(self._references_) != (self._feature_):
            raise zserio.PythonRuntimeException("Wrong array length for field RulesIndirectLanePositionAttributeSetMap.references: "
        ...
        if len(self._validities_) != (self._feature_):
            raise zserio.PythonRuntimeException("Wrong array length for field RulesIndirectLanePositionAttributeSetMap.validities: "
                                                f"{len(self._validities_)} != {self._feature_}!")
        self._validities_.write_packed(zserio_writer)

    def write_packed(self, zserio_context: RulesIndirectLanePositionAttributeSetMap.ZserioPackingContext,
    ...
    class ZserioPackingContext:
        def __init__(self):
            self._attribute_set_ = nds.rules.instantiations.rules_lane_position_attribute_set.RulesLanePositionAttributeSet.ZserioPackingContext()
