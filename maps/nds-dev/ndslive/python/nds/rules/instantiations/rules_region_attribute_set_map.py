...
import nds.rules.instantiations.rules_region_attribute_set
...
class RulesRegionAttributeSetMap:
    def __init__(
            ...
            attribute_set_: typing.Union[nds.rules.instantiations.rules_region_attribute_set.RulesRegionAttributeSet, None] = None,
            feature_: nds.core.attributemap.feature_iterator.FeatureIterator = nds.core.attributemap.feature_iterator.FeatureIterator(),
            references_: typing.List[nds.core.types.region_id.RegionId] = None,
            validities_: typing.List[nds.rules.types.region_validity.RegionValidity] = None) -> None:
        self._coord_shift_ = coord_shift_
        self._attribute_set_ = attribute_set_
        self._feature_ = feature_
        self._references_ = zserio.array.Array(zserio.array.VarUInt32ArrayTraits(), references_)
    ...
    @classmethod
    def from_reader(
            cls: typing.Type['RulesRegionAttributeSetMap'],
            zserio_reader: zserio.BitStreamReader,
            coord_shift_: nds.core.geometry.coord_shift.CoordShift) -> 'RulesRegionAttributeSetMap':
    ...
    def from_reader_packed(
            cls: typing.Type['RulesRegionAttributeSetMap'],
            zserio_context: RulesRegionAttributeSetMap.ZserioPackingContext,
            zserio_reader: zserio.BitStreamReader,
            coord_shift_: nds.core.geometry.coord_shift.CoordShift) -> 'RulesRegionAttributeSetMap':
        self = object.__new__(cls)
        self._coord_shift_ = coord_shift_
    ...
    def __eq__(self, other: object) -> bool:
        if isinstance(other, RulesRegionAttributeSetMap):
    ...
    @property
    def attribute_set(self) -> typing.Union[nds.rules.instantiations.rules_region_attribute_set.RulesRegionAttributeSet, None]:
        return self._attribute_set_

    @attribute_set.setter
    def attribute_set(self, attribute_set_: typing.Union[nds.rules.instantiations.rules_region_attribute_set.RulesRegionAttributeSet, None]) -> None:
        self._attribute_set_ = attribute_set_
    ...
    @property
    def references(self) -> typing.List[nds.core.types.region_id.RegionId]:
        return self._references_.raw_array

    @references.setter
    def references(self, references_: typing.List[nds.core.types.region_id.RegionId]) -> None:
        self._references_ = zserio.array.Array(zserio.array.VarUInt32ArrayTraits(), references_)

    @property
    def validities(self) -> typing.List[nds.rules.types.region_validity.RegionValidity]:
        return self._validities_.raw_array

    @validities.setter
    def validities(self, validities_: typing.List[nds.rules.types.region_validity.RegionValidity]) -> None:
        self._validities_ = zserio.array.Array(zserio.array.ObjectArrayTraits(self._ZserioElementFactory_validities(self)), validities_)

    def init_packing_context(self, zserio_context: RulesRegionAttributeSetMap.ZserioPackingContext) -> None:
    ...
    def bitsizeof_packed(self, zserio_context: RulesRegionAttributeSetMap.ZserioPackingContext, bitposition: int = 0) -> int:
        end_bitposition = bitposition
    ...
    def initialize_offsets_packed(self, zserio_context: RulesRegionAttributeSetMap.ZserioPackingContext, bitposition: int) -> int:
        end_bitposition = bitposition
    ...
    def read(self, zserio_reader: zserio.BitStreamReader) -> None:
        self._attribute_set_ = nds.rules.instantiations.rules_region_attribute_set.RulesRegionAttributeSet.from_reader(zserio_reader)
        self._feature_ = zserio_reader.read_varsize()
        self._references_ = zserio.array.Array.from_reader_packed(zserio.array.VarUInt32ArrayTraits(), zserio_reader, self._feature_)
    ...
    def read_packed(self, zserio_context: RulesRegionAttributeSetMap.ZserioPackingContext, zserio_reader: zserio.BitStreamReader) -> None:
        self._attribute_set_ = nds.rules.instantiations.rules_region_attribute_set.RulesRegionAttributeSet.from_reader_packed(zserio_context.attribute_set, zserio_reader)
    ...
    def write(self, zserio_writer: zserio.BitStreamWriter) -> None:
        ...
        if len(self._references_) != (self._feature_):
            raise zserio.PythonRuntimeException("Wrong array length for field RulesRegionAttributeSetMap.references: "
        ...
        if len(self._validities_) != (self._feature_):
            raise zserio.PythonRuntimeException("Wrong array length for field RulesRegionAttributeSetMap.validities: "
                                                f"{len(self._validities_)} != {self._feature_}!")
        self._validities_.write_packed(zserio_writer)

    def write_packed(self, zserio_context: RulesRegionAttributeSetMap.ZserioPackingContext,
    ...
    class ZserioPackingContext:
        def __init__(self):
            self._attribute_set_ = nds.rules.instantiations.rules_region_attribute_set.RulesRegionAttributeSet.ZserioPackingContext()
