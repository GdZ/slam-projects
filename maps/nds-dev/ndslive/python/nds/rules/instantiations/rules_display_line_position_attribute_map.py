...
import nds.display.reference.types.display_line_position_validity
...
import nds.rules.instantiations.rules_display_line_position_attribute
import nds.rules.instantiations.rules_property_list

class RulesDisplayLinePositionAttributeMap:
    def __init__(
            self,
            coord_shift_: nds.core.geometry.coord_shift.CoordShift,
            attribute_type_code_: typing.Union[nds.rules.attributes.rules_display_line_position_attribute_type.RulesDisplayLinePositionAttributeType, None] = None,
            ...
            feature_validities_: typing.List[nds.display.reference.types.display_line_position_validity.DisplayLinePositionValidity] = None,
            ...
            attribute_values_: typing.List[nds.rules.instantiations.rules_display_line_position_attribute.RulesDisplayLinePositionAttribute] = None,
            attribute_properties_: typing.List[nds.rules.instantiations.rules_property_list.RulesPropertyList] = None,
    ...
    @classmethod
    def from_reader(
            cls: typing.Type['RulesDisplayLinePositionAttributeMap'],
            zserio_reader: zserio.BitStreamReader,
            coord_shift_: nds.core.geometry.coord_shift.CoordShift) -> 'RulesDisplayLinePositionAttributeMap':
    ...
    def from_reader_packed(
            cls: typing.Type['RulesDisplayLinePositionAttributeMap'],
            zserio_context: RulesDisplayLinePositionAttributeMap.ZserioPackingContext,
            zserio_reader: zserio.BitStreamReader,
            coord_shift_: nds.core.geometry.coord_shift.CoordShift) -> 'RulesDisplayLinePositionAttributeMap':
        self = object.__new__(cls)
        self._coord_shift_ = coord_shift_
    ...
    def __eq__(self, other: object) -> bool:
        if isinstance(other, RulesDisplayLinePositionAttributeMap):
    ...
    @property
    def attribute_type_code(self) -> typing.Union[nds.rules.attributes.rules_display_line_position_attribute_type.RulesDisplayLinePositionAttributeType, None]:
        return self._attribute_type_code_

    @attribute_type_code.setter
    def attribute_type_code(self, attribute_type_code_: typing.Union[nds.rules.attributes.rules_display_line_position_attribute_type.RulesDisplayLinePositionAttributeType, None]) -> None:
        self._attribute_type_code_ = attribute_type_code_
    ...
    @property
    def feature_validities(self) -> typing.List[nds.display.reference.types.display_line_position_validity.DisplayLinePositionValidity]:
        return self._feature_validities_.raw_array

    @feature_validities.setter
    def feature_validities(self, feature_validities_: typing.List[nds.display.reference.types.display_line_position_validity.DisplayLinePositionValidity]) -> None:
        self._feature_validities_ = zserio.array.Array(zserio.array.ObjectArrayTraits(self._ZserioElementFactory_feature_validities(self)), feature_validities_)
    ...
    @property
    def attribute_values(self) -> typing.List[nds.rules.instantiations.rules_display_line_position_attribute.RulesDisplayLinePositionAttribute]:
        return self._attribute_values_.raw_array

    @attribute_values.setter
    def attribute_values(self, attribute_values_: typing.List[nds.rules.instantiations.rules_display_line_position_attribute.RulesDisplayLinePositionAttribute]) -> None:
        self._attribute_values_ = zserio.array.Array(zserio.array.ObjectArrayTraits(self._ZserioElementFactory_attribute_values(self)), attribute_values_)

    @property
    def attribute_properties(self) -> typing.List[nds.rules.instantiations.rules_property_list.RulesPropertyList]:
        return self._attribute_properties_.raw_array

    @attribute_properties.setter
    def attribute_properties(self, attribute_properties_: typing.List[nds.rules.instantiations.rules_property_list.RulesPropertyList]) -> None:
        self._attribute_properties_ = zserio.array.Array(zserio.array.ObjectArrayTraits(self._ZserioElementFactory_attribute_properties()), attribute_properties_)
    ...
    def init_packing_context(self, zserio_context: RulesDisplayLinePositionAttributeMap.ZserioPackingContext) -> None:
    ...
    def bitsizeof_packed(self, zserio_context: RulesDisplayLinePositionAttributeMap.ZserioPackingContext, bitposition: int = 0) -> int:
        end_bitposition = bitposition
    ...
    def initialize_offsets_packed(self, zserio_context: RulesDisplayLinePositionAttributeMap.ZserioPackingContext, bitposition: int) -> int:
        end_bitposition = bitposition
    ...
    def read(self, zserio_reader: zserio.BitStreamReader) -> None:
        self._attribute_type_code_ = nds.rules.attributes.rules_display_line_position_attribute_type.RulesDisplayLinePositionAttributeType.from_reader(zserio_reader)
    ...
    def read_packed(self, zserio_context: RulesDisplayLinePositionAttributeMap.ZserioPackingContext, zserio_reader: zserio.BitStreamReader) -> None:
        self._attribute_type_code_ = nds.rules.attributes.rules_display_line_position_attribute_type.RulesDisplayLinePositionAttributeType.from_reader_packed(zserio_context.attribute_type_code, zserio_reader)
    ...
    def write(self, zserio_writer: zserio.BitStreamWriter) -> None:
        ...
        if len(self._feature_references_) != (self._feature_):
            raise zserio.PythonRuntimeException("Wrong array length for field RulesDisplayLinePositionAttributeMap.featureReferences: "
        ...
        if len(self._feature_validities_) != (self._feature_):
            raise zserio.PythonRuntimeException("Wrong array length for field RulesDisplayLinePositionAttributeMap.featureValidities: "
        ...
        if len(self._feature_value_ptr_) != (self._feature_):
            raise zserio.PythonRuntimeException("Wrong array length for field RulesDisplayLinePositionAttributeMap.featureValuePtr: "
        ...
        if len(self._attribute_values_) != (self._attribute_):
            raise zserio.PythonRuntimeException("Wrong array length for field RulesDisplayLinePositionAttributeMap.attributeValues: "
        ...
        if len(self._attribute_properties_) != (self._attribute_):
            raise zserio.PythonRuntimeException("Wrong array length for field RulesDisplayLinePositionAttributeMap.attributeProperties: "
        ...
        if len(self._attribute_conditions_) != (self._attribute_):
            raise zserio.PythonRuntimeException("Wrong array length for field RulesDisplayLinePositionAttributeMap.attributeConditions: "
                                                f"{len(self._attribute_conditions_)} != {self._attribute_}!")
        self._attribute_conditions_.write_packed(zserio_writer)

    def write_packed(self, zserio_context: RulesDisplayLinePositionAttributeMap.ZserioPackingContext,
    ...
    class _ZserioElementFactory_feature_validities:
        ...
        def create(self, zserio_reader: zserio.BitStreamReader, zserio_index: int) -> nds.display.reference.types.display_line_position_validity.DisplayLinePositionValidity:
            del zserio_index
            return nds.display.reference.types.display_line_position_validity.DisplayLinePositionValidity.from_reader(zserio_reader, self._owner._coord_shift_)

        @staticmethod
        def create_packing_context() -> nds.display.reference.types.display_line_position_validity.DisplayLinePositionValidity.ZserioPackingContext:
            return nds.display.reference.types.display_line_position_validity.DisplayLinePositionValidity.ZserioPackingContext()

        def create_packed(self, zserio_context: nds.display.reference.types.display_line_position_validity.DisplayLinePositionValidity.ZserioPackingContext,
                          zserio_reader: zserio.BitStreamReader, zserio_index: int) -> nds.display.reference.types.display_line_position_validity.DisplayLinePositionValidity:
            del zserio_index
            return nds.display.reference.types.display_line_position_validity.DisplayLinePositionValidity.from_reader_packed(zserio_context, zserio_reader, self._owner._coord_shift_)
    ...
    class _ZserioElementFactory_attribute_values:
        ...
        def create(self, zserio_reader: zserio.BitStreamReader, zserio_index: int) -> nds.rules.instantiations.rules_display_line_position_attribute.RulesDisplayLinePositionAttribute:
            del zserio_index
            return nds.rules.instantiations.rules_display_line_position_attribute.RulesDisplayLinePositionAttribute.from_reader(zserio_reader, self._owner._attribute_type_code_)

        @staticmethod
        def create_packing_context() -> nds.rules.instantiations.rules_display_line_position_attribute.RulesDisplayLinePositionAttribute.ZserioPackingContext:
            return nds.rules.instantiations.rules_display_line_position_attribute.RulesDisplayLinePositionAttribute.ZserioPackingContext()

        def create_packed(self, zserio_context: nds.rules.instantiations.rules_display_line_position_attribute.RulesDisplayLinePositionAttribute.ZserioPackingContext,
                          zserio_reader: zserio.BitStreamReader, zserio_index: int) -> nds.rules.instantiations.rules_display_line_position_attribute.RulesDisplayLinePositionAttribute:
            del zserio_index
            return nds.rules.instantiations.rules_display_line_position_attribute.RulesDisplayLinePositionAttribute.from_reader_packed(zserio_context, zserio_reader, self._owner._attribute_type_code_)

    class _ZserioElementFactory_attribute_properties:
        IS_OBJECT_PACKABLE = True

        @staticmethod
        def create(zserio_reader: zserio.BitStreamReader, zserio_index: int) -> nds.rules.instantiations.rules_property_list.RulesPropertyList:
            del zserio_index
            return nds.rules.instantiations.rules_property_list.RulesPropertyList.from_reader(zserio_reader)

        @staticmethod
        def create_packing_context() -> nds.rules.instantiations.rules_property_list.RulesPropertyList.ZserioPackingContext:
            return nds.rules.instantiations.rules_property_list.RulesPropertyList.ZserioPackingContext()

        @staticmethod
        def create_packed(zserio_context: nds.rules.instantiations.rules_property_list.RulesPropertyList.ZserioPackingContext,
                          zserio_reader: zserio.BitStreamReader, zserio_index: int) -> nds.rules.instantiations.rules_property_list.RulesPropertyList:
            del zserio_index
            return nds.rules.instantiations.rules_property_list.RulesPropertyList.from_reader_packed(zserio_context, zserio_reader)
