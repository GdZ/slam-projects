...
import nds.rules.attributes.rules_lane_position_attribute_value
...
class RulesLanePositionFullAttribute:
    def __init__(
            ...
            attribute_value_: typing.Union[nds.rules.attributes.rules_lane_position_attribute_value.RulesLanePositionAttributeValue, None] = None,
    ...
    @classmethod
    def from_reader(
            cls: typing.Type['RulesLanePositionFullAttribute'],
            zserio_reader: zserio.BitStreamReader) -> 'RulesLanePositionFullAttribute':
    ...
    def from_reader_packed(
            cls: typing.Type['RulesLanePositionFullAttribute'],
            zserio_context: RulesLanePositionFullAttribute.ZserioPackingContext,
            zserio_reader: zserio.BitStreamReader) -> 'RulesLanePositionFullAttribute':
        self = object.__new__(cls)
    ...
    def __eq__(self, other: object) -> bool:
        if isinstance(other, RulesLanePositionFullAttribute):
    ...
    @property
    def attribute_value(self) -> typing.Union[nds.rules.attributes.rules_lane_position_attribute_value.RulesLanePositionAttributeValue, None]:
        return self._attribute_value_

    @attribute_value.setter
    def attribute_value(self, attribute_value_: typing.Union[nds.rules.attributes.rules_lane_position_attribute_value.RulesLanePositionAttributeValue, None]) -> None:
        self._attribute_value_ = attribute_value_
    ...
    def init_packing_context(self, zserio_context: RulesLanePositionFullAttribute.ZserioPackingContext) -> None:
    ...
    def bitsizeof_packed(self, zserio_context: RulesLanePositionFullAttribute.ZserioPackingContext, bitposition: int = 0) -> int:
        end_bitposition = bitposition
    ...
    def initialize_offsets_packed(self, zserio_context: RulesLanePositionFullAttribute.ZserioPackingContext, bitposition: int) -> int:
        end_bitposition = bitposition
    ...
    def read(self, zserio_reader: zserio.BitStreamReader) -> None:
        ...
        self._attribute_value_ = nds.rules.attributes.rules_lane_position_attribute_value.RulesLanePositionAttributeValue.from_reader(zserio_reader, self._attribute_type_code_)
    ...
    def read_packed(self, zserio_context: RulesLanePositionFullAttribute.ZserioPackingContext, zserio_reader: zserio.BitStreamReader) -> None:
        ...
        self._attribute_value_ = nds.rules.attributes.rules_lane_position_attribute_value.RulesLanePositionAttributeValue.from_reader_packed(zserio_context.attribute_value, zserio_reader, self._attribute_type_code_)
    ...
    def write(self, zserio_writer: zserio.BitStreamWriter) -> None:
        ...
        if self._attribute_value_.type is not (self._attribute_type_code_):
            raise zserio.PythonRuntimeException("Wrong parameter type for field RulesLanePositionFullAttribute.attributeValue: "
    ...
    def write_packed(self, zserio_context: RulesLanePositionFullAttribute.ZserioPackingContext,
    ...
    class ZserioPackingContext:
        def __init__(self):
            ...
            self._attribute_value_ = nds.rules.attributes.rules_lane_position_attribute_value.RulesLanePositionAttributeValue.ZserioPackingContext()
