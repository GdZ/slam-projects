...
import nds.rules.instantiations.rules_region_attribute
import nds.rules.types.region_validity

class RulesRegionAttributeMap:
    def __init__(
            self,
            coord_shift_: nds.core.geometry.coord_shift.CoordShift,
            attribute_type_code_: typing.Union[nds.rules.attributes.rules_region_attribute_type.RulesRegionAttributeType, None] = None,
            feature_: nds.core.attributemap.feature_iterator.FeatureIterator = nds.core.attributemap.feature_iterator.FeatureIterator(),
            feature_references_: typing.List[nds.core.types.region_id.RegionId] = None,
            feature_validities_: typing.List[nds.rules.types.region_validity.RegionValidity] = None,
            ...
            attribute_values_: typing.List[nds.rules.instantiations.rules_region_attribute.RulesRegionAttribute] = None,
        ...
        self._feature_references_ = zserio.array.Array(zserio.array.VarUInt32ArrayTraits(), feature_references_)
    ...
    @classmethod
    def from_reader(
            cls: typing.Type['RulesRegionAttributeMap'],
            zserio_reader: zserio.BitStreamReader,
            coord_shift_: nds.core.geometry.coord_shift.CoordShift) -> 'RulesRegionAttributeMap':
    ...
    def from_reader_packed(
            cls: typing.Type['RulesRegionAttributeMap'],
            zserio_context: RulesRegionAttributeMap.ZserioPackingContext,
            zserio_reader: zserio.BitStreamReader,
            coord_shift_: nds.core.geometry.coord_shift.CoordShift) -> 'RulesRegionAttributeMap':
        self = object.__new__(cls)
        self._coord_shift_ = coord_shift_
    ...
    def __eq__(self, other: object) -> bool:
        if isinstance(other, RulesRegionAttributeMap):
    ...
    @property
    def attribute_type_code(self) -> typing.Union[nds.rules.attributes.rules_region_attribute_type.RulesRegionAttributeType, None]:
        return self._attribute_type_code_

    @attribute_type_code.setter
    def attribute_type_code(self, attribute_type_code_: typing.Union[nds.rules.attributes.rules_region_attribute_type.RulesRegionAttributeType, None]) -> None:
        self._attribute_type_code_ = attribute_type_code_
    ...
    @property
    def feature_references(self) -> typing.List[nds.core.types.region_id.RegionId]:
        return self._feature_references_.raw_array

    @feature_references.setter
    def feature_references(self, feature_references_: typing.List[nds.core.types.region_id.RegionId]) -> None:
        self._feature_references_ = zserio.array.Array(zserio.array.VarUInt32ArrayTraits(), feature_references_)

    @property
    def feature_validities(self) -> typing.List[nds.rules.types.region_validity.RegionValidity]:
        return self._feature_validities_.raw_array

    @feature_validities.setter
    def feature_validities(self, feature_validities_: typing.List[nds.rules.types.region_validity.RegionValidity]) -> None:
        self._feature_validities_ = zserio.array.Array(zserio.array.ObjectArrayTraits(self._ZserioElementFactory_feature_validities(self)), feature_validities_)
    ...
    @property
    def attribute_values(self) -> typing.List[nds.rules.instantiations.rules_region_attribute.RulesRegionAttribute]:
        return self._attribute_values_.raw_array

    @attribute_values.setter
    def attribute_values(self, attribute_values_: typing.List[nds.rules.instantiations.rules_region_attribute.RulesRegionAttribute]) -> None:
        self._attribute_values_ = zserio.array.Array(zserio.array.ObjectArrayTraits(self._ZserioElementFactory_attribute_values(self)), attribute_values_)
    ...
    def init_packing_context(self, zserio_context: RulesRegionAttributeMap.ZserioPackingContext) -> None:
    ...
    def bitsizeof_packed(self, zserio_context: RulesRegionAttributeMap.ZserioPackingContext, bitposition: int = 0) -> int:
        end_bitposition = bitposition
    ...
    def initialize_offsets_packed(self, zserio_context: RulesRegionAttributeMap.ZserioPackingContext, bitposition: int) -> int:
        end_bitposition = bitposition
    ...
    def read(self, zserio_reader: zserio.BitStreamReader) -> None:
        self._attribute_type_code_ = nds.rules.attributes.rules_region_attribute_type.RulesRegionAttributeType.from_reader(zserio_reader)
        zserio_reader.alignto(8)
        self._feature_ = zserio_reader.read_varsize()
        self._feature_references_ = zserio.array.Array.from_reader_packed(zserio.array.VarUInt32ArrayTraits(), zserio_reader, self._feature_)
        zserio_reader.alignto(8)
    ...
    def read_packed(self, zserio_context: RulesRegionAttributeMap.ZserioPackingContext, zserio_reader: zserio.BitStreamReader) -> None:
        self._attribute_type_code_ = nds.rules.attributes.rules_region_attribute_type.RulesRegionAttributeType.from_reader_packed(zserio_context.attribute_type_code, zserio_reader)
    ...
    def write(self, zserio_writer: zserio.BitStreamWriter) -> None:
        ...
        if len(self._feature_references_) != (self._feature_):
            raise zserio.PythonRuntimeException("Wrong array length for field RulesRegionAttributeMap.featureReferences: "
        ...
        if len(self._feature_validities_) != (self._feature_):
            raise zserio.PythonRuntimeException("Wrong array length for field RulesRegionAttributeMap.featureValidities: "
        ...
        if len(self._feature_value_ptr_) != (self._feature_):
            raise zserio.PythonRuntimeException("Wrong array length for field RulesRegionAttributeMap.featureValuePtr: "
        ...
        if len(self._attribute_values_) != (self._attribute_):
            raise zserio.PythonRuntimeException("Wrong array length for field RulesRegionAttributeMap.attributeValues: "
        ...
        if len(self._attribute_properties_) != (self._attribute_):
            raise zserio.PythonRuntimeException("Wrong array length for field RulesRegionAttributeMap.attributeProperties: "
        ...
        if len(self._attribute_conditions_) != (self._attribute_):
            raise zserio.PythonRuntimeException("Wrong array length for field RulesRegionAttributeMap.attributeConditions: "
                                                f"{len(self._attribute_conditions_)} != {self._attribute_}!")
        self._attribute_conditions_.write_packed(zserio_writer)

    def write_packed(self, zserio_context: RulesRegionAttributeMap.ZserioPackingContext,
    ...
    class _ZserioElementFactory_feature_validities:
        ...
        def create(self, zserio_reader: zserio.BitStreamReader, zserio_index: int) -> nds.rules.types.region_validity.RegionValidity:
            del zserio_index
            return nds.rules.types.region_validity.RegionValidity.from_reader(zserio_reader, self._owner._coord_shift_)

        @staticmethod
        def create_packing_context() -> nds.rules.types.region_validity.RegionValidity.ZserioPackingContext:
            return nds.rules.types.region_validity.RegionValidity.ZserioPackingContext()

        def create_packed(self, zserio_context: nds.rules.types.region_validity.RegionValidity.ZserioPackingContext,
                          zserio_reader: zserio.BitStreamReader, zserio_index: int) -> nds.rules.types.region_validity.RegionValidity:
            del zserio_index
            return nds.rules.types.region_validity.RegionValidity.from_reader_packed(zserio_context, zserio_reader, self._owner._coord_shift_)
    ...
    class _ZserioElementFactory_attribute_values:
        ...
        def create(self, zserio_reader: zserio.BitStreamReader, zserio_index: int) -> nds.rules.instantiations.rules_region_attribute.RulesRegionAttribute:
            del zserio_index
            return nds.rules.instantiations.rules_region_attribute.RulesRegionAttribute.from_reader(zserio_reader, self._owner._attribute_type_code_)

        @staticmethod
        def create_packing_context() -> nds.rules.instantiations.rules_region_attribute.RulesRegionAttribute.ZserioPackingContext:
            return nds.rules.instantiations.rules_region_attribute.RulesRegionAttribute.ZserioPackingContext()

        def create_packed(self, zserio_context: nds.rules.instantiations.rules_region_attribute.RulesRegionAttribute.ZserioPackingContext,
                          zserio_reader: zserio.BitStreamReader, zserio_index: int) -> nds.rules.instantiations.rules_region_attribute.RulesRegionAttribute:
            del zserio_index
            return nds.rules.instantiations.rules_region_attribute.RulesRegionAttribute.from_reader_packed(zserio_context, zserio_reader, self._owner._attribute_type_code_)
