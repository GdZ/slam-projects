...
import nds.rules.instantiations.rules_lane_position_attribute
import nds.rules.instantiations.rules_property_list

class RulesIndirectLanePositionAttributeMap:
    def __init__(
            self,
            coord_shift_: nds.core.geometry.coord_shift.CoordShift,
            attribute_type_code_: typing.Union[nds.rules.attributes.rules_lane_position_attribute_type.RulesLanePositionAttributeType, None] = None,
            ...
            attribute_values_: typing.List[nds.rules.instantiations.rules_lane_position_attribute.RulesLanePositionAttribute] = None,
    ...
    @classmethod
    def from_reader(
            cls: typing.Type['RulesIndirectLanePositionAttributeMap'],
            zserio_reader: zserio.BitStreamReader,
            coord_shift_: nds.core.geometry.coord_shift.CoordShift) -> 'RulesIndirectLanePositionAttributeMap':
    ...
    def from_reader_packed(
            cls: typing.Type['RulesIndirectLanePositionAttributeMap'],
            zserio_context: RulesIndirectLanePositionAttributeMap.ZserioPackingContext,
            zserio_reader: zserio.BitStreamReader,
            coord_shift_: nds.core.geometry.coord_shift.CoordShift) -> 'RulesIndirectLanePositionAttributeMap':
        self = object.__new__(cls)
        self._coord_shift_ = coord_shift_
    ...
    def __eq__(self, other: object) -> bool:
        if isinstance(other, RulesIndirectLanePositionAttributeMap):
    ...
    @property
    def attribute_type_code(self) -> typing.Union[nds.rules.attributes.rules_lane_position_attribute_type.RulesLanePositionAttributeType, None]:
        return self._attribute_type_code_

    @attribute_type_code.setter
    def attribute_type_code(self, attribute_type_code_: typing.Union[nds.rules.attributes.rules_lane_position_attribute_type.RulesLanePositionAttributeType, None]) -> None:
        self._attribute_type_code_ = attribute_type_code_
    ...
    @property
    def attribute_values(self) -> typing.List[nds.rules.instantiations.rules_lane_position_attribute.RulesLanePositionAttribute]:
        return self._attribute_values_.raw_array

    @attribute_values.setter
    def attribute_values(self, attribute_values_: typing.List[nds.rules.instantiations.rules_lane_position_attribute.RulesLanePositionAttribute]) -> None:
        self._attribute_values_ = zserio.array.Array(zserio.array.ObjectArrayTraits(self._ZserioElementFactory_attribute_values(self)), attribute_values_)
    ...
    def init_packing_context(self, zserio_context: RulesIndirectLanePositionAttributeMap.ZserioPackingContext) -> None:
    ...
    def bitsizeof_packed(self, zserio_context: RulesIndirectLanePositionAttributeMap.ZserioPackingContext, bitposition: int = 0) -> int:
        end_bitposition = bitposition
    ...
    def initialize_offsets_packed(self, zserio_context: RulesIndirectLanePositionAttributeMap.ZserioPackingContext, bitposition: int) -> int:
        end_bitposition = bitposition
    ...
    def read(self, zserio_reader: zserio.BitStreamReader) -> None:
        self._attribute_type_code_ = nds.rules.attributes.rules_lane_position_attribute_type.RulesLanePositionAttributeType.from_reader(zserio_reader)
    ...
    def read_packed(self, zserio_context: RulesIndirectLanePositionAttributeMap.ZserioPackingContext, zserio_reader: zserio.BitStreamReader) -> None:
        self._attribute_type_code_ = nds.rules.attributes.rules_lane_position_attribute_type.RulesLanePositionAttributeType.from_reader_packed(zserio_context.attribute_type_code, zserio_reader)
    ...
    def write(self, zserio_writer: zserio.BitStreamWriter) -> None:
        ...
        if len(self._feature_references_) != (self._feature_):
            raise zserio.PythonRuntimeException("Wrong array length for field RulesIndirectLanePositionAttributeMap.featureReferences: "
        ...
        if len(self._feature_validities_) != (self._feature_):
            raise zserio.PythonRuntimeException("Wrong array length for field RulesIndirectLanePositionAttributeMap.featureValidities: "
        ...
        if len(self._feature_value_ptr_) != (self._feature_):
            raise zserio.PythonRuntimeException("Wrong array length for field RulesIndirectLanePositionAttributeMap.featureValuePtr: "
        ...
        if len(self._attribute_values_) != (self._attribute_):
            raise zserio.PythonRuntimeException("Wrong array length for field RulesIndirectLanePositionAttributeMap.attributeValues: "
        ...
        if len(self._attribute_properties_) != (self._attribute_):
            raise zserio.PythonRuntimeException("Wrong array length for field RulesIndirectLanePositionAttributeMap.attributeProperties: "
        ...
        if len(self._attribute_conditions_) != (self._attribute_):
            raise zserio.PythonRuntimeException("Wrong array length for field RulesIndirectLanePositionAttributeMap.attributeConditions: "
                                                f"{len(self._attribute_conditions_)} != {self._attribute_}!")
        self._attribute_conditions_.write_packed(zserio_writer)

    def write_packed(self, zserio_context: RulesIndirectLanePositionAttributeMap.ZserioPackingContext,
    ...
    class _ZserioElementFactory_attribute_values:
        ...
        def create(self, zserio_reader: zserio.BitStreamReader, zserio_index: int) -> nds.rules.instantiations.rules_lane_position_attribute.RulesLanePositionAttribute:
            del zserio_index
            return nds.rules.instantiations.rules_lane_position_attribute.RulesLanePositionAttribute.from_reader(zserio_reader, self._owner._attribute_type_code_)

        @staticmethod
        def create_packing_context() -> nds.rules.instantiations.rules_lane_position_attribute.RulesLanePositionAttribute.ZserioPackingContext:
            return nds.rules.instantiations.rules_lane_position_attribute.RulesLanePositionAttribute.ZserioPackingContext()

        def create_packed(self, zserio_context: nds.rules.instantiations.rules_lane_position_attribute.RulesLanePositionAttribute.ZserioPackingContext,
                          zserio_reader: zserio.BitStreamReader, zserio_index: int) -> nds.rules.instantiations.rules_lane_position_attribute.RulesLanePositionAttribute:
            del zserio_index
            return nds.rules.instantiations.rules_lane_position_attribute.RulesLanePositionAttribute.from_reader_packed(zserio_context, zserio_reader, self._owner._attribute_type_code_)
