...
class RoadValidityPosition:
    def __init__(
            ...
            position_indication_: typing.Optional[nds.road.reference.types.percentage_indication.PercentageIndication] = None) -> None:
        self._shift_ = shift_
    ...
    @classmethod
    def from_reader(
            cls: typing.Type['RoadValidityPosition'],
            zserio_reader: zserio.BitStreamReader,
            shift_: nds.core.geometry.coord_shift.CoordShift) -> 'RoadValidityPosition':
    ...
    def from_reader_packed(
            cls: typing.Type['RoadValidityPosition'],
            zserio_context: RoadValidityPosition.ZserioPackingContext,
            zserio_reader: zserio.BitStreamReader,
            shift_: nds.core.geometry.coord_shift.CoordShift) -> 'RoadValidityPosition':
        self = object.__new__(cls)
        self._shift_ = shift_
    ...
    def __eq__(self, other: object) -> bool:
        if isinstance(other, RoadValidityPosition):
    ...
    @property
    def position_indication(self) -> typing.Optional[nds.road.reference.types.percentage_indication.PercentageIndication]:
        return self._position_indication_

    @position_indication.setter
    def position_indication(self, position_indication_: typing.Optional[nds.road.reference.types.percentage_indication.PercentageIndication]) -> None:
        self._position_indication_ = position_indication_
    ...
    def init_packing_context(self, zserio_context: RoadValidityPosition.ZserioPackingContext) -> None:
    ...
    def bitsizeof_packed(self, zserio_context: RoadValidityPosition.ZserioPackingContext, bitposition: int = 0) -> int:
        end_bitposition = bitposition
    ...
    def initialize_offsets_packed(self, zserio_context: RoadValidityPosition.ZserioPackingContext, bitposition: int) -> int:
        end_bitposition = bitposition
    ...
    def read_packed(self, zserio_context: RoadValidityPosition.ZserioPackingContext, zserio_reader: zserio.BitStreamReader) -> None:
    ...
    def write(self, zserio_writer: zserio.BitStreamWriter) -> None:
        ...
        if self._position_.shift != (self._shift_):
            raise zserio.PythonRuntimeException("Wrong parameter shift for field RoadValidityPosition.position: "
    ...
    def write_packed(self, zserio_context: RoadValidityPosition.ZserioPackingContext,
