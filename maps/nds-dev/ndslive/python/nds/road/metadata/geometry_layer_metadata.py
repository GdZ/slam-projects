...
import nds.road.metadata.geometry_layer_type

class GeometryLayerMetadata:
    def __init__(
            self,
            layer_type_: typing.Union[nds.road.metadata.geometry_layer_type.GeometryLayerType, None] = None) -> None:
    ...
    @property
    def layer_type(self) -> typing.Union[nds.road.metadata.geometry_layer_type.GeometryLayerType, None]:
        return self._layer_type_

    @layer_type.setter
    def layer_type(self, layer_type_: typing.Union[nds.road.metadata.geometry_layer_type.GeometryLayerType, None]) -> None:
        self._layer_type_ = layer_type_
    ...
    def read(self, zserio_reader: zserio.BitStreamReader) -> None:
        self._layer_type_ = nds.road.metadata.geometry_layer_type.GeometryLayerType.from_reader(zserio_reader)

    def read_packed(self, zserio_context: GeometryLayerMetadata.ZserioPackingContext, zserio_reader: zserio.BitStreamReader) -> None:
        self._layer_type_ = nds.road.metadata.geometry_layer_type.GeometryLayerType.from_reader_packed(zserio_context.layer_type, zserio_reader)
