...
class AdasTransitionAttributeMetadata:
    def __init__(
            self,
            available_attributes_: typing.List[nds.adas.attributes.adas_transition_attribute_type.AdasTransitionAttributeType] = None,
            available_properties_: typing.List[nds.adas.properties.adas_property_type.AdasPropertyType] = None,
    ...
    @classmethod
    def from_reader(
            cls: typing.Type['AdasTransitionAttributeMetadata'],
            zserio_reader: zserio.BitStreamReader) -> 'AdasTransitionAttributeMetadata':
    ...
    def from_reader_packed(
            cls: typing.Type['AdasTransitionAttributeMetadata'],
            zserio_context: AdasTransitionAttributeMetadata.ZserioPackingContext,
            zserio_reader: zserio.BitStreamReader) -> 'AdasTransitionAttributeMetadata':
        self = object.__new__(cls)
    ...
    def __eq__(self, other: object) -> bool:
        if isinstance(other, AdasTransitionAttributeMetadata):
    ...
    @property
    def available_attributes(self) -> typing.List[nds.adas.attributes.adas_transition_attribute_type.AdasTransitionAttributeType]:
        return self._available_attributes_.raw_array

    @available_attributes.setter
    def available_attributes(self, available_attributes_: typing.List[nds.adas.attributes.adas_transition_attribute_type.AdasTransitionAttributeType]) -> None:
        self._available_attributes_ = zserio.array.Array(zserio.array.ObjectArrayTraits(self._ZserioElementFactory_available_attributes()), available_attributes_, is_auto=True)

    @property
    def available_properties(self) -> typing.List[nds.adas.properties.adas_property_type.AdasPropertyType]:
        return self._available_properties_.raw_array

    @available_properties.setter
    def available_properties(self, available_properties_: typing.List[nds.adas.properties.adas_property_type.AdasPropertyType]) -> None:
        self._available_properties_ = zserio.array.Array(zserio.array.ObjectArrayTraits(self._ZserioElementFactory_available_properties()), available_properties_, is_auto=True)
    ...
    def init_packing_context(self, zserio_context: AdasTransitionAttributeMetadata.ZserioPackingContext) -> None:
    ...
    def bitsizeof_packed(self, zserio_context: AdasTransitionAttributeMetadata.ZserioPackingContext, bitposition: int = 0) -> int:
        end_bitposition = bitposition
        end_bitposition += self._available_attributes_.bitsizeof_packed(end_bitposition)
        end_bitposition += self._available_properties_.bitsizeof_packed(end_bitposition)
    ...
    def initialize_offsets_packed(self, zserio_context: AdasTransitionAttributeMetadata.ZserioPackingContext, bitposition: int) -> int:
        end_bitposition = bitposition
        end_bitposition = self._available_attributes_.initialize_offsets_packed(end_bitposition)
        end_bitposition = self._available_properties_.initialize_offsets_packed(end_bitposition)
    ...
    def read_packed(self, zserio_context: AdasTransitionAttributeMetadata.ZserioPackingContext, zserio_reader: zserio.BitStreamReader) -> None:
        self._available_attributes_ = zserio.array.Array.from_reader_packed(zserio.array.ObjectArrayTraits(self._ZserioElementFactory_available_attributes()), zserio_reader, is_auto=True)
    ...
    def write_packed(self, zserio_context: AdasTransitionAttributeMetadata.ZserioPackingContext,
    ...
    class _ZserioElementFactory_available_attributes:
        ...
        @staticmethod
        def create(zserio_reader: zserio.BitStreamReader, zserio_index: int) -> nds.adas.attributes.adas_transition_attribute_type.AdasTransitionAttributeType:
            del zserio_index
            return nds.adas.attributes.adas_transition_attribute_type.AdasTransitionAttributeType.from_reader(zserio_reader)
        ...
        def create_packed(zserio_context: zserio.array.DeltaContext,
                          zserio_reader: zserio.BitStreamReader, zserio_index: int) -> nds.adas.attributes.adas_transition_attribute_type.AdasTransitionAttributeType:
            del zserio_index
            return nds.adas.attributes.adas_transition_attribute_type.AdasTransitionAttributeType.from_reader_packed(zserio_context, zserio_reader)

    class _ZserioElementFactory_available_properties:
        IS_OBJECT_PACKABLE = True

        @staticmethod
        def create(zserio_reader: zserio.BitStreamReader, zserio_index: int) -> nds.adas.properties.adas_property_type.AdasPropertyType:
            del zserio_index
            return nds.adas.properties.adas_property_type.AdasPropertyType.from_reader(zserio_reader)

        @staticmethod
        def create_packing_context() -> nds.adas.properties.adas_property_type.AdasPropertyType.ZserioPackingContext:
            return nds.adas.properties.adas_property_type.AdasPropertyType.ZserioPackingContext()

        @staticmethod
        def create_packed(zserio_context: nds.adas.properties.adas_property_type.AdasPropertyType.ZserioPackingContext,
                          zserio_reader: zserio.BitStreamReader, zserio_index: int) -> nds.adas.properties.adas_property_type.AdasPropertyType:
            del zserio_index
            return nds.adas.properties.adas_property_type.AdasPropertyType.from_reader_packed(zserio_context, zserio_reader)
