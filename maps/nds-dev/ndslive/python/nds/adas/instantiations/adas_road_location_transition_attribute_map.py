...
import nds.adas.instantiations.adas_property_list
import nds.adas.instantiations.adas_transition_attribute
...
class AdasRoadLocationTransitionAttributeMap:
    def __init__(
            ...
            attribute_type_code_: typing.Union[nds.adas.attributes.adas_transition_attribute_type.AdasTransitionAttributeType, None] = None,
            ...
            attribute_values_: typing.List[nds.adas.instantiations.adas_transition_attribute.AdasTransitionAttribute] = None,
            attribute_properties_: typing.List[nds.adas.instantiations.adas_property_list.AdasPropertyList] = None,
    ...
    @classmethod
    def from_reader(
            cls: typing.Type['AdasRoadLocationTransitionAttributeMap'],
            zserio_reader: zserio.BitStreamReader,
            coord_shift_: nds.core.geometry.coord_shift.CoordShift) -> 'AdasRoadLocationTransitionAttributeMap':
    ...
    def from_reader_packed(
            cls: typing.Type['AdasRoadLocationTransitionAttributeMap'],
            zserio_context: AdasRoadLocationTransitionAttributeMap.ZserioPackingContext,
            zserio_reader: zserio.BitStreamReader,
            coord_shift_: nds.core.geometry.coord_shift.CoordShift) -> 'AdasRoadLocationTransitionAttributeMap':
        self = object.__new__(cls)
        self._coord_shift_ = coord_shift_
    ...
    def __eq__(self, other: object) -> bool:
        if isinstance(other, AdasRoadLocationTransitionAttributeMap):
    ...
    @property
    def attribute_type_code(self) -> typing.Union[nds.adas.attributes.adas_transition_attribute_type.AdasTransitionAttributeType, None]:
        return self._attribute_type_code_

    @attribute_type_code.setter
    def attribute_type_code(self, attribute_type_code_: typing.Union[nds.adas.attributes.adas_transition_attribute_type.AdasTransitionAttributeType, None]) -> None:
        self._attribute_type_code_ = attribute_type_code_
    ...
    @property
    def attribute_values(self) -> typing.List[nds.adas.instantiations.adas_transition_attribute.AdasTransitionAttribute]:
        return self._attribute_values_.raw_array

    @attribute_values.setter
    def attribute_values(self, attribute_values_: typing.List[nds.adas.instantiations.adas_transition_attribute.AdasTransitionAttribute]) -> None:
        self._attribute_values_ = zserio.array.Array(zserio.array.ObjectArrayTraits(self._ZserioElementFactory_attribute_values(self)), attribute_values_)

    @property
    def attribute_properties(self) -> typing.List[nds.adas.instantiations.adas_property_list.AdasPropertyList]:
        return self._attribute_properties_.raw_array

    @attribute_properties.setter
    def attribute_properties(self, attribute_properties_: typing.List[nds.adas.instantiations.adas_property_list.AdasPropertyList]) -> None:
        self._attribute_properties_ = zserio.array.Array(zserio.array.ObjectArrayTraits(self._ZserioElementFactory_attribute_properties()), attribute_properties_)
    ...
    def init_packing_context(self, zserio_context: AdasRoadLocationTransitionAttributeMap.ZserioPackingContext) -> None:
    ...
    def bitsizeof_packed(self, zserio_context: AdasRoadLocationTransitionAttributeMap.ZserioPackingContext, bitposition: int = 0) -> int:
        end_bitposition = bitposition
    ...
    def initialize_offsets_packed(self, zserio_context: AdasRoadLocationTransitionAttributeMap.ZserioPackingContext, bitposition: int) -> int:
        end_bitposition = bitposition
    ...
    def read(self, zserio_reader: zserio.BitStreamReader) -> None:
        self._attribute_type_code_ = nds.adas.attributes.adas_transition_attribute_type.AdasTransitionAttributeType.from_reader(zserio_reader)
    ...
    def read_packed(self, zserio_context: AdasRoadLocationTransitionAttributeMap.ZserioPackingContext, zserio_reader: zserio.BitStreamReader) -> None:
        self._attribute_type_code_ = nds.adas.attributes.adas_transition_attribute_type.AdasTransitionAttributeType.from_reader_packed(zserio_context.attribute_type_code, zserio_reader)
    ...
    def write(self, zserio_writer: zserio.BitStreamWriter) -> None:
        ...
        if len(self._feature_references_) != (self._feature_):
            raise zserio.PythonRuntimeException("Wrong array length for field AdasRoadLocationTransitionAttributeMap.featureReferences: "
        ...
        if len(self._feature_validities_) != (self._feature_):
            raise zserio.PythonRuntimeException("Wrong array length for field AdasRoadLocationTransitionAttributeMap.featureValidities: "
        ...
        if len(self._feature_value_ptr_) != (self._feature_):
            raise zserio.PythonRuntimeException("Wrong array length for field AdasRoadLocationTransitionAttributeMap.featureValuePtr: "
        ...
        if len(self._attribute_values_) != (self._attribute_):
            raise zserio.PythonRuntimeException("Wrong array length for field AdasRoadLocationTransitionAttributeMap.attributeValues: "
        ...
        if len(self._attribute_properties_) != (self._attribute_):
            raise zserio.PythonRuntimeException("Wrong array length for field AdasRoadLocationTransitionAttributeMap.attributeProperties: "
        ...
        if len(self._attribute_conditions_) != (self._attribute_):
            raise zserio.PythonRuntimeException("Wrong array length for field AdasRoadLocationTransitionAttributeMap.attributeConditions: "
                                                f"{len(self._attribute_conditions_)} != {self._attribute_}!")
        self._attribute_conditions_.write_packed(zserio_writer)

    def write_packed(self, zserio_context: AdasRoadLocationTransitionAttributeMap.ZserioPackingContext,
    ...
    class _ZserioElementFactory_attribute_values:
        ...
        def create(self, zserio_reader: zserio.BitStreamReader, zserio_index: int) -> nds.adas.instantiations.adas_transition_attribute.AdasTransitionAttribute:
            del zserio_index
            return nds.adas.instantiations.adas_transition_attribute.AdasTransitionAttribute.from_reader(zserio_reader, self._owner._attribute_type_code_)

        @staticmethod
        def create_packing_context() -> nds.adas.instantiations.adas_transition_attribute.AdasTransitionAttribute.ZserioPackingContext:
            return nds.adas.instantiations.adas_transition_attribute.AdasTransitionAttribute.ZserioPackingContext()

        def create_packed(self, zserio_context: nds.adas.instantiations.adas_transition_attribute.AdasTransitionAttribute.ZserioPackingContext,
                          zserio_reader: zserio.BitStreamReader, zserio_index: int) -> nds.adas.instantiations.adas_transition_attribute.AdasTransitionAttribute:
            del zserio_index
            return nds.adas.instantiations.adas_transition_attribute.AdasTransitionAttribute.from_reader_packed(zserio_context, zserio_reader, self._owner._attribute_type_code_)

    class _ZserioElementFactory_attribute_properties:
        IS_OBJECT_PACKABLE = True

        @staticmethod
        def create(zserio_reader: zserio.BitStreamReader, zserio_index: int) -> nds.adas.instantiations.adas_property_list.AdasPropertyList:
            del zserio_index
            return nds.adas.instantiations.adas_property_list.AdasPropertyList.from_reader(zserio_reader)

        @staticmethod
        def create_packing_context() -> nds.adas.instantiations.adas_property_list.AdasPropertyList.ZserioPackingContext:
            return nds.adas.instantiations.adas_property_list.AdasPropertyList.ZserioPackingContext()

        @staticmethod
        def create_packed(zserio_context: nds.adas.instantiations.adas_property_list.AdasPropertyList.ZserioPackingContext,
                          zserio_reader: zserio.BitStreamReader, zserio_index: int) -> nds.adas.instantiations.adas_property_list.AdasPropertyList:
            del zserio_index
            return nds.adas.instantiations.adas_property_list.AdasPropertyList.from_reader_packed(zserio_context, zserio_reader)
