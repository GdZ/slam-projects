...
import nds.venue.details.instantiations.parking_facility_attribute
...
class ParkingFacilityAttributeMap:
    def __init__(
            ...
            feature_references_: typing.List[nds.venue.reference.types.parking_facility_id.ParkingFacilityId] = None,
            ...
            attribute_values_: typing.List[nds.venue.details.instantiations.parking_facility_attribute.ParkingFacilityAttribute] = None,
    ...
    @classmethod
    def from_reader(
            cls: typing.Type['ParkingFacilityAttributeMap'],
            zserio_reader: zserio.BitStreamReader,
            coord_shift_: nds.core.geometry.coord_shift.CoordShift) -> 'ParkingFacilityAttributeMap':
    ...
    def from_reader_packed(
            cls: typing.Type['ParkingFacilityAttributeMap'],
            zserio_context: ParkingFacilityAttributeMap.ZserioPackingContext,
            zserio_reader: zserio.BitStreamReader,
            coord_shift_: nds.core.geometry.coord_shift.CoordShift) -> 'ParkingFacilityAttributeMap':
        self = object.__new__(cls)
        self._coord_shift_ = coord_shift_
    ...
    def __eq__(self, other: object) -> bool:
        if isinstance(other, ParkingFacilityAttributeMap):
    ...
    @property
    def feature_references(self) -> typing.List[nds.venue.reference.types.parking_facility_id.ParkingFacilityId]:
        return self._feature_references_.raw_array

    @feature_references.setter
    def feature_references(self, feature_references_: typing.List[nds.venue.reference.types.parking_facility_id.ParkingFacilityId]) -> None:
        self._feature_references_ = zserio.array.Array(zserio.array.ObjectArrayTraits(self._ZserioElementFactory_feature_references()), feature_references_)
    ...
    @property
    def attribute_values(self) -> typing.List[nds.venue.details.instantiations.parking_facility_attribute.ParkingFacilityAttribute]:
        return self._attribute_values_.raw_array

    @attribute_values.setter
    def attribute_values(self, attribute_values_: typing.List[nds.venue.details.instantiations.parking_facility_attribute.ParkingFacilityAttribute]) -> None:
        self._attribute_values_ = zserio.array.Array(zserio.array.ObjectArrayTraits(self._ZserioElementFactory_attribute_values(self)), attribute_values_)
    ...
    def init_packing_context(self, zserio_context: ParkingFacilityAttributeMap.ZserioPackingContext) -> None:
    ...
    def bitsizeof_packed(self, zserio_context: ParkingFacilityAttributeMap.ZserioPackingContext, bitposition: int = 0) -> int:
        end_bitposition = bitposition
    ...
    def initialize_offsets_packed(self, zserio_context: ParkingFacilityAttributeMap.ZserioPackingContext, bitposition: int) -> int:
        end_bitposition = bitposition
    ...
    def read_packed(self, zserio_context: ParkingFacilityAttributeMap.ZserioPackingContext, zserio_reader: zserio.BitStreamReader) -> None:
    ...
    def write(self, zserio_writer: zserio.BitStreamWriter) -> None:
        ...
        if len(self._feature_references_) != (self._feature_):
            raise zserio.PythonRuntimeException("Wrong array length for field ParkingFacilityAttributeMap.featureReferences: "
        ...
        if len(self._feature_validities_) != (self._feature_):
            raise zserio.PythonRuntimeException("Wrong array length for field ParkingFacilityAttributeMap.featureValidities: "
        ...
        if len(self._feature_value_ptr_) != (self._feature_):
            raise zserio.PythonRuntimeException("Wrong array length for field ParkingFacilityAttributeMap.featureValuePtr: "
        ...
        if len(self._attribute_values_) != (self._attribute_):
            raise zserio.PythonRuntimeException("Wrong array length for field ParkingFacilityAttributeMap.attributeValues: "
        ...
        if len(self._attribute_properties_) != (self._attribute_):
            raise zserio.PythonRuntimeException("Wrong array length for field ParkingFacilityAttributeMap.attributeProperties: "
        ...
        if len(self._attribute_conditions_) != (self._attribute_):
            raise zserio.PythonRuntimeException("Wrong array length for field ParkingFacilityAttributeMap.attributeConditions: "
                                                f"{len(self._attribute_conditions_)} != {self._attribute_}!")
        self._attribute_conditions_.write_packed(zserio_writer)

    def write_packed(self, zserio_context: ParkingFacilityAttributeMap.ZserioPackingContext,
    ...
    class _ZserioElementFactory_feature_references:
        ...
        @staticmethod
        def create(zserio_reader: zserio.BitStreamReader, zserio_index: int) -> nds.venue.reference.types.parking_facility_id.ParkingFacilityId:
            del zserio_index
            return nds.venue.reference.types.parking_facility_id.ParkingFacilityId.from_reader(zserio_reader)

        @staticmethod
        def create_packing_context() -> nds.venue.reference.types.parking_facility_id.ParkingFacilityId.ZserioPackingContext:
            return nds.venue.reference.types.parking_facility_id.ParkingFacilityId.ZserioPackingContext()

        @staticmethod
        def create_packed(zserio_context: nds.venue.reference.types.parking_facility_id.ParkingFacilityId.ZserioPackingContext,
                          zserio_reader: zserio.BitStreamReader, zserio_index: int) -> nds.venue.reference.types.parking_facility_id.ParkingFacilityId:
            del zserio_index
            return nds.venue.reference.types.parking_facility_id.ParkingFacilityId.from_reader_packed(zserio_context, zserio_reader)
    ...
    class _ZserioElementFactory_attribute_values:
        ...
        def create(self, zserio_reader: zserio.BitStreamReader, zserio_index: int) -> nds.venue.details.instantiations.parking_facility_attribute.ParkingFacilityAttribute:
            del zserio_index
            return nds.venue.details.instantiations.parking_facility_attribute.ParkingFacilityAttribute.from_reader(zserio_reader, self._owner._attribute_type_code_)

        @staticmethod
        def create_packing_context() -> nds.venue.details.instantiations.parking_facility_attribute.ParkingFacilityAttribute.ZserioPackingContext:
            return nds.venue.details.instantiations.parking_facility_attribute.ParkingFacilityAttribute.ZserioPackingContext()

        def create_packed(self, zserio_context: nds.venue.details.instantiations.parking_facility_attribute.ParkingFacilityAttribute.ZserioPackingContext,
                          zserio_reader: zserio.BitStreamReader, zserio_index: int) -> nds.venue.details.instantiations.parking_facility_attribute.ParkingFacilityAttribute:
            del zserio_index
            return nds.venue.details.instantiations.parking_facility_attribute.ParkingFacilityAttribute.from_reader_packed(zserio_context, zserio_reader, self._owner._attribute_type_code_)
