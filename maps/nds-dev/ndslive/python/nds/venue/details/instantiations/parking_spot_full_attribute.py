...
import nds.venue.details.attributes.parking_spot_attribute_value
...
class ParkingSpotFullAttribute:
    def __init__(
            ...
            attribute_value_: typing.Union[nds.venue.details.attributes.parking_spot_attribute_value.ParkingSpotAttributeValue, None] = None,
    ...
    @classmethod
    def from_reader(
            cls: typing.Type['ParkingSpotFullAttribute'],
            zserio_reader: zserio.BitStreamReader) -> 'ParkingSpotFullAttribute':
    ...
    def from_reader_packed(
            cls: typing.Type['ParkingSpotFullAttribute'],
            zserio_context: ParkingSpotFullAttribute.ZserioPackingContext,
            zserio_reader: zserio.BitStreamReader) -> 'ParkingSpotFullAttribute':
        self = object.__new__(cls)
    ...
    def __eq__(self, other: object) -> bool:
        if isinstance(other, ParkingSpotFullAttribute):
    ...
    @property
    def attribute_value(self) -> typing.Union[nds.venue.details.attributes.parking_spot_attribute_value.ParkingSpotAttributeValue, None]:
        return self._attribute_value_

    @attribute_value.setter
    def attribute_value(self, attribute_value_: typing.Union[nds.venue.details.attributes.parking_spot_attribute_value.ParkingSpotAttributeValue, None]) -> None:
        self._attribute_value_ = attribute_value_
    ...
    def init_packing_context(self, zserio_context: ParkingSpotFullAttribute.ZserioPackingContext) -> None:
    ...
    def bitsizeof_packed(self, zserio_context: ParkingSpotFullAttribute.ZserioPackingContext, bitposition: int = 0) -> int:
        end_bitposition = bitposition
    ...
    def initialize_offsets_packed(self, zserio_context: ParkingSpotFullAttribute.ZserioPackingContext, bitposition: int) -> int:
        end_bitposition = bitposition
    ...
    def read(self, zserio_reader: zserio.BitStreamReader) -> None:
        ...
        self._attribute_value_ = nds.venue.details.attributes.parking_spot_attribute_value.ParkingSpotAttributeValue.from_reader(zserio_reader, self._attribute_type_code_)
    ...
    def read_packed(self, zserio_context: ParkingSpotFullAttribute.ZserioPackingContext, zserio_reader: zserio.BitStreamReader) -> None:
        ...
        self._attribute_value_ = nds.venue.details.attributes.parking_spot_attribute_value.ParkingSpotAttributeValue.from_reader_packed(zserio_context.attribute_value, zserio_reader, self._attribute_type_code_)
    ...
    def write(self, zserio_writer: zserio.BitStreamWriter) -> None:
        ...
        if self._attribute_value_.type is not (self._attribute_type_code_):
            raise zserio.PythonRuntimeException("Wrong parameter type for field ParkingSpotFullAttribute.attributeValue: "
    ...
    def write_packed(self, zserio_context: ParkingSpotFullAttribute.ZserioPackingContext,
    ...
    class ZserioPackingContext:
        def __init__(self):
            ...
            self._attribute_value_ = nds.venue.details.attributes.parking_spot_attribute_value.ParkingSpotAttributeValue.ZserioPackingContext()
