...
class ParkingRowAttributeMetadata:
    def __init__(
            self,
            available_attributes_: typing.List[nds.venue.details.attributes.parking_row_attribute_type.ParkingRowAttributeType] = None,
    ...
    @classmethod
    def from_reader(
            cls: typing.Type['ParkingRowAttributeMetadata'],
            zserio_reader: zserio.BitStreamReader) -> 'ParkingRowAttributeMetadata':
    ...
    def from_reader_packed(
            cls: typing.Type['ParkingRowAttributeMetadata'],
            zserio_context: ParkingRowAttributeMetadata.ZserioPackingContext,
            zserio_reader: zserio.BitStreamReader) -> 'ParkingRowAttributeMetadata':
        self = object.__new__(cls)
    ...
    def __eq__(self, other: object) -> bool:
        if isinstance(other, ParkingRowAttributeMetadata):
    ...
    @property
    def available_attributes(self) -> typing.List[nds.venue.details.attributes.parking_row_attribute_type.ParkingRowAttributeType]:
        return self._available_attributes_.raw_array

    @available_attributes.setter
    def available_attributes(self, available_attributes_: typing.List[nds.venue.details.attributes.parking_row_attribute_type.ParkingRowAttributeType]) -> None:
        self._available_attributes_ = zserio.array.Array(zserio.array.ObjectArrayTraits(self._ZserioElementFactory_available_attributes()), available_attributes_, is_auto=True)
    ...
    def init_packing_context(self, zserio_context: ParkingRowAttributeMetadata.ZserioPackingContext) -> None:
    ...
    def bitsizeof_packed(self, zserio_context: ParkingRowAttributeMetadata.ZserioPackingContext, bitposition: int = 0) -> int:
        end_bitposition = bitposition
        end_bitposition += self._available_attributes_.bitsizeof_packed(end_bitposition)
        end_bitposition += self._available_properties_.bitsizeof_packed(end_bitposition)
    ...
    def initialize_offsets_packed(self, zserio_context: ParkingRowAttributeMetadata.ZserioPackingContext, bitposition: int) -> int:
        end_bitposition = bitposition
        end_bitposition = self._available_attributes_.initialize_offsets_packed(end_bitposition)
        end_bitposition = self._available_properties_.initialize_offsets_packed(end_bitposition)
    ...
    def read_packed(self, zserio_context: ParkingRowAttributeMetadata.ZserioPackingContext, zserio_reader: zserio.BitStreamReader) -> None:
        self._available_attributes_ = zserio.array.Array.from_reader_packed(zserio.array.ObjectArrayTraits(self._ZserioElementFactory_available_attributes()), zserio_reader, is_auto=True)
    ...
    def write_packed(self, zserio_context: ParkingRowAttributeMetadata.ZserioPackingContext,
    ...
    class _ZserioElementFactory_available_attributes:
        ...
        @staticmethod
        def create(zserio_reader: zserio.BitStreamReader, zserio_index: int) -> nds.venue.details.attributes.parking_row_attribute_type.ParkingRowAttributeType:
            del zserio_index
            return nds.venue.details.attributes.parking_row_attribute_type.ParkingRowAttributeType.from_reader(zserio_reader)
        ...
        def create_packed(zserio_context: zserio.array.DeltaContext,
                          zserio_reader: zserio.BitStreamReader, zserio_index: int) -> nds.venue.details.attributes.parking_row_attribute_type.ParkingRowAttributeType:
            del zserio_index
            return nds.venue.details.attributes.parking_row_attribute_type.ParkingRowAttributeType.from_reader_packed(zserio_context, zserio_reader)
