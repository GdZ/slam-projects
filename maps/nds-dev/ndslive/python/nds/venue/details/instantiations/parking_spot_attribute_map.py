...
import nds.venue.details.instantiations.parking_spot_attribute
import nds.venue.details.instantiations.venue_property_list
import nds.venue.reference.types.parking_spot_id

class ParkingSpotAttributeMap:
    def __init__(
            self,
            coord_shift_: nds.core.geometry.coord_shift.CoordShift,
            attribute_type_code_: typing.Union[nds.venue.details.attributes.parking_spot_attribute_type.ParkingSpotAttributeType, None] = None,
            feature_: nds.core.attributemap.feature_iterator.FeatureIterator = nds.core.attributemap.feature_iterator.FeatureIterator(),
            feature_references_: typing.List[nds.venue.reference.types.parking_spot_id.ParkingSpotId] = None,
            ...
            attribute_values_: typing.List[nds.venue.details.instantiations.parking_spot_attribute.ParkingSpotAttribute] = None,
    ...
    @classmethod
    def from_reader(
            cls: typing.Type['ParkingSpotAttributeMap'],
            zserio_reader: zserio.BitStreamReader,
            coord_shift_: nds.core.geometry.coord_shift.CoordShift) -> 'ParkingSpotAttributeMap':
    ...
    def from_reader_packed(
            cls: typing.Type['ParkingSpotAttributeMap'],
            zserio_context: ParkingSpotAttributeMap.ZserioPackingContext,
            zserio_reader: zserio.BitStreamReader,
            coord_shift_: nds.core.geometry.coord_shift.CoordShift) -> 'ParkingSpotAttributeMap':
        self = object.__new__(cls)
        self._coord_shift_ = coord_shift_
    ...
    def __eq__(self, other: object) -> bool:
        if isinstance(other, ParkingSpotAttributeMap):
    ...
    @property
    def attribute_type_code(self) -> typing.Union[nds.venue.details.attributes.parking_spot_attribute_type.ParkingSpotAttributeType, None]:
        return self._attribute_type_code_

    @attribute_type_code.setter
    def attribute_type_code(self, attribute_type_code_: typing.Union[nds.venue.details.attributes.parking_spot_attribute_type.ParkingSpotAttributeType, None]) -> None:
        self._attribute_type_code_ = attribute_type_code_
    ...
    @property
    def feature_references(self) -> typing.List[nds.venue.reference.types.parking_spot_id.ParkingSpotId]:
        return self._feature_references_.raw_array

    @feature_references.setter
    def feature_references(self, feature_references_: typing.List[nds.venue.reference.types.parking_spot_id.ParkingSpotId]) -> None:
        self._feature_references_ = zserio.array.Array(zserio.array.ObjectArrayTraits(self._ZserioElementFactory_feature_references()), feature_references_)
    ...
    @property
    def attribute_values(self) -> typing.List[nds.venue.details.instantiations.parking_spot_attribute.ParkingSpotAttribute]:
        return self._attribute_values_.raw_array

    @attribute_values.setter
    def attribute_values(self, attribute_values_: typing.List[nds.venue.details.instantiations.parking_spot_attribute.ParkingSpotAttribute]) -> None:
        self._attribute_values_ = zserio.array.Array(zserio.array.ObjectArrayTraits(self._ZserioElementFactory_attribute_values(self)), attribute_values_)
    ...
    def init_packing_context(self, zserio_context: ParkingSpotAttributeMap.ZserioPackingContext) -> None:
    ...
    def bitsizeof_packed(self, zserio_context: ParkingSpotAttributeMap.ZserioPackingContext, bitposition: int = 0) -> int:
        end_bitposition = bitposition
    ...
    def initialize_offsets_packed(self, zserio_context: ParkingSpotAttributeMap.ZserioPackingContext, bitposition: int) -> int:
        end_bitposition = bitposition
    ...
    def read(self, zserio_reader: zserio.BitStreamReader) -> None:
        self._attribute_type_code_ = nds.venue.details.attributes.parking_spot_attribute_type.ParkingSpotAttributeType.from_reader(zserio_reader)
    ...
    def read_packed(self, zserio_context: ParkingSpotAttributeMap.ZserioPackingContext, zserio_reader: zserio.BitStreamReader) -> None:
        self._attribute_type_code_ = nds.venue.details.attributes.parking_spot_attribute_type.ParkingSpotAttributeType.from_reader_packed(zserio_context.attribute_type_code, zserio_reader)
    ...
    def write(self, zserio_writer: zserio.BitStreamWriter) -> None:
        ...
        if len(self._feature_references_) != (self._feature_):
            raise zserio.PythonRuntimeException("Wrong array length for field ParkingSpotAttributeMap.featureReferences: "
        ...
        if len(self._feature_validities_) != (self._feature_):
            raise zserio.PythonRuntimeException("Wrong array length for field ParkingSpotAttributeMap.featureValidities: "
        ...
        if len(self._feature_value_ptr_) != (self._feature_):
            raise zserio.PythonRuntimeException("Wrong array length for field ParkingSpotAttributeMap.featureValuePtr: "
        ...
        if len(self._attribute_values_) != (self._attribute_):
            raise zserio.PythonRuntimeException("Wrong array length for field ParkingSpotAttributeMap.attributeValues: "
        ...
        if len(self._attribute_properties_) != (self._attribute_):
            raise zserio.PythonRuntimeException("Wrong array length for field ParkingSpotAttributeMap.attributeProperties: "
        ...
        if len(self._attribute_conditions_) != (self._attribute_):
            raise zserio.PythonRuntimeException("Wrong array length for field ParkingSpotAttributeMap.attributeConditions: "
                                                f"{len(self._attribute_conditions_)} != {self._attribute_}!")
        self._attribute_conditions_.write_packed(zserio_writer)

    def write_packed(self, zserio_context: ParkingSpotAttributeMap.ZserioPackingContext,
    ...
    class _ZserioElementFactory_feature_references:
        ...
        @staticmethod
        def create(zserio_reader: zserio.BitStreamReader, zserio_index: int) -> nds.venue.reference.types.parking_spot_id.ParkingSpotId:
            del zserio_index
            return nds.venue.reference.types.parking_spot_id.ParkingSpotId.from_reader(zserio_reader)

        @staticmethod
        def create_packing_context() -> nds.venue.reference.types.parking_spot_id.ParkingSpotId.ZserioPackingContext:
            return nds.venue.reference.types.parking_spot_id.ParkingSpotId.ZserioPackingContext()

        @staticmethod
        def create_packed(zserio_context: nds.venue.reference.types.parking_spot_id.ParkingSpotId.ZserioPackingContext,
                          zserio_reader: zserio.BitStreamReader, zserio_index: int) -> nds.venue.reference.types.parking_spot_id.ParkingSpotId:
            del zserio_index
            return nds.venue.reference.types.parking_spot_id.ParkingSpotId.from_reader_packed(zserio_context, zserio_reader)
    ...
    class _ZserioElementFactory_attribute_values:
        ...
        def create(self, zserio_reader: zserio.BitStreamReader, zserio_index: int) -> nds.venue.details.instantiations.parking_spot_attribute.ParkingSpotAttribute:
            del zserio_index
            return nds.venue.details.instantiations.parking_spot_attribute.ParkingSpotAttribute.from_reader(zserio_reader, self._owner._attribute_type_code_)

        @staticmethod
        def create_packing_context() -> nds.venue.details.instantiations.parking_spot_attribute.ParkingSpotAttribute.ZserioPackingContext:
            return nds.venue.details.instantiations.parking_spot_attribute.ParkingSpotAttribute.ZserioPackingContext()

        def create_packed(self, zserio_context: nds.venue.details.instantiations.parking_spot_attribute.ParkingSpotAttribute.ZserioPackingContext,
                          zserio_reader: zserio.BitStreamReader, zserio_index: int) -> nds.venue.details.instantiations.parking_spot_attribute.ParkingSpotAttribute:
            del zserio_index
            return nds.venue.details.instantiations.parking_spot_attribute.ParkingSpotAttribute.from_reader_packed(zserio_context, zserio_reader, self._owner._attribute_type_code_)
