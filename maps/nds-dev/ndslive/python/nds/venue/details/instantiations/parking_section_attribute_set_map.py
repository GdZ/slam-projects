...
import nds.venue.details.instantiations.parking_section_attribute_set
...
class ParkingSectionAttributeSetMap:
    def __init__(
            ...
            attribute_set_: typing.Union[nds.venue.details.instantiations.parking_section_attribute_set.ParkingSectionAttributeSet, None] = None,
            feature_: nds.core.attributemap.feature_iterator.FeatureIterator = nds.core.attributemap.feature_iterator.FeatureIterator(),
            references_: typing.List[nds.venue.reference.types.parking_section_id.ParkingSectionId] = None,
    ...
    @classmethod
    def from_reader(
            cls: typing.Type['ParkingSectionAttributeSetMap'],
            zserio_reader: zserio.BitStreamReader,
            coord_shift_: nds.core.geometry.coord_shift.CoordShift) -> 'ParkingSectionAttributeSetMap':
    ...
    def from_reader_packed(
            cls: typing.Type['ParkingSectionAttributeSetMap'],
            zserio_context: ParkingSectionAttributeSetMap.ZserioPackingContext,
            zserio_reader: zserio.BitStreamReader,
            coord_shift_: nds.core.geometry.coord_shift.CoordShift) -> 'ParkingSectionAttributeSetMap':
        self = object.__new__(cls)
        self._coord_shift_ = coord_shift_
    ...
    def __eq__(self, other: object) -> bool:
        if isinstance(other, ParkingSectionAttributeSetMap):
    ...
    @property
    def attribute_set(self) -> typing.Union[nds.venue.details.instantiations.parking_section_attribute_set.ParkingSectionAttributeSet, None]:
        return self._attribute_set_

    @attribute_set.setter
    def attribute_set(self, attribute_set_: typing.Union[nds.venue.details.instantiations.parking_section_attribute_set.ParkingSectionAttributeSet, None]) -> None:
        self._attribute_set_ = attribute_set_
    ...
    @property
    def references(self) -> typing.List[nds.venue.reference.types.parking_section_id.ParkingSectionId]:
        return self._references_.raw_array

    @references.setter
    def references(self, references_: typing.List[nds.venue.reference.types.parking_section_id.ParkingSectionId]) -> None:
        self._references_ = zserio.array.Array(zserio.array.ObjectArrayTraits(self._ZserioElementFactory_references()), references_)
    ...
    def init_packing_context(self, zserio_context: ParkingSectionAttributeSetMap.ZserioPackingContext) -> None:
    ...
    def bitsizeof_packed(self, zserio_context: ParkingSectionAttributeSetMap.ZserioPackingContext, bitposition: int = 0) -> int:
        end_bitposition = bitposition
    ...
    def initialize_offsets_packed(self, zserio_context: ParkingSectionAttributeSetMap.ZserioPackingContext, bitposition: int) -> int:
        end_bitposition = bitposition
    ...
    def read(self, zserio_reader: zserio.BitStreamReader) -> None:
        self._attribute_set_ = nds.venue.details.instantiations.parking_section_attribute_set.ParkingSectionAttributeSet.from_reader(zserio_reader)
    ...
    def read_packed(self, zserio_context: ParkingSectionAttributeSetMap.ZserioPackingContext, zserio_reader: zserio.BitStreamReader) -> None:
        self._attribute_set_ = nds.venue.details.instantiations.parking_section_attribute_set.ParkingSectionAttributeSet.from_reader_packed(zserio_context.attribute_set, zserio_reader)
    ...
    def write(self, zserio_writer: zserio.BitStreamWriter) -> None:
        ...
        if len(self._references_) != (self._feature_):
            raise zserio.PythonRuntimeException("Wrong array length for field ParkingSectionAttributeSetMap.references: "
        ...
        if len(self._validities_) != (self._feature_):
            raise zserio.PythonRuntimeException("Wrong array length for field ParkingSectionAttributeSetMap.validities: "
                                                f"{len(self._validities_)} != {self._feature_}!")
        self._validities_.write(zserio_writer)

    def write_packed(self, zserio_context: ParkingSectionAttributeSetMap.ZserioPackingContext,
    ...
    class ZserioPackingContext:
        def __init__(self):
            self._attribute_set_ = nds.venue.details.instantiations.parking_section_attribute_set.ParkingSectionAttributeSet.ZserioPackingContext()
