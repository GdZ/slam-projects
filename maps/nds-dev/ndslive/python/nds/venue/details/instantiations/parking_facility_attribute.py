...
class ParkingFacilityAttribute:
    def __init__(
            self,
            attribute_type_code_: nds.venue.details.attributes.parking_facility_attribute_type.ParkingFacilityAttributeType,
            attribute_value_: typing.Union[nds.venue.details.attributes.parking_facility_attribute_value.ParkingFacilityAttributeValue, None] = None) -> None:
        self._attribute_type_code_ = attribute_type_code_
        self._attribute_value_ = attribute_value_

    @classmethod
    def from_reader(
            cls: typing.Type['ParkingFacilityAttribute'],
            zserio_reader: zserio.BitStreamReader,
            attribute_type_code_: nds.venue.details.attributes.parking_facility_attribute_type.ParkingFacilityAttributeType) -> 'ParkingFacilityAttribute':
    ...
    def from_reader_packed(
            cls: typing.Type['ParkingFacilityAttribute'],
            zserio_context: ParkingFacilityAttribute.ZserioPackingContext,
            zserio_reader: zserio.BitStreamReader,
            attribute_type_code_: nds.venue.details.attributes.parking_facility_attribute_type.ParkingFacilityAttributeType) -> 'ParkingFacilityAttribute':
        self = object.__new__(cls)
        self._attribute_type_code_ = attribute_type_code_
    ...
    def __eq__(self, other: object) -> bool:
        if isinstance(other, ParkingFacilityAttribute):
    ...
    @property
    def attribute_type_code(self) -> nds.venue.details.attributes.parking_facility_attribute_type.ParkingFacilityAttributeType:
    ...
    def init_packing_context(self, zserio_context: ParkingFacilityAttribute.ZserioPackingContext) -> None:
    ...
    def bitsizeof_packed(self, zserio_context: ParkingFacilityAttribute.ZserioPackingContext, bitposition: int = 0) -> int:
        end_bitposition = bitposition
    ...
    def initialize_offsets_packed(self, zserio_context: ParkingFacilityAttribute.ZserioPackingContext, bitposition: int) -> int:
        end_bitposition = bitposition
    ...
    def read_packed(self, zserio_context: ParkingFacilityAttribute.ZserioPackingContext, zserio_reader: zserio.BitStreamReader) -> None:
    ...
    def write(self, zserio_writer: zserio.BitStreamWriter) -> None:
        ...
        if self._attribute_value_.type is not (self._attribute_type_code_):
            raise zserio.PythonRuntimeException("Wrong parameter type for field ParkingFacilityAttribute.attributeValue: "
                                                f"{self._attribute_value_.type} != {self._attribute_type_code_}!")
        self._attribute_value_.write(zserio_writer)

    def write_packed(self, zserio_context: ParkingFacilityAttribute.ZserioPackingContext,
