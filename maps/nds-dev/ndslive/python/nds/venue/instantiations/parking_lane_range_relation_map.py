...
import nds.venue.instantiations.parking_range_relation
...
class ParkingLaneRangeRelationMap:
    def __init__(
            ...
            attribute_type_code_: typing.Union[nds.venue.parking.parking_range_relation_type.ParkingRangeRelationType, None] = None,
            ...
            attribute_values_: typing.List[nds.venue.instantiations.parking_range_relation.ParkingRangeRelation] = None,
    ...
    @classmethod
    def from_reader(
            cls: typing.Type['ParkingLaneRangeRelationMap'],
            zserio_reader: zserio.BitStreamReader,
            coord_shift_: nds.core.geometry.coord_shift.CoordShift) -> 'ParkingLaneRangeRelationMap':
    ...
    def from_reader_packed(
            cls: typing.Type['ParkingLaneRangeRelationMap'],
            zserio_context: ParkingLaneRangeRelationMap.ZserioPackingContext,
            zserio_reader: zserio.BitStreamReader,
            coord_shift_: nds.core.geometry.coord_shift.CoordShift) -> 'ParkingLaneRangeRelationMap':
        self = object.__new__(cls)
        self._coord_shift_ = coord_shift_
    ...
    def __eq__(self, other: object) -> bool:
        if isinstance(other, ParkingLaneRangeRelationMap):
    ...
    @property
    def attribute_type_code(self) -> typing.Union[nds.venue.parking.parking_range_relation_type.ParkingRangeRelationType, None]:
        return self._attribute_type_code_

    @attribute_type_code.setter
    def attribute_type_code(self, attribute_type_code_: typing.Union[nds.venue.parking.parking_range_relation_type.ParkingRangeRelationType, None]) -> None:
        self._attribute_type_code_ = attribute_type_code_
    ...
    @property
    def attribute_values(self) -> typing.List[nds.venue.instantiations.parking_range_relation.ParkingRangeRelation]:
        return self._attribute_values_.raw_array

    @attribute_values.setter
    def attribute_values(self, attribute_values_: typing.List[nds.venue.instantiations.parking_range_relation.ParkingRangeRelation]) -> None:
        self._attribute_values_ = zserio.array.Array(zserio.array.ObjectArrayTraits(self._ZserioElementFactory_attribute_values(self)), attribute_values_)
    ...
    def init_packing_context(self, zserio_context: ParkingLaneRangeRelationMap.ZserioPackingContext) -> None:
    ...
    def bitsizeof_packed(self, zserio_context: ParkingLaneRangeRelationMap.ZserioPackingContext, bitposition: int = 0) -> int:
        end_bitposition = bitposition
    ...
    def initialize_offsets_packed(self, zserio_context: ParkingLaneRangeRelationMap.ZserioPackingContext, bitposition: int) -> int:
        end_bitposition = bitposition
    ...
    def read(self, zserio_reader: zserio.BitStreamReader) -> None:
        self._attribute_type_code_ = nds.venue.parking.parking_range_relation_type.ParkingRangeRelationType.from_reader(zserio_reader)
    ...
    def read_packed(self, zserio_context: ParkingLaneRangeRelationMap.ZserioPackingContext, zserio_reader: zserio.BitStreamReader) -> None:
        self._attribute_type_code_ = nds.venue.parking.parking_range_relation_type.ParkingRangeRelationType.from_reader_packed(zserio_context.attribute_type_code, zserio_reader)
    ...
    def write(self, zserio_writer: zserio.BitStreamWriter) -> None:
        ...
        if len(self._feature_references_) != (self._feature_):
            raise zserio.PythonRuntimeException("Wrong array length for field ParkingLaneRangeRelationMap.featureReferences: "
        ...
        if len(self._feature_validities_) != (self._feature_):
            raise zserio.PythonRuntimeException("Wrong array length for field ParkingLaneRangeRelationMap.featureValidities: "
        ...
        if len(self._feature_value_ptr_) != (self._feature_):
            raise zserio.PythonRuntimeException("Wrong array length for field ParkingLaneRangeRelationMap.featureValuePtr: "
        ...
        if len(self._attribute_values_) != (self._attribute_):
            raise zserio.PythonRuntimeException("Wrong array length for field ParkingLaneRangeRelationMap.attributeValues: "
        ...
        if len(self._attribute_properties_) != (self._attribute_):
            raise zserio.PythonRuntimeException("Wrong array length for field ParkingLaneRangeRelationMap.attributeProperties: "
        ...
        if len(self._attribute_conditions_) != (self._attribute_):
            raise zserio.PythonRuntimeException("Wrong array length for field ParkingLaneRangeRelationMap.attributeConditions: "
                                                f"{len(self._attribute_conditions_)} != {self._attribute_}!")
        self._attribute_conditions_.write_packed(zserio_writer)

    def write_packed(self, zserio_context: ParkingLaneRangeRelationMap.ZserioPackingContext,
    ...
    class _ZserioElementFactory_attribute_values:
        ...
        def create(self, zserio_reader: zserio.BitStreamReader, zserio_index: int) -> nds.venue.instantiations.parking_range_relation.ParkingRangeRelation:
            del zserio_index
            return nds.venue.instantiations.parking_range_relation.ParkingRangeRelation.from_reader(zserio_reader, self._owner._attribute_type_code_)

        @staticmethod
        def create_packing_context() -> nds.venue.instantiations.parking_range_relation.ParkingRangeRelation.ZserioPackingContext:
            return nds.venue.instantiations.parking_range_relation.ParkingRangeRelation.ZserioPackingContext()

        def create_packed(self, zserio_context: nds.venue.instantiations.parking_range_relation.ParkingRangeRelation.ZserioPackingContext,
                          zserio_reader: zserio.BitStreamReader, zserio_index: int) -> nds.venue.instantiations.parking_range_relation.ParkingRangeRelation:
            del zserio_index
            return nds.venue.instantiations.parking_range_relation.ParkingRangeRelation.from_reader_packed(zserio_context, zserio_reader, self._owner._attribute_type_code_)
