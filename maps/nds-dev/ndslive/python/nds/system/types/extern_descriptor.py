...
class ExternDescriptor:
    def __init__(
            ...
            version_: nds.system.types.module_version.ModuleVersion = nds.system.types.module_version.ModuleVersion(),
            target_: nds.system.types.module_extern.ModuleExtern = nds.system.types.module_extern.ModuleExtern()) -> None:
        self._name_ = name_
        self._version_ = version_
        self._target_ = target_

    @classmethod
    def from_reader(
            cls: typing.Type['ExternDescriptor'],
            zserio_reader: zserio.BitStreamReader) -> 'ExternDescriptor':
    ...
    def __eq__(self, other: object) -> bool:
        if isinstance(other, ExternDescriptor):
            return ((self._name_ == other._name_) and
                    (self._version_ == other._version_) and
                    (self._target_ == other._target_))
    ...
    def __hash__(self) -> int:
        ...
        result = zserio.hashcode.calc_hashcode_string(result, self._target_)
    ...
    @property
    def target(self) -> nds.system.types.module_extern.ModuleExtern:
        return self._target_

    @target.setter
    def target(self, target_: nds.system.types.module_extern.ModuleExtern) -> None:
        self._target_ = target_
    ...
    def bitsizeof(self, bitposition: int = 0) -> int:
        ...
        end_bitposition += zserio.bitsizeof.bitsizeof_string(self._target_)
