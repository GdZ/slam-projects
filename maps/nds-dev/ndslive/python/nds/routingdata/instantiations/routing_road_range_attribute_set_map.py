...
import nds.routingdata.instantiations.routing_road_range_attribute_set

class RoutingRoadRangeAttributeSetMap:
    def __init__(
            self,
            coord_shift_: nds.core.geometry.coord_shift.CoordShift,
            attribute_set_: typing.Union[nds.routingdata.instantiations.routing_road_range_attribute_set.RoutingRoadRangeAttributeSet, None] = None,
    ...
    @classmethod
    def from_reader(
            cls: typing.Type['RoutingRoadRangeAttributeSetMap'],
            zserio_reader: zserio.BitStreamReader,
            coord_shift_: nds.core.geometry.coord_shift.CoordShift) -> 'RoutingRoadRangeAttributeSetMap':
    ...
    def from_reader_packed(
            cls: typing.Type['RoutingRoadRangeAttributeSetMap'],
            zserio_context: RoutingRoadRangeAttributeSetMap.ZserioPackingContext,
            zserio_reader: zserio.BitStreamReader,
            coord_shift_: nds.core.geometry.coord_shift.CoordShift) -> 'RoutingRoadRangeAttributeSetMap':
        self = object.__new__(cls)
        self._coord_shift_ = coord_shift_
    ...
    def __eq__(self, other: object) -> bool:
        if isinstance(other, RoutingRoadRangeAttributeSetMap):
    ...
    @property
    def attribute_set(self) -> typing.Union[nds.routingdata.instantiations.routing_road_range_attribute_set.RoutingRoadRangeAttributeSet, None]:
        return self._attribute_set_

    @attribute_set.setter
    def attribute_set(self, attribute_set_: typing.Union[nds.routingdata.instantiations.routing_road_range_attribute_set.RoutingRoadRangeAttributeSet, None]) -> None:
        self._attribute_set_ = attribute_set_
    ...
    def init_packing_context(self, zserio_context: RoutingRoadRangeAttributeSetMap.ZserioPackingContext) -> None:
    ...
    def bitsizeof_packed(self, zserio_context: RoutingRoadRangeAttributeSetMap.ZserioPackingContext, bitposition: int = 0) -> int:
        end_bitposition = bitposition
    ...
    def initialize_offsets_packed(self, zserio_context: RoutingRoadRangeAttributeSetMap.ZserioPackingContext, bitposition: int) -> int:
        end_bitposition = bitposition
    ...
    def read(self, zserio_reader: zserio.BitStreamReader) -> None:
        self._attribute_set_ = nds.routingdata.instantiations.routing_road_range_attribute_set.RoutingRoadRangeAttributeSet.from_reader(zserio_reader)
    ...
    def read_packed(self, zserio_context: RoutingRoadRangeAttributeSetMap.ZserioPackingContext, zserio_reader: zserio.BitStreamReader) -> None:
        self._attribute_set_ = nds.routingdata.instantiations.routing_road_range_attribute_set.RoutingRoadRangeAttributeSet.from_reader_packed(zserio_context.attribute_set, zserio_reader)
    ...
    def write(self, zserio_writer: zserio.BitStreamWriter) -> None:
        ...
        if len(self._references_) != (self._feature_):
            raise zserio.PythonRuntimeException("Wrong array length for field RoutingRoadRangeAttributeSetMap.references: "
        ...
        if len(self._validities_) != (self._feature_):
            raise zserio.PythonRuntimeException("Wrong array length for field RoutingRoadRangeAttributeSetMap.validities: "
                                                f"{len(self._validities_)} != {self._feature_}!")
        self._validities_.write_packed(zserio_writer)

    def write_packed(self, zserio_context: RoutingRoadRangeAttributeSetMap.ZserioPackingContext,
    ...
    class ZserioPackingContext:
        def __init__(self):
            self._attribute_set_ = nds.routingdata.instantiations.routing_road_range_attribute_set.RoutingRoadRangeAttributeSet.ZserioPackingContext()
