...
import nds.routingdata.instantiations.routing_property_list
import nds.routingdata.instantiations.routing_road_range_attribute

class RoutingRoadRangeAttributeMap:
    def __init__(
            self,
            coord_shift_: nds.core.geometry.coord_shift.CoordShift,
            attribute_type_code_: typing.Union[nds.routingdata.attributes.routing_road_range_attribute_type.RoutingRoadRangeAttributeType, None] = None,
            ...
            attribute_values_: typing.List[nds.routingdata.instantiations.routing_road_range_attribute.RoutingRoadRangeAttribute] = None,
            attribute_properties_: typing.List[nds.routingdata.instantiations.routing_property_list.RoutingPropertyList] = None,
    ...
    @classmethod
    def from_reader(
            cls: typing.Type['RoutingRoadRangeAttributeMap'],
            zserio_reader: zserio.BitStreamReader,
            coord_shift_: nds.core.geometry.coord_shift.CoordShift) -> 'RoutingRoadRangeAttributeMap':
    ...
    def from_reader_packed(
            cls: typing.Type['RoutingRoadRangeAttributeMap'],
            zserio_context: RoutingRoadRangeAttributeMap.ZserioPackingContext,
            zserio_reader: zserio.BitStreamReader,
            coord_shift_: nds.core.geometry.coord_shift.CoordShift) -> 'RoutingRoadRangeAttributeMap':
        self = object.__new__(cls)
        self._coord_shift_ = coord_shift_
    ...
    def __eq__(self, other: object) -> bool:
        if isinstance(other, RoutingRoadRangeAttributeMap):
    ...
    @property
    def attribute_type_code(self) -> typing.Union[nds.routingdata.attributes.routing_road_range_attribute_type.RoutingRoadRangeAttributeType, None]:
        return self._attribute_type_code_

    @attribute_type_code.setter
    def attribute_type_code(self, attribute_type_code_: typing.Union[nds.routingdata.attributes.routing_road_range_attribute_type.RoutingRoadRangeAttributeType, None]) -> None:
        self._attribute_type_code_ = attribute_type_code_
    ...
    @property
    def attribute_values(self) -> typing.List[nds.routingdata.instantiations.routing_road_range_attribute.RoutingRoadRangeAttribute]:
        return self._attribute_values_.raw_array

    @attribute_values.setter
    def attribute_values(self, attribute_values_: typing.List[nds.routingdata.instantiations.routing_road_range_attribute.RoutingRoadRangeAttribute]) -> None:
        self._attribute_values_ = zserio.array.Array(zserio.array.ObjectArrayTraits(self._ZserioElementFactory_attribute_values(self)), attribute_values_)

    @property
    def attribute_properties(self) -> typing.List[nds.routingdata.instantiations.routing_property_list.RoutingPropertyList]:
        return self._attribute_properties_.raw_array

    @attribute_properties.setter
    def attribute_properties(self, attribute_properties_: typing.List[nds.routingdata.instantiations.routing_property_list.RoutingPropertyList]) -> None:
        self._attribute_properties_ = zserio.array.Array(zserio.array.ObjectArrayTraits(self._ZserioElementFactory_attribute_properties()), attribute_properties_)
    ...
    def init_packing_context(self, zserio_context: RoutingRoadRangeAttributeMap.ZserioPackingContext) -> None:
    ...
    def bitsizeof_packed(self, zserio_context: RoutingRoadRangeAttributeMap.ZserioPackingContext, bitposition: int = 0) -> int:
        end_bitposition = bitposition
    ...
    def initialize_offsets_packed(self, zserio_context: RoutingRoadRangeAttributeMap.ZserioPackingContext, bitposition: int) -> int:
        end_bitposition = bitposition
    ...
    def read(self, zserio_reader: zserio.BitStreamReader) -> None:
        self._attribute_type_code_ = nds.routingdata.attributes.routing_road_range_attribute_type.RoutingRoadRangeAttributeType.from_reader(zserio_reader)
    ...
    def read_packed(self, zserio_context: RoutingRoadRangeAttributeMap.ZserioPackingContext, zserio_reader: zserio.BitStreamReader) -> None:
        self._attribute_type_code_ = nds.routingdata.attributes.routing_road_range_attribute_type.RoutingRoadRangeAttributeType.from_reader_packed(zserio_context.attribute_type_code, zserio_reader)
    ...
    def write(self, zserio_writer: zserio.BitStreamWriter) -> None:
        ...
        if len(self._feature_references_) != (self._feature_):
            raise zserio.PythonRuntimeException("Wrong array length for field RoutingRoadRangeAttributeMap.featureReferences: "
        ...
        if len(self._feature_validities_) != (self._feature_):
            raise zserio.PythonRuntimeException("Wrong array length for field RoutingRoadRangeAttributeMap.featureValidities: "
        ...
        if len(self._feature_value_ptr_) != (self._feature_):
            raise zserio.PythonRuntimeException("Wrong array length for field RoutingRoadRangeAttributeMap.featureValuePtr: "
        ...
        if len(self._attribute_values_) != (self._attribute_):
            raise zserio.PythonRuntimeException("Wrong array length for field RoutingRoadRangeAttributeMap.attributeValues: "
        ...
        if len(self._attribute_properties_) != (self._attribute_):
            raise zserio.PythonRuntimeException("Wrong array length for field RoutingRoadRangeAttributeMap.attributeProperties: "
        ...
        if len(self._attribute_conditions_) != (self._attribute_):
            raise zserio.PythonRuntimeException("Wrong array length for field RoutingRoadRangeAttributeMap.attributeConditions: "
                                                f"{len(self._attribute_conditions_)} != {self._attribute_}!")
        self._attribute_conditions_.write_packed(zserio_writer)

    def write_packed(self, zserio_context: RoutingRoadRangeAttributeMap.ZserioPackingContext,
    ...
    class _ZserioElementFactory_attribute_values:
        ...
        def create(self, zserio_reader: zserio.BitStreamReader, zserio_index: int) -> nds.routingdata.instantiations.routing_road_range_attribute.RoutingRoadRangeAttribute:
            del zserio_index
            return nds.routingdata.instantiations.routing_road_range_attribute.RoutingRoadRangeAttribute.from_reader(zserio_reader, self._owner._attribute_type_code_)

        @staticmethod
        def create_packing_context() -> nds.routingdata.instantiations.routing_road_range_attribute.RoutingRoadRangeAttribute.ZserioPackingContext:
            return nds.routingdata.instantiations.routing_road_range_attribute.RoutingRoadRangeAttribute.ZserioPackingContext()

        def create_packed(self, zserio_context: nds.routingdata.instantiations.routing_road_range_attribute.RoutingRoadRangeAttribute.ZserioPackingContext,
                          zserio_reader: zserio.BitStreamReader, zserio_index: int) -> nds.routingdata.instantiations.routing_road_range_attribute.RoutingRoadRangeAttribute:
            del zserio_index
            return nds.routingdata.instantiations.routing_road_range_attribute.RoutingRoadRangeAttribute.from_reader_packed(zserio_context, zserio_reader, self._owner._attribute_type_code_)

    class _ZserioElementFactory_attribute_properties:
        IS_OBJECT_PACKABLE = True

        @staticmethod
        def create(zserio_reader: zserio.BitStreamReader, zserio_index: int) -> nds.routingdata.instantiations.routing_property_list.RoutingPropertyList:
            del zserio_index
            return nds.routingdata.instantiations.routing_property_list.RoutingPropertyList.from_reader(zserio_reader)

        @staticmethod
        def create_packing_context() -> nds.routingdata.instantiations.routing_property_list.RoutingPropertyList.ZserioPackingContext:
            return nds.routingdata.instantiations.routing_property_list.RoutingPropertyList.ZserioPackingContext()

        @staticmethod
        def create_packed(zserio_context: nds.routingdata.instantiations.routing_property_list.RoutingPropertyList.ZserioPackingContext,
                          zserio_reader: zserio.BitStreamReader, zserio_index: int) -> nds.routingdata.instantiations.routing_property_list.RoutingPropertyList:
            del zserio_index
            return nds.routingdata.instantiations.routing_property_list.RoutingPropertyList.from_reader_packed(zserio_context, zserio_reader)
