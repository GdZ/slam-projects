...
import nds.routingdata.attributes.routing_road_transition_attribute_value
...
class RoutingRoadTransitionFullAttribute:
    def __init__(
            ...
            attribute_value_: typing.Union[nds.routingdata.attributes.routing_road_transition_attribute_value.RoutingRoadTransitionAttributeValue, None] = None,
            properties_: typing.Optional[nds.routingdata.instantiations.routing_property_list.RoutingPropertyList] = None,
    ...
    @classmethod
    def from_reader(
            cls: typing.Type['RoutingRoadTransitionFullAttribute'],
            zserio_reader: zserio.BitStreamReader) -> 'RoutingRoadTransitionFullAttribute':
    ...
    def from_reader_packed(
            cls: typing.Type['RoutingRoadTransitionFullAttribute'],
            zserio_context: RoutingRoadTransitionFullAttribute.ZserioPackingContext,
            zserio_reader: zserio.BitStreamReader) -> 'RoutingRoadTransitionFullAttribute':
        self = object.__new__(cls)
    ...
    def __eq__(self, other: object) -> bool:
        if isinstance(other, RoutingRoadTransitionFullAttribute):
    ...
    @property
    def attribute_value(self) -> typing.Union[nds.routingdata.attributes.routing_road_transition_attribute_value.RoutingRoadTransitionAttributeValue, None]:
        return self._attribute_value_

    @attribute_value.setter
    def attribute_value(self, attribute_value_: typing.Union[nds.routingdata.attributes.routing_road_transition_attribute_value.RoutingRoadTransitionAttributeValue, None]) -> None:
        self._attribute_value_ = attribute_value_

    @property
    def properties(self) -> typing.Optional[nds.routingdata.instantiations.routing_property_list.RoutingPropertyList]:
        return self._properties_

    @properties.setter
    def properties(self, properties_: typing.Optional[nds.routingdata.instantiations.routing_property_list.RoutingPropertyList]) -> None:
        self._properties_ = properties_
    ...
    def init_packing_context(self, zserio_context: RoutingRoadTransitionFullAttribute.ZserioPackingContext) -> None:
    ...
    def bitsizeof_packed(self, zserio_context: RoutingRoadTransitionFullAttribute.ZserioPackingContext, bitposition: int = 0) -> int:
        end_bitposition = bitposition
    ...
    def initialize_offsets_packed(self, zserio_context: RoutingRoadTransitionFullAttribute.ZserioPackingContext, bitposition: int) -> int:
        end_bitposition = bitposition
    ...
    def read(self, zserio_reader: zserio.BitStreamReader) -> None:
        ...
        self._attribute_value_ = nds.routingdata.attributes.routing_road_transition_attribute_value.RoutingRoadTransitionAttributeValue.from_reader(zserio_reader, self._attribute_type_code_)
        if zserio_reader.read_bool():
            self._properties_ = nds.routingdata.instantiations.routing_property_list.RoutingPropertyList.from_reader(zserio_reader)
        else:
            self._properties_ = None
        if zserio_reader.read_bool():
    ...
    def read_packed(self, zserio_context: RoutingRoadTransitionFullAttribute.ZserioPackingContext, zserio_reader: zserio.BitStreamReader) -> None:
        ...
        self._attribute_value_ = nds.routingdata.attributes.routing_road_transition_attribute_value.RoutingRoadTransitionAttributeValue.from_reader_packed(zserio_context.attribute_value, zserio_reader, self._attribute_type_code_)

        if zserio_reader.read_bool():
            self._properties_ = nds.routingdata.instantiations.routing_property_list.RoutingPropertyList.from_reader_packed(zserio_context.properties, zserio_reader)
        else:
            self._properties_ = None
    ...
    def write(self, zserio_writer: zserio.BitStreamWriter) -> None:
        ...
        if self._attribute_value_.type is not (self._attribute_type_code_):
            raise zserio.PythonRuntimeException("Wrong parameter type for field RoutingRoadTransitionFullAttribute.attributeValue: "
    ...
    def write_packed(self, zserio_context: RoutingRoadTransitionFullAttribute.ZserioPackingContext,
    ...
    class ZserioPackingContext:
        def __init__(self):
            ...
            self._attribute_value_ = nds.routingdata.attributes.routing_road_transition_attribute_value.RoutingRoadTransitionAttributeValue.ZserioPackingContext()
            self._properties_ = nds.routingdata.instantiations.routing_property_list.RoutingPropertyList.ZserioPackingContext()
