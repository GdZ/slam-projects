...
import nds.routingdata.instantiations.routing_road_transition_attribute

class RoutingRoadTransitionAttributeMap:
    def __init__(
            self,
            coord_shift_: nds.core.geometry.coord_shift.CoordShift,
            attribute_type_code_: typing.Union[nds.routingdata.attributes.routing_road_transition_attribute_type.RoutingRoadTransitionAttributeType, None] = None,
            feature_: nds.core.attributemap.feature_iterator.FeatureIterator = nds.core.attributemap.feature_iterator.FeatureIterator(),
            feature_references_: typing.List[nds.road.reference.types.transition_reference.TransitionReference] = None,
            ...
            attribute_values_: typing.List[nds.routingdata.instantiations.routing_road_transition_attribute.RoutingRoadTransitionAttribute] = None,
    ...
    @classmethod
    def from_reader(
            cls: typing.Type['RoutingRoadTransitionAttributeMap'],
            zserio_reader: zserio.BitStreamReader,
            coord_shift_: nds.core.geometry.coord_shift.CoordShift) -> 'RoutingRoadTransitionAttributeMap':
    ...
    def from_reader_packed(
            cls: typing.Type['RoutingRoadTransitionAttributeMap'],
            zserio_context: RoutingRoadTransitionAttributeMap.ZserioPackingContext,
            zserio_reader: zserio.BitStreamReader,
            coord_shift_: nds.core.geometry.coord_shift.CoordShift) -> 'RoutingRoadTransitionAttributeMap':
        self = object.__new__(cls)
        self._coord_shift_ = coord_shift_
    ...
    def __eq__(self, other: object) -> bool:
        if isinstance(other, RoutingRoadTransitionAttributeMap):
    ...
    @property
    def attribute_type_code(self) -> typing.Union[nds.routingdata.attributes.routing_road_transition_attribute_type.RoutingRoadTransitionAttributeType, None]:
        return self._attribute_type_code_

    @attribute_type_code.setter
    def attribute_type_code(self, attribute_type_code_: typing.Union[nds.routingdata.attributes.routing_road_transition_attribute_type.RoutingRoadTransitionAttributeType, None]) -> None:
        self._attribute_type_code_ = attribute_type_code_
    ...
    @property
    def feature_references(self) -> typing.List[nds.road.reference.types.transition_reference.TransitionReference]:
        return self._feature_references_.raw_array

    @feature_references.setter
    def feature_references(self, feature_references_: typing.List[nds.road.reference.types.transition_reference.TransitionReference]) -> None:
        self._feature_references_ = zserio.array.Array(zserio.array.ObjectArrayTraits(self._ZserioElementFactory_feature_references()), feature_references_)
    ...
    @property
    def attribute_values(self) -> typing.List[nds.routingdata.instantiations.routing_road_transition_attribute.RoutingRoadTransitionAttribute]:
        return self._attribute_values_.raw_array

    @attribute_values.setter
    def attribute_values(self, attribute_values_: typing.List[nds.routingdata.instantiations.routing_road_transition_attribute.RoutingRoadTransitionAttribute]) -> None:
        self._attribute_values_ = zserio.array.Array(zserio.array.ObjectArrayTraits(self._ZserioElementFactory_attribute_values(self)), attribute_values_)
    ...
    def init_packing_context(self, zserio_context: RoutingRoadTransitionAttributeMap.ZserioPackingContext) -> None:
    ...
    def bitsizeof_packed(self, zserio_context: RoutingRoadTransitionAttributeMap.ZserioPackingContext, bitposition: int = 0) -> int:
        end_bitposition = bitposition
    ...
    def initialize_offsets_packed(self, zserio_context: RoutingRoadTransitionAttributeMap.ZserioPackingContext, bitposition: int) -> int:
        end_bitposition = bitposition
    ...
    def read(self, zserio_reader: zserio.BitStreamReader) -> None:
        self._attribute_type_code_ = nds.routingdata.attributes.routing_road_transition_attribute_type.RoutingRoadTransitionAttributeType.from_reader(zserio_reader)
    ...
    def read_packed(self, zserio_context: RoutingRoadTransitionAttributeMap.ZserioPackingContext, zserio_reader: zserio.BitStreamReader) -> None:
        self._attribute_type_code_ = nds.routingdata.attributes.routing_road_transition_attribute_type.RoutingRoadTransitionAttributeType.from_reader_packed(zserio_context.attribute_type_code, zserio_reader)
    ...
    def write(self, zserio_writer: zserio.BitStreamWriter) -> None:
        ...
        if len(self._feature_references_) != (self._feature_):
            raise zserio.PythonRuntimeException("Wrong array length for field RoutingRoadTransitionAttributeMap.featureReferences: "
        ...
        if len(self._feature_validities_) != (self._feature_):
            raise zserio.PythonRuntimeException("Wrong array length for field RoutingRoadTransitionAttributeMap.featureValidities: "
        ...
        if len(self._feature_value_ptr_) != (self._feature_):
            raise zserio.PythonRuntimeException("Wrong array length for field RoutingRoadTransitionAttributeMap.featureValuePtr: "
        ...
        if len(self._attribute_values_) != (self._attribute_):
            raise zserio.PythonRuntimeException("Wrong array length for field RoutingRoadTransitionAttributeMap.attributeValues: "
        ...
        if len(self._attribute_properties_) != (self._attribute_):
            raise zserio.PythonRuntimeException("Wrong array length for field RoutingRoadTransitionAttributeMap.attributeProperties: "
        ...
        if len(self._attribute_conditions_) != (self._attribute_):
            raise zserio.PythonRuntimeException("Wrong array length for field RoutingRoadTransitionAttributeMap.attributeConditions: "
                                                f"{len(self._attribute_conditions_)} != {self._attribute_}!")
        self._attribute_conditions_.write_packed(zserio_writer)

    def write_packed(self, zserio_context: RoutingRoadTransitionAttributeMap.ZserioPackingContext,
    ...
    class _ZserioElementFactory_attribute_values:
        ...
        def create(self, zserio_reader: zserio.BitStreamReader, zserio_index: int) -> nds.routingdata.instantiations.routing_road_transition_attribute.RoutingRoadTransitionAttribute:
            del zserio_index
            return nds.routingdata.instantiations.routing_road_transition_attribute.RoutingRoadTransitionAttribute.from_reader(zserio_reader, self._owner._attribute_type_code_)

        @staticmethod
        def create_packing_context() -> nds.routingdata.instantiations.routing_road_transition_attribute.RoutingRoadTransitionAttribute.ZserioPackingContext:
            return nds.routingdata.instantiations.routing_road_transition_attribute.RoutingRoadTransitionAttribute.ZserioPackingContext()

        def create_packed(self, zserio_context: nds.routingdata.instantiations.routing_road_transition_attribute.RoutingRoadTransitionAttribute.ZserioPackingContext,
                          zserio_reader: zserio.BitStreamReader, zserio_index: int) -> nds.routingdata.instantiations.routing_road_transition_attribute.RoutingRoadTransitionAttribute:
            del zserio_index
            return nds.routingdata.instantiations.routing_road_transition_attribute.RoutingRoadTransitionAttribute.from_reader_packed(zserio_context, zserio_reader, self._owner._attribute_type_code_)
