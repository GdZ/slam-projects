...
import nds.routingdata.attributes.routing_road_range_attribute_value
import nds.routingdata.instantiations.routing_property_list

class RoutingRoadRangeFullAttribute:
    def __init__(
            self,
            ...
            attribute_value_: typing.Union[nds.routingdata.attributes.routing_road_range_attribute_value.RoutingRoadRangeAttributeValue, None] = None,
    ...
    @classmethod
    def from_reader(
            cls: typing.Type['RoutingRoadRangeFullAttribute'],
            zserio_reader: zserio.BitStreamReader) -> 'RoutingRoadRangeFullAttribute':
    ...
    def from_reader_packed(
            cls: typing.Type['RoutingRoadRangeFullAttribute'],
            zserio_context: RoutingRoadRangeFullAttribute.ZserioPackingContext,
            zserio_reader: zserio.BitStreamReader) -> 'RoutingRoadRangeFullAttribute':
        self = object.__new__(cls)
    ...
    def __eq__(self, other: object) -> bool:
        if isinstance(other, RoutingRoadRangeFullAttribute):
    ...
    @property
    def attribute_value(self) -> typing.Union[nds.routingdata.attributes.routing_road_range_attribute_value.RoutingRoadRangeAttributeValue, None]:
        return self._attribute_value_

    @attribute_value.setter
    def attribute_value(self, attribute_value_: typing.Union[nds.routingdata.attributes.routing_road_range_attribute_value.RoutingRoadRangeAttributeValue, None]) -> None:
        self._attribute_value_ = attribute_value_
    ...
    def init_packing_context(self, zserio_context: RoutingRoadRangeFullAttribute.ZserioPackingContext) -> None:
    ...
    def bitsizeof_packed(self, zserio_context: RoutingRoadRangeFullAttribute.ZserioPackingContext, bitposition: int = 0) -> int:
        end_bitposition = bitposition
    ...
    def initialize_offsets_packed(self, zserio_context: RoutingRoadRangeFullAttribute.ZserioPackingContext, bitposition: int) -> int:
        end_bitposition = bitposition
    ...
    def read(self, zserio_reader: zserio.BitStreamReader) -> None:
        ...
        self._attribute_value_ = nds.routingdata.attributes.routing_road_range_attribute_value.RoutingRoadRangeAttributeValue.from_reader(zserio_reader, self._attribute_type_code_)
    ...
    def read_packed(self, zserio_context: RoutingRoadRangeFullAttribute.ZserioPackingContext, zserio_reader: zserio.BitStreamReader) -> None:
        ...
        self._attribute_value_ = nds.routingdata.attributes.routing_road_range_attribute_value.RoutingRoadRangeAttributeValue.from_reader_packed(zserio_context.attribute_value, zserio_reader, self._attribute_type_code_)
    ...
    def write(self, zserio_writer: zserio.BitStreamWriter) -> None:
        ...
        if self._attribute_value_.type is not (self._attribute_type_code_):
            raise zserio.PythonRuntimeException("Wrong parameter type for field RoutingRoadRangeFullAttribute.attributeValue: "
    ...
    def write_packed(self, zserio_context: RoutingRoadRangeFullAttribute.ZserioPackingContext,
    ...
    class ZserioPackingContext:
        def __init__(self):
            ...
            self._attribute_value_ = nds.routingdata.attributes.routing_road_range_attribute_value.RoutingRoadRangeAttributeValue.ZserioPackingContext()
