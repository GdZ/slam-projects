...
class RoutingLaneRangeAttributeValue:
    def __init__(
            self,
            type_: nds.routingdata.attributes.routing_lane_range_attribute_type.RoutingLaneRangeAttributeType,
            *,
            ...
            speed_profiles_days_: typing.Union[nds.routingdata.types.speed_profiles_days.SpeedProfilesDays, None] = None) -> None:
        self._type_ = type_
        ...
        if up_excess_slope_ is not None:
            if self._choice != None:
                raise zserio.PythonRuntimeException("Calling constructor of choice RoutingLaneRangeAttributeValue is ambiguous!")
    ...
    @classmethod
    def from_reader(
            cls: typing.Type['RoutingLaneRangeAttributeValue'],
            zserio_reader: zserio.BitStreamReader,
            type_: nds.routingdata.attributes.routing_lane_range_attribute_type.RoutingLaneRangeAttributeType) -> 'RoutingLaneRangeAttributeValue':
    ...
    def from_reader_packed(
            cls: typing.Type['RoutingLaneRangeAttributeValue'],
            zserio_context: RoutingLaneRangeAttributeValue.ZserioPackingContext,
            zserio_reader: zserio.BitStreamReader,
            type_: nds.routingdata.attributes.routing_lane_range_attribute_type.RoutingLaneRangeAttributeType) -> 'RoutingLaneRangeAttributeValue':
        self = object.__new__(cls)
        self._type_ = type_
    ...
    def __eq__(self, other: object) -> bool:
        if isinstance(other, RoutingLaneRangeAttributeValue):
    ...
    def __hash__(self) -> int:
        ...
        if selector == (nds.routingdata.attributes.routing_lane_range_attribute_type.RoutingLaneRangeAttributeType.PLURAL_JUNCTION):
            result = zserio.hashcode.calc_hashcode_object(result, self._choice)
        elif selector == (nds.routingdata.attributes.routing_lane_range_attribute_type.RoutingLaneRangeAttributeType.CONSUMPTION_UP_EXCESS_SLOPE):
            result = zserio.hashcode.calc_hashcode_int32(result, self._choice)
        elif selector == (nds.routingdata.attributes.routing_lane_range_attribute_type.RoutingLaneRangeAttributeType.CONSUMPTION_DOWN_EXCESS_SLOPE):
            result = zserio.hashcode.calc_hashcode_int32(result, self._choice)
        elif selector == (nds.routingdata.attributes.routing_lane_range_attribute_type.RoutingLaneRangeAttributeType.CONSUMPTION_SPEED_VARIATION):
            result = zserio.hashcode.calc_hashcode_int32(result, self._choice)
        elif selector == (nds.routingdata.attributes.routing_lane_range_attribute_type.RoutingLaneRangeAttributeType.CONSUMPTION_SPEED_DEPENDENCY):
            result = zserio.hashcode.calc_hashcode_object(result, self._choice)
        elif selector == (nds.routingdata.attributes.routing_lane_range_attribute_type.RoutingLaneRangeAttributeType.CONSUMPTION_AVERAGE_SLOPE):
            result = zserio.hashcode.calc_hashcode_int32(result, self._choice)
        elif selector == (nds.routingdata.attributes.routing_lane_range_attribute_type.RoutingLaneRangeAttributeType.TOURIST_ROUTE_TYPE):
            result = zserio.hashcode.calc_hashcode_object(result, self._choice)
        elif selector == (nds.routingdata.attributes.routing_lane_range_attribute_type.RoutingLaneRangeAttributeType.NUM_TOLL_GATES):
            result = zserio.hashcode.calc_hashcode_int32(result, self._choice)
        elif selector == (nds.routingdata.attributes.routing_lane_range_attribute_type.RoutingLaneRangeAttributeType.NUM_TRAFFIC_LIGHTS):
            result = zserio.hashcode.calc_hashcode_int32(result, self._choice)
        elif selector == (nds.routingdata.attributes.routing_lane_range_attribute_type.RoutingLaneRangeAttributeType.NUM_GIVE_RIGHT_OF_WAY):
            result = zserio.hashcode.calc_hashcode_int32(result, self._choice)
        elif selector == (nds.routingdata.attributes.routing_lane_range_attribute_type.RoutingLaneRangeAttributeType.NUM_SPEED_CAMERAS):
            result = zserio.hashcode.calc_hashcode_int32(result, self._choice)
        elif selector == (nds.routingdata.attributes.routing_lane_range_attribute_type.RoutingLaneRangeAttributeType.NUM_SPEED_ZONES):
            result = zserio.hashcode.calc_hashcode_int32(result, self._choice)
        elif selector == (nds.routingdata.attributes.routing_lane_range_attribute_type.RoutingLaneRangeAttributeType.NUM_RAILWAY_CROSSINGS):
            result = zserio.hashcode.calc_hashcode_int32(result, self._choice)
        elif selector == (nds.routingdata.attributes.routing_lane_range_attribute_type.RoutingLaneRangeAttributeType.NUM_STATIONS):
            result = zserio.hashcode.calc_hashcode_int32(result, self._choice)
        elif selector == (nds.routingdata.attributes.routing_lane_range_attribute_type.RoutingLaneRangeAttributeType.SPEED_PROFILES_WEEK):
            result = zserio.hashcode.calc_hashcode_object(result, self._choice)
        elif selector == (nds.routingdata.attributes.routing_lane_range_attribute_type.RoutingLaneRangeAttributeType.SPEED_PROFILES_DAYS):
            result = zserio.hashcode.calc_hashcode_object(result, self._choice)
        else:
            pass
    ...
    @property
    def type(self) -> nds.routingdata.attributes.routing_lane_range_attribute_type.RoutingLaneRangeAttributeType:
        return self._type_
    ...
    def init_packing_context(self, zserio_context: RoutingLaneRangeAttributeValue.ZserioPackingContext) -> None:
        selector = self._type_
        ...
        if selector == (nds.routingdata.attributes.routing_lane_range_attribute_type.RoutingLaneRangeAttributeType.PLURAL_JUNCTION):
            ...
            raise zserio.PythonRuntimeException("No match in choice RoutingLaneRangeAttributeValue!")
    ...
    def bitsizeof_packed(self, zserio_context: RoutingLaneRangeAttributeValue.ZserioPackingContext,
    ...
    def initialize_offsets_packed(self, zserio_context: RoutingLaneRangeAttributeValue.ZserioPackingContext,
                                  bitposition: int) -> int:
        end_bitposition = bitposition
    ...
    def read_packed(self, zserio_context: RoutingLaneRangeAttributeValue.ZserioPackingContext,
    ...
    def write_packed(self, zserio_context: RoutingLaneRangeAttributeValue.ZserioPackingContext,
