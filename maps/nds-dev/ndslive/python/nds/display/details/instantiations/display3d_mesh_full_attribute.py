...
import nds.display.details.attributes.display3d_mesh_attribute_value
...
class Display3dMeshFullAttribute:
    def __init__(
            ...
            attribute_value_: typing.Union[nds.display.details.attributes.display3d_mesh_attribute_value.Display3dMeshAttributeValue, None] = None,
            properties_: typing.Optional[nds.display.details.instantiations.display_property_list.DisplayPropertyList] = None,
    ...
    @classmethod
    def from_reader(
            cls: typing.Type['Display3dMeshFullAttribute'],
            zserio_reader: zserio.BitStreamReader) -> 'Display3dMeshFullAttribute':
    ...
    def from_reader_packed(
            cls: typing.Type['Display3dMeshFullAttribute'],
            zserio_context: Display3dMeshFullAttribute.ZserioPackingContext,
            zserio_reader: zserio.BitStreamReader) -> 'Display3dMeshFullAttribute':
        self = object.__new__(cls)
    ...
    def __eq__(self, other: object) -> bool:
        if isinstance(other, Display3dMeshFullAttribute):
    ...
    @property
    def attribute_value(self) -> typing.Union[nds.display.details.attributes.display3d_mesh_attribute_value.Display3dMeshAttributeValue, None]:
        return self._attribute_value_

    @attribute_value.setter
    def attribute_value(self, attribute_value_: typing.Union[nds.display.details.attributes.display3d_mesh_attribute_value.Display3dMeshAttributeValue, None]) -> None:
        self._attribute_value_ = attribute_value_

    @property
    def properties(self) -> typing.Optional[nds.display.details.instantiations.display_property_list.DisplayPropertyList]:
        return self._properties_

    @properties.setter
    def properties(self, properties_: typing.Optional[nds.display.details.instantiations.display_property_list.DisplayPropertyList]) -> None:
        self._properties_ = properties_
    ...
    def init_packing_context(self, zserio_context: Display3dMeshFullAttribute.ZserioPackingContext) -> None:
    ...
    def bitsizeof_packed(self, zserio_context: Display3dMeshFullAttribute.ZserioPackingContext, bitposition: int = 0) -> int:
        end_bitposition = bitposition
    ...
    def initialize_offsets_packed(self, zserio_context: Display3dMeshFullAttribute.ZserioPackingContext, bitposition: int) -> int:
        end_bitposition = bitposition
    ...
    def read(self, zserio_reader: zserio.BitStreamReader) -> None:
        ...
        self._attribute_value_ = nds.display.details.attributes.display3d_mesh_attribute_value.Display3dMeshAttributeValue.from_reader(zserio_reader, self._attribute_type_code_)
        if zserio_reader.read_bool():
            self._properties_ = nds.display.details.instantiations.display_property_list.DisplayPropertyList.from_reader(zserio_reader)
        else:
            self._properties_ = None
        if zserio_reader.read_bool():
    ...
    def read_packed(self, zserio_context: Display3dMeshFullAttribute.ZserioPackingContext, zserio_reader: zserio.BitStreamReader) -> None:
        ...
        self._attribute_value_ = nds.display.details.attributes.display3d_mesh_attribute_value.Display3dMeshAttributeValue.from_reader_packed(zserio_context.attribute_value, zserio_reader, self._attribute_type_code_)

        if zserio_reader.read_bool():
            self._properties_ = nds.display.details.instantiations.display_property_list.DisplayPropertyList.from_reader_packed(zserio_context.properties, zserio_reader)
        else:
            self._properties_ = None
    ...
    def write(self, zserio_writer: zserio.BitStreamWriter) -> None:
        ...
        if self._attribute_value_.type is not (self._attribute_type_code_):
            raise zserio.PythonRuntimeException("Wrong parameter type for field Display3dMeshFullAttribute.attributeValue: "
    ...
    def write_packed(self, zserio_context: Display3dMeshFullAttribute.ZserioPackingContext,
    ...
    class ZserioPackingContext:
        def __init__(self):
            ...
            self._attribute_value_ = nds.display.details.attributes.display3d_mesh_attribute_value.Display3dMeshAttributeValue.ZserioPackingContext()
            self._properties_ = nds.display.details.instantiations.display_property_list.DisplayPropertyList.ZserioPackingContext()
