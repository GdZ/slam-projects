...
import nds.display.details.instantiations.display3d_mesh_attribute_set
import nds.display.reference.types.display_mesh3d_id

class Display3dMeshAttributeSetMap:
    def __init__(
            self,
            coord_shift_: nds.core.geometry.coord_shift.CoordShift,
            attribute_set_: typing.Union[nds.display.details.instantiations.display3d_mesh_attribute_set.Display3dMeshAttributeSet, None] = None,
            feature_: nds.core.attributemap.feature_iterator.FeatureIterator = nds.core.attributemap.feature_iterator.FeatureIterator(),
            references_: typing.List[nds.display.reference.types.display_mesh3d_id.DisplayMesh3dId] = None,
    ...
    @classmethod
    def from_reader(
            cls: typing.Type['Display3dMeshAttributeSetMap'],
            zserio_reader: zserio.BitStreamReader,
            coord_shift_: nds.core.geometry.coord_shift.CoordShift) -> 'Display3dMeshAttributeSetMap':
    ...
    def from_reader_packed(
            cls: typing.Type['Display3dMeshAttributeSetMap'],
            zserio_context: Display3dMeshAttributeSetMap.ZserioPackingContext,
            zserio_reader: zserio.BitStreamReader,
            coord_shift_: nds.core.geometry.coord_shift.CoordShift) -> 'Display3dMeshAttributeSetMap':
        self = object.__new__(cls)
        self._coord_shift_ = coord_shift_
    ...
    def __eq__(self, other: object) -> bool:
        if isinstance(other, Display3dMeshAttributeSetMap):
    ...
    @property
    def attribute_set(self) -> typing.Union[nds.display.details.instantiations.display3d_mesh_attribute_set.Display3dMeshAttributeSet, None]:
        return self._attribute_set_

    @attribute_set.setter
    def attribute_set(self, attribute_set_: typing.Union[nds.display.details.instantiations.display3d_mesh_attribute_set.Display3dMeshAttributeSet, None]) -> None:
        self._attribute_set_ = attribute_set_
    ...
    @property
    def references(self) -> typing.List[nds.display.reference.types.display_mesh3d_id.DisplayMesh3dId]:
        return self._references_.raw_array

    @references.setter
    def references(self, references_: typing.List[nds.display.reference.types.display_mesh3d_id.DisplayMesh3dId]) -> None:
        self._references_ = zserio.array.Array(zserio.array.ObjectArrayTraits(self._ZserioElementFactory_references()), references_)
    ...
    def init_packing_context(self, zserio_context: Display3dMeshAttributeSetMap.ZserioPackingContext) -> None:
    ...
    def bitsizeof_packed(self, zserio_context: Display3dMeshAttributeSetMap.ZserioPackingContext, bitposition: int = 0) -> int:
        end_bitposition = bitposition
    ...
    def initialize_offsets_packed(self, zserio_context: Display3dMeshAttributeSetMap.ZserioPackingContext, bitposition: int) -> int:
        end_bitposition = bitposition
    ...
    def read(self, zserio_reader: zserio.BitStreamReader) -> None:
        self._attribute_set_ = nds.display.details.instantiations.display3d_mesh_attribute_set.Display3dMeshAttributeSet.from_reader(zserio_reader)
    ...
    def read_packed(self, zserio_context: Display3dMeshAttributeSetMap.ZserioPackingContext, zserio_reader: zserio.BitStreamReader) -> None:
        self._attribute_set_ = nds.display.details.instantiations.display3d_mesh_attribute_set.Display3dMeshAttributeSet.from_reader_packed(zserio_context.attribute_set, zserio_reader)
    ...
    def write(self, zserio_writer: zserio.BitStreamWriter) -> None:
        ...
        if len(self._references_) != (self._feature_):
            raise zserio.PythonRuntimeException("Wrong array length for field Display3dMeshAttributeSetMap.references: "
        ...
        if len(self._validities_) != (self._feature_):
            raise zserio.PythonRuntimeException("Wrong array length for field Display3dMeshAttributeSetMap.validities: "
                                                f"{len(self._validities_)} != {self._feature_}!")
        self._validities_.write(zserio_writer)

    def write_packed(self, zserio_context: Display3dMeshAttributeSetMap.ZserioPackingContext,
    ...
    class ZserioPackingContext:
        def __init__(self):
            self._attribute_set_ = nds.display.details.instantiations.display3d_mesh_attribute_set.Display3dMeshAttributeSet.ZserioPackingContext()
