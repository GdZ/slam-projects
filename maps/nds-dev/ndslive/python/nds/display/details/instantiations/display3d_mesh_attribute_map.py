...
import nds.display.details.instantiations.display3d_mesh_attribute
import nds.display.details.instantiations.display_property_list
import nds.display.reference.types.display_mesh3d_id

class Display3dMeshAttributeMap:
    def __init__(
            self,
            coord_shift_: nds.core.geometry.coord_shift.CoordShift,
            attribute_type_code_: typing.Union[nds.display.details.attributes.display3d_mesh_attribute_type.Display3dMeshAttributeType, None] = None,
            ...
            attribute_values_: typing.List[nds.display.details.instantiations.display3d_mesh_attribute.Display3dMeshAttribute] = None,
    ...
    @classmethod
    def from_reader(
            cls: typing.Type['Display3dMeshAttributeMap'],
            zserio_reader: zserio.BitStreamReader,
            coord_shift_: nds.core.geometry.coord_shift.CoordShift) -> 'Display3dMeshAttributeMap':
    ...
    def from_reader_packed(
            cls: typing.Type['Display3dMeshAttributeMap'],
            zserio_context: Display3dMeshAttributeMap.ZserioPackingContext,
            zserio_reader: zserio.BitStreamReader,
            coord_shift_: nds.core.geometry.coord_shift.CoordShift) -> 'Display3dMeshAttributeMap':
        self = object.__new__(cls)
        self._coord_shift_ = coord_shift_
    ...
    def __eq__(self, other: object) -> bool:
        if isinstance(other, Display3dMeshAttributeMap):
    ...
    @property
    def attribute_type_code(self) -> typing.Union[nds.display.details.attributes.display3d_mesh_attribute_type.Display3dMeshAttributeType, None]:
        return self._attribute_type_code_

    @attribute_type_code.setter
    def attribute_type_code(self, attribute_type_code_: typing.Union[nds.display.details.attributes.display3d_mesh_attribute_type.Display3dMeshAttributeType, None]) -> None:
        self._attribute_type_code_ = attribute_type_code_
    ...
    @property
    def attribute_values(self) -> typing.List[nds.display.details.instantiations.display3d_mesh_attribute.Display3dMeshAttribute]:
        return self._attribute_values_.raw_array

    @attribute_values.setter
    def attribute_values(self, attribute_values_: typing.List[nds.display.details.instantiations.display3d_mesh_attribute.Display3dMeshAttribute]) -> None:
        self._attribute_values_ = zserio.array.Array(zserio.array.ObjectArrayTraits(self._ZserioElementFactory_attribute_values(self)), attribute_values_)
    ...
    def init_packing_context(self, zserio_context: Display3dMeshAttributeMap.ZserioPackingContext) -> None:
    ...
    def bitsizeof_packed(self, zserio_context: Display3dMeshAttributeMap.ZserioPackingContext, bitposition: int = 0) -> int:
        end_bitposition = bitposition
    ...
    def initialize_offsets_packed(self, zserio_context: Display3dMeshAttributeMap.ZserioPackingContext, bitposition: int) -> int:
        end_bitposition = bitposition
    ...
    def read(self, zserio_reader: zserio.BitStreamReader) -> None:
        self._attribute_type_code_ = nds.display.details.attributes.display3d_mesh_attribute_type.Display3dMeshAttributeType.from_reader(zserio_reader)
    ...
    def read_packed(self, zserio_context: Display3dMeshAttributeMap.ZserioPackingContext, zserio_reader: zserio.BitStreamReader) -> None:
        self._attribute_type_code_ = nds.display.details.attributes.display3d_mesh_attribute_type.Display3dMeshAttributeType.from_reader_packed(zserio_context.attribute_type_code, zserio_reader)
    ...
    def write(self, zserio_writer: zserio.BitStreamWriter) -> None:
        ...
        if len(self._feature_references_) != (self._feature_):
            raise zserio.PythonRuntimeException("Wrong array length for field Display3dMeshAttributeMap.featureReferences: "
        ...
        if len(self._feature_validities_) != (self._feature_):
            raise zserio.PythonRuntimeException("Wrong array length for field Display3dMeshAttributeMap.featureValidities: "
        ...
        if len(self._feature_value_ptr_) != (self._feature_):
            raise zserio.PythonRuntimeException("Wrong array length for field Display3dMeshAttributeMap.featureValuePtr: "
        ...
        if len(self._attribute_values_) != (self._attribute_):
            raise zserio.PythonRuntimeException("Wrong array length for field Display3dMeshAttributeMap.attributeValues: "
        ...
        if len(self._attribute_properties_) != (self._attribute_):
            raise zserio.PythonRuntimeException("Wrong array length for field Display3dMeshAttributeMap.attributeProperties: "
        ...
        if len(self._attribute_conditions_) != (self._attribute_):
            raise zserio.PythonRuntimeException("Wrong array length for field Display3dMeshAttributeMap.attributeConditions: "
                                                f"{len(self._attribute_conditions_)} != {self._attribute_}!")
        self._attribute_conditions_.write_packed(zserio_writer)

    def write_packed(self, zserio_context: Display3dMeshAttributeMap.ZserioPackingContext,
    ...
    class _ZserioElementFactory_attribute_values:
        ...
        def create(self, zserio_reader: zserio.BitStreamReader, zserio_index: int) -> nds.display.details.instantiations.display3d_mesh_attribute.Display3dMeshAttribute:
            del zserio_index
            return nds.display.details.instantiations.display3d_mesh_attribute.Display3dMeshAttribute.from_reader(zserio_reader, self._owner._attribute_type_code_)

        @staticmethod
        def create_packing_context() -> nds.display.details.instantiations.display3d_mesh_attribute.Display3dMeshAttribute.ZserioPackingContext:
            return nds.display.details.instantiations.display3d_mesh_attribute.Display3dMeshAttribute.ZserioPackingContext()

        def create_packed(self, zserio_context: nds.display.details.instantiations.display3d_mesh_attribute.Display3dMeshAttribute.ZserioPackingContext,
                          zserio_reader: zserio.BitStreamReader, zserio_index: int) -> nds.display.details.instantiations.display3d_mesh_attribute.Display3dMeshAttribute:
            del zserio_index
            return nds.display.details.instantiations.display3d_mesh_attribute.Display3dMeshAttribute.from_reader_packed(zserio_context, zserio_reader, self._owner._attribute_type_code_)
