...
class Display3dMeshAttributeMapListHeader:
    def __init__(
            self,
            num_maps_: int,
            attribute_type_code_: typing.List[nds.display.details.attributes.display3d_mesh_attribute_type.Display3dMeshAttributeType] = None,
    ...
    @classmethod
    def from_reader(
            cls: typing.Type['Display3dMeshAttributeMapListHeader'],
            zserio_reader: zserio.BitStreamReader,
            num_maps_: int) -> 'Display3dMeshAttributeMapListHeader':
    ...
    def from_reader_packed(
            cls: typing.Type['Display3dMeshAttributeMapListHeader'],
            zserio_context: Display3dMeshAttributeMapListHeader.ZserioPackingContext,
            zserio_reader: zserio.BitStreamReader,
            num_maps_: int) -> 'Display3dMeshAttributeMapListHeader':
        self = object.__new__(cls)
        self._num_maps_ = num_maps_
    ...
    def __eq__(self, other: object) -> bool:
        if isinstance(other, Display3dMeshAttributeMapListHeader):
    ...
    @property
    def attribute_type_code(self) -> typing.List[nds.display.details.attributes.display3d_mesh_attribute_type.Display3dMeshAttributeType]:
        return self._attribute_type_code_.raw_array

    @attribute_type_code.setter
    def attribute_type_code(self, attribute_type_code_: typing.List[nds.display.details.attributes.display3d_mesh_attribute_type.Display3dMeshAttributeType]) -> None:
        self._attribute_type_code_ = zserio.array.Array(zserio.array.ObjectArrayTraits(self._ZserioElementFactory_attribute_type_code()), attribute_type_code_)
    ...
    def init_packing_context(self, zserio_context: Display3dMeshAttributeMapListHeader.ZserioPackingContext) -> None:
        del zserio_context
    ...
    def bitsizeof_packed(self, zserio_context: Display3dMeshAttributeMapListHeader.ZserioPackingContext, bitposition: int = 0) -> int:
        del zserio_context
    ...
    def initialize_offsets_packed(self, zserio_context: Display3dMeshAttributeMapListHeader.ZserioPackingContext, bitposition: int) -> int:
        del zserio_context
    ...
    def read_packed(self, zserio_context: Display3dMeshAttributeMapListHeader.ZserioPackingContext, zserio_reader: zserio.BitStreamReader) -> None:
        del zserio_context
    ...
    def write(self, zserio_writer: zserio.BitStreamWriter) -> None:
        ...
        if len(self._attribute_type_code_) != (self._num_maps_):
            raise zserio.PythonRuntimeException("Wrong array length for field Display3dMeshAttributeMapListHeader.attributeTypeCode: "
        ...
        if len(self._condition_type_) != (self._num_maps_):
            raise zserio.PythonRuntimeException("Wrong array length for field Display3dMeshAttributeMapListHeader.conditionType: "
                                                f"{len(self._condition_type_)} != {self._num_maps_}!")
        self._condition_type_.write_packed(zserio_writer)

    def write_packed(self, zserio_context: Display3dMeshAttributeMapListHeader.ZserioPackingContext,
    ...
    class _ZserioElementFactory_attribute_type_code:
        ...
        @staticmethod
        def create(zserio_reader: zserio.BitStreamReader, zserio_index: int) -> nds.display.details.attributes.display3d_mesh_attribute_type.Display3dMeshAttributeType:
            del zserio_index
            return nds.display.details.attributes.display3d_mesh_attribute_type.Display3dMeshAttributeType.from_reader(zserio_reader)
        ...
        def create_packed(zserio_context: zserio.array.DeltaContext,
                          zserio_reader: zserio.BitStreamReader, zserio_index: int) -> nds.display.details.attributes.display3d_mesh_attribute_type.Display3dMeshAttributeType:
            del zserio_index
            return nds.display.details.attributes.display3d_mesh_attribute_type.Display3dMeshAttributeType.from_reader_packed(zserio_context, zserio_reader)
