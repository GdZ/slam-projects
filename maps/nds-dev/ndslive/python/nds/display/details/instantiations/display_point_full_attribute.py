...
import nds.display.details.attributes.display_point_attribute_value
import nds.display.details.instantiations.display_property_list

class DisplayPointFullAttribute:
    def __init__(
            self,
            ...
            attribute_value_: typing.Union[nds.display.details.attributes.display_point_attribute_value.DisplayPointAttributeValue, None] = None,
    ...
    @classmethod
    def from_reader(
            cls: typing.Type['DisplayPointFullAttribute'],
            zserio_reader: zserio.BitStreamReader) -> 'DisplayPointFullAttribute':
    ...
    def from_reader_packed(
            cls: typing.Type['DisplayPointFullAttribute'],
            zserio_context: DisplayPointFullAttribute.ZserioPackingContext,
            zserio_reader: zserio.BitStreamReader) -> 'DisplayPointFullAttribute':
        self = object.__new__(cls)
    ...
    def __eq__(self, other: object) -> bool:
        if isinstance(other, DisplayPointFullAttribute):
    ...
    @property
    def attribute_value(self) -> typing.Union[nds.display.details.attributes.display_point_attribute_value.DisplayPointAttributeValue, None]:
        return self._attribute_value_

    @attribute_value.setter
    def attribute_value(self, attribute_value_: typing.Union[nds.display.details.attributes.display_point_attribute_value.DisplayPointAttributeValue, None]) -> None:
        self._attribute_value_ = attribute_value_
    ...
    def init_packing_context(self, zserio_context: DisplayPointFullAttribute.ZserioPackingContext) -> None:
    ...
    def bitsizeof_packed(self, zserio_context: DisplayPointFullAttribute.ZserioPackingContext, bitposition: int = 0) -> int:
        end_bitposition = bitposition
    ...
    def initialize_offsets_packed(self, zserio_context: DisplayPointFullAttribute.ZserioPackingContext, bitposition: int) -> int:
        end_bitposition = bitposition
    ...
    def read(self, zserio_reader: zserio.BitStreamReader) -> None:
        ...
        self._attribute_value_ = nds.display.details.attributes.display_point_attribute_value.DisplayPointAttributeValue.from_reader(zserio_reader, self._attribute_type_code_)
    ...
    def read_packed(self, zserio_context: DisplayPointFullAttribute.ZserioPackingContext, zserio_reader: zserio.BitStreamReader) -> None:
        ...
        self._attribute_value_ = nds.display.details.attributes.display_point_attribute_value.DisplayPointAttributeValue.from_reader_packed(zserio_context.attribute_value, zserio_reader, self._attribute_type_code_)
    ...
    def write(self, zserio_writer: zserio.BitStreamWriter) -> None:
        ...
        if self._attribute_value_.type is not (self._attribute_type_code_):
            raise zserio.PythonRuntimeException("Wrong parameter type for field DisplayPointFullAttribute.attributeValue: "
    ...
    def write_packed(self, zserio_context: DisplayPointFullAttribute.ZserioPackingContext,
    ...
    class ZserioPackingContext:
        def __init__(self):
            ...
            self._attribute_value_ = nds.display.details.attributes.display_point_attribute_value.DisplayPointAttributeValue.ZserioPackingContext()
