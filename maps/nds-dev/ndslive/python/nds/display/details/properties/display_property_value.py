...
import nds.display.details.properties.property_type
import nds.display.details.properties.property_value

class DisplayPropertyValue:
    def __init__(
            self,
            type_: nds.display.details.properties.display_property_type.DisplayPropertyType,
            value_: typing.Optional[nds.display.details.properties.property_value.PropertyValue] = None,
    ...
    @classmethod
    def from_reader(
            cls: typing.Type['DisplayPropertyValue'],
            zserio_reader: zserio.BitStreamReader,
            type_: nds.display.details.properties.display_property_type.DisplayPropertyType) -> 'DisplayPropertyValue':
    ...
    def from_reader_packed(
            cls: typing.Type['DisplayPropertyValue'],
            zserio_context: DisplayPropertyValue.ZserioPackingContext,
            zserio_reader: zserio.BitStreamReader,
            type_: nds.display.details.properties.display_property_type.DisplayPropertyType) -> 'DisplayPropertyValue':
        self = object.__new__(cls)
        self._type_ = type_
    ...
    def __eq__(self, other: object) -> bool:
        if isinstance(other, DisplayPropertyValue):
    ...
    @property
    def type(self) -> nds.display.details.properties.display_property_type.DisplayPropertyType:
        return self._type_

    @property
    def value(self) -> typing.Optional[nds.display.details.properties.property_value.PropertyValue]:
        return self._value_

    @value.setter
    def value(self, value_: typing.Optional[nds.display.details.properties.property_value.PropertyValue]) -> None:
        self._value_ = value_

    def is_value_used(self) -> bool:
        return self._type_.type != nds.display.details.properties.property_type.PropertyType.CORE
    ...
    def init_packing_context(self, zserio_context: DisplayPropertyValue.ZserioPackingContext) -> None:
        if self.is_core_value_used():
    ...
    def bitsizeof_packed(self, zserio_context: DisplayPropertyValue.ZserioPackingContext, bitposition: int = 0) -> int:
        end_bitposition = bitposition
        if self.is_value_used():
            end_bitposition += self._value_.bitsizeof(end_bitposition)
        if self.is_core_value_used():
    ...
    def initialize_offsets_packed(self, zserio_context: DisplayPropertyValue.ZserioPackingContext, bitposition: int) -> int:
        end_bitposition = bitposition
        if self.is_value_used():
            end_bitposition = self._value_.initialize_offsets(end_bitposition)
        if self.is_core_value_used():
    ...
    def read(self, zserio_reader: zserio.BitStreamReader) -> None:
        if self.is_value_used():
            self._value_ = nds.display.details.properties.property_value.PropertyValue.from_reader(zserio_reader, self._type_.type)
        else:
            self._value_ = None
        if self.is_core_value_used():
    ...
    def read_packed(self, zserio_context: DisplayPropertyValue.ZserioPackingContext, zserio_reader: zserio.BitStreamReader) -> None:
        if self.is_value_used():
            self._value_ = nds.display.details.properties.property_value.PropertyValue.from_reader(zserio_reader, self._type_.type)
        else:
            self._value_ = None
    ...
    def write(self, zserio_writer: zserio.BitStreamWriter) -> None:
        if self.is_value_used():
            ...
            if self._value_.type is not (self._type_.type):
                raise zserio.PythonRuntimeException("Wrong parameter type for field DisplayPropertyValue.value: "
        ...
        if self.is_core_value_used():
            ...
            if self._core_value_.type is not (self._type_.core_type):
                raise zserio.PythonRuntimeException("Wrong parameter type for field DisplayPropertyValue.coreValue: "
                                                    f"{self._core_value_.type} != {self._type_.core_type}!")
            self._core_value_.write(zserio_writer)

    def write_packed(self, zserio_context: DisplayPropertyValue.ZserioPackingContext,
