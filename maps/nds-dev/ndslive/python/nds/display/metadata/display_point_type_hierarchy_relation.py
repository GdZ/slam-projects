...
class DisplayPointTypeHierarchyRelation:
    def __init__(
            self,
            parent_: typing.Union[nds.display.types.display_point_type.DisplayPointType, None] = None,
            children_: typing.List[nds.display.types.display_point_type.DisplayPointType] = None) -> None:
    ...
    @classmethod
    def from_reader(
            cls: typing.Type['DisplayPointTypeHierarchyRelation'],
            zserio_reader: zserio.BitStreamReader) -> 'DisplayPointTypeHierarchyRelation':
    ...
    def from_reader_packed(
            cls: typing.Type['DisplayPointTypeHierarchyRelation'],
            zserio_context: DisplayPointTypeHierarchyRelation.ZserioPackingContext,
            zserio_reader: zserio.BitStreamReader) -> 'DisplayPointTypeHierarchyRelation':
        self = object.__new__(cls)
    ...
    def __eq__(self, other: object) -> bool:
        if isinstance(other, DisplayPointTypeHierarchyRelation):
    ...
    @property
    def parent(self) -> typing.Union[nds.display.types.display_point_type.DisplayPointType, None]:
        return self._parent_

    @parent.setter
    def parent(self, parent_: typing.Union[nds.display.types.display_point_type.DisplayPointType, None]) -> None:
        self._parent_ = parent_

    @property
    def children(self) -> typing.List[nds.display.types.display_point_type.DisplayPointType]:
        return self._children_.raw_array

    @children.setter
    def children(self, children_: typing.List[nds.display.types.display_point_type.DisplayPointType]) -> None:
        self._children_ = zserio.array.Array(zserio.array.ObjectArrayTraits(self._ZserioElementFactory_children()), children_, is_auto=True)

    def init_packing_context(self, zserio_context: DisplayPointTypeHierarchyRelation.ZserioPackingContext) -> None:
    ...
    def bitsizeof_packed(self, zserio_context: DisplayPointTypeHierarchyRelation.ZserioPackingContext, bitposition: int = 0) -> int:
        end_bitposition = bitposition
    ...
    def initialize_offsets_packed(self, zserio_context: DisplayPointTypeHierarchyRelation.ZserioPackingContext, bitposition: int) -> int:
        end_bitposition = bitposition
    ...
    def read(self, zserio_reader: zserio.BitStreamReader) -> None:
        self._parent_ = nds.display.types.display_point_type.DisplayPointType.from_reader(zserio_reader)
    ...
    def read_packed(self, zserio_context: DisplayPointTypeHierarchyRelation.ZserioPackingContext, zserio_reader: zserio.BitStreamReader) -> None:
        self._parent_ = nds.display.types.display_point_type.DisplayPointType.from_reader_packed(zserio_context.parent, zserio_reader)
    ...
    def write_packed(self, zserio_context: DisplayPointTypeHierarchyRelation.ZserioPackingContext,
