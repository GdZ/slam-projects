...
import nds.display.types.display_mesh3d_type

class Mesh3dDisplayGeometryLayer:
    def __init__(
            self,
            ...
            identifier_: typing.Optional[typing.List[nds.display.reference.types.display_mesh3d_id.DisplayMesh3dId]] = None,
            types_: typing.Optional[typing.List[nds.display.types.display_mesh3d_type.DisplayMesh3dType]] = None,
    ...
    @classmethod
    def from_reader(
            cls: typing.Type['Mesh3dDisplayGeometryLayer'],
            zserio_reader: zserio.BitStreamReader,
            type_: nds.core.geometry.geometry_layer_type.GeometryLayerType,
            has_ids_: bool,
            has_types_: bool) -> 'Mesh3dDisplayGeometryLayer':
    ...
    def from_reader_packed(
            cls: typing.Type['Mesh3dDisplayGeometryLayer'],
            zserio_context: Mesh3dDisplayGeometryLayer.ZserioPackingContext,
            zserio_reader: zserio.BitStreamReader,
            type_: nds.core.geometry.geometry_layer_type.GeometryLayerType,
            has_ids_: bool,
            has_types_: bool) -> 'Mesh3dDisplayGeometryLayer':
    ...
    def __eq__(self, other: object) -> bool:
        if isinstance(other, Mesh3dDisplayGeometryLayer):
    ...
    @property
    def identifier(self) -> typing.Optional[typing.List[nds.display.reference.types.display_mesh3d_id.DisplayMesh3dId]]:
        return None if self._identifier_ is None else self._identifier_.raw_array

    @identifier.setter
    def identifier(self, identifier_: typing.Optional[typing.List[nds.display.reference.types.display_mesh3d_id.DisplayMesh3dId]]) -> None:
        if identifier_ is None:
            self._identifier_ = None
        else:
            self._identifier_ = zserio.array.Array(zserio.array.ObjectArrayTraits(self._ZserioElementFactory_identifier()), identifier_)
    ...
    @property
    def types(self) -> typing.Optional[typing.List[nds.display.types.display_mesh3d_type.DisplayMesh3dType]]:
        return None if self._types_ is None else self._types_.raw_array

    @types.setter
    def types(self, types_: typing.Optional[typing.List[nds.display.types.display_mesh3d_type.DisplayMesh3dType]]) -> None:
        if types_ is None:
            self._types_ = None
        else:
            self._types_ = zserio.array.Array(zserio.array.ObjectArrayTraits(self._ZserioElementFactory_types()), types_)
    ...
    def init_packing_context(self, zserio_context: Mesh3dDisplayGeometryLayer.ZserioPackingContext) -> None:
    ...
    def bitsizeof_packed(self, zserio_context: Mesh3dDisplayGeometryLayer.ZserioPackingContext, bitposition: int = 0) -> int:
        end_bitposition = bitposition
    ...
    def initialize_offsets_packed(self, zserio_context: Mesh3dDisplayGeometryLayer.ZserioPackingContext, bitposition: int) -> int:
        end_bitposition = bitposition
        end_bitposition += zserio_context.coord_shift_xy.bitsizeof(zserio.array.BitFieldArrayTraits(5), self._coord_shift_xy_)
        end_bitposition += zserio_context.coord_shift_z.bitsizeof(zserio.array.BitFieldArrayTraits(5), self._coord_shift_z_)
        end_bitposition = zserio.bitposition.alignto(8, end_bitposition)
    ...
    def read_packed(self, zserio_context: Mesh3dDisplayGeometryLayer.ZserioPackingContext, zserio_reader: zserio.BitStreamReader) -> None:
    ...
    def write(self, zserio_writer: zserio.BitStreamWriter) -> None:
        ...
        if self.is_identifier_used():
            ...
            if len(self._identifier_) != (self._num_elements_):
                raise zserio.PythonRuntimeException("Wrong array length for field Mesh3dDisplayGeometryLayer.identifier: "
        ...
        if self.is_types_used():
            ...
            if len(self._types_) != (self._num_elements_):
                raise zserio.PythonRuntimeException("Wrong array length for field Mesh3dDisplayGeometryLayer.types: "
        ...
        if self._buffers_.type is not (self._type_):
            raise zserio.PythonRuntimeException("Wrong parameter type for field Mesh3dDisplayGeometryLayer.buffers: "
                                                f"{self._buffers_.type} != {self._type_}!")
        if self._buffers_.shift_xy != (self._coord_shift_xy_):
            raise zserio.PythonRuntimeException("Wrong parameter shiftXY for field Mesh3dDisplayGeometryLayer.buffers: "
                                                f"{self._buffers_.shift_xy} != {self._coord_shift_xy_}!")
        if self._buffers_.shift_z != (self._coord_shift_z_):
            raise zserio.PythonRuntimeException("Wrong parameter shiftZ for field Mesh3dDisplayGeometryLayer.buffers: "
                                                f"{self._buffers_.shift_z} != {self._coord_shift_z_}!")
        if self._buffers_.num_elements != (self._num_elements_):
            raise zserio.PythonRuntimeException("Wrong parameter numElements for field Mesh3dDisplayGeometryLayer.buffers: "
                                                f"{self._buffers_.num_elements} != {self._num_elements_}!")
        self._buffers_.write(zserio_writer)

    def write_packed(self, zserio_context: Mesh3dDisplayGeometryLayer.ZserioPackingContext,
    ...
    class _ZserioElementFactory_types:
        ...
        @staticmethod
        def create(zserio_reader: zserio.BitStreamReader, zserio_index: int) -> nds.display.types.display_mesh3d_type.DisplayMesh3dType:
            del zserio_index
            return nds.display.types.display_mesh3d_type.DisplayMesh3dType.from_reader(zserio_reader)
        ...
        def create_packed(zserio_context: zserio.array.DeltaContext,
                          zserio_reader: zserio.BitStreamReader, zserio_index: int) -> nds.display.types.display_mesh3d_type.DisplayMesh3dType:
            del zserio_index
            return nds.display.types.display_mesh3d_type.DisplayMesh3dType.from_reader_packed(zserio_context, zserio_reader)
