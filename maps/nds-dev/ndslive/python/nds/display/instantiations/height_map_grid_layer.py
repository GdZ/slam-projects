...
import nds.core.grid.grid_varint32
import nds.display.types.heightmap_grid_id
...
class HeightMapGridLayer:
    def __init__(
            ...
            identifier_: typing.Optional[typing.List[nds.display.types.heightmap_grid_id.HeightmapGridId]] = None,
            types_: typing.Optional[typing.List[nds.core.grid.grid_type.GridType]] = None,
            grids_: typing.List[nds.core.grid.grid_varint32.Grid_varint32] = None) -> None:
    ...
    @classmethod
    def from_reader(
            cls: typing.Type['HeightMapGridLayer'],
            zserio_reader: zserio.BitStreamReader,
            has_ids_: bool,
            has_types_: bool) -> 'HeightMapGridLayer':
    ...
    def from_reader_packed(
            cls: typing.Type['HeightMapGridLayer'],
            zserio_context: HeightMapGridLayer.ZserioPackingContext,
            zserio_reader: zserio.BitStreamReader,
            has_ids_: bool,
            has_types_: bool) -> 'HeightMapGridLayer':
        self = object.__new__(cls)
    ...
    def __eq__(self, other: object) -> bool:
        if isinstance(other, HeightMapGridLayer):
    ...
    @property
    def identifier(self) -> typing.Optional[typing.List[nds.display.types.heightmap_grid_id.HeightmapGridId]]:
        return None if self._identifier_ is None else self._identifier_.raw_array

    @identifier.setter
    def identifier(self, identifier_: typing.Optional[typing.List[nds.display.types.heightmap_grid_id.HeightmapGridId]]) -> None:
        if identifier_ is None:
            self._identifier_ = None
        else:
            self._identifier_ = zserio.array.Array(zserio.array.VarUInt32ArrayTraits(), identifier_)
    ...
    @property
    def grids(self) -> typing.List[nds.core.grid.grid_varint32.Grid_varint32]:
        return self._grids_.raw_array

    @grids.setter
    def grids(self, grids_: typing.List[nds.core.grid.grid_varint32.Grid_varint32]) -> None:
        self._grids_ = zserio.array.Array(zserio.array.ObjectArrayTraits(self._ZserioElementFactory_grids(self)), grids_)

    def init_packing_context(self, zserio_context: HeightMapGridLayer.ZserioPackingContext) -> None:
    ...
    def bitsizeof_packed(self, zserio_context: HeightMapGridLayer.ZserioPackingContext, bitposition: int = 0) -> int:
        end_bitposition = bitposition
    ...
    def initialize_offsets_packed(self, zserio_context: HeightMapGridLayer.ZserioPackingContext, bitposition: int) -> int:
        end_bitposition = bitposition
        end_bitposition += zserio_context.coord_shift_xy.bitsizeof(zserio.array.BitFieldArrayTraits(5), self._coord_shift_xy_)
        end_bitposition += zserio_context.cell_size.bitsizeof(zserio.array.VarSizeArrayTraits(), self._cell_size_)
        end_bitposition = zserio.bitposition.alignto(8, end_bitposition)
    ...
    def read_packed(self, zserio_context: HeightMapGridLayer.ZserioPackingContext, zserio_reader: zserio.BitStreamReader) -> None:
    ...
    def write(self, zserio_writer: zserio.BitStreamWriter) -> None:
        ...
        if self.is_identifier_used():
            ...
            if len(self._identifier_) != (self._num_elements_):
                raise zserio.PythonRuntimeException("Wrong array length for field HeightMapGridLayer.identifier: "
        ...
        if self.is_types_used():
            ...
            if len(self._types_) != (self._num_elements_):
                raise zserio.PythonRuntimeException("Wrong array length for field HeightMapGridLayer.types: "
        ...
        if len(self._grids_) != (self._num_elements_):
            raise zserio.PythonRuntimeException("Wrong array length for field HeightMapGridLayer.grids: "
                                                f"{len(self._grids_)} != {self._num_elements_}!")
        self._grids_.write_packed(zserio_writer)

    def write_packed(self, zserio_context: HeightMapGridLayer.ZserioPackingContext,
    ...
    class _ZserioElementFactory_grids:
        ...
        def create(self, zserio_reader: zserio.BitStreamReader, zserio_index: int) -> nds.core.grid.grid_varint32.Grid_varint32:
            del zserio_index
            return nds.core.grid.grid_varint32.Grid_varint32.from_reader(zserio_reader, self._owner._cell_size_, self._owner._coord_shift_xy_)

        @staticmethod
        def create_packing_context() -> nds.core.grid.grid_varint32.Grid_varint32.ZserioPackingContext:
            return nds.core.grid.grid_varint32.Grid_varint32.ZserioPackingContext()

        def create_packed(self, zserio_context: nds.core.grid.grid_varint32.Grid_varint32.ZserioPackingContext,
                          zserio_reader: zserio.BitStreamReader, zserio_index: int) -> nds.core.grid.grid_varint32.Grid_varint32:
            del zserio_index
            return nds.core.grid.grid_varint32.Grid_varint32.from_reader_packed(zserio_context, zserio_reader, self._owner._cell_size_, self._owner._coord_shift_xy_)
