...
import nds.instructions.attributes.instructions_transition_attribute_type
import nds.instructions.instantiations.instructions_property_list
import nds.instructions.instantiations.instructions_transition_attribute
import nds.road.reference.types.transition_reference

class InstructionsTransitionAttributeMap:
    def __init__(
            self,
            coord_shift_: nds.core.geometry.coord_shift.CoordShift,
            attribute_type_code_: typing.Union[nds.instructions.attributes.instructions_transition_attribute_type.InstructionsTransitionAttributeType, None] = None,
            ...
            attribute_values_: typing.List[nds.instructions.instantiations.instructions_transition_attribute.InstructionsTransitionAttribute] = None,
    ...
    @classmethod
    def from_reader(
            cls: typing.Type['InstructionsTransitionAttributeMap'],
            zserio_reader: zserio.BitStreamReader,
            coord_shift_: nds.core.geometry.coord_shift.CoordShift) -> 'InstructionsTransitionAttributeMap':
    ...
    def from_reader_packed(
            cls: typing.Type['InstructionsTransitionAttributeMap'],
            zserio_context: InstructionsTransitionAttributeMap.ZserioPackingContext,
            zserio_reader: zserio.BitStreamReader,
            coord_shift_: nds.core.geometry.coord_shift.CoordShift) -> 'InstructionsTransitionAttributeMap':
        self = object.__new__(cls)
        self._coord_shift_ = coord_shift_
    ...
    def __eq__(self, other: object) -> bool:
        if isinstance(other, InstructionsTransitionAttributeMap):
    ...
    @property
    def attribute_type_code(self) -> typing.Union[nds.instructions.attributes.instructions_transition_attribute_type.InstructionsTransitionAttributeType, None]:
        return self._attribute_type_code_

    @attribute_type_code.setter
    def attribute_type_code(self, attribute_type_code_: typing.Union[nds.instructions.attributes.instructions_transition_attribute_type.InstructionsTransitionAttributeType, None]) -> None:
        self._attribute_type_code_ = attribute_type_code_
    ...
    @property
    def attribute_values(self) -> typing.List[nds.instructions.instantiations.instructions_transition_attribute.InstructionsTransitionAttribute]:
        return self._attribute_values_.raw_array

    @attribute_values.setter
    def attribute_values(self, attribute_values_: typing.List[nds.instructions.instantiations.instructions_transition_attribute.InstructionsTransitionAttribute]) -> None:
        self._attribute_values_ = zserio.array.Array(zserio.array.ObjectArrayTraits(self._ZserioElementFactory_attribute_values(self)), attribute_values_)
    ...
    def init_packing_context(self, zserio_context: InstructionsTransitionAttributeMap.ZserioPackingContext) -> None:
    ...
    def bitsizeof_packed(self, zserio_context: InstructionsTransitionAttributeMap.ZserioPackingContext, bitposition: int = 0) -> int:
        end_bitposition = bitposition
    ...
    def initialize_offsets_packed(self, zserio_context: InstructionsTransitionAttributeMap.ZserioPackingContext, bitposition: int) -> int:
        end_bitposition = bitposition
    ...
    def read(self, zserio_reader: zserio.BitStreamReader) -> None:
        self._attribute_type_code_ = nds.instructions.attributes.instructions_transition_attribute_type.InstructionsTransitionAttributeType.from_reader(zserio_reader)
    ...
    def read_packed(self, zserio_context: InstructionsTransitionAttributeMap.ZserioPackingContext, zserio_reader: zserio.BitStreamReader) -> None:
        self._attribute_type_code_ = nds.instructions.attributes.instructions_transition_attribute_type.InstructionsTransitionAttributeType.from_reader_packed(zserio_context.attribute_type_code, zserio_reader)
    ...
    def write(self, zserio_writer: zserio.BitStreamWriter) -> None:
        ...
        if len(self._feature_references_) != (self._feature_):
            raise zserio.PythonRuntimeException("Wrong array length for field InstructionsTransitionAttributeMap.featureReferences: "
        ...
        if len(self._feature_validities_) != (self._feature_):
            raise zserio.PythonRuntimeException("Wrong array length for field InstructionsTransitionAttributeMap.featureValidities: "
        ...
        if len(self._feature_value_ptr_) != (self._feature_):
            raise zserio.PythonRuntimeException("Wrong array length for field InstructionsTransitionAttributeMap.featureValuePtr: "
        ...
        if len(self._attribute_values_) != (self._attribute_):
            raise zserio.PythonRuntimeException("Wrong array length for field InstructionsTransitionAttributeMap.attributeValues: "
        ...
        if len(self._attribute_properties_) != (self._attribute_):
            raise zserio.PythonRuntimeException("Wrong array length for field InstructionsTransitionAttributeMap.attributeProperties: "
        ...
        if len(self._attribute_conditions_) != (self._attribute_):
            raise zserio.PythonRuntimeException("Wrong array length for field InstructionsTransitionAttributeMap.attributeConditions: "
                                                f"{len(self._attribute_conditions_)} != {self._attribute_}!")
        self._attribute_conditions_.write_packed(zserio_writer)

    def write_packed(self, zserio_context: InstructionsTransitionAttributeMap.ZserioPackingContext,
    ...
    class _ZserioElementFactory_attribute_values:
        ...
        def create(self, zserio_reader: zserio.BitStreamReader, zserio_index: int) -> nds.instructions.instantiations.instructions_transition_attribute.InstructionsTransitionAttribute:
            del zserio_index
            return nds.instructions.instantiations.instructions_transition_attribute.InstructionsTransitionAttribute.from_reader(zserio_reader, self._owner._attribute_type_code_)

        @staticmethod
        def create_packing_context() -> nds.instructions.instantiations.instructions_transition_attribute.InstructionsTransitionAttribute.ZserioPackingContext:
            return nds.instructions.instantiations.instructions_transition_attribute.InstructionsTransitionAttribute.ZserioPackingContext()

        def create_packed(self, zserio_context: nds.instructions.instantiations.instructions_transition_attribute.InstructionsTransitionAttribute.ZserioPackingContext,
                          zserio_reader: zserio.BitStreamReader, zserio_index: int) -> nds.instructions.instantiations.instructions_transition_attribute.InstructionsTransitionAttribute:
            del zserio_index
            return nds.instructions.instantiations.instructions_transition_attribute.InstructionsTransitionAttribute.from_reader_packed(zserio_context, zserio_reader, self._owner._attribute_type_code_)
