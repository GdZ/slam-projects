...
import nds.instructions.attributes.instructions_transition_attribute_value
...
class InstructionsTransitionFullAttribute:
    def __init__(
            ...
            attribute_value_: typing.Union[nds.instructions.attributes.instructions_transition_attribute_value.InstructionsTransitionAttributeValue, None] = None,
            properties_: typing.Optional[nds.instructions.instantiations.instructions_property_list.InstructionsPropertyList] = None,
    ...
    @classmethod
    def from_reader(
            cls: typing.Type['InstructionsTransitionFullAttribute'],
            zserio_reader: zserio.BitStreamReader) -> 'InstructionsTransitionFullAttribute':
    ...
    def from_reader_packed(
            cls: typing.Type['InstructionsTransitionFullAttribute'],
            zserio_context: InstructionsTransitionFullAttribute.ZserioPackingContext,
            zserio_reader: zserio.BitStreamReader) -> 'InstructionsTransitionFullAttribute':
        self = object.__new__(cls)
    ...
    def __eq__(self, other: object) -> bool:
        if isinstance(other, InstructionsTransitionFullAttribute):
    ...
    @property
    def attribute_value(self) -> typing.Union[nds.instructions.attributes.instructions_transition_attribute_value.InstructionsTransitionAttributeValue, None]:
        return self._attribute_value_

    @attribute_value.setter
    def attribute_value(self, attribute_value_: typing.Union[nds.instructions.attributes.instructions_transition_attribute_value.InstructionsTransitionAttributeValue, None]) -> None:
        self._attribute_value_ = attribute_value_

    @property
    def properties(self) -> typing.Optional[nds.instructions.instantiations.instructions_property_list.InstructionsPropertyList]:
        return self._properties_

    @properties.setter
    def properties(self, properties_: typing.Optional[nds.instructions.instantiations.instructions_property_list.InstructionsPropertyList]) -> None:
        self._properties_ = properties_
    ...
    def init_packing_context(self, zserio_context: InstructionsTransitionFullAttribute.ZserioPackingContext) -> None:
    ...
    def bitsizeof_packed(self, zserio_context: InstructionsTransitionFullAttribute.ZserioPackingContext, bitposition: int = 0) -> int:
        end_bitposition = bitposition
    ...
    def initialize_offsets_packed(self, zserio_context: InstructionsTransitionFullAttribute.ZserioPackingContext, bitposition: int) -> int:
        end_bitposition = bitposition
    ...
    def read(self, zserio_reader: zserio.BitStreamReader) -> None:
        ...
        self._attribute_value_ = nds.instructions.attributes.instructions_transition_attribute_value.InstructionsTransitionAttributeValue.from_reader(zserio_reader, self._attribute_type_code_)
        if zserio_reader.read_bool():
            self._properties_ = nds.instructions.instantiations.instructions_property_list.InstructionsPropertyList.from_reader(zserio_reader)
        else:
            self._properties_ = None
        if zserio_reader.read_bool():
    ...
    def read_packed(self, zserio_context: InstructionsTransitionFullAttribute.ZserioPackingContext, zserio_reader: zserio.BitStreamReader) -> None:
        ...
        self._attribute_value_ = nds.instructions.attributes.instructions_transition_attribute_value.InstructionsTransitionAttributeValue.from_reader_packed(zserio_context.attribute_value, zserio_reader, self._attribute_type_code_)

        if zserio_reader.read_bool():
            self._properties_ = nds.instructions.instantiations.instructions_property_list.InstructionsPropertyList.from_reader_packed(zserio_context.properties, zserio_reader)
        else:
            self._properties_ = None
    ...
    def write(self, zserio_writer: zserio.BitStreamWriter) -> None:
        ...
        if self._attribute_value_.type is not (self._attribute_type_code_):
            raise zserio.PythonRuntimeException("Wrong parameter type for field InstructionsTransitionFullAttribute.attributeValue: "
    ...
    def write_packed(self, zserio_context: InstructionsTransitionFullAttribute.ZserioPackingContext,
    ...
    class ZserioPackingContext:
        def __init__(self):
            ...
            self._attribute_value_ = nds.instructions.attributes.instructions_transition_attribute_value.InstructionsTransitionAttributeValue.ZserioPackingContext()
            self._properties_ = nds.instructions.instantiations.instructions_property_list.InstructionsPropertyList.ZserioPackingContext()
