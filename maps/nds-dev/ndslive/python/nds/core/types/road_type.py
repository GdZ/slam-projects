...
class RoadType:
    def __init__(
            ...
            characteristics_: typing.Optional[typing.List[nds.core.types.road_character.RoadCharacter]] = None) -> None:
        self._form_ = form_
    ...
    @classmethod
    def from_reader(
            cls: typing.Type['RoadType'],
            zserio_reader: zserio.BitStreamReader) -> 'RoadType':
    ...
    def from_reader_packed(
            cls: typing.Type['RoadType'],
            zserio_context: RoadType.ZserioPackingContext,
            zserio_reader: zserio.BitStreamReader) -> 'RoadType':
        self = object.__new__(cls)
    ...
    @property
    def characteristics(self) -> typing.Optional[typing.List[nds.core.types.road_character.RoadCharacter]]:
        return None if self._characteristics_ is None else self._characteristics_.raw_array

    @characteristics.setter
    def characteristics(self, characteristics_: typing.Optional[typing.List[nds.core.types.road_character.RoadCharacter]]) -> None:
        if characteristics_ is None:
            self._characteristics_ = None
        else:
            self._characteristics_ = zserio.array.Array(zserio.array.ObjectArrayTraits(self._ZserioElementFactory_characteristics()), characteristics_, is_auto=True)
    ...
    def init_packing_context(self, zserio_context: RoadType.ZserioPackingContext) -> None:
    ...
    def bitsizeof_packed(self, zserio_context: RoadType.ZserioPackingContext, bitposition: int = 0) -> int:
        end_bitposition = bitposition
    ...
    def initialize_offsets_packed(self, zserio_context: RoadType.ZserioPackingContext, bitposition: int) -> int:
        end_bitposition = bitposition
    ...
    def read_packed(self, zserio_context: RoadType.ZserioPackingContext, zserio_reader: zserio.BitStreamReader) -> None:
    ...
    def write_packed(self, zserio_context: RoadType.ZserioPackingContext,
    ...
    class _ZserioElementFactory_characteristics:
        ...
        @staticmethod
        def create(zserio_reader: zserio.BitStreamReader, zserio_index: int) -> nds.core.types.road_character.RoadCharacter:
            del zserio_index
            return nds.core.types.road_character.RoadCharacter.from_reader(zserio_reader)
        ...
        def create_packed(zserio_context: zserio.array.DeltaContext,
                          zserio_reader: zserio.BitStreamReader, zserio_index: int) -> nds.core.types.road_character.RoadCharacter:
            del zserio_index
            return nds.core.types.road_character.RoadCharacter.from_reader_packed(zserio_context, zserio_reader)
