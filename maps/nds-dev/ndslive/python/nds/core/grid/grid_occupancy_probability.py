...
import nds.localization.types.occupancy_probability
...
class Grid_OccupancyProbability:
    def __init__(
            ...
            grid_: typing.List[nds.localization.types.occupancy_probability.OccupancyProbability] = None) -> None:
        self._size_ = size_
        self._shift_ = shift_
        self._south_west_corner_ = south_west_corner_
        self._num_rows_ = num_rows_
        self._num_columns_ = num_columns_
        self._grid_ = zserio.array.Array(zserio.array.ObjectArrayTraits(self._ZserioElementFactory_grid()), grid_)

    @classmethod
    def from_reader(
            cls: typing.Type['Grid_OccupancyProbability'],
            zserio_reader: zserio.BitStreamReader,
            size_: nds.core.grid.grid_cell_size.GridCellSize,
            shift_: nds.core.geometry.coord_shift.CoordShift) -> 'Grid_OccupancyProbability':
    ...
    def from_reader_packed(
            cls: typing.Type['Grid_OccupancyProbability'],
            zserio_context: Grid_OccupancyProbability.ZserioPackingContext,
            zserio_reader: zserio.BitStreamReader,
            size_: nds.core.grid.grid_cell_size.GridCellSize,
            shift_: nds.core.geometry.coord_shift.CoordShift) -> 'Grid_OccupancyProbability':
        self = object.__new__(cls)
    ...
    def __eq__(self, other: object) -> bool:
        if isinstance(other, Grid_OccupancyProbability):
    ...
    @property
    def grid(self) -> typing.List[nds.localization.types.occupancy_probability.OccupancyProbability]:
        return self._grid_.raw_array

    @grid.setter
    def grid(self, grid_: typing.List[nds.localization.types.occupancy_probability.OccupancyProbability]) -> None:
        self._grid_ = zserio.array.Array(zserio.array.ObjectArrayTraits(self._ZserioElementFactory_grid()), grid_)
    ...
    def init_packing_context(self, zserio_context: Grid_OccupancyProbability.ZserioPackingContext) -> None:
    ...
    def bitsizeof_packed(self, zserio_context: Grid_OccupancyProbability.ZserioPackingContext, bitposition: int = 0) -> int:
        end_bitposition = bitposition
    ...
    def initialize_offsets_packed(self, zserio_context: Grid_OccupancyProbability.ZserioPackingContext, bitposition: int) -> int:
        end_bitposition = bitposition
    ...
    def read(self, zserio_reader: zserio.BitStreamReader) -> None:
        ...
        self._grid_ = zserio.array.Array.from_reader_packed(zserio.array.ObjectArrayTraits(self._ZserioElementFactory_grid()), zserio_reader, self._num_rows_ * self._num_columns_)

    def read_packed(self, zserio_context: Grid_OccupancyProbability.ZserioPackingContext, zserio_reader: zserio.BitStreamReader) -> None:
    ...
    def write(self, zserio_writer: zserio.BitStreamWriter) -> None:
        ...
        if self._south_west_corner_.shift != (self._shift_):
            raise zserio.PythonRuntimeException("Wrong parameter shift for field Grid_OccupancyProbability.southWestCorner: "
        ...
        if len(self._grid_) != (self._num_rows_ * self._num_columns_):
            raise zserio.PythonRuntimeException("Wrong array length for field Grid_OccupancyProbability.grid: "
                                                f"{len(self._grid_)} != {self._num_rows_ * self._num_columns_}!")
        self._grid_.write_packed(zserio_writer)

    def write_packed(self, zserio_context: Grid_OccupancyProbability.ZserioPackingContext,
    ...
    class _ZserioElementFactory_grid:
        IS_OBJECT_PACKABLE = True

        @staticmethod
        def create(zserio_reader: zserio.BitStreamReader, zserio_index: int) -> nds.localization.types.occupancy_probability.OccupancyProbability:
            del zserio_index
            return nds.localization.types.occupancy_probability.OccupancyProbability.from_reader(zserio_reader)

        @staticmethod
        def create_packing_context() -> nds.localization.types.occupancy_probability.OccupancyProbability.ZserioPackingContext:
            return nds.localization.types.occupancy_probability.OccupancyProbability.ZserioPackingContext()

        @staticmethod
        def create_packed(zserio_context: nds.localization.types.occupancy_probability.OccupancyProbability.ZserioPackingContext,
                          zserio_reader: zserio.BitStreamReader, zserio_index: int) -> nds.localization.types.occupancy_probability.OccupancyProbability:
            del zserio_index
            return nds.localization.types.occupancy_probability.OccupancyProbability.from_reader_packed(zserio_context, zserio_reader)
