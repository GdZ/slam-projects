...
class TimeDurationHours:
    ...
    @classmethod
    def from_reader(
            cls: typing.Type['TimeDurationHours'],
            zserio_reader: zserio.BitStreamReader) -> 'TimeDurationHours':
    ...
    def from_reader_packed(
            cls: typing.Type['TimeDurationHours'],
            zserio_context: TimeDurationHours.ZserioPackingContext,
            zserio_reader: zserio.BitStreamReader) -> 'TimeDurationHours':
        self = object.__new__(cls)
    ...
    def __eq__(self, other: object) -> bool:
        if isinstance(other, TimeDurationHours):
    ...
    def init_packing_context(self, zserio_context: TimeDurationHours.ZserioPackingContext) -> None:
    ...
    def bitsizeof_packed(self, zserio_context: TimeDurationHours.ZserioPackingContext, bitposition: int = 0) -> int:
        end_bitposition = bitposition
    ...
    def initialize_offsets_packed(self, zserio_context: TimeDurationHours.ZserioPackingContext, bitposition: int) -> int:
        end_bitposition = bitposition
        end_bitposition += zserio_context.hours.bitsizeof(zserio.array.BitFieldArrayTraits(8), self._hours_)
        end_bitposition += zserio_context.minutes.bitsizeof(zserio.array.BitFieldArrayTraits(8), self._minutes_)
    ...
    def read(self, zserio_reader: zserio.BitStreamReader) -> None:
        ...
        # check constraint
        if not (self._minutes_ < 60):
            raise zserio.PythonRuntimeException("Constraint violated for field TimeDurationHours.minutes!")

    def read_packed(self, zserio_context: TimeDurationHours.ZserioPackingContext, zserio_reader: zserio.BitStreamReader) -> None:
    ...
    def write_packed(self, zserio_context: TimeDurationHours.ZserioPackingContext,
