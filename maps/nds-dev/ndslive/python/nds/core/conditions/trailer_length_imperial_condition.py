...
import nds.core.vehicle.trailer_length_imperial

class TrailerLengthImperialCondition:
    def __init__(
            self,
            trailer_number_: int = int(),
            length_: nds.core.vehicle.trailer_length_imperial.TrailerLengthImperial = nds.core.vehicle.trailer_length_imperial.TrailerLengthImperial(),
    ...
    @classmethod
    def from_reader(
            cls: typing.Type['TrailerLengthImperialCondition'],
            zserio_reader: zserio.BitStreamReader) -> 'TrailerLengthImperialCondition':
    ...
    def from_reader_packed(
            cls: typing.Type['TrailerLengthImperialCondition'],
            zserio_context: TrailerLengthImperialCondition.ZserioPackingContext,
            zserio_reader: zserio.BitStreamReader) -> 'TrailerLengthImperialCondition':
        self = object.__new__(cls)
    ...
    def __eq__(self, other: object) -> bool:
        if isinstance(other, TrailerLengthImperialCondition):
    ...
    @property
    def length(self) -> nds.core.vehicle.trailer_length_imperial.TrailerLengthImperial:
        return self._length_

    @length.setter
    def length(self, length_: nds.core.vehicle.trailer_length_imperial.TrailerLengthImperial) -> None:
        self._length_ = length_
    ...
    def init_packing_context(self, zserio_context: TrailerLengthImperialCondition.ZserioPackingContext) -> None:
    ...
    def bitsizeof_packed(self, zserio_context: TrailerLengthImperialCondition.ZserioPackingContext, bitposition: int = 0) -> int:
        end_bitposition = bitposition
    ...
    def initialize_offsets_packed(self, zserio_context: TrailerLengthImperialCondition.ZserioPackingContext, bitposition: int) -> int:
        end_bitposition = bitposition
        end_bitposition += zserio_context.trailer_number.bitsizeof(zserio.array.BitFieldArrayTraits(2), self._trailer_number_)
        end_bitposition += zserio_context.length.bitsizeof(zserio.array.VarUInt32ArrayTraits(), self._length_)
        end_bitposition += 1
    ...
    def read_packed(self, zserio_context: TrailerLengthImperialCondition.ZserioPackingContext, zserio_reader: zserio.BitStreamReader) -> None:
    ...
    def write_packed(self, zserio_context: TrailerLengthImperialCondition.ZserioPackingContext,
