...
import nds.core.vehicle.liters_per100km
...
class CombustionConsumptionCurve:
    def __init__(
            ...
            consumption_: typing.List[nds.core.vehicle.liters_per100km.LitersPer100km] = None) -> None:
        self._num_entries_ = num_entries_
        self._speed_ = zserio.array.Array(zserio.array.BitFieldArrayTraits(8), speed_)
        self._consumption_ = zserio.array.Array(zserio.array.Float16ArrayTraits(), consumption_)

    @classmethod
    def from_reader(
            cls: typing.Type['CombustionConsumptionCurve'],
            zserio_reader: zserio.BitStreamReader) -> 'CombustionConsumptionCurve':
    ...
    def from_reader_packed(
            cls: typing.Type['CombustionConsumptionCurve'],
            zserio_context: CombustionConsumptionCurve.ZserioPackingContext,
            zserio_reader: zserio.BitStreamReader) -> 'CombustionConsumptionCurve':
        self = object.__new__(cls)
    ...
    def __eq__(self, other: object) -> bool:
        if isinstance(other, CombustionConsumptionCurve):
    ...
    @property
    def consumption(self) -> typing.List[nds.core.vehicle.liters_per100km.LitersPer100km]:
        return self._consumption_.raw_array

    @consumption.setter
    def consumption(self, consumption_: typing.List[nds.core.vehicle.liters_per100km.LitersPer100km]) -> None:
        self._consumption_ = zserio.array.Array(zserio.array.Float16ArrayTraits(), consumption_)

    def init_packing_context(self, zserio_context: CombustionConsumptionCurve.ZserioPackingContext) -> None:
    ...
    def bitsizeof_packed(self, zserio_context: CombustionConsumptionCurve.ZserioPackingContext, bitposition: int = 0) -> int:
        end_bitposition = bitposition
    ...
    def initialize_offsets_packed(self, zserio_context: CombustionConsumptionCurve.ZserioPackingContext, bitposition: int) -> int:
        end_bitposition = bitposition
        end_bitposition += zserio_context.num_entries.bitsizeof(zserio.array.BitFieldArrayTraits(8), self._num_entries_)
    ...
    def read(self, zserio_reader: zserio.BitStreamReader) -> None:
        ...
        self._consumption_ = zserio.array.Array.from_reader(zserio.array.Float16ArrayTraits(), zserio_reader, self._num_entries_)

    def read_packed(self, zserio_context: CombustionConsumptionCurve.ZserioPackingContext, zserio_reader: zserio.BitStreamReader) -> None:
    ...
    def write(self, zserio_writer: zserio.BitStreamWriter) -> None:
        ...
        if len(self._speed_) != (self._num_entries_):
            raise zserio.PythonRuntimeException("Wrong array length for field CombustionConsumptionCurve.speed: "
                                                f"{len(self._speed_)} != {self._num_entries_}!")
        self._speed_.write(zserio_writer)

        # check array length
        if len(self._consumption_) != (self._num_entries_):
            raise zserio.PythonRuntimeException("Wrong array length for field CombustionConsumptionCurve.consumption: "
                                                f"{len(self._consumption_)} != {self._num_entries_}!")
        self._consumption_.write(zserio_writer)

    def write_packed(self, zserio_context: CombustionConsumptionCurve.ZserioPackingContext,
