...
class Line3D:
    def __init__(
            ...
            positions_: typing.List[nds.core.geometry.position3d.Position3D] = None) -> None:
    ...
    @classmethod
    def from_reader(
            cls: typing.Type['Line3D'],
            zserio_reader: zserio.BitStreamReader,
            shift_xy_: nds.core.geometry.coord_shift.CoordShift,
            shift_z_: nds.core.geometry.coord_shift.CoordShift) -> 'Line3D':
    ...
    def from_reader_packed(
            cls: typing.Type['Line3D'],
            zserio_context: Line3D.ZserioPackingContext,
            zserio_reader: zserio.BitStreamReader,
            shift_xy_: nds.core.geometry.coord_shift.CoordShift,
            shift_z_: nds.core.geometry.coord_shift.CoordShift) -> 'Line3D':
        self = object.__new__(cls)
    ...
    def init_packing_context(self, zserio_context: Line3D.ZserioPackingContext) -> None:
    ...
    def bitsizeof_packed(self, zserio_context: Line3D.ZserioPackingContext, bitposition: int = 0) -> int:
        end_bitposition = bitposition
    ...
    def initialize_offsets_packed(self, zserio_context: Line3D.ZserioPackingContext, bitposition: int) -> int:
        end_bitposition = bitposition
        end_bitposition += zserio_context.num_positions.bitsizeof(zserio.array.VarSizeArrayTraits(), self._num_positions_)
        end_bitposition = self._positions_.initialize_offsets_packed(end_bitposition)
    ...
    def read(self, zserio_reader: zserio.BitStreamReader) -> None:
        ...
        if not (self._num_positions_ > 0):
            raise zserio.PythonRuntimeException("Constraint violated for field Line3D.numPositions!")
    ...
    def read_packed(self, zserio_context: Line3D.ZserioPackingContext, zserio_reader: zserio.BitStreamReader) -> None:
    ...
    def write(self, zserio_writer: zserio.BitStreamWriter) -> None:
        ...
        if len(self._positions_) != (self._num_positions_):
            raise zserio.PythonRuntimeException("Wrong array length for field Line3D.positions: "
                                                f"{len(self._positions_)} != {self._num_positions_}!")
        self._positions_.write_packed(zserio_writer)

    def write_packed(self, zserio_context: Line3D.ZserioPackingContext,
