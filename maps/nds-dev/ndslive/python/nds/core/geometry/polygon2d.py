...
class Polygon2D:
    ...
    @classmethod
    def from_reader(
            cls: typing.Type['Polygon2D'],
            zserio_reader: zserio.BitStreamReader,
            ib_: nds.core.geometry.index_buffer.IndexBuffer) -> 'Polygon2D':
    ...
    def from_reader_packed(
            cls: typing.Type['Polygon2D'],
            zserio_context: Polygon2D.ZserioPackingContext,
            zserio_reader: zserio.BitStreamReader,
            ib_: nds.core.geometry.index_buffer.IndexBuffer) -> 'Polygon2D':
        self = object.__new__(cls)
        self._ib_ = ib_
    ...
    def init_packing_context(self, zserio_context: Polygon2D.ZserioPackingContext) -> None:
    ...
    def bitsizeof_packed(self, zserio_context: Polygon2D.ZserioPackingContext, bitposition: int = 0) -> int:
        end_bitposition = bitposition
    ...
    def initialize_offsets_packed(self, zserio_context: Polygon2D.ZserioPackingContext, bitposition: int) -> int:
        end_bitposition = bitposition
    ...
    def read(self, zserio_reader: zserio.BitStreamReader) -> None:
        ...
        if not ((self._start_index_ + self._num_positions_) <= self._ib_.num_entries):
            raise zserio.PythonRuntimeException("Constraint violated for field Polygon2D.numPositions!")

    def read_packed(self, zserio_context: Polygon2D.ZserioPackingContext, zserio_reader: zserio.BitStreamReader) -> None:
    ...
    def write_packed(self, zserio_context: Polygon2D.ZserioPackingContext,
