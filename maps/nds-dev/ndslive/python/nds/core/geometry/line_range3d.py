...
class LineRange3D:
    def __init__(
            self,
            line_: nds.core.geometry.line3d.Line3D,
    ...
    @classmethod
    def from_reader(
            cls: typing.Type['LineRange3D'],
            zserio_reader: zserio.BitStreamReader,
            line_: nds.core.geometry.line3d.Line3D) -> 'LineRange3D':
    ...
    def from_reader_packed(
            cls: typing.Type['LineRange3D'],
            zserio_context: LineRange3D.ZserioPackingContext,
            zserio_reader: zserio.BitStreamReader,
            line_: nds.core.geometry.line3d.Line3D) -> 'LineRange3D':
        self = object.__new__(cls)
        self._line_ = line_
    ...
    def __eq__(self, other: object) -> bool:
        if isinstance(other, LineRange3D):
    ...
    @property
    def line(self) -> nds.core.geometry.line3d.Line3D:
        return self._line_
    ...
    def init_packing_context(self, zserio_context: LineRange3D.ZserioPackingContext) -> None:
    ...
    def bitsizeof_packed(self, zserio_context: LineRange3D.ZserioPackingContext, bitposition: int = 0) -> int:
        end_bitposition = bitposition
    ...
    def initialize_offsets_packed(self, zserio_context: LineRange3D.ZserioPackingContext, bitposition: int) -> int:
        end_bitposition = bitposition
        end_bitposition += zserio_context.start.bitsizeof(zserio.array.VarSizeArrayTraits(), self._start_)
        end_bitposition += zserio_context.end.bitsizeof(zserio.array.VarSizeArrayTraits(), self._end_)
    ...
    def read(self, zserio_reader: zserio.BitStreamReader) -> None:
        ...
        if not (self._end_ > self._start_ and self._end_ <= self._line_.last_position_idx()):
            raise zserio.PythonRuntimeException("Constraint violated for field LineRange3D.end!")

    def read_packed(self, zserio_context: LineRange3D.ZserioPackingContext, zserio_reader: zserio.BitStreamReader) -> None:
    ...
    def write_packed(self, zserio_context: LineRange3D.ZserioPackingContext,
