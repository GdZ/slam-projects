...
class LineRangeOffset2D:
    def __init__(
            ...
            num_bits_: nds.core.geometry.coord_width.CoordWidth = nds.core.geometry.coord_width.CoordWidth(),
            ...
            start_offset_: typing.Optional[nds.core.geometry.position_offset2d.PositionOffset2D] = None,
            end_offset_: typing.Optional[nds.core.geometry.position_offset2d.PositionOffset2D] = None) -> None:
        self._shift_ = shift_
    ...
    @classmethod
    def from_reader(
            cls: typing.Type['LineRangeOffset2D'],
            zserio_reader: zserio.BitStreamReader,
            shift_: nds.core.geometry.coord_shift.CoordShift) -> 'LineRangeOffset2D':
    ...
    def from_reader_packed(
            cls: typing.Type['LineRangeOffset2D'],
            zserio_context: LineRangeOffset2D.ZserioPackingContext,
            zserio_reader: zserio.BitStreamReader,
            shift_: nds.core.geometry.coord_shift.CoordShift) -> 'LineRangeOffset2D':
        self = object.__new__(cls)
        self._shift_ = shift_
    ...
    def __eq__(self, other: object) -> bool:
        if isinstance(other, LineRangeOffset2D):
    ...
    @num_bits.setter
    def num_bits(self, num_bits_: nds.core.geometry.coord_width.CoordWidth) -> None:
        self._num_bits_ = num_bits_
    ...
    @property
    def start_offset(self) -> typing.Optional[nds.core.geometry.position_offset2d.PositionOffset2D]:
        return self._start_offset_

    @start_offset.setter
    def start_offset(self, start_offset_: typing.Optional[nds.core.geometry.position_offset2d.PositionOffset2D]) -> None:
        self._start_offset_ = start_offset_
    ...
    @property
    def end_offset(self) -> typing.Optional[nds.core.geometry.position_offset2d.PositionOffset2D]:
        return self._end_offset_

    @end_offset.setter
    def end_offset(self, end_offset_: typing.Optional[nds.core.geometry.position_offset2d.PositionOffset2D]) -> None:
        self._end_offset_ = end_offset_
    ...
    def init_packing_context(self, zserio_context: LineRangeOffset2D.ZserioPackingContext) -> None:
    ...
    def bitsizeof_packed(self, zserio_context: LineRangeOffset2D.ZserioPackingContext, bitposition: int = 0) -> int:
        end_bitposition = bitposition
    ...
    def initialize_offsets_packed(self, zserio_context: LineRangeOffset2D.ZserioPackingContext, bitposition: int) -> int:
        end_bitposition = bitposition
    ...
    def read(self, zserio_reader: zserio.BitStreamReader) -> None:
        ...
        if self.is_start_offset_used():
            self._start_offset_ = nds.core.geometry.position_offset2d.PositionOffset2D.from_reader(zserio_reader, self._num_bits_, self._shift_)
        else:
            self._start_offset_ = None
        if self.is_end_offset_used():
            self._end_offset_ = nds.core.geometry.position_offset2d.PositionOffset2D.from_reader(zserio_reader, self._num_bits_, self._shift_)
        else:
            self._end_offset_ = None

    def read_packed(self, zserio_context: LineRangeOffset2D.ZserioPackingContext, zserio_reader: zserio.BitStreamReader) -> None:
        ...
        if self.is_start_offset_used():
            self._start_offset_ = nds.core.geometry.position_offset2d.PositionOffset2D.from_reader_packed(zserio_context.start_offset, zserio_reader, self._num_bits_, self._shift_)
        else:
            self._start_offset_ = None

        if self.is_end_offset_used():
            self._end_offset_ = nds.core.geometry.position_offset2d.PositionOffset2D.from_reader_packed(zserio_context.end_offset, zserio_reader, self._num_bits_, self._shift_)
        else:
            self._end_offset_ = None
    ...
    def write(self, zserio_writer: zserio.BitStreamWriter) -> None:
        ...
        if self.is_start_offset_used():
            # check parameters
            if self._start_offset_.num_bits != (self._num_bits_):
                raise zserio.PythonRuntimeException("Wrong parameter numBits for field LineRangeOffset2D.startOffset: "
                                                    f"{self._start_offset_.num_bits} != {self._num_bits_}!")
            if self._start_offset_.shift != (self._shift_):
                raise zserio.PythonRuntimeException("Wrong parameter shift for field LineRangeOffset2D.startOffset: "
                                                    f"{self._start_offset_.shift} != {self._shift_}!")
            self._start_offset_.write(zserio_writer)

        if self.is_end_offset_used():
            # check parameters
            if self._end_offset_.num_bits != (self._num_bits_):
                raise zserio.PythonRuntimeException("Wrong parameter numBits for field LineRangeOffset2D.endOffset: "
                                                    f"{self._end_offset_.num_bits} != {self._num_bits_}!")
            if self._end_offset_.shift != (self._shift_):
                raise zserio.PythonRuntimeException("Wrong parameter shift for field LineRangeOffset2D.endOffset: "
                                                    f"{self._end_offset_.shift} != {self._shift_}!")
            self._end_offset_.write(zserio_writer)

    def write_packed(self, zserio_context: LineRangeOffset2D.ZserioPackingContext,
    ...
    class ZserioPackingContext:
        def __init__(self):
            ...
            self._start_offset_ = nds.core.geometry.position_offset2d.PositionOffset2D.ZserioPackingContext()
            self._end_offset_ = nds.core.geometry.position_offset2d.PositionOffset2D.ZserioPackingContext()
