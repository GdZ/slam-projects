...
class LinePositionOffset2D:
    def __init__(
            ...
            offset_: typing.Union[nds.core.geometry.position_offset2d.PositionOffset2D, None] = None) -> None:
        self._shift_ = shift_
    ...
    @classmethod
    def from_reader(
            cls: typing.Type['LinePositionOffset2D'],
            zserio_reader: zserio.BitStreamReader,
            shift_: nds.core.geometry.coord_shift.CoordShift) -> 'LinePositionOffset2D':
    ...
    def from_reader_packed(
            cls: typing.Type['LinePositionOffset2D'],
            zserio_context: LinePositionOffset2D.ZserioPackingContext,
            zserio_reader: zserio.BitStreamReader,
            shift_: nds.core.geometry.coord_shift.CoordShift) -> 'LinePositionOffset2D':
        self = object.__new__(cls)
        self._shift_ = shift_
    ...
    def __eq__(self, other: object) -> bool:
        if isinstance(other, LinePositionOffset2D):
    ...
    @property
    def offset(self) -> typing.Union[nds.core.geometry.position_offset2d.PositionOffset2D, None]:
        return self._offset_

    @offset.setter
    def offset(self, offset_: typing.Union[nds.core.geometry.position_offset2d.PositionOffset2D, None]) -> None:
        self._offset_ = offset_

    def init_packing_context(self, zserio_context: LinePositionOffset2D.ZserioPackingContext) -> None:
    ...
    def bitsizeof_packed(self, zserio_context: LinePositionOffset2D.ZserioPackingContext, bitposition: int = 0) -> int:
        end_bitposition = bitposition
    ...
    def initialize_offsets_packed(self, zserio_context: LinePositionOffset2D.ZserioPackingContext, bitposition: int) -> int:
        end_bitposition = bitposition
        end_bitposition += zserio_context.line_position.bitsizeof(zserio.array.VarSizeArrayTraits(), self._line_position_)
        end_bitposition += zserio_context.num_bits.bitsizeof(zserio.array.BitFieldArrayTraits(5), self._num_bits_)
    ...
    def read(self, zserio_reader: zserio.BitStreamReader) -> None:
        ...
        self._offset_ = nds.core.geometry.position_offset2d.PositionOffset2D.from_reader(zserio_reader, self._num_bits_, self._shift_)

    def read_packed(self, zserio_context: LinePositionOffset2D.ZserioPackingContext, zserio_reader: zserio.BitStreamReader) -> None:
        ...
        self._offset_ = nds.core.geometry.position_offset2d.PositionOffset2D.from_reader_packed(zserio_context.offset, zserio_reader, self._num_bits_, self._shift_)
    ...
    def write(self, zserio_writer: zserio.BitStreamWriter) -> None:
        ...
        # check parameters
        if self._offset_.num_bits != (self._num_bits_):
            raise zserio.PythonRuntimeException("Wrong parameter numBits for field LinePositionOffset2D.offset: "
                                                f"{self._offset_.num_bits} != {self._num_bits_}!")
        if self._offset_.shift != (self._shift_):
            raise zserio.PythonRuntimeException("Wrong parameter shift for field LinePositionOffset2D.offset: "
                                                f"{self._offset_.shift} != {self._shift_}!")
        self._offset_.write(zserio_writer)

    def write_packed(self, zserio_context: LinePositionOffset2D.ZserioPackingContext,
    ...
    class ZserioPackingContext:
        def __init__(self):
            ...
            self._offset_ = nds.core.geometry.position_offset2d.PositionOffset2D.ZserioPackingContext()
