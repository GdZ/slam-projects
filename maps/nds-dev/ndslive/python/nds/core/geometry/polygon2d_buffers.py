...
import nds.core.geometry.polygon2d
...
class Polygon2DBuffers:
    def __init__(
            ...
            positions_: typing.List[nds.core.geometry.position2d.Position2D] = None,
            index_buffer_: typing.Union[nds.core.geometry.index_buffer.IndexBuffer, None] = None,
            polygons_: typing.List[nds.core.geometry.polygon2d.Polygon2D] = None) -> None:
        self._shift_ = shift_
        ...
        self._polygons_ = zserio.array.Array(zserio.array.ObjectArrayTraits(self._ZserioElementFactory_polygons(self)), polygons_)

    @classmethod
    def from_reader(
            cls: typing.Type['Polygon2DBuffers'],
            zserio_reader: zserio.BitStreamReader,
            shift_: nds.core.geometry.coord_shift.CoordShift,
            num_elements_: int) -> 'Polygon2DBuffers':
    ...
    def from_reader_packed(
            cls: typing.Type['Polygon2DBuffers'],
            zserio_context: Polygon2DBuffers.ZserioPackingContext,
            zserio_reader: zserio.BitStreamReader,
            shift_: nds.core.geometry.coord_shift.CoordShift,
            num_elements_: int) -> 'Polygon2DBuffers':
        self = object.__new__(cls)
    ...
    def __eq__(self, other: object) -> bool:
        if isinstance(other, Polygon2DBuffers):
            return (self._shift_ == other._shift_ and
                    ...
                    (self._polygons_ == other._polygons_))
    ...
    def __hash__(self) -> int:
        ...
        result = zserio.hashcode.calc_hashcode_object(result, self._polygons_)
    ...
    @property
    def polygons(self) -> typing.List[nds.core.geometry.polygon2d.Polygon2D]:
        return self._polygons_.raw_array

    @polygons.setter
    def polygons(self, polygons_: typing.List[nds.core.geometry.polygon2d.Polygon2D]) -> None:
        self._polygons_ = zserio.array.Array(zserio.array.ObjectArrayTraits(self._ZserioElementFactory_polygons(self)), polygons_)

    def init_packing_context(self, zserio_context: Polygon2DBuffers.ZserioPackingContext) -> None:
    ...
    def bitsizeof(self, bitposition: int = 0) -> int:
        ...
        end_bitposition += self._polygons_.bitsizeof_packed(end_bitposition)

        return end_bitposition - bitposition

    def bitsizeof_packed(self, zserio_context: Polygon2DBuffers.ZserioPackingContext, bitposition: int = 0) -> int:
        end_bitposition = bitposition
    ...
    def initialize_offsets(self, bitposition: int = 0) -> int:
        ...
        end_bitposition = self._polygons_.initialize_offsets_packed(end_bitposition)

        return end_bitposition

    def initialize_offsets_packed(self, zserio_context: Polygon2DBuffers.ZserioPackingContext, bitposition: int) -> int:
        end_bitposition = bitposition
        end_bitposition += zserio_context.num_positions.bitsizeof(zserio.array.VarSizeArrayTraits(), self._num_positions_)
        end_bitposition = self._positions_.initialize_offsets_packed(end_bitposition)
    ...
    def read(self, zserio_reader: zserio.BitStreamReader) -> None:
        ...
        self._polygons_ = zserio.array.Array.from_reader_packed(zserio.array.ObjectArrayTraits(self._ZserioElementFactory_polygons(self)), zserio_reader, self._num_elements_)

    def read_packed(self, zserio_context: Polygon2DBuffers.ZserioPackingContext, zserio_reader: zserio.BitStreamReader) -> None:
    ...
    def write(self, zserio_writer: zserio.BitStreamWriter) -> None:
        ...
        if len(self._positions_) != (self._num_positions_):
            raise zserio.PythonRuntimeException("Wrong array length for field Polygon2DBuffers.positions: "
        ...
        if self._index_buffer_.position_buffer_size != (self._num_positions_):
            raise zserio.PythonRuntimeException("Wrong parameter positionBufferSize for field Polygon2DBuffers.indexBuffer: "
                                                f"{self._index_buffer_.position_buffer_size} != {self._num_positions_}!")
        self._index_buffer_.write(zserio_writer)

        # check array length
        if len(self._polygons_) != (self._num_elements_):
            raise zserio.PythonRuntimeException("Wrong array length for field Polygon2DBuffers.polygons: "
                                                f"{len(self._polygons_)} != {self._num_elements_}!")
        self._polygons_.write_packed(zserio_writer)

    def write_packed(self, zserio_context: Polygon2DBuffers.ZserioPackingContext,
    ...
    class _ZserioElementFactory_polygons:
        IS_OBJECT_PACKABLE = True

        def __init__(self, owner):
            self._owner = owner

        def create(self, zserio_reader: zserio.BitStreamReader, zserio_index: int) -> nds.core.geometry.polygon2d.Polygon2D:
            del zserio_index
            return nds.core.geometry.polygon2d.Polygon2D.from_reader(zserio_reader, self._owner._index_buffer_)

        @staticmethod
        def create_packing_context() -> nds.core.geometry.polygon2d.Polygon2D.ZserioPackingContext:
            return nds.core.geometry.polygon2d.Polygon2D.ZserioPackingContext()

        def create_packed(self, zserio_context: nds.core.geometry.polygon2d.Polygon2D.ZserioPackingContext,
                          zserio_reader: zserio.BitStreamReader, zserio_index: int) -> nds.core.geometry.polygon2d.Polygon2D:
            del zserio_index
            return nds.core.geometry.polygon2d.Polygon2D.from_reader_packed(zserio_context, zserio_reader, self._owner._index_buffer_)
