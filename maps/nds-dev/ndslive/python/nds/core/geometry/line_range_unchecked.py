...
class LineRangeUnchecked:
    ...
    @classmethod
    def from_reader(
            cls: typing.Type['LineRangeUnchecked'],
            zserio_reader: zserio.BitStreamReader) -> 'LineRangeUnchecked':
    ...
    def from_reader_packed(
            cls: typing.Type['LineRangeUnchecked'],
            zserio_context: LineRangeUnchecked.ZserioPackingContext,
            zserio_reader: zserio.BitStreamReader) -> 'LineRangeUnchecked':
        self = object.__new__(cls)
    ...
    def __eq__(self, other: object) -> bool:
        if isinstance(other, LineRangeUnchecked):
    ...
    def init_packing_context(self, zserio_context: LineRangeUnchecked.ZserioPackingContext) -> None:
    ...
    def bitsizeof_packed(self, zserio_context: LineRangeUnchecked.ZserioPackingContext, bitposition: int = 0) -> int:
        end_bitposition = bitposition
    ...
    def initialize_offsets_packed(self, zserio_context: LineRangeUnchecked.ZserioPackingContext, bitposition: int) -> int:
        end_bitposition = bitposition
        end_bitposition += zserio_context.start.bitsizeof(zserio.array.VarSizeArrayTraits(), self._start_)
        end_bitposition += zserio_context.end.bitsizeof(zserio.array.VarSizeArrayTraits(), self._end_)
    ...
    def read(self, zserio_reader: zserio.BitStreamReader) -> None:
        ...
        # check constraint
        if not (self._end_ > self._start_):
            raise zserio.PythonRuntimeException("Constraint violated for field LineRangeUnchecked.end!")

    def read_packed(self, zserio_context: LineRangeUnchecked.ZserioPackingContext, zserio_reader: zserio.BitStreamReader) -> None:
    ...
    def write_packed(self, zserio_context: LineRangeUnchecked.ZserioPackingContext,
