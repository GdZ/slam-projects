...
private static final long serialVersionUID = 0L;
   ...
   */
  @java.lang.Override public int getGearModeValue() {
    return gearMode_;
  }
  /**
   * <pre>
   ...
   * @return The gearMode.
   */
  @java.lang.Override public org.sensoris.categories.powertrain.TransmissionStatus.GearMode getGearMode() {
    org.sensoris.categories.powertrain.TransmissionStatus.GearMode result = org.sensoris.categories.powertrain.TransmissionStatus.GearMode.forNumber(gearMode_);
   ...
   */
  @java.lang.Override public int getDriveModeValue() {
    return driveMode_;
  }
  /**
   * <pre>
   ...
   */
  @java.lang.Override public org.sensoris.categories.powertrain.TransmissionStatus.DriveMode getDriveMode() {
    org.sensoris.categories.powertrain.TransmissionStatus.DriveMode result = org.sensoris.categories.powertrain.TransmissionStatus.DriveMode.forNumber(driveMode_);
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (gearMode_ != other.gearMode_) return false;
    if (driveMode_ != other.driveMode_) return false;
    if (hasCurrentGear() != other.hasCurrentGear()) return false;
    if (hasCurrentGear()) {
      if (!getCurrentGear()
          .equals(other.getCurrentGear())) return false;
    }
  ...
  public static final class Builder extends
    ...
    private void buildPartial0(org.sensoris.categories.powertrain.TransmissionStatus result) {
      ...
      if (((from_bitField0_ & 0x00000008) != 0)) {
        result.currentGear_ = currentGearBuilder_ == null
            ? currentGear_
            : currentGearBuilder_.build();
      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 16: {
              gearMode_ = input.readEnum();
              bitField0_ |= 0x00000002;
              break;
            } // case 16
            case 24: {
              driveMode_ = input.readEnum();
              bitField0_ |= 0x00000004;
              break;
            } // case 24
            case 34: {
              input.readMessage(
                  getCurrentGearFieldBuilder().getBuilder(),
                  extensionRegistry);
     ...
     *
     * <code>.sensoris.protobuf.categories.powertrain.TransmissionStatus.GearMode gear_mode = 2;</code>
     * @param value The enum numeric value on the wire for gearMode to set.
     ...
     *
     * <code>.sensoris.protobuf.categories.powertrain.TransmissionStatus.GearMode gear_mode = 2;</code>
     * @param value The gearMode to set.
     * @return This builder for chaining.
     */
     ...
     *
     * <code>.sensoris.protobuf.categories.powertrain.TransmissionStatus.DriveMode drive_mode = 3;</code>
     * @param value The enum numeric value on the wire for driveMode to set.
     * @return This builder for chaining.
     */
    ...
    public Builder mergeCurrentGear(org.sensoris.types.base.Int64Value value) {
      if (currentGearBuilder_ == null) {
        if (((bitField0_ & 0x00000008) != 0) &&
          currentGear_ != null &&
          currentGear_ != org.sensoris.types.base.Int64Value.getDefaultInstance()) {
          getCurrentGearBuilder().mergeFrom(value);
        } else {
          currentGear_ = value;
        }
      } else {
