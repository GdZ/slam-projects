...
#ifndef GOOGLE_PROTOBUF_INCLUDED_sensoris_2fprotobuf_2fcategories_2fdriving_5fbehavior_2eproto_2epb_2eh
#define GOOGLE_PROTOBUF_INCLUDED_sensoris_2fprotobuf_2fcategories_2fdriving_5fbehavior_2eproto_2epb_2eh
...
constexpr ParkingStatus_StatusAndConfidence_Type ParkingStatus_StatusAndConfidence_Type_Type_MIN = static_cast<ParkingStatus_StatusAndConfidence_Type>(0);
constexpr ParkingStatus_StatusAndConfidence_Type ParkingStatus_StatusAndConfidence_Type_Type_MAX = static_cast<ParkingStatus_StatusAndConfidence_Type>(2);
constexpr int ParkingStatus_StatusAndConfidence_Type_Type_ARRAYSIZE = 2 + 1;
const ::google::protobuf::EnumDescriptor*
ParkingStatus_StatusAndConfidence_Type_descriptor();
template <typename T>
...
inline const std::string& ParkingStatus_StatusAndConfidence_Type_Name(ParkingStatus_StatusAndConfidence_Type value) {
  return ::google::protobuf::internal::NameOfDenseEnum<ParkingStatus_StatusAndConfidence_Type_descriptor,
                                                 0, 2>(
      static_cast<int>(value));
}
inline bool ParkingStatus_StatusAndConfidence_Type_Parse(absl::string_view name, ParkingStatus_StatusAndConfidence_Type* value) {
...
constexpr ParkingStatus_DirectionAndConfidence_Type ParkingStatus_DirectionAndConfidence_Type_Type_MIN = static_cast<ParkingStatus_DirectionAndConfidence_Type>(0);
constexpr ParkingStatus_DirectionAndConfidence_Type ParkingStatus_DirectionAndConfidence_Type_Type_MAX = static_cast<ParkingStatus_DirectionAndConfidence_Type>(3);
constexpr int ParkingStatus_DirectionAndConfidence_Type_Type_ARRAYSIZE = 3 + 1;
const ::google::protobuf::EnumDescriptor*
ParkingStatus_DirectionAndConfidence_Type_descriptor();
template <typename T>
...
inline const std::string& ParkingStatus_DirectionAndConfidence_Type_Name(ParkingStatus_DirectionAndConfidence_Type value) {
  return ::google::protobuf::internal::NameOfDenseEnum<ParkingStatus_DirectionAndConfidence_Type_descriptor,
                                                 0, 3>(
      static_cast<int>(value));
}
inline bool ParkingStatus_DirectionAndConfidence_Type_Parse(absl::string_view name, ParkingStatus_DirectionAndConfidence_Type* value) {
...
class ParkingStatus_StatusAndConfidence final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:sensoris.protobuf.categories.drivingbehavior.ParkingStatus.StatusAndConfidence) */ {
 public:
  inline ParkingStatus_StatusAndConfidence() : ParkingStatus_StatusAndConfidence(nullptr) {}
  ~ParkingStatus_StatusAndConfidence() override;
  template<typename = void>
  explicit PROTOBUF_CONSTEXPR ParkingStatus_StatusAndConfidence(::google::protobuf::internal::ConstantInitialized);

  inline ParkingStatus_StatusAndConfidence(const ParkingStatus_StatusAndConfidence& from)
      : ParkingStatus_StatusAndConfidence(nullptr, from) {}
  ...
  inline void Swap(ParkingStatus_StatusAndConfidence* other) {
  ...
  ParkingStatus_StatusAndConfidence* New(::google::protobuf::Arena* arena = nullptr) const final {
  ...
  void MergeFrom( const ParkingStatus_StatusAndConfidence& from) {
    ParkingStatus_StatusAndConfidence::MergeImpl(*this, from);
  }
  private:
  ...
  static ::absl::string_view FullMessageName() {
    return "sensoris.protobuf.categories.drivingbehavior.ParkingStatus.StatusAndConfidence";
  }
  protected:
  explicit ParkingStatus_StatusAndConfidence(::google::protobuf::Arena* arena);
  ParkingStatus_StatusAndConfidence(::google::protobuf::Arena* arena, const ParkingStatus_StatusAndConfidence& from);
  public:
...
class ParkingStatus_DirectionAndConfidence final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:sensoris.protobuf.categories.drivingbehavior.ParkingStatus.DirectionAndConfidence) */ {
 public:
  inline ParkingStatus_DirectionAndConfidence() : ParkingStatus_DirectionAndConfidence(nullptr) {}
  ~ParkingStatus_DirectionAndConfidence() override;
  template<typename = void>
  explicit PROTOBUF_CONSTEXPR ParkingStatus_DirectionAndConfidence(::google::protobuf::internal::ConstantInitialized);

  inline ParkingStatus_DirectionAndConfidence(const ParkingStatus_DirectionAndConfidence& from)
      : ParkingStatus_DirectionAndConfidence(nullptr, from) {}
  ...
  inline void Swap(ParkingStatus_DirectionAndConfidence* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetArena() != nullptr &&
        GetArena() == other->GetArena()) {
  ...
  ParkingStatus_DirectionAndConfidence* New(::google::protobuf::Arena* arena = nullptr) const final {
  ...
  void MergeFrom( const ParkingStatus_DirectionAndConfidence& from) {
    ParkingStatus_DirectionAndConfidence::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::google::protobuf::Message& to_msg, const ::google::protobuf::Message& from_msg);
  public:
  ...
  friend class ::google::protobuf::internal::AnyMetadata;
  static ::absl::string_view FullMessageName() {
    return "sensoris.protobuf.categories.drivingbehavior.ParkingStatus.DirectionAndConfidence";
  }
  protected:
  explicit ParkingStatus_DirectionAndConfidence(::google::protobuf::Arena* arena);
  ParkingStatus_DirectionAndConfidence(::google::protobuf::Arena* arena, const ParkingStatus_DirectionAndConfidence& from);
  public:
...
class ParkingStatus final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:sensoris.protobuf.categories.drivingbehavior.ParkingStatus) */ {
 public:
  inline ParkingStatus() : ParkingStatus(nullptr) {}
  ~ParkingStatus() override;
  template<typename = void>
  explicit PROTOBUF_CONSTEXPR ParkingStatus(::google::protobuf::internal::ConstantInitialized);

  inline ParkingStatus(const ParkingStatus& from)
      : ParkingStatus(nullptr, from) {}
  ...
  inline void Swap(ParkingStatus* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetArena() != nullptr &&
        GetArena() == other->GetArena()) {
  ...
  ParkingStatus* New(::google::protobuf::Arena* arena = nullptr) const final {
  ...
  void MergeFrom( const ParkingStatus& from) {
    ParkingStatus::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::google::protobuf::Message& to_msg, const ::google::protobuf::Message& from_msg);
  public:
  ...
  friend class ::google::protobuf::internal::AnyMetadata;
  static ::absl::string_view FullMessageName() {
    return "sensoris.protobuf.categories.drivingbehavior.ParkingStatus";
  }
  protected:
  explicit ParkingStatus(::google::protobuf::Arena* arena);
  ParkingStatus(::google::protobuf::Arena* arena, const ParkingStatus& from);
  public:
  ...
  PROTOBUF_NODISCARD ::sensoris::protobuf::categories::drivingbehavior::ParkingStatus_StatusAndConfidence* release_status_and_confidence();
  ::sensoris::protobuf::categories::drivingbehavior::ParkingStatus_StatusAndConfidence* mutable_status_and_confidence();
  void set_allocated_status_and_confidence(::sensoris::protobuf::categories::drivingbehavior::ParkingStatus_StatusAndConfidence* value);
  void unsafe_arena_set_allocated_status_and_confidence(::sensoris::protobuf::categories::drivingbehavior::ParkingStatus_StatusAndConfidence* value);
  ...
  ::sensoris::protobuf::categories::drivingbehavior::ParkingStatus_StatusAndConfidence* _internal_mutable_status_and_confidence();
  ...
  PROTOBUF_NODISCARD ::sensoris::protobuf::categories::drivingbehavior::ParkingStatus_DirectionAndConfidence* release_direction_and_confidence();
  ::sensoris::protobuf::categories::drivingbehavior::ParkingStatus_DirectionAndConfidence* mutable_direction_and_confidence();
  void set_allocated_direction_and_confidence(::sensoris::protobuf::categories::drivingbehavior::ParkingStatus_DirectionAndConfidence* value);
  void unsafe_arena_set_allocated_direction_and_confidence(::sensoris::protobuf::categories::drivingbehavior::ParkingStatus_DirectionAndConfidence* value);
  ...
  ::sensoris::protobuf::categories::drivingbehavior::ParkingStatus_DirectionAndConfidence* _internal_mutable_direction_and_confidence();
  ...
  PROTOBUF_NODISCARD ::sensoris::protobuf::types::base::Int64ValueAndAccuracy* release_duration_and_accuracy();
  ::sensoris::protobuf::types::base::Int64ValueAndAccuracy* mutable_duration_and_accuracy();
  void set_allocated_duration_and_accuracy(::sensoris::protobuf::types::base::Int64ValueAndAccuracy* value);
  void unsafe_arena_set_allocated_duration_and_accuracy(::sensoris::protobuf::types::base::Int64ValueAndAccuracy* value);
  ...
  ::sensoris::protobuf::types::base::Int64ValueAndAccuracy* _internal_mutable_duration_and_accuracy();
...
class DrivingBehaviorCategory final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:sensoris.protobuf.categories.drivingbehavior.DrivingBehaviorCategory) */ {
 public:
  inline DrivingBehaviorCategory() : DrivingBehaviorCategory(nullptr) {}
  ~DrivingBehaviorCategory() override;
  template<typename = void>
  explicit PROTOBUF_CONSTEXPR DrivingBehaviorCategory(::google::protobuf::internal::ConstantInitialized);

  inline DrivingBehaviorCategory(const DrivingBehaviorCategory& from)
      : DrivingBehaviorCategory(nullptr, from) {}
  ...
  inline void Swap(DrivingBehaviorCategory* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetArena() != nullptr &&
        GetArena() == other->GetArena()) {
  ...
  DrivingBehaviorCategory* New(::google::protobuf::Arena* arena = nullptr) const final {
  ...
  void MergeFrom( const DrivingBehaviorCategory& from) {
    DrivingBehaviorCategory::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::google::protobuf::Message& to_msg, const ::google::protobuf::Message& from_msg);
  public:
  ...
  friend class ::google::protobuf::internal::AnyMetadata;
  static ::absl::string_view FullMessageName() {
    return "sensoris.protobuf.categories.drivingbehavior.DrivingBehaviorCategory";
  }
  protected:
  explicit DrivingBehaviorCategory(::google::protobuf::Arena* arena);
  DrivingBehaviorCategory(::google::protobuf::Arena* arena, const DrivingBehaviorCategory& from);
  public:
  ...
  ::google::protobuf::RepeatedPtrField<::sensoris::protobuf::categories::drivingbehavior::ParkingStatus>* _internal_mutable_parking_status();
  public:
...
inline void ParkingStatus_StatusAndConfidence::unsafe_arena_set_allocated_confidence(::sensoris::protobuf::types::base::Confidence* value) {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  if (GetArena() == nullptr) {
...
inline ::sensoris::protobuf::types::base::Confidence* ParkingStatus_StatusAndConfidence::_internal_mutable_confidence() {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  _impl_._has_bits_[0] |= 0x00000001u;
...
inline ::sensoris::protobuf::types::base::Confidence* ParkingStatus_StatusAndConfidence::mutable_confidence() ABSL_ATTRIBUTE_LIFETIME_BOUND {
...
inline void ParkingStatus_StatusAndConfidence::set_allocated_confidence(::sensoris::protobuf::types::base::Confidence* value) {
...
inline void ParkingStatus_DirectionAndConfidence::unsafe_arena_set_allocated_confidence(::sensoris::protobuf::types::base::Confidence* value) {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  if (GetArena() == nullptr) {
    delete reinterpret_cast<::google::protobuf::MessageLite*>(_impl_.confidence_);
  }
...
inline ::sensoris::protobuf::types::base::Confidence* ParkingStatus_DirectionAndConfidence::_internal_mutable_confidence() {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  _impl_._has_bits_[0] |= 0x00000001u;
  if (_impl_.confidence_ == nullptr) {
    auto* p = CreateMaybeMessage<::sensoris::protobuf::types::base::Confidence>(GetArena());
...
inline ::sensoris::protobuf::types::base::Confidence* ParkingStatus_DirectionAndConfidence::mutable_confidence() ABSL_ATTRIBUTE_LIFETIME_BOUND {
  ::sensoris::protobuf::types::base::Confidence* _msg = _internal_mutable_confidence();
...
inline void ParkingStatus_DirectionAndConfidence::set_allocated_confidence(::sensoris::protobuf::types::base::Confidence* value) {
  ::google::protobuf::Arena* message_arena = GetArena();
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  if (message_arena == nullptr) {
    delete reinterpret_cast<::google::protobuf::MessageLite*>(_impl_.confidence_);
...
inline void ParkingStatus::unsafe_arena_set_allocated_envelope(::sensoris::protobuf::types::base::EventEnvelope* value) {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  if (GetArena() == nullptr) {
...
inline ::sensoris::protobuf::types::base::EventEnvelope* ParkingStatus::_internal_mutable_envelope() {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  _impl_._has_bits_[0] |= 0x00000001u;
...
inline ::sensoris::protobuf::types::base::EventEnvelope* ParkingStatus::mutable_envelope() ABSL_ATTRIBUTE_LIFETIME_BOUND {
...
inline void ParkingStatus::set_allocated_envelope(::sensoris::protobuf::types::base::EventEnvelope* value) {
  ::google::protobuf::Arena* message_arena = GetArena();
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  if (message_arena == nullptr) {
    delete reinterpret_cast<::google::protobuf::MessageLite*>(_impl_.envelope_);
...
inline void ParkingStatus::unsafe_arena_set_allocated_status_and_confidence(::sensoris::protobuf::categories::drivingbehavior::ParkingStatus_StatusAndConfidence* value) {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  if (GetArena() == nullptr) {
...
inline ::sensoris::protobuf::categories::drivingbehavior::ParkingStatus_StatusAndConfidence* ParkingStatus::_internal_mutable_status_and_confidence() {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  _impl_._has_bits_[0] |= 0x00000002u;
  if (_impl_.status_and_confidence_ == nullptr) {
    auto* p = CreateMaybeMessage<::sensoris::protobuf::categories::drivingbehavior::ParkingStatus_StatusAndConfidence>(GetArena());
...
inline ::sensoris::protobuf::categories::drivingbehavior::ParkingStatus_StatusAndConfidence* ParkingStatus::mutable_status_and_confidence() ABSL_ATTRIBUTE_LIFETIME_BOUND {
...
inline void ParkingStatus::set_allocated_status_and_confidence(::sensoris::protobuf::categories::drivingbehavior::ParkingStatus_StatusAndConfidence* value) {
  ::google::protobuf::Arena* message_arena = GetArena();
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  if (message_arena == nullptr) {
    delete reinterpret_cast<::sensoris::protobuf::categories::drivingbehavior::ParkingStatus_StatusAndConfidence*>(_impl_.status_and_confidence_);
  }

  if (value != nullptr) {
    ::google::protobuf::Arena* submessage_arena = reinterpret_cast<::sensoris::protobuf::categories::drivingbehavior::ParkingStatus_StatusAndConfidence*>(value)->GetArena();
    if (message_arena != submessage_arena) {
      value = ::google::protobuf::internal::GetOwnedMessage(message_arena, value, submessage_arena);
    }
    _impl_._has_bits_[0] |= 0x00000002u;
...
inline void ParkingStatus::unsafe_arena_set_allocated_direction_and_confidence(::sensoris::protobuf::categories::drivingbehavior::ParkingStatus_DirectionAndConfidence* value) {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  if (GetArena() == nullptr) {
...
inline ::sensoris::protobuf::categories::drivingbehavior::ParkingStatus_DirectionAndConfidence* ParkingStatus::_internal_mutable_direction_and_confidence() {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  _impl_._has_bits_[0] |= 0x00000004u;
  if (_impl_.direction_and_confidence_ == nullptr) {
    auto* p = CreateMaybeMessage<::sensoris::protobuf::categories::drivingbehavior::ParkingStatus_DirectionAndConfidence>(GetArena());
...
inline ::sensoris::protobuf::categories::drivingbehavior::ParkingStatus_DirectionAndConfidence* ParkingStatus::mutable_direction_and_confidence() ABSL_ATTRIBUTE_LIFETIME_BOUND {
...
inline void ParkingStatus::set_allocated_direction_and_confidence(::sensoris::protobuf::categories::drivingbehavior::ParkingStatus_DirectionAndConfidence* value) {
  ::google::protobuf::Arena* message_arena = GetArena();
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  if (message_arena == nullptr) {
    delete reinterpret_cast<::sensoris::protobuf::categories::drivingbehavior::ParkingStatus_DirectionAndConfidence*>(_impl_.direction_and_confidence_);
  }

  if (value != nullptr) {
    ::google::protobuf::Arena* submessage_arena = reinterpret_cast<::sensoris::protobuf::categories::drivingbehavior::ParkingStatus_DirectionAndConfidence*>(value)->GetArena();
    if (message_arena != submessage_arena) {
      value = ::google::protobuf::internal::GetOwnedMessage(message_arena, value, submessage_arena);
    }
    _impl_._has_bits_[0] |= 0x00000004u;
...
inline void ParkingStatus::unsafe_arena_set_allocated_duration_and_accuracy(::sensoris::protobuf::types::base::Int64ValueAndAccuracy* value) {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  if (GetArena() == nullptr) {
...
inline ::sensoris::protobuf::types::base::Int64ValueAndAccuracy* ParkingStatus::_internal_mutable_duration_and_accuracy() {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  _impl_._has_bits_[0] |= 0x00000008u;
...
inline ::sensoris::protobuf::types::base::Int64ValueAndAccuracy* ParkingStatus::mutable_duration_and_accuracy() ABSL_ATTRIBUTE_LIFETIME_BOUND {
...
inline void ParkingStatus::set_allocated_duration_and_accuracy(::sensoris::protobuf::types::base::Int64ValueAndAccuracy* value) {
  ::google::protobuf::Arena* message_arena = GetArena();
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  if (message_arena == nullptr) {
    delete reinterpret_cast<::google::protobuf::MessageLite*>(_impl_.duration_and_accuracy_);
...
inline void DrivingBehaviorCategory::unsafe_arena_set_allocated_envelope(::sensoris::protobuf::types::base::CategoryEnvelope* value) {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  if (GetArena() == nullptr) {
    delete reinterpret_cast<::google::protobuf::MessageLite*>(_impl_.envelope_);
  }
...
inline ::sensoris::protobuf::types::base::CategoryEnvelope* DrivingBehaviorCategory::_internal_mutable_envelope() {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  _impl_._has_bits_[0] |= 0x00000001u;
  if (_impl_.envelope_ == nullptr) {
...
inline ::sensoris::protobuf::types::base::CategoryEnvelope* DrivingBehaviorCategory::mutable_envelope() ABSL_ATTRIBUTE_LIFETIME_BOUND {
...
inline void DrivingBehaviorCategory::set_allocated_envelope(::sensoris::protobuf::types::base::CategoryEnvelope* value) {
  ::google::protobuf::Arena* message_arena = GetArena();
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  if (message_arena == nullptr) {
    delete reinterpret_cast<::google::protobuf::MessageLite*>(_impl_.envelope_);
...
inline ::google::protobuf::RepeatedPtrField<::sensoris::protobuf::categories::drivingbehavior::ParkingStatus>* DrivingBehaviorCategory::mutable_parking_status()
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
...
inline ::sensoris::protobuf::categories::drivingbehavior::ParkingStatus* DrivingBehaviorCategory::add_parking_status() ABSL_ATTRIBUTE_LIFETIME_BOUND {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
...
#endif  // GOOGLE_PROTOBUF_INCLUDED_sensoris_2fprotobuf_2fcategories_2fdriving_5fbehavior_2eproto_2epb_2eh
