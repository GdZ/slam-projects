...
constexpr MarkingColorAndConfidence_Type MarkingColorAndConfidence_Type_Type_MAX = static_cast<MarkingColorAndConfidence_Type>(12);
constexpr int MarkingColorAndConfidence_Type_Type_ARRAYSIZE = 12 + 1;
...
constexpr LaneBoundary_TypeAndConfidence_Type LaneBoundary_TypeAndConfidence_Type_Type_MAX = static_cast<LaneBoundary_TypeAndConfidence_Type>(31);
constexpr int LaneBoundary_TypeAndConfidence_Type_Type_ARRAYSIZE = 31 + 1;
const ::google::protobuf::EnumDescriptor*
